...
<div class="col-3-height">
                ...
                <div id="projector_details" class="product_info">
                    ...
                    <iaixsl:choose>
                        <iaixsl:when test="/shop/basket/@wholesaler = 'true' or /shop/page/projector/product/price/@value != 0">
                            ...
                            <section id="projector_productname" class="product_name d-flex mb-2 mb-sm-4 justify-content-between col-12">
                                <div class="product_name__wrapper pr-md-2 col-12 px-0">
                                    <div class="firm-icon-projector-h1 d-flex d-md-none justify-content-end ">
                                    <img>
                                    <iaixsl:attribute name="src">
                                    <iaixsl:value-of disable-output-escaping="yes" select="/shop/page/projector/product/firm/@icon"/>
                                    </iaixsl:attribute>
                                    <iaixsl:attribute name="title">
                                    ...
                                    <div class="row px-0">
                                    <h1 class="product_name__name m-0 col-12 col-md-9 pr-0">
                                        <iaixsl:value-of disable-output-escaping="yes" select="/shop/page/projector/product/name"/>
                                    </h1>
                                    <div class="firm-icon-projector-h1 col-md-3 d-none d-md-block pl-0">
                                    <img>
                                    <iaixsl:attribute name="src">
                                    <iaixsl:value-of disable-output-escaping="yes" select="/shop/page/projector/product/firm/@icon"/>
                                    </iaixsl:attribute>
    ...
    <div class="row col-12">
        <div class="col-12 col-md-6 px-0">
            ...
            <iaixsl:if test="page/projector/products_associated_zone1 and (/shop/basket/@login != '')">
            ...
            <iaixsl:if test="page/projector/products_associated_zone2 and not(/shop/basket/@login != '')">
        ...
        <!--Produkty powiązane z tym produktem - strefa 3 (projector_associated_zone3, 111440.1)-->
                ...
                <iaixsl:if test="page/projector/products_associated_zone3 and (/shop/basket/@login != '')">
        ...
        <!--Produkty powiązane z tym produktem - strefa 4 (projector_associated_zone4, 88393.1)-->
                ...
                <iaixsl:if test="page/projector/products_associated_zone4 and not(/shop/basket/@login != '')">
                    <section id="products_associated_zone4" class="hotspot mb-5 --slider col-12 p-0 px-sm-3">
                        
                        <iaixsl:variable name="headline_after_products_associated_zone4"></iaixsl:variable>
                        
                        <iaixsl:if test="not(page/projector/products_associated_zone4/product or page/projector/products_associated_zone4/opinion)">
                            <iaixsl:attribute name="data-ajaxLoad">true</iaixsl:attribute>
                            <iaixsl:attribute name="data-pageType">projector</iaixsl:attribute>
                        </iaixsl:if>
                        ...
                        <iaixsl:choose>
                            <iaixsl:when test="page/projector/products_associated_zone4/product or page/projector/products_associated_zone4/opinion">

                            
                            <h2>
                                <iaixsl:choose>
                                    <iaixsl:when test="page/projector/products_associated_zone4/@link">
                                        <a class="headline">
                                            <iaixsl:attribute name="href"><iaixsl:value-of select="page/projector/products_associated_zone4/@link"/></iaixsl:attribute>
                                            <iaixsl:attribute name="title"></iaixsl:attribute>

                                            <span class="headline__name">
                                                <iaixsl:choose>
                                                    <iaixsl:when test="page/projector/products_associated_zone4/@name"><iaixsl:value-of select="page/projector/products_associated_zone4/@name"/></iaixsl:when>
                                                    <iaixsl:otherwise>Produkty kupione z tym produktem</iaixsl:otherwise>
                                                </iaixsl:choose>
                                            </span>
                                    ...
                                    <iaixsl:otherwise>
                                        <span class="headline">
                                            <span class="headline__name">
                                                <iaixsl:choose>
                                                    <iaixsl:when test="page/projector/products_associated_zone4/@name">
                                                    <!-- <iaixsl:value-of select="page/projector/products_associated_zone4/@name"/> -->
                                                    </iaixsl:when>
                                                    <iaixsl:otherwise>Produkty kupione z tym produktem</iaixsl:otherwise>
                                                </iaixsl:choose>
                                            </span>
                            ...
                            <div class="products d-flex flex-wrap justify-content-center">
                                <iaixsl:for-each select="page/projector/products_associated_zone4/*">
