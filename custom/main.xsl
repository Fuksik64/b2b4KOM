...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 107421.1)-->
            ...
            <iaixsl:if test="(action/set_render/item/@name = 'popup') or not(action/set_render/item)">
                ...
                <head>
                    ...
                    <link rel="preload" as="script" href="/data/include/cms/b2b4kom/JS/loader.js"   />
                    <link rel="stylesheet"> 
...
<header>
    ...
    <div class="categories-wrapper-ul2 ">
        ...
        <!--Strona główna (main, 106486.1)-->
                <iaixsl:if test="page/hotspot/products_zone1 and not(/shop/basket/@login != '')">
        ...
        <!--Buttony strefa 2 na stronie głównej (main_buttons2, 106484.1)-->
            ...
            <!--Hotspot na stronie głównej - strefa 4 (main_hotspot_zone4, 111148.1)-->
                ...
                <iaixsl:if test="page/hotspot/products_zone3 and (/shop/basket/@login != '')">
                ...
                <iaixsl:if test="/shop/page/hotspot/products_zone3/@cache_html"> </iaixsl:if>
                    ...
                    <div class="banners-featured-4 row col-12 mx-auto px-0">
            ...
            <iaixsl:if test="page/mainpage1">
            <h2 class="big_label custom-label actual-label">
            <span>
            Aktualności
            </span>
            </h2>
            <a class="d-flex justify-content-end m-0 show-more-actual">
                <iaixsl:attribute name="href">
                    <iaixsl:value-of select="page/mainpage1/@link"/>    
                </iaixsl:attribute>            
            <span>
            pokaż więcej 
            </span>
            ...
            <ul class="col-12 actual-slider px-0">
                ...
                <a>
                <iaixsl:attribute name="href">
                <iaixsl:value-of select="more/@href"/>
                </iaixsl:attribute>
                <h4><iaixsl:value-of select="title" disable-output-ecaping="yes"/></h4>
                </a>
                <p><iaixsl:value-of select="description" disable-output-escaping="yes"/></p>
                <div class="actual-text-add-info">
                    <span class="date">
                    <iaixsl:value-of select="date" disable-output-escaping="yes"/>
                    </span>
                </div>
                </div>
                ...
                <iaixsl:if test="page/hotspot/products_zone2 and not(/shop/basket/@login != '')">
        ...
        <!--Hotspot na stronie głównej - strefa 2 (main_hotspot_zone2, 111122.1)-->
                ...
                <iaixsl:if test="page/hotspot/products_zone4 and (/shop/basket/@login != '')">
        ...
        <h2 class="big_label custom-label">
            ...
            <iaixsl:if test="/shop/commercial_button">
                <iaixsl:for-each select="/shop/commercial_button/link">
                    ...
                    <ul class="producents-main-slider">
                    <iaixsl:if test="(html/@title='Producenci')">
                    <iaixsl:value-of select="html" disable-output-escaping="yes" />
                    </iaixsl:if>
                    </ul>
                </iaixsl:for-each>
    ...
    <iaixsl:if test="page/@type = 'blog-item'">
      <script type="application/ld+json">
        ...
        <!--Elementy dodawane dynamicznie (menu_dynamically_added_content, 106830.1)-->
            ...
            <script src="/data/include/cms/b2b4kom/JS/main/mainSliders.js" >
                <iaixsl:attribute name="defer"></iaixsl:attribute>
                <iaixsl:attribute name="type">module</iaixsl:attribute>
