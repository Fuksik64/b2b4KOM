...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 107421.1)-->
            ...
            <iaixsl:if test="(action/set_render/item/@name = 'popup') or not(action/set_render/item)">
                ...
                <script src="/gfx/pol/contact_address.js.gzip?r=1600678639"></script></head>
...
<div class="categories-wrapper-ul2 ">
         ...
         <div class="contact-mobile-text">
                    ...
                    <p><i class="icon-envelope"></i><a href="mailto:sklep@4kom.pl">hurt@4kom.pl</a></p>
                        </div>
         </div>
         <div>
...
<div class="col-3-height">
        ...
        <iaixsl:variable name="contact_mobile_label">Zadzwoń lub napisz do nas</iaixsl:variable>
        ...
        <div class="row my-3">
            ...
            <div id="contact_address" class="col-md-6 col-12 col-contact">
            ...
            <div class="contact_address_sub">
                        ...
                        <div class="contact_data_address"> 
                            <div class="contact_data_address_sub">
                                ...
                                <iaixsl:if test="/shop/page/contact/owner_data/@zipcode or /shop/page/contact/owner_data/@city">
                                    ...
                                    <p id="contact_address_city"><iaixsl:value-of select="/shop/page/contact/owner_data/@zipcode"/><iaixsl:text> </iaixsl:text><iaixsl:value-of select="/shop/page/contact/owner_data/@city"/>
                                    
                                    
                                    <iaixsl:if test="/shop/page/contact/owner_data/@country">
                                     (<iaixsl:value-of select="/shop/page/contact/owner_data/@country"/>)
                                     </iaixsl:if>
                ...
                <div>
                    ...
                    <div class="mt-2 nip-regon">
                    <iaixsl:for-each select="/shop/page/contact/additional_nodes/node">
                         <iaixsl:if test="@type = 'nip'">
                         <p>
                    ...
                    <h3 class="mt-2">Dane płatnicze:
                    </h3>
                    <div class="bank-details">
                      <iaixsl:for-each select="/shop/page/contact/additional_nodes/node">
                         <iaixsl:if test="@type = 'reqAccount'">
                         <p>
                         <!-- <iaixsl:value-of select="@title"/>:  -->
                         Konto: 
                         <span>
            ...
            <div id="contact_contact" class="col-md-6 col-12 col-contact">
            <h2>
            ...
            <div class="contact_contact_sub">   
                <div class="contact_contact_phone">
                    ...
                    <iaixsl:if test="@title = 'Tel'">
                    <strong>
                    Obsługa kientów hurtowych
                    </strong>
                    </iaixsl:if>
                    <iaixsl:if test="@title = 'E-mail'">
                    <strong>
                    E-mail:
                    </strong>
                    </iaixsl:if>
                        <p>
                            <iaixsl:if test="@title and not(@title = '')">
                            <iaixsl:choose>
                                <iaixsl:when test="@title = 'Tel'">
                                    <i class="icon-phone"></i>
                                    <span><iaixsl:value-of select="@title"/>.: </span>
                                </iaixsl:when>
                                <iaixsl:when test="@title = 'E-mail'">
                ...
                <div class="contact_contact_firm d-none">
                    <iaixsl:if test="/shop/page/contact/shop_data/@shopname">
                        <p>
                        <strong>Pełna nazwa: </strong>
                ...
                <div class="contact-avaibility-info mt-2">
        ...
        <!--Dane adresowe na stronie Kontakt (contact_address, 112677.1)-->
                        ...
                        <div class="loadingMap">
                            <div class="loadingContent">
                                <div class="loadingBox">
                                    ...
                                    <span class="loadingAdres">Szukanie adresu</span>
                                    <img class="loadingMapImg" src="/gfx/pol/mapLoader.gif?r=1600678639" alt=""/>
                                </div>
                            </div>
                        </div>
                        <img class="marker_face" src="/gfx/pol/marker_face.png?r=1600678639" alt=""/>
            ...
            <iaixsl:if test="not(/shop/page/contact/google_api_key/@value) and (/shop/page/contact/shop_data/@street or /shop/page/contact/shop_data/@zipcode or /shop/page/contact/shop_data/@city)">
                <section class="row map-row">
                        ...
                        <div class="map-pink-background">
                       
                        </div>
                        <div class="map-pink-text">
                        <h3 class="mb-3">Hurtownia 4KOM</h3>
                        <h3 >Adres</h3>
                        <p>ul Zamkowa 4</p>
                        <p>95-200 Pabianice</p>
                        <h3 class="mt-3">Godziny otwarcia:</h3>
            ...
            <div id="stocks_contact4" class="row">
                <div class="col-12">
                    ...
                    <a href="/stock.php" class="btn --solid --medium">Zobacz nasze sklepy</a>
                </div>
            </div>
