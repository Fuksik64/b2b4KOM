...
<div class="col-3-height">
        ...
        <div class="row mt-3 producers-custom-row">
            <div class="4kom-column col-12 col-md-4">
                <h2 class="big_label">
                4kom.pl
                </h2>
                <div class="4kom-info-producers">
                <p>
                    <p class="mb-2">Firma 4Kom specjalizuje się w internetowej sprzedaży akcesoriów GSM
                    </p>
                    <p>
                    Na rynku nieprzerwanie działamy od 2013 roku. Jesteśmy znanym dystrybutorem produktów największych marek z zakresu akcesoriów GSM. Nasza oferta liczy ponad 40 tysięcy produktów i stale poszerzana jest o najnowsze trendy.
                    </p>
                </p>
                </div>
            </div>

            <div id="producers-list" class="col-12 col-md-8">
            <h2 class="big_label">
                Producenci
            </h2>
            ...
            <div id="producers-list_sub" class="row m-0">
		        <iaixsl:for-each select="page/producers-list/firm">
                    <a class="col-md-3 col-sm-3 col-3 producers-list_item">
                        ...
                        <small>
                             (produktów: 
                            <iaixsl:value-of select="@products"/>)
                        </small> -->
                    </a>
		        </iaixsl:for-each>
                </div>
                <a  id="showMoreProducers" class="button-producers">
                Pokaż
                <i class="icon-chevron-right"></i>
                </a>
                </div>
    ...
    <iaixsl:if test="page/@type = 'blog-item'">
      <script type="application/ld+json">
        ...
        <!--Elementy dodawane dynamicznie (menu_dynamically_added_content, 106830.1)-->
            ...
            <script src="/data/include/cms/b2b4kom/JS/producers/producersShowMore.js">
                <iaixsl:attribute name="defer"></iaixsl:attribute>
                <iaixsl:attribute name="type">module</iaixsl:attribute>
             </script>
