                  ...
                  <iaixsl:attribute name="class">basketedit_productslist <iaixsl:if test="not(/shop/page/basket-details/product/size/@type != 'uniw')">nosizesbasket </iaixsl:if><iaixsl:if test="not(/shop/basket/@product_comment_active = 'y')">nocommentbasket</iaixsl:if></iaixsl:attribute>
										...
										<iaixsl:choose>
												...
												<table>
													...
													<iaixsl:for-each select="/shop/page/basket-details/product[not(preceding-sibling::product/@id=@id)]">
															...
															<tr class="productslist_item">
																	...
																	<td class="productslist_product_sum">
																			...
																			<iaixsl:choose>
																					...
																					<iaixsl:otherwise>
                                                                                            ...
                                                                                            <iaixsl:otherwise>
																							<span class="unit_price_basket_custom">
                                                                                                    <span>za sztukę: </span>
																									<iaixsl:value-of select="price/@price_net_formatted"/>
																									<small> netto</small>
																							</span>
                                                                    ...
                                                                    <!-- <td class="basket-edit-remove-link">
                                                                    <a>
											...
											<iaixsl:otherwise>
												...
												<h2>
														Dostępne za <strong class="basket__division_weeks"/><i class="icon-clock"/>
												</h2>
											...
											<div class="basket__division_option --not-divide">
												<div class="basket__division_group f-group --radio mb-0">
													...
													<label class="f-label basket__division_label" for="division_no"><strong>Poczekam na skompletowanie zamówienia.</strong><span class="basket__division_option_small d-block mt-1">Sklep skompletuje i wyśle na raz wszystkie produkty z zamówienia.</span>
														<div class="basket__division_option_info --not-divide mt-3 pt-2">Produkty z dłuższym czasemm oczekiwania - gotowe do wysłania za <strong class="basket__division_weeks"/></div>
													</label>
												</div>
											</div>
    ...
    <div class="span-rabbate-code col-12 col-sm-6 col-md-12">
                        ...
                        <div class="basketedit_summary_left">
                            ...
                            <iaixsl:if test="/shop/client_data/client_balance/limit/@value > '0'">
                                <div class="basketedit_limit_section">
                                    <div class="basketedit_product_summary limit-kupiecki">
                                        <label>
                                            Limit zadłużenia:
                                        </label>
                                    ...
                                    <div class="basketedit_product_summary limit-kredytowy">
                                        <label>
                                            ...
                                            <iaixsl:for-each select="/shop/page/basket-details/summary/payment/instalment">
                                                <a class="instalment_payment_basket__element --link">
                                                    ...
                                                    <div class="instalment_payment_basket__img_container">
                                                        <img src="/gfx/pol/instalment_basket.svg?r=1600678639" class="instalment_payment_basket__img"/>
                                                    </div>
                ...
                <div class="basketedit_summary_buttons table_display summary_buttons">
                    ...
                    <div class="btn_wrapper d-sm-none">
                        <a class="btn --solid --large --icon-right icon-angle-right n53706_button1" href="/order1.php" id="basket_go_next_phone">
                            ...
                            Przejdź dalej <i class="icon-chevron-right"></i>
                        </a>
                    </div>
            ...
            <div id="menu_security_policy" class="menu_box">
                <iaixsl:choose>
                    ...
                    <iaixsl:otherwise>
                        ...
                        <div class="menu_sub_box">
                            <img src="/gfx/pol/iai_security.png?r=1600678639" alt="Idosell security badge"/>
        ...
        <!-- !CUSTOM -->
                ...
                <iaixsl:if test="page/hotspot/products_zone2">
                    <section id="basketedit_hotspot_zone2" class="hotspot --slider mb-5">
                        
                        <iaixsl:variable name="headline_after_basketedit_hotspot_zone2"></iaixsl:variable>
                        ...
                        <iaixsl:choose>
                                ...
                                <iaixsl:choose>
                                    <iaixsl:when test="page/hotspot/products_zone2/@link">
                                        <a class="headline">
                                            ...
                                            <iaixsl:if test="$headline_after_basketedit_hotspot_zone2">
                                                <span class="headline__after"><iaixsl:value-of select="$headline_after_basketedit_hotspot_zone2"/></span>
                                            </iaixsl:if>
                                        </a>
                                    </iaixsl:when>
                                    <iaixsl:otherwise>
                            ...
                            <div class="products d-flex flex-wrap">
                                <iaixsl:for-each select="page/hotspot/products_zone2/*">
                                    ...
                                    <iaixsl:variable name="var_b2b"></iaixsl:variable>
                                    ...
                                    <div class="product col-6 col-sm-3 py-3">
                                        ...
                                        <a class="product__icon d-flex justify-content-center align-items-center">
                                            ...
                                            <img src="/gfx/pol/loader.gif?r=1611137966" class="b-lazy">
