...
<div class="categories-wrapper-ul2 ">
         ...
         <p>Obsługa sklepu dostępna jest od poniedziałku do piątku, w godzinach 8:00 - 16:00
                ...
                <div id="layout">
                    ...
                    <div class="row  mb-3 col-12 menu_not_main_wrapper">
...
<div class="col-3-height">
    ...
    <!--Błędy i informacje w projektorze (menu_messages, 106608.1)-->
        ...
        <!--CMS - Formularz logowania (signin_cms, 107646.1)-->
            <iaixsl:if test="page/text/body">
                <div class="signin_cms">
                    <div class="signin_cms_sub cm mb-4">
        ...
        <iaixsl:variable name="social_media_name">
            <iaixsl:value-of select="/shop/login_options/service[@id = /shop/client_data/@last_login_option]/@name"/>
        </iaixsl:variable>
            ...
            <div id="signin-form_box_left" class="signin-form_box col-md-8 col-sm-7 col-12">
                    ...
                    <iaixsl:when test="not(/shop/client_data/@signin = 'cookie') and /shop/client_data/@iai_accounts = 'consent' and (not(/shop/client_data/@last_login_option = 'shop'))">
                        ...
                        <div id="cookie_login_social" class="iai_accounts">
                            <span id="cookie_login_social_desc" class="iai_accounts">
                                Zaloguj się z <strong>IAI Accounts</strong> przez 
                                <iaixsl:value-of select="$social_media_name"/>
                                , a Twoje dane do wysyłki zostaną uzupełnione automatycznie na podstawie poprzednich zamówień.
                            </span>
                            ...
                            <span id="cookie_login_social_desc">
                                <iaixsl:choose>
                                    <iaixsl:when test="not(/shop/client_data/@iai_accounts = 'consent')">
                                        <strong>Jesteś już naszym klientem. </strong>
                                        Zaloguj się ponownie przez 
                                        <iaixsl:value-of select="$social_media_name"/>
                                        , abyśmy mieli pewność że to Ty. 
                                    </iaixsl:when>
                                    <iaixsl:otherwise>
                                        <iaixsl:attribute name="class">iai_accounts</iaixsl:attribute>
                                        Zaloguj się z <strong>IAI Accounts</strong> przez 
                                ...
                                <div id="client_new_social">
                                    ...
                                    <div class="client_new_social_sub">
                                        ...
                                        <iaixsl:if test="not(page/client-data/@allow_register = 'false')">
                                            <p> Jeżeli posiadasz konto w jednym z poniższych serwisów, możesz je wykorzystać do utworzenia konta  i późniejszego logowania.<br/><br/> <b>Jeżeli posiadasz już wcześniej założone konto</b> możesz je dla własnej wygody połączyć z logowaniem ze swojego ulubionego serwisu. Aby to zrobić, najpierw zaloguj się, a następnie przejdź do edycji swoich danych gdzie znajdziesz odpowiednie narzędzie do połączenia konta.</p>
                                        </iaixsl:if>
                ...
                <div class="signin-form_box_sub" id="signin-form_box_sub_1">
                    <div class="signin-form_select">
                        <h3>Zaloguj mnie przez</h3>
                        <input id="signin-form_radio1" type="radio" value="signin-form_box_sub_1" checked="checked" name="login_form1" data-target="login_form2"/><label for="signin-form_radio1">login i hasło</label>
                        <input id="signin-form_radio2" type="radio" value="signin-form_box_sub_2" name="email_form1" data-target="email_form2"/><label for="signin-form_radio2">przypomnij hasło</label>
                    </div>
                    ...
                    <form action="/signin.php" method="post" novalidate="novalidate">
                        ...
                        <div class="signin_buttons col-md-10 col-12">
                            ...
                            <iaixsl:if test="/shop/client_data/@signin = 'cookie'">
                                <a class="cookie_login_social_new_account" href="/client-new.php?register&amp;wholesaler=true">To nie jest moje konto i chcę założyć nowe</a>
                            </iaixsl:if>
                            <iaixsl:if test="/shop/client_data/@signin = 'cookie' and not(/shop/client_data/@last_login_option = 'shop') and count(login_options/service[not(@name = $social_media_name)]) > 0">
                                <a class="cookie_login_social_more_social" href="#more_social">Zaloguj się kontem z innego serwisu</a>
                            </iaixsl:if>
                        </div>
                    </form>
                ...
                <div class="signin-form_box_sub" id="signin-form_box_sub_2">
                    <p class="reminder_desc">Na Twój adres zostanie wysłany e-mail, który pozwala na automatyczne zalogowanie się. Zmiana hasła będzie możliwa po zalogowaniu na stronie edycji Twoich danych.</p>

                    <div class="signin-form_select">
                        <h3>Zaloguj mnie przez</h3>
                        <input id="signin-form_radio3" type="radio" value="signin-form_box_sub_1" name="login_form2" data-target="login_form1"/><label for="signin-form_radio3">login i hasło</label>
                        <input id="signin-form_radio4" type="radio" value="signin-form_box_sub_2" name="email_form2" data-target="email_form1" checked="checked"/><label for="signin-form_radio4">przypomnij hasło</label>
                    </div>
                        ...
                        <div class="signin_inputs col-md-10 col-12">
                            <div class="form-group">
                                <div class="has-feedback">
                                    ...
                                    <label for="user_mail_recover" class="control-label">Adres e-mail</label>
                                    <span class="form-control-feedback"/>
                                </div>
                                <div class="form-desc">
                            ...
                            <div class="signin_buttons col-md-10 col-12">
                                ...
                                <a class="password_back_signin" href="#signin-form_radio1">Wróć do standardowego logowania</a>
                            </div>
                        </div>
                    </form>
                </div>
