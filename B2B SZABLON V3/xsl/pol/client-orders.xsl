                ...
                <iaixsl:choose>
                    <iaixsl:when test="page/orders/@mode = 'rma'">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
                            <h1 class="big_label">
                                Wybierz zamówienie, z którego chcesz reklamować produkt
                            </h1>
                        </div>
                    </iaixsl:when>
                    <iaixsl:when test="page/orders/@mode = 'returns'">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
                            <h1 class="big_label">
                                Wybierz zamówienie, z którego chcesz zwrócić produkty
                            </h1>
                        </div>
                    </iaixsl:when>
                    <iaixsl:when test="page/orders/@mode = 'closed'">
                        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
                            <h1 class="big_label">
                                Zamówienia zrealizowane i anulowane
                            </h1>
                            <a href="client-orders.php?display=opened" class="btn --solid --medium mt-2">
                                ...
                                Lista aktualnie realizowanych zamówień
                            </a>
                        </div>
                    </iaixsl:when>
                    <iaixsl:otherwise>
                ...
                <iaixsl:choose>
                                ...
                                <table class="orders" cellspacing="0" cellpadding="0"  id="rebates">
                                    <tr>
                                        <td colspan="3" class="headerek" id="rabat_header">
                                            Łączna wartość zrealizowanych zamówień
                                            ...
                                            <td>
                                                <iaixsl:choose>
                                                    ...
                                                    <iaixsl:when test="@paymentstatus = 'g' and (@paid and (number(@cost) > number(@paid)))">
                                                        ...
                                                        opłać pozostałą kwotę przy odbiorze<br/>
                                                                ...
                                                                <iaixsl:when test="@prepaid > 0">
                                                                    ...
                                                                    <iaixsl:choose>
                                                                        ...
                                                                        <iaixsl:when test="@prepaidstatus ='c'">
                                                                            oczekuje na odblokowanie wpłaty
                                                                        </iaixsl:when>
                                            ...
                                            <div><iaixsl:attribute name="class">btn-icon prepaid-icon status-<iaixsl:value-of select="$status_order"/></iaixsl:attribute>
                                                <iaixsl:choose>
                                                    ...
                                                    <iaixsl:when test="$status_order = 't'">
                                                        <span><i class="icon-ok"></i></span>
                                                        <small><iaixsl:choose><iaixsl:when test="@personal_collection = 'yes'">odebrane</iaixsl:when><iaixsl:otherwise>wysłane</iaixsl:otherwise></iaixsl:choose></small>
                                                    </iaixsl:when>
                                                    ...
                                                    <iaixsl:when test="$status_order = 'o'">
                                                        <span><i class="icon-clock"></i></span>
                                                        <small>realizowane</small>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="$status_order = 'p'">
                                                        <span><i class="icon-ok"></i></span>
                                                        <small>gotowe do wysłania / odbioru</small>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="$status_order = 'i'">
                                                        <span><i class="icon-remove"></i></span>
                                                        <small>odrzucone</small>
                                                    </iaixsl:when>
                                        ...
                                        <td>
                                            <iaixsl:choose>
                                                <iaixsl:when test="@returns_url">
                                                    <a class="btn --icon-left icon-plus --medium see_button pr-0"><iaixsl:attribute name="href"><iaixsl:value-of select="@returns_url"/></iaixsl:attribute><span><i class='icon-plus'></i></span><small>Wybierz</small></a>
                                                </iaixsl:when>
                                                <iaixsl:when test="@rma_url">
                                                    <a class="btn --icon-left icon-plus --medium see_button pr-0"><iaixsl:attribute name="href"><iaixsl:value-of select="@rma_url"/></iaixsl:attribute><span><i class='icon-plus'></i></span><small>Wybierz</small></a>
                                                </iaixsl:when>
                                                <iaixsl:otherwise>
                                                    <a class="btn --icon-left icon-plus --medium see_button pr-0"><iaixsl:attribute name="href"><iaixsl:value-of select="@orderdetails"/></iaixsl:attribute><span><i class='icon-plus'></i></span><small>Zobacz</small></a>
                                                </iaixsl:otherwise>
                                            </iaixsl:choose>
                                        </td>
                                    </tr>
                    ...
                    <iaixsl:otherwise>
                        <div class="client_orders_null">
                            <iaixsl:choose>
                                <iaixsl:when test="page/orders/@mode = 'rma'">
                                    Obecnie nie masz zamówień, które mogą podlegać reklamacji.
                                </iaixsl:when>
                                <iaixsl:when test="page/orders/@mode = 'returns'">
                                    Obecnie nie masz zamówień, które mogą podlegać zwrotowi.
                                </iaixsl:when>
                                <iaixsl:when test="page/orders/@mode = 'closed'">
                                    Obecnie nie masz zrealizowanych zamówień.
                                </iaixsl:when>
                                <iaixsl:otherwise>
                                    Obecnie nie masz zamówień w trakcie realizacji.
                                </iaixsl:otherwise>
                            </iaixsl:choose>
                        </div>
