...
<script src="/gfx/pol/orderdetails_payments.js.gzip?r=1612960004"></script>
                            </iaixsl:when>
                            <iaixsl:otherwise>
    ...
    <!--Informacje o zamówieniu (orderdetails_info, 114646.1)-->
						...
						<div class="orderdetails_summary_price">
							...
							<iaixsl:if test="page/prepaid/details/@deliveryid != '47'">
								<div class="orderdetails_total_summary">
									...
									<strong id="currencytotal_prepaid"><iaixsl:value-of select="page/prepaid/details/@currencytotal_formatted"/> brutto</strong>
									<iaixsl:if test="/shop/page/prepaid/points/@display">
										<span>
											 + 
														...
														<div class="row">
																<div class="credit_card_pci_dss col-12">
																		...
																		<span class="pci_dss_icon_container">
																				<img src="/gfx/pol/pci_css_logo.png?r=1612960004" alt="PCI DSS Compilant"/>
																		</span>
																</div>
														</div>
												</form>
        ...
        <div id="prepaid_delivery_list">
            ...
            <table>
                ...
                <tr>
                    <td class="ordered-icon">
                        <img src="/gfx/pol/shipping_icon.png?r=1612960004">
                    ...
                    <iaixsl:when test="/shop/page/prepaid/prepaid_history/item/@status = 'n'">
                        <iaixsl:for-each select="/shop/page/prepaid/prepaid_history/item[@status = 'n']">
                            <tr class="payment_form_item">
                                <td class="ordered-icon">
                                    <img src="/gfx/pol/prepaid_method_icon.png?r=1612960004">
                                        <iaixsl:if test="@icon">
                                            <iaixsl:attribute name="src"><iaixsl:value-of select="@icon"/></iaixsl:attribute>
                                        </iaixsl:if>
                                        <iaixsl:attribute name="alt"><iaixsl:value-of select="@payment_name"/></iaixsl:attribute>
                ...
                <iaixsl:if test="/shop/page/insurance_product">
                    ...
                    <tr>
                        <td class="ordered-icon">
                            <img src="/gfx/pol/insurance_icon.png?r=1612960004" alt="insurance_icon"/>
                        </td>
                        <td class="ordered-name">
                            Ochrona Kupującego: 
            ...
            <iaixsl:if test="$prepaidrt_txt and /shop/page/prepaid/actions/return/@url">
                <div class="actions_return col-12 col-sm-6">
                    <div class="actions_return_sub col-12 mb-4">
                        ...
                        <div>
                            <img alt="returns" src="/gfx/pol/returns_action.png?r=1612960004"/><span>Jeżeli chcesz skorzystać z prawa do zwrotu zakupionych produktów bez podania przyczyny - skorzystaj z naszego systemu do zwrotów, który uczyni proces prostym i bezpiecznym.</span></div>
                            <a class="btn --solid">
            ...
            <iaixsl:if test="$prepaidzt_txt and /shop/page/prepaid/actions/rma/@url">
                <div class="actions_rma col-12 col-sm-6">
                    <div class="actions_rma_sub col-12">
                        ...
                        <div>
                            <img alt="rma" src="/gfx/pol/rma_action.png?r=1612960004"/><span>Jeżeli produkt w momencie dostawy był sprawny, ale popsuł się i chcesz zgłosić reklamację z tytułu gwarancji poprzez nasz sklep, skorzystaj z naszego systemu zgłaszania reklamacji, co uczyni proces łatwiejszym i szybszym.</span></div>
                            <a class="btn --solid">
...
<script src="/gfx/pol/orderdetails_payments.js.gzip?r=1612960004"></script>
            ...
            <script src="/gfx/pol/prepaid_order_products.js.gzip?r=1612960004"></script>
            <script>
                app_shop.runApp();
            </script>
