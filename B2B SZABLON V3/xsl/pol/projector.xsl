...
<iaixsl:if test="/shop/page/@cache_basket"/>
    ...
    <!--Nazwa produktu na karcie (projector_productname, 111557.1)-->
		...
		<!--Dokładne dane o produkcie (projector_details, 113285.1)-->
            ...
            <iaixsl:variable name="brutto_bundle_txt"> wybranych produktów netto </iaixsl:variable>
                    ...
                    <div id="projector_prices_wrapper">
                        ...
                        <iaixsl:if test="$advanceprice_txt and page/projector/product/price/@advanceprice_net_formatted">
                            <div id="projector_advanceprice_wrapper">
                                <iaixsl:value-of disable-output-escaping="yes" select="$advanceprice_txt"/><b id="projector_advanceprice"><iaixsl:value-of select="page/projector/product/price/@advanceprice_net_formatted"/></b>. Dokładne informacje zostaną podane w podsumowaniu zamówienia, przed jego złożeniem.
                            </div>
                        </iaixsl:if>
                    </div>
											...
											<div class="product__prices ml-md-auto flex-md-row align-items-md-center">
												<iaixsl:choose>
													<iaixsl:when test="price/@value > 0">
														...
														<div class="product__promo_info_wrapper">
															<span class="product__promo_info">Taniej w kolekcji o <iaixsl:value-of select="bundle_price/@percent_diff"/>%</span>
														</div>
													</iaixsl:when>
													<iaixsl:otherwise>
														<a class="price --phone">
...
<!--Menu powiadomienia (menu_notice, 107640.1)-->
        ...
        <!--Elementy dodawane dynamicznie (menu_dynamically_added_content, 106830.1)-->
            ...
            <script src="/gfx/pol/menu_alert.js.gzip?r=1612960004"></script>
            <script src="/gfx/pol/projector_photos.js.gzip?r=1612960004"></script><script src="/gfx/pol/projector_details.js.gzip?r=1612960004"></script><script src="/gfx/pol/projector_bundle_zone.js.gzip?r=1612960004"></script><script src="/gfx/pol/projector_banner.js.gzip?r=1612960004"></script><script src="/gfx/pol/projector_projector_opinons_form.js.gzip?r=1612960004"></script>
            <script>
                app_shop.runApp();
            </script>
