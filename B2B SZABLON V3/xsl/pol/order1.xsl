...
<iaixsl:if test="/shop/page/@cache_basket"/>
   ...
   <!--Wybór sposobu dostawy i płatności (order1, 117025.1)-->
    <iaixsl:variable name="idoPay"></iaixsl:variable>
                  ...
                  <iaixsl:for-each select="/shop/page/order1/groupList/item">
                    ...
                    <iaixsl:if test="count(/shop/page/order1/prepaid_methods/item[@group = $groupID][not(@single_group_payment_method = 'true')]) > 0">
                      <div class="order__payments_group f-group --radio mb-0 px-2  px-sm-3">
                        ...
                        <iaixsl:if test="(/shop/page/order1/prepaid_methods/item[@id='44'][@system_id='29'] or /shop/page/order1/prepaid_methods/item[@id='45'][@system_id='29']) and $idoPay != '' and @id = 'card' and count(/shop/page/order1/prepaid_methods/item[@group='card'][not(@system_id='29')]) = 0">
                            <iaixsl:attribute name="system-id">29</iaixsl:attribute>
                        </iaixsl:if>
                        <iaixsl:if test="not(/shop/page/order1/balance/@active='y' and /shop/page/order1/balance/@onlyPrepaid='y')">
                        ...
                        <label class="order__payments_label f-label d-flex align-items-center pr-0 py-2">
                          ...
                          <span class="order__payments_sub d-flex flex-row align-items-center justify-content-end">
                            <span class="order__payments_icons d-flex justify-content-end flex-wrap align-items-center">
                              <iaixsl:choose>
                                <iaixsl:when test="(/shop/page/order1/prepaid_methods/item[@id='44'][@system_id='29'] or /shop/page/order1/prepaid_methods/item[@id='45'][@system_id='29']) and $idoPay != '' and @id = 'card' and count(/shop/page/order1/prepaid_methods/item[@group='card'][not(@system_id='29')]) = 0">
                                  <iaixsl:for-each select="/shop/page/order1/prepaid_methods/item[@id='44' or @id='45']">
                                    <iaixsl:if test="@icon != ''">
                                      <div class="order__ingroup_payment_icon">
                                        <img><iaixsl:attribute name="src"><iaixsl:value-of select="@icon"/></iaixsl:attribute><iaixsl:attribute name="alt"><iaixsl:value-of select="@name"/></iaixsl:attribute></img>
                                      </div>
                                    </iaixsl:if>
                                  </iaixsl:for-each>
                                </iaixsl:when>
                                <iaixsl:when test="/shop/page/order1/prepaid_methods/item[@group = $groupID]/@checked = 'true' and not(/shop/page/order1/shipping/delivery[@type = 'dvp' and @checked = 'true'])">
                                  <iaixsl:if test="/shop/page/order1/prepaid_methods/item[@group = $groupID and @checked = 'true']/@icon != ''">
                                    <div class="order__ingroup_payment_icon">
                                      <img><iaixsl:attribute name="src"><iaixsl:value-of select="/shop/page/order1/prepaid_methods/item[@group = $groupID and @checked = 'true']/@icon"/></iaixsl:attribute><iaixsl:attribute name="alt"><iaixsl:value-of select="/shop/page/order1/prepaid_methods/item[@group = $groupID and @checked = 'true']/@name"/></iaixsl:attribute></img>
                                    </div>
                                  </iaixsl:if>
                                </iaixsl:when>
                                <iaixsl:otherwise>
                      ...
                      <label class="order__delivery_label f-label d-flex align-items-center pr-0 py-2">
                        ...
                        <span class="order__delivery_sub d-flex flex-column align-items-center justify-content-center flex-md-row">
                          ...
                          <span class="order__delivery_icons d-flex justify-content-end">
                            <iaixsl:choose>
                                <iaixsl:when test="@id = '93-1'">
                                    <img class="order__delivery_img" src="/gfx/pol/online_delivery.png?r=1612960004">
              ...
              <section class="order__delivery --division mb-3 mb-md-5">
                ...
                <div class="headline">
                  <span class="headline__name --prepaid">
                    ...
                    <span class="headline__name_txt">Opcje dostawy dla produktów dostępnych <span class="headline__division_literal">za </span></span>
                    <span class="headline__division_time">
                  ...
                  <span class="headline__name --dvp">
                    ...
                    <span class="headline__name_txt">Opcje dostawy za pobraniem dla produktów dostępnych <span class="headline__division_literal">za </span></span>
                    <span class="headline__division_time">
											<iaixsl:attribute name="data-weeks"><iaixsl:value-of select="/shop/basket/shipping_division_time/@week_amount"/></iaixsl:attribute>
											<iaixsl:attribute name="data-days"><iaixsl:value-of select="/shop/basket/shipping_division_time/@days"/></iaixsl:attribute>
											<iaixsl:attribute name="data-week_day"><iaixsl:value-of select="/shop/basket/shipping_division_time/@week_day"/></iaixsl:attribute>
                                        ...
                                        <iaixsl:when test="count(/shop/page/order1/stocks/stock) > 0">
                                          <iaixsl:for-each select="/shop/page/order1/stocks/stock[@selected = 'selected']">
                                            <iaixsl:choose>
                                              ...
                                              <iaixsl:otherwise>
                                                <iaixsl:choose>
                                                  <iaixsl:when test="(@pickup_days_division = 0) and (@pickup_hours_division = 0) and (@pickup_minutes_division = 0)">
                                                    Zamówienie będzie gotowe do odbioru natychmiast po przyjęciu zamówienia
                                                  </iaixsl:when>
                                                  <iaixsl:otherwise>
                                                    Przygotowanie do odbioru osobistego zajmie 
                                                    ...
                                                    <iaixsl:if test="@pickup_days_division > 0">
                                                      <iaixsl:value-of select="@pickup_days_division"/>
                                                      <iaixsl:choose>
                                                    ...
                                                    <iaixsl:if test="@pickup_hours_division > 0">
                                                      <iaixsl:value-of select="@pickup_hours_division"/>
                                                      <iaixsl:choose>
                                                    ...
                                                    <iaixsl:if test="@pickup_minutes_division > 0">
                                                      <iaixsl:value-of select="@pickup_minutes_division"/>
                                                       min
                                                    </iaixsl:if>
                                                  </iaixsl:otherwise>
                                                </iaixsl:choose>
			...
			<section class="summary --order1 p-2 p-md-0">
					...
					<div class="summary__sub --right">
						<div class="summary__calculations">
							...
							<div class="summary__calculation --active --worth">
								<span class="summary__calculation_label">Wartość zamówienia:</span>
				...
				<div class="summary__block --bottom d-flex flex-column flex-sm-row justify-content-sm-end align-items-sm-center p-md-3 flex-md-row">
					...
					<div class="summary__buttons">
						<a href="#order2" class="btn --solid --large --icon-right icon-angle-right summary__button">Przejdź dalej</a>
					</div>
				</div>
			</section>
...
<!--Menu powiadomienia (menu_notice, 107640.1)-->
        ...
        <!--Elementy dodawane dynamicznie (menu_dynamically_added_content, 106830.1)-->
            ...
            <script src="/gfx/pol/order1.js.gzip?r=1612960004"></script>
            <script>
                app_shop.runApp();
            </script>
