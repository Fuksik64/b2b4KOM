...
<iaixsl:if test="/shop/page/@cache_basket"/>
		...
		<iaixsl:variable name="news_list_see_more">Czytaj więcej</iaixsl:variable>
				...
				<section id="news_list" class="article mb-4">
					...
					<iaixsl:choose>
						...
						<iaixsl:when test="not(/shop/page/newslist/mainpage1)">
							<div class="menu_messages_message" id="menu_messages_warning">
								<div class="menu_messages_warning_sub">
									<p>W tej chwili nie ma żadnych aktualności.</p>
								</div>
							</div>
						</iaixsl:when>
						<iaixsl:otherwise>
        ...
        <!--Produkty powiązane (news_cms_associated, 111450.1)-->
            <iaixsl:if test="page/news/cms_products/product or page/news/cms_products/opinion">
                ...
                <section id="news_cms_associated" class="hotspot mb-5">
                    ...
                    <iaixsl:variable name="headline_after_news_cms_associated">Zobacz wszystkie</iaixsl:variable>
