        ...
        <!--Blog - Produkty powiązane (blog_item_associated, 111448.1)-->
            <iaixsl:if test="page/cms_products/product or page/cms_products/opinion">
                ...
                <section id="blog_item_associated" class="hotspot mb-5">
                    ...
                    <iaixsl:variable name="headline_after_blog_item_associated">Zobacz wszystkie</iaixsl:variable>
                    
                    <h2>
                        <iaixsl:choose>
                            <iaixsl:when test="page/cms_products/@link">
                                <a class="headline">
                                    <iaixsl:attribute name="href"><iaixsl:value-of select="page/cms_products/@link"/></iaixsl:attribute>
                                    <iaixsl:attribute name="title">Kliknij aby zobaczyć wszystkie produkty </iaixsl:attribute>

                                    <span class="headline__name">
                                        <iaixsl:choose>
                                            <iaixsl:when test="page/cms_products/@name"><iaixsl:value-of select="page/cms_products/@name"/></iaixsl:when>
                                            <iaixsl:otherwise>Polecane</iaixsl:otherwise>
                                        </iaixsl:choose>
                                    </span>
                                    <iaixsl:if test="$headline_after_blog_item_associated">
                                        <span class="headline__after"><iaixsl:value-of select="$headline_after_blog_item_associated"/></span>
                                    </iaixsl:if>
                                </a>
                            </iaixsl:when>
                            <iaixsl:otherwise>
                        ...
                        <iaixsl:for-each select="page/cms_products/*">
                            ...
                            <div class="product col-6 col-sm-4 py-3">
                                ...
                                <a class="product__icon d-flex justify-content-center align-items-center">
                                    ...
                                    <img src="/gfx/pol/loader.gif?r=1612960004" class="b-lazy">
                                            ...
                                            <iaixsl:choose>
                                                ...
                                                <iaixsl:otherwise>
                                                    <iaixsl:if test="$var_maxprice_net_formatted != ''">
                                                        ...
                                                        </del><iaixsl:value-of select="$var_net_prices"/>
                                                    </iaixsl:if>
                                                    <strong class="price">
