...
<iaixsl:if test="/shop/page/@cache_basket"/>
        ...
        <!--Agregator zbierania opinii (opinions_add_aggregator, 109124.1)-->
			<section id="opinion_order" class="opinion_order">
				<h2 class="headline">
					<span class="headline__name">Oceń zadowolenie z przebiegu zamówienia nr <iaixsl:value-of select="/shop/page/opinions/@order_id"/></span>
				</h2>
				<form class="opinion_order__form" action="/ajax/opinions.php?action=insert" method="POST">
					...
					<div class="note_wrapper">
						<span class="note_invitation">
							<span class="note_invitation_desktop">Będziemy Ci wdzięczni za ocenę, w skali od 1 (tragicznie) do 5 (bardzo dobrze i szybko), realizacji zamówienia. Prosimy o subiektywną, lecz sprawiedliwą ocenę, oceniającą to na co jako sklep mieliśmy faktycznie wpływ. Jeżeli oceniasz zamówienie na 1, 2 lub 3 gwiazdki, koniecznie prosimy o wpisanie uwag, abyśmy wiedzieli co poprawić podczas kolejnych zamówień.</span>
							<span class="note_invitation_mobile">Jak oceniasz obsługę Twojego zamówienia?</span>
						</span>
					...
					<div class="f-group">
						<div class="has-feedback">
							...
							<label class="f-label">Napisz swoją opinię o obsłudze zamówienia</label>
						...
						<iaixsl:if test="/shop/page/opinions/@order_sum_loyalty_points and not(/shop/page/opinions/@order_sum_loyalty_points = '')">
							<div class="opinions_points_sum">
								Za ocenę tego zamówienia możesz otrzymać łącznie 
								<strong>
									<iaixsl:choose>
					...
					<div class="f-button">
						<button class="btn --medium --solid" type="submit">Wyślij nam swoją opinię</button>
					</div>
				</form>
			</section>
			<section id="opinion_products" class="opinion_products">
				<h2 class="headline">
					<span class="headline__name">Poniżej możesz ocenić poszczególne produkty z zamówienia</span>
				</h2>
				<iaixsl:for-each select="/shop/page/opinions/opinions_products/opinion_product">
					<form class="opinion_products__form" action="/ajax/opinions.php?action=insert" method="POST">
							...
							<div class="opinion_products__block --opinion col-md-8">
								...
								<div class="f-group">
									<div class="has-feedback">
										...
										<label class="f-label">Napisz swoją opinię o produkcie</label>
								...
								<div class="opinion_products__photo d-md-flex">
									...
									<div class="f-button">
										<button class="btn --medium --solid" type="submit">Wyślij opinię</button>
									</div>
								</div>
							</div>
						</div>
						<iaixsl:if test="/shop/page/opinions/@product_sum_loyalty_points and not(/shop/page/opinions/@product_sum_loyalty_points = '')">
							<div class="opinions_points_sum">
								Za ocenę tego produktu możesz otrzymać łącznie 
								<strong>
									<iaixsl:choose>
...
<!--Menu powiadomienia (menu_notice, 107640.1)-->
        ...
        <!--Elementy dodawane dynamicznie (menu_dynamically_added_content, 106830.1)-->
            ...
            <script src="/gfx/pol/opinions_add_aggregator.js.gzip?r=1612960004"></script>
            <script>
                app_shop.runApp();
            </script>
