    ...
    <div id="affiliate_main_menu" class="row">
      ...
      <div class="affiliate_stats col-md-6 col-sm-12" id="affiliate_stats">
        <div class="affiliate_stats_sub col-md-12">
          ...
          <div><i><iaixsl:attribute name="class">icon-signal</iaixsl:attribute></i>Mierzenie skuteczności działalności poszczególnych partnerów. Narzędzie pokazuje efektywność działania wszystkich partnerów łącznie z możliwością sortowania.</div>
          ...
          <a class="btn --solid">
              ...
              <iaixsl:attribute name="title">Lista przekierowań do sklepu z Twojego polecenia</iaixsl:attribute>
          ...
          <a class="btn --solid">
              ...
              <iaixsl:attribute name="title">Lista zamówień złożonych przez klientów, którzy trafili do sklepu z Twojego polecenia</iaixsl:attribute>
              Zamówienia klientów
          </a>
          <a class="btn --solid">
              ...
              <iaixsl:attribute name="title">Lista klientów, którzy założyli konto po wejściu z Twojego polecenia</iaixsl:attribute>
              Lista klientów
          </a>
        ...
        <div class="affiliate_generator col-md-6 col-sm-12" id="affiliate_generator">
          <div class="affiliate_generator_sub col-md-12">
            ...
            <div><i><iaixsl:attribute name="class">icon-cog-alt</iaixsl:attribute></i>Możliwość przygotowania gotowych do użycia reklam (statyczne obrazki i flash). Panel umożliwia pobranie kodu HTML z przygotowanym linkiem afiliacyjnym.</div>
            ...
            <a class="btn --solid">
                ...
                <iaixsl:attribute name="title">Lista kodów promocyjnych</iaixsl:attribute>
                Kody promocyjne
            </a>
            ...
            <a class="btn --solid">
                ...
                <iaixsl:attribute name="title">Generator kodu HTML</iaixsl:attribute>
                Kod HTML
            </a>
            <a class="btn --solid">
                ...
                <iaixsl:attribute name="title">Generator kodu PHP</iaixsl:attribute>
                Kod PHP
            </a>
            <a class="btn --solid">
                ...
                <iaixsl:attribute name="title">Generator kodu JavaScript</iaixsl:attribute>
                Kod JavaScript
            </a>
          ...
          <div class="affiliate_calculations col-md-6 col-sm-12" id="affiliate_calculations">
            <div class="affiliate_calculations_sub col-md-12">
              ...
              <div><i><iaixsl:attribute name="class">icon-users</iaixsl:attribute></i>Narzędzie pozwala sprawdzić aktulany stan Twoich rozliczeń ze sklepem.</div>
              ...
              <a class="btn --solid">
                  ...
                  <iaixsl:attribute name="title">Rozliczenia przepływów na Twoim koncie partnerskim</iaixsl:attribute>
                  Rozliczenia
              </a>
            ...
            <div class="affiliate_calculations col-md-6 col-sm-12" id="affiliate_calculations">
              <div class="affiliate_calculations_sub col-md-12">
                ...
                <div><i><iaixsl:attribute name="class">icon-credit-card</iaixsl:attribute></i>Narzędzie pozwala na wypłaty lub wymiany zgromadzonych środków na bon produktowy.</div>
                ...
                <a class="btn --solid">
                    ...
                    <iaixsl:attribute name="title">Informacje o stanie konta partnerskiego, mechanizm wypłacania środków w postaci bonów produktowych i historia wypłat</iaixsl:attribute>
                    Środki do wykorzystania
                </a>
