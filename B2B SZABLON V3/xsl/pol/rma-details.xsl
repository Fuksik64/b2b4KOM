...
<iaixsl:if test="/shop/page/@cache_basket"/>
    ...
    <!--Rma szczegóły (rma_details_form, 116660.1)-->
        ...
        <iaixsl:variable name="n5_4atxt">Nadaj paczkę <small>Za nadanie nic dodatkowo nie płacisz</small></iaixsl:variable>
            ...
            <div class="step_confirmation">
                ...
                <div id="orderdetails_info" class="rma_orderdetails_info">
                    ...
                    <h2 class="big_label">
                        <span>Szczegóły reklamacji</span>
                        <span class="order-date">
                            Data wygenerowania reklamacji: <iaixsl:value-of select="page/details/@datetime"/>
                        </span>
                    </h2>
                        ...
                        <div class="prepaid-status">
                            <strong>
                                <iaixsl:choose>
                                    ...
                                    <iaixsl:when test="page/details/@status=4">
                                        Reklamacja rozpatrywana - Skierowano do testów
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=5">
                                        Reklamacja rozpatrywana - Produkt wysłany do producenta
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=6">
                                        Reklamacja rozpatrywana - Trwa naprawianie
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=7">
                                        Reklamacja rozpatrzona negatywnie - Nie stwierdzono usterki
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=8">
                                        Reklamacja rozpatrzona negatywnie - Wada spowodowana złą eksploatacją
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=9">
                                        Reklamacja rozpatrzona negatywnie - Przekroczono termin gwarancji
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=10">
                                        Reklamacja rozpatrzona pozytywnie - Zwrot pieniędzy - skierowanie do wypłaty
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=11">
                                        Reklamacja rozpatrzona pozytywnie - Zwrot pieniędzy - wypłata
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=12">
                                        Reklamacja rozpatrzona pozytywnie - Wymiana na nowy produkt
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=13">
                                        Reklamacja rozpatrzona pozytywnie - Wymiana produktu na inny
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=14">
                                        Reklamacja nie dotarła
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=15">
                                        Klient wygenerował reklamację
                                    </iaixsl:when>
                                    ...
                                    <iaixsl:when test="page/details/@status=17">
                                        Reklamacja anulowana
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=18">
                                        Reklamacja anulowana przez klienta
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=19">
                                        Reklamacja potwierdzona
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=20">
                                        Reklamacja nieobsłużona
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=21">
                                        Reklamacja odrzucona
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=22">
                                        Reklamacja odrzucona - Nie stwierdzono usterki
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=23">
                                        Reklamacja odrzucona - Przekroczono termin gwarancji
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=24">
                                        Reklamacja odrzucona - Wada spowodowana złą eksploatacją
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=25">
                                        Reklamacja rozpatrzona pozytywnie - Przesyłka zwrotna wysłana do klienta
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=26">
                                        Reklamacja rozpatrzona pozytywnie - Wysłano nowy produkt bez oczekiwania na pierwotny
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=27">
                                        Reklamacja rozpatrzona pozytywnie - Zmiana danych odbiorcy na dokumencie sprzedaży
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=28">
                                        Reklamacja rozpatrywana - Naprawa zakończona
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=29">
                                        Reklamacja rozpatrywana - Wymaga dodatkowych informacji od klienta
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=30">
                                        Reklamacja rozpatrzona negatywnie - Przesyłka zwrotna wysłana do klienta
                                    </iaixsl:when>
                                </iaixsl:choose>
                            </strong>
                            <small>Nr reklamacji: <iaixsl:value-of select="page/details/@id"/></small>
                        </div>

                        <div class="prepaid-buttons">
                            <iaixsl:if test="/shop/page/editlink/@url">
                                <a class="btn-icon prepaid-edit">
                                    <iaixsl:attribute name="title">Kliknij, aby przejść do edycji reklamacji.</iaixsl:attribute>
                                    <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/editlink/@url"/></iaixsl:attribute><i class="icon-pencil"></i><span>Zmień reklamację</span></a>
                            </iaixsl:if>
                            <iaixsl:if test="/shop/page/cancellink/@url">
                                <a class="btn-icon prepaid-cancel orderdetails_info_cancel">
                                    <iaixsl:attribute name="onclick">return confirm('Anulowanie reklamacji jest czynnością nieodwracalną. Aby kontynuować wciśnij przycisk "Anuluj reklamację".')</iaixsl:attribute>
                                    <iaixsl:attribute name="title">Anuluj reklamację</iaixsl:attribute>
                                    <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/cancellink/@url"/></iaixsl:attribute>
                                    <i class="icon-remove"></i><span>Anuluj reklamację</span>
                                </a>
                            </iaixsl:if>
                        </div>
                    </div>
                ...
                <iaixsl:choose>
                    ...
                    <iaixsl:when test="/shop/page/rma_method/@id='2' and $n5_4atxt">
                        <div class="return_image_i">
                            <div class="text-1a">Wydrukuj zgłoszenie reklamacji i etykiety</div>
                            <div class="text-2a">Przygotuj paczkę. Dołącz formularz reklamacji.</div>
                            <div class="text-3a">Nadaj paczkę <small>Za nadanie nic dodatkowo nie płacisz</small></div>
                            <img src="/gfx/pol/instukcja_zwrot2.png?r=1612960004" alt=""/>
                        </div>
                    </iaixsl:when>
                    <iaixsl:otherwise>
                        <div class="return_image_i">
                            <div class="text-1">Wydrukuj zgłoszenie reklamacji i etykiety</div>
                            <div class="text-2">Przygotuj paczkę. Dołącz formularz reklamacji.</div>
                            <div class="text-3">Przyklej etykietę na paczkę</div>
                            <div class="text-4">Nadaj paczkę</div>
                            <img src="/gfx/pol/instukcja_zwrot.png?r=1612960004" alt=""/>
                        </div>
                    </iaixsl:otherwise>
                </iaixsl:choose>
                    ...
                    <iaixsl:if test="/shop/page/documentlink/@url">
                        <div class="return_wrapper2">
                            <a class="btn --solid --large" target="blank">
                                ...
                                Wydrukuj zgłoszenie reklamacji
                ...
                <iaixsl:if test="/shop/page/rma_questions">
                    <div class="rma_questions">
                        <h2 class="big_label">
                            <span>Korespondencja dotycząca reklamacji</span>
                        </h2>
                            ...
                            <div class="rma_af_input">
                                ...
                                <div class="form-group clearfix row">
                                    <label for="comment" class="control-label">
                                        <iaixsl:attribute name="class">control-label col-lg-3 col-md-4 col-xs-12</iaixsl:attribute>
                                        <div class="rma_af_info">
                                            <strong>Dodaj wiadomość</strong>
                                            <span>Obsługa sklepu udzieli odpowiedzi w najkrótszym możliwym czasie.</span>
                                        </div>
                                    </label>
                                    <div>
                                        <iaixsl:attribute name="class">has-feedback has-required col-lg-9 col-md-8 col-xs-12</iaixsl:attribute>
                                ...
                                <div class="rma_af_buttons">
                                    <a class="btn --solid --large --secondary --icon-left icon-paperclip rma_attach_file">
                                        Załącz plik
                                    </a>

                                    <button class="btn --solid --large mb-1" type="submit">
                                        Wyślij
                                    </button>
        ...
        <iaixsl:if test="page/returnproducts/products/product">
            ...
            <div id="prepaid_order_products">
                <h2 class="big_label">Reklamowany produkt</h2>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5" class="rma-remarks">
                                        ...
                                        <div class="rma-remarks">
                                            <b class="rma-remarks">Opis usterki: </b>
        ...
        <div class="step7">
            ...
            <iaixsl:if test="/shop/page/pickup/name">
                <div class="returns_details_wrapper">
                    <h2 class="big_label">Adres punktu reklamacyjnego</h2>
                            ...
                            <div class="pickupl_return_one_sub">
                                <div class="pickupl_return_one_link">
                                    <a target="_blank" class="btn --solid">
                                        <iaixsl:attribute name="title">więcej informacji</iaixsl:attribute>
                                        <iaixsl:attribute name="href">
            ...
            <iaixsl:variable name="txt_54116_1">Dokumenty wystawione dla tej reklamacji</iaixsl:variable>
                        ...
                        <div class="basketedit_calculations">
                            <iaixsl:if test="/shop/page/costs/cost[@type='products']/@value_formatted">
                                <div class="basketedit_product_summary">
                                    <label>Wartość reklamowanego produktu: 
                                    </label>
            ...
            <div class="prepaid_summary_buttons">
                ...
                <iaixsl:if test="page/backlink_other/@url">
                    <a class="btn --solid --medium">
                        ...
                        Reklamuj inny produkt z tego zamówienia
                    </a>
                </iaixsl:if>
            </div>
        </iaixsl:if>
        ...
        <div id="menu_notice" style="display: none;">
            ...
            <h2>Anulowanie reklamacji</h2>
            <strong>
                Anulowanie reklamacji jest czynnością nieodwracalną. Aby kontynuować wciśnij przycisk anuluj reklamację.
            </strong>
