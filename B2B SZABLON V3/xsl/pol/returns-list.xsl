...
<div class="client_order">
    <h1 class="big_label">
        <span>Lista Twoich zwrotów</span>
    </h1>
    <iaixsl:choose>
        <iaixsl:when test="/shop/page/returns/item">
            <table class="orders" cellspacing="0" cellpadding="0" >
                ...
                <thead>
                    <tr id="orders_header">
                        <td class="ord3" id="orders_head_1">id zwrotu</td>
                        <td class="ord3" id="orders_head_2">data zwrotu</td>
                        <td class="ord3" id="orders_head_3">do zwrotu</td>

                        <td class="ord3" id="orders_head_5">status</td>
                        <td class="ord3" id="orders_head_6">szczegóły</td>
                    </tr>
                </thead>
                <tbody>
                    <iaixsl:for-each select="/shop/page/returns/item">
                        <tr>
                            ...
                            <td>
                             ...
                             <td class="ord">
                                <a class="orders_more"><iaixsl:attribute name="href"><iaixsl:value-of select="@url"/></iaixsl:attribute>więcej...</a>
                            </td>
                        </tr>
                    </iaixsl:for-each>
                </tbody>
        ...
        <iaixsl:otherwise>
            <div class="return_list_noitem menu_messages_message" id="return_list_noitem">Nie dodano jeszcze żadnego zwrotu.</div>
        </iaixsl:otherwise>
    </iaixsl:choose>
</div>
