...
<iaixsl:if test="/shop/page/@cache_basket"/>
		...
		<iaixsl:when test="count(page/opinions-photos/opinions/opinion[@image_small or @image_large]) > 0">
			...
			<div id="opinions">
				<h1 class="big_label">Inspiracje i zdjęcia klientów</h1>
				<p class="opinions-description">
					Chcesz dodać swoje zdjęcie? Możesz to zrobić pisząc opinię i dodając swoje zdjęcie o jednym z produktów. Aby szybciej znaleźć takie produkty, skorzystaj z 
					<a href="/products-bought.php">listy kupionych produktów</a>.
					<iaixsl:if test="page/opinions-photos/opinions/@product_photo_loyalty_points">
					<br/>

						Za każdą opinię ze zdjęciem otrzymasz od nas 
						<iaixsl:value-of select="page/opinions-photos/opinions/@product_photo_loyalty_points"/> 
						pkt. w programie lojalnościowym.
					</iaixsl:if>
		...
		<iaixsl:otherwise>
			<div id="opinions" class="d-flex flex-column align-items-center --empty">
				...
				<h1 class="big_label">Nikt jeszcze nie dodał swoich zdjęć produktów</h1>
				<p class="opinions-description">
				    <span class="d-block">Chcesz być pierwszą osobą i przejść w ten sposób do historii naszego sklepu?</span>
					Dodaj zdjęcie do opinii o dowolnym produkcie. Aby szybciej znaleźć takie produkty, skorzystaj z 
					<a href="/products-bought.php">listy kupionych produktów</a>.
...
<!--Menu powiadomienia (menu_notice, 107640.1)-->
        ...
        <!--Elementy dodawane dynamicznie (menu_dynamically_added_content, 106830.1)-->
            ...
            <script src="/gfx/pol/opinions_photos_display.js.gzip?r=1612960004"></script>
            <script>
                app_shop.runApp();
            </script>
