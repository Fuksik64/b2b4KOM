...
<iaixsl:if test="/shop/page/@cache_basket"/>
        ...
        <div class="breadcrumbs col-md-12">
            ...
            <section class="noproduct my-5">
                ...
                <h3 class="noproduct__label mb-2">Item not found.</h3>
                <p>Try specifying more accurate parameters. Use a <a href="/searching.php" title="Click here to perform advanced search">search tool</a>.</p>
                    ...
                    <iaixsl:if test="/shop/basket/@login">
                        <form class="noproduct__form" method="post" novalidate="novalidate">
                            ...
                            <div class="noproduct__inputs mt-5">
                                <p class="mb-3">Before asking about a new product, make sure that it does not already appear on <a href="products-requests.php" title="Go to the list of requested products">your list of requested products</a>.</p>
                                <div class="f-group">
                                    <div class="f-feedback --required">
                                        <input id="noproduct__name" class="f-control validate" name="name" minlength="3"/>
                                        <label class="f-label" for="noproduct__name">Product name</label>
                                ...
                                <div class="f-group">
                                    <div class="f-feedback --required">
                                        ...
                                        <label class="f-label" for="noproduct__desc">Description</label>
                                        <span class="f-control-feedback"/>
                                    </div>
                                </div>
                                <div class="d-flex flex-column justify-content-center align-items-center">
                                    ...
                                    <p><i class="icon-need"></i> Fields marked with asterisk are required.</p>
                                </div>
                            </div>
                        </form>
                    </iaixsl:if>
        ...
        <!--Hotspot w noproduct strefa 1 (noproduct_hotspot_zone1, 111451.1)-->
                ...
                <iaixsl:if test="/shop/page/additional/hotspot/products_zone1">
                    ...
                    <section id="noproduct_hotspot_zone1" class="hotspot mb-5">
                        ...
                        <iaixsl:variable name="headline_after_noproduct_hotspot_zone1">View all</iaixsl:variable>
...
<!--Menu powiadomienia (menu_notice, 107640.1)-->
        ...
        <!--Elementy dodawane dynamicznie (menu_dynamically_added_content, 106830.1)-->
            ...
            <script src="/gfx/eng/noproduct_product_request_form.js.gzip?r=1612959986"></script>
            <script>
                app_shop.runApp();
            </script>
