...
<iaixsl:if test="/shop/page/@cache_basket"/>
		...
		<iaixsl:variable name="news_item_date">true</iaixsl:variable>
		<iaixsl:variable name="news_list_date">true</iaixsl:variable>
		<iaixsl:variable name="news_list_see_more">Read more</iaixsl:variable>

		<iaixsl:choose>
			
			<iaixsl:when test="/shop/page/news">
				<section id="news_item" class="news mb-4">
					<div class="news__date_name">
						<iaixsl:if test="$news_item_date">
							<div class="news__date datasquare"><iaixsl:value-of disable-output-escaping="yes" select="/shop/page/news/date"/></div>
							<h1 class="headline">
								<span class="headline__name"><iaixsl:value-of disable-output-escaping="yes" select="/shop/page/news/title"/></span>
							</h1>
						</iaixsl:if>
					</div>
					<div class="news__description"><iaixsl:value-of disable-output-escaping="yes" select="/shop/page/news/description"/></div>
				</section>
			</iaixsl:when>
			...
			<iaixsl:when test="/shop/page/newslist">
				<section id="news_list" class="article mb-4">
					...
					<iaixsl:choose>
						...
						<iaixsl:when test="not(/shop/page/newslist/mainpage1)">
							<div class="menu_messages_message" id="menu_messages_warning">
								<div class="menu_messages_warning_sub">
								...
								<iaixsl:for-each select="page/newslist/mainpage1/item">
									<article class="article__item col-12 col-md-6">
										...
										<div class="article__text">
											...
											<iaixsl:if test="link/@href and $news_list_see_more">
												<div class="article__more">
													<a class="article__more_link">
														<iaixsl:attribute name="href"><iaixsl:value-of select="link/@href"/></iaixsl:attribute>
														<iaixsl:attribute name="title"><iaixsl:value-of disable-output-escaping="yes" select="title"/></iaixsl:attribute>
														<iaixsl:value-of select="$news_list_see_more"/>
													</a>
												</div>
											</iaixsl:if>
										</div>
    ...
    <!--Bookmarklets News (news_bookmarklets, 107867.1)-->
        ...
        <!--Produkty powiązane (news_cms_associated, 111450.1)-->
            <iaixsl:if test="page/news/cms_products/product or page/news/cms_products/opinion">
                ...
                <section id="news_cms_associated" class="hotspot mb-5">
                    
                    <iaixsl:variable name="headline_after_news_cms_associated">View all</iaixsl:variable>
                    
                    <h2>
                        <iaixsl:choose>
                            <iaixsl:when test="page/news/cms_products/@link">
                                <a class="headline">
                                    <iaixsl:attribute name="href"><iaixsl:value-of select="page/news/cms_products/@link"/></iaixsl:attribute>
                                    <iaixsl:attribute name="title">Click here to view all products</iaixsl:attribute>

                                    <span class="headline__name">
                                        <iaixsl:choose>
                                            <iaixsl:when test="page/news/cms_products/@name"><iaixsl:value-of select="page/news/cms_products/@name"/></iaixsl:when>
                                            <iaixsl:otherwise>Recommended</iaixsl:otherwise>
                                        </iaixsl:choose>
                                    </span>
                                    <iaixsl:if test="$headline_after_news_cms_associated">
                                        <span class="headline__after"><iaixsl:value-of select="$headline_after_news_cms_associated"/></span>
                                    </iaixsl:if>
                                </a>
                            </iaixsl:when>
                            <iaixsl:otherwise>
