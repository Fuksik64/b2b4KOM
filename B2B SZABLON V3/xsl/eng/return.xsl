...
<iaixsl:if test="/shop/page/@cache_basket"/>
        ...
        <iaixsl:variable name="error_undefined_ret">Unknown error has occurred.</iaixsl:variable>

        <iaixsl:variable name="file_upload_invalid_type">File cannot be uploaded </iaixsl:variable>

        <iaixsl:variable name="file_upload_invalid_extension">File cannot be uploaded </iaixsl:variable>

        <iaixsl:variable name="file_upload_size_exceeded">File cannot be uploaded </iaixsl:variable>

        <iaixsl:variable name="file_uploaded_remove_fail">An error has occurred when uploading a file.</iaixsl:variable>

        <iaixsl:variable name="auction_shop_bundle_not_exist">The set with selected products is not listed on any auction. If it is possible please select a different set of products or contact us.</iaixsl:variable>

        <iaixsl:variable name="token_expired">Your data access link has expired. To access the data in your account, use the <a title="Sign in" href="/signin.php">sign in page</a>.</iaixsl:variable>

        <iaixsl:variable name="too_much_product">You can order maximum </iaixsl:variable>

        <iaixsl:variable name="not_enough_product">You have to order minimum </iaixsl:variable>

        <iaixsl:variable name="too_much_product_size">You can order maximum </iaixsl:variable>

        <iaixsl:variable name="not_enough_product_size">You have to order minimum </iaixsl:variable>

        <iaixsl:variable name="return_rebates_code_used">This discount code has already been used.</iaixsl:variable>

        <iaixsl:variable name="rebates_code_notbegun">Indicated discount code is not active. This special offer has not yet started!</iaixsl:variable>
                ...
                <iaixsl:choose>
                    ...
                    <iaixsl:when test="page/return/@type='file_upload_invalid_type' and $file_upload_invalid_type">
                        <h3 class="return_label"><iaixsl:value-of select="$file_upload_invalid_type"/>
                            <span class="invalidFileName"><iaixsl:value-of select="@value"/></span>  because its type of files is invalid.</h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type='file_upload_size_exceeded' and $file_upload_size_exceeded">
                        <h3 class="return_label"><iaixsl:value-of select="$file_upload_size_exceeded"/>
                            <span class="invalidFileName"><iaixsl:value-of select="@value"/></span>  because it is larger than the allowed size.</h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type='token_expired' and $token_expired">
                        <h3 class="return_label">Your data access link has expired. To access the data in your account, use the <a title="Sign in" href="/signin.php">sign in page</a>.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='too_much_product' and $too_much_product">
                        <h3 class="return_label"><iaixsl:value-of select="$too_much_product"/><iaixsl:value-of select="/shop/page/return/param/@value"/> pcs.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='not_enough_product' and $not_enough_product">
                        <h3 class="return_label"><iaixsl:value-of select="$not_enough_product"/><iaixsl:value-of select="/shop/page/return/param/@value"/> pcs.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='too_much_product_size' and $too_much_product_size">
                        <h3 class="return_label"><iaixsl:value-of select="$too_much_product_size"/><iaixsl:value-of select="/shop/page/return/param/@value"/> pcs. of a chosen size.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='not_enough_product_size' and $not_enough_product_size">
                        <h3 class="return_label"><iaixsl:value-of select="$not_enough_product_size"/><iaixsl:value-of select="/shop/page/return/param/@value"/> pcs. of a chosen size.</h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type = 'rma_require_one_order'">
                        <h3 class="return_label">There are no orders registered on your account. In order to add a complaint you must place an order beforehand.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'orderedit_dataerror'">
                        <h3 class="return_label">Data error during the order edition.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'order_product_worth'">
                        <h3 class="return_label">Order cannot be placed, because there are products with a price set to 0 in a basket.<iaixsl:value-of select="currency/@name"/>. Please correct the basket contents.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='order_invalidpoints'">
                        <h3 class="return_label">An error with product purchased for points has occurred. <a href="/contact.php"> Please contact the shop staff</a>.</h3>
                    </iaixsl:when>

                    
                    <iaixsl:when test="page/return/@type='openid_login_canceled'">
                        <h3 class="return_label">Loging in canceled.</h3>
                    </iaixsl:when>
                    <iaixsl:when test="page/return/@type='openid_invalid_authorization'">
                        <h3 class="return_label">Authorization error.</h3>
                    </iaixsl:when>
                    

                    <iaixsl:when test="page/return/@type = 'suggestbody_illegal_urls'">
                        <h3 class="return_label">We have not sent an e-mail, because it contains addresses of other pages. Please do not use such addresses or use the default template.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'account_login_disabled'">
                        <h3 class="return_label">This account is not authorized to sign in on this page. Use another account or <a href="/client-new.php?register">register a new one</a>.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'order_notenoughpoints'">
                        <h3 class="return_label">You have insufficient number of loyalty points.</h3>
                    </iaixsl:when>


                    <iaixsl:when test="page/return/@type = 'compare_error_minimum'">
                        <h3 class="return_label">Add at least two products to compare them.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'questionnaire_error'">
                        <h3 class="return_label">An error has occurred, a survey not sent.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'questionnaire_sent'">
                        <h3 class="return_label">Thank you! Survey sent.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'polcard_authorized'">
                        <h3 class="return_label">Authorization successful.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'polcard_unauthorized'">
                        <h3 class="return_label">Authorization failed.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'payment_credit_zagiel_error'">
                        <h3 class="return_label">You have resigned from instalments. Go to the order details and retry to pay by instalments or choose other payment method.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'payment_credit_zagiel_success'">
                        <h3 class="return_label">Wait for contact from Bank. During the phone conversation a consultant will create a instalment agreement for you. Please prepare your ID and a second identity document.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'polcard_error'">
                        <h3 class="return_label">PolCard authorization error</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'contactus_sent'">
                        <h3 class="return_label">Message sent.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'contactus_error'">
                        <h3 class="return_label">An error has occurred. Message not sent.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'ordercancel_ok'">
                        <h3 class="return_label">Order <iaixsl:if test="page/return/@extra"><iaixsl:value-of select="page/return/@extra"/></iaixsl:if> was canceled.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'returncancel_ok'">
                        <h3 class="return_label">The return has been cancelled.</h3>
                    </iaixsl:when>
                    <iaixsl:when test="page/return/@type = 'returncancel_error'">
                        <h3 class="return_label">The return cannot be cancelled. Contact <a href="/contact.php"> our staff </a> for more information.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'ordercancel_dberror'">
                        <h3 class="return_label">Database error.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'ordercancel_dataerror'">
                        <h3 class="return_label">This order cannot be canceled.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'orderconfirm_ok'">
                        <h3 class="return_label">Thank you. Order <iaixsl:if test="page/return/@extra"><iaixsl:value-of select="page/return/@extra"/></iaixsl:if> has been marked as confirmed.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'orderconfirm_noneed'">
                        <h3 class="return_label">Order does not have to be confirmed by e-mail.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'orderconfirm_confirmed'">
                        <h3 class="return_label">Order has been confirmed earlier.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'orderconfirm_dataerror'">
                        <h3 class="return_label">The entered address is invalid or incorrect.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'prepaid_error'">
                        <h3 class="return_label">You cannot modify this order. Please contact <a href="/contact.php">the shop staff</a>.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'prepaid_payback'">
                        <h3 class="return_label">You have removed the pre payment. Funds will be refunded to you as soon they are registered on our bank account.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'account_badlogin'">
                        <h3 class="return_label">Entered login or password are invalid.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'account_nouser'">
                        <h3 class="return_label">There is no account with this login or e-mail address.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'account_disabled'">
                        <h3 class="return_label">Indicated account was blocked.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'account_wholesale_disabled'">
                        <h3 class="return_label">The store is available only for wholesalers. If your wish to become one, please contact the shop staff.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'account_passremind'">
                        <h3 class="return_label">We have sent an e-mail that allows to sign in automatically, to your e-mail address. Change of password will be possible after signing in to your personal information edition.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'basket_empty'">
                        <div class="basket_icon_wrapper"><i class="icon-empty_basket"></i></div>
                        <h3 class="return_label">Your basket is empty.</h3>
                        <p>Add products to start order process.</p>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'basket_size'">
                        <h3 class="return_label">Your basket reached the limit of maximum number of available products.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'wisheslist_empty'">
                        <div class="whish_icon_wrapper"><i class="icon-star-empty"></i></div>
                        <h3 class="return_label">Shopping list is empty.</h3>
                        <p>Add products to your list.</p>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'ordered_empty'">
                        <div class="ordered_icon_wrapper"><i class="icon-empty_basket"></i></div>
                        <h3 class="return_label">The list of purchased products is empty.</h3>
                        <p>When you buy a product, it will appear on this list.</p>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type = 'order_minimum'">
                        <h3 class="return_label">
                            ...
                            <iaixsl:if test="page/return/@extra">
                                <br/>Minimum value of the order is 
                    ...
                    <iaixsl:when test="page/return/@type = 'order_minimal_wholesale'">
                        <h3 class="return_label">
                            ...
                            <iaixsl:if test="page/return/@extra">
                                <br/>Minimal wholesale order value is 
                                <iaixsl:value-of select="page/return/@extra"/><iaixsl:value-of select="currency/@name"/>
                            </iaixsl:if>
                        </h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type = 'order_notenough'">
                        <h3 class="return_label">You cannot place an order, because 
                             we have insufficient number of products you are trying to order.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'order_tomuch'">
                        <h3 class="return_label">Total sum of orders placed by you is too high
                            <iaixsl:if test="page/return/@extra">(<iaixsl:value-of select="page/return/@extra"/><iaixsl:value-of select="currency/@name"/>)</iaixsl:if>
                            <br/>Wait until we complete your previous orders or <a href="/login.php">cancel one of them.</a></h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'shipping_error'">
                        <h3 class="return_label">We are sorry, but we do not deliver our products to the indicated country. If you would like to place an order in our store, <a href="/contact.php">contact us</a> so we can add your country to the list of the ones supported by us.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'mailing_nosuchemail'">
                        <h3 class="return_label">There is no such e-mail address on our mailing list.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'mailing_removesuccess'">
                        <h3 class="return_label">E-mail address has been removed from mailing list.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'mailing_addsuccess'">
                        <h3 class="return_label">E-mail address has been added to a mailing list.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'mailing_emailexist'">
                        <h3 class="return_label">This e-mail address is already on a mailing list.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'mailing_maileregerror'">
                        <h3 class="return_label">Invalid e-mail address. Please re-enter it.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'mailing_sendingconfirm'">
                        <h3 class="return_label">We have sent an e-mail, confirming changes on our mailing list, to the indicated address. Open the e-mail and follow the instructions from our message.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'payment_success'">
                        <h3 class="return_label">On-line payment accepted.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'payment_error'">
                        <h3 class="return_label">On-line payment error.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'payment_pending'">
                        <h3 class="return_label">Awaiting confirmation from a payment system.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'payment_credit_success'">
                        <h3 class="return_label">Payment by instalments has been accepted.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'payment_credit_error'">
                        <h3 class="return_label">Instalments payment error.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'opinion_addsuccess'">
                        <h3 class="return_label">Review has been added and is awaiting approval.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'opinion_adderror'">
                        <h3 class="return_label">An error has occurred – a review not added to a product.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = '403'">
                        <h3 class="return_label">Access to this file is forbidden.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = '404'">
                        <h3 class="return_label">Indicated document not found. If you have been redirected to this page by an invalid link, please <a href="/contact.php">report it to us</a>.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = '500'">
                        <h3 class="return_label">Server error. Wait for a while and try to refresh the page.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'askforproduct_sent'">
                        <h3 class="return_label">Question to a product<iaixsl:text> </iaixsl:text><iaixsl:value-of select="page/return/@extra"/><iaixsl:text> </iaixsl:text>successfully added. Please wait for an answer.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'askforproduct_error'">
                        <h3 class="return_label">Question to a product<iaixsl:text> </iaixsl:text><iaixsl:value-of select="page/return/@extra"/><iaixsl:text> </iaixsl:text>not sent. Try again later.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'incorrect_email'">
                        <h3 class="return_label">Invalid e-mail address. Please enter a correct e-mail address.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'suggestreceiver_toolong'">
                        <h3 class="return_label">E-mail address length cannot exceed 255 characters.<iaixsl:text> </iaixsl:text></h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'suggestreceiver_bademail'">
                        <h3 class="return_label">Indicated e-mail address or addresses are invalid. Check if they are correct and, if there are more of them, whether they are separated with comas.<iaixsl:text> </iaixsl:text></h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'suggestsignature_tooshort'">
                        <h3 class="return_label">Entered signature is too short. Enter your name or a nickname, recipient will recognize you by.<iaixsl:text> </iaixsl:text></h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'suggestbody_tooshort'">
                        <h3 class="return_label">Please enter content of a message to a friend.<iaixsl:text> </iaixsl:text></h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'suggestproduct_sent'">
                        <h3 class="return_label">Message with a product recommendation has been sent.<iaixsl:text> </iaixsl:text></h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='rebates_code_begins'">
                        <h3 class="return_label">Special offer for this discount code has not started yet.</h3>
                    </iaixsl:when>
                    <iaixsl:when test="page/return/@type='rebates_code_expires'">
                        <h3 class="return_label">Special offer for this discount code has ended.</h3>
                    </iaixsl:when>
                    <iaixsl:when test="page/return/@type='rebates_code_undefined'">
                        <h3 class="return_label">Indicated discount code does not exist.</h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type='account_logoff'">
                        <h3 class="return_label">Order-placing error has occurred. Please sign in again and finish buying. If it is impossible, <a href="/contact.php">contact the shop staff</a>.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='get_attachment_error'">
                        <h3 class="return_label">Attachment, you are trying to download, is unavailable.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='stock_not_found'">
                        <h3 class="return_label">Point of collection not found.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='stock_transfer'">
                        <h3 class="return_label">You cannot place an order as the selected products are from different stocks. <a href="/contact.php">Please contact the shop staff</a>to receive information how to complete an order.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='insurance_error'">
                        <h3 class="return_label">An error has occurred when insuring your order and the insurance has not been registered. <a href="/contact.php">Please, contact the shop staff to learn more.</a></h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='products_not_available'">
                        <h3 class="return_label">Product is not available in none of personal collection points.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='no_partners'">
                        <h3 class="return_label">We are sorry. Our store does not share information about its trade partners.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='page_only_register'">
                        <h3 class="return_label">The page available only for signed users. <a class="loginPopUpShow" href="/signin.php" title="Sign in">Sign in.</a></h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='page_only_unregister'">
                        <h3 class="return_label">The page available for unsigned users only. <a href="/login.php?operation=logout" title="Log out">Log out.</a></h3>
                    </iaixsl:when>
                    <iaixsl:when test="page/return/@type='product_question_confirmed'">
                        <h3 class="return_label">Thank your for contacting us. We have registered your question. We will answer as soon as possible.</h3>
                    </iaixsl:when>
                    <iaixsl:when test="page/return/@type='product_question_confirm_error'">
                        <h3 class="return_label">An error has occurred. The question about the product not sent.</h3>
                    </iaixsl:when>
                    <iaixsl:when test="page/return/@type='product_question_wrong_email'">
                        <h3 class="return_label">Invalid e-mail address. Question not sent.</h3>
                    </iaixsl:when>
                    <iaixsl:when test="page/return/@type='product_question_sent'">
                        <h3 class="return_label">Thank your for your questions. To confirm them, please click on the link we have just sent to you in the e-mail.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'to_many_products_compared'">
                        <h3 class="return_label">A product cannot be compared. Remove unnecessary products from the comparison to be able to add new ones.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'products_not_found'">
                        <h3 class="return_label">Item not found. Use a <a href="/searching.php" title="Click here to perform advanced search">advanced search tool</a>.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'virtual_products_not_found'">
                        <h3 class="return_label">List of files which you cannot download anymore, is empty.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'virtual_products_to_download_not_found'">
                        <h3 class="return_label">You have no files to download. This page will be active after buying them.</h3>
                    </iaixsl:when>
