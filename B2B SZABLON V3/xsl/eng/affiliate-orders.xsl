...
<iaixsl:choose>
    <iaixsl:when test="count(page/orders/client)">
        <div class="affiliate_orders_desc">
            <p class="affiliate_orders_desc">Individuals who have purchased or created an account in our shop, thanks to your recommendation, are listed in the table below. Given sums relate to orders placed with your partnership. To view detailed information about a particular person, click on a customer id.</p>
        </div>
   ...
   <iaixsl:attribute name="class">ui-responsive table-stroke ui-table ui-table-reflow affiliate_orders</iaixsl:attribute>
                    ...
                    <thead>
                        <tr>
                            <th id="affiliate_orders_th1">customer id</th>
                            <th id="affiliate_orders_th3">account created on</th>
                            <th id="affiliate_orders_th4">number of orders</th>
                            <th id="affiliate_orders_th5">total value of placed orders<span><br/><small>(shipping costs not included)</small></span></th>
                            <th id="affiliate_orders_th6">number of completed orders</th>
                            <th id="affiliate_orders_th7">value of completed orders<span><br/><small>(shipping costs not included)</small></span></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <iaixsl:if test="page/orders/client_sum">
                            <tr data-mobile-class="hide" class="table-stroke-row-sum">
                                <td class="affiliate_orders_sum"><span>Total</span></td>
    ...
    <iaixsl:otherwise>
        <div class="affiliate_orders_null">
            No orders placed by your clients.
        </div>
    </iaixsl:otherwise>
</iaixsl:choose>
</iaixsl:if>
