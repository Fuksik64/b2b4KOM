    ...
    <iaixsl:if test="not(page/@type='affiliate-not-active')"/>
        <div class="affiliate_main_cms_label">
            <span class="big_label affiliate_main_cms_label">
                Welcome to the Affiliate Program page
            </span>
        </div>
    ...
    <div id="affiliate_main_menu" class="row">
      ...
      <div class="affiliate_stats col-md-6 col-sm-12" id="affiliate_stats">
        <div class="affiliate_stats_sub col-md-12">
          ...
          <div><i><iaixsl:attribute name="class">icon-signal</iaixsl:attribute></i>Measuring the effectiveness of affiliate partners. The tool assesses the effectiveness of all affiliate partners and includes the sorting option.</div>
          ...
          <a class="btn --solid">
              ...
              <iaixsl:attribute name="title">List of redirections to the store from your recommendation</iaixsl:attribute>
              Your redirections
          </a>
          <a class="btn --solid">
              ...
              <iaixsl:attribute name="title">List of orders placed by customers who were recommended by you</iaixsl:attribute>
              Customer orders
          </a>
          <a class="btn --solid">
              ...
              <iaixsl:attribute name="title">List of customers who created their accounts thanks to your recommendation</iaixsl:attribute>
              Customer list
          </a>
        ...
        <div class="affiliate_generator col-md-6 col-sm-12" id="affiliate_generator">
          <div class="affiliate_generator_sub col-md-12">
            <h3>
              Codes and banners generator
            </h3>
            <div><i><iaixsl:attribute name="class">icon-cog-alt</iaixsl:attribute></i>Ability to prepare ready-to-use advertisements (flash and static pictures). The panel enables retrieving HTML code with an affiliate link.</div>
            ...
            <a class="btn --solid">
                ...
                <iaixsl:attribute name="title">Rebate code</iaixsl:attribute>
                Rebate code
            </a>
            ...
            <a class="btn --solid">
                ...
                <iaixsl:attribute name="title">HTML code generator</iaixsl:attribute>
                HTML code
            </a>
            <a class="btn --solid">
                ...
                <iaixsl:attribute name="title">PHP code generator</iaixsl:attribute>
                PHP code 
            </a>
            <a class="btn --solid">
                ...
                <iaixsl:attribute name="title">JavaScript code generator</iaixsl:attribute>
                JavaScript code
            </a>
          ...
          <div class="affiliate_calculations col-md-6 col-sm-12" id="affiliate_calculations">
            <div class="affiliate_calculations_sub col-md-12">
              ...
              <div><i><iaixsl:attribute name="class">icon-users</iaixsl:attribute></i>The tool enables fund withdrawal or exchanging funds for gift vouchers</div>
              ...
              <a class="btn --solid">
                  ...
                  <iaixsl:attribute name="title">Settling cash flows on your affiliate partner account</iaixsl:attribute>
                  Settlements
              </a>
            ...
            <div class="affiliate_calculations col-md-6 col-sm-12" id="affiliate_calculations">
              <div class="affiliate_calculations_sub col-md-12">
                ...
                <div><i><iaixsl:attribute name="class">icon-credit-card</iaixsl:attribute></i>The tool enables fund withdrawal or exchanging funds for gift vouchers</div>
                ...
                <a class="btn --solid">
                    ...
                    <iaixsl:attribute name="title">Information about affiliate partner account balance, mechanism of exchanging funds for vouchers and withdrawal history</iaixsl:attribute>
                    Available funds
                </a>
