            ...
            <div class="step6">
                ...
                <div class="progress_bar_wrapper pb_step6">
                    ...
                    <div class="_step _step2">
                        ...
                        <p>
                            <i/>
                            <b>Select products</b> to be returned 
                        </p>
                    </div>
                    <div class="_step _step3">
                        ...
                        <p>
                            <i/>
                            <b>Select a method</b> of a return
                        </p>
                    </div>
                    <div class="_step _step4">
                        ...
                        <p>
                            <i/>
                            <b>Select a point</b> for the product delivery
                        </p>
                    </div>
                    <div class="_step _step5">
                        ...
                        <p>
                            <i/>
                            <b>Select a method</b> of a refund
                        </p>
                    </div>
                ...
                <div class="n57856_order_overtaker">
                    <form class="returns_form" method="post">
                                ...
                                <div class="order2_info1" id="order2_box_1">
                                    <div class="order2_info1_sub">
                                        ...
                                        <iaixsl:if test="page/orderclient/@nip">
                                            Tax No.:<iaixsl:value-of select="page/orderclient/@nip"/><br/>
                                        </iaixsl:if>
                                        e-mail
                                    ...
                                    <iaixsl:when test="page/pickup">
                                        ...
                                        <div class="order2_info1" id="order2_box_2b">
                                            ...
                                            <a class="order2_button_change_address btn --solid mt-2 mt-sm-0" target="_blank">
                                                ...
                                                change a return delivery address
                                            </a>
                        ...
                        <div id="return_products_list" class="order2_products">
                            ...
                            <iaixsl:variable name="return_with_special_offer">You are returning products from a discounted order. Refund will be made including the earlier discount and proportionally reduced, depending on a returned product. In case of any questions please contact us.</iaixsl:variable>
                            <iaixsl:variable name="required_from_special_offer">This product price had an impact on the price of other products in the basket</iaixsl:variable>
                                            ...
                                            <iaixsl:if test="@required_from_special_offer = 'true' and $required_from_special_offer != ''">
                                                ...
                                                <iaixsl:if test="@required_from_special_offer = 'true'">
                                                    <div class="productslist_product_special_offer">
                                                        ...
                                                        This product price had an impact on the price of other products in the basket
                                                    </div>
                                                </iaixsl:if>
                                            </iaixsl:if>
                                        ...
                                        <td class="order2_name">
                                            ...
                                            <iaixsl:choose>
                                                <iaixsl:when test="/shop/page/return_method/@description">
                                                    <span class="order2_name">Return method:
                                                ...
                                                <iaixsl:when test="/shop/page/return_method/@id = 2 and /shop/page/return_method/@shipping_cost = 'client' and not(/shop/page/repayment_method/@id = 't')">
                                                    ...
                                                    <div class="return_description">
                                                        The payment will be deducted from the value of the returned products
                                                    </div>
                                                </iaixsl:when>
                                                ...
                                                <iaixsl:when test="/shop/page/return_method/@id = 3">
                                                    ...
                                                    <div class="return_description">
                                                        I commit myself to post the parcel and pay all the expenses of its shipment to the shop.
                                                    </div>
                                                </iaixsl:when>
                                    ...
                                    <td class="order2_name">
                                        ...
                                        <iaixsl:choose>
                                            <iaixsl:when test="/shop/page/repayment_method/@id = 't'">
                                                <span class="order2_name">The refund method: Customer balance</span>

                                                <div class="return_description">
                                                    I want the refund to be added to my balance so I can use it with my future orders.
                                                </div>

                                            </iaixsl:when>
                                            <iaixsl:when test="/shop/page/repayment_method/@id = 'b'">
                                                <span class="order2_name">The refund method: Wire transfer</span>
                                                <div class="return_description">
                                                    The refund will be sent via a wire transfer to the provided account number.
                                                </div>
                                            </iaixsl:when>
                                            <iaixsl:when test="/shop/page/repayment_method/@id = 'tc'">
                                                <span class="order2_name">The refund method: Restore a trade credit</span>
                                                <div class="return_description">
                                                    The refund will be added to your balance in a form of a trade credit.
                                                </div>
                                            </iaixsl:when>
                                            <iaixsl:otherwise>
                                                <span class="order2_name">
                                ...
                                <div class="basketedit_summary_buttons table_display">
                                    ...
                                    <div class="btn_wrapper">
                                        ...
                                        <input class="btn --solid --large" type="submit">
                                            ...
                                            <iaixsl:attribute name="value">Add a return notification</iaixsl:attribute>

                                            <iaixsl:if test="/shop/return_edit/@return_id">
                                                <iaixsl:attribute name="value">Save changes</iaixsl:attribute>
                                            </iaixsl:if>
