...
<iaixsl:if test="/shop/page/@cache_basket"/>
        ...
        <!--Agregator zbierania opinii (opinions_add_aggregator, 109124.1)-->
			<section id="opinion_order" class="opinion_order">
				<h2 class="headline">
					<span class="headline__name">Evaluate your order No. <iaixsl:value-of select="/shop/page/opinions/@order_id"/></span>
				</h2>
				<form class="opinion_order__form" action="/ajax/opinions.php?action=insert" method="POST">
					...
					<div class="note_wrapper">
						<span class="note_invitation">
							<span class="note_invitation_desktop">We would appreciate it if you could rate, on a scale of 1 (tragic) to 5 (very good and fast), the performance of your order. Please give us a subjective but fair evaluation of what we, as a store, have actually influenced. If you rate your order 1, 2, or 3 stars, please be sure to write your comments so we know what to improve on future orders.</span>
							<span class="note_invitation_mobile">How do you evaluate your order?</span>
						</span>
					...
					<div class="f-group">
						<div class="has-feedback">
							...
							<label class="f-label">Write a few words on how you evaluate your order</label>
						...
						<iaixsl:if test="/shop/page/opinions/@order_sum_loyalty_points and not(/shop/page/opinions/@order_sum_loyalty_points = '')">
							<div class="opinions_points_sum">
								...
								in our loyalty program for evaluating this order.
							</div>
						</iaixsl:if>
					</div>

					<div class="f-button">
						<button class="btn --medium --solid" type="submit">Send us your review</button>
					</div>
				</form>
			</section>
			<section id="opinion_products" class="opinion_products">
				<h2 class="headline">
					<span class="headline__name">You can evaluate individual products from the order below</span>
				</h2>
				<iaixsl:for-each select="/shop/page/opinions/opinions_products/opinion_product">
					<form class="opinion_products__form" action="/ajax/opinions.php?action=insert" method="POST">
							...
							<div class="opinion_products__block --opinion col-md-8">
								...
								<div class="f-group">
									<div class="has-feedback">
										...
										<label class="f-label">Write your review about the product</label>
								...
								<div class="opinion_products__photo d-md-flex">
										...
										<div class="opinion_add_photos_wrapper">
											...
											<iaixsl:if test="/shop/page/opinions/@product_photo_loyalty_points">
												<div class="opinions_points_picture">
													Add your own photo of this product <br/> and earn an extra
													<strong>
														<iaixsl:choose>
															<iaixsl:when test="substring-after(/shop/page/opinions/@product_photo_loyalty_points, '.') = '00'">
																<iaixsl:value-of select="substring-before(/shop/page/opinions/@product_photo_loyalty_points, '.')"/>
									...
									<div class="f-button">
										<button class="btn --medium --solid" type="submit">Send review</button>
									</div>
								</div>
							</div>
						</div>
						<iaixsl:if test="/shop/page/opinions/@product_sum_loyalty_points and not(/shop/page/opinions/@product_sum_loyalty_points = '')">
							<div class="opinions_points_sum">
								For rating this product you can get a total of 
								<strong>
									<iaixsl:choose>
...
<!--Menu powiadomienia (menu_notice, 107640.1)-->
        ...
        <!--Elementy dodawane dynamicznie (menu_dynamically_added_content, 106830.1)-->
            ...
            <script src="/gfx/eng/opinions_add_aggregator.js.gzip?r=1612959986"></script>
            <script>
                app_shop.runApp();
            </script>
