...
<iaixsl:if test="/shop/page/@cache_basket"/>
    ...
    <!--Nazwa produktu na karcie (projector_productname, 111557.1)-->
		...
		<!--Dokładne dane o produkcie (projector_details, 113285.1)-->
            ...
            <iaixsl:variable name="brutto_bundle_txt"> selected net goods </iaixsl:variable>
                    ...
                    <div id="projector_prices_wrapper">
                        ...
                        <iaixsl:if test="$advanceprice_txt and page/projector/product/price/@advanceprice_net_formatted">
                            <div id="projector_advanceprice_wrapper">
                                <iaixsl:value-of disable-output-escaping="yes" select="$advanceprice_txt"/><b id="projector_advanceprice"><iaixsl:value-of select="page/projector/product/price/@advanceprice_net_formatted"/></b> may be required. Detailed information will be provided in the order summary, before its placement.
                            </div>
                        </iaixsl:if>
                    </div>
                    ...
                    <div id="projector_buy_section" class="product_section">
                        ...
                        <div class="projector_buttons" id="projector_buttons">
                            ...
                            <a href="#add_favorite" class="projector_buttons_obs" id="projector_button_observe">
                                <iaixsl:attribute name="title">Add to shopping list</iaixsl:attribute>
					...
					<iaixsl:if test="not(page/projector/product/@product_type = 'product_service') and (page/projector/product/sizes_version/@stocks_link or page/projector/product/sizes/@stocks_link or page/projector/product/versions/@count > 0)">
						<div class="benefits__block --stocks">
							<iaixsl:choose>
								...
								<iaixsl:otherwise>
									<span class="benefits__item --stock">This product is not available in a stationary store</span>
								</iaixsl:otherwise>
							</iaixsl:choose>
						</div>
        ...
        <!--Karta produktu - w zestawiaj taniej (projector_in_bundle, 118403.1)-->
			...
			<iaixsl:if test="page/projector/bundle/product or page/projector/collection/product">
				<section id="projector_in_bundle" class="hotspot mb-5 --list col-12">
					<h2>
						<span class="headline"><span class="headline__name">Save by buying more</span></span>
					</h2>
											...
											<div class="product__prices ml-md-auto flex-md-row align-items-md-center">
												<iaixsl:choose>
													<iaixsl:when test="price/@value > 0">
														...
														<div class="product__promo_info_wrapper">
															<span class="product__promo_info">Cheaper in the collection by <iaixsl:value-of select="bundle_price/@percent_diff"/>%</span>
														</div>
													</iaixsl:when>
													<iaixsl:otherwise>
														<a class="price --phone">
...
<!--Menu powiadomienia (menu_notice, 107640.1)-->
        ...
        <!--Elementy dodawane dynamicznie (menu_dynamically_added_content, 106830.1)-->
            ...
            <script src="/gfx/eng/menu_alert.js.gzip?r=1612959986"></script>
            <script src="/gfx/eng/projector_photos.js.gzip?r=1612959986"></script><script src="/gfx/eng/projector_details.js.gzip?r=1612959986"></script><script src="/gfx/eng/projector_bundle_zone.js.gzip?r=1612959986"></script><script src="/gfx/eng/projector_banner.js.gzip?r=1612959986"></script><script src="/gfx/eng/projector_projector_opinons_form.js.gzip?r=1612959986"></script>
            <script>
                app_shop.runApp();
            </script>
