...
<iaixsl:if test="/shop/page/@cache_basket"/>
        ...
        <!--Zamówienia klienta z programu partnerskiego (affiliate_client_orders, 90392.1)-->

<iaixsl:if test="page/client/item">

<div class="affiliate_client_label">
<iaixsl:attribute name="class">big_label affiliate_client_label</iaixsl:attribute>
    <span class="affiliate_client_label">
        Customer orders<iaixsl:value-of select="page/client/@id"/>
    </span>
</div>
<div class="affiliate_client">
    <div class="affiliate_client_sub">
        <table class="affiliate_client">
   <iaixsl:attribute name="class">ui-responsive table-stroke ui-table ui-table-reflow affiliate_client</iaixsl:attribute>
            <thead>
                <tr>
                    <th id="affiliate_client_th1">order id</th>
                    <th id="affiliate_client_th2">date of order</th>
                    <th id="affiliate_client_th3">date of shipment</th>
                    <th id="affiliate_client_th4">total value of the order</th>
                    <th id="affiliate_client_th5">quantity of products</th>
                    <th id="affiliate_client_th6">payment</th>
                    <th id="affiliate_client_th7">status</th>
                    <th id="affiliate_client_th8">partner</th>
                    <th id="affiliate_client_th9">commission</th>
                </tr>
            </thead>
            <tbody>
                <iaixsl:for-each select="page/client/item">
                    <tr>
                        <iaixsl:choose>
                            <iaixsl:when test="position() mod 2">
                                <iaixsl:attribute name="class">affiliate_client_row1</iaixsl:attribute>
                            </iaixsl:when>
                            <iaixsl:otherwise>
                                <iaixsl:attribute name="class">affiliate_client_row2</iaixsl:attribute>
                            </iaixsl:otherwise>
                        </iaixsl:choose>
                        <td class="affiliate_client_first">
                            <iaixsl:choose>
                              <iaixsl:when test="@orderid">
                                   <iaixsl:value-of select="@orderid"/>
                              </iaixsl:when>
                              <iaixsl:otherwise>
                        ...
                        <td>
                            <iaixsl:value-of select="@dispatch"/>
                        </td>
                        <td>
                            <span class="affiliate_client_price"><iaixsl:value-of select="@cost_formatted"/></span>
                        </td>
                        <td>
                            <iaixsl:value-of select="@numprod"/>
                        </td>
                        <td>
                            <span class="affiliate_client_price"><iaixsl:value-of select="@prepaid_formatted"/></span>
                        </td>
                        <td>
                            <iaixsl:value-of select="@status"/>
                        </td>
                        <td>
                            <iaixsl:value-of select="@affiliate"/>
                        </td>
                        
                        <td>
                            <iaixsl:value-of select="@commission_formatted"/>
                        </td>
                    </tr>
                </iaixsl:for-each>
            </tbody>
...
<!--Zamówienia klienta - stronicowanie (affiliate_client_paging, 110546.1)-->
        <iaixsl:variable name="prev_page"></iaixsl:variable>
        <iaixsl:variable name="next_page">Next page</iaixsl:variable>

        <iaixsl:if test="count(page/client/navigation/item) > 1">
            <ul class="pagination mb-2 mb-sm-3">
                
                <iaixsl:if test="page/client/navigation/prev">
                    <li class="pagination__element --prev">
                        ...
                        <a class="pagination__link">
                            <iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="page/client/navigation/path/@value"/><iaixsl:value-of select="page/client/navigation/prev/@counter"/></iaixsl:attribute>
                        </a>
                        <iaixsl:if test="$prev_page">
                ...
                <iaixsl:if test="not(page/client/navigation/prev)">
                ...
                <iaixsl:for-each select="page/client/navigation/item">
                    <iaixsl:if test="@gap">
                ...
                <iaixsl:if test="page/client/navigation/next">
                    <li class="pagination__element --next">
                        ...
                        <a class="pagination__link">
                            <iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="page/client/navigation/path/@value"/><iaixsl:value-of select="page/client/navigation/next/@counter"/></iaixsl:attribute>
                        </a>
                        <iaixsl:if test="$next_page">
                ...
                <iaixsl:if test="not(page/client/navigation/next)">
