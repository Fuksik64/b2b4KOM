...
<iaixsl:if test="/shop/page/@cache_basket"/>
		...
		<iaixsl:when test="count(page/opinions-photos/opinions/opinion[@image_small or @image_large]) > 0">
			...
			<div id="opinions">
				<h1 class="big_label">Inspirations and photos of customers</h1>
				<p class="opinions-description">
					Do you want to add your photo? You can do this by writing a review and adding your photo about one of the products. To find such products faster, please use
					<a href="/products-bought.php">list of purchased products</a>.
					<iaixsl:if test="page/opinions-photos/opinions/@product_photo_loyalty_points">
					<br/>

						You will receive from us for each opinion with a photo
						<iaixsl:value-of select="page/opinions-photos/opinions/@product_photo_loyalty_points"/> 
						point. in the loyalty program.
					</iaixsl:if>
		...
		<iaixsl:otherwise>
			<div id="opinions" class="d-flex flex-column align-items-center --empty">
				...
				<h1 class="big_label">Nobody has added their product photos yet</h1>
				<p class="opinions-description">
				    <span class="d-block">Do you want to be the first person and thus go down in the history of our store?</span>
					Add a picture to your review of any product. To find such products faster, please use
					<a href="/products-bought.php">list of purchased products</a>.
...
<!--Menu powiadomienia (menu_notice, 107640.1)-->
        ...
        <!--Elementy dodawane dynamicznie (menu_dynamically_added_content, 106830.1)-->
            ...
            <script src="/gfx/eng/opinions_photos_display.js.gzip?r=1612959986"></script>
            <script>
                app_shop.runApp();
            </script>
