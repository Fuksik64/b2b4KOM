                                                ...
                                                <iaixsl:choose>
                                                    <iaixsl:when test="@type = 'p'">
                                                        ...
                                                        <span class="rma_add_form_infotitle2">
                                                            ...
                                                            <iaixsl:if test="/shop/page/rma/payments/@active = '1'">
                                                                <img class="rma_need" src="/gfx/eng/need.gif?r=1612959986"><iaixsl:attribute name="alt">This field is required to place an order</iaixsl:attribute></img>
                                                                <img src="/gfx/eng/correct.png?r=1612959986" class="rma_correct_img" id="rma_add_przekaz_on" style="display:none;"/>
                                                                <img src="/gfx/eng/incorrect.png?r=1612959986" class="rma_correct_img" id="rma_add_przekaz_off" style="display:none;"/>
                                                            </iaixsl:if>
                                                        </span>
                                                    ...
                                                    <iaixsl:when test="@type = 'b'">
                                                        ...
                                                        <span class="rma_add_form_infotitle2">
                                                            ...
                                                            <iaixsl:if test="/shop/page/rma/payments/@active = '1'">
                                                                <img class="rma_need" src="/gfx/eng/need.gif?r=1612959986"><iaixsl:attribute name="alt">This field is required to place an order</iaixsl:attribute></img>
                                                                <img src="/gfx/eng/correct.png?r=1612959986" class="rma_correct_img" id="rma_add_bankaccount_on" style="display:none;"/>
                                                                <img src="/gfx/eng/incorrect.png?r=1612959986" class="rma_correct_img" id="rma_add_bankaccount_off" style="display:none;"/>
                                                            </iaixsl:if>
                                                        </span>
                                                    ...
                                                    <iaixsl:when test="@type = 'c'">
                                                        ...
                                                        <span class="rma_add_form_infotitle2">
                                                            ...
                                                            <iaixsl:if test="/shop/page/rma/payments/@active = '1'">
                                                                <img class="rma_need" src="/gfx/eng/need.gif?r=1612959986"><iaixsl:attribute name="alt">This field is required to place an order</iaixsl:attribute></img>
                                                                <img src="/gfx/eng/correct.png?r=1612959986" class="rma_correct_img" id="rma_add_czek_on" style="display:none;"/>
                                                                <img src="/gfx/eng/incorrect.png?r=1612959986" class="rma_correct_img" id="rma_add_czek_off" style="display:none;"/>
                                                            </iaixsl:if>
                                                        </span>
