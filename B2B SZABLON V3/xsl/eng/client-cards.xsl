			...
			<iaixsl:choose>
				<iaixsl:when test="/shop/page/cards/item">
					<div id="client_cards">
						...
						<p>
							To check all discounts we have granted you, go to 
						<a href="client-rebate.php">your account and click on the Discount section.</a>
						</p>
