...
<iaixsl:if test="/shop/page/@cache_basket"/>
    ...
    <!--Rma potwierdzenie (rma_confirmation_form, 107797.1)-->
        ...
        <iaixsl:if test="page/@type = 'rma_products' and page/@display = 'confirmation'">
            <div class="step6">
                    ...
                    <form class="returns_form" method="post">
                        ...
                        <div class="order2_products">
                            ...
                            <iaixsl:if test="$return_with_special_offer != '' and /shop/page/returnproducts/products/@return_with_special_offer = 'true'">
                                <div class="menu_messages_message menu_messages_return_with_specia"><div><iaixsl:value-of select="$return_with_special_offer"/></div></div>
                            </iaixsl:if>
