...
<iaixsl:if test="/shop/page/@cache_basket"/>
    ...
    <!--Błędy i informacje w projektorze (menu_messages, 106608.1)-->
        ...
        <iaixsl:if test="page/@type = 'basketedit'">
            <script>
                var only_virtual_literal = 'Files will be available under <a href="/client-files.php" style="text-decoration:underline">"My files"</a> in a customer's tab after paying for order.';
            </script>
                  ...
                  <iaixsl:attribute name="class">basketedit_productslist <iaixsl:if test="not(/shop/page/basket-details/product/size/@type != 'uniw')">nosizesbasket </iaixsl:if><iaixsl:if test="not(/shop/basket/@product_comment_active = 'y')">nocommentbasket</iaixsl:if></iaixsl:attribute>
										...
										<iaixsl:choose>
											<iaixsl:when test="/shop/allow_division_order/@is_active = 'false' or count(page/basket-details/product[@division='later']) = 0 or count(page/basket-details/product[@division='now']) = 0 or /shop/allow_division_order/@turn_on = 'no'">
												<h2>
														List of products in your shopping basket
												</h2>
												...
												<iaixsl:if test="count(page/basket-details/product) > $hideLimit">
														<table class="basketedit_bar">
																<tr class="productslist_tools_top">
																		...
																		<td>
																				<a href="#removeSelected" class="btn --icon-left icon-trash removeSelected">Remove from basket</a>

																				<a href="#saveQuantity" class="btn --icon-left icon-repeat saveQuantity">Apply changes</a>

																				<a href="#addSelectedToFavorite" class="btn --icon-left icon-save addSelectedToFavorite">Save your basket</a>
																		</td>
																</tr>
														</table>
												</iaixsl:if>
															...
															<tr class="productslist_item">
																	...
																	<iaixsl:if test="/shop/basket/@product_comment_active = 'y' and count(/shop/page/basket-details/product/price[not(@special_offer='true')]) > 0">
																			<td class="productslist_product_comment">
																					...
																					<a href="#addComment">
																					<iaixsl:attribute name="title">click to add a comment</iaixsl:attribute>
																					<i class="icon-paper-clip"></i> <span>add a description<br/>or an attachment</span>
																					</a>
																					</iaixsl:if>
																			</td>
																	</iaixsl:if>
																			...
																			<iaixsl:choose>
																					...
																					<iaixsl:otherwise>
																							<iaixsl:if test="price/@beforerebate != price/@value">
																								...
																								<del class="beforerebate_formatted">(<iaixsl:value-of select="price/@beforerebate_formatted"/><small> gross</small>)</del>
																							</iaixsl:if>
																							<span>
																									<iaixsl:value-of select="price/@price_net_formatted"/>
																									<small> net</small>
																							...
																							<span class="gross_price">(<iaixsl:value-of select="price/@price_formatted"/><small> gross</small>)</span>
																	...
																	<div>
																			...
																			<iaixsl:if test="not(size/@unit_sellby = '1')">
																					...
																					<div class="productslist_product_sellby_info">sold in sets of 
																	...
																	<td class="productslist_product_sum">
																			...
																			<iaixsl:choose>
																					...
																					<iaixsl:otherwise>
																							...
																							<span class="gross_price">(<iaixsl:value-of select="price/@worth_formatted"/><small> gross</small>)</span>
																					</iaixsl:otherwise>
																			</iaixsl:choose>
																		...
																		<iaixsl:if test="($setPositionelements = 1) and (position() = 1)">
																			...
																			<iaixsl:choose>
																					<iaixsl:when test="price/@special_offer='true'">
																							<i class="icon-ok-sign"></i>Special offer
																					</iaixsl:when>
																					<iaixsl:otherwise>
																				...
																				<div class="prodl_comment_top">
																					...
																					<div class="prodl_comment">
																							...
																							<div class="prodl_comment_left">
																									...
																									<a href="#clearComment" class="btn clear_comment">clear</a>
																							</div>
																							...
																							<div class="prodl_comment_right">
																													...
																													<iaixsl:for-each select="order_files/file">
																															<li>
																																	...
																																	<a class="deleteFile">
																																			...
																																			<iaixsl:attribute name="title">Remove file</iaixsl:attribute>
																																			Remove file
																																	</a>
																															</li>
																													</iaixsl:for-each>
																									...
																									<div class="prodl_comment_button">
																											<a href="#saveQuantity" class="btn --solid --secondary saveQuantityFile">Add file</a>
																									</div>
																			...
																			<iaixsl:if test="(size/@to_little_for_gross = 'true') and not((size/@orderedsum) > (size/@amount) and not(size/@amount = '0') and not(size/@amount = '-1'))">
																					<div class="productslist_product_info">
																							...
																							<iaixsl:value-of select="size/@ordered - size/@amount_wholesale"/>
																							 pcs. of this product in a retail price. The given price is the average price for this combination.
																					</div>
																			</iaixsl:if>
																	...
																	<iaixsl:if test="@product_type='product_virtual'">
																			<tr>
																					<td colspan="5">
																							<iaixsl:if test="/shop/basket/@product_comment_active = 'y'"><iaixsl:attribute name="colspan">6</iaixsl:attribute></iaixsl:if>
																							<div class="virtual">
																									Files will be available under <a href="/client-files.php" style="color:#e35c5c;text-decoration:underline">"My files"</a> in a customer's tab after paying for the order.
																							</div>
																					</td>
																			</tr>
																	</iaixsl:if>
											...
											<iaixsl:otherwise>
												...
												<h2>
														Available immediately, can be sent today<i class="icon-truck"/>
												</h2>
												...
												<h2>
														Available <span class="basket__division_literal">in </span><strong class="basket__division_weeks"/><i class="icon-clock"/>
												</h2>
                    ...
                    <table class="basketedit_bar">
                        <tr class="productslist_tools_bottom">
                            <td class="selectAllCheckbox">
                                ...
                                <label for="selectAllCheckbox2">Select all</label>
                            </td>
                            <td>
											...
											<div class="basket__division_option --not-divide">
												<div class="basket__division_group f-group --radio mb-0">
													...
													<label class="f-label basket__division_label" for="division_no"><strong>I will wait for the order to be completed.</strong><span class="basket__division_option_small d-block mt-1">The store will complete and ship all products from the order at once.</span>
														<div class="basket__division_option_info --not-divide mt-3 pt-2">Products with longer waiting times - ready to ship <span class="basket__division_literal">in </span><strong class="basket__division_weeks"/></div>
													</label>
												</div>
											</div>
                                            ...
                                            <iaixsl:for-each select="/shop/page/basket-details/summary/payment/instalment">
                                                <a class="instalment_payment_basket__element --link">
                                                    ...
                                                    <div class="instalment_payment_basket__img_container">
                                                        <img src="/gfx/eng/instalment_basket.svg?r=1612959986" class="instalment_payment_basket__img"/>
                                                    </div>
        ...
        <iaixsl:if test="page/@type = 'wishesedit'">
            ...
            <iaixsl:if test="not(/shop/basket/@login) or (/shop/basket/@login = '')">
                <div class="menu_messages_message">Shopping list is stored only for logged users. Please, <a class="loginPopUpShow" href="/login.php">sign in</a> or, if you do not have an account yet, <a href="/client-new.php?register">register</a>.</div>
            </iaixsl:if>
            <div class="products_bought row" id="favourites_list">
                ...
                <div id="pb_list" class="pb_list">
                    <div class="pb_list_header row d-none d-md-flex">
                        ...
                        <div class="pb_header_date col-2">On a shopping list from:</div>
                        <div class="pb_header_price col-2">Price net:</div>
                    </div>
                    ...
                    <div class="col-md-12 col-sm-4 col-6">
                        <div class="pb_product">
                            ...
                            <div class="col-md-2 col-12 mb-3 mb-md-0">
                                <div class="pb_date">
                                    <span class="d-block d-md-none">On a shopping list from:</span>
                            ...
                            <div class="col-md-2 col-12 mb-3 mb-md-0">
                                <div class="pb_price">
                                    <span class="d-block d-md-none">Price net:</span>
                                    <iaixsl:choose>
                                        <iaixsl:when test="price/@value = 0">
                                            <iaixsl:choose>
            ...
            <div id="menu_security_policy" class="menu_box">
                <iaixsl:choose>
                    <iaixsl:when test="/shop/@trust_level = '1'">
                        ...
                        <img src="/gfx/eng/iai_security_supershop.png?r=1612959986" alt="SuperFair.Shop badge"/>
                    ...
                    <iaixsl:otherwise>
                        ...
                        <div class="menu_sub_box">
                            <img src="/gfx/eng/iai_security.png?r=1612959986" alt="Idosell security badge"/>
