...
<iaixsl:if test="page/@type = 'return_products' and page/@display = 'courier'">
<div class="step3d">
       <div class="progress_bar_wrapper">
            <iaixsl:attribute name="class">progress_bar_wrapper pb_step3</iaixsl:attribute>
        ...
        <form class="return_delivery_form row" action="" method="post">
    <iaixsl:attribute name="action"><iaixsl:value-of select="page/formactionlink/@url"/></iaixsl:attribute>
  <iaixsl:for-each select="page/shipping/delivery">
                    ...
                    <div class="order1_delitem_comment" style="display:none;"><iaixsl:attribute name="id">delivery_<iaixsl:value-of select="@id"/></iaixsl:attribute></div>    
                            ...
                            <label class="order1_delitem_price">
                                                ...
                                                <label class="order1_delitem_price_point_disabled showTip_order1">
                                                    <iaixsl:attribute name="title">You do not have enough loyalty points</iaixsl:attribute>
