...
<iaixsl:if test="/shop/page/@cache_basket"/>
    ...
    <!--Rma lista produktów (rma_products_list, 112667.1)-->



        <iaixsl:if test="page/@type = 'rma_products' and page/@display = 'add'">
            <div class="step2">
                ...
                <iaixsl:if test="page/products">
                    ...
                    <form class="returns_productslist" action="/rma-method.php?type=multiproduct" method="post">
                        ...
                        <div id="basketedit_productslist" class="basketedit_productslist return_productslist">
                            ...
                            <table>
                                ...
                                <tr class="basketedit_productslist_label">
                                    ...
                                    <iaixsl:if test="page/products/product/warranty">
                                        <th class="productslist_product_warranty">
                                            Warranty
                                        </th>
                                    </iaixsl:if>
                                ...
                                <iaixsl:for-each select="page/products/product">
                                    <tr class="productslist_item">
                                        ...
                                        <td class="productslist_product_name">
                                            ...
                                            <iaixsl:choose>
                                                <iaixsl:when test="@allowReturn='0'">
                                                    
                                                    <div class="productslist_product_info d-sm-none">
                                                        <div class="btn-icon allowReturn_1">
                                                            <small><i class="icon-remove-sign"></i></small>
                                                            <span>You probably cannot make a complaint about this product. In case of any questions, please <a href='/contact.php' >contact us</a>.</span>
                                                        </div>
                                                    </div>
                                                </iaixsl:when>
                                                <iaixsl:when test="@allowReturn='2'">
                                                    
                                                    <div class="productslist_product_info d-sm-none">
                                                        <div class="btn-icon allowReturn_2">
                                                            <small><i class="icon-question"></i></small>
                                                            <span>Make sure you can make a complaint – pay special attention to the day of receiving your order, as well as the warranty time. <a href='/#' >I wanto to make a return</a>.</span>
                                                        </div>
                                                    </div>
                                                </iaixsl:when>
                                            </iaixsl:choose>
                                        ...
                                        <iaixsl:if test="warranty">
                                            <td class="productslist_product_warranty">
                                                <iaixsl:if test="warranty/@gfx">
                                                    <div class="productslist_warranty_gfx">
                                                        <img>
                                                            <iaixsl:attribute name="src"><iaixsl:value-of select="warranty/@gfx"/></iaixsl:attribute>
                                                            <iaixsl:attribute name="alt"><iaixsl:value-of select="warranty/@name"/></iaixsl:attribute>
                                                        </img>
                                                    </div>
                                                </iaixsl:if>

                                                <iaixsl:if test="not(warranty/@gfx)">
                                                    <div class="productslist_warranty">
                                                        <iaixsl:value-of disable-output-escaping="yes" select="warranty/@name"/>
                                                        
                                                        <img class="qmark2 showTip" src="/gfx/eng/qmark2.gif?r=1612959986" alt="" title=""/>
                                                        <div class="productslist_warranty_info tooltipContent">
                                                            <iaixsl:value-of disable-output-escaping="yes" select="warranty/text()"/>
                                                        </div>
                                                    </div>
                                                </iaixsl:if>
                                        ...
                                        <td class="productslist_product_comment">
                                            <iaixsl:if test="not(@allowReturn='0') and not(@allowReturn='2')">
                                                <a href="#addComment">
                                                    <iaixsl:attribute name="title">Click to add a description</iaixsl:attribute>
                                                    <i class="icon-paper-clip"></i> <span>add a description or <br/> an attachment</span>
                                                </a>
                                            </iaixsl:if>
                                        </td>
                                        ...
                                        <td class="productslist_product_quantity">
                                            ...
                                            <iaixsl:if test="not(@allowReturn='0')">
                                                <div>
                                                    <iaixsl:choose>
                                            ...
                                            <div class="prodl_comment">
                                                ...
                                                <div class="prodl_comment_right">
                                                    ...
                                                    <div class="prodl_comment_button">
                                                        <a href="#addMoreFiles" class="btn --solid addMoreFiles">
                                                            Add file</a>
                                                    </div>
                        ...
                        <div class="returns_summary_buttons table_display">
                            ...
                            <iaixsl:if test="( (count(/shop/page/products/product) - count(/shop/page/products/product[@allowReturn='0'])) > 0)">
