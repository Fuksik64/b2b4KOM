...
<iaixsl:if test="/shop/page/@cache_basket"/>
    ...
    <!--Rma szczegóły (rma_details_form, 116660.1)-->
        ...
        <iaixsl:variable name="n5_4atxt">Send a parcel<small>with no additional charge</small></iaixsl:variable>
                ...
                <div id="orderdetails_info" class="rma_orderdetails_info">
                    ...
                    <h2 class="big_label">
                        ...
                        <span class="order-date">
                            Return generation date:<iaixsl:value-of select="page/details/@datetime"/>
                        </span>
                    </h2>
                        ...
                        <div class="prepaid-status">
                            <strong>
                                <iaixsl:choose>
                                    ...
                                    <iaixsl:when test="page/details/@status=5">
                                        Products shipped to the manufacturer
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=6">
                                        Being repaired
                                    </iaixsl:when>
                                    ...
                                    <iaixsl:when test="page/details/@status=8">
                                        The defect caused by inapropriate usage
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=9">
                                        Exceeded the warranty period
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=10">
                                        Refound - awaiting payment
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=11">
                                        Refound - payment complete
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=12">
                                        Exchange for new product
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=13">
                                        The return cancelled by a customer
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=14">
                                        Cancelled return
                                    </iaixsl:when>
                                    ...
                                    <iaixsl:when test="page/details/@status=16">
                                        Cease the order reshipment
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=17">
                                        A customer generated a return - it will be delivered personally
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=18">
                                        A customer generated a return - it will be sent by the customer
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=19">
                                        Return confirmed
                                    </iaixsl:when>
                                    ...
                                    <iaixsl:when test="page/details/@status=25">
                                        Package sent back to customer
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=26">
                                        New product has been sent
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=27">
                                        Customer data has changed on sales documents
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=28">
                                        Repairs completed
                                    </iaixsl:when>
                            ...
                            <small>Return no.:<iaixsl:value-of select="page/details/@id"/></small>
                        </div>

                        <div class="prepaid-buttons">
                            <iaixsl:if test="/shop/page/editlink/@url">
                                <a class="btn-icon prepaid-edit">
                                    <iaixsl:attribute name="title">Clik to modify return</iaixsl:attribute>
                                    <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/editlink/@url"/></iaixsl:attribute><i class="icon-pencil"></i><span>Modify return</span></a>
                            </iaixsl:if>
                            <iaixsl:if test="/shop/page/cancellink/@url">
                                <a class="btn-icon prepaid-cancel orderdetails_info_cancel">
                                    <iaixsl:attribute name="onclick">return confirm('Cancellation of the return can not be undone. To continue, press "Cancel the return."')</iaixsl:attribute>
                                    <iaixsl:attribute name="title">Cancel the return</iaixsl:attribute>
                                    <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/cancellink/@url"/></iaixsl:attribute>
                                    <i class="icon-remove"></i><span>Cancel the return</span>
                                </a>
                            </iaixsl:if>
                        </div>
                    </div>
                ...
                <iaixsl:choose>
                    ...
                    <iaixsl:when test="/shop/page/rma_method/@id='2' and $n5_4atxt">
                        <div class="return_image_i">
                            <div class="text-1a">Print the complaint notification and labels</div>
                            <div class="text-2a">Prepare a parcel <small>Attach a complaint form</small></div>
                            <div class="text-3a">Send a parcel<small>with no additional charge</small></div>
                            <img src="/gfx/eng/instukcja_zwrot2.png?r=1612959986" alt=""/>
                        </div>
                    </iaixsl:when>
                    <iaixsl:otherwise>
                        <div class="return_image_i">
                            <div class="text-1">Print the complaint notification and label</div>
                            <div class="text-2">Prepare a parcel <small>Attach a complaint form</small></div>
                            <div class="text-3">Stick a label on a parcel</div>
                            <div class="text-4">Send a parcel</div>
                            <img src="/gfx/eng/instukcja_zwrot.png?r=1612959986" alt=""/>
                        </div>
                    </iaixsl:otherwise>
                </iaixsl:choose>
                    ...
                    <iaixsl:if test="/shop/page/documentlink/@url">
                        <div class="return_wrapper2">
                            <a class="btn --solid --large" target="blank">
                                ...
                                Print the complaint notification
                                ...
                                <div class="form-group clearfix row">
                                    <label for="comment" class="control-label">
                                        ...
                                        <div class="rma_af_info">
                                            ...
                                            <span>Store service will respond in the shortest possible time.</span>
                                        </div>
                                    </label>
                                    <div>
        ...
        <iaixsl:if test="page/returnproducts/products/product">
            ...
            <div id="prepaid_order_products">
                <h2 class="big_label">Products in return</h2>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5" class="rma-remarks">
                                        ...
                                        <div class="rma-remarks">
                                            <b class="rma-remarks">Problem description</b>
        ...
        <iaixsl:variable name="prepaid016txt">Shipment number: </iaixsl:variable>
        <iaixsl:variable name="prepaid017atxt">Shipment tracking: </iaixsl:variable>
        <iaixsl:variable name="prepaid017txt">courier website</iaixsl:variable>
        <iaixsl:variable name="n5_4atxt">Send a parcel<small>with no additional charge</small></iaixsl:variable>
        ...
        <div class="step7">
            ...
            <iaixsl:if test="/shop/page/pickup/name">
                <div class="returns_details_wrapper">
                    <h2 class="big_label">Return acceptance point address</h2>
                            ...
                            <div class="pickupl_return_one_sub">
                                <div class="pickupl_return_one_link">
                                    <a target="_blank" class="btn --solid">
                                        <iaixsl:attribute name="title">View details</iaixsl:attribute>
                                        <iaixsl:attribute name="href">
            ...
            <iaixsl:variable name="txt_54116_1">Related documents</iaixsl:variable>
                        ...
                        <div class="basketedit_calculations">
                            <iaixsl:if test="/shop/page/costs/cost[@type='products']/@value_formatted">
                                <div class="basketedit_product_summary">
                                    <label>The value of the products in the return:
                                    </label>
                            ...
                            <iaixsl:if test="/shop/page/costs/cost[@type='shipping']/@value_formatted">
                                <div class="basketedit_product_summary">
                                    <label>Return of the cost of delivery to the customer:
                                    </label>
                            ...
                            <iaixsl:if test="/shop/page/costs/cost[@type='shop_shipping']/@value_formatted">
                                <div class="basketedit_product_summary">
                                    <label>The cost of the return shipment:
                                    </label>
            ...
            <div class="prepaid_summary_buttons">
                ...
                <iaixsl:if test="page/backlink_other/@url">
                    <a class="btn --solid --medium">
                        ...
                        Add another return in current order
                    </a>
                </iaixsl:if>
            </div>
        </iaixsl:if>
        ...
        <div id="menu_notice" style="display: none;">
            ...
            <h2>Cancel a return</h2>
            <strong>
                Cancelling a return is irreversible. To continue click on the “cancel the return” button.
            </strong>
