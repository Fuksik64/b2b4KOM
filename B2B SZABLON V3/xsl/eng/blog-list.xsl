...
<iaixsl:if test="/shop/page/@cache_basket"/>
        ...
        <!--Blog - Categories description (blog_list_categoriesdescription, 107750.1)-->
            <div class="blog_categoriesdescription mb-4">
                <h1 class="big_label">
                    <iaixsl:choose>
                        <iaixsl:when test="page/blogitems/additional/category_list/name and (page/blogitems/additional/category_list/name != '')">
                            <iaixsl:value-of disable-output-escaping="yes" select="page/blogitems/additional/category_list/name"/>
                        </iaixsl:when>
                        <iaixsl:otherwise>
                            Blog
                        </iaixsl:otherwise>
                ...
                <iaixsl:if test="not(page/blogitems/additional/category_list/description = '') and (page/blogitems/additional/category_list/description) ">
                    <iaixsl:if test="((/shop/page/blogitems/navigation/item[1]/@counter =1) and (/shop/page/blogitems/navigation/item[1]/@type ='current'))">
                        <div class="blog_categoriesdescription_sub clearfix">
                            <iaixsl:value-of disable-output-escaping="yes" select="page/blogitems/additional/category_list/description"/>
                        </div>
                    </iaixsl:if>
                </iaixsl:if>
            </div>
        <!--Blog - List (blog_list_display, 111163.1)-->
		<iaixsl:variable name="blog_list_date"></iaixsl:variable>
		<iaixsl:variable name="blog_list_see_more">Read more</iaixsl:variable>

		<iaixsl:if test="count(page/blogitems/blogitem) > 0">
					...
					<iaixsl:for-each select="page/blogitems/blogitem">
						<article class="article__item col-12 col-md-6">
							...
							<iaixsl:if test="image/@src and image/@src!=''">
								...
								<img src="/gfx/eng/loader.gif?r=1612959986" class="article__image b-lazy">
							...
							<div class="article__text">
								...
								<iaixsl:if test="more/@href and not(more/@href='') and $blog_list_see_more">
									<div class="article__more">
										<a class="article__more_link">
											<iaixsl:attribute name="href"><iaixsl:value-of select="more/@href"/></iaixsl:attribute>
											<iaixsl:attribute name="title"><iaixsl:value-of disable-output-escaping="yes" select="title"/></iaixsl:attribute>
											<iaixsl:value-of select="$blog_list_see_more"/>
										</a>
									</div>
								</iaixsl:if>
							</div>
	...
	<!--Blog - Paging (blog_list_paging, 110564.1)-->
        ...
        <iaixsl:if test="count(page/blogitems/navigation/item) > 1">
            <ul class="pagination mb-2 mb-sm-3">
                
                <iaixsl:if test="page/blogitems/navigation/prev">
                    <li class="pagination__element --prev">
                        ...
                        <a class="pagination__link">
                            <iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="page/blogitems/navigation/path/@value"/><iaixsl:value-of select="page/blogitems/navigation/prev/@counter"/></iaixsl:attribute>
                        </a>
                        <iaixsl:if test="$prev_page">
                ...
                <iaixsl:if test="not(page/blogitems/navigation/prev)">
                ...
                <iaixsl:for-each select="page/blogitems/navigation/item">
                    <iaixsl:if test="@gap">
                ...
                <iaixsl:if test="page/blogitems/navigation/next">
                    <li class="pagination__element --next">
                        ...
                        <a class="pagination__link">
                            <iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="page/blogitems/navigation/path/@value"/><iaixsl:value-of select="page/blogitems/navigation/next/@counter"/></iaixsl:attribute>
                        </a>
                        <iaixsl:if test="$next_page">
                ...
                <iaixsl:if test="not(page/blogitems/navigation/next)">
