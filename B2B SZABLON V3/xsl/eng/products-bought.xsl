...
<iaixsl:if test="/shop/page/@cache_basket"/>
        ...
        <!--Lista kupionych produktów (products_bought_list, 110587.1)-->

<iaixsl:variable name="changePrice">true</iaixsl:variable>
<iaixsl:variable name="select_sort_label"></iaixsl:variable>
<iaixsl:variable name="select_portionpb_label"></iaixsl:variable>
<iaixsl:variable name="select_sort_label_bottom"></iaixsl:variable>
<iaixsl:variable name="select_portionpb_label_bottom"></iaixsl:variable>
...
<iaixsl:variable name="next_page_bottom">Next page</iaixsl:variable>
    ...
    <div class="products-bought row" id="products-bought">
        <div class="col-12 products-bought__label-wrapper">
            <h1 class="big_label">List of purchased products</h1>
        </div>
        <form id="paging_setting_top" class="s_paging col-md-12" action="/settings.php">
            <iaixsl:if test="not(/shop/page/navigation/@disable_sort_change = 'y')">
                <div class="s_paging__item --sort">
                    ...
                    <select class="s_paging__select --order --small-md" id="select_top_sort" name="sort_order">
                        <option value="name-a" class="option_name-a"><iaixsl:if test="page/navigation/@sort = 'name' and page/navigation/@order = 'a'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>Sort by name - ascending</option>
                        <option value="name-d" class="option_name-d"><iaixsl:if test="page/navigation/@sort = 'name' and page/navigation/@order = 'd'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>Sort by name - descending</option>
                        <option value="price-a" class="option_price-a"><iaixsl:if test="page/navigation/@sort = 'price' and page/navigation/@order = 'a'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>Sort by price - ascending</option>
                        <option value="price-d" class="option_price-d"><iaixsl:if test="page/navigation/@sort = 'price' and page/navigation/@order = 'd'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>Sort by price - descending</option>
                        <option value="date-a" class="option_date-a"><iaixsl:if test="page/navigation/@sort = 'date' and page/navigation/@order = 'a'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>Sort by date - ascending</option>
                        <option value="date-d" class="option_date-d"><iaixsl:if test="page/navigation/@sort = 'date' and page/navigation/@order = 'd'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>Sort by date - descending</option>
                    </select>
                </div>
            </iaixsl:if>
            <iaixsl:if test="count(page/navigation/portions) > 1">
                <div class="s_paging__item --portions d-none d-md-block">
                    <iaixsl:if test="$select_portionpb_label">
                        <label for="select_top_portions"><iaixsl:value-of disable-output-escaping="yes" select="$select_portionpb_label"/></label>
                    </iaixsl:if>
                    <select class="s_paging__select --portions --small-md" id="select_top_portions" name="portions">
                        <iaixsl:for-each select="page/navigation/portions">
            ...
            <iaixsl:if test="count(page/navigation/item) > 1">
                <div id="s_paging_top" class="s_paging__item pagination d-none d-sm-flex mb-2 mb-sm-3">
                    <ul class="pagination">
                        
                        <iaixsl:if test="page/navigation/prev">
                            <li class="pagination__element --prev">
                                ...
                                <a class="pagination__link">
                                    <iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="page/navigation/path/@value"/><iaixsl:value-of select="page/navigation/prev/@counter"/></iaixsl:attribute>
                                </a>
                                <iaixsl:if test="$prev_page">
                        ...
                        <iaixsl:if test="not(page/navigation/prev)">
                        ...
                        <iaixsl:for-each select="page/navigation/item">
                            <iaixsl:if test="@gap">
                        ...
                        <iaixsl:if test="page/navigation/next">
                            <li class="pagination__element --next">
                                ...
                                <a class="pagination__link">
                                    <iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="page/navigation/path/@value"/><iaixsl:value-of select="page/navigation/next/@counter"/></iaixsl:attribute>
                                </a>
                                <iaixsl:if test="$next_page">
                        ...
                        <iaixsl:if test="not(page/navigation/next)">
        ...
        <div class="col-12 products-bought__list-wrapper">
            <div id="products-bought__list" class="products-bought__list">
                <div class="products-bought__list-header row d-none d-md-flex pb-2">
                    <div class="products-bought__header-name col-6"></div>
                    <div class="products-bought__header-date col-2">Last purchase</div>
                    <div class="products-bought__header-price col-2">Current price net</div>
                </div>
                <div class="row products-bought__products">
                    <iaixsl:for-each select="/shop/page/products-list/product">
                        <div class="col-md-12 col-sm-4 col-6">
                            <div class="products-bought__product">
                                <div class="row align-items-center products-bought__product-inner">
                                    <div class="col-md-1 col-12 mb-3 mb-md-0">
                                        <div class="products-bought__checkbox f-group --checkbox mb-0">
                                            <iaixsl:if test="sizes/size[@buy_date]/@amount = 0">
                                                <iaixsl:attribute name="class">products-bought__checkbox f-group --checkbox mb-0 --unavailable</iaixsl:attribute>
                                            </iaixsl:if>
                                            <input type="checkbox" class="f-control focused products-bought__input-checkbox">
                                                <iaixsl:attribute name="data-size"><iaixsl:value-of select="sizes/size[@buy_date]/@type"/></iaixsl:attribute>
                                                <iaixsl:attribute name="data-amount"><iaixsl:value-of select="sizes/size[@buy_date]/@amount"/></iaixsl:attribute>
                                    ...
                                    <div class="col-md-1 col-12 mb-3 mb-md-0">
                                        <div class="products-bought__product-icon">
                                            <a>
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                                                <img class="basket_prod rwd-src" alt="Szczegoly" src="/gfx/eng/loader.gif?r=1612959986">
                                                    <iaixsl:attribute name="data-src_desktop"><iaixsl:value-of select="icon_small"/></iaixsl:attribute>
                                                    <iaixsl:attribute name="data-src_tablet"><iaixsl:value-of select="icon_small"/></iaixsl:attribute>
                                    ...
                                    <div class="col-md-4 col-12 mb-3 mb-md-0">
                                        <div class="products-bought__product-info">
                                            ...
                                            <iaixsl:if test="@product_type = 'product_virtual'">
                                                <div class="products-bought__product-single-info">
                                                    <span>
                                            ...
                                            <iaixsl:if test="not(@barcode ='')">
                                                <div class="products-bought__product-single-info" id="kod_54008x">
                                                    <span>
                                                        Product code: 
                                                    </span>
                                            ...
                                            <iaixsl:if test="not(sizes/size[@buy_date]/@type='uniw')">
                                                <div class="products-bought__product-single-info">
                                                    ...
                                                    <iaixsl:value-of select="sizes/size[@buy_date]/@description"/>
                                                </div>
                                            </iaixsl:if>
                                    ...
                                    <div class="col-md-2 col-12 mb-3 mb-md-0">
                                        <div class="products-bought__product-date">
                                            <span class="d-block d-md-none">Last purchase</span>
                                            <iaixsl:value-of select="sizes/size[@buy_date]/@buy_date"/>
                                        </div>
                                    </div>

                                    
                                    <div class="col-md-2 col-12 mb-3 mb-md-0">
                                        <div class="products-bought__product-price">
                                            <span class="d-block d-md-none">Current price net</span>
                                            <iaixsl:choose>
                                                <iaixsl:when test="sizes/size[@buy_date]/price/@value = 0">
                                                    <a class="col2_54008x_phone" href="/contact.php">Price on phone demand</a>
                                                </iaixsl:when>
                                                <iaixsl:otherwise>
                                                    <iaixsl:if test="sizes/size[@buy_date]/price/@maxprice and sizes/size[@buy_date]/price/@maxprice != ''">
                                                        <iaixsl:choose>
                                                            <iaixsl:when test="$changePrice">
																																<del><iaixsl:value-of select="sizes/size[@buy_date]/price/@maxprice_net_formatted"/></del>
                                                            </iaixsl:when>
                                                            <iaixsl:otherwise>
                                                                <del><iaixsl:value-of select="sizes/size[@buy_date]/price/@maxprice_formatted"/></del>
                                                            </iaixsl:otherwise>
                                                        </iaixsl:choose>
                                                    </iaixsl:if>
                                                    <iaixsl:choose>
                                                        <iaixsl:when test="$changePrice">
																														<strong><iaixsl:value-of select="sizes/size[@buy_date]/price/@price_net_formatted"/></strong>
                                                        </iaixsl:when>
                                                        <iaixsl:otherwise>
                                                            <strong><iaixsl:value-of select="sizes/size[@buy_date]/price/@price_formatted"/></strong>
                                                        </iaixsl:otherwise>
                                                    </iaixsl:choose>
                                                </iaixsl:otherwise>
                                            </iaixsl:choose>
                                    ...
                                    <div class="col-md-2 col-12 mb-3 mb-md-0 mt-auto mt-md-0">
                                        <div class="products-bought__product-button">
                                            <iaixsl:choose>
                                                <iaixsl:when test="sizes/size[@buy_date]/@amount = 0">
                                                    <span class="products-bought__product-unavailable">
                                                        Product unavailable
                                                    </span>
                                                </iaixsl:when>
                                                <iaixsl:otherwise>
                                                    <a class="btn --solid">
                                                        <iaixsl:attribute name="href"><iaixsl:value-of select="add_to_basket"/></iaixsl:attribute>
                                                        <iaixsl:attribute name="title">To basket</iaixsl:attribute>
                                                        To basket
                                                    </a>
                                                </iaixsl:otherwise>
                                            </iaixsl:choose>
        ...
        <form id="paging_setting_bottom" class="s_paging col-12 col-md-auto" action="/settings.php">
            <iaixsl:if test="not(/shop/page/navigation/@disable_sort_change = 'y')">
                <div class="s_paging__item --sort d-none">
            ...
            <iaixsl:if test="count(page/navigation/portions) > 1">
                <div class="s_paging__item --portions d-none">
                    <iaixsl:if test="$select_portionpb_label_bottom">
                        <label for="select_bottom_portions"><iaixsl:value-of disable-output-escaping="yes" select="$select_portionpb_label_bottom"/></label>
                    </iaixsl:if>
            ...
            <iaixsl:if test="count(page/navigation/item) > 1">
                <div id="s_paging_bottom" class="s_paging__item pagination d-flex mb-2 mb-md-0">
                    <ul class="pagination">
        ...
        <div class="col-12">
            <div class="products-bought__products-button">
                <div class="products-bought__checkbox-all f-group --checkbox">
                    <input type="checkbox" class="f-control focused products-bought__input-checkbox-all">
                    </input>
                    <label class="f-label">Select all</label>
                </div>
