    ...
    <iaixsl:choose>
        <iaixsl:when test="count(page/calculations/payment)">
                ...
                <div class="affiliate_calculations_desc">
                    The following table shows the sums you have obtained for the participation in the Affiliate Program. These are cash flows on your partnership account:
                        <ol>
                        <li>
            ...
            <div class="affiliate_calculations">    
                <div class="affiliate_calculations_sub">
                    <table class="affiliate_calculations">
                        ...
                        <thead>
                            <tr>
                                <th id="affiliate_calculations_th0">date of the grant commission</th>
                                <th id="affiliate_calculations_th1">valid from</th>
                                <th id="affiliate_calculations_th4">valid to</th>
                                <th id="affiliate_calculations_th2">your salary</th>
                                <th id="affiliate_calculations_th3">description</th>
                            </tr>
                        </thead>
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="affiliate_calculations_third">
                                       <iaixsl:choose>
                                        ...
                                        <span>Direct salary for the order <iaixsl:value-of select="$orderid"/></span>
                                        </iaixsl:when>
                                        
                                        <iaixsl:when test="@type = 'rd'">
                                        <span class="r">Direct salary for the order has been canceled  <iaixsl:value-of select="$orderid"/></span>
                                        </iaixsl:when>
                                        
                                        <iaixsl:when test="@type = 'gi'">
                                        <span>Indirect salary for the order <iaixsl:value-of select="$orderid"/></span>
                                        </iaixsl:when>
                                        
                                        <iaixsl:when test="@type = 'ri'">
                                        <span class="r">Indirect salary for the order has been canceled <iaixsl:value-of select="$orderid"/></span>
                                        </iaixsl:when>
                                        
                                        <iaixsl:when test="@type = 'gv'">
                                        <span>Generated voucher with ID <iaixsl:value-of select="$orderid"/></span>
                                        </iaixsl:when>
                                        
                                        <iaixsl:when test="@type = 'rv'">
                                        <span class="r">Blocked voucher with ID <iaixsl:value-of select="$orderid"/></span>
                                        </iaixsl:when>
                                        
                                        <iaixsl:when test="@type = 'gc'">
                                        <span>Cash payout has been done</span>
                                        </iaixsl:when>
                                        
                                        <iaixsl:when test="@type = 'rc'">
                                        <span class="r">Cash payout has been rejected</span>
                                        </iaixsl:when>
