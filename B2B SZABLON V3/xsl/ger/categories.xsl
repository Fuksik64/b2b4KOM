...
<iaixsl:if test="/shop/page/@cache_basket"/>
        ...
        <!--Lista kategorii (categories, 107766.1)-->

            <h1 class="categories-list_label big_label">
            Liste der Kategorien
            </h1>

            <div class="categories-list_wrapper">

            <iaixsl:choose>
                <iaixsl:when test="page/categories-list/@mode='2'">

                <ul class="categories-list_level1">
                    <iaixsl:for-each select="/shop/navigation2/item">
                    <li class="categories-list_level1">
                        <iaixsl:choose>
                        <iaixsl:when test="@link">
                            <a class="categories-list_level1">
                            <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                            <iaixsl:attribute name="title"><iaixsl:value-of select="@name"/></iaixsl:attribute>
                            <iaixsl:value-of disable-output-escaping="yes" select="@name"/>
                            </a>
                        ...
                        <iaixsl:otherwise>
                            <span class="categories-list_level1">
                            <iaixsl:value-of disable-output-escaping="yes" select="@name"/>
                            </span>
                        </iaixsl:otherwise>
                        </iaixsl:choose>
                        <iaixsl:if test="item">
                        <span class="more_categories">
                            <iaixsl:attribute name="class">more_categories d-sm-none</iaixsl:attribute>
                            
                        </span>
                        <ul class="categories-list_level2">
                            <iaixsl:for-each select="item">
                            <li class="categories-list_level2">
                                <iaixsl:choose>
                                <iaixsl:when test="@link">
                                    <a class="categories-list_level2">
                                    <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                                    <iaixsl:attribute name="title"><iaixsl:value-of select="@name"/></iaixsl:attribute>
                                    <iaixsl:value-of disable-output-escaping="yes" select="@name"/>
                                    </a>
                                ...
                                <iaixsl:otherwise>
                                    <span class="categories-list_level2">
                                    <iaixsl:value-of disable-output-escaping="yes" select="@name"/>
                                    </span>
                                </iaixsl:otherwise>
                                </iaixsl:choose>
                                ...
                                <ul class="categories-list_level3">
                                    <iaixsl:for-each select="item">
                                    <li class="categories-list_level3">
                                        <iaixsl:choose>
                                        <iaixsl:when test="@link">
                                            <a class="categories-list_level3">
                                            <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                                            <iaixsl:attribute name="title"><iaixsl:value-of select="@name"/></iaixsl:attribute>
                                            <iaixsl:value-of disable-output-escaping="yes" select="@name"/>
                                            </a>
                                        ...
                                        <iaixsl:otherwise>
                                            <span class="categories-list_level3">
                                            <iaixsl:value-of disable-output-escaping="yes" select="@name"/>
                                            </span>
                                        </iaixsl:otherwise>
                                        </iaixsl:choose>
