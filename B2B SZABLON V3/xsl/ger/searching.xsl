...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 107421.1)-->
            ...
            <iaixsl:if test="(action/set_render/item/@name = 'popup') or not(action/set_render/item)">
                ...
                <script src="/gfx/ger/searching.js.gzip?r=1612959995"></script></head>
...
<iaixsl:if test="/shop/page/@cache_basket"/>
        ...
        <!--Wyszukiwanie zaawansowane (searching, 116383.1)-->

        <div id="searching">
            <div class="header">
                <h1 class="big_label">
                    Erweiterte Suche</h1>
                <div class="info">Um das gesuchte Produkt zu finden, wählen Sie passende Suchkriterien. Unsere Suchmaschine schränkt die Suche auf die existierenden Produkte ein.</div>
            </div>
            <div class="menu_messages_warning" id="select_products_info">
                <div class="menu_messages_warning_sub">
                    <p>Das gesuchte Produkt wurde nicht gefunden. Bitte wählen Sie andere Suchkriterien.</p>
                </div>
            </div>
            <form action="/search.php" method="get" class="searching_form" id="searching_form">
                ...
                <div id="searchingPreloader1" class="searching_wrapper">
                    <div id="searchingPreloader2" style="z-index: 100; display: none;">bitte warten...</div>
                    <div class="searching_top form-group">
                        <div class="searching_text">
                            <label for="searching_text">Suchen</label>
                        ...
                        <div class="searching_price">
                            ...
                            <div id="contener3">
                                <div class="n59070_price_sub">
                                    ...
                                    <span class="searching_price_sep"> bis</span>
                            ...
                            <div id="contener4">
                                <span class="n59070_price_label">Produkte zum Preis von</span>
                        ...
                        <div class="searching_checkboxes">
                            <span class="label">Suchen in</span>
                            <ul>
                    ...
                    <div class="searching_button_under">
                        <div class="searching_sort_cont">
                            <span class="searching_sort_text">Sortieren nach:</span>
                                ...
                                <select class="searching_engine_traits" name="sort" id="sort">
                                    ...
                                    <option value="date">
                                        <iaixsl:if test="page/searching/completed/sort/@type = 'date'">
                                            <iaixsl:attribute name="selected">selected</iaixsl:attribute>
                                        </iaixsl:if>Datum der Hinzufügung
                                    </option>
                                    <option value="name">
                            ...
                            <span class="searching_sort_radios">
                                ...
                                <label for="searching_dsc">Aufsteigend</label>
                                ...
                                <label for="searching_asc">Absteigend</label>
                            </span>
                            <button class="btn --solid --medium searching_button_under" type="submit">
                                Suche</button>
                        </div>
                    </div>
                </div>
        ...
        <script class="ajaxLoad">
            <iaixsl:choose>
                <iaixsl:when test="/shop/page/communicates">
