...
<iaixsl:if test="/shop/page/@cache_basket"/>
    ...
    <!--Reklamacja sposób zwrotu (rma_repayments_form, 107849.1)-->
        ...
        <iaixsl:if test="page/@type = 'return_products' and page/@display = 'repayment'">
            ...
            <iaixsl:variable name="n83521_shipping_title">Kostenlose Lieferung zum Geschäft</iaixsl:variable>
                                    ...
                                    <div class="return_form">
                                                    ...
                                                    <iaixsl:when test="@id = 'cashback'">
                                                        ...
                                                        <iaixsl:choose>
                                                            <iaixsl:when test="@payment_system">
                                                                Das Zahlungsabwicklungssystem ist<span><iaixsl:value-of select="@payment_system"/>.</span>
                                                            </iaixsl:when>
                                                            <iaixsl:otherwise/>
                                                        </iaixsl:choose>
                                                    </iaixsl:when>
                                        ...
                                        <iaixsl:if test="$n83521_shipping_title and @id = 't' and  /shop/page/repayment_methods/@shipping_balanced_refund = 'true'">
                                            <div class="n69372_shipping_balance">
                                                ...
                                                <div>
                                                    Bei der Wahl der <b>Kostenerstattung auf das Kundensaldo.</b><br/>Für die gewählte Erstattungsform.
                                                </div>
                                            </div>
                                        </iaixsl:if>
