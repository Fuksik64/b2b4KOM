...
<iaixsl:if test="/shop/page/@cache_basket"/>
        ...
        <!--Zwroty list (returns_list_form, 69370.1)-->
    ...
    <!--Zwroty lista CMS (returns_list_cms, 69371.1)-->
...
<div class="client_order">
    ...
    <iaixsl:choose>
        <iaixsl:when test="/shop/page/returns/item">
            <table class="orders" cellspacing="0" cellpadding="0" >
                ...
                <thead>
                    <tr id="orders_header">
                        ...
                        <td class="ord3" id="orders_head_3">Zahlbetrag</td>

                        <td class="ord3" id="orders_head_5">Status</td>
                        <td class="ord3" id="orders_head_6">Einzelheiten</td>
                    </tr>
                </thead>
                <tbody>
                    <iaixsl:for-each select="/shop/page/returns/item">
                        <tr>
                            <td class="ord">
                                <iaixsl:choose>
                            ...
                            <td>
                             ...
                             <td class="ord">
                                <a class="orders_more"><iaixsl:attribute name="href"><iaixsl:value-of select="@url"/></iaixsl:attribute>mehr...</a>
                            </td>
                        </tr>
                    </iaixsl:for-each>
                </tbody>
        ...
        <iaixsl:otherwise>
            <div class="return_list_noitem menu_messages_message" id="return_list_noitem">Es wurde noch keine Retoure hinzugefügt.</div>
        </iaixsl:otherwise>
    </iaixsl:choose>
</div>
