...
<iaixsl:if test="/shop/page/@cache_basket"/>
        ...
        <!--Agregator zbierania opinii (opinions_add_aggregator, 109124.1)-->
			<section id="opinion_order" class="opinion_order">
				<h2 class="headline">
					<span class="headline__name">Bewerten Sie Ihre Bestellung Nr. <iaixsl:value-of select="/shop/page/opinions/@order_id"/></span>
				</h2>
				<form class="opinion_order__form" action="/ajax/opinions.php?action=insert" method="POST">
					<input name="email" type="hidden">
						<iaixsl:attribute name="value"><iaixsl:value-of select="/shop/page/opinions/sender/@email"/></iaixsl:attribute>
					</input>
					...
					<input name="sourceId" type="hidden">
						<iaixsl:attribute name="value"><iaixsl:value-of select="/shop/page/opinions/@order_id"/></iaixsl:attribute>
					</input>
					<input name="language" type="hidden">
						<iaixsl:attribute name="value"><iaixsl:value-of select="/shop/page/opinions/@language"/></iaixsl:attribute>
					</input>
					<input name="sourceType" type="hidden" value="o"/>

					<div class="note_wrapper">
						<span class="note_invitation">
							<span class="note_invitation_desktop">Wir würden uns freuen, wenn Sie auf einer Skala von 1 (tragisch) bis 5 (sehr gut und schnell) die Durchführung Ihrer Bestellung bewerten könnten. Bitte geben Sie uns eine subjektive, aber faire Bewertung dessen, was wir als Geschäft tatsächlich beeinflusst haben. Wenn Sie Ihre Bestellung mit 1, 2 oder 3 Sternen bewerten, schreiben Sie uns bitte unbedingt Ihren Kommentar, damit wir wissen, was wir bei zukünftigen Bestellungen verbessern können.</span>
							<span class="note_invitation_mobile">Wie bewerten Sie Ihre Bestellung?</span>
						</span>

						<div class="notes">
							<iaixsl:variable name="opinion_order_stars"><iaixsl:value-of select="page/opinions/opinion_order/notes/note[@selected='true']/@value"/></iaixsl:variable>
							<iaixsl:for-each select="page/opinions/opinion_order/notes/note">
								<a href="#" class="opinion_star">
									<iaixsl:choose>
										<iaixsl:when test="$opinion_order_stars =''">
											<iaixsl:attribute name="class">opinion_star active</iaixsl:attribute>
										</iaixsl:when>
										<iaixsl:when test="not(@value > $opinion_order_stars)">
											<iaixsl:attribute name="class">opinion_star active</iaixsl:attribute>
										</iaixsl:when>
									</iaixsl:choose>
									...
									<span><i class="icon-star"/></span>
								</a>
							</iaixsl:for-each>
							<strong class="notes_note">
								<iaixsl:choose><iaixsl:when test="not($opinion_order_stars = '')"><iaixsl:value-of select="$opinion_order_stars"/></iaixsl:when><iaixsl:otherwise>5</iaixsl:otherwise></iaixsl:choose>/<iaixsl:value-of select="count(page/opinions/opinion_order/notes/note)"/>
							</strong>
							<input name="rating" type="hidden">
								<iaixsl:attribute name="value"><iaixsl:choose><iaixsl:when test="not($opinion_order_stars = '')"><iaixsl:value-of select="$opinion_order_stars"/></iaixsl:when><iaixsl:otherwise>5</iaixsl:otherwise></iaixsl:choose></iaixsl:attribute>
							</input>

							
							<iaixsl:if test="/shop/page/opinions/@order_evaluation_loyalty_points and not(/shop/page/opinions/@order_evaluation_loyalty_points = '')">
								<span class="notes_points">
									<iaixsl:text>+ </iaixsl:text>
									<iaixsl:choose>
										<iaixsl:when test="substring-after(/shop/page/opinions/@order_evaluation_loyalty_points, '.') = '00'">
											<iaixsl:value-of select="substring-before(/shop/page/opinions/@order_evaluation_loyalty_points, '.')"/>
										</iaixsl:when>
										<iaixsl:otherwise>
											<iaixsl:value-of select="/shop/page/opinions/@order_evaluation_loyalty_points"/>
										</iaixsl:otherwise>
									</iaixsl:choose>
									Pkt.
								</span>
					...
					<div class="f-group">
						<div class="has-feedback">
							<textarea class="f-control" name="opinion"><iaixsl:value-of select="page/opinions/opinion_order/text"/></textarea>
							<label class="f-label">Schreiben Sie ein paar Worte dazu, wie Sie Ihren Auftrag bewerten</label>

							
							<iaixsl:if test="/shop/page/opinions/@order_review_loyalty_points and not(/shop/page/opinions/@order_review_loyalty_points = '')">
								<strong class="opinions_points">
									<iaixsl:text>+ </iaixsl:text>
									<iaixsl:choose>
										<iaixsl:when test="substring-after(/shop/page/opinions/@order_review_loyalty_points, '.') = '00'">
											<iaixsl:value-of select="substring-before(/shop/page/opinions/@order_review_loyalty_points, '.')"/>
										</iaixsl:when>
										<iaixsl:otherwise>
											<iaixsl:value-of select="/shop/page/opinions/@order_review_loyalty_points"/>
										</iaixsl:otherwise>
									</iaixsl:choose>
									Pkt.
								</strong>
						...
						<iaixsl:if test="/shop/page/opinions/@order_sum_loyalty_points and not(/shop/page/opinions/@order_sum_loyalty_points = '')">
							<div class="opinions_points_sum">
								Für die Bewertung dieser Bestellung können Sie insgesamt 
								<strong>
									<iaixsl:choose>
										<iaixsl:when test="substring-after(/shop/page/opinions/@order_sum_loyalty_points, '.') = '00'">
											<iaixsl:value-of select="substring-before(/shop/page/opinions/@order_sum_loyalty_points, '.')"/>
										</iaixsl:when>
										<iaixsl:otherwise>
											<iaixsl:value-of select="/shop/page/opinions/@order_sum_loyalty_points"/>
										</iaixsl:otherwise>
									</iaixsl:choose>
									Pkt.
								</strong>
								in unserem Treueprogramm sammeln.
							</div>
						</iaixsl:if>
					</div>

					<div class="f-button">
						<button class="btn --medium --solid" type="submit">Schreiben Sie ein paar Worte dazu, wie Sie Ihren Auftrag bewerten</button>
					</div>
				</form>
			</section>
			<section id="opinion_products" class="opinion_products">
				<h2 class="headline">
					<span class="headline__name">Sie können einzelne Produkte aus der folgenden Bestellung bewerten</span>
				</h2>
				<iaixsl:for-each select="/shop/page/opinions/opinions_products/opinion_product">
					<form class="opinion_products__form" action="/ajax/opinions.php?action=insert" method="POST">
						<input name="sourceType" type="hidden" value="p"/>
						<input name="orderSerialNumber" type="hidden">
							<iaixsl:attribute name="value"><iaixsl:value-of select="/shop/page/opinions/@order_id"/></iaixsl:attribute>
						</input>
						<input name="email" type="hidden">
							<iaixsl:attribute name="value"><iaixsl:value-of select="/shop/page/opinions/sender/@email"/></iaixsl:attribute>
						...
						<div class="opinion_products__wrapper">
							<div class="opinion_products__block --product mb-4 col-md-4 mb-md-0">
								<div class="product_name"><iaixsl:value-of select="@name"/></div>
								<div class="product_icon">
									<img>
										<iaixsl:attribute name="src"><iaixsl:value-of select="@product_photo"/></iaixsl:attribute>
										<iaixsl:attribute name="alt"><iaixsl:value-of select="@name"/></iaixsl:attribute>
										<iaixsl:attribute name="title"><iaixsl:value-of select="@name"/></iaixsl:attribute>
									</img>
								</div>
							</div>
							<div class="opinion_products__block --opinion col-md-8">
								<div class="notes">
									<iaixsl:variable name="opinion_order_stars"><iaixsl:value-of select="notes/note[@selected='true']/@value"/></iaixsl:variable>
									<iaixsl:for-each select="notes/note">
										<a href="#" class="opinion_star">
											<iaixsl:choose>
												<iaixsl:when test="$opinion_order_stars = ''">
													<iaixsl:attribute name="class">opinion_star active</iaixsl:attribute>
									...
									<strong class="notes_note">
										<iaixsl:choose><iaixsl:when test="not($opinion_order_stars = '')"><iaixsl:value-of select="$opinion_order_stars"/></iaixsl:when><iaixsl:otherwise>5</iaixsl:otherwise></iaixsl:choose>/<iaixsl:value-of select="count(notes/note)"/>
									</strong>
									<input name="rating" type="hidden">
										<iaixsl:attribute name="value"><iaixsl:choose><iaixsl:when test="not($opinion_order_stars = '')"><iaixsl:value-of select="$opinion_order_stars"/></iaixsl:when><iaixsl:otherwise>5</iaixsl:otherwise></iaixsl:choose></iaixsl:attribute>
									</input>
									...
									<iaixsl:if test="/shop/page/opinions/@product_evaluation_loyalty_points and not(/shop/page/opinions/@product_evaluation_loyalty_points = '')">
										<span class="notes_points">
											<iaixsl:text>+ </iaixsl:text>
											<iaixsl:choose>
												<iaixsl:when test="substring-after(/shop/page/opinions/@product_evaluation_loyalty_points, '.') = '00'">
													<iaixsl:value-of select="substring-before(/shop/page/opinions/@product_evaluation_loyalty_points, '.')"/>
												</iaixsl:when>
												<iaixsl:otherwise>
													<iaixsl:value-of select="/shop/page/opinions/@product_evaluation_loyalty_points"/>
												</iaixsl:otherwise>
											</iaixsl:choose>
											Pkt.
										</span>
								...
								<div class="f-group">
									<div class="has-feedback">
										<textarea class="f-control" name="opinion"><iaixsl:value-of select="text"/></textarea>
										<label class="f-label">Schreiben Sie Ihre Meinung zum Produkt</label>

										
										<iaixsl:if test="/shop/page/opinions/@product_review_loyalty_points and not(/shop/page/opinions/@product_review_loyalty_points = '')">
											<strong class="opinions_points">
												<iaixsl:text>+ </iaixsl:text>
												<iaixsl:choose>
													<iaixsl:when test="substring-after(/shop/page/opinions/@product_review_loyalty_points, '.') = '00'">
														<iaixsl:value-of select="substring-before(/shop/page/opinions/@product_review_loyalty_points, '.')"/>
													</iaixsl:when>
													<iaixsl:otherwise>
														<iaixsl:value-of select="/shop/page/opinions/@product_review_loyalty_points"/>
													</iaixsl:otherwise>
												</iaixsl:choose>
												Pkt.
											</strong>
								...
								<div class="opinion_products__photo d-md-flex">
									<iaixsl:if test="image/@enabled='true'">
										<div class="opinion_add_photos_wrapper">
											<div class="opinion_add_photos">
												<span class="opinion_add_photos_text">
													<i class="icon-file-image"></i>  Fügen Sie Ihr eigenes Produktfoto hinzu:
												</span>
												<input class="opinion_add_photo f-control" type="file" name="opinion_photo">
												...
												<iaixsl:if test="/shop/page/opinions/@product_photo_loyalty_points and not(/shop/page/opinions/@product_photo_loyalty_points = '')">
													<strong class="opinions_points">
														<iaixsl:text>+ </iaixsl:text>
														<iaixsl:choose>
															<iaixsl:when test="substring-after(/shop/page/opinions/@product_photo_loyalty_points, '.') = '00'">
																<iaixsl:value-of select="substring-before(/shop/page/opinions/@product_photo_loyalty_points, '.')"/>
															</iaixsl:when>
															<iaixsl:otherwise>
																<iaixsl:value-of select="/shop/page/opinions/@product_photo_loyalty_points"/>
															</iaixsl:otherwise>
														</iaixsl:choose>
														Pkt.
													</strong>
											...
											<iaixsl:if test="/shop/page/opinions/@product_photo_loyalty_points">
												<div class="opinions_points_picture">
													Fügen Sie Ihr eigenes Foto von diesem Produkt hinzu <br/> und verdienen Sie
													<strong>
														<iaixsl:choose>
															<iaixsl:when test="substring-after(/shop/page/opinions/@product_photo_loyalty_points, '.') = '00'">
																<iaixsl:value-of select="substring-before(/shop/page/opinions/@product_photo_loyalty_points, '.')"/>
													...
													zusätzliche Punkte in unserem Treueprogramm.
												</div>
											</iaixsl:if>
										</div>
									</iaixsl:if>
									...
									<div class="f-button">
										<button class="btn --medium --solid" type="submit">Senden</button>
									</div>
								</div>
							</div>
						</div>
						<iaixsl:if test="/shop/page/opinions/@product_sum_loyalty_points and not(/shop/page/opinions/@product_sum_loyalty_points = '')">
							<div class="opinions_points_sum">
								Für die Bewertung dieses Produkts können Sie insgesamt 
								<strong>
									<iaixsl:choose>
										<iaixsl:when test="substring-after(/shop/page/opinions/@product_sum_loyalty_points, '.') = '00'">
											<iaixsl:value-of select="substring-before(/shop/page/opinions/@product_sum_loyalty_points, '.')"/>
										</iaixsl:when>
										<iaixsl:otherwise>
											<iaixsl:value-of select="/shop/page/opinions/@product_sum_loyalty_points"/>
										</iaixsl:otherwise>
									</iaixsl:choose>
									Pkt.
								</strong>
								in unserem Treueprogramm erhalten.
							</div>
						</iaixsl:if>
					</form>
				</iaixsl:for-each>
			</section>
			<iaixsl:if test="/shop/page/opinions/@id"> </iaixsl:if>
...
<!--Menu powiadomienia (menu_notice, 107640.1)-->
        ...
        <!--Elementy dodawane dynamicznie (menu_dynamically_added_content, 106830.1)-->
            ...
            <script src="/gfx/ger/opinions_add_aggregator.js.gzip?r=1612959995"></script>
            <script>
                app_shop.runApp();
            </script>
