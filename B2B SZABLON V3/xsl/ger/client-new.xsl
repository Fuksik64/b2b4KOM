    ...
    <!--Błędy i informacje w projektorze (menu_messages, 106608.1)-->
        ...
        <!--Cms na stronę dodawania konta (client-new) (client_new_cms, 107668.1)-->
            <iaixsl:if test="page/text/body">
                <iaixsl:variable name="loginedit_cms_label">Zusätzliche Informationen</iaixsl:variable>
        ...
        <iaixsl:if test="not(login_options/service[@connected='true'])">
                        ...
                        <div id="client_new_social">
                            ...
                            <iaixsl:if test="/shop/page/client-data/@edit='true'">
                                <h2>
                                    ...
                                    Verbinden Sie das Konto im Shop, indem Sie ein existierendes Konto in einem anderen Internet-Service nutzen
                                </h2>
                            </iaixsl:if>
                            ...
                            <div class="client_new_social_sub">
                                ...
                                <iaixsl:if test="page/client-data/@allow_register = 'false'">
                                    <div class="client_new_form_info" id="client_new_form_info">
                                        Loggen Sie sich unter Verwendung einer der folgenden Formen ein, um die Registrierung abzuschließen.
                                    </div>
                                </iaixsl:if>
            ...
            <iaixsl:choose>
                <iaixsl:when test="/shop/page/communicates/message/@type='login_connect'">
                    <div style="display:none;">
                        <div id="client_new_social_info">
                            <h2>Verbinden des Kontos beim Service  <iaixsl:value-of select="/shop/page/communicates/message/@value"/></h2>
                            <strong>
                                Die Informationen zu Ihrem Konto beim folgenden Service wurden erfolgreich heruntergeladen: <iaixsl:value-of select="/shop/page/communicates/message/@value"/>. <br/><br/>Bitte ergänzen Sie die fehlenden Daten und beenden Sie die Registrierung.
                            </strong>
                ...
                <iaixsl:when test="/shop/page/communicates/message/@type='login_connected'">
                    <div style="display:none;">
                        <div id="client_new_social_info">
                            <h2>Verbinden des Kontos bei dem Service  <iaixsl:value-of select="/shop/page/communicates/message/@value"/></h2>

                            <strong>
                                Ihr Konto im Shop wurde mit dem Konto beim folgenden Service erfolgreich verknüpft: <iaixsl:value-of select="/shop/page/communicates/message/@value"/>. <br/><br/>Gehen Sie zum Registrierungsformular und überprüfen Sie Ihre Daten.
		...
		<iaixsl:variable name="data_edit_blocked">Ein Teil der Daten ist nur für Shopbetreiber bearbeitet werden</iaixsl:variable>
				...
				<div class="col-12" id="client_new_client">
					...
					<iaixsl:choose>
						...
						<iaixsl:when test="/shop/page/client-data/@operation = 'register-wholesale-add' and /shop/action/registration_options/retail">
							<div class="cn_wrapper choose_other_form">
								<i class="icon-register-card"></i> Sind Sie ein Privatkunde? Verwenden Sie das <a>
									...
									<iaixsl:attribute name="title">Klicken Sie hier, um zum vereinfachten Registrierungsformular zu gelangen</iaixsl:attribute>
									vereinfachte Registrierungsformular
								</a>
							</div>
						</iaixsl:when>
					</iaixsl:choose>
									...
									<div class="has-feedback col-12">
										<select class="form-control" name="client_province">
											...
											<iaixsl:if test="not(provinces/province/@id = /shop/page/client-data/invoice_data/@province or provinces/province/@selected)">
												<option disabled="disabled" selected="selected" value="no_province">
													Wählen Sie 
													<iaixsl:choose>
														<iaixsl:when test="province_types/type/text() = 'state'"> Bundesstaat</iaixsl:when>
														<iaixsl:when test="province_types/type/text() = 'province'"> Provinz</iaixsl:when>
														<iaixsl:when test="province_types/type/text() = 'territory'"> Territorium</iaixsl:when>
										...
										<label for="client_province" class="control-label">
											<iaixsl:for-each select="province_types/type">
												<iaixsl:choose>
													<iaixsl:when test="text() = 'state'">Bundesstaat</iaixsl:when>
													<iaixsl:when test="text() = 'province'">Provinz</iaixsl:when>
													<iaixsl:when test="text() = 'territory'">Territorium</iaixsl:when>
													<iaixsl:otherwise>Region</iaixsl:otherwise>
						...
						<div class="login_box cn_wrapper">
							...
							<div class="form-group row">
								...
								<div class="form-desc col-12">
									Das Login muss mindestens 3 und maximal 40 Zeichen (nur Buchstaben oder Zahlen) enthalten.
								</div>
							</div>
							...
							<iaixsl:if test="page/client-data/@action = 'password_token' and $client_new_mode = 'edit'">
								<p class="no_password_social_text">
									<iaixsl:attribute name="style">display:none;</iaixsl:attribute>
									<b>Sie müssen sich Ihr Passwort nicht merken.</b> Verknüpfen Sie Ihr Geschäftskonto mit Ihrem Konto auf einer der folgenden Websites und melden Sie sich beim nächsten Einkauf an.
								</p>
							</iaixsl:if>
				...
				<div class="col-6">
					...
					<div class="clientnew_regulations">
						...
						<iaixsl:if test="($client_new_mode = 'edit') and login_options/service[@connected='true']">
							<div class="form-group">
								<div class="col-12">
									<label> Ihr Konto ist mit dem Konto beim folgenden Service verknüpft: <iaixsl:value-of select="login_options/service[@connected='true']/@name"/></label>
						...
						<iaixsl:if test="not(/shop/contact/owner/@vat_registered = 'false')">
							<div class="checkbox">
								<label>
									...
									</input>Ich bin ein EU-Mehrwertsteuerzahler. Ich bestelle ohne Mehrwertsteuer und verpflichte mich dazu, die Mehrwertsteuer in meinem eigenen Land abzurechnen.
								</label>
							</div>
						</iaixsl:if>
						<iaixsl:choose>
						...
						<div class="form-group">
							<div class="checkbox">
								<label>
									...
									</input>  Ja, ich möchte den E-Mail Newsletter abonnieren (der Newsletter-Service kann jederzeit wieder abbestellt werden)
								</label>
							</div>
						</div>
							...
							<div class="form-group">
								<div class="checkbox">
									<label>
										...
										</input>  Ja, ich möchte den SMS-Newsletter erhalten (SMS-Newsletter kann jederzeit wieder abbestellt werden)<br/><br/>
                    ...
                    <div class="col-sm-6 col-12">
                        <iaixsl:choose>
                            ...
                            <iaixsl:when test="/shop/page/client-data/@active_card and not(/shop/page/client-data/@active_card='')">
                                <div class="form-group">
                                    <span class="rebate_card_header">Ihre Rabattkarte ist aktiv!</span>
                                ...
                                <p class="rebate_card_desc">
                                    Sie kӧnnen die aktive Rabattkarte wechseln. Geben Sie bitte die neue Nummer oben ein. Gehen Sie zu Ihrer Rabattliste und prüfen Sie <a href="/client-rebate.php" title="Twoje rabaty">die Details</a> der gewährten Rabatte. 
                                </p>
                            </iaixsl:when>
                            <iaixsl:otherwise>
                                <div class="form-group">
                                ...
                                <p class="rebate_card_desc">
                                    Wenn Sie unsere Plastikrabattkarte haben, geben Sie bitte die Nummer ein. Auf diese Weise erhalten Sie die gleichen Rabatte wie in unseren traditionellen Läden.
                                </p>
                            </iaixsl:otherwise>
                        </iaixsl:choose>
                    </div>
...
<!--Menu powiadomienia (menu_notice, 107640.1)-->
        ...
        <!--Elementy dodawane dynamicznie (menu_dynamically_added_content, 106830.1)-->
            ...
            <script src="/gfx/ger/client_new_form.js.gzip?r=1612959995"></script>
            <script>
                app_shop.runApp();
            </script>
