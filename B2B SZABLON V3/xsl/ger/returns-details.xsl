                        ...
                        <div class="prepaid-status">
                            <strong>
                                <iaixsl:choose>
                                    ...
                                    <iaixsl:when test="page/details/@status=13">
                                        Rückgabe abgelehnt – Umtausch des Produkts gegen eine anderes
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=14">
                                        Rückgabe nicht empfangen
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=15">
                                        Der Kunde hat die Rückgabe generiert
                                    </iaixsl:when>
                        ...
                        <div class="prepaid-buttons">
                            <iaixsl:if test="/shop/page/editlink/@url">
                                <a class="btn-icon prepaid-edit">
                                    ...
                                    <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/editlink/@url"/></iaixsl:attribute><small><i class="icon-pencil"></i></small><span>ändern Beschwerde</span></a>
                            </iaixsl:if>
                            <iaixsl:if test="/shop/page/cancellink/@url">
                                <a class="btn-icon prepaid-cancel orderdetails_info_cancel">
                                    ...
                                    <small><i class="icon-remove"></i></small><span>Abbrechen Beschwerde</span>
                                </a>
                            </iaixsl:if>
                        </div>
                    </div>
                ...
                <iaixsl:choose>
                    <iaixsl:when test="/shop/page/return_method/@id='2' and $n5_4atxt">
                        <div class="return_image_i">
                            <div class="text-1a">Drucken Sie das Rücksendeformular und das Rücksendeetikett aus</div>
                            <div class="text-2a">Bereiten Sie das Paket für den Versand vor <small>Legen Sie Ihrer Rücksendung sowohl das Rücksendeformular als auch den Kaufbeleg bei</small></div>
                    ...
                    <iaixsl:otherwise>
                        <div class="return_image_i">
                            <div class="text-1">Drucken Sie das Rücksendeformular und das Rücksendeetikett aus</div>
                            <div class="text-2">Bereiten Sie das Paket für den Versand vor<small>Legen Sie Ihrer Rücksendung sowohl das Rücksendeformular als auch den Kaufbeleg bei</small></div>
                ...
                <iaixsl:if test="/shop/page/repayment_method or /shop/page/return_method">
                    <div class="returns_details_wrapper">
                        <table class="returns_details_table">
                            <tbody>
                                <tr>
                                    <th class="returns_details_name">Rückerstattungs- und Versandart
                                    </th>
...
<iaixsl:when test="/shop/page/return_method/@description">
                                                    <span class="product_name">Versandart:
                                                        <iaixsl:value-of select="/shop/page/return_method/@name"/>
                                                    </span>
                                        ...
                                        <td class="returns_details_name float_icon">
                                            ...
                                            <iaixsl:choose>
                                                <iaixsl:when test="/shop/page/repayment_method/@id = 't'">
                                                    <span class="product_name">Rückerstattungsart: Kundensaldo</span>
                                                ...
                                                <iaixsl:when test="/shop/page/repayment_method/@id = 'b'">
                                                    <span class="product_name">Rückerstattungsart: Überweisung</span>
                                                    <div class="return_description">
                                                ...
                                                <iaixsl:when test="/shop/page/repayment_method/@id = 'tc'">
                                                    <span class="product_name">Rückerstattungsart: Handelskredit wiederherstellen</span>
                                                    <div class="return_description">
                ...
                <iaixsl:if test="/shop/page/remarks">
                    <div class="returns_details_wrapper">
                        <h2 class="big_label">Bemerkungen an den Shop
                        </h2>
                ...
                <iaixsl:variable name="txt_54116_1">Dokumente, die für diese Rückgabe ausgestellt wurden</iaixsl:variable>
                    ...
                    <div class="basketedit_summary_right">
                        <div class="basketedit_calculations">
                            ...
                            <iaixsl:if test="/shop/page/costs/cost[@type='shipping']/@value_formatted">
                                <div class="basketedit_product_summary">
                                    <label>Kosten für den Kurierversand:
                                    </label>
