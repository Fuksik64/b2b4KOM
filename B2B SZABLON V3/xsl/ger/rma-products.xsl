    ...
    <!--Rma lista produktów (rma_products_list, 112667.1)-->
        ...
        <iaixsl:if test="page/@type = 'rma_products' and page/@display = 'add'">
            <div class="step2">
                ...
                <iaixsl:variable name="return_with_special_offer">Sie erheben eine Beanstandung einer Bestellung, auf die Rabatt gewährt wurde. Der Beanstandungswert wird unter Berücksichtigung dieses Rabatts berechnet und entsprechend reduziert, je nach der zurückgegebenen Ware. Bei Problemen kontaktieren Sie bitte das Personal des Geschäfts. </iaixsl:variable>
                                                ...
                                                <iaixsl:when test="@allowReturn='0'">
                                                    ...
                                                    <div class="productslist_product_info d-sm-none">
                                                        <div class="btn-icon allowReturn_1">
                                                            ...
                                                            <span>Diese Ware können Sie wahrscheinlich nicht beanstanden. Falls notwendig, bitte <a href='/contact.php'>kontaktieren Sie uns</a>. </span>
                                                        </div>
                                                    </div>
                                                </iaixsl:when>
                                                <iaixsl:when test="@allowReturn='2'">
                                                    ...
                                                    <div class="productslist_product_info d-sm-none">
                                                        <div class="btn-icon allowReturn_2">
                                                            ...
                                                            <span>Vergewissern Sie sich, ob Sie diese Ware beanstanden können. Beachten Sie insbesondere den Tag, an dem Sie die Ware erhalten haben, sowie die Garantiefrist. <a href='/#'>Ich möchte beanstanden</a>. </span>
                                                        </div>
                                                    </div>
                                                </iaixsl:when>
                                            </iaixsl:choose>
                                            ...
                                            <td class="productslist_product_warranty">
                                                ...
                                                <iaixsl:if test="not(warranty/@gfx)">
                                                    <div class="productslist_warranty">
                                                        ...
                                                        <img class="qmark2 showTip" src="/gfx/ger/qmark2.gif?r=1612959995" alt="" title=""/>
                                        ...
                                        <td class="productslist_product_comment">
                                            <iaixsl:if test="not(@allowReturn='0') and not(@allowReturn='2')">
                                                <a href="#addComment">
                                                    ...
                                                    <i class="icon-paper-clip"></i> <span>Beschreibung des Problems</span>
                                                </a>
                                            </iaixsl:if>
                                        </td>
