...
<iaixsl:if test="/shop/page/@cache_basket"/>
        ...
        <!--opinie - zdjęcia - wyświetlanie (opinions_photos_display, 116167.1)-->
		<iaixsl:choose>
		<iaixsl:when test="count(page/opinions-photos/opinions/opinion[@image_small or @image_large]) > 0">

			<div id="opinions">
				<h1 class="big_label">Inspirationen und Fotos von Kunden</h1>
				<p class="opinions-description">
					Möchten Sie Ihr Foto hinzufügen? Sie können dies tun, indem Sie eine Bewertung schreiben und Ihr Foto zu einem der Produkte hinzufügen. Um solche Produkte schneller zu finden, verwenden Sie bitte
					<a href="/products-bought.php">Liste der gekauften Produkte</a>.
					<iaixsl:if test="page/opinions-photos/opinions/@product_photo_loyalty_points">
					<br/>

						Sie erhalten von uns für jede Meinung ein Foto
						<iaixsl:value-of select="page/opinions-photos/opinions/@product_photo_loyalty_points"/> 
						Punkt. im Treueprogramm.
					</iaixsl:if>
					
				</p>
				<div id="opinions_wrapper" class="opinions_wrapper row">
					<iaixsl:for-each select="page/opinions-photos/opinions/opinion[@image_small or @image_large]">
						<div class="opinion_item">
						<div class="opinion_item_sub">
								
								<a class="opinion-icon">
									<iaixsl:attribute name="href"><iaixsl:value-of select="product/@link"/></iaixsl:attribute>
									<iaixsl:attribute name="title"><iaixsl:value-of select="product/@name"/></iaixsl:attribute>
									<img src="/gfx/ger/loader.gif?r=1612959995" class="b-lazy">
										<iaixsl:attribute name="data-src"><iaixsl:value-of disable-output-escaping="yes" select="@image_large"/></iaixsl:attribute>
										<iaixsl:attribute name="alt"><iaixsl:value-of disable-output-escaping="yes" select="product/@name"/></iaixsl:attribute>
									</img>
								</a>
								<div class="note-wrapper">
									...
									<div class="opinion_author">
										<iaixsl:if test="client/@client">
											<span><iaixsl:value-of select="client/@client"/></span>
										</iaixsl:if>
									</div>
										
									<div class="opinion_content --txtToSplit">
											<iaixsl:if test="content != ''">
							<iaixsl:value-of disable-output-escaping="yes" select="content"/>
											</iaixsl:if>
										</div>
								</div>
								<div class="opinion-hover">
									<div class="product-img">
											<img>
												<iaixsl:attribute name="src"><iaixsl:value-of disable-output-escaping="yes" select="product/icon_small"/></iaixsl:attribute>
											</img>
									</div>
									<div class="product-info">
										<span class="product-name"><iaixsl:value-of select="product/@name"/></span>
										<a class="see-product">
												<iaixsl:attribute name="href"><iaixsl:value-of select="product/@link"/></iaixsl:attribute>
												<iaixsl:attribute name="title"><iaixsl:value-of select="product/@name"/></iaixsl:attribute>
												Produkt anzeigen
					...
					<div id="opinions_paging_bottom">
					    
					    	<iaixsl:choose>
							    <iaixsl:when test="page/opinions-photos/navigation/next">
							        <a class="next d-none">
        								<iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="page/opinions-photos/navigation/path/@value"/><iaixsl:value-of select="page/opinions-photos/navigation/next/@counter"/></iaixsl:attribute>
        						    </a>
    							</iaixsl:when>
                        		<iaixsl:otherwise>
                        		    <iaixsl:attribute name="class">--last d-none</iaixsl:attribute>
                        		</iaixsl:otherwise>
                        	</iaixsl:choose>
						</div>
		...
		<iaixsl:otherwise>
			<div id="opinions" class="d-flex flex-column align-items-center --empty">
				<div class="opinions_icon_wrapper"><i class="icon-opinions-empty"></i></div>
				<h1 class="big_label">Bisher hat noch niemand seine Produktfotos hinzugefügt</h1>
				<p class="opinions-description">
				    <span class="d-block">Möchten Sie die erste Person sein und auf diese Weise in die Geschichte unseres Geschäfts einsteigen?</span>
					Fügen Sie Ihrer Bewertung eines Produkts ein Bild hinzu. Um solche Produkte schneller zu finden, verwenden Sie bitte
					<a href="/products-bought.php">Liste der gekauften Produkte</a>.
					<iaixsl:if test="false">
...
<!--Menu powiadomienia (menu_notice, 107640.1)-->
        ...
        <!--Elementy dodawane dynamicznie (menu_dynamically_added_content, 106830.1)-->
            ...
            <script src="/gfx/ger/opinions_photos_display.js.gzip?r=1612959995"></script>
            <script>
                app_shop.runApp();
            </script>
