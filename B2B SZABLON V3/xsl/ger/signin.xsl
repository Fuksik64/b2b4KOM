            ...
            <div id="signin-form_box_left" class="signin-form_box col-md-8 col-sm-7 col-12">
                    ...
                    <iaixsl:when test="not(/shop/client_data/@signin = 'cookie') and /shop/client_data/@iai_accounts = 'consent' and (not(/shop/client_data/@last_login_option = 'shop'))">
                        ...
                        <div id="cookie_login_social" class="iai_accounts">
                            <span id="cookie_login_social_desc" class="iai_accounts">
                                Von <strong>IAI Accounts</strong> über 
                                ...
                                <iaixsl:for-each select="login_options/service[not(@name='shop_register') and not(@login_url)]">
                                    <form action="login.php" method="post" style="display:none;">
                                        ...
                                        <iaixsl:if test="not(@name='OpenId')">
                                            <label><iaixsl:value-of select="@name"/><span> Benutzername</span></label>
                                        </iaixsl:if>
                            ...
                            <span id="cookie_login_social_desc">
                                <iaixsl:choose>
                                    <iaixsl:when test="not(/shop/client_data/@iai_accounts = 'consent')">
                                        <strong>Du bist schon unser Kunde. </strong>
                                        Erneut über 
                                        <iaixsl:value-of select="$social_media_name"/>
                                         einloggen
                                    </iaixsl:when>
                                ...
                                <div id="client_new_social">
                                    ...
                                    <div class="client_new_social_sub">
                                        ...
                                        <iaixsl:if test="not(page/client-data/@allow_register = 'false')">
                                            <p> Hierzu loggen Sie sich zuerst ein und dann gehen Sie zu Ihren Konto-Einstellungen, wo Sie ein Tool zum Verbinden der Konten finden werden.</p>
                                        </iaixsl:if>
                ...
                <div class="signin-form_box_sub" id="signin-form_box_sub_1">
                    <div class="signin-form_select">
                        ...
                        <input id="signin-form_radio1" type="radio" value="signin-form_box_sub_1" checked="checked" name="login_form1" data-target="login_form2"/><label for="signin-form_radio1">Benutzername und Passwort</label>
                        <input id="signin-form_radio2" type="radio" value="signin-form_box_sub_2" name="email_form1" data-target="email_form2"/><label for="signin-form_radio2">Passwort erinnern</label>
                    </div>
                    ...
                    <form action="/signin.php" method="post" novalidate="novalidate">
                        ...
                        <div class="signin_buttons col-md-10 col-12">
                            ...
                            <iaixsl:if test="/shop/client_data/@signin = 'cookie'">
                                <a class="cookie_login_social_new_account" href="/client-new.php?register&amp;wholesaler=true">Das ist nicht mein Konto und ich möchte ein neues erstellen</a>
                            </iaixsl:if>
                            <iaixsl:if test="/shop/client_data/@signin = 'cookie' and not(/shop/client_data/@last_login_option = 'shop') and count(login_options/service[not(@name = $social_media_name)]) > 0">
                                <a class="cookie_login_social_more_social" href="#more_social">Mit dem Konto aus einem anderen Netzwerk einloggen</a>
                            </iaixsl:if>
                        </div>
                    </form>
                ...
                <div class="signin-form_box_sub" id="signin-form_box_sub_2">
                    <p class="reminder_desc">An Ihre E-Mail-Adresse wird ein Link gesendet, der Sie automatisch im Shop einloggt. Hier können Sie sowohl Ihr Passwort als auch andere Daten festlegen. </p>

                    <div class="signin-form_select">
                        <h3>Log me in through</h3>
                        <input id="signin-form_radio3" type="radio" value="signin-form_box_sub_1" name="login_form2" data-target="login_form1"/><label for="signin-form_radio3">Benutzername und Passwort</label>
                        <input id="signin-form_radio4" type="radio" value="signin-form_box_sub_2" name="email_form2" data-target="email_form1" checked="checked"/><label for="signin-form_radio4">Passwort erinnern</label>
                    </div>
                    ...
                    <form class="password-recover" action="/password-recover.php" method="post" novalidate="novalidate">
                        ...
                        <div class="signin_inputs col-md-10 col-12">
                            ...
                            <div class="signin_buttons col-md-10 col-12">
                                ...
                                <a class="password_back_signin" href="#signin-form_radio1">Zurück</a>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <div class="signin-form_box_sub">
                        <iaixsl:choose>
                            <iaixsl:when test="page/actions/client_once">
                                ...
                                <p class="registration_desc">Wenn Sie noch kein Konto in unserem Shop erstellt haben, werden Sie darum gebeten, Ihre Daten anzugeben. </p>
                                <iaixsl:if test="page/actions/client_register">
                                    ...
                                    <iaixsl:if test="$register_number > 1">
                                        <div class="register_wholesaler">
                                            <i class="icon-wholesaler-register"></i> Sind sie ein großhändler? Verwenden Sie das <a>
                                                ...
                                                <iaixsl:attribute name="title">Klicken Sie hier, um zum Registrierungsformular für Großhändler zu gelangen</iaixsl:attribute>
