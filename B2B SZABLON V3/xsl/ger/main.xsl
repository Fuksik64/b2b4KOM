...
<iaixsl:if test="/shop/page/@cache_basket"/>
        ...
        <!--Banery na stronie głównej (main_banner1, 106482.3)-->
                                    ...
                                    <li>
                                        <a><iaixsl:choose>
                                            ...
                                            <iaixsl:attribute name="title"><iaixsl:value-of select="text"/></iaixsl:attribute><iaixsl:choose>
                                                <iaixsl:when test="image"><iaixsl:if test="image/@src">
                                                        <img>
                                                    ...
                                                    </iaixsl:if></iaixsl:when>
                                                <iaixsl:when test="image_desktop or image_tablet or image_mobile"><picture>
                                            ...
                                            <iaixsl:for-each select="page/hotspot/products_zone1/product[not(position() > 4)]">
                                                <li class="d-flex align-items-start">
                                                    ...
                                                    <a class="product__icon d-flex justify-content-center align-self-center align-items-center col-6">
                                                        ...
                                                        <img src="/gfx/ger/loader.gif?r=1612959995">
                                                            <iaixsl:choose>
