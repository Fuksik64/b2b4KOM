...
<iaixsl:if test="/shop/page/@cache_basket"/>
        ...
        <!--Formularz przypomnienia hasła (password-recover, 108083.1)-->

            <div id="signin_password_recovery">
                <h1 class="big_label">
                    Passwort erinnern
                </h1>
                <div class="row flex-column align-items-center ">
                    <p class="reminder_desc col-12 col-sm-6 mb-3">Damit wir Ihnen Ihr Passwort zusenden können, geben Sie bitte Ihren Benutzernamen oder die zu Ihrem Konto zugehörende E-Mail-Adresse ein. Klicken Sie dann auf "Passwort erinnern". Wir senden Ihnen Ihr aktuelles Passwort per E-Mail zu.</p>
                    <form class="password-recover col-12 col-sm-6 mb-3" action="/password-recover.php" method="post">
                        <input type="hidden" name="operation" value="recover"/>

                        <div class="form-group">
                            <div class="has-feedback">
                                <input id="signin_pass_recover_input" class="form-control" type="text" name="email"/>
                                <label class="control-label" for="signin_pass_recover_input">e-mail</label>
                            </div>
                            <div class="form-desc">
                                Geben Sie Ihre e-mail bei der Registrierung angegeben oder Treue Kartennummer: 
                            </div>
                        </div>
                        <button class="signin_password-recover btn --solid --medium" type="submit">
                            Senden
                        </button>
                    </form>

                    <div class="password_recovery_phone col-12 col-sm-6">
                        Wenn Sie Ihr Passwort vergessen haben und die mit Ihrem Konto verbundene E-Mail-Adresse nicht mehr verwenden, wenden Sie sich bitte an die Telefonnummer<b><iaixsl:text> </iaixsl:text><iaixsl:value-of select="page/login/response/@tel"/></b><iaixsl:text> </iaixsl:text>oder senden Sie uns eine E-Mail an <iaixsl:text> </iaixsl:text><a class="mail_54144"><iaixsl:attribute name="href">mailto:<iaixsl:value-of select="page/login/response/@email"/></iaixsl:attribute><iaixsl:value-of select="page/login/response/@email"/></a>.
                    </div>
                </div>
            </div>

            
            <iaixsl:if test="/shop/page/password-recover"/>
