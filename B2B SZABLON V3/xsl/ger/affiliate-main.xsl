...
<iaixsl:if test="/shop/page/@cache_basket"/>
        ...
        <!--Strona główna programu partnerskiego - CMS (affiliate_main_cms, 107749.1)-->
    <iaixsl:if test="not(page/@type='affiliate-not-active')"/>
        <div class="affiliate_main_cms_label">
            <span class="big_label affiliate_main_cms_label">
                Willkommen auf der Seite unseres Partnerprogramms
            </span>
        </div>

<iaixsl:if test="page/text/body">
        <div class="affiliate_main_cms">
            <div class="affiliate_main_cms_sub cm">
                <iaixsl:value-of disable-output-escaping="yes" select="page/text/body"/>
            </div>
        </div>
    </iaixsl:if>

    <div id="affiliate_main_menu" class="row">

      <div class="affiliate_stats col-md-6 col-sm-12" id="affiliate_stats">
        <div class="affiliate_stats_sub col-md-12">
          <h3>
              Statistics
          </h3>
          <div><i><iaixsl:attribute name="class">icon-signal</iaixsl:attribute></i>Messung der Handlungseffektivität der einzelnen Partner. Das Tool zeigt die Handlungseffektivität aller Partner an, zusammen mit der Möglichkeit, diese zu sortieren. </div>


          <a class="btn --solid">
                <iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="/shop/action/affiliateStats/@url"/></iaixsl:attribute>
              <iaixsl:if test="page/@type = 'affiliate-stats'">
                  <iaixsl:attribute name="class">activ</iaixsl:attribute>
              </iaixsl:if>
              <iaixsl:attribute name="title">Liste der Umleitungen zum Geschäft auf Ihre Empfehlung </iaixsl:attribute>
              Ihre Umleitungen 
          </a>
          <a class="btn --solid">
                <iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="/shop/action/affiliateOrders/@url"/></iaixsl:attribute>
              <iaixsl:if test="page/@type = 'affiliate-orders'">
                  <iaixsl:attribute name="class">activ</iaixsl:attribute>
              </iaixsl:if>
              <iaixsl:attribute name="title">Liste der Bestellungen von Kunden, die auf Ihre Empfehlung das Geschäft besucht haben. </iaixsl:attribute>
              Kundenbestellungen
          </a>
          <a class="btn --solid">
                <iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="/shop/action/affiliateClients/@url"/></iaixsl:attribute>
              <iaixsl:if test="page/@type = 'affiliate-clients'">
                  <iaixsl:attribute name="class">activ</iaixsl:attribute>
              </iaixsl:if>
              <iaixsl:attribute name="title">Liste der Kunden, die nach einem Besuch auf Ihre Empfehlung ein Konto eröffnet haben</iaixsl:attribute>
              Kundenliste 
          </a>
        ...
        <div class="affiliate_generator col-md-6 col-sm-12" id="affiliate_generator">
          <div class="affiliate_generator_sub col-md-12">
            <h3>
              Kode- und Bannergenerator 
            </h3>
            <div><i><iaixsl:attribute name="class">icon-cog-alt</iaixsl:attribute></i>Es besteht die Möglichkeit, zur Verwendung fertige Werbung (statische Bilder und Flash) vorzubereiten. Die Systemsteuerung erlaubt es, einen HTML Kode mit einem vorbereiteten Verbindungslink runterzuladen.  </div>
            
            <a class="btn --solid">
                <iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="/shop/action/affiliateGenerator/@url"/><iaixsl:text disable-output-escaping="yes">?generate=promoCodes</iaixsl:text></iaixsl:attribute>
                <iaixsl:if test="page/generator/@type = 'promoCodes'">
                    <iaixsl:attribute name="class">activ</iaixsl:attribute>
                </iaixsl:if>
                <iaixsl:attribute name="title">Rabatt-Codes</iaixsl:attribute>
                Rabatt-Codes
            </a>

            <a class="btn --solid">
                <iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="/shop/action/affiliateGenerator/@url"/><iaixsl:text disable-output-escaping="yes">?generate=html</iaixsl:text></iaixsl:attribute>
                <iaixsl:if test="page/generator/@type = 'html'">
                    <iaixsl:attribute name="class">activ</iaixsl:attribute>
                </iaixsl:if>
                <iaixsl:attribute name="title">HTML-Kodegenerator</iaixsl:attribute>
                HTML Kode
            </a>
            <a class="btn --solid">
                <iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="/shop/action/affiliateGenerator/@url"/><iaixsl:text disable-output-escaping="yes">?generate=php</iaixsl:text></iaixsl:attribute>
                <iaixsl:if test="page/generator/@type = 'php'">
                    <iaixsl:attribute name="class">activ</iaixsl:attribute>
                </iaixsl:if>
                <iaixsl:attribute name="title">PHP-Kodegenerator</iaixsl:attribute>
                PHP Kode
            </a>
            <a class="btn --solid">
                <iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="/shop/action/affiliateGenerator/@url"/><iaixsl:text disable-output-escaping="yes">?generate=js</iaixsl:text></iaixsl:attribute>
                <iaixsl:if test="page/generator/@type = 'js'">
                    <iaixsl:attribute name="class">activ</iaixsl:attribute>
                </iaixsl:if>
                <iaixsl:attribute name="title">JavaScript-Kodegenerator</iaixsl:attribute>
                JavaScript Kode
            </a>
          ...
          <div class="affiliate_calculations col-md-6 col-sm-12" id="affiliate_calculations">
            <div class="affiliate_calculations_sub col-md-12">
              <h3>
                Abrechnungen
              </h3>
              <div><i><iaixsl:attribute name="class">icon-users</iaixsl:attribute></i>Das Tool erlaubt es, den aktuellen Stand Ihrer Abrechnungen mit dem Geschäft zu überprüfen.</div>
  
              <a class="btn --solid">
                    <iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="/shop/action/affiliateCalculations/@url"/></iaixsl:attribute>
                  <iaixsl:if test="page/@type = 'affiliate-calculations'">
                      <iaixsl:attribute name="class">activ</iaixsl:attribute>
                  </iaixsl:if>
                  <iaixsl:attribute name="title">Transferverrechnungen auf Ihrem Partnerkonto</iaixsl:attribute>
                  Abrechnungen
              </a>
            ...
            <div class="affiliate_calculations col-md-6 col-sm-12" id="affiliate_calculations">
              <div class="affiliate_calculations_sub col-md-12">
                ...
                <div><i><iaixsl:attribute name="class">icon-credit-card</iaixsl:attribute></i>Das Tool erlaubt es, die zurückgelegten Mittel auszuzahlen oder sie gegen einen Warengutschein auszutauschen. </div>
    
                <a class="btn --solid">
                    <iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="/shop/action/affiliateResources/@url"/></iaixsl:attribute>
                    <iaixsl:if test="page/@type = 'affiliate-resources'">
                        <iaixsl:attribute name="class">activ</iaixsl:attribute>
                    </iaixsl:if>
                    <iaixsl:attribute name="title">Informationen über den Stand des Partnerkontos, Auszahlmechanismus für Mittel in Form von Warengutscheinen und Chronik der Auszahlungen </iaixsl:attribute>
                    Verfügbare Mittel 
                </a>
