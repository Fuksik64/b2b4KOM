			...
			<iaixsl:if test="/shop/page/opinions-shop/comments/@all > '0'">
									...
									<div class="opinions_shop__opinion pb-5 mb-5">
										...
										<div class="opinions_shop__opinion_bottom d-flex justify-content-between align-items-center flex-wrap">
											...
											<div class="opinions_shop__rate d-flex align-items-center ml-auto mb-2">
												...
												<a href="#thumbs_up" class="opinions_shop__thumbs --up ml-3"><i class="icon-thumbs-up-empty"></i> Ja <span class="opinions_shop__rate_count"><iaixsl:value-of select="@rate_yes"/></span></a>
												<a href="#thumbs_down" class="opinions_shop__thumbs --down ml-3"><i class="icon-thumbs-down"></i> Nein <span class="opinions_shop__rate_count"><iaixsl:value-of select="@rate_no"/></span></a>
											</div>
										</div>
				...
				<div class="opinions_shop__opinion --skeleton pb-5 mb-5">
					...
					<div class="opinions_shop__opinion_bottom d-flex justify-content-between align-items-center flex-wrap">
						...
						<div class="opinions_shop__rate d-flex align-items-center ml-auto mb-2">
							<span class="opinions_shop__rate_text">War die Meinung hilfreich?</span>
							<a href="#thumbs_up" class="opinions_shop__thumbs --up ml-3"><i class="icon-thumbs-up-empty"></i> Ja <span class="opinions_shop__rate_count"/></a>
							<a href="#thumbs_down" class="opinions_shop__thumbs --down ml-3"><i class="icon-thumbs-down"></i> Nein <span class="opinions_shop__rate_count"/></a>
						</div>
					</div>
...
<!--Menu powiadomienia (menu_notice, 107640.1)-->
        ...
        <!--Elementy dodawane dynamicznie (menu_dynamically_added_content, 106830.1)-->
            ...
            <script src="/gfx/ger/opinions_shop_display.js.gzip?r=1612959995"></script>
            <script>
                app_shop.runApp();
            </script>
