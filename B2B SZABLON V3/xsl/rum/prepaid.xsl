...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 107421.1)-->
            ...
            <iaixsl:if test="(action/set_render/item/@name = 'popup') or not(action/set_render/item)">
                ...
                <script type="text/javascript" src="/gfx/rum/orderdetails_payments.js.gzip?r=1571748615"></script></head>
...
<iaixsl:if test="page/prepaid/text/body != ''">
    ...
    <!--Informacje o zamówieniu (orderdetails_info, 110014.1)-->
            ...
            <iaixsl:variable name="prepaidProForma"><small><i class="icon-file-text"></i></small><span>Pro forma</span></iaixsl:variable>
            ...
            <div id="orderdetails_info">
                <h2 class="big_label">
                    ...
                    <iaixsl:if test="not(page/prepaid/status_explanation = '')">
                        <a href="#show_status_explanation" class="show_status_explanation"><i class="icon-question"></i></a>
                        <div style="display:none;"><iaixsl:value-of disable-output-escaping="yes" select="page/prepaid/status_explanation"/></div>
                    </iaixsl:if>
                    <span class="order-date">
                        order date: <iaixsl:value-of select="page/prepaid/details/@datetime"/>
                    </span>
                </h2>

                <div id="orderdetails_info_status">
                    <div class="prepaid-icon">
                        <iaixsl:attribute name="class">prepaid-icon status-<iaixsl:value-of select="/shop/page/prepaid/details/@wykonane"/></iaixsl:attribute>

                        <i>
                            <iaixsl:attribute name="class">
                            <iaixsl:choose>
                                <iaixsl:when test="(page/prepaid/details/@wykonane = 'n')">icon-ok</iaixsl:when>
                                <iaixsl:when test="(page/prepaid/details/@wykonane = 't')"><iaixsl:choose><iaixsl:when test="(page/prepaid/details/@personal_collection = 'yes')">icon-signin received</iaixsl:when><iaixsl:otherwise>icon-truck</iaixsl:otherwise></iaixsl:choose></iaixsl:when>
                                <iaixsl:when test="(page/prepaid/details/@wykonane = 'i')">icon-thumbs-down-alt</iaixsl:when>
                                <iaixsl:when test="(page/prepaid/details/@wykonane = 's')">icon-remove</iaixsl:when>
                                <iaixsl:when test="(page/prepaid/details/@wykonane = 'o')">icon-clock</iaixsl:when>
                                <iaixsl:when test="(page/prepaid/details/@wykonane = 'p')">icon-ok</iaixsl:when>
                                <iaixsl:when test="(page/prepaid/details/@wykonane = 'h')">icon-pause</iaixsl:when>
                                <iaixsl:when test="(page/prepaid/details/@wykonane = 'w')">icon-money</iaixsl:when>
                                <iaixsl:when test="(page/prepaid/details/@wykonane = 'd')">icon-truck</iaixsl:when>
                                <iaixsl:when test="(page/prepaid/details/@wykonane = 'z')">icon-back</iaixsl:when>
                                <iaixsl:when test="(page/prepaid/details/@wykonane = 'k')">icon-remove</iaixsl:when>
                                <iaixsl:when test="(page/prepaid/details/@wykonane = 'r')">icon-chat</iaixsl:when>
                                <iaixsl:when test="(page/prepaid/details/@wykonane = 'j')">icon-link</iaixsl:when>
                                <iaixsl:when test="(page/prepaid/details/@wykonane = 'l')">icon-attention</iaixsl:when>
                                <iaixsl:when test="(page/prepaid/details/@wykonane = 'a')">icon-clock</iaixsl:when>
                                <iaixsl:when test="(page/prepaid/details/@wykonane = 'b')">icon-box</iaixsl:when>
                            </iaixsl:choose>
                            </iaixsl:attribute>
                        </i>
                    </div>
                    ...
                    <div class="prepaid-status">
                        ...
                        <small>Order ID:<iaixsl:value-of select="page/prepaid/details/@orderid"/></small>
                        <iaixsl:if test="page/prepaid/details/@msg = 'order' and page/prepaid/details/@prepaidstatus  = 'c'">
                            <div class="prepaid-msg">
                                    <br />The payment for this order cannot be made yet. Await the information about unblocking the payment option and the payment request.
                            </div>
                        </iaixsl:if>
                        <iaixsl:if test="page/prepaid/details/@msg = 'confirm'">
                            <div class="prepaid-msg">
                                An order confirmation e-mail has been sent to your e-mail address. Please check your inbox and click on the link to confirm your order.
                            </div>
                        </iaixsl:if>
                    </div>
                    ...
                    <div class="prepaid-buttons">
                        <iaixsl:if test="/shop/page/prepaid/documents/document/@type='invoice_proforma' and $prepaidProForma">
                            <a class="btn-icon prepaid-proforma">
                            <iaixsl:attribute name="title"><small><i class="icon-file-text"></i></small><span>Pro forma</span></iaixsl:attribute>
                            <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/prepaid/documents/document[@type='invoice_proforma']/@link"/></iaixsl:attribute><small><i class="icon-file-text"></i></small><span>Pro forma</span></a>
                        </iaixsl:if>
                        ...
                        <iaixsl:if test="page/prepaid/editlink/@active = 'y'">
                            ...
                            <iaixsl:attribute name="href"><iaixsl:value-of select="page/prepaid/editlink/@link"/></iaixsl:attribute><small><i class="icon-pencil"></i></small><span>Edit order</span></a>
                        </iaixsl:if>

                        <iaixsl:if test="/shop/page/prepaid/opinions_forms/trusted_shops/raiting_action">
                            <a class="btn-icon prepaid-opinions" target="_blank">
                                ...
                                <small><i class="icon-star"></i></small><span>Rate our store!</span>
                            </a>
                        </iaixsl:if>

                        <iaixsl:if test="page/prepaid/confirmlink/@link">
                            <a class="btn-icon prepaid-resend">
                                ...
                                <small><i class="icon-envelope"></i></small><span>Confirm again by e-mail</span>
                            </a>
                        </iaixsl:if>
                        ...
                        <iaixsl:if test="(page/prepaid/cancellink/@active='y') and not(page/prepaid/order/@payment_paid)">
                            <a class="btn-icon prepaid-cancel orderdetails_info_cancel">
                                ...
                                <small><i class="icon-remove"></i></small><span>Cancel order</span>
                            </a>
                        </iaixsl:if>
                    </div>
                </div>
            </div>
        <!--Płatności do zamówienia (orderdetails_payments, 109380.1)-->
                                        ...
                                        <div class="payments_group">
                                            ...
                                            <label class="payments_group_sub_content">
                                                ...
                                                <span class="payments_sub_container">
                                                    <iaixsl:if test="@id = 'blik'">
                                                        <span style="display: none;" class="blik_placeholder">Enter the 6-digit BLIK code:<input id="blik_placeholder_input" type="text"/></span>
                                                    </iaixsl:if>
                                                        ...
                                                        <div class="prepaid_payment">
                                                            ...
                                                            <iaixsl:if test="@description and not(@description = ' ')">
                                                                <div class="prepaid_payment_description">
                                                                    ...
                                                                    <iaixsl:if test="@description and not(@description = ' ')">
                                                                        <iaixsl:value-of disable-output-escaping="yes" select="@description"/>
                                                                        <iaixsl:if test="(@id = '28') and (@allProducts = '0')"><span class="prepaid_payment_lukaswarning">Nie wszystkie umieszczone w koszyku towary umożliwią zakup z ratami Lukas Bank. Przejdź do szczegó��ów każdego z towarów aby dowiedzieć się które z nich umożliwiają taki zakup. Jeżeli zdecydujesz się na zakup na raty, opłata za te towary będzie musiała być wniesiona odrębnie pozostałymi sposobami płatności.</span></iaixsl:if>
                                                                    </iaixsl:if>
                                                                </div>
                                                            </iaixsl:if>
                                                        </div>
                    ...
                    <div class="orderdetails_summary col-sm-4 col-12">
                        <div class="orderdetails_summary_info">
                            ...
                            <div class="orderdetails_summary_price">
                                ...
                                <iaixsl:if test="page/prepaid/prepaid_history/@currencysum and page/prepaid/prepaid_history/@currencysum != '0.00' and page/prepaid/prepaid_history/@currencysum != '-0.00'">
                                ...
                                <iaixsl:if test="page/prepaid/prepaid_history/item[position()=last()]/@first_pay = 'false' and (page/prepaid/prepaid_history/item[position() = last()]/@status = 'n' or page/prepaid/prepaid_history/@show_payment_button = 'true')">
                                        ...
                                        <div class="selected_payment_history">
                                            ...
                                            <div class="selected_payment_history_description">
                                                ...
                                                <iaixsl:if test="not(dates/date_canceled/@date)">
                                                    ...
                                                    <strong><iaixsl:value-of select="amount/client_currency/@value_formatted"/>.</strong>
                                                </iaixsl:if>
                                                <br/>
                                                If, for some reason, you have not completed the payment process pay again
                                                <iaixsl:if test="/shop/page/prepaid_methods/item"> or select another payment method.</iaixsl:if>
                            ...
                            <div class="row">
                                <div class="credit_card_pci_dss col-12">
                                    ...
                                    <span class="pci_dss_icon_container">
                                        <img src="/gfx/rum/pci_css_logo.png?r=1571748615" alt="PCI DSS Compilant"/>
                                    </span>
                                </div>
                            </div>
                        </form>
            ...
            <table>
                ...
                <tr>
                    <td class="ordered-icon">
                        <img src="/gfx/rum/shipping_icon.png?r=1571748615">
                    ...
                    <iaixsl:when test="/shop/page/prepaid/prepaid_history/item/@status = 'n'">
                        <iaixsl:for-each select="/shop/page/prepaid/prepaid_history/item[@status = 'n']">
                            <tr class="payment_form_item">
                                <td class="ordered-icon">
                                    <img src="/gfx/rum/prepaid_method_icon.png?r=1571748615">
                                        <iaixsl:if test="@icon">
                                            <iaixsl:attribute name="src"><iaixsl:value-of select="@icon"/></iaixsl:attribute>
                                        </iaixsl:if>
                                        <iaixsl:attribute name="alt"><iaixsl:value-of select="@payment_name"/></iaixsl:attribute>
                ...
                <iaixsl:if test="/shop/page/insurance_product">
                    ...
                    <tr>
                        <td class="ordered-icon">
                            <img src="/gfx/rum/insurance_icon.png?r=1571748615" alt="insurance_icon"/>
                        </td>
                        <td class="ordered-name">
                            Buyer Protection: 
                            ...
                            <tr>
                                ...
                                <td class="ordered-name">
                                    ...
                                    <iaixsl:if test="not(/shop/page/ordered_products/product/@size_id = 'uniw')">
                                        <div class="ordered-size d-sm-none"><iaixsl:value-of select="@size_desc"/></div>
                                    </iaixsl:if>


                                    <iaixsl:if test="/shop/page/ordered_products/product[not(@code = '')]">
                                        <div class="ordered-code d-sm-none"><iaixsl:value-of select="@code"/></div>
                                    </iaixsl:if>
            ...
            <iaixsl:if test="$prepaidrt_txt and /shop/page/prepaid/actions/return/@url">
                <div class="actions_return col-12 col-sm-6">
                    <div class="actions_return_sub col-12 mb-4">
                        ...
                        <div>
                            <img alt="returns" src="/gfx/rum/returns_action.png?r=1571748615"/><span>If you would like to use the right to return a product without giving a reason, use our returns system which makes the process safe and simple.</span></div>
                            <a class="btn --solid">
            ...
            <iaixsl:if test="$prepaidzt_txt and /shop/page/prepaid/actions/rma/@url">
                <div class="actions_rma col-12 col-sm-6">
                    <div class="actions_rma_sub col-12">
                        ...
                        <div>
                            <img alt="rma" src="/gfx/rum/rma_action.png?r=1571748615"/><span>If a product was fine at the moment of delivery but then has broken and you would like to file a complaint through our shop, just use our RMA system which makes the process quicker and easier.</span></div>
                            <a class="btn --solid">
