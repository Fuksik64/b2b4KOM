...
<!--Błędy i informacje w projektorze (menu_messages, 106608.1)-->
        ...
        <!--CMS - Formularz logowania (signin_cms, 107646.1)-->
            <iaixsl:if test="page/text/body">
                <div class="signin_cms">
                    <div class="signin_cms_sub cm">
                        <iaixsl:value-of disable-output-escaping="yes" select="page/text/body"/>
                    </div>    
                </div>
            </iaixsl:if>
        <!--Formularz logowania (signin-form, 110605.1)-->

        <iaixsl:variable name="social_media_name">
            <iaixsl:choose>
                <iaixsl:when test="/shop/client_data/@last_login_option = 'fb'">Facebook</iaixsl:when>
                <iaixsl:when test="/shop/client_data/@last_login_option = 'google'">Google</iaixsl:when>
                <iaixsl:when test="/shop/client_data/@last_login_option = 'paypal'">PayPal</iaixsl:when>
                <iaixsl:when test="/shop/client_data/@last_login_option = 'openid-27'">OpenID</iaixsl:when>
                <iaixsl:when test="/shop/client_data/@last_login_option = 'openid-28'">OpenID</iaixsl:when>
            </iaixsl:choose>
        </iaixsl:variable>

        <iaixsl:variable name="wholesaler_register">true</iaixsl:variable>
        <iaixsl:variable name="register_number"><iaixsl:value-of select="count(/shop/action/registration_options/*)"/></iaixsl:variable>

        <div id="signin-form" class="signin-form row">
            <div id="signin-form_box_left" class="signin-form_box col-md-8 col-sm-7 col-12">
                <iaixsl:if test="/shop/client_data/@signin = 'cookie'">
                ...
                <iaixsl:choose>
                    <iaixsl:when test="not(/shop/client_data/@signin = 'cookie') and /shop/client_data/@iai_accounts = 'consent' and (not(/shop/client_data/@last_login_option = 'shop'))">
                        ...
                        <div id="cookie_login_social" class="iai_accounts">
                            <span id="cookie_login_social_desc" class="iai_accounts">
                                Log in with <strong>IAI Accounts</strong> via 
                                <iaixsl:value-of select="$social_media_name"/>
                            ...
                            <div id="cookie_login_social_item">
                                <div id="client_new_social">
                                    <div class="client_new_social_sub">
                                        <ul>
                                            <iaixsl:for-each select="login_options/service[@name = $social_media_name]">
                                                <li>
                                                    <iaixsl:choose>
                        ...
                        <iaixsl:if test="count(login_options/service[not(@name = $social_media_name)]) > 0">
                            <div id="cookie_login_social_more">
                                <ul>
                                    <iaixsl:for-each select="login_options/service[not(@name='shop_register') and not(@name = $social_media_name)]">
                                        <li>
                                            <iaixsl:choose>
                                                <iaixsl:when test="@login_url">
                                                    <a class="btn --outline --medium --icon-left service_item">
                                ...
                                <iaixsl:for-each select="login_options/service[not(@name='shop_register') and not(@login_url)]">
                                    <form action="login.php" method="post" style="display:none;">
                                        <iaixsl:attribute name="id">social_networking_<iaixsl:value-of select="translate(@name, ' +', '_')"/></iaixsl:attribute>
                                        <iaixsl:if test="@form_action">
                                            <iaixsl:attribute name="action"><iaixsl:value-of select="@form_action"/></iaixsl:attribute>
                                        </iaixsl:if>
                                        <input type="hidden" name="openid_serviceid">
                                            <iaixsl:attribute name="value"><iaixsl:value-of select="@id"/></iaixsl:attribute>
                                        </input>
                                        <iaixsl:if test="@name='OpenId'">
                                            <label><iaixsl:value-of select="@name"/><span> URL</span></label>
                                        </iaixsl:if>
                                        <iaixsl:if test="not(@name='OpenId')">
                                            <label><iaixsl:value-of select="@name"/><span> login</span></label>
                                        </iaixsl:if>
                                        <input id="signin_login_url" type="text" name="openid_url" size="160"/>

                                        <button type="submit" class="signin_button btn --solid">
                                            <iaixsl:attribute name="data-signin_button"><iaixsl:value-of select="@name"/></iaixsl:attribute>
                                            Sign in 
                                        </button>
                                    </form>
                                </iaixsl:for-each>
                    ...
                    <iaixsl:when test="/shop/client_data/@signin = 'cookie' and (not(/shop/client_data/@last_login_option = 'shop'))">

                        <div id="cookie_login_social">
                            <iaixsl:if test="/shop/client_data/@iai_accounts = 'consent'">
                                <iaixsl:attribute name="class">iai_accounts</iaixsl:attribute>
                            </iaixsl:if>
                            <span id="cookie_login_social_desc">
                                <iaixsl:choose>
                                    <iaixsl:when test="not(/shop/client_data/@iai_accounts = 'consent')">
                                        <strong>You are already our customer.</strong>
                                        Log in again via 
                                        <iaixsl:value-of select="$social_media_name"/>
                                ...
                                <div id="client_new_social">
                                    ...
                                    <div class="client_new_social_sub">
                                        ...
                                        <iaixsl:if test="not(page/client-data/@allow_register = 'false')">
                                            <p>If you have an account in one of the services listed below, you can use it to create an account and for the future sign in process.<br/><br/><b>If you have an earlier-created account</b> you can merge it with the login details to your favorite site, for your own convenience. To do this, first sign in and go to your personal details edition, where you can find account merging tools.</p>
                                        </iaixsl:if>

                                        <iaixsl:if test="count(login_options/service)>1">
                                            <ul>
                                                <iaixsl:for-each select="login_options/service[not(@name='shop_register')]">
                                                    <li>
                                                        <iaixsl:choose>
                                                            <iaixsl:when test="@login_url">
                                                                <a class="btn --outline --medium --icon-left service_item">
                ...
                <div class="signin-form_box_sub" id="signin-form_box_sub_1">
                    <div class="signin-form_select">
                        <h3>Log me in through</h3>
                        <input id="signin-form_radio1" type="radio" value="signin-form_box_sub_1" checked="checked" name="login_form1" data-target="login_form2"/><label for="signin-form_radio1">login and password</label>
                        <input id="signin-form_radio2" type="radio" value="signin-form_box_sub_2" name="email_form1" data-target="email_form2"/><label for="signin-form_radio2">remind my password</label>
                    </div>
                    ...
                    <form action="/signin.php" method="post" novalidate="novalidate">
                        ...
                        <div class="signin_inputs col-md-10 col-12">
                            <div class="form-group">
                                <div class="has-feedback">
                                    <input id="user_login" type="text" class="form-control" name="login">
                                        <iaixsl:if test="/shop/client_data/@signin = 'cookie' and /shop/client_data/@email">
                        ...
                        <div class="signin_buttons col-md-10 col-12">
                            <button class="btn --solid --medium signin_button" type="submit">
                                Sign in 
                            </button>
                            ...
                            <iaixsl:if test="/shop/client_data/@signin = 'cookie'">
                                <a class="cookie_login_social_new_account" href="/client-new.php?register">This is not my account and I want to create a new one</a>
                            </iaixsl:if>
                            <iaixsl:if test="/shop/client_data/@signin = 'cookie' and not(/shop/client_data/@last_login_option = 'shop') and count(login_options/service[not(@name = $social_media_name)]) > 0">
                                <a class="cookie_login_social_more_social" href="#more_social">Log in using external service account</a>
                            </iaixsl:if>
                        </div>
                    </form>
                ...
                <div class="signin-form_box_sub" id="signin-form_box_sub_2">
                    <p class="reminder_desc">An e-mail that allows you to automatically log in has been sent to your e-mail address. Changing the password will be possible after logging in.</p>

                    <div class="signin-form_select">
                        <h3>Log me in through</h3>
                        <input id="signin-form_radio3" type="radio" value="signin-form_box_sub_1" name="login_form2" data-target="login_form1"/><label for="signin-form_radio3">login and password</label>
                        <input id="signin-form_radio4" type="radio" value="signin-form_box_sub_2" name="email_form2" data-target="email_form1" checked="checked"/><label for="signin-form_radio4">remind my password</label>
                    </div>

                    <form class="password-recover" action="/password-recover.php" method="post" novalidate="novalidate">
                        <iaixsl:if test="(/shop/@sslurl) and (/shop/@sslurl != '')"><iaixsl:attribute name="action"><iaixsl:value-of select="/shop/@sslurl"/>password-recover.php</iaixsl:attribute></iaixsl:if>
                        <input type="hidden" name="operation" value="recover"/>
                        <div class="signin_inputs col-md-10 col-12">
                            <div class="form-group">
                                <div class="has-feedback">
                                    <input id="user_mail_recover" type="mail" class="form-control validate" name="email" required="required" autocomplete="off">
                                        <iaixsl:attribute name="placeholder"/>
                                    </input>
                                    <label for="user_mail_recover" class="control-label">E-mail</label>
                                    <span class="form-control-feedback"/>
                                </div>
                                <div class="form-desc">
                            ...
                            <div class="signin_buttons col-md-10 col-12">
                                <button class="btn --solid --medium signin_password-recover" type="submit">
                                    Remind password
                                </button>

                                <a class="password_back_signin" href="#signin-form_radio1">Back to standard login</a>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <div class="signin-form_box_sub">
                        <iaixsl:choose>
                            <iaixsl:when test="page/actions/client_once">
                                ...
                                <p class="registration_desc">If you have not created an account in our shop, you will be asked to enter your personal details and a delivery address.</p>
                                <iaixsl:if test="page/actions/client_register">
                                    <a class="btn --solid --medium signin-form_register">
                                        <iaixsl:choose>
                                            <iaixsl:when test="$register_number = 1">
                                    ...
                                    <iaixsl:if test="$register_number > 1">
                                        <div class="register_wholesaler">
                                ...
                                <iaixsl:if test="page/actions/client_once">
                                    <a class="btn --solid --medium --secondary signin-form_once">
                                        <iaixsl:attribute name="href"><iaixsl:value-of select="page/actions/client_once/@url"/></iaixsl:attribute>
        ...
        <iaixsl:if test="/shop/page/password-recover"><span/></iaixsl:if>
