...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 107421.1)-->
        ...
        <!--Nowości w sklepie (news, 107848.1)-->
            ...
            <iaixsl:variable name="setLink_back"></iaixsl:variable>
            <iaixsl:variable name="main_news_see_more">Read more</iaixsl:variable>

            <iaixsl:if test="/shop/page/news">
                <div class="n65105_news" itemscope="" itemtype="http://schema.org/NewsArticle">
                    <div class="n65105_news_sub">
                        <table>
                            <tbody>
                                <tr>
                                    <td class="main_news2">   
                                        ...
                                        <iaixsl:if test="/shop/page/news/date">
                                            <div class="date" itemprop="dateCreated"><iaixsl:attribute name="class">date datasquare</iaixsl:attribute>
                                            <iaixsl:value-of disable-output-escaping="yes" select="/shop/page/news/date"/>
                                            </div>
                                        </iaixsl:if>   
                                        <h1 class="n53963" itemprop="name">
                                            <iaixsl:attribute name="class">big_label n53963</iaixsl:attribute>
                                            <iaixsl:value-of disable-output-escaping="yes" select="/shop/page/news/title"/>
                                        </h1>
                                    </td>
                            ...
                            <tr>
                                <td class="news">
                            <div class="n65105_news_text" itemprop="description">
            <iaixsl:attribute name="class">n65105_news_text cm</iaixsl:attribute>
                                <iaixsl:value-of disable-output-escaping="yes" select="/shop/page/news/description"/>
                            </div>
                                    
                                <iaixsl:if test="$setLink_back">
                                    <div class="back"><a class="back" href="#" onClick="if(document.referrer=='') window.location.href = '/news.php'; else history.back();return false;"></a></div>       
                                </iaixsl:if>
                            </td>
                            </tr>
                            </tbody>
            ...
            <iaixsl:if test="/shop/page/newslist">
            <div id="news_list" class="article_wrapper n65105_news_list mb-3">
                ...
                <div class="row article_sub_wrapper">
                    ...
                    <iaixsl:if test="(not(/shop/page/newslist/mainpage)) and (not(/shop/page/newslist/mainpage1)) and (not(/shop/page/newslist/mainpage2))">
                        <div id="return_message" class="n54531_outline">
                        <div class="n54531_outline_sub">
                        <h3 class="return_label">There are no news at the moment.</h3>
                        </div>
                        </div>
                    </iaixsl:if>
                
                    <iaixsl:for-each select="page/newslist/mainpage1/item">           
                        <div class="article_element_wrapper col-md-6 col-12">
                                            ...
                                            <div class="article_text_wrapper">
                                                ...
                                                <iaixsl:if test="link/@href and $main_news_see_more">
                    ...
                    <iaixsl:for-each select="page/newslist/mainpage2/item">
                        <div class="article_element_wrapper col-md-6 col-12">
                    ...
                    <iaixsl:for-each select="page/newslist/mainpage/item">
                        <div class="article_element_wrapper col-md-6 col-12">
            ...
            <iaixsl:if test="/shop/page/news/image"> </iaixsl:if>
        ...
        <iaixsl:if test="count(page/newslist/navigation/item) > 1">
            <ul class="pagination mb-2 mb-sm-3">
                
                <iaixsl:if test="page/newslist/navigation/prev">
                    <li class="pagination__element --prev">
                        ...
                        <a class="pagination__link">
                            <iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="page/newslist/navigation/path/@value"/><iaixsl:value-of select="page/newslist/navigation/prev/@counter"/></iaixsl:attribute>
                        </a>
                        <iaixsl:if test="$prev_page">
                ...
                <iaixsl:if test="not(page/newslist/navigation/prev)">
                ...
                <iaixsl:for-each select="page/newslist/navigation/item">
                    <iaixsl:if test="@gap">
                ...
                <iaixsl:if test="page/newslist/navigation/next">
                    <li class="pagination__element --next">
                        ...
                        <a class="pagination__link">
                            <iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="page/newslist/navigation/path/@value"/><iaixsl:value-of select="page/newslist/navigation/next/@counter"/></iaixsl:attribute>
                        </a>
                        <iaixsl:if test="$next_page">
                ...
                <iaixsl:if test="not(page/newslist/navigation/next)">
    ...
    <!--Bookmarklets News (news_bookmarklets, 107867.1)-->
        ...
        <!--Produkty powiązane (news_cms_associated, 107851.1)-->
            <iaixsl:if test="page/news/cms_products/product or page/news/cms_products/opinion">
                <div class="main_hotspot mb-4" id="news_cms_associated">
                    <iaixsl:choose>
                        <iaixsl:when test="page/news/cms_products/@link">
                            <a class="big_label">
                                <iaixsl:attribute name="href"><iaixsl:value-of select="page/news/cms_products/@link"/></iaixsl:attribute><iaixsl:attribute name="title">Click here to view all products</iaixsl:attribute>
                                <iaixsl:choose><iaixsl:when test="page/news/cms_products/@name"><iaixsl:value-of select="page/news/cms_products/@name"/></iaixsl:when><iaixsl:otherwise>Recommended</iaixsl:otherwise></iaixsl:choose>
                    ...
                    <div class="align_row main_hotspot_sub">
                        <div class="products_wrapper row m-0">
                            ...
                            <iaixsl:for-each select="page/news/cms_products/*">
        ...
        <!--Facebook comments News (news_facebook_comments, 107868.1)-->
            <iaixsl:if test="page/facebook_comments">
                <div class="news_fb_comments">
                    <div class="big_label news_fb_comments_label">
                        Share your comment
                    </div>
                    <div id="fb-root"/>
                    <script>
                    ...
                    <div class="fb-comments">
                        <iaixsl:attribute name="data-href"><iaixsl:value-of select="/shop/@baseurl"/><iaixsl:value-of select="translate (/shop/navigation/current/@curr_url, '/', '')"/></iaixsl:attribute>
                        <iaixsl:attribute name="data-num-posts">10</iaixsl:attribute>
                        <iaixsl:attribute name="data-width">756</iaixsl:attribute>
