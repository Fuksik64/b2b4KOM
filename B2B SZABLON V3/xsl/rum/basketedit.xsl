...
<!--Błędy i informacje w projektorze (menu_messages, 106608.1)-->
        ...
        <!--Lista produktów w koszyku (basketedit_productslist, 110677.1)-->
                        ...
                        <div class="basketedit_summary_left">
                            ...
                            <iaixsl:if test="(page/basket-details/summary/points/@debit) and (page/basket-details/summary/points/@debit > 0)">
                                <div class="basketedit_summary_debit">
                                    ...
                                    <b><iaixsl:value-of select="format-number(page/basket-details/summary/points/@debit, '#')"/><span> pts</span></b> in Loyalty Program.
                                    <iaixsl:if test="/shop/basket/@client_points != '0'">
                                        Currently you have 
                                        <b><iaixsl:value-of select="format-number(/shop/basket/@client_points, '#')"/><span> pts</span></b>
                                    </iaixsl:if>
                                </div>
                            </iaixsl:if>
            ...
            <div id="menu_security_policy" class="menu_box">
                <iaixsl:choose>
                    ...
                    <iaixsl:otherwise>
                        ...
                        <div class="menu_sub_box">
                            <img src="/gfx/rum/iai_security.png?r=1571748615" alt="Idosell security badge"/>
