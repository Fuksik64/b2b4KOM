...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 107421.1)-->
                                    ...
                                    <li>
                                        <a><iaixsl:choose>
                                            ...
                                            <iaixsl:attribute name="title"><iaixsl:value-of select="text"/></iaixsl:attribute><iaixsl:choose>
                                                <iaixsl:when test="image or image_desktop or image_tablet or image_mobile"><img src="/gfx/rum/loader.gif?r=1571748615">
        ...
        <!--Hotspot na stronie głównej - strefa 1 (main_hotspot_zone1, 106483.1)-->
        ...
        <!--Strona główna (main, 106486.1)-->
            <iaixsl:if test="navigation5/item">
                <div id="main_tree5" class="mb-4"> 
                    <ul class="main_tree_sub row align_row"> 
                        <iaixsl:attribute name="data-align">ul#px</iaixsl:attribute>
                        <iaixsl:for-each select="navigation5/item">
                            <li class="col-sm-4 col-12 mb-0 mb-sm-4">
                                <iaixsl:choose>
                                    ...
                                    <iaixsl:otherwise>  
                                        <strong class="title"><iaixsl:value-of disable-output-escaping="yes" select="@name"/></strong>
                                    </iaixsl:otherwise>  
                                </iaixsl:choose>
                                <iaixsl:if test="item">    
                                    <ul>
                                        ...
                                        <iaixsl:if test="( count(item) > 1 ) and @link and @display_all = 'y'">
                                            <li class="display_all">      
                                                <a>
                                                    <iaixsl:attribute name="href"><iaixsl:choose><iaixsl:when test="@display_all_link"><iaixsl:value-of select="@display_all_link"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="@link"/></iaixsl:otherwise></iaixsl:choose></iaixsl:attribute>     
                                                    More               
                                                </a>
                                            </li>
                                        </iaixsl:if> 
                                    ...
                                    <iaixsl:choose>
                                        <iaixsl:when test="page/hotspot/products_zone2/@link">
                                            <a class="big_label">
                                                ...
                                                <iaixsl:choose><iaixsl:when test="page/hotspot/products_zone2/@name"><iaixsl:value-of select="page/hotspot/products_zone2/@name"/></iaixsl:when><iaixsl:otherwise>Special offers</iaixsl:otherwise></iaixsl:choose>
                                                <small><i class="icon-caret-right"></i> View all</small>
                                            </a>
                                        </iaixsl:when>
                                        <iaixsl:otherwise>
            ...
            <div id="main_blog" class="article_wrapper mb-4">
                ...
                <h2 class="label_wrapper">
                   <a href="/blog-list.php" class="big_label">
						...
						<iaixsl:attribute name="title"></iaixsl:attribute>
						Blog <small><i class="icon-caret-right"></i> View all</small>
                	</a>
                </h2>

                <div class="row article_sub_wrapper col-bg-1">
                    <iaixsl:for-each select="page/mainpage2/item">
                        <div class="article_element_wrapper col-md-6 col-sm-12">
...
<iaixsl:if test="count(page/mainpage2/item) > 0 and $main_blog_view_all">
                    <div class="view_all_wrapper">
                        <a href="/blog-list.php" class="view_all_link">
                            <iaixsl:attribute name="title"></iaixsl:attribute>
        ...
        <!--Newsy na stronie głównej (strefa 1) (main_news1, 106524.1)-->
            ...
            <iaixsl:if test="count(page/mainpage1/item) > 0">
                <div id="main_news1" class="article_wrapper mb-4">
                    ...
                    <h2 class="label_wrapper">
                    <a href="/news.php" class="big_label">
                            ...
                            News <small><i class="icon-caret-right"></i> View all</small>
                        </a>
                    </h2>
                    ...
                    <iaixsl:if test="count(page/mainpage1/item) > 0 and $main_news_view_all">
                        <div class="view_all_wrapper">
                            <a href="/news.php" class="view_all_link">
                                <iaixsl:attribute name="title"></iaixsl:attribute>
