...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 107421.1)-->
            ...
            <iaixsl:if test="(action/set_render/item/@name = 'popup') or not(action/set_render/item)">
                ...
                <script type="text/javascript" src="/gfx/rum/stock_info.js.gzip?r=1571748615"></script></head>
    ...
    <iaixsl:if test="page/text/body">
        <div class="stock_cms_label">
<iaixsl:attribute name="class">stock_cms_label  big_label</iaixsl:attribute>
            <span class="stock_cms_label">
                    
                    Additional information
            </span>
        </div>
        <div class="stock_cms">
            <div class="stock_cms_sub">
                <iaixsl:value-of disable-output-escaping="yes" select="page/text/body"/>
            </div>    
        </div>
    </iaixsl:if>
    <!--Informacja o magazynie (stock_info, 107884.1)-->
        ...
        <iaixsl:variable name="mapHide">TRUE</iaixsl:variable>
        ...
        <script>
            var mapTypeStock= "<iaixsl:value-of select="$mapType"/>";
            var navControlStock= "<iaixsl:value-of select="$navControl"/>";
            var mapTypeControlStock= "<iaixsl:value-of select="$mapTypeControl"/>";
            var scControlStock= "<iaixsl:value-of select="$scControl"/>";
            var controlTypeStock= "<iaixsl:value-of select="$controlType"/>";
            var mapTypeControlStyleStock= "<iaixsl:value-of select="$mapTypeControlStyle"/>";
            var mapHide = "<iaixsl:value-of select="$mapHide"/>";
            var markersAnimationStock = "<iaixsl:value-of select="$markersAnimation"/>";
            var bCordStock = "<iaixsl:value-of select="$bCord"/>";
            var lCordStock = "<iaixsl:value-of select="$lCord"/>";
            var stockLanguage   = "<iaixsl:value-of select="$mapLanguage"/>";
            var stockZoom     = parseInt("<iaixsl:value-of select="$mapZoom"/>");
            var markerStockCustomIcon      = "<iaixsl:value-of select="$mapCustomMarkers"/>";
            var mapSiteType = 'stock';
            var google_api_key = '<iaixsl:value-of select="/shop/page/stock/google_api_key/@value"/>';
        </script>
        ...
        <div class="stock_info_outline" id="stock_info_58110">
            <div class="big_label stock_label">
                <span class="stock_label">
                    Information about a personal collection point:
                </span>
            </div>
            <div class="stock_info_sub">
                <div class="stock_info_details">
                    <iaixsl:if test="page/stock/@name and (page/stock/@name != '')">
                        <div class="stock_info_section" id="stock_info_details_name">
                            <span class="stock_info_title">Name</span>
                            <h1 class="stock_info_name"><iaixsl:value-of select="page/stock/@name"/></h1>
                        </div>
                    </iaixsl:if>
                    <iaixsl:if test="page/stock/@street and (page/stock/@street != '')">
                        <div class="stock_info_section" id="stock_info_details_street">
                            <span class="stock_info_title">Street</span>
                            <span class="stock_info_value"><iaixsl:value-of select="page/stock/@street"/></span>
                        </div>
                    </iaixsl:if>
                    <iaixsl:if test="page/stock/@zipcode and (page/stock/@zipcode != '')">
                        <div class="stock_info_section" id="stock_info_details_zipcode">
                            <span class="stock_info_title">Postal code</span>
                            <span class="stock_info_value"><iaixsl:value-of select="page/stock/@zipcode"/></span>
                        </div>
                    </iaixsl:if>
                    <iaixsl:if test="page/stock/@city and (page/stock/@city != '')">
                        <div class="stock_info_section" id="stock_info_details_city">
                            <span class="stock_info_title">City</span>
                            <span class="stock_info_value"><iaixsl:value-of select="page/stock/@city"/></span>
                        </div>
                    </iaixsl:if>
                    <iaixsl:if test="page/stock/@country and (page/stock/@country != '')">
                        <div class="stock_info_section" id="stock_info_details_country">
                            <span class="stock_info_title">Country</span>
                            <span class="stock_info_value"><iaixsl:value-of select="page/stock/@country"/></span>
                        </div>
                    </iaixsl:if>

                    <iaixsl:if test="page/stock/@phone and (page/stock/@phone != '')">
                        <div class="stock_info_section" id="stock_info_details_phone">
                            <span class="stock_info_title">Phone number</span>
                            <span class="stock_info_value">
                                <iaixsl:choose>
                                    <iaixsl:when test="page/stock/@phone_link and (page/stock/@phone_link != '')">
                                        <a>
                                            <iaixsl:attribute name="href"><iaixsl:value-of select="page/stock/@phone_link"/></iaixsl:attribute>
                                            <iaixsl:attribute name="title"><iaixsl:value-of select="page/stock/@phone"/></iaixsl:attribute>
                                            <iaixsl:value-of select="page/stock/@phone"/>
                                        </a>
                                    </iaixsl:when>
                                    <iaixsl:otherwise>
                                        <iaixsl:value-of select="page/stock/@phone"/>
                    ...
                    <iaixsl:if test="page/stock/@fax and (page/stock/@fax != '')">
                        <div class="stock_info_section" id="stock_info_details_fax">
                            <span class="stock_info_title">Fax</span>
                            <span class="stock_info_value"><iaixsl:value-of select="page/stock/@fax"/></span>
                        </div>
                    </iaixsl:if>

                    <iaixsl:if test="page/stock/@mail and (page/stock/@mail != '')">
                        <div class="stock_info_section" id="stock_info_details_mail">
                            <span class="stock_info_title">E-mail</span>
                            <a class="stock_info_value">
                                <iaixsl:attribute name="title"><iaixsl:value-of select="page/stock/@mail"/></iaixsl:attribute>
                                <iaixsl:choose>
                                    <iaixsl:when test="page/stock/@mail_link and page/stock/@mail_link != ''">
                                        <iaixsl:attribute name="href"><iaixsl:value-of select="page/stock/@mail_link"/></iaixsl:attribute>
                                    </iaixsl:when>
                                    <iaixsl:otherwise>
                                        <iaixsl:attribute name="href">mailto:<iaixsl:value-of select="page/stock/@mail"/></iaixsl:attribute>
                                    </iaixsl:otherwise>
                                </iaixsl:choose>
                                <iaixsl:value-of select="page/stock/@mail"/>
                            </a>
                        </div>
                    </iaixsl:if>

                    <iaixsl:if test="page/stock/@gg and (page/stock/@gg != '')">
                        <div class="stock_info_section" id="stock_info_details_gg">
                            <span class="stock_info_title">Messanger</span>
                            <a class="stock_info_value">
                                <iaixsl:attribute name="href">gg:<iaixsl:value-of select="page/stock/@gg"/></iaixsl:attribute>
                                <img alt="gg">
                                    <iaixsl:attribute name="src">http://status.gadu-gadu.pl/users/status.asp?id=<iaixsl:value-of select="page/stock/@gg"/></iaixsl:attribute>
                                </img>
                                <iaixsl:value-of select="page/stock/@gg"/>
                            </a>
                        </div>
                    </iaixsl:if>
                    <iaixsl:if test="page/stock/@skype and (page/stock/@skype != '')">
                        <div class="stock_info_section" id="stock_info_details_skype">
                            <span class="stock_info_title">Skype</span>
                            <a class="stock_info_value">
                                <iaixsl:attribute name="href">callto://<iaixsl:value-of select="page/stock/@skype"/></iaixsl:attribute>
                                <img alt="skype">
                                    <iaixsl:attribute name="src">http://mystatus.skype.com/smallicon/<iaixsl:value-of select="page/stock/@skype"/></iaixsl:attribute>
                                </img>
                                <iaixsl:value-of select="page/stock/@skype"/>
                            </a>
                        </div>
                    </iaixsl:if>


                    <iaixsl:if test="page/stock/@street and (page/stock/@street != '') or page/stock/@zipcode or (page/stock/@zipcode != '') or page/stock/@city and (page/stock/@city != '')">
                        <iaixsl:if test="($mapHide != '') and page/stock/google_api_key/@value">


                            <a class="btn --solid show_on_map">
                                <iaixsl:attribute name="href">http://maps.google.com/maps?q=<iaixsl:value-of select="page/stock/@zipcode"/>%20<iaixsl:value-of select="page/stock/@city"/>%20<iaixsl:value-of select="page/stock/@street"/></iaixsl:attribute>
                                <i class="icon-globe"></i> <span class="d-none d-sm-inline">Show on map</span><span class="d-sm-none">Map</span>
                            </a>
                        </iaixsl:if>
                    </iaixsl:if>
                </div>
                ...
                <div class="stock_info_hours">
                    <span class="stock_info_hours_label">Opening hours</span>
                    <iaixsl:if test="page/stock_time/monday">
                        <div class="stock_info_hours_day">
                            <span class="stock_info_hours_day">Monday</span>
                            <span class="stock_info_hours_time">
                                <iaixsl:choose>
                                    <iaixsl:when test="page/stock_time/monday/@open != page/stock_time/monday/@close">
                                        <iaixsl:value-of select="page/stock_time/monday/@open"/> - <iaixsl:value-of select="page/stock_time/monday/@close"/>
                                    </iaixsl:when>
                                    <iaixsl:otherwise>
                                        Closed
                                    </iaixsl:otherwise>
                    ...
                    <iaixsl:if test="page/stock_time/tuesday">
                        <div class="stock_info_hours_day">
                            <span class="stock_info_hours_day">Tuesday</span>
                            <span class="stock_info_hours_time">
                                <iaixsl:choose>
                                    <iaixsl:when test="page/stock_time/tuesday/@open != page/stock_time/tuesday/@close">
                                        <iaixsl:value-of select="page/stock_time/tuesday/@open"/> - <iaixsl:value-of select="page/stock_time/tuesday/@close"/>
                                    </iaixsl:when>
                                    <iaixsl:otherwise>
                                        Closed
                                    </iaixsl:otherwise>
                    ...
                    <iaixsl:if test="page/stock_time/wednesday">
                        <div class="stock_info_hours_day">
                            <span class="stock_info_hours_day">Wednesday</span>
                            <span class="stock_info_hours_time">
                                <iaixsl:choose>
                                    <iaixsl:when test="page/stock_time/wednesday/@open != page/stock_time/wednesday/@close">
                                        <iaixsl:value-of select="page/stock_time/wednesday/@open"/> - <iaixsl:value-of select="page/stock_time/wednesday/@close"/>
                                    </iaixsl:when>
                                    <iaixsl:otherwise>
                                        Closed
                                    </iaixsl:otherwise>
                    ...
                    <iaixsl:if test="page/stock_time/thursday">
                        <div class="stock_info_hours_day">
                            <span class="stock_info_hours_day">Thursday</span>
                            <span class="stock_info_hours_time">
                                <iaixsl:choose>
                                    <iaixsl:when test="page/stock_time/thursday/@open != page/stock_time/thursday/@close">
                                        <iaixsl:value-of select="page/stock_time/thursday/@open"/> - <iaixsl:value-of select="page/stock_time/thursday/@close"/>
                                    </iaixsl:when>
                                    <iaixsl:otherwise>
                                        Closed
                                    </iaixsl:otherwise>
                    ...
                    <iaixsl:if test="page/stock_time/friday">
                        <div class="stock_info_hours_day">
                            <span class="stock_info_hours_day">Friday</span>
                            <span class="stock_info_hours_time">
                                <iaixsl:choose>
                                    <iaixsl:when test="page/stock_time/friday/@open != page/stock_time/friday/@close">

                                        <iaixsl:value-of select="page/stock_time/friday/@open"/> - <iaixsl:value-of select="page/stock_time/friday/@close"/>
                                    </iaixsl:when>
                                    <iaixsl:otherwise>
                                        Closed
                                    </iaixsl:otherwise>
                    ...
                    <iaixsl:if test="page/stock_time/saturday">
                        <div class="stock_info_hours_day">
                            <span class="stock_info_hours_day">Saturday</span>
                            <span class="stock_info_hours_time">
                                <iaixsl:choose>
                                    <iaixsl:when test="page/stock_time/saturday/@open != page/stock_time/saturday/@close">
                                        <iaixsl:value-of select="page/stock_time/saturday/@open"/> - <iaixsl:value-of select="page/stock_time/saturday/@close"/>
                                    </iaixsl:when>
                                    <iaixsl:otherwise>
                                        Closed
                                    </iaixsl:otherwise>
                    ...
                    <iaixsl:if test="page/stock_time/sunday">
                        <div class="stock_info_hours_day">
                            <span class="stock_info_hours_day">Sunday</span>
                            <span class="stock_info_hours_time">
                                <iaixsl:choose>
                                    <iaixsl:when test="page/stock_time/sunday/@open != page/stock_time/sunday/@close">
                                        <iaixsl:value-of select="page/stock_time/sunday/@open"/> - <iaixsl:value-of select="page/stock_time/sunday/@close"/>
                                    </iaixsl:when>
                                    <iaixsl:otherwise>
                                        Closed
                                    </iaixsl:otherwise>
            ...
            <iaixsl:if test="page/stock/google_api_key/@value and (page/stock/@street and (page/stock/@street != '') or page/stock/@zipcode and (page/stock/@zipcode != '') or page/stock/@city and (page/stock/@city != ''))">

                <div class="stock_map_all">
                    <iaixsl:if test="($mapHide != '')">
                        <iaixsl:attribute name="class">stock_map_all hide</iaixsl:attribute>
                    </iaixsl:if>
                    <div class="loadingMap">
                        <div class="loadingContent">
                            <div class="loadingBox">
                                ...
                                <span class="loadingAddress">Looking for the address</span>
            ...
            <iaixsl:if test="page/stock/text()">
                <div class="big_label stock_label">
                    <span class="stock_label">
                        Detailed information
                    </span>
                </div>
                <div class="stock_info_desc">
                    <iaixsl:value-of disable-output-escaping="yes" select="page/stock"/>
                </div>
            </iaixsl:if>
        </div>
