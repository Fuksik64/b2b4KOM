...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 107421.1)-->
            ...
            <iaixsl:if test="(action/set_render/item/@name = 'popup') or not(action/set_render/item)">
                ...
                <script type="text/javascript" src="/gfx/rum/pickup_sites_list.js.gzip?r=1571748615"></script></head>
...
<!--Błędy i informacje w projektorze (menu_messages, 106608.1)-->
        ...
        <iaixsl:variable name="requires_client_number"></iaixsl:variable>
        ...
        <iaixsl:if test="page/pickups">
            ...
            <div id="pickup_site">
                ...
                <h1 class="big_label">
                    Select <iaixsl:value-of select="page/pickups/@validName"/>
                </h1>

                <img class="markerCluster" style="display:none;" src="/gfx/rum/m1.png?r=1571748615"/>
                <img class="markerCluster" style="display:none;" src="/gfx/rum/m2.png?r=1571748615"/>
                <img class="markerCluster" style="display:none;" src="/gfx/rum/m3.png?r=1571748615"/>
                <img class="markerCluster" style="display:none;" src="/gfx/rum/m4.png?r=1571748615"/>
                <img class="markerCluster" style="display:none;" src="/gfx/rum/m5.png?r=1571748615"/>
                <img class="marker_face" src="/gfx/rum/marker_face.png?r=1571748615"/>
                    ...
                    <iaixsl:choose>
                        <iaixsl:when test="/shop/page/pickups/deliveryaddress and /shop/page/pickups/google_api_key/@value and /shop/page/pickups/google_api_key/@value != ''">
                            <div class="locationField_sub">
                                <p class="pickup_list_desc">Enter the address and search for the nearest collection points. Next to the map, click on one of the points to pick up the order here.</p>
                                <div id="locationField">
                                    ...
                                    <a class="btn --solid --medium">
                                        <span class="d-none d-sm-inline">Search for points</span>
                    ...
                    <form id="pickup_list_form" method="post">
                                    ...
                                    <iaixsl:if test="/shop/page/pickups/deliveryaddress">
                                        <div class="map_button_search">
                                            <a href="#search_here" class="btn --solid --medium pickup_search_here">
                                                <iaixsl:attribute name="title">Click to search for pickup points in this area</iaixsl:attribute>
                                                Search in this area
                                            </a>
                                        </div>
                                    </iaixsl:if>
                                    ...
                                    <div class="loadingMap">
                                        <div class="loadingContent">
                                            <div class="loadingBox">
                                                <span class="loadingMap">Loading map</span>
                                                ...
                                                <img class="loadingMapImg" src="/gfx/rum/mapLoader.gif?r=1571748615"/>
                                            </div>
                                        </div>
                                    </div>
                                                            ...
                                                            <iaixsl:choose>
                                                                ...
                                                                <iaixsl:when test="delivery_time">
                                                                    ...
                                                                    <iaixsl:if test="delivery_time/@hour  > 0">
                                                                        <iaixsl:value-of select="delivery_time/@hour"/> h
                                                                    </iaixsl:if>
                                                                ...
                                                                <iaixsl:when test="delivery_time/@days = '0'">
                                                                    <iaixsl:choose>
                                                                        ...
                                                                        <iaixsl:otherwise>
                                                                            Order will be ready for personal collection in <iaixsl:value-of select="delivery_time/@hour"/>
                                                                            <iaixsl:choose>
                                                                ...
                                                                <iaixsl:otherwise>
                                                                    Order will be ready for personal collection in <iaixsl:value-of select="delivery_time/@days"/>
                                                                    <iaixsl:choose>
                                                                        <iaixsl:when test="delivery_time/@days = '1'">
                                                                             day
                                                                        </iaixsl:when>
                        ...
                        <iaixsl:if test="(page/order_calendar/@type = 'y') or (page/order_calendar/@type = 't')">
                            <div id="selectPickupDayWrapper">
                                <div class="big_label">
                                    Select a preferred date for a pick up:
                                </div>
                        ...
                        <iaixsl:if test="page/order_calendar/@type = 't'">
                            <div class="pickupl_hour_wrapper">
                                <span>You can also enter your preferred range of hours (e.g. 13.00 - 16.00)</span>
                        ...
                        <div class="pickupl_submit">
                            ...
                            <p class="pickupl_back">If you want to change a delivery method, go back to <a id="pickup_site_back"><iaixsl:attribute name="href"><iaixsl:value-of select="page/pickups/@back"/></iaixsl:attribute><iaixsl:attribute name="title">Click here to get back to delivery and payment method selection</iaixsl:attribute>delivery and payment method selection</a>.</p>
                        </div>
                    </form>
                </div>
