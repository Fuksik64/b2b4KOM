                                ...
                                <table class="orders" cellspacing="0" cellpadding="0"  id="rebates">
                                    ...
                                    <tr>
                                        <td class="headerek" id="rebate_left">
                                            <iaixsl:value-of select="page/orders/sum/@quater"/>
                                            <iaixsl:value-of select="currency/@name"/>
                                        </td>
                                        <td class="headerek" id="rebate_center">
                                            <iaixsl:value-of select="page/orders/sum/@year"/>
                                            <iaixsl:value-of select="currency/@name"/>
                                        </td>
                                        <td class="headerek" id="rebate_right">
                                            <iaixsl:value-of select="page/orders/sum/@all"/>
                                            <iaixsl:value-of select="currency/@name"/>
                                        </td>
                                    </tr>
                                </table>
                                        ...
                                        <td>
                                            <iaixsl:choose>
                                                <iaixsl:when test="@returns_url">
                                                    <a class="btn --icon-left icon-plus --medium see_button"><iaixsl:attribute name="href"><iaixsl:value-of select="@returns_url"/></iaixsl:attribute><span><i class='icon-plus'></i></span><small>add a return</small></a>
                                                </iaixsl:when>
                                                <iaixsl:when test="@rma_url">
                                                    <a class="btn --icon-left icon-plus --medium see_button"><iaixsl:attribute name="href"><iaixsl:value-of select="@rma_url"/></iaixsl:attribute><span><i class='icon-plus'></i></span><small>Choose</small></a>
                                                </iaixsl:when>
                                                <iaixsl:otherwise>
                                                    <a class="btn --icon-left icon-plus --medium see_button"><iaixsl:attribute name="href"><iaixsl:value-of select="@orderdetails"/></iaixsl:attribute><span><i class='icon-plus'></i></span><small>more...</small></a>
                                                </iaixsl:otherwise>
                                            </iaixsl:choose>
                                        </td>
                                    </tr>
