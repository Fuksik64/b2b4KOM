    ...
    <iaixsl:choose>
        <iaixsl:when test="count(page/calculations/payment)">
                ...
                <div class="affiliate_calculations_desc">
                    Poniższa tabela zawiera kwoty, które należą Ci się od nas za zamówienia pozyskane w ramach udziału w programie partnerskim. Są to przepływy na Twoim koncie partnerskim:
                        <ol>
                        <li>
            ...
            <div class="affiliate_calculations">    
                <div class="affiliate_calculations_sub">
                    <table class="affiliate_calculations">
                        ...
                        <thead>
                            <tr>
                                <th id="affiliate_calculations_th0">data przyznania prowizji</th>
                                <th id="affiliate_calculations_th1">ważna od</th>
                                <th id="affiliate_calculations_th4">ważna do</th>
                                <th id="affiliate_calculations_th2">twoje wynagrodzenie</th>
                                <th id="affiliate_calculations_th3">opis</th>
                            </tr>
                        </thead>
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="affiliate_calculations_third">
                                       <iaixsl:choose>
                                        ...
                                        <span>Wynagrodzenie bezpośrednie za zamówienie <iaixsl:value-of select="$orderid"/></span>
                                        </iaixsl:when>
                                        
                                        <iaixsl:when test="@type = 'rd'">
                                        <span class="r">Anulowano wynagrodzenie bezpośrednie za zamówienie  <iaixsl:value-of select="$orderid"/></span>
                                        </iaixsl:when>
                                        
                                        <iaixsl:when test="@type = 'gi'">
                                        <span>Wynagrodzenie pośrednie za zamówienie <iaixsl:value-of select="$orderid"/></span>
                                        </iaixsl:when>
                                        
                                        <iaixsl:when test="@type = 'ri'">
                                        <span class="r">Anulowano wynagrodzenie pośrednie za zamówienie <iaixsl:value-of select="$orderid"/></span>
                                        </iaixsl:when>
                                        
                                        <iaixsl:when test="@type = 'gv'">
                                        <span>Wygenerowano bon o numerze <iaixsl:value-of select="$orderid"/></span>
                                        </iaixsl:when>
                                        
                                        <iaixsl:when test="@type = 'rv'">
                                        <span class="r">Zablokowano bon o numerze <iaixsl:value-of select="$orderid"/></span>
                                        </iaixsl:when>
                                        
                                        <iaixsl:when test="@type = 'gc'">
                                        <span>Wypłacono gotówkę </span>
                                        </iaixsl:when>
                                        
                                        <iaixsl:when test="@type = 'rc'">
                                        <span class="r">Wypłata gotówki została odrzucona </span>
                                        </iaixsl:when>

                                        <iaixsl:when test="@type = 'rr'">
                                        <span>Zwrot produktu</span>
                                        </iaixsl:when>
                                        </iaixsl:choose>
                                    </td>
                                </tr>
