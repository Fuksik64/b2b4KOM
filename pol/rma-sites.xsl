            ...
            <div class="step4a">
                ...
                <iaixsl:choose>
                    <iaixsl:when test="count(page/pickups/pickup) > 1">
                        <h1 class="big_label return_label">Wybierz adres punktu reklamacyjnego</h1>

                    </iaixsl:when>

                    <iaixsl:otherwise>

                        <h1 class="big_label return_label">Adres punktu reklamacyjnego</h1>
                                ...
                                <div class="pickupl_return">
                                    ...
                                    <div class="pickupl_return_sub">
                                        ...
                                        <div class="pickupl_return_link">
                                            <a target="_blank">
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="link"/></iaixsl:attribute>
                                                <iaixsl:attribute name="title">więcej informacji o punkcie</iaixsl:attribute>
                                                więcej informacji
                                            </a>
                                        </div>
                                        <iaixsl:if test="info">
