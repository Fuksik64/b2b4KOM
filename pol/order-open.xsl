        ...
        <!--Otwórz zamówienie (order_open_form, 112607.1)-->
			<section class="order_open mb-4">
				...
				<h1 class="order_open__label headline">
					<span class="order_open__label_txt headline__name">Sprawdzenie statusu zamówienia</span>
				</h1>

				
				<div class="order_open__description menu_messages_message mb-4">Aby sprawdzić status zamówienia, podaj jego numer (znajdziesz go w wiadomość e-mail, którą otrzymałeś po złożeniu zamówienia) oraz numer telefonu lub adres e-mail.</div>
				...
				<div class="order_open__signin d-flex justify-content-center">
					<a href="/login.php" class="order_open__signin_link">Mam zarejestrowane konto i chcę przejść do listy swoich zamówień</a>
				</div>
			</section>
