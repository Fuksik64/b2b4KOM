...
<div class="affiliate_orders_label">
   <iaixsl:attribute name="class">big_label affiliate_orders_label</iaixsl:attribute>
    ...
    <span class="affiliate_orders_label">
        Zamówienia Twoich klientów
    </span>
</div>
<iaixsl:choose>
    <iaixsl:when test="count(page/orders/client)">
        <div class="affiliate_orders_desc">
            <p class="affiliate_orders_desc">W poniższej tabeli umieszczone są osoby, które dokonały zakupu lub założyły u nas konto z Twojego polecenia. Podane kwoty dotyczą zamówień wykonanych z Twoim partnerstwem. Aby wyświetlić szczegółowe informacje na temat danej osoby, kliknij jej ID.</p>
        </div>
   ...
   <iaixsl:attribute name="class">ui-responsive table-stroke ui-table ui-table-reflow affiliate_orders</iaixsl:attribute>
                    ...
                    <thead>
                        <tr>
                            <th id="affiliate_orders_th1">id klienta</th>
                            <th id="affiliate_orders_th3">data założenia konta</th>
                            <th id="affiliate_orders_th4">ilość złożonych zamówień</th>
                            <th id="affiliate_orders_th5">wartość zamówionych produktów<span><br/><small>(bez kosztów przesyłki)</small></span></th>
                            <th id="affiliate_orders_th6">ilość wykonanych zamówień</th>
                            <th id="affiliate_orders_th7">kwota wykonanych zamówień<span><br/><small>(bez kosztów przesyłki)</small></span></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <iaixsl:if test="page/orders/client_sum">
                            <tr data-mobile-class="hide" class="table-stroke-row-sum">
                                <td class="affiliate_orders_sum"><span>Suma</span></td>
    ...
    <iaixsl:otherwise>
        <div class="affiliate_orders_null">
            Brak zamówień złożonych przez Twoich klientów.
        </div>
    </iaixsl:otherwise>
</iaixsl:choose>
</iaixsl:if>
