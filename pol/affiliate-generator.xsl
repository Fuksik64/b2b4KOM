...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 107421.1)-->
            ...
            <iaixsl:if test="(action/set_render/item/@name = 'popup') or not(action/set_render/item)">
                ...
                <script src="/gfx/pol/affiliate_generator_php.js.gzip?r=1600678639"></script><script src="/gfx/pol/affiliate_generator_code.js.gzip?r=1600678639"></script></head>
...
<iaixsl:attribute name="class">big_label affiliate_generator_js_step1_label</iaixsl:attribute>
                ...
                <div class="step1_js_desc">
                    <span>Wpisz URL do produktów , które zostaną zwrócone w reklamie.</span>
                </div>
...
Sprawdź produkty</a><img style="display:none;" class="affiliate_loader_gif" id="affiliate_loader_gif" src="/gfx/pol/affiliate_loader.gif?r=1600678639"/>
                    <div style="color:green; display:none;" class="affiliate_resources_ok" id="affiliate_resources_ok">
                        Istnieją produkty spełniające powyższe kryteria
                    </div>
...
<iaixsl:attribute name="class">big_label affiliate_generator_js_step2_label</iaixsl:attribute>
                    <span class="affiliate_generator_js_step2_label_span">
                        KROK 2 - WYGLĄD REKLAMY
                    </span>
                </div>
                <div class="affiliate_generator_js_step2_desc">Dostosuj wygląd reklamy podając parametry jej wyświetlania, rozmiar i kolorystykę. Aby otworzyć przybornik wyboru koloru kliknij na kolorową ikonkę</div>
                <div class="affiliate_wyswietlanie">
                    <div style="font-weight:bold; font-size:13px;">Ustawienia wyświetlania</div>
                    <table cellspacing="0" cellpadding="0" class="affiliate_wyswietlanie">
                        <tr>
                            <td class="affiliate_wyswietlanie_left">Język</td>
                        ...
                        <tr>
                            <td class="affiliate_wyswietlanie_left">Waluta</td>
                            <td class="affiliate_wyswietlanie_right">
                            <iaixsl:choose>
                                <iaixsl:when test="count(/shop/currency/option) = 1">
                                    <iaixsl:for-each select="/shop/currency/option">
                        ...
                        <tr id="affiliate_ilosc_produktow">
                            <td class="affiliate_wyswietlanie_left">Ilość produktów</td>
                            <td class="affiliate_wyswietlanie_right">
                        ...
                        <tr id="affiliate_uklad_produktow">
                            <td class="affiliate_wyswietlanie_left">Układ produktów</td>
                            <td class="affiliate_wyswietlanie_right">
                                <select class="affiliate_wyglad" id="products_uklad" name="products_uklad">
                                    <option value="poziomy">poziomy</option>
                                    <option value="pionowy">pionowy</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            <td class="affiliate_wyswietlanie_left">Szerokość jednego produktu:</td>
                            <td class="affiliate_wyswietlanie_right"> 
                                <input value="225" style="width:40px;" type="text" name="banner_width" id="banner_width"/> px
                            </td>
                        </tr>
                        <tr>
                            <td class="affiliate_wyswietlanie_left">Wysokość jednego produktu:</td>
                            <td class="affiliate_wyswietlanie_right">
                                <input value="300" style="width:40px;" type="text" name="banner_height" id="banner_height"/> px
                            </td>
                        </tr>
                        <tr>
                            <td class="affiliate_wyswietlanie_left">Szerokość grafiki produktu:</td>
                            <td class="affiliate_wyswietlanie_right"> 
                                <input value="225" style="width:40px;" type="text" name="image_width" id="image_width"/> px
                            </td>
                        </tr>
                        <tr>
                            <td class="affiliate_wyswietlanie_left">Wysokość grafiki produktu:</td>
                            <td class="affiliate_wyswietlanie_right">
                ...
                <div class="affiliate_kolorystyka">
                    <div style="font-weight:bold; font-size:13px;">Kolorystyka</div>
                    <table class="affiliate_kolorystyka">
                        <tr>
                            <td class="affiliate_kolorystyka_left"><span>Kolor nazwy produktu:</span></td>
                            <td class="affiliate_kolorystyka_right">
                                ...
                                <input class="affiliate_js_bold" type="checkbox" name="nazwa_bold"/>Pogrubienie</span>
                                <div class="clear"/>
                            </td>
                        </tr>
                        <tr>
                            <td class="affiliate_kolorystyka_left"><span>Kolor ceny:</span></td>
                            <td class="affiliate_kolorystyka_right"><input name="color4" class="iColorPicker" type="text" style="width: 60px;" maxlength="7" value="#d9592b" id="color4"/><span style="float:left;"><input class="affiliate_js_bold" type="checkbox" name="cena_bold"/>Pogrubienie</span><div class="clear"/></td>
                        </tr>
                        <tr>
                            <td class="affiliate_kolorystyka_left"><span>Kolor przekreślonej ceny:</span></td>
                            <td class="affiliate_kolorystyka_right"><input name="color5" class="iColorPicker" type="text" style="width: 60px;" maxlength="7" value="#8d8d8d" id="color5"/><span style="float:left;"><input class="affiliate_js_bold" type="checkbox" name="cena_promo_bold"/>Pogrubienie</span><div class="clear"/></td>
                        </tr>
                        <tr>
                            <td class="affiliate_kolorystyka_left"><span>Ramka:</span></td>
                            <td class="affiliate_kolorystyka_right">
                        ...
                        <tr id="border_tr" style="display:none;">
                            <td class="affiliate_kolorystyka_left"><span>Kolor ramki:</span></td>
                            <td class="affiliate_kolorystyka_right"><div><input name="color1" class="iColorPicker" type="text" style="width: 60px;" maxlength="7" value="#fff" id="color1"/><span style="float:left;">Grubość <input style="width:20px;" name="border_width" type="text" value="1"/> px</span><div class="clear"/></div></td>
                        </tr>
                        <tr>
                            <td class="affiliate_kolorystyka_left"><span>Tło:</span></td>
                            <td class="affiliate_kolorystyka_right">
                        ...
                        <tr id="background_tr" style="display:none;">
                            <td class="affiliate_kolorystyka_left"><span>Kolor tła:</span></td>
            ...
            <form name="affiliate_form_js" id="affiliate_form_js" action="/ajax/affiliate-generator.php" method="POST">
                ...
                <div class="affiliate_generator_js_step1_label">
                    ...
                    <span class="affiliate_generator_js_step1_label_span">
                     ...
                     <div class="step1_js_desc">
                    <span>Wpisz URL do listy produktów lub do karty pojedynczego produktu.</span>
                </div>
                <div class="affiliate_products_link">
                <input type="text" name="link" class="affiliate_products_link">
                    <iaixsl:attribute name="value"><iaixsl:value-of select="/shop/page/generator/default_link"/></iaixsl:attribute>
                ...
                <div class="affiliate_kolorystyka">
                    ...
                    <table class="affiliate_kolorystyka">
                        ...
                        <tr>
                            <td class="affiliate_kolorystyka_left"><span>Ramka:</span></td>
                            <td class="affiliate_kolorystyka_right">
                                <span><input name="border_radio" class="border_color" type="radio" id="border_radio1" value="nie" checked="checked"/>nie</span>
                                <span style="margin-left:10px;"><input name="border_radio" class="border_color" type="radio" id="border_radio2" value="tak"/>tak</span>
                            </td>
                        </tr>
                        <tr id="border_tr" style="display:none;">
                            <td class="affiliate_kolorystyka_left"><span>Kolor ramki:</span></td>
                        ...
                        <tr>
                            <td class="affiliate_kolorystyka_left"><span>Tło:</span></td>
                            <td class="affiliate_kolorystyka_right">
                                <span><input name="background_radio" class="background_color" type="radio" id="background_radio1" value="nie" checked="checked"/>nie</span>
                                <span style="margin-left:10px;"><input name="background_radio" class="background_color" type="radio" id="background_radio2" value="tak"/>tak</span>
                            </td>
                        </tr>
                        <tr id="background_tr" style="display:none;">
                            <td class="affiliate_kolorystyka_left"><span>Kolor tła:</span></td>
...
Pokaż podgląd reklamy</a>
                ...
                <div class="affiliate_js_step3_desc">
                    <p class="affiliate_php_desc">Po wciśnięciu przycisku "Generuj kod PHP" pojawi się przykładowy kod PHP, który możesz skopiować i wkleić do swojego skryptu. Możesz go dowolnie modyfikować.
                    </p>
                    <p class="affiliate_php_desc">Skrypt będzie pobierał XML zakodowany w UTF-8. Aby polskie znaki były prawidłowo wyświetlane, ustaw w kodzie odpowiednie kodowanie wejściowe i wyjściowe. Kodowanie wyjściowe musi był zgodne z kodowaniem, jakiego używasz na swojej stronie. Domyślnie zdefiniowane jest:
                    </p>
                    <ul class="php_ul">
                        <li>wejściowe (INPUT_ENCODING): UTF-8</li>
                        <li>wyjściowe - wyświetlane na Twojej stronie (OUTPUT_ENCODING): ISO-8859-2</li>
                    </ul>
                    <p class="affiliate_php_desc">Jest to ustawienie odpowiednie dla PHP5. W przypadku PHP 4 i wcześniejszych, konieczne jest ustawienie kodowania wejściowego na ISO-8859-2. Najpopularniejsze dostępne w PHP kodowania to:
                    </p>
                    <ul class="php_ul">
                        <li>UTF-8</li>
                        <li>Windows-1251</li>
                    ...
                    <p class="affiliate_php_desc">Do konwersji otrzymanego xmla używana jest funkcja iconv(), dostępna dla PHP od wersji 4.0.5. Obsługa określonych zestawów znaków jest zależna od implementacji iconv() w Twoim systemie. Proszę pamiętać, że w niektórych systemach funkcja iconv() działa niezgodnie z oczekiwaniami. W takich przypadkach nalezy zainstalować bibliotekę libiconv. Więcej informacji o funkcji iconv() i kodowaniu szukaj na stronie
...
<!--Affiliate - kody promocyjne (affiliate_generator_code, 107732.1)-->
    ...
    <iaixsl:if test="page/generator/@type ='promoCodes'">
      <div id="affiliate_promo_code" class="clearfix">
        <div class="big_label">
          Poleć znajomym i zarób
        </div>
        <iaixsl:choose>
          <iaixsl:when test="page/generator/rebate_codes/rebate_code">
            <div class="affiliate_code_desc">
              <p class="affiliate_promo_code_desc">
                Zarabianie na kodach nic Cię nie kosztuje, wymaga jedynie Twojego zaangażowania i czasu, który zainwestujesz w promocję.<br />Sprawdź jak jest to proste i zacznij zarabiać pieniądze. 
              </p>
            </div>
            ...
            <div class="info_bar row">
              <div class="info_bar_sub col-12 col-md-4">
                <div class="info_bar_sub" id="info_bar_step1">
                    ...
                    Udostępniamy Ci indywidualny kod powiązany z Twoim kontem partnerskim w naszym sklepie.
                    </div>
                </div>
              </div>
              ...
              <div class="info_bar_sub col-12 col-md-4">
                <div class="info_bar_sub" id="info_bar_step2">
                    <strong>
                    PROMUJ KODY RABATOWE
                    </strong>
                    <div class="info_bar_desc">
                    Udostępnij wybrany kod dalej np. w portalach społecznościowych lub na swojej stronie internetowej.
                    </div>
                </div>
              </div>
              ...
              <div class="info_bar_sub col-12 col-md-4">
                <div class="info_bar_sub" id="info_bar_step3">
                    ...
                    <div class="info_bar_desc">
                    Na twoje konto wróci część kwoty zapłaconej przez klientów, którzy użyli tego kodu rabatowego.
                    </div>
                </div>
              </div>
            </div>
            <div class="affiliate_code_desc">
              <p class="affiliate_promo_code_desc">
                Chcesz otrzymać niesamowite wynagrodzenie pieniężne dla siebie i swoich przyjaciół? Jeśli odpowiedź brzmi tak, po prostu skopiuj kod rabatowy i wyślij go swoim znajomym.
              </p>
            </div>
                      ...
                      <div class="n67313_out">
                        <div class="n67313_border">
                          ...
                          <span class="code_details_shops">
                            <div class="n67313_rebate_l">Aktywny w sklepach</div>
                          ...
                          <iaixsl:if test="producer/item">
                            <div class="n67313_rebate_l">Na wybranych producentów</div>
                          ...
                          <iaixsl:if test="series/item">
                            <div class="n67313_rebate_l">Na wybrane serie</div>
                          ...
                          <iaixsl:if test="main_cat/item">
                            <div class="n67313_rebate_l">Na wybrane kategorie</div>
            ...
            <div class="affiliate_code_desc">
              <p class="affiliate_promo_code_desc">
                Jeśli jesteś doświadczonym developerem i chcesz rozwinąć opcje dostosowania wyglądu przycisku z kodem rabatowym, kliknij przycisk poniżej.
              </p>
            </div>
            ...
            <form name="affiliate_form_promo_codes" id="affiliate_form_promo_codes" method="POST">
              ...
              <div class="affiliate_form_step step1">
                <div class="big_label">
                  krok1 - wybierz kod rabatowy
                </div>
                <div class="affiliate_code_desc">
                  <p class="affiliate_promo_code_desc">
                    Poniżej znajduje się lista wszystkich kodów promocyjnych aktywnych w sklepach biorących udział w programie partnerskim
                  </p>
                </div>
              ...
              <div class="form-group row justify-content-end">
                <div class="has-feedback control-label next_div_grid col-12 col-sm-9 pull-right">
                  <iaixsl:for-each select="/shop/page/generator/rebate_codes/rebate_code">
                    ...
                    Brak kodu spełniającego powyższe kryteria.
                    </div>
                </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="has-feedback control-label next_div_grid affiliate_promo_step_2_input">
                    ...
                    <label for="promo_code_text_link" id="promo_code_text_link_label" class="control-label grid">Link tekstowy
                    </label>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <label for="promo_code_text_link_icon" id="promo_code_text_link_icon_label" class="control-label grid">
                        <i class="icon-tags"></i> Link tekstowy + ikona
                    </label>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="col-6 col-sm-4 col-md-3">
                    <label for="promo_code_text_przycisk_ikona" id="promo_code_text_przycisk_ikona_label" class="control-label grid">
                        <i class="icon-tags"></i> Przycisk + ikona
                    </label>
                </div>
                </div>
            </div>
        ...
        <div class="form-group row">
            ...
            <p id="promo_codes_preview_label">
                Podgląd przycisku z kodem rabatowym 
            </p>
...
<iaixsl:attribute name="class">big_label affiliate_generator_html_step1_label</iaixsl:attribute>
				...
				<div class="step1_html_desc">
					<span>Podaj adres, pod który trafi klient (przykład: http://nazwasklepu.pl/)</span>
				</div>
				<div>
				...
				<div class="step1_html_desc2">
					<span>Podaj zawartość odnośnika (konieczne przy generowaniu kodu jako odnośnik)</span>
				</div>
				<div>
...
<iaixsl:attribute name="class">big_label affiliate_generator_html_step3_label</iaixsl:attribute>
                ...
                <div class="affiliate_html_buttons">
					...
					<a class="btn --solid generate_url_button" href="##">
                        <iaixsl:attribute name="onClick">generate('<iaixsl:value-of select="basket/@client_id"/>', 'link_url'); return false;</iaixsl:attribute>Generuj url linka
					</a>
					<a class="btn --solid generate_link_button" href="##">
						<iaixsl:attribute name="onClick">generate('<iaixsl:value-of select="basket/@client_id"/>', 'link_html'); return false;</iaixsl:attribute>Generuj kod linka
					</a>
				</div>
