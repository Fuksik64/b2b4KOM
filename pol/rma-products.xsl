            ...
            <div class="step2">
                <div class="progress_bar_wrapper pb_step2 rma_progress_bar">
                    ...
                    <div class="_step _step2">
                        ...
                        <p>
                            <i> </i>
                            <b>Wybierz produkty</b> do reklamacji
                        </p>
                    </div>
                    <div class="_step _step3">
                        ...
                        <p>
                            <i> </i>
                            <b>Wybierz sposób</b> dostarczenia
                        </p>
                    </div>
                                                ...
                                                <iaixsl:when test="@allowReturn='0'">
                                                    ...
                                                    <div class="productslist_product_info d-sm-none">
                                                        <div class="btn-icon allowReturn_1">
                                                            ...
                                                            <span>Tego produktu prawdopodobnie nie możesz reklamować. W razie potrzeby prosimy o <a href='/contact.php' >kontakt</a>.</span>
                                                        </div>
                                                    </div>
                                                </iaixsl:when>
                                                <iaixsl:when test="@allowReturn='2'">
                                                    ...
                                                    <div class="productslist_product_info d-sm-none">
                                                        <div class="btn-icon allowReturn_2">
                                                            ...
                                                            <span>Upewnij się czy możesz reklamować ten produkt, szczególnie zwracając uwagę na dzień otrzymania produktu i okres gwarancji. <a href='/#' >Chcę reklamować</a>.</span>
                                                        </div>
                                                    </div>
                                                </iaixsl:when>
                                            </iaixsl:choose>
                                            ...
                                            <td class="productslist_product_warranty">
                                                ...
                                                <iaixsl:if test="not(warranty/@gfx)">
                                                    <div class="productslist_warranty">
                                                        ...
                                                        <img class="qmark2 showTip" src="/gfx/pol/qmark2.gif?r=1600678639" alt="" title=""/>
                                        ...
                                        <td class="productslist_product_comment">
                                            <iaixsl:if test="not(@allowReturn='0') and not(@allowReturn='2')">
                                                <a href="#addComment">
                                                    ...
                                                    <i class="icon-paper-clip"></i> <span>dodaj opis lub <br/>załącznik</span>
                                                </a>
                                            </iaixsl:if>
                                        </td>
