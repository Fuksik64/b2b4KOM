...
<iaixsl:variable name="login">Twoje konto</iaixsl:variable>
<iaixsl:variable name="loginedit">Zmień swoje dane</iaixsl:variable>
<iaixsl:variable name="address">Adresy dostaw</iaixsl:variable>
<iaixsl:variable name="orders_opened">Bieżące zamówienia</iaixsl:variable>
<iaixsl:variable name="orders_closed">Zamknięte zamówienia</iaixsl:variable>
<iaixsl:variable name="affiliate">Program partnerski</iaixsl:variable>
<iaixsl:variable name="rma">Reklamacje</iaixsl:variable>
