...
<div class="col-3-height">
        ...
        <!--Navigation - elementy nawigacji (navigation_elements, 108885.1)-->
            
            <iaixsl:variable name="setLink_navigation">true</iaixsl:variable>
            
            <iaixsl:variable name="setNumber_navigation">true</iaixsl:variable>

            <div id="Navigation" class="navigation_main">
                <div class="navigation_description">
                    <h1 class="big_label">
                        <iaixsl:value-of select="page/description/name/text()"/>
                    </h1>
                    <iaixsl:if test="page/description/icon">
                        <img>
                            <iaixsl:attribute name="src"><iaixsl:value-of select="page/description/icon"/></iaixsl:attribute>
                            <iaixsl:attribute name="alt"><iaixsl:value-of select="page/description/@name"/></iaixsl:attribute>
                            <iaixsl:attribute name="title"><iaixsl:value-of select="page/description/@name"/></iaixsl:attribute>
                        </img>
                    </iaixsl:if>
                    <div class="navigation_desc">
                        <iaixsl:value-of disable-output-escaping="yes" select="page/description/desc"/>
                    </div>
                </div>

                <div class="navigation_items row mx-0">
                    <iaixsl:for-each select="page/navigation/item">
                        <a class="navigation_item col-6 col-sm-4 col-md-3">
                            <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                            <iaixsl:if test="@gfx">
                                <div class="navigation_img d-flex justify-content-center align-items-center">
                                    <img>
                                        <iaixsl:attribute name="src"><iaixsl:value-of select="@gfx"/></iaixsl:attribute>
                            ...
                            <iaixsl:if test="$setNumber_navigation">
                                <span class="count">
                                    (produktów: <span><iaixsl:value-of select="@product_quantity"/></span>)
                                </span>
                            </iaixsl:if>
                        </a>
                    </iaixsl:for-each>
                ...
                <iaixsl:if test="$setLink_navigation and /shop//item[@ni=/shop/navigation/current/@ni]/@display_all_link">
                    <a class="see_all btn --solid">
                        <iaixsl:attribute name="href">
                            <iaixsl:value-of select="/shop//item[@ni=/shop/navigation/current/@ni]/@display_all_link"/>
                        </iaixsl:attribute>
