...
<iaixsl:attribute name="class">big_label affiliate_resources_label</iaixsl:attribute>
    ...
    Twoje środki do wykorzystania
    </span>
</div>
<input type="hidden" id="payment_min"/>
<iaixsl:choose>
    <iaixsl:when test="(0 > page/payments/@total) or (page/payments/@total = '0.00')">
        <span class="affiliate_noresources">Obecnie nie masz środków które mógłbyś wykorzystać.</span>
    </iaixsl:when>
    <iaixsl:otherwise>
         <div class="affiliate_resources_wyplata">
            Stan Twojego konta partnerskiego wynosi:
            <ol>
                <li>
                    całkowity stan konta: 
                    <strong class="resources_total"><iaixsl:value-of select="page/payments/@total_formatted"/></strong>
                </li>
                <li>
                    łączna kwota pomniejszonych prowizji z powodu zwrotów produktów: 
            ...
            <iaixsl:if test="page/client/@loyalty_points = 'true'">
                 Prowizja za zamówienia pozyskanych klientów jest wypłacana w formie punktów na Twoje<a href="/affiliate-main.php">saldo w programie lojalnościowym</a>
            </iaixsl:if>
                Jeśli chcesz zamienić zgromadzone środki na bon produktowy, wpisz w poniższe pola kwotę nie mniejszą niż  
                <span class="resources_minpayment">
                    <iaixsl:value-of select="page/shop/@minpayment"/><iaixsl:value-of select="/shop/currency/@name"/>
                </span>
                <span> i nie większą niż środki zgromadzone na Twoim koncie, a następnie kliknij przycisk "Zgłoś chęć wypłaty".</span>
                <form method="POST">
                    ...
                    <div class="affiliate_resources_payment">
                        <div class="affiliate_resources_payment_sub">
                            <span class="affiliate_resources_kwota_label">Kwota do wypłaty </span>
                    ...
                    <div class="affiliate_resources_payment_type">
                        <iaixsl:choose>
                            ...
                            <iaixsl:otherwise>
                                Powyższa wartość będzie wypłacona w bonie produktowym.
                            </iaixsl:otherwise>
                        </iaixsl:choose>
                    </div>
                    <input type="submit" class="btn --solid --medium affiliate_resources_submit" id="affiliate_resources_submit">
                                <iaixsl:attribute name="value">Zgłoś chęć wypłaty</iaixsl:attribute>
                    </input>
                </form>
        </div>
    </iaixsl:otherwise>
                    ...
                    <iaixsl:choose>
                      ...
                      <iaixsl:otherwise>                       
                        <div class="affiliate-icon-status badge-success">
                         ...
                         <span> 
                          Potwierdzone <small>(<iaixsl:value-of select="@status"/>)</small>
                         </span> 
                      </iaixsl:otherwise>
                    </iaixsl:choose>
                  </div>
