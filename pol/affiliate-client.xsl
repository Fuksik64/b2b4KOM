...
<iaixsl:attribute name="class">big_label affiliate_client_label</iaixsl:attribute>
    <span class="affiliate_client_label">
        zamówienia klienta <iaixsl:value-of select="page/client/@id"/>
    </span>
</div>
<div class="affiliate_client">
   ...
   <iaixsl:attribute name="class">ui-responsive table-stroke ui-table ui-table-reflow affiliate_client</iaixsl:attribute>
            <thead>
                <tr>
                    <th id="affiliate_client_th1">id zamówienia</th>
                    <th id="affiliate_client_th2">data zamówienia</th>
                    <th id="affiliate_client_th3">data wysyłki</th>
                    <th id="affiliate_client_th4">wartość zamówienia</th>
                    <th id="affiliate_client_th5">ilość produktów</th>
                    <th id="affiliate_client_th6">płatność</th>
                    <th id="affiliate_client_th7">status</th>
                    <th id="affiliate_client_th8">partner</th>
                    <th id="affiliate_client_th9">prowizja</th>
                </tr>
            </thead>
            <tbody>
