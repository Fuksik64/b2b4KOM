                ...
                <div class="n57856_order_overtaker">
                    <form class="returns_form" method="post">
                                ...
                                <div class="order2_info1" id="order2_box_1">
                                    <div class="order2_info1_sub">
                                        ...
                                        <iaixsl:if test="page/orderclient/@nip">
                                            NIP: <iaixsl:value-of select="page/orderclient/@nip"/><br/>
                                        </iaixsl:if>
                                        e-mail
                                    ...
                                    <iaixsl:otherwise>
                                        ...
                                        <div class="order2_info1" id="order2_box_2b">
                                            ...
                                            <a class="order2_button_change_address btn --solid mt-2 mt-sm-0">
                                                ...
                                                zmień punkt dostarczenia zwrotu
                                            </a>
                                        </div>
                                    </iaixsl:otherwise>
                                </iaixsl:choose>
                        ...
                        <div id="return_products_list" class="order2_products">
                            ...
                            <iaixsl:variable name="return_with_special_offer">Dokonujesz zwrotu zamówienia na które został udzielony rabat. Wartość zwrotu zostanie wliczona z uwzględnieniem tego rabatu i odpowiednio pomniejszona w zależności od zwracanego produktu. W razie problemów zapraszamy do kontaktu z obsługą sklepu.</iaixsl:variable>
                            <iaixsl:variable name="required_from_special_offer"><span>Ten produkt wpłynął swoją ceną</span> na ceny innych produktów w koszyku.</iaixsl:variable>
                                            ...
                                            <iaixsl:if test="@required_from_special_offer = 'true' and $required_from_special_offer != ''">
                                                ...
                                                <iaixsl:if test="@required_from_special_offer = 'true'">
                                                    <div class="productslist_product_special_offer">
                                                        ...
                                                        <span>Ten produkt wpłynął swoją ceną</span> na ceny innych produktów w koszyku.
                                                    </div>
                                                </iaixsl:if>
                                            </iaixsl:if>
                            ...
                            <table class="order2_table">
                                <tr>
                                    <th class="order2_name">
                                        ...
                                        Sposób zwrotu produktów i forma zwrotu należności
                                        ...
                                        <td class="order2_name">
                                            ...
                                            <iaixsl:choose>
                                                <iaixsl:when test="/shop/page/return_method/@description">
                                                    <span class="order2_name">Sposób zwrotu produktów: 
                                    ...
                                    <td class="order2_name">
                                        ...
                                        <iaixsl:choose>
                                            <iaixsl:when test="/shop/page/repayment_method/@id = 't'">
                                                <span class="order2_name">Forma zwrotu należności: Saldo klienta</span>
                                            ...
                                            <iaixsl:when test="/shop/page/repayment_method/@id = 'b'">
                                                <span class="order2_name">Forma zwrotu należności: Przelew</span>
                                                <div class="return_description">
                                            ...
                                            <iaixsl:when test="/shop/page/repayment_method/@id = 'tc'">
                                                <span class="order2_name">Forma zwrotu należności: Przywróć kredyt kupiecki</span>
                                                <div class="return_description">
                                ...
                                <div class="basketedit_summary_right">
                                    ...
                                    <div class="basketedit_calculations">
                                        ...
                                        <iaixsl:if test="/shop/page/costs/cost[@type='shipping']/@value_formatted">
                                            <div class="basketedit_product_summary">
                                                <label>
                                                    Zwrot kosztu dostawy do klienta:
                                ...
                                <div class="basketedit_summary_buttons table_display">
                                    ...
                                    <div class="btn_wrapper">
                                        ...
                                        <input class="btn --solid --large" type="submit">
                                            ...
                                            <iaixsl:attribute name="value">Dodaj zgłoszenie zwrotu</iaixsl:attribute>

                                            <iaixsl:if test="/shop/return_edit/@return_id">
                                                <iaixsl:attribute name="value">Zapisz zmiany</iaixsl:attribute>
                                            </iaixsl:if>
