...
<div class="col-3-height">
        ...
        <!--opinie o sklepie (opinions_shop_display, 114534.1)-->
			<iaixsl:if test="/shop/page/opinions-shop/comments/@all > '0'">
				<section id="opinions_shop" class="opinions_shop">
					
					<h2 class="headline">
						<span class="headline__name">Opinie klientów o naszym sklepie</span>
					</h2>
					...
					<div class="opinions_shop__container row">
						...
						<div class="opinions_shop__block --average col-12 d-sm-flex flex-sm-wrap align-self-md-start col-md-4 col-lg-3">
							...
							<div class="opinions_shop__average mb-5 px-0 col-sm-6 pr-sm-3 col-md-12 pr-md-0">
								...
								<div class="opinions_shop__total_reviews">Liczba wystawionych opinii naszych klientów: <iaixsl:value-of select="/shop/page/opinions-shop/comments/@all"/></div>
							</div>
							...
							<div class="opinions_shop__sorts_wrapper mb-5 px-0 col-sm-6 pl-sm-3 col-md-12 pl-md-0 mb-md-0">
								...
								<div class="opinions_shop__guide">Kliknij ocenę aby filtrować opinie</div>
							</div>
						</div>
							...
							<div class="opinions_shop__wrapper">
								<iaixsl:for-each select="/shop/page/opinions-shop/comments/opinions/opinion">
									<div class="opinions_shop__opinion pb-5 mb-5">
										...
										<div class="opinions_shop__opinion_top d-flex justify-content-between align-items-center mb-2">
										...
										<div class="opinions_shop__opinion_bottom d-flex justify-content-between align-items-center flex-wrap">
											...
											<div class="opinions_shop__rate d-flex align-items-center ml-auto mb-2">
												<span class="opinions_shop__rate_text">Czy opinia była pomocna?</span>
												<a href="#thumbs_up" class="opinions_shop__thumbs --up ml-3"><i class="icon-thumbs-up-empty"></i> Tak <span class="opinions_shop__rate_count"><iaixsl:value-of select="@rate_yes"/></span></a>
												<a href="#thumbs_down" class="opinions_shop__thumbs --down ml-3"><i class="icon-thumbs-down"></i> Nie <span class="opinions_shop__rate_count"><iaixsl:value-of select="@rate_no"/></span></a>
											</div>
										</div>
										
										<iaixsl:if test="response and response != ''">
											<div class="opinions_shop__response mt-4 p-3">
												<div class="opinions_shop__response_top"><strong>Odpowiedź sklepu</strong><span class="opinions_shop__response_date"><iaixsl:value-of select="response/@date"/></span></div>
				...
				<div class="opinions_shop__opinion --skeleton pb-5 mb-5">
					...
					<div class="opinions_shop__opinion_bottom d-flex justify-content-between align-items-center flex-wrap">
						...
						<div class="opinions_shop__rate d-flex align-items-center ml-auto mb-2">
							<span class="opinions_shop__rate_text">Czy opinia była pomocna?</span>
							<a href="#thumbs_up" class="opinions_shop__thumbs --up ml-3"><i class="icon-thumbs-up-empty"></i> Tak <span class="opinions_shop__rate_count"/></a>
							<a href="#thumbs_down" class="opinions_shop__thumbs --down ml-3"><i class="icon-thumbs-down"></i> Nie <span class="opinions_shop__rate_count"/></a>
						</div>
					</div>
					
					<div class="opinions_shop__response mt-4 p-3">
						<div class="opinions_shop__response_top"><strong>Odpowiedź sklepu</strong><span class="opinions_shop__response_date"/></div>
    ...
    <iaixsl:if test="page/@type = 'blog-item'">
      <script type="application/ld+json">
        ...
        <!--Elementy dodawane dynamicznie (menu_dynamically_added_content, 106830.1)-->
            ...
            <script src="/gfx/pol/opinions_shop_display.js.gzip?r=1600678639"></script>
            <script>
                app_shop.runApp();
            </script>
