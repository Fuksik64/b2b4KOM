            ...
            <iaixsl:when test="/shop/page/rma/item">
                ...
                <div class="client_order">
                    ...
                    <table class="orders" cellspacing="0" cellpadding="0" >
                        ...
                        <thead>
                            <tr id="orders_header">
                                <td class="ord3" id="orders_head_1">ID reklamacji</td>
                                <td class="ord3" id="orders_head_2">Data reklamacji</td>
                                

                                <td class="ord3" id="orders_head_5">Status</td>
                                <td class="ord3" id="orders_head_6">Akcja</td>
                            </tr>
                        </thead>
                        <tbody>
                            <iaixsl:for-each select="/shop/page/rma/item">
                                <tr>
                                        ...
                                        <div>
                                            ...
                                            <iaixsl:choose>
                                                ...
                                                <iaixsl:when test="@status=1">
                                                    ...
                                                    <small>Reklamacja rozpatrywana</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=2">
                                                    <span><i class="icon-ok"></i></span>
                                                    <small>Reklamacja rozpatrzona pozytywnie</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=3">
                                                    <span><i class="icon-remove"></i></span>
                                                    <small>Reklamacja rozpatrzona negatywnie</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=4">
                                                    <span><i class="icon-clock"></i></span>
                                                    <small>Reklamacja rozpatrywana - Skierowano do testów</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=5">
                                                    <span><i class="icon-clock"></i></span>
                                                    <small>Reklamacja rozpatrywana - Produkt wysłany do producenta</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=6">
                                                    <span><i class="icon-clock"></i></span>
                                                    <small>Reklamacja rozpatrywana - Trwa naprawianie</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=7">
                                                    <span><i class="icon-remove"></i></span>
                                                    <small>Reklamacja rozpatrzona negatywnie - Nie stwierdzono usterki</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=8">
                                                    <span><i class="icon-remove"></i></span>
                                                    <small>Reklamacja rozpatrzona negatywnie - Wada spowodowana złą eksploatacją</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=9">
                                                    <span><i class="icon-remove"></i></span>
                                                    <small>Reklamacja rozpatrzona negatywnie - Przekroczono termin gwarancji</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=10">
                                                    <span><i class="icon-ok"></i></span>
                                                    <small>Reklamacja rozpatrzona pozytywnie - Zwrot pieniędzy - skierowanie do wypłaty</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=11">
                                                    <span><i class="icon-ok"></i></span>
                                                    <small>Reklamacja rozpatrzona pozytywnie - Zwrot pieniędzy - wypłata</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=12">
                                                    <span><i class="icon-ok"></i></span>
                                                    <small>Reklamacja rozpatrzona pozytywnie - Wymiana na nowy produkt</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=13">
                                                    <span><i class="icon-remove"></i></span>
                                                    <small>Reklamacja anulowana przez klienta</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=14">
                                                    <span><i class="icon-remove"></i></span>
                                                    <small>Reklamacja nie dotarła</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=15">
                                                    <span><i class="icon-clock"></i> </span>
                                                    <small>Klient wygenerował reklamację</small>
                                                </iaixsl:when>
                                                
                                                <iaixsl:when test="@status=16">
                                                    <span><i class="icon-remove"></i></span>
                                                    <small>Zaniechanie ponownej wysyłki zamówienia </small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=17">
                                                    <span><i class="icon-remove"></i></span>
                                                    <small>Reklamacja anulowana </small>
                                                </iaixsl:when>
                                                ...
                                                <iaixsl:when test="@status=19">
                                                    <span><i class="icon-ok"></i></span>
                                                    <small>Reklamacja potwierdzona</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=20">
                                                    <span><i class="icon-clock"></i></span>
                                                    <small>Reklamacja nieobsłużona</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=21">
                                                    <span><i class="icon-remove"></i></span>
                                                    <small>Reklamacja odrzucona</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=22">
                                                    <span><i class="icon-remove"></i></span>
                                                    <small>Reklamacja odrzucona - Nie stwierdzono usterki</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=23">
                                                    <span><i class="icon-remove"></i></span>
                                                    <small>Reklamacja odrzucona - Przekroczono termin gwarancji</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=24">
                                                    <span><i class="icon-remove"></i></span>
                                                    <small>Reklamacja odrzucona - Wada spowodowana złą eksploatacją</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=25">
                                                    <span><i class="icon-ok"></i></span>
                                                    <small>Reklamacja rozpatrzona pozytywnie - Przesyłka zwrotna wysłana do klienta</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=26">
                                                    <span><i class="icon-ok"></i></span>
                                                    <small>Reklamacja rozpatrzona pozytywnie - Wysłano nowy produkt bez oczekiwania na pierwotny</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=27">
                                                    <span><i class="icon-ok"></i></span>
                                                    <small>Reklamacja rozpatrzona pozytywnie - Zmiana danych odbiorcy na dokumencie sprzedaży</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=28">
                                                    <span><i class="icon-clock"></i></span>
                                                    <small>Reklamacja rozpatrywana - Naprawa zakończona</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=29">
                                                    <span><i class="icon-clock"></i></span>
                                                    <small>Reklamacja rozpatrywana - Wymaga dodatkowych informacji od klienta</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=30">
                                                    <span><i class="icon-remove"></i></span>
                                                    <small>Reklamacja rozpatrzona negatywnie - Przesyłka zwrotna wysłana do klienta</small>
                                                </iaixsl:when>
                                                <iaixsl:otherwise>
                                                    <span><i class="icon-ok"></i></span>
                                                    <small>
                                    ...
                                    <td class="ord">
                                        <a class="btn-icon"><iaixsl:attribute name="href"><iaixsl:value-of select="@url"/></iaixsl:attribute><span><i class='icon-plus'></i></span><small>Wybierz</small></a>
                                    </td>
                                </tr>
                            </iaixsl:for-each>
                        </tbody>
                ...
                <div class="rma_list_data_outline">
                    ...
                    <div class="rma_list_data_addbutton">
                        <a href="rma-add.php" class="btn --solid --medium rma_list_data_addbutton">
                            ...
                            <iaixsl:attribute name="title"><i class="icon-pencil"></i> Dodaj reklamację</iaixsl:attribute>
                            <span class="img_button_edytujaddbutton"/>
                            <div class="addbutton_maintxt"><i class="icon-pencil"></i> Dodaj reklamację</div>
                            <div class="addbutton_sidetxt">Masz zastrzeżenia do otrzymanego produktu? Zgłoś reklamację.</div>
                        </a>
                    </div>
                        ...
                        <div class="rma_list_data_sub">
                            ...
                            <div class="rma_list_data_toggler">
                                <div id="rma_tab_close" class="rma_list_tab" onclick="rma_list.choosePanel('rma_tab_close','rma_panel_close');">
                                    ...
                                    <span>Reklamacje zakończone</span>
                                </div>
                                ...
                                <div id="rma_panel_close" class="rma_list_data_panel" style="display:none;">
                                    ...
                                    <iaixsl:choose>
                                        <iaixsl:when test="page/list/close/@count = 0">
                                            <span class="rma_list_noitem">Brak zakończonych reklamacji.</span>
                                        </iaixsl:when>
                                        <iaixsl:otherwise>
                                            ...
                                            <iaixsl:for-each select="page/list/close/item">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="rma_list_item_operation">
                                                        więcej <i class="icon-angle-down"></i>
                                                    </span>
                                                    <span class="rma_list_item_operation ophidden">
                                                        mniej <i class="icon-angle-up"></i>
                                                    </span>
                                                </div>
                                                    ...
                                                    <div class="rma_list_item_sub">
                                                        ...
                                                        <div class="rma_list_itmesub1">
                                                            ...
                                                            <div class="rma_list_itemstatus">
                                                                <div class="rma_list_itemhead">
                                                                    <span>Aktualny status zgłoszenia reklamacyjnego:</span>
                                                                </div>
                                                        ...
                                                        <div class="rma_list_itmesub2">
                                                            ...
                                                            <div class="rma_list_itemplace">
                                                                <div class="rma_list_itemhead">
                                                                    <span>Reklamacja realizowana w:</span>
                                                                </div>
                                                                    ...
                                                                    <iaixsl:if test="stock/@link !=''">
                                                                        <div class="rma_list_itemstock_link">
                                                                            <a class="rma_list_itemstock_link">
                                                                                ...
                                                                                więcej informacji <i class="icon-double-angle-right"></i>
                                                                            </a>
                                                                        </div>
                                                                    </iaixsl:if>
                                                                </div>
                                                            ...
                                                            <div class="rma_list_itembuttons">
                                                                <iaixsl:if test="documents/postdocument ">
                                                                    <a class="btn --solid --medium rma_list_button_etykieta" target="_blank">
                                                                        ...
                                                                        <iaixsl:attribute name="title">Kliknij aby wydrukować etykietę adresową</iaixsl:attribute>
                                                                        <span class="img_button_etykieta"/>
                                                                        <i class="icon-print"></i> Wydrukuj etykietkę adresową
                                                                    </a>
                                                                </iaixsl:if>
                                                                <iaixsl:if test="documents/letterofcomplaint">
                                                                    <a class="btn --solid --medium rma_list_button_wydrukuj" target="_blank">
                                                                        ...
                                                                        <iaixsl:attribute name="title">Kliknij aby wydrukować zgłoszenie reklamacyjne</iaixsl:attribute>
                                                                        <span class="img_button_zgloszenie"/>
                                                                        <i class="icon-print"></i> Wydrukuj zgłoszenie reklamacyjne
                                                                    </a>
                                                                </iaixsl:if>
                                                                <iaixsl:if test="@edit_link and (@edit_link != '')">
                                                                    <a class="btn --solid --medium rma_list_button_edit">
                                                                        ...
                                                                        <iaixsl:attribute name="title">Kliknij aby przejść do edycji tej reklamacji</iaixsl:attribute>
                                                                        <span class="img_button_edytuj"/>
                                                                        <i class="icon-pencil"></i> Edytuj reklamację
                                                                    </a>
                                                                </iaixsl:if>
                                                                ...
                                                                <iaixsl:if test="@cancel_link and (@cancel_link != '')">
                                                                    <a class="btn --solid --medium rma_list_button_cancel">
                                                                        ...
                                                                        <iaixsl:attribute name="title">Kliknij aby anulować tę reklamację</iaixsl:attribute>
                                                                        <span class="img_button_anuluj"/>
                                                                        <i class="icon-remove"></i> Anuluj reklamację
                                                                    </a>
                                                                </iaixsl:if>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <iaixsl:if test="count(staff_note/note) > 0">
                                                            <div class="rma_list_itmesub3">
                                                                <iaixsl:if test="count(staff_note/note) = 1">
                                                                    <div class="rma_list_noteslabel">Notatka obsługi sklepu</div>
                                                                </iaixsl:if>
                                                                <iaixsl:if test="count(staff_note/note) > 1">
                                                                    <div class="rma_list_noteslabel">Notatka obsługi sklepu</div>
                                                                </iaixsl:if>
                                ...
                                <div id="rma_panel_active" class="rma_list_data_panel">
                                    ...
                                    <iaixsl:choose>
                                        <iaixsl:when test="page/list/active/@count = 0">
                                            <span class="rma_list_noitem">Brak reklamacji w toku.</span>
                                        </iaixsl:when>
                                        <iaixsl:otherwise>
                    ...
                    <iaixsl:if test="(page/list/active/@count = 0) and (page/list/close/@count = 0)">
                        <span class="rma_list_noitem" id="rma_list_noitem">Nie dodano jeszcze żadnej reklamacji.</span>
                    </iaixsl:if>
