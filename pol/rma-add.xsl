            ...
            <form id="rma_add_form" method="post" action="/rma-add.php">
                ...
                <div class="rma_add_form_addbutton">
                    <a href="rma-list.php" class="btn --solid --medium --icon-left icon-file-alt rma_add_form_listbutton">
                        <iaixsl:attribute name="title">Kliknij aby przejść do listy złożonych reklamacji</iaixsl:attribute>
                    ...
                    <span class="rma_add_form_label">
                        <iaixsl:choose>
                            <iaixsl:when test="page/rma/@action = 'view'">
                                Podgląd reklamacji nr <iaixsl:value-of select="page/rma/@id"/>
                            </iaixsl:when>
                            <iaixsl:when test="page/rma/@action = 'edit'">
                                Edycja reklamacji nr <iaixsl:value-of select="page/rma/@id"/>
                            </iaixsl:when>
                            <iaixsl:when test="page/rma/@action = 'add'">
                                Zgłoszenie nowej reklamacji
                            </iaixsl:when>
                        </iaixsl:choose>
                    </span>
                </div>
                ...
                <div class="rma_add_form_section" id="rma_add_form_section1">
                    <div class="rma_add_form_sectionheader">
                        <span class="rma_add_form_sectionheader">Twoje dane</span>
                    </div>
                    <iaixsl:if test="not(page/rma/@action = 'view')">
                        <div class="rma_add_form_sectiondesc">
                            <span class="rma_add_form_sectiondesc">Poniżej znajdują się Twoje dane, wprowadzone podczas rejestracji. Jeżeli uważasz, że są one nieaktualne, koniecznie</span>
                            <a class="rma_add_form_clientedit">
                                ...
                                <iaixsl:attribute name="title">Przejdź do edycji swoich danych</iaixsl:attribute>
                                 popraw swoje dane
                            </a>
                        </div>
                    </iaixsl:if>
                    <div class="rma_add_form_sectionsub row" id="rma_add_form_subsection1">
                        ...
                        <div class="rma_add_form_box" id="rma_add_form_box1">
                            <span class="rma_add_form_adr1">Dane billingowe:</span>
                        ...
                        <div class="rma_add_form_box" id="rma_add_form_box2">
                            <span class="rma_add_form_adr2">Adres dostawy:</span>
                            <div class="rma_add_form_boxsub3">
                                <iaixsl:choose>
                        ...
                        <div class="rma_add_form_box" id="rma_add_form_box2b">
                            <span class="rma_add_form_adr1">Dane kontaktowe:</span>
                ...
                <div class="rma_add_form_section" id="rma_add_form_section2">
                    <div class="rma_add_form_sectionheader">
                        <span class="rma_add_form_sectionheader">Informacje o reklamowanym produkcie</span>
                    </div>
                    <iaixsl:if test="not(page/rma/@action = 'view')">
                        <div class="rma_add_form_sectiondesc">
                            <span class="rma_add_form_sectiondesc">Poniższe informacje są niezbędne do rozpatrzenia reklamacji. Proszę podaj nazwę produktu wraz z rozmiarem.</span>
                        </div>
                    </iaixsl:if>
                    <div class="rma_add_form_sectionsub row" id="rma_add_form_subsection2">
                        ...
                        <div class="rma_add_form_box" id="rma_add_form_box3">
                            ...
                            <div class="rma_add_form_boxsub">
                                <span class="rma_add_form_infotitle">Miejsce zakupu:</span>
                                <span class="rma_add_form_infovalue">
                                    <iaixsl:choose>
                                        <iaixsl:when test="page/rma/@action = 'view'">
                                            <iaixsl:if test="page/rma/buy_place/place[@checked = 'true']/@name = 'shop'">Sklep internetowy </iaixsl:if>
                                            <iaixsl:if test="page/rma/buy_place/place[@checked = 'true']/@name = 'auction'">Aukcja internetowa<iaixsl:value-of select="page/rma/auctions/auction[@checked = 'true']/@name"/></iaixsl:if>
                        ...
                        <div class="rma_add_form_box" id="rma_add_form_box4">
                            ...
                            <div class="rma_add_form_descval">
                                <iaixsl:choose>
                                    <iaixsl:when test="page/rma/@action = 'view'">
                                        <span class="rma_add_form_desc">Opis usterki:</span>
                ...
                <iaixsl:if test="not(page/rma/payments/@active = '0')">
                    <div class="rma_add_form_section" id="rma_add_form_section3">
                        <div class="rma_add_form_sectionheader">
                            <span class="rma_add_form_sectionheader">Zwrot pieniędzy</span>
                        </div>
                        <iaixsl:if test="not(page/rma/@action = 'view')">
                            <div class="rma_add_form_sectiondesc">
                                <span class="rma_add_form_sectiondesc">Aby przyśpieszyć zwrot pieniędzy w przypadku gdy reklamacja zostanie rozpatrzona pozytywnie, podaj niżej w jaki sposób oczekujesz zwrotu pieniędzy. Samo podanie tych informacji nie oznacza, że reklamacja zakończy się zwrotem pieniędzy.</span>
                            </div>
                        </iaixsl:if>
                        ...
                        <div class="col-12 col-sm-4">
                            <div class="rma_add_form_box" id="rma_add_form_box5">
                                <div class="rma_add_form_boxsub2">
                                    <span class="rma_add_form_infotitle2">Forma zwrotu pieniędzy:</span>
                                    <span class="rma_add_form_infovalue2">
                                        <iaixsl:choose>
                                            <iaixsl:when test="page/rma/@action = 'view'">
                                                <iaixsl:choose>
                                                    <iaixsl:when test="page/rma/payments/payment[@checked = 'true']/@type = 'b'">Konto bankowe</iaixsl:when>
                                                    <iaixsl:when test="page/rma/payments/payment[@checked = 'true']/@type = 'p'">Przekazem na adres</iaixsl:when>
                                                    <iaixsl:when test="page/rma/payments/payment[@checked = 'true']/@type = 'c'">Czek</iaixsl:when>
                                                    <iaixsl:when test="page/rma/payments/payment[@checked = 'true']/@type = 't'">Środki do wykorzystania przy kolejnych zakupach</iaixsl:when>
                                                </iaixsl:choose>
                                            </iaixsl:when>
                                            <iaixsl:otherwise>
                                        ...
                                        <iaixsl:choose>
                                            <iaixsl:when test="page/rma/payments/payment[@checked = 'true']/@type = 'b'">
                                                <div class="rma_add_form_boxsub2_hidden" style="display:block;">
                                                    <span class="rma_add_form_infotitle2">Konto bankowe</span>
                                            ...
                                            <iaixsl:when test="page/rma/payments/payment[@checked = 'true']/@type = 'p'">
                                                <div class="rma_add_form_boxsub2_hidden" style="display:block;">
                                                    <span class="rma_add_form_infotitle2">Przekazem na adres</span>
                                                    <span class="rma_add_form_infovalue2"><iaixsl:value-of disable-output-escaping="no" select="page/rma/payments_text"/></span>
                                                </div>
                                            </iaixsl:when>
                                            <iaixsl:when test="page/rma/payments/payment[@checked = 'true']/@type = 'c'">
                                                <div class="rma_add_form_boxsub2_hidden" style="display:block;">
                                                    <span class="rma_add_form_infotitle2">Czek</span>
                                                    <span class="rma_add_form_infovalue2"><iaixsl:value-of disable-output-escaping="no" select="page/rma/payments_text"/></span>
                                                </div>
                                            </iaixsl:when>
                                        </iaixsl:choose>
                                                ...
                                                <iaixsl:choose>
                                                    <iaixsl:when test="@type = 'p'">
                                                        ...
                                                        <span class="rma_add_form_infotitle2">
                                                            ...
                                                            <iaixsl:if test="/shop/page/rma/payments/@active = '1'">
                                                                <img class="rma_need" src="/gfx/pol/need.gif?r=1600678639"><iaixsl:attribute name="alt">To pole jest wymagane do złożenia zamówienia</iaixsl:attribute></img>
                                                                <img src="/gfx/pol/correct.png?r=1600678639" class="rma_correct_img" id="rma_add_przekaz_on" style="display:none;"/>
                                                                <img src="/gfx/pol/incorrect.png?r=1600678639" class="rma_correct_img" id="rma_add_przekaz_off" style="display:none;"/>
                                                            </iaixsl:if>
                                                        </span>
                                                    ...
                                                    <iaixsl:when test="@type = 'b'">
                                                        ...
                                                        <span class="rma_add_form_infotitle2">
                                                            ...
                                                            <iaixsl:if test="/shop/page/rma/payments/@active = '1'">
                                                                <img class="rma_need" src="/gfx/pol/need.gif?r=1600678639"><iaixsl:attribute name="alt">To pole jest wymagane do złożenia zamówienia</iaixsl:attribute></img>
                                                                <img src="/gfx/pol/correct.png?r=1600678639" class="rma_correct_img" id="rma_add_bankaccount_on" style="display:none;"/>
                                                                <img src="/gfx/pol/incorrect.png?r=1600678639" class="rma_correct_img" id="rma_add_bankaccount_off" style="display:none;"/>
                                                            </iaixsl:if>
                                                        </span>
                                                    ...
                                                    <iaixsl:when test="@type = 'c'">
                                                        ...
                                                        <span class="rma_add_form_infotitle2">
                                                            ...
                                                            <iaixsl:if test="/shop/page/rma/payments/@active = '1'">
                                                                <img class="rma_need" src="/gfx/pol/need.gif?r=1600678639"><iaixsl:attribute name="alt">To pole jest wymagane do złożenia zamówienia</iaixsl:attribute></img>
                                                                <img src="/gfx/pol/correct.png?r=1600678639" class="rma_correct_img" id="rma_add_czek_on" style="display:none;"/>
                                                                <img src="/gfx/pol/incorrect.png?r=1600678639" class="rma_correct_img" id="rma_add_czek_off" style="display:none;"/>
                                                            </iaixsl:if>
                                                        </span>
                    ...
                    <div class="rma_add_form_sectionheader">
                        <iaixsl:choose>
                            <iaixsl:when test="page/rma/@action = 'view' or count(page/rma/stocks/stock) = 1">
                                <span class="rma_add_form_sectionheader">Miejsce realizacji reklamacji</span>
                            </iaixsl:when>
                            <iaixsl:otherwise>
                                <span class="rma_add_form_sectionheader">Gdzie chcesz wysłać reklamację?</span>
                            </iaixsl:otherwise>
                        </iaixsl:choose>
                    </div>
                    <iaixsl:if test="not(page/rma/@action = 'view') and count(/shop/page/rma/stocks/stock) > 1">
                        <div class="rma_add_form_sectiondesc">
                            <span class="rma_add_form_sectiondesc">Wybierz punkt przyjmowania reklamacji pod który wyślesz reklamację i z którym będziesz się kontaktował w jej sprawie</span>
                        </div>
                    </iaixsl:if>
                        ...
                        <iaixsl:for-each select="page/rma/stocks/stock">
                            <div class="rma_add_form_stock">
                                ...
                                <iaixsl:if test="not(/shop/page/rma/@action = 'view') and count(/shop/page/rma/stocks/stock) > 1">
                                    <iaixsl:attribute name="title">Kliknij, aby wybrać reklamację w tym punkcie</iaixsl:attribute>
                        ...
                        <a id="rma_add_form_submit" onmouseover="rma_add.checkInps();" class="btn --solid --medium rma_add_form_button_add">
                            ...
                            <iaixsl:choose>
                                <iaixsl:when test="page/rma/@id">
                                    ...
                                    <iaixsl:attribute name="title">Kliknij aby zapisać zmiany w reklamacji</iaixsl:attribute>
                                    Zapisz zmiany
                                </iaixsl:when>
                                <iaixsl:otherwise>
                                    <iaixsl:attribute name="title">Kliknij aby zgłosić reklamację</iaixsl:attribute>
                                    Zgłoś reklamację
                                </iaixsl:otherwise>
                            </iaixsl:choose>
