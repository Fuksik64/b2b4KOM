...
<div class="step2">
        ...
        <iaixsl:if test="page/products">
            ...
            <iaixsl:variable name="allowReturnInfo">Tego produktu nie możesz zwrócić.</iaixsl:variable>
            <iaixsl:variable name="allowReturnInfoPoint">Ten produkt kupiłeś za punkty, dlatego nie możesz go zwrócić.</iaixsl:variable>
            <iaixsl:variable name="allowReturnInfoGratis">Ten produkt dostałeś w gratisie, dlatego nie możesz go zwrócić.</iaixsl:variable>
                            ...
                            <tr class="productslist_tools_bottom">
                                ...
                                <iaixsl:if test="/shop/page/products/product/@required_from_special_offer = 'true' and $required_from_special_offer != ''">
                                    ...
                                    <iaixsl:if test="not($allowReturnInfo) or ($allowReturnInfo and (count(/shop/page/products/product) - count(/shop/page/products/product[@allowReturn='0'])) > 1)">
                                        <a href="#selectall" class="btn --solid --icon-left icon-plus select_all">Zaznacz wszystkie produkty</a>
                                    </iaixsl:if>
