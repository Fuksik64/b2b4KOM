...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 107421.1)-->
            ...
            <iaixsl:if test="(action/set_render/item/@name = 'popup') or not(action/set_render/item)">
                ...
                <script src="/gfx/pol/login.js.gzip?r=1600678639"></script></head>
        ...
        <iaixsl:if test="(page/@type = 'login') and (page/login/@type='ok') and not(page/login/response)">
            <div id="login_welcome" class="l_welcome">
                ...
                <span class="l_welcome__element --text">
                    Cieszymy się z Twoich ponownych odwiedzin
                </span>
                                    ...
                                    <div class="login_menu_sub col-12">
                                        ...
                                        <div class="balance_section">
                                            ...
                                            <iaixsl:if test="page/login/client_balance/balance/@value > 0">
                                                ...
                                                <span>Twoje saldo (nadpłata): </span>
                                            ...
                                            <iaixsl:if test="page/login/client_balance/limit/@value > 0">
                                                <div class="login_point_count">
                                                <span>Pozostały limit kredytowy: </span>
                                            ...
                                            <iaixsl:if test="page/login/client/invoice_data/@account_number">
                                                <div class="login_point_count">
                                                <span>Indywidualne konto do Twoich wpłat:
                                                    <span class="btn_note"><i class="icon-question"></i></span><div class="tooltipContent">Ten numer konta jest Twoim unikatowym numerem konta. Dzięki niemu możesz na ten numer opłacać zamówienia. Te konto jest tylko i wyłącznie Twoje, więc jeśli nawet się pomylisz i przelejesz za dużo środków zostaną one dodane do Twojego salda.</div></span>
                    ...
                    <div class="login_menu_wrapper col-12 row mx-0 flex-wrap align-items-stretch">
                        ...
                        <iaixsl:if test="/shop/page/actions/products_wishes/@url or /shop/page/actions/products_requests/@url">
                            <div class="login_menu col-md-6 col-12" id="products_login">
                                <div class="login_menu_sub">
                                    <h3>
                                        <iaixsl:choose><iaixsl:when test="$iconsproducts"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsproducts"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="products" src="/gfx/pol/products.png?r=1600678639"/></iaixsl:otherwise></iaixsl:choose>
                                        PRODUKTY
                                    </h3>
                                    <div><span>Przeglądaj i edytuj swoją listę zakupową. W tej sekcji możesz również edytować listę produktów poszukiwanych, które chciałbyś zobaczyć w naszym sklepie.</span></div>
                        ...
                        <iaixsl:if test="/shop/page/actions/orders_opened/@url or /shop/page/actions/orders_closed/@url">
                            <div class="login_menu col-md-6 col-12" id="orders_login">
                                <div class="login_menu_sub">
                                    <h3>
                                        <iaixsl:choose><iaixsl:when test="$iconsorders"><i><iaixsl:attribute name="class"><iaixsl:value-of select="$iconsorders"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="orders" src="/gfx/pol/orders.png?r=1600678639"/></iaixsl:otherwise></iaixsl:choose>
                                        ZAMÓWIENIA I DOSTĘPNE ŚRODKI
                                    </h3>
                                    <div><span>Sekcja, w której możesz na bieżąco śledzić postęp realizacji bieżących zamówień, zarządzać wpłatami oraz przejrzeć zrealizowane już przez nas zamówienia.</span></div>
                                        <a class="btn --outline">
                        ...
                        <div class="login_menu col-md-6 col-12" id="client_cards">
                            <div class="login_menu_sub">
                                <h3>
                                    <iaixsl:choose><iaixsl:when test="$iconsprofit"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsprofit"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="profit" src="/gfx/pol/profity.png?r=1600678639"/></iaixsl:otherwise></iaixsl:choose>
                                    PROFITY ZA BYCIE LOJALNYM KLIENTEM
                                </h3>
                                <div><span>Sprawdź czy posiadasz jakieś ważne karty stałego klienta i co można zrobić aby je otrzymać. Sprawdź również na jakie grupy produktów uzyskasz rabat i w jakiej wysokości.</span></div>
                        ...
                        <iaixsl:if test="/shop/page/actions/client_edit/@url">
                            <div class="login_menu col-md-6 col-12" id="dane_login">
                                <div class="login_menu_sub">
                                    <h3>
                                        <iaixsl:choose><iaixsl:when test="$iconseditdata"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconseditdata"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="editdata" src="/gfx/pol/editdata.png?r=1600678639"/></iaixsl:otherwise></iaixsl:choose>
                                        <iaixsl:choose><iaixsl:when test="/shop/client_files/@to_download = 'true'">DANE OSOBOWE I PLIKI DO POBRANIA</iaixsl:when><iaixsl:otherwise>DANE OSOBOWE</iaixsl:otherwise></iaixsl:choose>
                                    </h3>
                                    <div><span>W tym miejscu możesz sprawdzić lub zmienić Twoje dane osobowe, dodać nowe adresy dostaw, których będziesz mógł użyć przy składaniu zamówienia oraz zmienić walutę i język sklepu.</span></div>
                        ...
                        <div class="login_menu col-md-6 col-12" id="returns_login">
                            <div class="login_menu_sub">
                                <h3>
                                    <iaixsl:choose><iaixsl:when test="$iconsreturns"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsreturns"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="returns" src="/gfx/pol/returns.png?r=1600678639"/></iaixsl:otherwise></iaixsl:choose>
                                    ZWROTY PRODUKTÓW
                                </h3>
                                <div><span>Zarządzaj swoimi zwrotami produktów. W tej sekcji możesz dodać zwrot zakupionego u nas produktu oraz wyświetlić informacje o zgłoszonych wcześniej w naszym sklepie zwrotach.</span></div>
                                <a class="btn --outline">
                        ...
                        <iaixsl:if test="/shop/rma/@active = 'y' and /shop/rma/@link">
                            <div class="login_menu col-md-6 col-12" id="rma_login">
                                <div class="login_menu_sub">
                                    <h3>
                                    <iaixsl:choose><iaixsl:when test="$iconsrma"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsrma"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="rma" src="/gfx/pol/rma.png?r=1600678639"/></iaixsl:otherwise></iaixsl:choose>

                                        REKLAMACJE PRODUKTÓW
                                    </h3>
                                    <div><span>Ta sekcja pozwala na złożenie reklamacji produktów w naszym sklepie. Jeśli już złożyłeś reklamację znajdziesz tu jej szczegóły oraz informacje o stanie jej realizacji.</span></div>
                                    <a class="btn --outline">
                        ...
                        <iaixsl:if test="(/shop/page/actions/client_rebate_points/@url and not(/shop/page/actions/client_rebate_points/@url='')) or /shop/page/actions/products_points/@available='true' or (/shop/page/actions/points_cms/@url and not(/shop/page/actions/points_cms/@url=''))">
                            <div class="login_menu col-md-6 col-12" id="points_login">
                                <div class="login_menu_sub">
                                    <h3>
                                        <iaixsl:choose><iaixsl:when test="$iconspoints"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconspoints"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="points" src="/gfx/pol/points.png?r=1600678639"/></iaixsl:otherwise></iaixsl:choose>
                                        PROGRAM LOJALNOŚCIOWY
                                        <iaixsl:if test="/shop/basket/@client_points">
                                            <span>Obecnie posiadasz: <strong><iaixsl:value-of select="/shop/basket/@client_points"/> pkt.</strong></span>
                                        </iaixsl:if>
                                    </h3>
                        ...
                        <iaixsl:if test="/shop/page/affiliate and /shop/page/affiliate/@link">
                            <div class="login_menu col-md-6 col-12" id="affiliate_login">
                                <div class="login_menu_sub">
                                    <h3>
                                        <iaixsl:choose><iaixsl:when test="$iconsaffiliate"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsaffiliate"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="affiliate" src="/gfx/pol/affiliate.png?r=1600678639"/></iaixsl:otherwise></iaixsl:choose>
                                        PROGRAM PARTNERSKI
                                    </h3>
