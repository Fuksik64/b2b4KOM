...
<div class="categories-wrapper-ul2 ">
    ...
    <!--Rma metoda reklamacji (rma_methods_form, 107099.1)-->
        ...
        <iaixsl:if test="page/@type = 'rma_products' and page/@display = 'method'">
            ...
            <iaixsl:variable name="n69372_p_txt">Forma reklamacji</iaixsl:variable>
            ...
            <div class="step3">
                ...
                <h1 class="big_label return_label">W jaki sposób chciałbyś dostarczyć reklamowany produkt?</h1>
...
<iaixsl:if test="/shop/client_data/@phone and /shop/client_data/@phone = '' and @id = 4"><iaixsl:attribute name="class">return_type choose_return_type disabled_inpost</iaixsl:attribute></iaixsl:if>
                                        ...
                                        <div class="return_name">
                                            <iaixsl:choose>
                                                ...
                                                <iaixsl:when test="@id = 1">
                                                    Dostarczę osobiście do jednego z punktów obsługi reklamacji
                                                </iaixsl:when>
                                                <iaixsl:when test="@id = 2">
                                                    Skorzystam z przesyłki opłaconej przez sklep
                                                </iaixsl:when>
                                        ...
                                        <div class="return_desc">
                                            <iaixsl:choose>
                                                ...
                                                <iaixsl:when test="@id = 1">
                                                    Zobowiązuję się do osobistego dostarczenia paczki do wybranego punktu obsługi reklamacji.
                                                </iaixsl:when>
                                                <iaixsl:when test="@id = 2 and @shipping_cost='client'">                                               
                                                     Koszt przesyłki zostanie odliczony od zwracanej mi kwoty do reklamacji.                                                            
                                                </iaixsl:when>
                                                <iaixsl:when test="@id = 2 and @shipping_cost='shop'">                                               
                                                     Koszt przesyłki ponosi sklep                                                            
                                                </iaixsl:when>
                                                <iaixsl:when test="@id = 3">
                                                    Zobowiązuję się do samodzielnego nadania paczki wraz z poniesieniem wszystkich kosztów związanych z dostarczeniem produktu do sklepu.
                                                </iaixsl:when>                                            
                                            </iaixsl:choose>
                                        </div>
                                        <iaixsl:if test="$n69372_p_txt and  shipping/delivery">
                                            ...
                                            <iaixsl:if test="$n69372_shipping_title and  /shop/page/return_methods/@shipping_balanced_refund = 'true'">
                                                <div class="n69372_shipping_balance">
                                                    ...
                                                    <div>
                                                        Przy wyborze <b>zwrotu środków na saldo klienta.</b><br/>Dla wybranej formy reklamacji. 
                                                    </div>
                                                </div>
                                            </iaixsl:if>
                                            ...
                                            <div class="return_methods_info">
                                                Formę reklamacji wybierzesz w następnym kroku.
                                            </div>
                                        </iaixsl:if>
                                    </div>
                    ...
                    <iaixsl:if test="page/rma_deliveries/rma_delivery/delivery">
                        ...
                        <div class="return_delivery_form">
                            <h1 class="big_label return_label">Wybierz sposób wysyłki reklamowanego produktu</h1>
