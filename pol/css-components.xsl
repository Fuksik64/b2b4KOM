...
<div class="col-3-height">
        ...
        <!--Własne css (css_components_own, 106493.1)-->
            <iaixsl:for-each select="test_items/test_item"> 
                <iaixsl:value-of disable-output-escaping="yes" select="."/>
            </iaixsl:for-each>
            <iaixsl:value-of disable-output-escaping="yes" select="style"/>
        <!--Ikony (css_components_icons, 96338.1)-->



<!--Karuzela (css_components_carousel, 107306.1)-->

<!--Grid (css_components_layout, 106469.1)-->



<!--Przyciski (css_components_buttons, 96383.1)-->



<!--Formularze (css_components_forms, 96340.1)-->


        <!--Stronicowanie (css_components_pagination, 96360.1)-->



<!--Listy rozwijane (css_components_dropdown, 108115.1)-->



<!--Mapa (css_components_map, 96440.1)-->
