...
<iaixsl:attribute name="class">big_label affiliate_clients_label</iaixsl:attribute>
    ...
    <iaixsl:when test="count(page/clients_list/login)">
        <div class="affiliate_clients_desc">
            <p class="affiliate_clients_desc">Poniżej znajduje się lista wszystkich klientów, którzy założyli konto po wejściu z Twojego polecenia.</p>
        </div>
   ...
   <iaixsl:attribute name="class">ui-responsive table-stroke ui-table ui-table-reflow affiliate_clients</iaixsl:attribute>
                    ...
                    <thead>
                        <tr>
                            <th id="affiliate_clients_th1">id klienta</th>
                            <th id="affiliate_clients_th3">data założenia konta</th>
                        </tr>
                    </thead>
                    <tbody>
    ...
    <iaixsl:otherwise>
        <div class="affiliate_clients_desc_null">
            W chwili obecnej nie posiadasz klientów którzy założyli konto z Twojego polecenia.
        </div>
    </iaixsl:otherwise>
    </iaixsl:choose>
</iaixsl:if>
