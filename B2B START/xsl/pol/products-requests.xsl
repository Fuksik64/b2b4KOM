...
<iaixsl:if test="/shop/page/@cache_basket"/>
        ...
        <!--Produkty zaproponowane - CMS (products_requests_cms, 58581.1)-->
    <iaixsl:if test="page/text/body">
        <div class="products_requests_cms_label">
<iaixsl:attribute name="class">products_requests_cms_label big_label</iaixsl:attribute>
            <span class="products_requests_cms_label">
                    Jak działa zgłaszanie produktów?
            </span>
        </div>
        <div class="products_requests_cms">
            <div class="products_requests_cms_sub">
                <iaixsl:value-of disable-output-escaping="yes" select="page/text/body"/>
            </div>    
        </div>
    </iaixsl:if>
    <!--Produkty zaproponowane - lista (products_requests_list, 58582.1)-->
    <div class="products_requests_list">
        <div class="products_requests_list_label">
<iaixsl:attribute name="class">products_requests_cms_label  big_label</iaixsl:attribute>

            <span class="products_requests_list_label">
                    Lista poszukiwanych produktów
            </span>
        </div>
        
        <div class="products_requests_list_sub">
            <table class="products_requests_list" cellspacing="0" cellpadding="0">
                <iaixsl:for-each select="page/products_requests/item">
                    <tr>
                        <iaixsl:attribute name="class">
                            <iaixsl:if test="position() mod 2 = 0">products_requests_list_itemp</iaixsl:if><iaixsl:if test="position() mod 2 = 1">products_requests_list_itemn</iaixsl:if>
                        </iaixsl:attribute>
                        <td class="products_requests_list_info1">
                            <iaixsl:if test="@name">
                                <div class="products_requests_list_name">
                                    <span class="products_requests_list_name"><iaixsl:value-of select="@name"/></span>
                                </div>
                            </iaixsl:if>
                            <iaixsl:if test="@desc">
                                <div class="products_requests_list_desc">
                                    <iaixsl:value-of select="@desc"/>
                                </div>
                            </iaixsl:if>
                        </td>
                        <td class="products_requests_list_info2">
                            <div class="products_requests_list_date">
                                <span class="products_requests_list_date_title">Data zgłoszenia: </span>
                                <span class="products_requests_list_date_val"><iaixsl:value-of select="@date"/></span>
                            </div>
                            <a class="products_requests_list_remlink">
                                <iaixsl:attribute name="href"><iaixsl:value-of select="@remove_link"/></iaixsl:attribute>
                                <iaixsl:attribute name="title">Kliknij, aby usunąć zgłoszenie tego produktu.</iaixsl:attribute>
                                usuń z listy
                            </a>
                        </td>
                    </tr>
            ...
            <div class="products_requests_add">
                Aby dodać nowy produkt do listy poszukiwanych, skorzystaj z 
                <a class="products_requests_add">
                    <iaixsl:attribute name="href"><iaixsl:value-of select="page/action/noproduct/@url"/></iaixsl:attribute>
                    <iaixsl:attribute name="title">Formularz zgłaszania sugestii produktów</iaixsl:attribute>
                    formularza zgłaszania sugestii produktów</a>.
            </div>
        </div>    
