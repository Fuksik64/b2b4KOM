...
<div class="payment_card">
    <div class="payment_card_sub">
        <div class="payment_card_info">
            Dane karty nie będą przechowywane w naszym systemie. Zostaną wykasowane natychmiast po zrealizowaniu transakcji.
        </div>
        ...
        <form class="payment_card">
                ...
                <iaixsl:choose>
                    <iaixsl:when test="@name = 'creditCard[system]'">
                        <div class="payment_card_formel cc_wrapper">
                            <label for="credit_card_system" class="payment_card_formel">Rodzaj karty:</label>
                            ...
                            <span class="payment_card_need">
                                <img src="/gfx/pol/need.gif?r=1600678639" class="payment_card_nedd_img"><iaixsl:attribute name="alt">To pole jest wymagane do dokonania płatności</iaixsl:attribute><iaixsl:attribute name="title">To pole jest wymagane do złożenia zamówienia</iaixsl:attribute></img>
                                <img src="/gfx/pol/correct.png?r=1600678639" class="payment_card_correct_img" style="display:none;"/><img src="/gfx/pol/incorrect.png?r=1600678639" class="payment_card_wrong_img" style="display:none;"/>
                                <span class="payment_card_help"><span class="payment_card_help2">Wybierz system kart kredytowych</span></span>
                            </span>
                    ...
                    <iaixsl:when test="@name = 'creditCard[number]'">
                        <div class="payment_card_formel">
                            <label for="credit_card_number" class="payment_card_formel">Numer karty:</label>
                    ...
                    <iaixsl:when test="@name = 'creditCard[endDateMonth]'">
                        <div class="payment_card_formel">
                            <label for="credit_card_month" class="payment_card_formel">Data ważności:</label>
                        ...
                        <div class="payment_card_datedesc">
                            Datę ważności należy wpisać w postaci dwucyfrowych liczb, np. 04/12
                        </div>
                    </iaixsl:when>
                    <iaixsl:when test="@name = 'creditCard[securityCode]'">
                        <div class="payment_card_formel">
                            <label for="credit_card_code" class="payment_card_formel">Kod zabezpieczający (CVV):</label>
                    ...
                    <iaixsl:when test="@name = 'creditCard[name]'">
                        <div class="payment_card_formel">
                            <label for="credit_card_name" class="payment_card_formel">Imię i nazwisko:</label>
            ...
            <div class="credit_card_submit">
                <button class="btn --solid --large credit_card_submit disabled" type="submit">
                    <iaixsl:attribute name="title">Dokonaj płatności</iaixsl:attribute>
                    Dokonaj płatności
                </button>
