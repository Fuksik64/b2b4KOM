    ...
    <div class="products_bought row" id="productpb_bought">
        ...
        <div id="pb_list" class="pb_list">
            <div class="pb_list_header row d-none d-md-flex">
                ...
                <div class="pb_header_date col-2">Data ostatniego zakupu</div>
                <div class="pb_header_price col-2">Cena jedn.</div>
            </div>
                ...
                <div class="pb_product">
                    ...
                    <div class="col-md-1 col-12 mb-3 mb-md-0">
                        <div class="pb_icon">
                            <a>
                                <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                                <img class="basket_prod rwd-src" alt="Szczegoly" src="/gfx/pol/loader.gif?r=1600678639">
                                    ...
                                    <iaixsl:for-each select="bundled/product">
                                        <span>
                                            ...
                                            <iaixsl:if test="@product_type = 'product_virtual'">
                                                <i class="product_virtual">Produkt wirtualny</i>
                                            </iaixsl:if>

                                            <iaixsl:if test="@product_type = 'product_service'">
                                                <i class="product_service">Usługa</i>
                                            </iaixsl:if>
                                        </span>
                                    </iaixsl:for-each>
                                </div>
                    ...
                    <div class="col-md-2 col-12 mb-3 mb-md-0">
                        <div class="pb_date">
                            <span class="d-block d-md-none">Data ostatniego zakupu</span>
                    ...
                    <div class="col-md-2 col-12 mb-3 mb-md-0">
                        <div class="pb_price">
                            <span class="d-block d-md-none">Cena jedn.</span>
                            <iaixsl:choose>
