...
<iaixsl:if test="/shop/page/@cache_basket"/>
   ...
   <!--Lista zamówień klienta (client-orders, 110015.1)-->

            
            <iaixsl:variable name="setSerialNumber">
                true
            </iaixsl:variable>

            <div class="client_order">
                <iaixsl:choose>
                    <iaixsl:when test="page/orders/@mode = 'rma'">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
                            <h1 class="big_label">
                                Wählen Sie die gewünschte Reihenfolge zu Waren werben
                            </h1>
                        </div>
                    </iaixsl:when>
                    <iaixsl:when test="page/orders/@mode = 'returns'">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
                            <h1 class="big_label">
                                Bitte wählen Sie die Bestellung aus, aus der Sie einen oder mehrere Artikel zurücksenden möchten
                            </h1>
                        </div>
                    </iaixsl:when>
                    <iaixsl:when test="page/orders/@mode = 'closed'">
                        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
                            <h1 class="big_label">
                                Abgeschlossene und stornierte Bestellungen
                            </h1>
                            <a href="client-orders.php?display=opened" class="btn --solid --medium mt-2">
                                <iaixsl:if test="/shop/action/clientOrders/@url"><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/clientOrders/@url"/>?display=opened</iaixsl:attribute></iaixsl:if>
                                Die Liste der offenen Bestellungen
                            </a>
                        </div>
                    </iaixsl:when>
                    <iaixsl:otherwise>
                        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
                            ...
                            <a href="client-orders.php?display=closed" class="btn --solid --medium mt-2">
                                <iaixsl:if test="/shop/action/clientOrders/@url"><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/clientOrders/@url"/>?display=closed</iaixsl:attribute></iaixsl:if>

                                Die Liste der bereits abgeschlossenen Bestellungen
                            </a>
                        </div>
                    </iaixsl:otherwise>
                </iaixsl:choose>
                <iaixsl:choose>
                    <iaixsl:when test="/shop/page/orders/item">

                        <iaixsl:if test="page/orders/@mode = 'closed'">
                                ...
                                <table class="orders" cellspacing="0" cellpadding="0"  id="rebates">
                                    <tr>
                                        <td colspan="3" class="headerek" id="rabat_header">
                                            Gesamtwert der abgeschlossenen Bestellungen
                                    ...
                                    <tr>
                                        <td class="headerek" id="rebate_left">
                                            <iaixsl:value-of select="page/orders/sum/@quater_formatted"/>
                                        </td>
                                        <td class="headerek" id="rebate_center">
                                            <iaixsl:value-of select="page/orders/sum/@year_formatted"/>
                                        </td>
                                        <td class="headerek" id="rebate_right">
                                            <iaixsl:value-of select="page/orders/sum/@all_formatted"/>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                        ...
                        <div class="n54068_head_separator">
                            <iaixsl:if test="not(page/orders/@mode = 'closed')">
                                <iaixsl:attribute name="id">header_open</iaixsl:attribute>
                            </iaixsl:if>
                            <iaixsl:if test="page/orders/@mode = 'closed'">
                                <iaixsl:attribute name="id">header_closed</iaixsl:attribute>
                            </iaixsl:if>
                        </div>

                        
                        <table class="orders" cellspacing="0" cellpadding="0" >
                            <iaixsl:attribute name="class">ui-responsive table-stroke ui-table ui-table-reflow orders</iaixsl:attribute>
                            <thead>
                                <tr>
                                    <th id="orders_th1">
                                        Bestellungs-ID
                                    ...
                                    <iaixsl:if test="not(page/orders/@mode = 'returns') and not(page/orders/@mode = 'rma')">
                                        <th id="orders_th3">
                                            Zahlbetrag
                                        </th>
                                        <th id="orders_th4">
                            ...
                            <tbody>
                                <iaixsl:for-each select="/shop/page/orders/item">
                                    <iaixsl:variable name="status_order"><iaixsl:choose><iaixsl:when test="@status != ''"><iaixsl:value-of select="@status"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="@finished"/></iaixsl:otherwise></iaixsl:choose></iaixsl:variable>
                                    <tr>
                                        <td>
                                            <iaixsl:choose>
                                        ...
                                        <iaixsl:if test="not(/shop/page/orders/@mode = 'returns')  and not(/shop/page/orders/@mode = 'rma')">
                                            <td>
                                                <iaixsl:value-of select="@cost_formatted"/>
                                            </td>
                                            <td>
                                                <iaixsl:choose>
                                                    <iaixsl:when test="$status_order = 'k' or $status_order = 'i' or $status_order = 'j' or $status_order = 's'  or $status_order = 'l'">
                                                        Nicht zutreffend
                                                    </iaixsl:when>
                                                    <iaixsl:when test="@paymentstatus = 'g' and (@paid and (number(@cost) > number(@paid)))">
                                                        bezahlt
                                                        <iaixsl:value-of select="@paid_formatted"/>
                                                        <br/>
                                                        
                                                        per Nachnahme noch <br/>

                                                    </iaixsl:when>
                                                    <iaixsl:when test="@paymentstatus = 'g'">
                                                        per Nachnahme
                                                    </iaixsl:when>
                                                    <iaixsl:otherwise>
                                                        <iaixsl:if test="@paid and (number(@cost) > number(@paid))">
                                                            bezahlt
                                                            <iaixsl:value-of select="@paid_formatted"/>
                                                            <br/>
                                                        </iaixsl:if>
                                                        ...
                                                        <div>
                                                            <iaixsl:choose>
                                                                <iaixsl:when test="@prepaid > 0">
                                                                    <iaixsl:attribute name="class">n54068_prepaid_desc</iaixsl:attribute>

                                                                    <iaixsl:choose>
                                                                        <iaixsl:when test="$status_order = 'k' or $status_order = 'i' or $status_order = 'j' or $status_order = 's'  or $status_order = 'l'">
                                                                            Nicht zutreffend
                                                                        </iaixsl:when>
                                                                        <iaixsl:when test="@prepaidstatus ='n'">
                                                                            <iaixsl:choose>
                                                                                <iaixsl:when test="@paid and (number(@cost) > number(@paid))">
                                                                                    bezahlen den Rest diese Bestellung
                                                                                </iaixsl:when>
                                                                                <iaixsl:otherwise>
                                                                                    unbezahlt
                                                                                </iaixsl:otherwise>
                                                                        ...
                                                                        <iaixsl:when test="@prepaidstatus ='c'">
                                                                            in Erwartung der Zahlungsfreigabe
                                                                        </iaixsl:when>
                                                                        <iaixsl:when test="@prepaidstatus ='b'">
                                                                            Rückerstattung der Einzahlung
                                                                        </iaixsl:when>
                                                                        <iaixsl:when test="@prepaidstatus ='y'">
                                                                            bezahlt
                                                                        </iaixsl:when>
                                                                        <iaixsl:when test="@prepaidstatus ='z'">
                                                                            wurde durch den Kunden storniert
                                                                        </iaixsl:when>
                                                                    </iaixsl:choose>

                                                                </iaixsl:when>
                                                                <iaixsl:otherwise>
                                                                    <iaixsl:attribute name="class">n54068_prepaid_desc_big</iaixsl:attribute>
                                                                    ...
                                                                    <iaixsl:choose>
                                                                        ...
                                                                        <iaixsl:when test="@prepaidstatus ='y'">
                                                                            <iaixsl:choose>
                                                                                <iaixsl:when test="$status_order = 'w'">
                                                                                    nicht bezahlt
                                                                                </iaixsl:when>
                                                                                <iaixsl:otherwise>
                                                                                    bezahlt
                                        ...
                                        <td>
                                            <div><iaixsl:attribute name="class">btn-icon prepaid-icon status-<iaixsl:value-of select="$status_order"/></iaixsl:attribute>
                                                <iaixsl:choose>
                                                    <iaixsl:when test="@returned_items = 'fully'">
                                                        <span><i class="icon-ok"></i></span>
                                                        <small>zurückgegeben</small>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="@returned_items = 'partially'">
                                                        <span><i class="icon-truck"></i> </span>
                                                        <small>teilweise zurückgegeben</small>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="$status_order = 'k'">
                                                        <span><i class="icon-remove"></i></span>
                                                        <small>storniert</small>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="$status_order = 't'">
                                                        <span><i class="icon-ok"></i></span>
                                                        <small><iaixsl:choose><iaixsl:when test="@personal_collection = 'yes'">empfangen</iaixsl:when><iaixsl:otherwise>versandt</iaixsl:otherwise></iaixsl:choose></small>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="$status_order = 'n'">
                                                        <span><i class="icon-clock"></i></span>
                                                        <small>angenommen</small>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="$status_order = 'o'">
                                                        <span><i class="icon-clock"></i></span>
                                                        <small>in Bearbeitung</small>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="$status_order = 'p'">
                                                        <span><i class="icon-ok"></i></span>
                                                        <small>fertig</small>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="$status_order = 'i'">
                                                        <span><i class="icon-remove"></i></span>
                                                        <small>abgelehnt</small>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="$status_order = 's'">
                                                        <span><i class="icon-attention"></i></span>
                                                        <small>storniert</small>
                                                    </iaixsl:when>

                                                    <iaixsl:when test="$status_order = 'z'">
                                                        <span><i class="icon-back"></i></span>
                                                        <small>die Rückgabe </small>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="$status_order = 'h'">
                                                        <span><i class="icon-pause"></i></span>
                                                        <small>angehalten</small>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="$status_order = 'w'">
                                                        <iaixsl:choose>
                                                            <iaixsl:when test="number(@paid) = number(@cost)">
                                                                <span><i class="icon-clock"></i></span>
                                                                <small>Warten auf die Umsetzung</small>
                                                            </iaixsl:when>
                                                            <iaixsl:when test="number(@paid) > 0">
                                                                <span><i class="icon-money"></i></span>
                                                                <small>in Erwartung der Realisierung</small>
                                                            </iaixsl:when>
                                                            <iaixsl:otherwise>
                                                                <span><i class="icon-pause"></i></span>
                                                                <small>in Erwartung der Einzahlung</small>
                                                            </iaixsl:otherwise>
                                                        </iaixsl:choose>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="$status_order = 'd'">
                                                        <span><i class="icon-pause"></i></span>
                                                        <small>in Erwartung der Lieferung</small>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="$status_order = 'r'">
                                                        <span><i class="icon-back"></i></span>
                                                        <small>Reklamation</small>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="$status_order = 'l'">
                                                        <span><i class="icon-attention"></i></span>
                                                        <small>wird vermisst</small>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="$status_order = 'j'">
                                                        <span><i class="icon-paperclip"></i></span>
                                                        <small>gebündelt</small>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="$status_order = 'a'">
                                                        <span><i class="icon-calendar"></i></span>
                                                        <small>in Bearbeitung</small>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="$status_order = 'b'">
                                                        <span><i class="icon-box"></i></span>
                                                        <small>wird gepackt</small>
                                                    </iaixsl:when>
                                        ...
                                        <td>
                                            <iaixsl:choose>
                                                <iaixsl:when test="@returns_url">
                                                    <a class="btn --icon-left icon-plus --medium see_button pr-0"><iaixsl:attribute name="href"><iaixsl:value-of select="@returns_url"/></iaixsl:attribute><span><i class='icon-plus'></i></span><small>Retoure hinzufügen</small></a>
                                                </iaixsl:when>
                                                <iaixsl:when test="@rma_url">
                                                    <a class="btn --icon-left icon-plus --medium see_button pr-0"><iaixsl:attribute name="href"><iaixsl:value-of select="@rma_url"/></iaixsl:attribute><span><i class='icon-plus'></i></span><small>Wählen</small></a>
                                                </iaixsl:when>
                                                <iaixsl:otherwise>
                                                    <a class="btn --icon-left icon-plus --medium see_button pr-0"><iaixsl:attribute name="href"><iaixsl:value-of select="@orderdetails"/></iaixsl:attribute><span><i class='icon-plus'></i></span><small>mehr...</small></a>
                                                </iaixsl:otherwise>
                                            </iaixsl:choose>
                                        </td>
                                    </tr>
                    ...
                    <iaixsl:otherwise>
                        <div class="client_orders_null">
                            <iaixsl:choose>
                                <iaixsl:when test="page/orders/@mode = 'rma'">
                                    Derzeit haben wir keine Beschwerden.
                                </iaixsl:when>
                                <iaixsl:when test="page/orders/@mode = 'returns'">
                                    Derzeit haben Sie keine Bestellungen, die zurückgegeben werden können.
                                </iaixsl:when>
                                <iaixsl:when test="page/orders/@mode = 'closed'">
                                    Derzeit hast du keine bearbeiteten Bestellungen.
                                </iaixsl:when>
                                <iaixsl:otherwise>
                                    Derzeit haben Sie keine Aufträge verarbeitet.
                                </iaixsl:otherwise>
                            </iaixsl:choose>
                        </div>
                        <div class="n54744_goback">
                            <a class="btn --solid n54744" href="/main.php">
                                <iaixsl:if test="/shop/action/main/@url"><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/main/@url"/></iaixsl:attribute></iaixsl:if>
        ...
        <!--Stronicowanie wyników (client_orders_paging, 110572.1)-->
        <iaixsl:variable name="prev_page"></iaixsl:variable>
        <iaixsl:variable name="next_page">Nächste Seite</iaixsl:variable>

        <iaixsl:if test="count(page/orders/navigation/item) > 1">
            <ul class="pagination mb-2 mb-sm-3">
                
                <iaixsl:if test="page/orders/navigation/prev">
                    <li class="pagination__element --prev">
                        ...
                        <a class="pagination__link">
                            <iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="page/orders/navigation/path/@value"/><iaixsl:value-of select="page/orders/navigation/prev/@counter"/></iaixsl:attribute>
                        </a>
                        <iaixsl:if test="$prev_page">
                ...
                <iaixsl:if test="not(page/orders/navigation/prev)">
                ...
                <iaixsl:for-each select="page/orders/navigation/item">
                    <iaixsl:if test="@gap">
                ...
                <iaixsl:if test="page/orders/navigation/next">
                    <li class="pagination__element --next">
                        ...
                        <a class="pagination__link">
                            <iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="page/orders/navigation/path/@value"/><iaixsl:value-of select="page/orders/navigation/next/@counter"/></iaixsl:attribute>
                        </a>
                        <iaixsl:if test="$next_page">
                ...
                <iaixsl:if test="not(page/orders/navigation/next)">
