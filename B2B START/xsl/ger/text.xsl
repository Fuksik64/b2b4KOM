...
<iaixsl:if test="/shop/page/@cache_basket"/>
        ...
        <!--Pomoc/FAQ/Info (text, 107938.1)-->
            <iaixsl:if test="page/text/@name != ''">
                <h1 class="text_menu_title_header">
                <iaixsl:attribute name="class">text_menu_title_header big_label</iaixsl:attribute>
                    <span class="title_header"><iaixsl:value-of disable-output-escaping="yes" select="page/text/@name"/></span>
                </h1>
            </iaixsl:if>

            <iaixsl:if test="/shop/page/text/@displayindex='true' and /shop/page/cmsindex/documentsgroup[@type = /shop/page/text/@type]/subdocument"> 
                <div class="text_menu">
                        <div class="text_menu_list"><span class="cms_page_list">Inhaltsverzeichnis</span></div>
                    <div class="text_menu_sub">
                        <ul>    
                            <iaixsl:for-each select="/shop/page/cmsindex/documentsgroup[@type = /shop/page/text/@type]/subdocument">
                                <li>
        ...
        <!--Facebook comments CMS (text_facebook_comments, 107940.1)-->
            <iaixsl:if test="page/facebook_comments">
                <div class="cms_fb_comments mt-3">
                    <div class="headline cms_fb_comments_label">
                        <span class="headline__name">Teilen Sie Ihre Kommentare mit anderen</span>
                    </div>
                    <div id="fb-root"/>
                    <script>
                    ...
                    <div class="fb-comments">
                        <iaixsl:attribute name="data-href"><iaixsl:value-of select="/shop/@baseurl"/><iaixsl:value-of select="/shop/page/text/@type"/>.php?page=<iaixsl:value-of select="/shop/page/text/@id"/></iaixsl:attribute>
                        <iaixsl:attribute name="data-num-posts">10</iaixsl:attribute>
                        <iaixsl:attribute name="data-width">750</iaixsl:attribute>
        ...
        <!--Produkty powiązane ze stroną CMS (text_cms_associated, 111453.1)-->
            <iaixsl:if test="/shop/page/cms_products/product or /shop/page/cms_products/opinion">

                <section id="text_cms_associated" class="hotspot mb-5">
                    
                    <iaixsl:variable name="headline_after_text_cms_associated">Alles anzeigen</iaixsl:variable>
                    
                    <h2>
                        <iaixsl:choose>
                            <iaixsl:when test="/shop/page/cms_products/@link">
                                <a class="headline">
                                    <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/cms_products/@link"/></iaixsl:attribute>
                                    <iaixsl:attribute name="title">Klicken Sie hier, um alle Produkte anzuzeigen</iaixsl:attribute>

                                    <span class="headline__name">
                                        <iaixsl:choose>
                                            <iaixsl:when test="/shop/page/cms_products/@name"><iaixsl:value-of select="/shop/page/cms_products/@name"/></iaixsl:when>
                                            <iaixsl:otherwise>Empfohlen</iaixsl:otherwise>
                                        </iaixsl:choose>
                                    </span>
                                    <iaixsl:if test="$headline_after_text_cms_associated">
                                        <span class="headline__after"><iaixsl:value-of select="$headline_after_text_cms_associated"/></span>
                                    </iaixsl:if>
                                </a>
                            </iaixsl:when>
                            <iaixsl:otherwise>
                    ...
                    <div class="products d-flex flex-wrap">
                        <iaixsl:for-each select="/shop/page/cms_products/*">
