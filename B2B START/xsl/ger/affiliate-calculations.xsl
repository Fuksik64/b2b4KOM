...
<iaixsl:if test="page/calculations">
    ...
    <iaixsl:choose>
        <iaixsl:when test="count(page/calculations/payment)">
            
                <div class="affiliate_calculations_desc">
                    Folgende Tabelle enthält die Beträge, die Ihnen im Rahmen unseres Partnerprogramms zustehen. Der aktuelle Stand Ihres Kontos beträgt 
                        <ol>
                        <li>
                        ...
                        <li>  
                            Gesamtsumme der reduzierten Provisionen aufgrund von Warenrückgaben: 
                    ...
                    <iaixsl:if test="page/client/@loyalty_points = 'true'">
                        Die Provision für Bestellungen der gewonnenen Kunden wird in Form von Punkten auf Ihr <a href="/affiliate-main.php"> Saldo im Loyalitätsprogramm ausgezahlt</a> 
                    </iaixsl:if>
                </div>
            <div class="affiliate_calculations">    
                <div class="affiliate_calculations_sub">
                    <table class="affiliate_calculations">
                        <iaixsl:attribute name="class">ui-responsive table-stroke ui-table ui-table-reflow affiliate_calculations</iaixsl:attribute>
                        <thead>
                            <tr>
                                <th id="affiliate_calculations_th0">Datum der Provisionsbewilligung </th>
                                <th id="affiliate_calculations_th1">Gültig ab</th>
                                <th id="affiliate_calculations_th4">Gültig bis</th>
                                <th id="affiliate_calculations_th2">Ihre Vergütung</th>
                                <th id="affiliate_calculations_th3">Beschreibung</th>
                            </tr>
                        </thead>
                        <tbody>
                            <iaixsl:for-each select="page/calculations/payment">
                                <tr>
                                    <iaixsl:choose>
                                        <iaixsl:when test="position() mod 2">
                                            <iaixsl:attribute name="class">affiliate_calculations_row1</iaixsl:attribute>
                                        </iaixsl:when>
                                        <iaixsl:otherwise>
                                            <iaixsl:attribute name="class">affiliate_calculations_row2</iaixsl:attribute>
                                        </iaixsl:otherwise>
                                    </iaixsl:choose>
                                   
                                    <td class="affiliate_calculations_first">
                                        <iaixsl:value-of select="@date"/>
                                    </td>
                                     <td>
                                        <iaixsl:value-of select="@available_from"/>
                                    </td>
                                    <td>
                                        <iaixsl:value-of select="@valid_until"/>
                                    </td>
                                    <td class="affiliate_calculations_secound">
                                        <iaixsl:choose>
                                            <iaixsl:when test="0 > @value">
                                                <span class="r"><iaixsl:value-of select="@value_formatted"/></span>
                                            </iaixsl:when>
                                            <iaixsl:otherwise>
                                                <span class="g">+<iaixsl:value-of select="@value_formatted"/></span>
                                            </iaixsl:otherwise>
                                        </iaixsl:choose>
                                    </td>
                                    <iaixsl:variable name="orderid"><iaixsl:choose><iaixsl:when test="@orderid"><iaixsl:value-of select="@orderid"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="@id"/></iaixsl:otherwise></iaixsl:choose></iaixsl:variable> 
                                    <td class="affiliate_calculations_third">
                                       <iaixsl:choose>
                                        <iaixsl:when test="@type = 'gd'">
                                        <span>Direkte Vergütung für die Bestellung <iaixsl:value-of select="$orderid"/></span>
                                        </iaixsl:when>
                                        
                                        <iaixsl:when test="@type = 'rd'">
                                        <span class="r">Direkte Vergütung für die Bestellung wurde annulliert  <iaixsl:value-of select="$orderid"/></span>
                                        </iaixsl:when>
                                        
                                        <iaixsl:when test="@type = 'gi'">
                                        <span>Indirekte Vergütung für die Bestellung <iaixsl:value-of select="$orderid"/></span>
                                        </iaixsl:when>
                                        
                                        <iaixsl:when test="@type = 'ri'">
                                        <span class="r">Indirekte Vergütung für die Bestellung wurde annulliert <iaixsl:value-of select="$orderid"/></span>
                                        </iaixsl:when>
                                        
                                        <iaixsl:when test="@type = 'gv'">
                                        <span>Ein Gutschein mit der folgenden Nummer wurde erstellt: <iaixsl:value-of select="$orderid"/></span>
                                        </iaixsl:when>
                                        
                                        <iaixsl:when test="@type = 'rv'">
                                        <span class="r">Der Gutschein mit der folgenden Nummer wurde gesperrt: <iaixsl:value-of select="$orderid"/></span>
                                        </iaixsl:when>
                                        
                                        <iaixsl:when test="@type = 'gc'">
                                        <span>Das Bargeld wurde ausgezahlt </span>
                                        </iaixsl:when>
                                        
                                        <iaixsl:when test="@type = 'rc'">
                                        <span class="r">Die Barauszahlung wurde abgelehnt </span>
                                        </iaixsl:when>

                                        <iaixsl:when test="@type = 'rr'">
                                        <span>Warenrückgabe</span>
                                        </iaixsl:when>
                                        </iaixsl:choose>
                                    </td>
                                </tr>
...
<!--Program partnerski - lista rozliczeń stronicowanie (affiliate_calculations_paging, 110543.1)-->
        <iaixsl:variable name="prev_page"></iaixsl:variable>
        <iaixsl:variable name="next_page">Nächste Seite</iaixsl:variable>

        <iaixsl:if test="count(page/calculations/navigation/item) > 1">
            <ul class="pagination mb-2 mb-sm-3">
                
                <iaixsl:if test="page/calculations/navigation/prev">
                    <li class="pagination__element --prev">
                        ...
                        <a class="pagination__link">
                            <iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="page/calculations/navigation/path/@value"/><iaixsl:value-of select="page/calculations/navigation/prev/@counter"/></iaixsl:attribute>
                        </a>
                        <iaixsl:if test="$prev_page">
                ...
                <iaixsl:if test="not(page/calculations/navigation/prev)">
                ...
                <iaixsl:for-each select="page/calculations/navigation/item">
                    <iaixsl:if test="@gap">
                ...
                <iaixsl:if test="page/calculations/navigation/next">
                    <li class="pagination__element --next">
                        ...
                        <a class="pagination__link">
                            <iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="page/calculations/navigation/path/@value"/><iaixsl:value-of select="page/calculations/navigation/next/@counter"/></iaixsl:attribute>
                        </a>
                        <iaixsl:if test="$next_page">
                ...
                <iaixsl:if test="not(page/calculations/navigation/next)">
