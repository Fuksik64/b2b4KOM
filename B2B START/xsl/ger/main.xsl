                                    ...
                                    <li>
                                        <a><iaixsl:choose>
                                            ...
                                            <iaixsl:attribute name="title"><iaixsl:value-of select="text"/></iaixsl:attribute><iaixsl:choose>
                                                <iaixsl:when test="image or image_desktop or image_tablet or image_mobile"><img src="/gfx/ger/loader.gif?r=1600678629">
        ...
        <!--Hotspot na stronie głównej - strefa 1 (main_hotspot_zone1, 111262.1)-->
                ...
                <iaixsl:if test="page/hotspot/products_zone1">
                    <section id="main_hotspot_zone1" class="hotspot mb-5">
                        ...
                        <iaixsl:variable name="headline_after_products_zone1">Alles anzeigen</iaixsl:variable>
                        ...
                        <iaixsl:choose>
                            <iaixsl:when test="count(page/hotspot/products_zone1/product) > 0">
                                ...
                                <iaixsl:variable name="main_hotspot_zone1_b2b_var">Produkt im Einzelverkauf nicht erhältlich. Großhandelspreise nur für registrierte Kunden sichtbar.</iaixsl:variable>
        ...
        <!--Hotspot na stronie głównej - strefa 2 (main_hotspot_zone2, 111122.1)-->
                ...
                <iaixsl:if test="page/hotspot/products_zone2">
                    <section id="main_hotspot_zone2" class="hotspot mb-5">
                        ...
                        <iaixsl:variable name="headline_after_products_zone2">Alles anzeigen</iaixsl:variable>
                                        ...
                                        <a class="headline">
                                            ...
                                            <span class="headline__name">
                                                <iaixsl:choose>
                                                    ...
                                                    <iaixsl:otherwise>Bestseller</iaixsl:otherwise>
                                                </iaixsl:choose>
                                            </span>
        ...
        <!--Hotspot na stronie głównej - strefa 4 (main_hotspot_zone4, 111148.1)-->
                ...
                <iaixsl:if test="page/hotspot/products_zone4">
                    ...
                    <section id="main_hotspot_zone4" class="hotspot mb-5">
                        ...
                        <iaixsl:variable name="headline_after_products_zone4">Alles anzeigen</iaixsl:variable>
                                        ...
                                        <a class="headline">
                                            ...
                                            <span class="headline__name">
                                                <iaixsl:choose>
                                                    ...
                                                    <iaixsl:otherwise>Neuheiten</iaixsl:otherwise>
                                                </iaixsl:choose>
                                            </span>
