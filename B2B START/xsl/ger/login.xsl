...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 107421.1)-->
            ...
            <iaixsl:if test="(action/set_render/item/@name = 'popup') or not(action/set_render/item)">
                ...
                <script src="/gfx/ger/login.js.gzip?r=1600678629"></script></head>
...
<iaixsl:if test="/shop/page/@cache_basket"/>
        ...
        <!--Tekst powitalny (login-welcome, 110573.1)-->
        ...
        <iaixsl:if test="(page/@type = 'login') and (page/login/@type='ok') and not(page/login/response)">
            <div id="login_welcome" class="l_welcome">
                ...
                <a href="/login.php?operation=logout" class="l_welcome__element --logout btn --outline --icon-left icon-power-off">
                    Loggen Sie sich aus
                </a>
            </div>
        </iaixsl:if>
    <!--Strona konta (login, 112106.1)-->
            <script class="ajaxLoad">
                app_shop.vars.clientCartCode = '<iaixsl:value-of select="/shop/basket/@client_id_upc"/>';
            </script>

            <iaixsl:if test="(page/@type = 'login') and (page/login/@type='ok') and not(page/login/response)">
                <iaixsl:variable name="iconsorders">icon-basket</iaixsl:variable>
                <iaixsl:variable name="iconsproducts">icon-box</iaixsl:variable>
                <iaixsl:variable name="iconsprofit">icon-tag</iaixsl:variable>
                <iaixsl:variable name="iconseditdata">icon-user</iaixsl:variable>
                <iaixsl:variable name="iconsreturns">icon-back</iaixsl:variable>
                <iaixsl:variable name="iconsrma">icon-chat</iaixsl:variable>
                <iaixsl:variable name="iconspoints">icon-trophy</iaixsl:variable>
                <iaixsl:variable name="iconsaffiliate">icon-money</iaixsl:variable>
                <div id="login_menu" class="row">
                            ...
                            <iaixsl:if test="(page/login/client_balance/balance/@value > 0) or (page/login/client_balance/limit/@value > 0) or (page/login/client/invoice_data/@account_number)">
                                <div class="login_menu bg_alter clearfix" id="account_login">
                                    <div class="login_menu_sub col-12">
                                        <h3>Bankkonto Information</h3>
                                        <div class="balance_section">
                                            <iaixsl:if test="page/login/client_balance/balance/@value > 0 and page/login/client_balance/limit/@value > 0"><iaixsl:attribute name="class">balance_section twosect</iaixsl:attribute></iaixsl:if>
                                            <iaixsl:if test="page/login/client_balance/balance/@value > 0">
                                                <div class="login_point_count">
                                                <span>Saldo (Überzahlungen auf dem Kundenkonto): </span>
                                                    <strong><iaixsl:value-of select="page/login/client_balance/balance/@value"/><iaixsl:value-of select="$signbetweenpricecurrency"/><iaixsl:value-of select="page/login/client_balance/balance/@currency_sign"/></strong>
                                                </div>
                                            </iaixsl:if>
                                            <iaixsl:if test="page/login/client_balance/limit/@value > 0">
                                                <div class="login_point_count">
                                                <span>Verfügbarer Kreditlimit: </span>
                                            ...
                                            <iaixsl:if test="page/login/client/invoice_data/@account_number">
                                                <div class="login_point_count">
                                                <span>Bankkonto:
                                                    <span class="btn_note"><i class="icon-question"></i></span><div class="tooltipContent">Diese Kontonummer ist deine einzigartige Kontonummer. Dadurch kannst du an diese Nummer Bestellungen bezahlen. Dieses Konto gehör ausschließlich dir</div></span>
                    ...
                    <div class="login_menu_wrapper col-12 row mx-0 flex-wrap align-items-stretch">
                        <iaixsl:if test="(page/login/client_balance/balance/@value > 0) or (page/login/client_balance/limit/@value > 0) or (page/login/client/invoice_data/@account_number)">
                            <iaixsl:attribute name="class">login_menu_wrapper col-md-8 col-12 row mx-0 flex-wrap align-items-stretch</iaixsl:attribute>
                        </iaixsl:if>

                        <iaixsl:if test="/shop/page/actions/products_wishes/@url or /shop/page/actions/products_requests/@url">
                            <div class="login_menu col-md-6 col-12" id="products_login">
                                <div class="login_menu_sub">
                                    <h3>
                                        <iaixsl:choose><iaixsl:when test="$iconsproducts"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsproducts"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="products" src="/gfx/ger/products.png?r=1600678629"/></iaixsl:otherwise></iaixsl:choose>
                                        PRODUKTE
                                    </h3>
                                    <div><span>Durchsehen und Bearbeiten Sie Wunschliste. In dieser Sektion können Sie auch die Liste gesuchter Produkte bearbeiten, die Sie in unserem Shop finden möchten.</span></div>

                                    <a class="btn --outline">
                                        <iaixsl:if test="not(/shop/page/actions/products_wishes/@url)">
                                            <iaixsl:attribute name="data-disabled">true</iaixsl:attribute>
                                            <iaixsl:attribute name="onclick">return false</iaixsl:attribute>
                                        </iaixsl:if>
                                        <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/actions/products_wishes/@url"/></iaixsl:attribute>
                                        Wunschliste
                                    </a>
                                    <a class="btn --outline">
                        ...
                        <iaixsl:if test="/shop/page/actions/orders_opened/@url or /shop/page/actions/orders_closed/@url">
                            <div class="login_menu col-md-6 col-12" id="orders_login">
                                <div class="login_menu_sub">
                                    <h3>
                                        <iaixsl:choose><iaixsl:when test="$iconsorders"><i><iaixsl:attribute name="class"><iaixsl:value-of select="$iconsorders"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="orders" src="/gfx/ger/orders.png?r=1600678629"/></iaixsl:otherwise></iaixsl:choose>
                                        BESTELLUNGEN
                                    </h3>
                                    <div><span>In dieser Sektion können Sie laufend die Realisierung der laufenden Bestellungen überwachen, Zahlungen verwalten und die schon von uns realisierten Aufträge durchsehen.</span></div>
                                        <a class="btn --outline">
                        ...
                        <div class="login_menu col-md-6 col-12" id="client_cards">
                            <div class="login_menu_sub">
                                <h3>
                                    <iaixsl:choose><iaixsl:when test="$iconsprofit"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsprofit"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="profit" src="/gfx/ger/profity.png?r=1600678629"/></iaixsl:otherwise></iaixsl:choose>
                                    VORTEILE FÜR UNSERE TREUEN KUNDEN
                                </h3>
                                <div><span>Prüfen Sie, ob Sie über irgendwelche gültigen Kundenkarten verfügen und was man machen muss, um solche zu erhalten. Prüfen Sie auch bei welchen Warengruppen Sie Rabatt erhalten und wie hoch er sein wird.</span></div>
                        ...
                        <iaixsl:if test="/shop/page/actions/client_edit/@url">
                            <div class="login_menu col-md-6 col-12" id="dane_login">
                                <div class="login_menu_sub">
                                    <h3>
                                        <iaixsl:choose><iaixsl:when test="$iconseditdata"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconseditdata"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="editdata" src="/gfx/ger/editdata.png?r=1600678629"/></iaixsl:otherwise></iaixsl:choose>
                                        <iaixsl:choose><iaixsl:when test="/shop/client_files/@to_download = 'true'">PERSONENBEZOGENE DATEN</iaixsl:when><iaixsl:otherwise>PERSONENBEZOGENE DATEN</iaixsl:otherwise></iaixsl:choose>
                                    </h3>
                                    <div><span>An dieser Stelle kann man seine Personalangaben prüfen und ändern, neue Lieferanschriften hinzufügen, die man bei der Bestellung verwenden kann und die Währung und Sprache des Shops ändern.</span></div>
                        ...
                        <div class="login_menu col-md-6 col-12" id="returns_login">
                            <div class="login_menu_sub">
                                <h3>
                                    <iaixsl:choose><iaixsl:when test="$iconsreturns"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsreturns"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="returns" src="/gfx/ger/returns.png?r=1600678629"/></iaixsl:otherwise></iaixsl:choose>
                                    RETOUREN
                                </h3>
                                <div><span>Verwalten Sie Ihre Warenrückgaben. In dieser Sektion können Sie die bei uns gekaufte Ware zurückgeben und Informationen über die vorher in unserem Shop angemeldeten Rücksendungen einsehen.</span></div>
                                <a class="btn --outline">
                        ...
                        <iaixsl:if test="/shop/rma/@active = 'y' and /shop/rma/@link">
                            <div class="login_menu col-md-6 col-12" id="rma_login">
                                <div class="login_menu_sub">
                                    <h3>
                                    <iaixsl:choose><iaixsl:when test="$iconsrma"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsrma"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="rma" src="/gfx/ger/rma.png?r=1600678629"/></iaixsl:otherwise></iaixsl:choose>

                                        REKLAMATIONSABTEILUNG (RMA)
                                    </h3>
                                    <div><span>Diese Sektion ermöglicht Warenreklamationen bei uns einzulegen. Wenn Sie schon eine Reklamation eingereicht haben, finden Sie hier Details und Informationen über die Realisierung dieser.</span></div>
                                    <a class="btn --outline">
                        ...
                        <iaixsl:if test="(/shop/page/actions/client_rebate_points/@url and not(/shop/page/actions/client_rebate_points/@url='')) or /shop/page/actions/products_points/@available='true' or (/shop/page/actions/points_cms/@url and not(/shop/page/actions/points_cms/@url=''))">
                            <div class="login_menu col-md-6 col-12" id="points_login">
                                <div class="login_menu_sub">
                                    <h3>
                                        <iaixsl:choose><iaixsl:when test="$iconspoints"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconspoints"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="points" src="/gfx/ger/points.png?r=1600678629"/></iaixsl:otherwise></iaixsl:choose>
                                        TREUEPROGRAMM
                                        <iaixsl:if test="/shop/basket/@client_points">
                                            <span>Auf Ihrem Konto haben Sie <strong><iaixsl:value-of select="/shop/basket/@client_points"/> Pkt.</strong></span>
                                        </iaixsl:if>
                                    </h3>
                                    <div><span>An dieser Stelle können Sie sich mit den Nutzungsregeln des Loyalitätsprogramms sowie mit der Verwendung, der von Ihnen gesammelten Punkte bekannt machen.</span></div>
                                    ...
                                    <iaixsl:if test="/shop/page/actions/client_rebate_points and /shop/page/actions/client_rebate_points/@url and not(/shop/page/actions/client_rebate_points/@url='')">
                                        <a class="btn --outline">
                                            ...
                                            Punkte gegen Rabatt tauschen
                                        </a>
                                    </iaixsl:if>
                                    <iaixsl:if test="/shop/page/actions/products_points/@available='true'">
                                        <a class="btn --outline" href="/search.php?forpoints=y">
                                        ...
                                        Gegen Punkte verfügbare Produkte
                                        </a>
                                </iaixsl:if>
                                </div>
                            </div>
                        ...
                        <iaixsl:if test="/shop/page/affiliate and /shop/page/affiliate/@link">
                            <div class="login_menu col-md-6 col-12" id="affiliate_login">
                                <div class="login_menu_sub">
                                    <h3>
                                        <iaixsl:choose><iaixsl:when test="$iconsaffiliate"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsaffiliate"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="affiliate" src="/gfx/ger/affiliate.png?r=1600678629"/></iaixsl:otherwise></iaixsl:choose>
                                        VERDIENEN SIE MIT UNS
                                    </h3>
                                    <div><span>Verdienen Sie mit uns dazu! Nutzten Sie das Partnerprogramm und empfehlen unseren Shop weiter. Dadurch können Sie Werbungen generieren, die Ihrer Webseite ermöglichen Geld zu verdienen oder für die nächsten.</span></div>
                                    <a class="btn --outline">
