                                            ...
                                            <iaixsl:when test="page/projector/product/price/@value = 0">
                                                <strong class="projector_price_value" id="projector_price_value">
                                                    <a href="wholesaler.php" target="_blank">
                                                        <iaixsl:attribute name="title">Klicken, um zum Kontaktformular zu gehen</iaixsl:attribute>
                                                        Preis am Telefon
                                                    </a>
                                                </strong>
                                            </iaixsl:when>
					...
					<iaixsl:if test="not(page/projector/product/@product_type = 'product_service') and (page/projector/product/sizes_version/@stocks_link or page/projector/product/sizes/@stocks_link)">
						...
						<div id="product_stocks" class="product_stocks">
							<div class="product_stocks__product mb-3 mb-sm-5 px-1 px-sm-4">
								<h2 class="px-0 mb-3">Produktverfügbarkeit in unseren Shops</h2>
        ...
        <!--Karta produktu - w zestawiaj taniej (projector_in_bundle, 111660.1)-->
			<iaixsl:if test="page/projector/bundle/product">
				<section id="projector_in_bundle" class="hotspot mb-5 --list col-12">
					<h2>
						<span class="headline"><span class="headline__name">Im Set günstiger!</span></span>
					</h2>
...
<!--Menu powiadomienia (menu_notice, 107640.1)-->
        ...
        <!--Elementy dodawane dynamicznie (menu_dynamically_added_content, 106830.1)-->
            ...
            <script src="/gfx/ger/menu_alert.js.gzip?r=1600678629"></script>
            <script src="/gfx/ger/projector_photos.js.gzip?r=1600678629"></script><script src="/gfx/ger/projector_details.js.gzip?r=1600678629"></script><script src="/gfx/ger/projector_bundle_zone.js.gzip?r=1600678629"></script><script src="/gfx/ger/projector_banner.js.gzip?r=1600678629"></script><script src="/gfx/ger/projector_projector_opinons_form.js.gzip?r=1600678629"></script>
            <script>
                app_shop.runApp();
            </script>
