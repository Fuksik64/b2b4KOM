            ...
            <div class="step4a">
                ...
                <iaixsl:choose>
                    <iaixsl:when test="count(page/pickups/pickup) > 1">
                        <h1 class="big_label return_label">Wählen Sie den gewünschten Standort für die Rückgabe Ihrer Bestellung aus </h1>

                    </iaixsl:when>

                    <iaixsl:otherwise>

                        <h1 class="big_label return_label">Standort für die Rückgabe der Bestellung</h1>
                                ...
                                <div class="pickupl_return">
                                    ...
                                    <div class="pickupl_return_sub">
                                        ...
                                        <div class="pickupl_return_link">
                                            <a target="_blank">
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="link"/></iaixsl:attribute>
                                                <iaixsl:attribute name="title">mehr Informationen zum Standort</iaixsl:attribute>
                                                mehr Informationen
                                            </a>
                                        </div>
                                        <iaixsl:if test="info">
