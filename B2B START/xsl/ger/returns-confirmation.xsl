...
<iaixsl:if test="/shop/page/@cache_basket"/>
    ...
    <!--Zwroty potwierdzenie (returns_confirmation_form, 107767.1)-->



        <iaixsl:if test="page/@type = 'return_products' and page/@display = 'confirmation'">
            <div class="step6">


                <div class="progress_bar_wrapper pb_step6">
                ...
                <div class="n57856_order_overtaker">
                    <form class="returns_form" method="post">
                        <iaixsl:attribute name="action"><iaixsl:value-of select="page/formactionlink/@url"/></iaixsl:attribute>
                        ...
                        <div class="order2_info">
                            <div class="order2_info_sub" id="order2_info_sub1">
                                ...
                                <div class="order2_info1" id="order2_box_1">
                                    <div class="order2_info1_sub">
                                        <iaixsl:if test="page/orderclient/@firm">
                                            <iaixsl:value-of select="page/orderclient/@firm"/><br/>
                                        </iaixsl:if>
                                        <iaixsl:if test="not(page/orderclient/@firm)">
                                            <iaixsl:value-of select="page/orderclient/@firstname"/><iaixsl:text> </iaixsl:text>
                                            <iaixsl:value-of select="page/orderclient/@lastname"/><br/>
                                        </iaixsl:if>
                                        <iaixsl:value-of select="page/orderclient/@street"/><br/>
                                        <iaixsl:value-of select="page/orderclient/@zipcode"/><iaixsl:text> </iaixsl:text><iaixsl:value-of select="page/orderclient/@city"/> (<iaixsl:value-of select="page/orderclient/@country_long"/>)<br/>
                                        <iaixsl:if test="page/orderclient/@nip">
                                            USt-IdNr.<iaixsl:value-of select="page/orderclient/@nip"/><br/>
                                        </iaixsl:if>
                                        E-Mail:
                                        <iaixsl:value-of select="page/orderclient/@email"/><br/>
                                    </div>

                                    <a class="order2_button_change_address btn --solid mt-2 mt-sm-0">
                                        <iaixsl:attribute name="href"><iaixsl:value-of select="page/orderclient/@changelink"/></iaixsl:attribute>
                            ...
                            <div class="order2_info_sub" id="order2_info_sub2">
                                <iaixsl:choose>
                                    <iaixsl:when test="page/pickup">
                                        <h3 class="order2_info1" id="order2_nagl_2a">
                                            Standort für die Rückgabe der Bestellung
                                        </h3>
                                        <div class="order2_info1" id="order2_box_2b">
                                            <div class="order2_info1_sub">
                                                <span class="order2_stock_name"><iaixsl:value-of select="page/pickup/name"/></span>
                                                <iaixsl:value-of select="page/pickup/address"/><br/>
                                                <iaixsl:value-of select="page/pickup/zipcode"/><iaixsl:text> </iaixsl:text>
                                                <iaixsl:value-of select="page/pickup/city"/> (<iaixsl:value-of select="page/pickup/country"/>)<br/>
                                                <div class="order2_moreinfo">
                                                    <a class="order2_button_change_address btn --solid mt-2 mt-sm-0">
                                                        <iaixsl:attribute name="href"><iaixsl:value-of select="page/pickup/link"/></iaixsl:attribute>
                                                        mehr Informationen
                                                    </a>
                                                </div>
                                            </div>

                                            <a class="order2_button_change_address btn --solid mt-2 mt-sm-0" target="_blank">
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="page/pickupchangelink/@url"/></iaixsl:attribute>
                                                Standort für die Rückgabe der Bestellung ändern
                                            </a>
                                    ...
                                    <iaixsl:otherwise>
                                        ...
                                        <div class="order2_info1" id="order2_box_2b">
                                            <div class="order2_info1_sub">
                                                ...
                                                <iaixsl:if test="page/deliveryaddress/@additional">
                                                    <iaixsl:value-of select="page/deliveryaddress/@additional"/><br/>
                                                </iaixsl:if>



                                                <iaixsl:value-of select="page/deliveryaddress/@street"/><br/>
                                                <iaixsl:value-of select="page/deliveryaddress/@zipcode"/><iaixsl:text> </iaixsl:text>
                                                <iaixsl:value-of select="page/deliveryaddress/@city"/> (<iaixsl:value-of select="page/deliveryaddress/@country_long"/>)<br/>



                                            </div>
                                            <a class="order2_button_change_address btn --solid mt-2 mt-sm-0">
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="page/deliveryaddress/@changelink"/></iaixsl:attribute>
                                                Standort für die Rückgabe der Bestellung ändern
                                            </a>
                                        </div>
                                    </iaixsl:otherwise>
                        ...
                        <div id="return_products_list" class="order2_products">


                            <iaixsl:variable name="return_with_special_offer">Sie geben Waren zurück, für die Rabatt gewährt wurde. Der Rückgabewert wird unter Berücksichtigung dieses Rabatts berechnet und entsprechend reduziert, je nach der zurückgegebenen Ware. Bei Problemen kontaktieren Sie bitte das Personal des Geschäfts.  </iaixsl:variable>
                            <iaixsl:variable name="required_from_special_offer"><span>Diese Ware hat durch ihren Preis</span>die Preise anderer Waren im Korb beeinflusst. </iaixsl:variable>


                            <iaixsl:if test="$return_with_special_offer != '' and /shop/page/returnproducts/products/@return_with_special_offer = 'true'">
                                <div class="menu_messages_message"><iaixsl:attribute name="class">menu_messages_message menu_messages_return_with_specia</iaixsl:attribute><div><iaixsl:value-of select="$return_with_special_offer"/></div></div>
                            </iaixsl:if>
                            ...
                            <table class="order2_table">
                                <tr>
                                    <th class="order2_name">
                                        Retournierte Produkte
                                    </th>

                                    <iaixsl:if test="/shop/page/returnproducts/products/product/@required_from_special_offer = 'true' and $required_from_special_offer != ''">
                                        <th class="order2_special_offer">
                                            
                                        </th>
                                    </iaixsl:if>

                                    <th class="order2_price">
                                        Einheitspreis
                                    </th>
                                ...
                                <iaixsl:for-each select="page/returnproducts/products/product">
                                    ...
                                    <tr>
                                        ...
                                        <td class="order2_name">
                                            ...
                                            <iaixsl:if test="@required_from_special_offer = 'true' and $required_from_special_offer != ''">

                                                <iaixsl:if test="@required_from_special_offer = 'true'">
                                                    <div class="productslist_product_special_offer">
                                                        <iaixsl:attribute name="class">productslist_product_info visible-phone</iaixsl:attribute>
                                                        <span>Diese Ware hat durch ihren Preis</span>die Preise anderer Waren im Korb beeinflusst. 
                                                    </div>
                                                </iaixsl:if>
                                            </iaixsl:if>
                                        ...
                                        <iaixsl:if test="@required_from_special_offer = 'true' and $required_from_special_offer != ''">
                                            <td class="productslist_product_special_offer">
                                                <iaixsl:attribute name="class">productslist_product_special_offer hidden-phone</iaixsl:attribute>
                                                <iaixsl:if test="@required_from_special_offer = 'true'">
                                                    <div class="productslist_product_special_offer">
                                                        <span>Diese Ware hat durch ihren Preis</span>die Preise anderer Waren im Korb beeinflusst. 
                                                    </div>
                                        ...
                                        <td class="order2_quantity">
                                            <iaixsl:value-of select="@quantity"/><iaixsl:text> </iaixsl:text><iaixsl:value-of select="@worth_unit"/>
                                        </td>
                        ...
                        <div id="return_products_delivery" class="order2_products">
                            ...
                            <table class="order2_table">
                                <tr>
                                    <th class="order2_name">
                                        ...
                                        Rückerstattungs- und Versandart
                                ...
                                <iaixsl:if test="/shop/page/return_method">
                                    <tr>
                                        <td class="order2_name">
                                            ...
                                            <iaixsl:choose>
                                                <iaixsl:when test="/shop/page/return_method/@description">
                                                    <span class="order2_name">Versandart:
                                                ...
                                                <iaixsl:when test="/shop/page/return_method/@id = 1">
                                                    ...
                                                    <div class="return_description">
                                                        Sie geben Waren zurück, für die Rabatt gewährt wurde. Der Rückgabewert wird unter Berücksichtigung dieses Rabatts berechnet und entsprechend reduziert, je nach der zurückgegebenen Ware. Bei Problemen kontaktieren Sie bitte das Personal des Geschäfts.  
                                                    </div>
                                                </iaixsl:when>
                                                <iaixsl:when test="/shop/page/return_method/@id = 2 and /shop/page/return_method/@shipping_cost = 'client' and not(/shop/page/repayment_method/@id = 't')">
                                                    <span class="order2_name">
                                                        Versandart:
                                                ...
                                                <iaixsl:when test="/shop/page/return_method/@id = 2 and /shop/page/return_method/@shipping_cost = 'shop'">
                                                    <span class="order2_name">
                                                        Versandart:
                                                        Ich möchte eine der im Shop verfügbaren Lieferarten auswählen
                                                    </span>
                                                    <div class="return_description">
                                                         Versandkosten sind Shop
                                                    </div>
                                                </iaixsl:when>
                                        ...
                                        <td class="order2_bruttoworth">
                                            <div class="worth_box">
                                                <iaixsl:if test="/shop/page/costs/cost[@type='shop_shipping']">
                                                    <iaixsl:value-of select="/shop/page/costs/cost[@type='shop_shipping']/@value_formatted"/>
                                                </iaixsl:if>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <td class="order2_name">
                                        ...
                                        <iaixsl:choose>
                                            <iaixsl:when test="/shop/page/repayment_method/@id = 't'">
                                                <span class="order2_name">Rückerstattungsart: Kundensaldo</span>
                                            ...
                                            <iaixsl:when test="/shop/page/repayment_method/@id = 'b'">
                                                <span class="order2_name">Rückerstattungsart: Überweisung</span>
                                                <div class="return_description">
                                                    Der Gegenwert Ihrer Bestellung wird Ihnen per Banküberweisung an die folgende Bankverbindung zurückerstattet.
                                                </div>
                                            </iaixsl:when>
                                            <iaixsl:when test="/shop/page/repayment_method/@id = 'tc'">
                                                <span class="order2_name">Rückerstattungsart: Handelskredit wiederherstellen</span>
                                                <div class="return_description">
                            ...
                            <div class="basketedit_summary_sub">
                                ...
                                <div class="basketedit_summary_right">
                                    ...
                                    <div class="basketedit_calculations">
                                        <iaixsl:if test="/shop/page/costs/cost[@type='products']/@value_formatted">
                                            <div class="basketedit_product_summary">
                                                <label>
                                                    Wert der zurückgegebenen Ware:
                                                    
                                                </label>
                                                <strong>
                                                    <iaixsl:value-of select="/shop/page/costs/cost[@type='products']/@value_formatted"/>
                                                </strong>
                                            </div>
                                        </iaixsl:if>
                                        ...
                                        <iaixsl:if test="/shop/page/costs/cost[@type='shipping']/@value_formatted">
                                            <div class="basketedit_product_summary">
                                                <label>
                                                    Rückerstattung der Versandkosten an den Kunden:
                                                    

                                                </label>
                                                <strong>
                                                    <iaixsl:value-of select="/shop/page/costs/cost[@type='shipping']/@value_formatted"/>
                                                </strong>
                                            </div>
                                        </iaixsl:if>
                                    ...
                                    <iaixsl:if test="/shop/page/costs/@value_formatted">
                                        <div class="basketedit_total_summary">
                                            ...
                                            <strong>
                                                <iaixsl:value-of select="/shop/page/costs/@value_formatted"/>
                                            </strong>
                                        </div>
                                    </iaixsl:if>
                                ...
                                <div class="basketedit_summary_buttons table_display">
                                    ...
                                    <div class="btn_wrapper">
                                        ...
                                        <input class="btn --solid --large" type="submit">


                                            <iaixsl:attribute name="value">Retourenantrag hinzufügen</iaixsl:attribute>

                                            <iaixsl:if test="/shop/return_edit/@return_id">
                                                <iaixsl:attribute name="value">Änderungen speichern</iaixsl:attribute>
                                            </iaixsl:if>
