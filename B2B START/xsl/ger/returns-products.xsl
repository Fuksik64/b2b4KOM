...
<iaixsl:if test="page/@type = 'return_products' and page/@display = 'add'">
<div class="step2">
        ...
        <h1 class="big_label return_label">Wählen Sie Produkte aus, die Sie zurückgeben möchten</h1>
        ...
        <iaixsl:if test="$return_with_special_offer != '' and /shop/page/products/@return_with_special_offer = 'true'">
        ...
        <iaixsl:if test="page/products">

           
            <iaixsl:variable name="setIconLarge"></iaixsl:variable>
            <iaixsl:variable name="wholesalerPrice"></iaixsl:variable>
            <iaixsl:variable name="hideLimit">2</iaixsl:variable>
            <iaixsl:variable name="allowReturnInfo">Dieses Produkt wird nicht zurückerstattet.</iaixsl:variable>
            <iaixsl:variable name="allowReturnInfoPoint">Dieses Produkt haben Sie für Punkte gekauft, deswegen können Sie es nicht zurückgeben. </iaixsl:variable>
            <iaixsl:variable name="allowReturnInfoGratis">Dieses Produkt haben Sie gratis erhalten, deswegen können Sie es nicht zurückgeben. </iaixsl:variable>




            <form class="returns_productslist" action="/returns-method.php?type=multiproduct" method="post">
                ...
                <div id="basketedit_productslist" class="basketedit_productslist return_productslist">
                    ...
                    <table>
                        ...
                        <tr class="basketedit_productslist_label">
                            ...
                            <iaixsl:if test="/shop/page/products/product/@required_from_special_offer = 'true' and $required_from_special_offer != ''">
                              <th>
                        ...
                        <iaixsl:for-each select="page/products/product">
                            <tr class="productslist_item">
                                ...
                                <iaixsl:choose>
                                    <iaixsl:when test="$allowReturnInfoPoint and @allowReturn='0' and @for_points='true'">
                                        <iaixsl:attribute name="colspan">2</iaixsl:attribute>
                                        <div class="productslist_product_info">
                                            <iaixsl:value-of select="$allowReturnInfoPoint"/>
                                        </div>
                                    </iaixsl:when>
                                    <iaixsl:when test="$allowReturnInfoGratis and @allowReturn='0' and @gratis='t'">
                                        <iaixsl:attribute name="colspan">2</iaixsl:attribute>
                                        <div class="productslist_product_info">
                                            <iaixsl:value-of select="$allowReturnInfoGratis"/>
                                        </div>
                                    </iaixsl:when>
                                    <iaixsl:when test="$allowReturnInfo and @allowReturn='0'">
                                        <iaixsl:attribute name="colspan">2</iaixsl:attribute>
                                        <div class="productslist_product_info">
                                            <iaixsl:value-of select="$allowReturnInfo"/>
                                        </div>
                                    ...
                                    <div>
                                        <iaixsl:choose>
                                         ...
                                         <iaixsl:if test="change_group/@changelink">
                                                ...
                                                <a>
                                                   <iaixsl:attribute name="class">productslist_change_product</iaixsl:attribute>
                                        ...
                                        <span class="productslist_quantity">
                                            ...
                                            <input type="text">
                                                <iaixsl:attribute name="name">set_quantity[<iaixsl:value-of select="position()"/>]</iaixsl:attribute>
                                                <iaixsl:attribute name="value"><iaixsl:value-of select="@selected_quantity"/></iaixsl:attribute>
                                            </input>
                                            <input type="hidden" name="data_amount">
                                            <iaixsl:attribute name="value"><iaixsl:value-of select="@quantity"/></iaixsl:attribute>
                                            </input>
                                            <input type="hidden" name="data_unit_sellby">
                                                <iaixsl:attribute name="value"><iaixsl:value-of select="size/@unit_sellby"/></iaixsl:attribute>
                                            </input>
                                            <input type="hidden" name="data_unit">
                                                <iaixsl:attribute name="value"><iaixsl:value-of select="size/@unit"/></iaixsl:attribute>
                                            </input>
                                            <input type="hidden" name="data_unit_precision">
                                                <iaixsl:attribute name="value"><iaixsl:value-of select="size/@unit_precision"/></iaixsl:attribute>
                                            </input>
                                    ...
                                    <iaixsl:if test="$allowReturnInfo and @allowReturn='0'">
                                        <iaixsl:attribute name="style">display:none;</iaixsl:attribute>
                                         ...
                                         <input type="checkbox">
                                            <iaixsl:attribute name="name">product[<iaixsl:value-of select="position()"/>]</iaixsl:attribute>
                                            <iaixsl:attribute name="value"><iaixsl:value-of select="@id"/></iaixsl:attribute>
                                            <iaixsl:if test="@checked = 'true' or @selected_quantity > 0"><iaixsl:attribute name="checked">checked</iaixsl:attribute></iaixsl:if>
                                        </input>
                        ...
                        <iaixsl:if test="not($allowReturnInfo) or ($allowReturnInfo and (count(/shop/page/products/product) - count(/shop/page/products/product[@allowReturn='0'])) > 0)">
                            <tr class="productslist_tools_bottom">
                                ...
                                <td colspan="5">
                                <iaixsl:if test="/shop/page/products/product/@required_from_special_offer = 'true' and $required_from_special_offer != ''">
                                        <iaixsl:attribute name="colspan">6</iaixsl:attribute>
                                </iaixsl:if>
                                    <iaixsl:if test="not($allowReturnInfo) or ($allowReturnInfo and (count(/shop/page/products/product) - count(/shop/page/products/product[@allowReturn='0'])) > 1)">
                                        <a href="#selectall" class="btn --solid --icon-left icon-plus select_all">Alle Produkte auswählen</a>
                                    </iaixsl:if>

                                    <label class="return_product">
                                        <input type="checkbox" class="return_product">
                                            <iaixsl:if test="/shop/page/remarks"><iaixsl:attribute name="checked">checked</iaixsl:attribute></iaixsl:if>
                                        </input>
                                        Bemerkungen zur Retoure hinzufügen
                                    </label>
                                </td>
                            </tr>
                        </iaixsl:if>
                   ...
                   <textarea name="return_comment" class="return_comment"><iaixsl:choose><iaixsl:when test="/shop/page/remarks"><iaixsl:value-of disable-output-escaping="yes" select="/shop/page/remarks"/></iaixsl:when><iaixsl:otherwise><iaixsl:attribute name="style">display:none</iaixsl:attribute></iaixsl:otherwise></iaixsl:choose></textarea>
                </div>
                        ...
                        <iaixsl:if test="not($allowReturnInfo) or ($allowReturnInfo and (count(/shop/page/products/product) - count(/shop/page/products/product[@allowReturn='0'])) > 0)">
                            <div class="btn_wrapper">
                                <button id="return_go_next" type="submit" class="btn --solid --large --icon-right icon-angle-right">
                                    Weiter
                                </button>
                            </div>
                        </iaixsl:if>
