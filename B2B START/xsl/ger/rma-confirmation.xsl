                ...
                <div class="n57856_order_overtaker">
                    <form class="returns_form" method="post">
                        ...
                        <div class="order2_products">
                            ...
                            <iaixsl:variable name="return_with_special_offer">Sie geben eine Bestellung zurück, für die Rabatt gewährt wurde. Der Rückgabewert wird unter Berücksichtigung dieses Rabatts berechnet und entsprechend reduziert, je nach der zurückgegebenen Ware. Bei Problemen kontaktieren Sie bitte das Personal des Geschäfts.</iaixsl:variable>
                            <iaixsl:variable name="required_from_special_offer"><span>Diese Ware hat durch seinen Preis</span>die Preise anderer Waren im Korb beeinflusst. </iaixsl:variable>
                                            ...
                                            <iaixsl:if test="@required_from_special_offer = 'true' and $required_from_special_offer != ''">
                                                ...
                                                <iaixsl:if test="@required_from_special_offer = 'true'">
                                                    <div class="productslist_product_special_offer">
                                                        ...
                                                        <span>Diese Ware hat durch seinen Preis</span>die Preise anderer Waren im Korb beeinflusst. 
                                                    </div>
                                                </iaixsl:if>
                                            </iaixsl:if>
