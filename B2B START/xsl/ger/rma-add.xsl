                                                ...
                                                <iaixsl:choose>
                                                    <iaixsl:when test="@type = 'p'">
                                                        ...
                                                        <span class="rma_add_form_infotitle2">
                                                            ...
                                                            <iaixsl:if test="/shop/page/rma/payments/@active = '1'">
                                                                <img class="rma_need" src="/gfx/ger/need.gif?r=1600678629"><iaixsl:attribute name="alt">Dieses Feld muss ausgefüllt werden, um die Bestellung aufzugeben</iaixsl:attribute></img>
                                                                <img src="/gfx/ger/correct.png?r=1600678629" class="rma_correct_img" id="rma_add_przekaz_on" style="display:none;"/>
                                                                <img src="/gfx/ger/incorrect.png?r=1600678629" class="rma_correct_img" id="rma_add_przekaz_off" style="display:none;"/>
                                                            </iaixsl:if>
                                                        </span>
                                                    ...
                                                    <iaixsl:when test="@type = 'b'">
                                                        ...
                                                        <span class="rma_add_form_infotitle2">
                                                            ...
                                                            <iaixsl:if test="/shop/page/rma/payments/@active = '1'">
                                                                <img class="rma_need" src="/gfx/ger/need.gif?r=1600678629"><iaixsl:attribute name="alt">Dieses Feld muss ausgefüllt werden, um die Bestellung aufzugeben</iaixsl:attribute></img>
                                                                <img src="/gfx/ger/correct.png?r=1600678629" class="rma_correct_img" id="rma_add_bankaccount_on" style="display:none;"/>
                                                                <img src="/gfx/ger/incorrect.png?r=1600678629" class="rma_correct_img" id="rma_add_bankaccount_off" style="display:none;"/>
                                                            </iaixsl:if>
                                                        </span>
                                                    ...
                                                    <iaixsl:when test="@type = 'c'">
                                                        ...
                                                        <span class="rma_add_form_infotitle2">
                                                            ...
                                                            <iaixsl:if test="/shop/page/rma/payments/@active = '1'">
                                                                <img class="rma_need" src="/gfx/ger/need.gif?r=1600678629"><iaixsl:attribute name="alt">Dieses Feld muss ausgefüllt werden, um die Bestellung aufzugeben</iaixsl:attribute></img>
                                                                <img src="/gfx/ger/correct.png?r=1600678629" class="rma_correct_img" id="rma_add_czek_on" style="display:none;"/>
                                                                <img src="/gfx/ger/incorrect.png?r=1600678629" class="rma_correct_img" id="rma_add_czek_off" style="display:none;"/>
                                                            </iaixsl:if>
                                                        </span>
