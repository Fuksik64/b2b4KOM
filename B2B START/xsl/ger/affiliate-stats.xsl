...
<iaixsl:if test="/shop/page/@cache_basket"/>
        ...
        <!--Przekierowania - lista (affiliate_stats_list, 107764.1)-->

<iaixsl:if test="page/affiliate_statistics">
<div class="affiliate_stats_label">
    <iaixsl:attribute name="class">big_label affiliate_stats_label</iaixsl:attribute>
    <span class="affiliate_stats_label">
        Ihre Weiterleitungen
    </span>
</div>
<div class="affiliate_stats_desc">
    <p class="affiliate_stats_desc">Unten befindet sich die Zusammenstellung aller Weiterleitugen zum Shop aufgrund Ihrer Empfehlung.</p>
</div>
<div class="affiliate_stats">
    <div class="affiliate_stats_sub">
        <table class="affiliate_stats">
                <tr class="col-9">
                    <th>Einfache Links</th>
                    <th>Banner</th>
                    <th>Promotion-Codes</th>
                    <th>Flash-Werbungen</th>
                    <th>PHP-Werbungen</th>
                    <th>JavaScript-Werbungen</th>
                </tr>
                <iaixsl:for-each select="page/affiliate_statistics">
                    <tr class="col-3">
                        <iaixsl:for-each select="item">
                            <td>
