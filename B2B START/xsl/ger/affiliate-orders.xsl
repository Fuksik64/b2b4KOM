...
<div class="affiliate_orders_label">
   <iaixsl:attribute name="class">big_label affiliate_orders_label</iaixsl:attribute>

    <span class="affiliate_orders_label">
        Bestellungen Ihrer Kunden
    </span>
</div>
<iaixsl:choose>
    <iaixsl:when test="count(page/orders/client)">
        <div class="affiliate_orders_desc">
            <p class="affiliate_orders_desc">In der folgenden Tabelle sind die Personen aufgelistet, die aufgrund Ihrer Empfehlung bei uns eingekauft oder ein Konto erstellt haben. Die angegebenen Beträge ergeben sich aus den Bestellungen, die mit Ihrer Partnerschaft abgewickelt wurden. Um detaillierte Informationen zu einer bestimmten Person anzuzeigen, klicken Sie auf den entsprechenden Benutzernamen.</p>
        </div>
        <div class="affiliate_orders">
            <div class="affiliate_orders_sub">
                <table class="affiliate_orders">
   <iaixsl:attribute name="class">ui-responsive table-stroke ui-table ui-table-reflow affiliate_orders</iaixsl:attribute>



                    <thead>
                        <tr>
                            <th id="affiliate_orders_th1">Kunden-ID</th>
                            <th id="affiliate_orders_th3">Datum der Kontoerstellung</th>
                            <th id="affiliate_orders_th4">Anzahl der aufgegebenen Bestellungen</th>
                            <th id="affiliate_orders_th5">Wert der aufgegebenen Bestellungen<span><br/><small>(ohne Versandkosten)</small></span></th>
                            <th id="affiliate_orders_th6">Anzahl der abgeschlossenen Bestellungen</th>
                            <th id="affiliate_orders_th7">Wert der abgeschlossenen Bestellungen<span><br/><small>(ohne Versandkosten)</small></span></th>
                        </tr>
                    </thead>
                    <tbody>
                        <iaixsl:for-each select="page/orders/client">
                            <tr>
                                <iaixsl:choose>
                                    <iaixsl:when test="position() mod 2">
                                        <iaixsl:attribute name="class">affiliate_orders_row1</iaixsl:attribute>
                                    </iaixsl:when>
                                    <iaixsl:otherwise>
                                        <iaixsl:attribute name="class">affiliate_orders_row2</iaixsl:attribute>
                                    </iaixsl:otherwise>
                                </iaixsl:choose>
                                <td class="affiliate_orders_first">
                                    <span class="affiliate_orders_name"><a><iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute><iaixsl:value-of select="@nr"/></a></span>
                                </td>
                                <td>
                                    <iaixsl:value-of select="@setDate"/>
                                </td>
                                <td>
                                    <iaixsl:value-of select="@totalCount"/>
                                </td>
                                <td>
                                    <span class="affiliate_orders_price"><iaixsl:value-of select="@totalSum_formatted"/></span>
                                </td>
                                <td>
                                    <iaixsl:value-of select="@sentCount"/>
                                </td>
                                <td>
                                    <span class="affiliate_orders_price"><iaixsl:value-of select="@sentSum_formatted"/></span>
                                </td>
                            </tr>
                        </iaixsl:for-each>
                        <iaixsl:if test="page/orders/client_sum">
                            <tr data-mobile-class="hide" class="table-stroke-row-sum">
                                <td class="affiliate_orders_sum"><span>Summe</span></td>
                                <td class="affiliate_orders_sum"/>
                                <td class="affiliate_orders_sum"/>
                                <td class="affiliate_orders_sum"><iaixsl:value-of select="page/orders/client_sum/@totalSum_formatted"/></td>
                                <td class="affiliate_orders_sum"/>
                                <td class="affiliate_orders_sum"><iaixsl:value-of select="page/orders/client_sum/@sentSum_formatted"/></td>
                            </tr>
                        </iaixsl:if>
                    </tbody>
                </table>
    ...
    <iaixsl:otherwise>
        <div class="affiliate_orders_null">
            Keine Bestellungen von Ihren Kunden.
        </div>
    </iaixsl:otherwise>
</iaixsl:choose>
</iaixsl:if>
<!--Zamówienia klientów - stronicowanie (affiliate_orders_paging, 110552.1)-->
