        ...
        <!--Returns Open Form (returns_open_form, 112619.1)-->
			<section class="returns_open mb-4">
				...
				<h1 class="returns_open__label headline">
					<span class="returns_open__label_txt headline__name">Wählen Sie die Bestellung aus, aus der Sie die Ware zurücksenden möchten.</span>
				</h1>
				...
				<div class="returns_open__description menu_messages_message mb-4">
                    <iaixsl:choose>
                        <iaixsl:when test="/shop/page/returns-open/@returns_exist_link and not(/shop/page/returns-open/@returns_exist_link = '')">
                            Für diese Bestellung wurde bereits eine Rücksendung generiert. Bitte überprüfen Sie den Status Ihrer aktuellen Anmeldungen oder fügen Sie eine weitere Anmeldung über die Registerkarte Rücksendungen hinzu
                        </iaixsl:when>
                        ...
                        <iaixsl:otherwise>
                            Für dieses Konto wurde keine Bestellung aufgegeben. Sie können daher keine Reklamation generieren. Wenn Sie eine Bestellung von einem anderen Konto oder ohne Anmeldung reklamieren möchten, füllen Sie bitte das folgende Formular aus.
                        </iaixsl:otherwise>
                    </iaixsl:choose>
				</div>
