...
<iaixsl:attribute name="class">big_label affiliate_client_label</iaixsl:attribute>
    <span class="affiliate_client_label">
        Bestellungen des Kunden <iaixsl:value-of select="page/client/@id"/>
    </span>
</div>
<div class="affiliate_client">
   ...
   <iaixsl:attribute name="class">ui-responsive table-stroke ui-table ui-table-reflow affiliate_client</iaixsl:attribute>
            <thead>
                <tr>
                    <th id="affiliate_client_th1">Bestellungs-ID</th>
                    <th id="affiliate_client_th2">Bestelldatum</th>
                    <th id="affiliate_client_th3">Versanddatum</th>
                    <th id="affiliate_client_th4">Bestellwert</th>
                    <th id="affiliate_client_th5">Anzahl der Produkte</th>
                    <th id="affiliate_client_th6">Zahlung</th>
                    <th id="affiliate_client_th7">Status</th>
                    <th id="affiliate_client_th8">Partner</th>
                    <th id="affiliate_client_th9">Kommission</th>
                </tr>
            </thead>
            <tbody>
