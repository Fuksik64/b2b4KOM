        ...
        <!--Blog - Produkty powiązane (blog_item_associated, 111448.1)-->
            <iaixsl:if test="page/cms_products/product or page/cms_products/opinion">
                ...
                <section id="blog_item_associated" class="hotspot mb-5">
                    ...
                    <iaixsl:variable name="headline_after_blog_item_associated">Alles anzeigen</iaixsl:variable>
                                ...
                                <a class="headline">
                                    ...
                                    <span class="headline__name">
                                        <iaixsl:choose>
                                            ...
                                            <iaixsl:otherwise>Empfohlen</iaixsl:otherwise>
                                        </iaixsl:choose>
                                    </span>
                        ...
                        <iaixsl:for-each select="page/cms_products/*">
                            ...
                            <div class="product col-6 col-sm-4 py-3">
                                ...
                                <a class="product__icon d-flex justify-content-center align-items-center">
                                    ...
                                    <img src="/gfx/ger/loader.gif?r=1600678629" class="b-lazy">
