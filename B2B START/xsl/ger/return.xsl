...
<iaixsl:if test="/shop/page/@cache_basket"/>
        ...
        <iaixsl:variable name="error_undefined_ret">Ein unbekannter Fehler ist aufgetreten.</iaixsl:variable>

        <iaixsl:variable name="file_upload_invalid_type">Die Datei </iaixsl:variable>

        <iaixsl:variable name="file_upload_invalid_extension">Die Datei </iaixsl:variable>

        <iaixsl:variable name="file_upload_size_exceeded">Die Datei </iaixsl:variable>

        <iaixsl:variable name="file_uploaded_remove_fail">Beim Hochladen der folgenden Datei ist ein Fehler aufgetreten: </iaixsl:variable>

        <iaixsl:variable name="auction_shop_bundle_not_exist">Der Satz mit der ausgewählten Warenkombination befindet sich nicht in den laufenden Auktionen. Wenn möglich, wählen Sie eine andere Warenkombination, oder setzen Sie sich bitte mit uns in Verbindung.</iaixsl:variable>

        <iaixsl:variable name="token_expired">Der Zugangslink zu Ihren Daten hat seine Gültigkeit bereits verloren. Um die Daten in Ihr Konto zuzugreifen, verwenden Sie die <a title="Anmeldenseite" href="/signin.php">Anmeldenseite</a>.</iaixsl:variable>

        <iaixsl:variable name="too_much_product">Maximal können </iaixsl:variable>

        <iaixsl:variable name="not_enough_product">Minimal müssen Sie </iaixsl:variable>

        <iaixsl:variable name="too_much_product_size">Maximal können </iaixsl:variable>

        <iaixsl:variable name="not_enough_product_size">Minimal müssen Sie </iaixsl:variable>

        <iaixsl:variable name="return_rebates_code_used">Dieser Rabatt Code bereits verwendet wurde.</iaixsl:variable>

        <iaixsl:variable name="rebates_code_notbegun">Der eingegebene Rabattcode ist noch nicht aktiv. Dieses Sonderangebot wurde noch nicht gestartet.</iaixsl:variable>

        <iaixsl:variable name="rebates_code_expired"></iaixsl:variable>
                ...
                <iaixsl:choose>
                    ...
                    <iaixsl:when test="page/return/@type='file_upload_invalid_type' and $file_upload_invalid_type">
                        <h3 class="return_label"><iaixsl:value-of select="$file_upload_invalid_type"/>
                            <span class="invalidFileName"><iaixsl:value-of select="@value"/></span> kann nicht hochgeladen werden, weil dieser Dateityp nicht unterstützt wird.</h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type='file_upload_size_exceeded' and $file_upload_size_exceeded">
                        <h3 class="return_label"><iaixsl:value-of select="$file_upload_size_exceeded"/>
                            <span class="invalidFileName"><iaixsl:value-of select="@value"/></span> kann nicht hochgeladen werden, weil sie die maximale Größenbeschränkung von 10 MB überschreitet.</h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type = 'opinion_addphotoerror'">
                        <h3 class="return_label">Das von Ihnen hinzugefügte Foto ist nicht korrekt. 
                            <iaixsl:if test="page/return/param[@name = 'max_height'] and page/return/param[@name = 'max_width']">
                                <br/>Maximale Größe des Fotos: 
                    ...
                    <iaixsl:when test="page/return/@type='token_expired' and $token_expired">
                        <h3 class="return_label">Der Zugangslink zu Ihren Daten hat seine Gültigkeit bereits verloren. Um die Daten in Ihr Konto zuzugreifen, verwenden Sie die <a title="Anmeldenseite" href="/signin.php">Anmeldenseite</a>.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='too_much_product' and $too_much_product">
                        <h3 class="return_label"><iaixsl:value-of select="$too_much_product"/><iaixsl:value-of select="/shop/page/return/param/@value"/> St. bestellen.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='not_enough_product' and $not_enough_product">
                        <h3 class="return_label"><iaixsl:value-of select="$not_enough_product"/><iaixsl:value-of select="/shop/page/return/param/@value"/> St. bestellen.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='too_much_product_size' and $too_much_product_size">
                        <h3 class="return_label"><iaixsl:value-of select="$too_much_product_size"/><iaixsl:value-of select="/shop/page/return/param/@value"/> St. in der gewählten Größe bestellen.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='not_enough_product_size' and $not_enough_product_size">
                        <h3 class="return_label"><iaixsl:value-of select="$not_enough_product_size"/><iaixsl:value-of select="/shop/page/return/param/@value"/> St. in der gewählten Größe bestellen.</h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type = 'rma_require_one_order'">
                        <h3 class="return_label">Um eine Beschwerde einreichen zu können, müssen Sie vorher eine Bestellung aufgeben haben. Es sind keine Bestellungen auf Ihren Konto verbucht.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'orderedit_dataerror'">
                        <h3 class="return_label">Beim Bearbeiten der Bestellung ist ein Datenfehler aufgetreten.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'order_product_worth'">
                        <h3 class="return_label">Sie können Ihre Bestellung nicht aufgeben. Im Warenkorb befinden sich Produkte im Wert von 0 <iaixsl:value-of select="currency/@name"/>. Bitte überprüfen Sie den Warenkorbinhalt.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='order_invalidpoints'">
                        <h3 class="return_label">Es ist ein Fehler mit dem Produkt aufgetreten, das Sie gegen Punkte erwerben wollten. <a href="/contact.php">Bitte kontaktieren Sie unseren Kundenservice</a>.</h3>
                    </iaixsl:when>

                    
                    <iaixsl:when test="page/return/@type='openid_login_canceled'">
                        <h3 class="return_label">Login abgebrochen.</h3>
                    </iaixsl:when>
                    <iaixsl:when test="page/return/@type='openid_invalid_authorization'">
                        <h3 class="return_label">Berechtigungsfehler.</h3>
                    </iaixsl:when>
                    

                    <iaixsl:when test="page/return/@type = 'suggestbody_illegal_urls'">
                        <h3 class="return_label">Wir haben Ihre E-Mail nicht gesendet, da sie Adressen anderer Seiten enthält. Bitte verwenden Sie keine Adressen bzw. lassen Sie die Standardvorlage unverändert. </h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'account_login_disabled'">
                        <h3 class="return_label">Dieses Konto erlaubt es Ihnen nicht, sich auf dieser Seite einzuloggen. Bitte verwenden Sie ein anderes Konto oder <a href="/client-new.php?register">erstellen Sie ein neues</a>.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'order_notenoughpoints'">
                        <h3 class="return_label">Sie haben nicht genug Treuepunkte auf Ihrem Konto.</h3>
                    </iaixsl:when>


                    <iaixsl:when test="page/return/@type = 'compare_error_minimum'">
                        <h3 class="return_label">Sie müssen mindestens zwei Produkte für den Vergleich auswählen</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'questionnaire_error'">
                        <h3 class="return_label">Ein Fehler ist aufgetreten. Der Fragebogen wurde nicht abgeschickt.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'questionnaire_sent'">
                        <h3 class="return_label">Vielen Dank! Ihr Fragebogen wurde abgeschickt.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'polcard_authorized'">
                        <h3 class="return_label">Die Berechtigungsprüfung wurde erfolgreich abgeschlossen.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'polcard_unauthorized'">
                        <h3 class="return_label">Die Berechtigungsprüfung ist fehlgeschlagen.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'payment_credit_zagiel_error'">
                        <h3 class="return_label">Sie haben auf den Ratenkredit verzichtet. Bitte gehen Sie zu den Bestelldetails und versuchen Sie erneut, die Ratenzahlung zu tätigen oder wählen Sie eine andere Zahlungsart aus.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'payment_credit_zagiel_success'">
                        <h3 class="return_label">Bitte warten Sie auf einen Anruf eines Bank Beraters. Im Telefongespräch wird er mit Ihnen zusammen einen Finanzierungsvertrag aufsetzen. Bitte halten Sie Ihren Personalausweis sowie einen zweiten Identitätsnachweis bereit. </h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'polcard_error'">
                        <h3 class="return_label">Ein Berechtigungsfehler (PolCard) ist aufgetreten.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'contactus_sent'">
                        <h3 class="return_label">Die Nachricht wurde erfolgreich gesendet.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'contactus_error'">
                        <h3 class="return_label">Ein Fehler ist aufgetreten. Die Nachricht wurde nicht gesendet.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'ordercancel_ok'">
                        <h3 class="return_label">Die Bestellung <iaixsl:if test="page/return/@extra"><iaixsl:value-of select="page/return/@extra"/></iaixsl:if> wurde storniert.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'returncancel_ok'">
                        <h3 class="return_label">Erstattung wurde storniert.</h3>
                    </iaixsl:when>
                    <iaixsl:when test="page/return/@type = 'returncancel_error'">
                        <h3 class="return_label">"Erstattung kann nicht rückgängig gemacht werden. Weitere Informationen erfahren Sie von unserem <a href="/contact.php">Kundenservice</a>.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'ordercancel_dberror'">
                        <h3 class="return_label">Datenbankfehler.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'ordercancel_dataerror'">
                        <h3 class="return_label">Diese Bestellung kann nicht storniert werden.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'orderconfirm_ok'">
                        <h3 class="return_label">Viele Dank! Ihre Bestellung <iaixsl:if test="page/return/@extra"><iaixsl:value-of select="page/return/@extra"/></iaixsl:if> wurde als bestätigt markiert.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'orderconfirm_noneed'">
                        <h3 class="return_label">Die Bestellung muss nicht mehr per E-Mail bestätigt werden.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'orderconfirm_confirmed'">
                        <h3 class="return_label">Die Bestellung wurde bereits bestätigt.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'orderconfirm_dataerror'">
                        <h3 class="return_label">Die angegebene Adresse ist ungültig oder wurde inkorrekt eingegeben.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'prepaid_error'">
                        <h3 class="return_label">Sie können diese Bestellung nicht ändern. Bitte kontaktieren Sie <a href="/contact.php">unseren Kundenservice</a>.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'prepaid_payback'">
                        <h3 class="return_label">Sie haben Ihre Vorauszahlung storniert. Das Geld wird Ihnen zurückerstattet, sobald es auf unserem Konto eingegangen ist.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'account_badlogin'">
                        <h3 class="return_label">Der angegebene Benutzername oder das angegebene Passwort ist nicht korrekt.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'account_nouser'">
                        <h3 class="return_label">Es existiert kein Konto mit dem angegebenen Benutzernamen und/oder der angegebenen E-Mail-Adresse.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'account_disabled'">
                        <h3 class="return_label">Das angegebene Konto wurde gesperrt.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'account_wholesale_disabled'">
                        <h3 class="return_label">Der Shop ist nur für Großhandelskunden verfügbar. Wenn Sie den Status eines Großhandelskunden erhalten möchten, wenden Sie sich bitte an unseren Kundenservice.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'account_passremind'">
                        <h3 class="return_label">An Ihre Adresse wurde eine E-Mail gesendet, dank der Sie sich in unserem Shop automatisch einloggen können. Danach können Sie Ihr Passwort jederzeit ändern. Hierzu gehen Sie bitte zu Ihrer Benutzerdatenseite. </h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'basket_empty'">
                        <div class="basket_icon_wrapper"><i class="icon-empty_basket"></i></div>
                        <h3 class="return_label">Ihr Warenkorb enthält noch keine Produkte.</h3>
                        <p>Suchen Sie sich ein oder mehrere Produkte aus unserem Sortiment aus und fügen Sie sie dem Warenkorb hinzu, um eine Bestellung aufgeben zu können.</p>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'basket_size'">
                        <h3 class="return_label">Ihr Warenkorb hat die maximale Anzahl an Produkten erreicht.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'wisheslist_empty'">
                        <div class="whish_icon_wrapper"><i class="icon-star-empty"></i></div>
                        <h3 class="return_label">Wunschliste ist leer.</h3>
                        <p>Fügen Sie Ihrer Liste Produkte hinzu.</p>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'ordered_empty'">
                        <div class="ordered_icon_wrapper"><i class="icon-empty_basket"></i></div>
                        <h3 class="return_label">Die Einkaufsliste ist leer.</h3>
                        <p>Wenn Sie ein Produkt kaufen, erscheint es auf dieser Liste.</p>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type = 'order_minimum'">
                        <h3 class="return_label">
                            ...
                            <iaixsl:if test="page/return/@extra">
                                <br/>Der Mindestbestellwert beträgt 
                    ...
                    <iaixsl:when test="page/return/@type = 'order_minimal_wholesale'">
                        <h3 class="return_label">
                            Der Bestellwert ist zu niedrig.
                            <iaixsl:if test="page/return/@extra">
                                <br/>Der Mindestbestellwert für Großhändler beträgt 
                                <iaixsl:value-of select="page/return/@extra"/><iaixsl:value-of select="currency/@name"/>
                            </iaixsl:if>
                        </h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type = 'order_notenough'">
                        <h3 class="return_label">Sie können Ihre Bestellung nicht aufgeben, weil einige Produkte 
                             in der von Ihnen gewünschten Stückzahl nicht verfügbar sind.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'order_tomuch'">
                        <h3 class="return_label">Der Gesamtwert Ihrer aufgegebenen Bestellungen ist zu hoch 
                            <iaixsl:if test="page/return/@extra">(<iaixsl:value-of select="page/return/@extra"/><iaixsl:value-of select="currency/@name"/>)</iaixsl:if>
                            <br/>Bitte warten Sie, bis wir Ihre vorherige Bestellung abgeschlossen haben, oder <a href="/login.php">stornieren Sie sie.</a></h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'shipping_error'">
                        <h3 class="return_label">Bitte entschuldigen Sie, aber wir haben keine Versandart für Ihr Land vorgesehen. Möchten Sie Ihre Bestellung dennoch in unserem Shop aufgeben, <a href="/contact.php">kontaktieren Sie bitte unseren Kundenservice</a>.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'mailing_nosuchemail'">
                        <h3 class="return_label">Die angegebene E-Mail-Adresse ist in unserer Mailingliste noch nicht vorhanden.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'mailing_removesuccess'">
                        <h3 class="return_label">Die E-Mail-Adresse wurde aus der Mailingliste entfernt.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'mailing_addsuccess'">
                        <h3 class="return_label">Die E-Mail-Adresse wurde zur Mailingliste hinzugefügt.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'mailing_emailexist'">
                        <h3 class="return_label">Die angegebene E-Mail-Adresse wurde bereits in unsere Mailingliste eingetragen.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'mailing_maileregerror'">
                        <h3 class="return_label">Ungültige E-Mail-Adresse. Bitte versuchen Sie es erneut.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'mailing_sendingconfirm'">
                        <h3 class="return_label">An die angegebene E-Mail-Adresse wurde eine Nachricht mit der Bestätigung von Änderungen in unserer Mailingliste gesendet. Bitte rufen Sie die E-Mail ab und folgen Sie den darin enthaltenene Hinweisen.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'payment_success'">
                        <h3 class="return_label">Die Anweisung zur Online-Zahlung wurde angenommen.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'payment_error'">
                        <h3 class="return_label">Beim Zahlen mit der von Ihnen ausgewählten Zahlungsart (Online-Zahlung) ist ein Fehler aufgetreten.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'payment_pending'">
                        <h3 class="return_label">Bestätigung seitens des Zahlungssystems wird erwartet.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'payment_credit_success'">
                        <h3 class="return_label">Die Anweisung zur Ratenzahlung wurde angenommen.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'payment_credit_error'">
                        <h3 class="return_label">Beim Zahlen mit der von Ihnen ausgewählten Zahlungsart (Ratenzahlung) ist ein Fehler aufgetreten.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'opinion_addsuccess'">
                        <h3 class="return_label">Der Kommentar wurde hinzugefügt und wartet auf Moderation.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'opinion_adderror'">
                        <h3 class="return_label">Ein Fehler ist aufgetreten – der Kommentar wurde nicht zum Produkt hinzugefügt.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = '403'">
                        <h3 class="return_label">Der Zugriff auf diese Datei wurde verweigert.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = '404'">
                        <h3 class="return_label">Das gesuchte Dokument wurde nicht gefunden. Wenn Sie auf diese Seite durch einen Link geleitet wurden, wären wir Ihnen dankbar, wenn <a href="/contact.php">Sie uns darüber informieren</a>.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = '500'">
                        <h3 class="return_label">Ein Serverfehler ist aufgetreten. Bitte warten Sie einen Augenblick und versuchen Sie, die Seite erneut aufzurufen. </h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'askforproduct_sent'">
                        <h3 class="return_label">Ihre Frage zum Produkt<iaixsl:text> </iaixsl:text><iaixsl:value-of select="page/return/@extra"/><iaixsl:text> </iaixsl:text>wurde erfolgreich gesendet. Bitte warten Sie auf unsere Antwort.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'askforproduct_error'">
                        <h3 class="return_label">Ihre Frage zum Produkt<iaixsl:text> </iaixsl:text><iaixsl:value-of select="page/return/@extra"/><iaixsl:text> </iaixsl:text>konnte nicht gesendet werden. Bitte versuchen Sie es später erneut.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'incorrect_email'">
                        <h3 class="return_label">Ungültige E-Mail-Adresse. Bitte geben Sie die korrekte E-Mail-Adresse ein.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'suggestreceiver_toolong'">
                        <h3 class="return_label">Die Länge der eingegebenen E-Mail-Adressen darf 255 Zeichen nicht überschreiten.<iaixsl:text> </iaixsl:text></h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'suggestreceiver_bademail'">
                        <h3 class="return_label">Die eingegebene E-Mail-Adresse bzw. die eingegebenen E-Mail-Adressen sind ungültig. Bitte überprüfen Sie sie noch einmal. Denken Sie daran, dass mehrere Adressen durch Kommata getrennt werden müssen.<iaixsl:text> </iaixsl:text></h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'suggestsignature_tooshort'">
                        <h3 class="return_label">Die eingegebene Unterschrift ist zu kurz. Bitte geben Sie Ihren Namen bzw. Spitznamen ein, damit der Empfänger Sie erkennen kann.<iaixsl:text> </iaixsl:text></h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'suggestbody_tooshort'">
                        <h3 class="return_label">Bitte geben Sie Ihre Nachricht ein.<iaixsl:text> </iaixsl:text></h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'suggestproduct_sent'">
                        <h3 class="return_label">Ihre Nachricht mit der Produktempfehlung wurde gesendet.<iaixsl:text> </iaixsl:text></h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='rebates_code_begins'">
                        <h3 class="return_label">Das Sonderangebot für diesen Rabattcode wurde noch nicht gestartet.</h3>
                    </iaixsl:when>
                    <iaixsl:when test="page/return/@type='rebates_code_expires'">
                        <h3 class="return_label">Das Sonderangebot für diesen Rabattcode wurde bereits beendet.</h3>
                    </iaixsl:when>
                    <iaixsl:when test="page/return/@type='rebates_code_undefined'">
                        <h3 class="return_label">Der angegebene Rabattcode existiert nicht.</h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type='account_logoff'">
                        <h3 class="return_label">Bei der Übermittlung Ihrer Bestellung ist ein Fehler aufgetreten. Bitte loggen Sie sich erneut ein, um den Bestellvorgang abzuschließen. Sollten Sie weiterhin Schwierigkeiten haben, <a href="/contact.php">kontaktieren Sie bitte unseren Kundenservice</a>. </h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='get_attachment_error'">
                        <h3 class="return_label">Der Anhang, den Sie herunterzuladen versuchen, ist nicht verfügbar.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='stock_not_found'">
                        <h3 class="return_label">Es wurde kein Abholort gefunden. </h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='stock_transfer'">
                        <h3 class="return_label">Sie können die Bestellung nicht aufgeben, weil die bestellten Produkte sich in verschiedenen Lagern befinden. Bitte <a href="/contact.php">kontaktieren Sie die Shop-Mitarbeiter</a>, um die Informationen zu erhalten, wie Sie Ihre Bestellung vervollständigen können.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='insurance_error'">
                        <h3 class="return_label">Es ist ein Fehler aufgetreten. Ihre Bestellung konnte nicht versichert werden. <a href="/contact.php">Bitte kontaktieren Sie unseren Kundenservice.</a></h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='products_not_available'">
                        <h3 class="return_label">Das Produkt ist an keinem der Abholorte verfügbar.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='no_partners'">
                        <h3 class="return_label">Bitte entschuldigen Sie. Unser Shop stellt Informationen über unsere Geschäftspartner nicht zur Verfügung.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='page_only_register'">
                        <h3 class="return_label">Die Seite ist nur für eingeloggte Kunden verfügbar. <a class="loginPopUpShow" href="/signin.php" title="Einloggen">Loggen Sie sich ein.</a></h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='page_only_unregister'">
                        <h3 class="return_label">Die Seite ist nur für nicht eingeloggte Kunden verfügbar. <a href="/login.php?operation=logout" title="Ausloggen">Loggen Sie sich aus.</a></h3>
                    </iaixsl:when>
                    <iaixsl:when test="page/return/@type='product_question_confirmed'">
                        <h3 class="return_label">Vielen Dank für Ihre Kontaktaufnahme. Wir haben Ihre Frage registriert. Die Antwort wird so schnell wie möglich an Ihre E-Mail-Adresse geschickt.</h3>
                    </iaixsl:when>
                    <iaixsl:when test="page/return/@type='product_question_confirm_error'">
                        <h3 class="return_label">Ein Fehler ist aufgetreten. Ihre Frage zum Produkt wurde nicht gesendet.</h3>
                    </iaixsl:when>
                    <iaixsl:when test="page/return/@type='product_question_wrong_email'">
                        <h3 class="return_label">Ungültige E-Mail-Adresse. Die Frage konnte nicht gesendet werden.</h3>
                    </iaixsl:when>
                    <iaixsl:when test="page/return/@type='product_question_sent'">
                        <h3 class="return_label">Vielen Dank für Ihre Anfrage. In Kürze erhalten Sie eine E-Mail mit einem Link. Bitte klicken Sie ihn an, um Ihre Frage an uns abzuschicken.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'to_many_products_compared'">
                        <h3 class="return_label">Maximale Anzahl von Waren wird für den Vergleich aufgenommen. Entfernen Sie einige von ihnen um die andere hinzuzufügen. </h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'products_not_found'">
                        <h3 class="return_label">Das gesuchte Produkt wurde nicht gefunden. Bitte verwenden Sie die <a href="/searching.php" title="Klicken Sie hier, um zur erweiterten Suchmaschine zu gelangen">erweiterten Suchmaschine</a>.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'virtual_products_not_found'">
                        <h3 class="return_label">Die Liste der Dateien, die Sie nicht mehr herunterladen können, ist leer.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'virtual_products_to_download_not_found'">
                        <h3 class="return_label">Es sind keine Dateien zum Herunterladen vorhanden. Diese Seite wird erst nach dem Kauf der Dateien aktiviert.</h3>
                    </iaixsl:when>
