...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 107421.1)-->
            ...
            <iaixsl:if test="(action/set_render/item/@name = 'popup') or not(action/set_render/item)">
                ...
                <script src="/gfx/ger/stock_info.js.gzip?r=1600678629"></script></head>
        ...
        <div class="stock_info_outline" id="stock_info_58110">
            ...
            <div class="stock_info_sub">
                <div class="stock_info_details">
                    ...
                    <iaixsl:if test="page/stock/@street and (page/stock/@street != '')">
                        <div class="stock_info_section" id="stock_info_details_street">
                            <span class="stock_info_title">Straße</span>
                    ...
                    <iaixsl:if test="page/stock/@zipcode and (page/stock/@zipcode != '')">
                        <div class="stock_info_section" id="stock_info_details_zipcode">
                            <span class="stock_info_title">Postleitzahl</span>
                    ...
                    <iaixsl:if test="page/stock/@city and (page/stock/@city != '')">
                        <div class="stock_info_section" id="stock_info_details_city">
                            <span class="stock_info_title">Stadt</span>
                    ...
                    <iaixsl:if test="page/stock/@country and (page/stock/@country != '')">
                        <div class="stock_info_section" id="stock_info_details_country">
                            <span class="stock_info_title">Land</span>
                    ...
                    <iaixsl:if test="page/stock/@phone and (page/stock/@phone != '')">
                        <div class="stock_info_section" id="stock_info_details_phone">
                            <span class="stock_info_title">Telefon</span>
                    ...
                    <iaixsl:if test="page/stock/@gg and (page/stock/@gg != '')">
                        <div class="stock_info_section" id="stock_info_details_gg">
                            <span class="stock_info_title">Gadu-Gadu</span>
                            <a class="stock_info_value">
                                <iaixsl:attribute name="href">gg:<iaixsl:value-of select="page/stock/@gg"/></iaixsl:attribute>
                                <img alt="gg">
                                    <iaixsl:attribute name="src">https://status.gadu-gadu.pl/users/status.asp?id=<iaixsl:value-of select="page/stock/@gg"/></iaixsl:attribute>
                                </img>
                    ...
                    <iaixsl:if test="page/stock/@skype and (page/stock/@skype != '')">
                        <div class="stock_info_section" id="stock_info_details_skype">
                            ...
                            <span class="stock_info_value"><iaixsl:value-of select="page/stock/@skype"/></span>
                        </div>
                    </iaixsl:if>
                    ...
                    <iaixsl:if test="page/stock/@street and (page/stock/@street != '') or page/stock/@zipcode or (page/stock/@zipcode != '') or page/stock/@city and (page/stock/@city != '')">
                        <iaixsl:if test="($mapHide != '') and page/stock/google_api_key/@value">
                            ...
                            <a class="btn --solid show_on_map">
                                <iaixsl:attribute name="href">https://maps.google.com/maps?q=<iaixsl:value-of select="page/stock/@zipcode"/>%20<iaixsl:value-of select="page/stock/@city"/>%20<iaixsl:value-of select="page/stock/@street"/></iaixsl:attribute>
                                <i class="icon-globe"></i> <span class="d-none d-sm-inline">Auf Karte anzeigen</span><span class="d-sm-none">Landkarte</span>
                            </a>
                        </iaixsl:if>
                    </iaixsl:if>
                </div>
                ...
                <div class="stock_info_hours">
                    <span class="stock_info_hours_label">Öffnungszeiten</span>
                    <iaixsl:if test="page/stock_time/monday">
                        <div class="stock_info_hours_day">
                            <span class="stock_info_hours_day">Montag</span>
                    ...
                    <iaixsl:if test="page/stock_time/tuesday">
                        <div class="stock_info_hours_day">
                            <span class="stock_info_hours_day">Dienstag</span>
                            <span class="stock_info_hours_time">
                                <iaixsl:choose>
                    ...
                    <iaixsl:if test="page/stock_time/wednesday">
                        <div class="stock_info_hours_day">
                            <span class="stock_info_hours_day">Mittwoch</span>
                            <span class="stock_info_hours_time">
                                <iaixsl:choose>
                    ...
                    <iaixsl:if test="page/stock_time/thursday">
                        <div class="stock_info_hours_day">
                            <span class="stock_info_hours_day">Donnerstag</span>
                            <span class="stock_info_hours_time">
                                <iaixsl:choose>
                    ...
                    <iaixsl:if test="page/stock_time/friday">
                        <div class="stock_info_hours_day">
                            <span class="stock_info_hours_day">Freitag</span>
                            <span class="stock_info_hours_time">
                                <iaixsl:choose>
                    ...
                    <iaixsl:if test="page/stock_time/saturday">
                        <div class="stock_info_hours_day">
                            <span class="stock_info_hours_day">Samstag</span>
                            <span class="stock_info_hours_time">
                                <iaixsl:choose>
                    ...
                    <iaixsl:if test="page/stock_time/sunday">
                        <div class="stock_info_hours_day">
                            <span class="stock_info_hours_day">Sonntag</span>
                            <span class="stock_info_hours_time">
                                <iaixsl:choose>
                    ...
                    <div class="loadingMap">
                        <div class="loadingContent">
                            <div class="loadingBox">
                                ...
                                <span class="loadingAddress">Adresse suchen</span>
