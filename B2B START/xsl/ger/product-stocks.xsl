...
<iaixsl:if test="/shop/page/@cache_basket"/>
    ...
    <iaixsl:if test="page/text/body">
        <div class="product_stocks_cms_label">
              <iaixsl:attribute name="class">product_stocks_cms_label big_label</iaixsl:attribute>
            <span class="product_stocks_cms_label">
                    Zusätzliche Informationen
            </span>
        </div>
        <div class="product_stocks_cms">
            <div class="product_stocks_cms_sub">
...
<div id="product_stocks_list">
        ...
        <h1>
            Produktverfügbarkeit in unseren Shops
        </h1>
...
<div class="product_stocks_list_productinfo product_wrapper">
    ...
    <iaixsl:variable name="var_name"><iaixsl:value-of disable-output-escaping="yes" select="/shop/page/product/name/text()"/></iaixsl:variable>

    <iaixsl:variable name="var_icon"><iaixsl:value-of select="/shop/page/product/icon"/></iaixsl:variable>

    <iaixsl:variable name="var_icon_small"><iaixsl:value-of select="/shop/page/product/icon_small"/></iaixsl:variable>

    <iaixsl:variable name="var_link"><iaixsl:value-of select="/shop/page/product/@link"/></iaixsl:variable>


    
    <a class="product-icon align_row" rel="nofollow" data-align="img#css">
    ...
    <iaixsl:variable name="var_size_min_formatted"><iaixsl:value-of select="/shop/page/product/price/@size_min_formatted"/></iaixsl:variable>

    <iaixsl:variable name="var_size_max_formatted"><iaixsl:value-of select="/shop/page/product/price/@size_max_formatted"/></iaixsl:variable>

    <iaixsl:variable name="var_points"><iaixsl:value-of select="/shop/page/product/price/@points"/></iaixsl:variable>

    <iaixsl:variable name="var_value"><iaixsl:value-of select="/shop/page/product/price/@value"/></iaixsl:variable>

    <iaixsl:variable name="var_price_formatted"><iaixsl:value-of select="/shop/page/product/price/@price_formatted"/></iaixsl:variable>

    <iaixsl:variable name="var_maxprice_formatted"><iaixsl:value-of select="/shop/page/product/price/@maxprice_formatted"/></iaixsl:variable>
...
<iaixsl:if test="page/product/traits/trait[not(@gfx)]">
                    <div class="list_traits">
                                <ul>

                                   <iaixsl:for-each select="page/product/traits/trait[not(@gfx)]">
...
<div class="product_stocks_list_s_w">
            ...
            <iaixsl:choose>
                <iaixsl:when test="page/table_stocks/row/@type = 'size'">

                     <iaixsl:for-each select="page/table_stocks/row">

                        <div class="product_stocks_size_wrapper">

                        <iaixsl:choose>
                            <iaixsl:when test="count(/shop/page/table_stocks/row) = '1'">
                            	<iaixsl:if test="not(@id = 'uniw')">
    	                            <b>
    	                                Größe: 
    	                                <iaixsl:value-of select="@name"/>
    	                            </b>
                            ...
                            <iaixsl:otherwise>
                                <a class="show_tab tab_hidden">
                                    <iaixsl:attribute name="href">#size_<iaixsl:value-of select="@id"/></iaixsl:attribute>
                                    Größe: 
                                    <iaixsl:value-of select="@name"/>
                                </a>
                            </iaixsl:otherwise>
                        ...
                        <div class="sizes_wrapper">
                          <iaixsl:if test="count(/shop/page/table_stocks/row) = '1'">
                                <iaixsl:attribute name="style">display: table;</iaixsl:attribute>
                            </iaixsl:if>

                            <iaixsl:attribute name="id">size_<iaixsl:value-of select="@id"/></iaixsl:attribute>

                             <iaixsl:for-each select="col">

                                    <a class="size_wrappers">
                                      <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                                      <div class="size_wrapper">
                                         ...
                                         <b>
                                            <iaixsl:choose>
                                                <iaixsl:when test="available/@status = 'enable'">
                                                    <i class="icon-check"></i> Verfügbar 
                                                </iaixsl:when>
                                                <iaixsl:when test="available/@status = 'disable'">
                                                    <i class="icon-remove"></i> Nicht verfügbar 
                                                </iaixsl:when>
                                                <iaixsl:when test="available/@status = 'order'">
                                                    <i class="icon-clock"></i> Auf Kundenbestellung
                                                </iaixsl:when>
                                            </iaixsl:choose>
                                        </b>
                                        <div class="icon_next">
            ...
            <iaixsl:otherwise>
                ...
                <iaixsl:for-each select="page/table_stocks/row[1]/col">
                    <iaixsl:if test="not(@id = 'uniw')">
                        <b>
                            Größe: 
                            <iaixsl:value-of select="@name"/>
                    ...
                    <iaixsl:variable name="tmp_size"><iaixsl:value-of select="@id"/></iaixsl:variable>

                    <div class="sizes_wrapper">
                      <iaixsl:if test="/shop/page/table_stocks/row[1]/col">
                            <iaixsl:attribute name="style">display: table;</iaixsl:attribute>
                        </iaixsl:if>

                         <iaixsl:for-each select="/shop/page/table_stocks/row">
                                ...
                                <a class="size_wrappers">
                                  ...
                                  <div class="size_wrapper">
                                     ...
                                     <b>
                                        <iaixsl:choose>
                                            <iaixsl:when test="col[@id = $tmp_size]/available/@status = 'enable'">
                                                <i class="icon-check"></i> Verfügbar 
                                            </iaixsl:when>
                                            <iaixsl:when test="col[@id = $tmp_size]/available/@status = 'disable'">
                                                <i class="icon-remove"></i> Nicht verfügbar 
                                            </iaixsl:when>
                                            <iaixsl:when test="col[@id = $tmp_size]/available/@status = 'order'">
                                                <i class="icon-clock"></i> Auf Kundenbestellung
                                            </iaixsl:when>
                                        </iaixsl:choose>
                                    </b>
