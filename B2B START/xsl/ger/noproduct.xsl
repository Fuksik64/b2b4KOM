...
<iaixsl:if test="/shop/page/@cache_basket"/>
                  ...
                  <iaixsl:attribute name="data-item"><iaixsl:value-of select="$SET_filters"/></iaixsl:attribute>
                    ...
                    <iaixsl:if test="not(action/set_render/item) or (action/set_render/item/@name = 'content')">
                        <div id="content" class="span9">
                            ...
                            <!--Brak produktów - propozycja produktu (noproduct_product_request_form, 113194.1)-->
            <section class="noproduct my-5">
                <div class="noproduct__icon"><i class="icon-noproduct"></i></div>
                <h3 class="noproduct__label mb-2">Das gesuchte Produkt wurde nicht gefunden.</h3>
                <p>44/5000 Versuchen Sie, genauere Parameter anzugeben. Bitte verwenden Sie die <a href="/searching.php" title="Klicken Sie hier, um zur erweiterten Suchmaschine zu gelangen">Suchmaschine</a>.</p>

                <div class="noproduct__form_wrapper pt-lg-5">
                    <span class="headline mt-5">
                    ...
                    <iaixsl:if test="/shop/basket/@login">
                        <form class="noproduct__form" method="post" novalidate="novalidate">
                            ...
                            <div class="noproduct__inputs mt-5">
                                <p class="mb-3">Bevor Sie Ihren Produktvorschlag abschicken, überprüfen Sie bitte, ob das Produkt in der <a href="products-requests.php" title="Przejdź do listy poszukiwanych produktów">Liste der gesuchten Produkte</a> bereits vorhanden ist.</p>
                                <div class="f-group">
                                    <div class="f-feedback --required">
                                        <input id="noproduct__name" class="f-control validate" name="name" minlength="3"/>
                                        <label class="f-label" for="noproduct__name">Produktname</label>
                                        <span class="f-control-feedback"/>
                                    </div>
                                </div>
                                <div class="f-group">
                                    <div class="f-feedback --required">
                                        <textarea id="noproduct__desc" class="f-control validate" name="desc" minlength="3"/>
                                        <label class="f-label" for="noproduct__desc">Beschreibung</label>
                                        <span class="f-control-feedback"/>
                                    </div>
                                </div>
                                <div class="d-flex flex-column justify-content-center align-items-center">
                                    <button class="btn --solid --medium px-5 mb-3" type="submit">
                                    ...
                                    <p><i class="icon-need"></i> Felder mit einem Stern gekennzeichneten Felder sind Pflicht.</p>
                                </div>
                            </div>
                        </form>
                    </iaixsl:if>
        ...
        <!--Hotspot w noproduct strefa 1 (noproduct_hotspot_zone1, 111451.1)-->
            
                <iaixsl:if test="/shop/page/additional/hotspot/products_zone1">

                    <section id="noproduct_hotspot_zone1" class="hotspot mb-5">
                        
                        <iaixsl:variable name="headline_after_noproduct_hotspot_zone1">Alles anzeigen</iaixsl:variable>
...
<!--Menu powiadomienia (menu_notice, 107640.1)-->
        ...
        <!--Elementy dodawane dynamicznie (menu_dynamically_added_content, 106830.1)-->
            ...
            <script src="/gfx/ger/noproduct_product_request_form.js.gzip?r=1600678629"></script>
            <script>
                app_shop.runApp();
            </script>
