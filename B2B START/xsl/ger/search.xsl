...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 107421.1)-->
            ...
            <iaixsl:if test="(action/set_render/item/@name = 'popup') or not(action/set_render/item)">
                ...
                <script src="/gfx/ger/search_gallery.js.gzip?r=1600678629"></script></head>
...
<iaixsl:if test="/shop/page/@cache_basket"/>
                                            ...
                                            <div class="filters__content --search">
                                                <div class="f-group mb-0">
                                                    <input type="text" class="f-control --search_by_text __serialize">
                                                        ...
                                                        <iaixsl:attribute name="placeholder">Ihr Suchbegriff</iaixsl:attribute>
                                                    </input>
        ...
        <div class="search_categoriesdescription">
            ...
            <span class="navigation_total">
                ( Anzahl der Produkte: <b><iaixsl:value-of select="page/products/navigation/@total"/></b> )
            </span>
            </iaixsl:if>
    ...
    <!--Lista produktów (search, 111232.1)-->
			...
			<iaixsl:variable name="var_net_prices_search"> exkl. MwSt.</iaixsl:variable>
			<iaixsl:variable name="var_b2b_search">Produkt im Einzelverkauf nicht erhältlich. Großhandelspreise nur für registrierte Kunden sichtbar.</iaixsl:variable>
			
			<iaixsl:variable name="addcompare_txt">+ Auf die Vergleichsliste</iaixsl:variable>
									...
									<iaixsl:choose>
										...
										<iaixsl:otherwise>
											<a class="product__compare_item --add btn" rel="nofollow">
												...
												<iaixsl:attribute name="title">Klicken Sie hier um das Produkt der Vergleich hinzufügen</iaixsl:attribute>
		...
		<!--Lista produktów jako galeria (search_gallery, 108230.1)-->
            <iaixsl:if test="/shop/page/products/display_mode/@active = 'gallery'">
                ...
                <iaixsl:variable name="count_unit"> St.</iaixsl:variable>
                    ...
                    <form action="/basketchange.php?type=multiproduct" method="post">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="info-item-wrapper">
                                            ...
                                            <iaixsl:if test="(firm/@name) and not(firm/@name = '') and (firm/@productslink)">
                                                <div class="info-item">
                                                    ...
                                                    <a class="info-value">
                                                        ...
                                                        <iaixsl:attribute name="title">Produkte dieses Herstellers anzeigen  <iaixsl:value-of select="firm/@name"/></iaixsl:attribute>
                                            ...
                                            <iaixsl:if test="(@barcode) and not(@barcode = '')">
                                                <div class="info-item">
                                                    <span class="info-label">Produktcode: </span>
                                            ...
                                            <iaixsl:if test="price/@unit_converted_price_net_formatted">
                                                <div class="info-item">
                                                    <span class="info-label">Grundpreis: </span>
                                            ...
                                            <iaixsl:if test="(price/@srp_net) and not(price/@srp_net = '')">
                                                <div class="info-item">
                                                    <span class="info-label">Empfohlener Verkaufspreis</span>
                                            ...
                                            <iaixsl:if test="not(sizes/@unit_sellby = '1')">
                                                <div class="info-item">
                                                    <span class="info-label">Verkauft für: </span>
                                    ...
                                    <div class="search_list_buttons">
                                        ...
                                        <iaixsl:if test="traits/trait[not(@gfx)] or traits/trait[@gfx2]">
                                            <a href="#show_specification" class="btn_specification btn --outline --icon-right icon-angle-down">
                                                <iaixsl:attribute name="data-toggleTxt">Spezifikation</iaixsl:attribute>
                                                Spezifikation
                                            </a>
                                        </iaixsl:if>
                                    </div>
                                                                ...
                                                                <iaixsl:when test="(price/@value = 0) and (price/@points)">
                                                                    <div class="price_search_points">
                                                                        <label class="search_forpoints">
                                                                            ...
                                                                            </input><span> kaufen Sie für <iaixsl:value-of select="price/@points"/> Pkt.</span>
                                                                        </label>
                                                                    </div>
                                                                </iaixsl:when>
                                                                ...
                                                                <iaixsl:otherwise>
                                                                    ...
                                                                    <iaixsl:if test="price/@price_net_formatted">
                                                                        ...
                                                                        <a class="shipping_info" target="blank" href="#shipping_info">
                                                                            <iaixsl:attribute name="title">Überprüfen Zeiten und Versandkosten</iaixsl:attribute>
                                                                    ...
                                                                    <iaixsl:if test="price/@points">
                                                                        <div class="price_search_points">
                                                                            <span>oder</span><label class="search_forpoints">
                                                                            <input type="checkbox" value="1">
                                                                                <iaixsl:attribute name="name">forpoints[<iaixsl:value-of select="$product_position"/><iaixsl:value-of select="position()"/>]</iaixsl:attribute>
                                                                            </input><span> kaufen Sie für <iaixsl:value-of select="price/@points"/> Pkt.</span>
                                                                        </label>
                                                                    ...
                                                                    <iaixsl:if test="((@amount_wholesale) and not(@amount = @amount_wholesale))">
                                                                        <iaixsl:choose>
                                                                            <iaixsl:when test="sizes/size/@amount_wholesale = 0">
                                                                                <div class="price_detail_info">(Produkt nur zum Einzelhandelspreis erhältlich)</div>
                                                                            </iaixsl:when>
                                                                            <iaixsl:otherwise>
                                                                                <div class="price_detail_info">
                                                                                    ...
                                                                                    <iaixsl:value-of select="@amount_wholesale"/><iaixsl:text> </iaixsl:text><iaixsl:value-of select="../@unit"/>
                                                                                     Einzelhandelspreis 
                                                                                    <img class="search_detail_info_tip" src="/gfx/ger/help_tip.png?r=1600678629"/>)
                                                                                    <div class="tooltipContent">
                                                                                        Über 
                                                                                        <span><iaixsl:value-of select="@amount_wholesale"/><iaixsl:text> </iaixsl:text><iaixsl:value-of select="../@unit"/></span>
                                                                                         der Nettopreis für jedes weiteres <iaixsl:value-of select="../@unit"/>
                                                                                         beträgt 
                                                        ...
                                                        <td class="search_rebate">
                                                            <iaixsl:if test="not((price/@value = 0) and (price/@points))">
                                                                <iaixsl:if test="price/rebateNumber/rebate">
                                                                    <div class="rabat btn --icon-left icon-plus showTip">Rabatt</div>
                                                                    <div class="tooltipContent">
                                                                ...
                                                                <iaixsl:choose>
                                                                    <iaixsl:when test="not(../../@product_type ='product_bundle')">
                                                                        <button class="search_buy">
                                                                            <iaixsl:attribute name="title">Dieses Produkt zu dem Warenkorb hinzufügen</iaixsl:attribute>
                                                                        ...
                                                                        <iaixsl:choose>
                                                                            <iaixsl:when test="(../../bundled/product/sizes/size/@type !=  'uniw')">
                                                                                <a class="btn --solid search_see_bundle">
                                                                                    <iaixsl:attribute name="href"><iaixsl:value-of select="../../@link"/></iaixsl:attribute>
                                                                                    <iaixsl:attribute name="title">Zu den Informationen zum Set</iaixsl:attribute>

                                                                                    Zu den Informationen zum Set
                                                                                </a>
                                                                            </iaixsl:when>
                                                                            <iaixsl:otherwise>
                                                                                <button class="search_buy">
                                    ...
                                    <iaixsl:if test="count(sizes/size) > $sizes_hide_on">
                                        <iaixsl:if test="not(price/@value = 0 and not(/shop/basket/@wholesaler = 'true'))">
                                            <a href="#show_sizes" class="show_all_sizes btn --icon-right icon-angle-up pl-0">
                                                <iaixsl:attribute name="data-toggleTxt">Alle Größen einblenden</iaixsl:attribute>
                                                Ausblenden Größen
                                            </a>
                                        </iaixsl:if>
                                    </iaixsl:if>
                        ...
                        <div id="search-total">
                            <button type="submit" class="btn --solid --large">
                                <iaixsl:attribute name="data-loadtxt">&lt;i class="icon-refresh icon-spin"&gt;&lt;/i&gt; Auswahl zum Warenkorb hinzufügen</iaixsl:attribute>
						...
						<tr>
							...
							<td class="product-name-td">
								<h3><a class="product-name">
									<iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
									<iaixsl:attribute name="title">Klicken Sie hier, um die detaillierte Beschreibung anzuzeigen</iaixsl:attribute>
                                        ...
                                        <a class="headline">
                                            ...
                                            <span class="headline__name">
                                                <iaixsl:choose>
                                                    ...
                                                    <iaixsl:otherwise>Sonderangebot</iaixsl:otherwise>
                                                </iaixsl:choose>
                                            </span>
...
<!--Menu powiadomienia (menu_notice, 107640.1)-->
        ...
        <!--Elementy dodawane dynamicznie (menu_dynamically_added_content, 106830.1)-->
            ...
            <script src="/gfx/ger/menu_filter.js.gzip?r=1600678629"></script>
            <script>
                app_shop.runApp();
            </script>
