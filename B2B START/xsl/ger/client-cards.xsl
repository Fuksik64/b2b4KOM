			...
			<iaixsl:choose>
				<iaixsl:when test="/shop/page/cards/item">
					<div id="client_cards">
						...
						<p>
							Um zu prüfen, welche Rabattstuffen Ihnen gewährt wurden, gehen Sie zur 
						<a href="client-rebate.php">Seite Rabatt in Ihrem Kundenpanel.</a>
						</p>
