...
<iaixsl:if test="/shop/page/@cache_basket"/>
		...
		<iaixsl:variable name="news_list_see_more">Weiterlesen</iaixsl:variable>
		...
		<iaixsl:choose>
			...
			<iaixsl:when test="/shop/page/newslist">
				<section id="news_list" class="article mb-4">
					<h1 class="headline">
						<span class="headline__name">Aktuelles</span>
					</h1>
        ...
        <!--Produkty powiązane (news_cms_associated, 111450.1)-->
            <iaixsl:if test="page/news/cms_products/product or page/news/cms_products/opinion">
                ...
                <section id="news_cms_associated" class="hotspot mb-5">
                    ...
                    <iaixsl:variable name="headline_after_news_cms_associated">Alles anzeigen</iaixsl:variable>
