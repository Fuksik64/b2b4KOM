...
<iaixsl:if test="/shop/page/@cache_basket"/>
    ...
    <!--Rma szczegóły (rma_details_form, 116660.1)-->
        ...
        <iaixsl:variable name="n5_4atxt">Versenden Sie das Paket <small>ohne zusätzliche Kosten</small></iaixsl:variable>
                        ...
                        <div class="prepaid-status">
                            <strong>
                                <iaixsl:choose>
                                    ...
                                    <iaixsl:when test="page/details/@status=5">
                                        Produkte an den Hersteller ausgeliefert
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=6">
                                        Es dauert die Reparatur
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=7">
                                        Keine Defekte
                                    </iaixsl:when>
                                    ...
                                    <iaixsl:when test="page/details/@status=9">
                                        Überschritten die Garantiezeit
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=10">
                                        Rückerstattung - beziehen sich auf Zahlungen
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=11">
                                        Die Erstattung - Zahlung
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=12">
                                        Ersetzen eines neuen Produkts
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=13">
                                    ...
                                    <iaixsl:when test="page/details/@status=15">
                                        Erneuter Bestellversand
                                    </iaixsl:when>
                                    
                                    <iaixsl:when test="page/details/@status=16">
                                        Kein erneuter Bestellversand
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=17">
                                        Kunde hat eine Retoure beantragt und gibt den Artikel persönlich zurück
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=18">
                                        Kunde hat eine Retoure beantragt und übernimmt den Rückversand des Artikels
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=19">
                                        Beschwerde bestätigt
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=20">
                                        Die Beschwerde wartet verarbeitet zu werden
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=21">
                                    ...
                                    <iaixsl:when test="page/details/@status=25">
                                        Rücksendungen an den Kunden gesendet
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=26">
                                        Sent neue Ware
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=27">
                                        Veränderte Kundendaten für Verkaufsbeleg
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=28">
                                    ...
                                    <iaixsl:when test="page/details/@status=30">
                                        Rücklieferung an den Kunden gesendet
                                    </iaixsl:when>
                                </iaixsl:choose>
                            </strong>
                            <small>der Beschwerden ID:<iaixsl:value-of select="page/details/@id"/></small>
                        </div>
                        ...
                        <div class="prepaid-buttons">
                            <iaixsl:if test="/shop/page/editlink/@url">
                                <a class="btn-icon prepaid-edit">
                                    ...
                                    <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/editlink/@url"/></iaixsl:attribute><i class="icon-pencil"></i><span>ändern Beschwerde</span></a>
                            </iaixsl:if>
                            <iaixsl:if test="/shop/page/cancellink/@url">
                                <a class="btn-icon prepaid-cancel orderdetails_info_cancel">
                                    ...
                                    <iaixsl:attribute name="title">Abbrechen Beschwerde</iaixsl:attribute>
                                    <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/cancellink/@url"/></iaixsl:attribute>
                                    <i class="icon-remove"></i><span>Abbrechen Beschwerde</span>
                                </a>
                            </iaixsl:if>
                        </div>
                    </div>
                ...
                <iaixsl:choose>
                    ...
                    <iaixsl:when test="/shop/page/rma_method/@id='2' and $n5_4atxt">
                        <div class="return_image_i">
                            <div class="text-1a">Drucken Sie die Reklamationsbenachrichtigung und die Etiketten aus</div>
                            <div class="text-2a">Bereiten Sie das Paket vor und fügen Sie das Beschwerdeformular bei</div>
                            <div class="text-3a">Versenden Sie das Paket <small>ohne zusätzliche Kosten</small></div>
                            <img src="/gfx/ger/instukcja_zwrot2.png?r=1600678629" alt=""/>
                        </div>
                    </iaixsl:when>
                    <iaixsl:otherwise>
                        <div class="return_image_i">
                            <div class="text-1">Drucken Sie die Reklamationsbenachrichtigung und die Etiketten aus</div>
                            <div class="text-2">Bereiten Sie das Paket vor und fügen Sie das Beschwerdeformular bei</div>
                            <div class="text-3">Kleben Sie das Etikett außen auf Ihr Rücksendepaket</div>
                            <div class="text-4">Schicken Sie Ihre Rücksendung zurück</div>
                            <img src="/gfx/ger/instukcja_zwrot.png?r=1600678629" alt=""/>
                        </div>
                    </iaixsl:otherwise>
                </iaixsl:choose>
                    ...
                    <iaixsl:if test="/shop/page/documentlink/@url">
                        <div class="return_wrapper2">
                            <a class="btn --solid --large" target="blank">
                                ...
                                Drucken Sie das Beschwerdeformular aus
        ...
        <iaixsl:if test="page/returnproducts/products/product">
            ...
            <div id="prepaid_order_products">
                <h2 class="big_label">Defekte Waren</h2>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5" class="rma-remarks">
                                        ...
                                        <div class="rma-remarks">
                                            <b class="rma-remarks">Fehlerbeschreibung :</b>
        ...
        <iaixsl:variable name="prepaid016txt">Sendungsnummer: </iaixsl:variable>
        <iaixsl:variable name="prepaid017atxt">Sendungsverfolgung: </iaixsl:variable>
        <iaixsl:variable name="prepaid017txt">Seite des Transporteurs</iaixsl:variable>
        <iaixsl:variable name="n5_4atxt">Versenden Sie das Paket <small>ohne zusätzliche Kosten</small></iaixsl:variable>
        ...
        <div class="step7">
            ...
            <iaixsl:if test="/shop/page/pickup/name">
                <div class="returns_details_wrapper">
                    <h2 class="big_label">Rückgabeort</h2>
                        ...
                        <div class="basketedit_calculations">
                            <iaixsl:if test="/shop/page/costs/cost[@type='products']/@value_formatted">
                                <div class="basketedit_product_summary">
                                    <label>Der Wert des Produkts geworben wird:
                                    </label>
                            ...
                            <iaixsl:if test="/shop/page/costs/cost[@type='shipping']/@value_formatted">
                                <div class="basketedit_product_summary">
                                    <label>Die Erstattung der Kosten für die Lieferung an den Kunden:
                                    </label>
                            ...
                            <iaixsl:if test="/shop/page/costs/cost[@type='shop_shipping']/@value_formatted">
                                <div class="basketedit_product_summary">
                                    <label>Die Kosten der Rücksendung:
                                    </label>
        ...
        <div id="menu_notice" style="display: none;">
            ...
            <h2>Retoure stornieren</h2>
            <strong>
                Das Stornieren einer Retoure ist unwiderruflich. Um den Vorgang fortzusetzen, klicken Sie bitte auf "Retoure stornieren"
            </strong>
