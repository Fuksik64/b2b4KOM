...
<script src="/gfx/ger/orderdetails_payments.js.gzip?r=1600678629"></script>
                            </iaixsl:when>
                            <iaixsl:otherwise>
    ...
    <!--Informacje o zamówieniu (orderdetails_info, 114646.1)-->
														...
														<div class="row">
																<div class="credit_card_pci_dss col-12">
																		...
																		<span class="pci_dss_icon_container">
																				<img src="/gfx/ger/pci_css_logo.png?r=1600678629" alt="PCI DSS Compilant"/>
																		</span>
																</div>
														</div>
												</form>
        ...
        <div id="prepaid_delivery_list">
            ...
            <table>
                ...
                <tr>
                    <td class="ordered-icon">
                        <img src="/gfx/ger/shipping_icon.png?r=1600678629">
                    ...
                    <iaixsl:when test="/shop/page/prepaid/prepaid_history/item/@status = 'n'">
                        <iaixsl:for-each select="/shop/page/prepaid/prepaid_history/item[@status = 'n']">
                            <tr class="payment_form_item">
                                <td class="ordered-icon">
                                    <img src="/gfx/ger/prepaid_method_icon.png?r=1600678629">
                                        <iaixsl:if test="@icon">
                                            <iaixsl:attribute name="src"><iaixsl:value-of select="@icon"/></iaixsl:attribute>
                                        </iaixsl:if>
                                        <iaixsl:attribute name="alt"><iaixsl:value-of select="@payment_name"/></iaixsl:attribute>
                ...
                <iaixsl:if test="/shop/page/insurance_product">
                    ...
                    <tr>
                        <td class="ordered-icon">
                            <img src="/gfx/ger/insurance_icon.png?r=1600678629" alt="insurance_icon"/>
                        </td>
                        <td class="ordered-name">
                            Käuferschutz: 
            ...
            <iaixsl:if test="$prepaidrt_txt and /shop/page/prepaid/actions/return/@url">
                <div class="actions_return col-12 col-sm-6">
                    <div class="actions_return_sub col-12 mb-4">
                        ...
                        <div>
                            <img alt="returns" src="/gfx/ger/returns_action.png?r=1600678629"/><span>Wenn Sie Ihr Recht auf Rückgabe der gekauften Ware ohne Angabe von Gründen ausüben wollen, nutzen Sie unser Rückgabesystem, das diesen Prozess einfach und sicher macht.</span></div>
                            <a class="btn --solid">
...
<script src="/gfx/ger/orderdetails_payments.js.gzip?r=1600678629"></script>
            ...
            <script src="/gfx/ger/prepaid_order_products.js.gzip?r=1600678629"></script>
            <script>
                app_shop.runApp();
            </script>
