...
<div class="payment_card">
    <div class="payment_card_sub">
        <div class="payment_card_info">
            Ihre Kartendaten werden nicht in unserem System gespeichert. Sie werden sofort nach dem Abschluss der Transaktion gelöscht.
        </div>
        ...
        <form class="payment_card">
                ...
                <iaixsl:choose>
                    <iaixsl:when test="@name = 'creditCard[system]'">
                        <div class="payment_card_formel cc_wrapper">
                            <label for="credit_card_system" class="payment_card_formel">Kartenart:</label>
                            ...
                            <span class="payment_card_need">
                                <img src="/gfx/ger/need.gif?r=1600678629" class="payment_card_nedd_img"><iaixsl:attribute name="alt">Dieses Feld muss ausgefüllt werden, um Ihre Zahlung zu tätigen</iaixsl:attribute><iaixsl:attribute name="title">Dieses Feld muss ausgefüllt werden, um die Bestellung aufzugeben</iaixsl:attribute></img>
                                <img src="/gfx/ger/correct.png?r=1600678629" class="payment_card_correct_img" style="display:none;"/><img src="/gfx/ger/incorrect.png?r=1600678629" class="payment_card_wrong_img" style="display:none;"/>
                                <span class="payment_card_help"><span class="payment_card_help2">Wählen Sie Ihre Kreditkartenart</span></span>
                            </span>
                    ...
                    <iaixsl:when test="@name = 'creditCard[number]'">
                        <div class="payment_card_formel">
                            <label for="credit_card_number" class="payment_card_formel">Kreditkartenummer:</label>
                    ...
                    <iaixsl:when test="@name = 'creditCard[endDateMonth]'">
                        <div class="payment_card_formel">
                            <label for="credit_card_month" class="payment_card_formel">Gültig bis:</label>
                        ...
                        <div class="payment_card_datedesc">
                            Geben Sie das Ablaufdatum im Format MM/JJ ein, z.B. 04/12
                        </div>
                    </iaixsl:when>
                    <iaixsl:when test="@name = 'creditCard[securityCode]'">
                        <div class="payment_card_formel">
                            <label for="credit_card_code" class="payment_card_formel">Prüfziffer (CVV):</label>
                    ...
                    <iaixsl:when test="@name = 'creditCard[name]'">
                        <div class="payment_card_formel">
                            <label for="credit_card_name" class="payment_card_formel">Vorname und Nachname:</label>
            ...
            <div class="credit_card_submit">
                <button class="btn --solid --large credit_card_submit disabled" type="submit">
                    <iaixsl:attribute name="title">Jetzt bezahlen</iaixsl:attribute>
                    Jetzt bezahlen
                </button>
