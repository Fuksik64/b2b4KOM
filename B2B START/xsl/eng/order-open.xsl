        ...
        <!--Otwórz zamówienie (order_open_form, 112607.1)-->
			<section class="order_open mb-4">
				...
				<h1 class="order_open__label headline">
					<span class="order_open__label_txt headline__name">Check order status</span>
				</h1>

				
				<div class="order_open__description menu_messages_message mb-4">To check the order status, enter its number (you can find it in the e-mail which you have received after placing an order) and your phone number or e-mail address.</div>
				...
				<div class="order_open__signin d-flex justify-content-center">
					<a href="/login.php" class="order_open__signin_link">I have a registered account and want to go to the list of my orders</a>
				</div>
			</section>
