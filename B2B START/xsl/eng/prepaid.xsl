...
<script src="/gfx/eng/orderdetails_payments.js.gzip?r=1600678618"></script>
                            </iaixsl:when>
                            <iaixsl:otherwise>
    ...
    <!--Informacje o zamówieniu (orderdetails_info, 114646.1)-->
														...
														<div class="row">
																<div class="credit_card_pci_dss col-12">
																		...
																		<span class="pci_dss_icon_container">
																				<img src="/gfx/eng/pci_css_logo.png?r=1600678618" alt="PCI DSS Compilant"/>
																		</span>
																</div>
														</div>
												</form>
        ...
        <div id="prepaid_delivery_list">
            ...
            <table>
                ...
                <tr>
                    <td class="ordered-icon">
                        <img src="/gfx/eng/shipping_icon.png?r=1600678618">
                    ...
                    <iaixsl:when test="/shop/page/prepaid/prepaid_history/item/@status = 'n'">
                        <iaixsl:for-each select="/shop/page/prepaid/prepaid_history/item[@status = 'n']">
                            <tr class="payment_form_item">
                                <td class="ordered-icon">
                                    <img src="/gfx/eng/prepaid_method_icon.png?r=1600678618">
                                        <iaixsl:if test="@icon">
                                            <iaixsl:attribute name="src"><iaixsl:value-of select="@icon"/></iaixsl:attribute>
                                        </iaixsl:if>
                                        <iaixsl:attribute name="alt"><iaixsl:value-of select="@payment_name"/></iaixsl:attribute>
                ...
                <iaixsl:if test="/shop/page/insurance_product">
                    ...
                    <tr>
                        <td class="ordered-icon">
                            <img src="/gfx/eng/insurance_icon.png?r=1600678618" alt="insurance_icon"/>
                        </td>
                        <td class="ordered-name">
                            Buyer Protection: 
            ...
            <iaixsl:if test="$prepaidrt_txt and /shop/page/prepaid/actions/return/@url">
                <div class="actions_return col-12 col-sm-6">
                    <div class="actions_return_sub col-12 mb-4">
                        ...
                        <div>
                            <img alt="returns" src="/gfx/eng/returns_action.png?r=1600678618"/><span>If you would like to use the right to return a product without giving a reason, use our returns system which makes the process safe and simple.</span></div>
                            <a class="btn --solid">
            ...
            <iaixsl:if test="$prepaidzt_txt and /shop/page/prepaid/actions/rma/@url">
                <div class="actions_rma col-12 col-sm-6">
                    <div class="actions_rma_sub col-12">
                        ...
                        <div>
                            <img alt="rma" src="/gfx/eng/rma_action.png?r=1600678618"/><span>If a product was fine at the moment of delivery but then has broken and you would like to file a complaint through our shop, just use our RMA system which makes the process quicker and easier.</span></div>
                            <a class="btn --solid">
...
<script src="/gfx/eng/orderdetails_payments.js.gzip?r=1600678618"></script>
            ...
            <script src="/gfx/eng/prepaid_order_products.js.gzip?r=1600678618"></script>
            <script>
                app_shop.runApp();
            </script>
