...
<div class="client_order">
    <h1 class="big_label">
        <span>List of your returns</span>
    </h1>
    <iaixsl:choose>
            ...
            <table class="orders" cellspacing="0" cellpadding="0" >
                ...
                <thead>
                    <tr id="orders_header">
                        ...
                        <td class="ord3" id="orders_head_2">date of the return</td>
                        <td class="ord3" id="orders_head_3">to return</td>

                        <td class="ord3" id="orders_head_5">status</td>
                        <td class="ord3" id="orders_head_6">details</td>
                    </tr>
                </thead>
                <tbody>
                            ...
                            <td>
                                <iaixsl:choose>
                                                            ...
                                                            <iaixsl:when test="@status=17">
                                                                A customer added a return – it will be delivered personally
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@status=18">
                                                                A customer added a return - it will be sent by the customer
                                                            </iaixsl:when>
                                </iaixsl:choose>
                            </td>
                             <td class="ord">
                                <a class="orders_more"><iaixsl:attribute name="href"><iaixsl:value-of select="@url"/></iaixsl:attribute>more...</a>
                            </td>
                        </tr>
                    </iaixsl:for-each>
                </tbody>
        ...
        <iaixsl:otherwise>
            <div class="return_list_noitem menu_messages_message" id="return_list_noitem">No returns has been added yet.</div>
        </iaixsl:otherwise>
    </iaixsl:choose>
</div>
