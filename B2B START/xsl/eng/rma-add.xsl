            ...
            <form id="rma_add_form" method="post" action="/rma-add.php">
                ...
                <div class="rma_add_form_addbutton">
                    <a href="rma-list.php" class="btn --solid --medium --icon-left icon-file-alt rma_add_form_listbutton">
                        <iaixsl:attribute name="title">Click here to go to the list of complaints</iaixsl:attribute>
                    ...
                    <span class="rma_add_form_label">
                        <iaixsl:choose>
                            <iaixsl:when test="page/rma/@action = 'view'">
                                Preview of the complaint no. <iaixsl:value-of select="page/rma/@id"/>
                            </iaixsl:when>
                            <iaixsl:when test="page/rma/@action = 'edit'">
                                Edition of the complaint no. <iaixsl:value-of select="page/rma/@id"/>
                            </iaixsl:when>
                ...
                <div class="rma_add_form_section" id="rma_add_form_section1">
                    <div class="rma_add_form_sectionheader">
                        <span class="rma_add_form_sectionheader">Your personal data</span>
                    </div>
                    <iaixsl:if test="not(page/rma/@action = 'view')">
                        <div class="rma_add_form_sectiondesc">
                            <span class="rma_add_form_sectiondesc">The personal information you have provided during a registration process is displayed below. If any of this information is incorrect, please</span>
                            <a class="rma_add_form_clientedit">
                                ...
                                <iaixsl:attribute name="title">Proceed to personal information edition</iaixsl:attribute>
                    ...
                    <div class="rma_add_form_sectionsub row" id="rma_add_form_subsection1">
                        ...
                        <div class="rma_add_form_box" id="rma_add_form_box1">
                            <span class="rma_add_form_adr1">Billing details:</span>
                        ...
                        <div class="rma_add_form_box" id="rma_add_form_box2">
                            <span class="rma_add_form_adr2">Delivery address:</span>
                            <div class="rma_add_form_boxsub3">
                                <iaixsl:choose>
                        ...
                        <div class="rma_add_form_box" id="rma_add_form_box2b">
                            <span class="rma_add_form_adr1">Contact details:</span>
                ...
                <div class="rma_add_form_section" id="rma_add_form_section2">
                    <div class="rma_add_form_sectionheader">
                        <span class="rma_add_form_sectionheader">Product details</span>
                    </div>
                    <iaixsl:if test="not(page/rma/@action = 'view')">
                        <div class="rma_add_form_sectiondesc">
                            <span class="rma_add_form_sectiondesc">The following information is necessary to verify a complaint. Please enter a product name and its size.</span>
                        </div>
                    </iaixsl:if>
                    <div class="rma_add_form_sectionsub row" id="rma_add_form_subsection2">
                        ...
                        <div class="rma_add_form_box" id="rma_add_form_box3">
                            ...
                            <div class="rma_add_form_boxsub">
                                <span class="rma_add_form_infotitle">Place of purchase:</span>
                                <span class="rma_add_form_infovalue">
                                    <iaixsl:choose>
                                        <iaixsl:when test="page/rma/@action = 'view'">
                                            <iaixsl:if test="page/rma/buy_place/place[@checked = 'true']/@name = 'shop'">On-line store</iaixsl:if>
                                            <iaixsl:if test="page/rma/buy_place/place[@checked = 'true']/@name = 'auction'">On-line auction<iaixsl:value-of select="page/rma/auctions/auction[@checked = 'true']/@name"/></iaixsl:if>
                                                ...
                                                <div class="form-group clearfix">
                                                    <div class=" ">
                                                        <label for="buy_place_desc" class="control-label">
                                                            Short description of a purchase place:
                                                        </label>
                                                    </div>
                                                    <div class="has-feedback has-required ">
                        ...
                        <div class="rma_add_form_box" id="rma_add_form_box4">
                            ...
                            <div class="rma_add_form_descval">
                                <iaixsl:choose>
                                    <iaixsl:when test="page/rma/@action = 'view'">
                                        <span class="rma_add_form_desc">Defect's description:</span>
                ...
                <iaixsl:if test="not(page/rma/payments/@active = '0')">
                    <div class="rma_add_form_section" id="rma_add_form_section3">
                        <div class="rma_add_form_sectionheader">
                            <span class="rma_add_form_sectionheader">Refund</span>
                        </div>
                        <iaixsl:if test="not(page/rma/@action = 'view')">
                            <div class="rma_add_form_sectiondesc">
                                <span class="rma_add_form_sectiondesc">In order to speed up the refund, enter the expected refund method below. Please note that the request for supplying this information does not mean that the complaint will be completed with a successful refund.</span>
                            </div>
                        </iaixsl:if>
                        ...
                        <div class="col-12 col-sm-4">
                            <div class="rma_add_form_box" id="rma_add_form_box5">
                                <div class="rma_add_form_boxsub2">
                                    <span class="rma_add_form_infotitle2">Refund method:</span>
                                    <span class="rma_add_form_infovalue2">
                                        <iaixsl:choose>
                                            <iaixsl:when test="page/rma/@action = 'view'">
                                                <iaixsl:choose>
                                                    <iaixsl:when test="page/rma/payments/payment[@checked = 'true']/@type = 'b'">Bank account</iaixsl:when>
                                                    <iaixsl:when test="page/rma/payments/payment[@checked = 'true']/@type = 'p'">Money transfer to a specified address</iaixsl:when>
                                                    <iaixsl:when test="page/rma/payments/payment[@checked = 'true']/@type = 'c'">Cheque</iaixsl:when>
                                                    <iaixsl:when test="page/rma/payments/payment[@checked = 'true']/@type = 't'">Funds to be used for future purchases</iaixsl:when>
                                                </iaixsl:choose>
                                            </iaixsl:when>
                                            <iaixsl:otherwise>
                                                    ...
                                                    <span>
                                                        ...
                                                        <iaixsl:choose>
                                                            ...
                                                            <iaixsl:when test="@type = 'p'">
                                                                Money transfer to a specified address
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@type = 'c'">
                                                                Cheque
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@type = 't'">
                                                                Funds to be used for future purchases
                                                            </iaixsl:when>
                                                        </iaixsl:choose>
                                                    </span>
                                                </iaixsl:for-each>
                                        ...
                                        <iaixsl:choose>
                                            <iaixsl:when test="page/rma/payments/payment[@checked = 'true']/@type = 'b'">
                                                <div class="rma_add_form_boxsub2_hidden" style="display:block;">
                                                    <span class="rma_add_form_infotitle2">Bank account</span>
                                            ...
                                            <iaixsl:when test="page/rma/payments/payment[@checked = 'true']/@type = 'p'">
                                                <div class="rma_add_form_boxsub2_hidden" style="display:block;">
                                                    <span class="rma_add_form_infotitle2">Money transfer to a specified address</span>
                                                    <span class="rma_add_form_infovalue2"><iaixsl:value-of disable-output-escaping="no" select="page/rma/payments_text"/></span>
                                                </div>
                                            </iaixsl:when>
                                            <iaixsl:when test="page/rma/payments/payment[@checked = 'true']/@type = 'c'">
                                                <div class="rma_add_form_boxsub2_hidden" style="display:block;">
                                                    <span class="rma_add_form_infotitle2">Cheque</span>
                                                    <span class="rma_add_form_infovalue2"><iaixsl:value-of disable-output-escaping="no" select="page/rma/payments_text"/></span>
                                                </div>
                                            </iaixsl:when>
                                        </iaixsl:choose>
                                                ...
                                                <iaixsl:choose>
                                                    <iaixsl:when test="@type = 'p'">
                                                        ...
                                                        <span class="rma_add_form_infotitle2">
                                                            ...
                                                            <iaixsl:if test="/shop/page/rma/payments/@active = '1'">
                                                                <img class="rma_need" src="/gfx/eng/need.gif?r=1600678618"><iaixsl:attribute name="alt">This field is required to place an order</iaixsl:attribute></img>
                                                                <img src="/gfx/eng/correct.png?r=1600678618" class="rma_correct_img" id="rma_add_przekaz_on" style="display:none;"/>
                                                                <img src="/gfx/eng/incorrect.png?r=1600678618" class="rma_correct_img" id="rma_add_przekaz_off" style="display:none;"/>
                                                            </iaixsl:if>
                                                        </span>
                                                    ...
                                                    <iaixsl:when test="@type = 'b'">
                                                        ...
                                                        <span class="rma_add_form_infotitle2">
                                                            ...
                                                            <iaixsl:if test="/shop/page/rma/payments/@active = '1'">
                                                                <img class="rma_need" src="/gfx/eng/need.gif?r=1600678618"><iaixsl:attribute name="alt">This field is required to place an order</iaixsl:attribute></img>
                                                                <img src="/gfx/eng/correct.png?r=1600678618" class="rma_correct_img" id="rma_add_bankaccount_on" style="display:none;"/>
                                                                <img src="/gfx/eng/incorrect.png?r=1600678618" class="rma_correct_img" id="rma_add_bankaccount_off" style="display:none;"/>
                                                            </iaixsl:if>
                                                        </span>
                                                    ...
                                                    <iaixsl:when test="@type = 'c'">
                                                        ...
                                                        <span class="rma_add_form_infotitle2">
                                                            ...
                                                            <iaixsl:if test="/shop/page/rma/payments/@active = '1'">
                                                                <img class="rma_need" src="/gfx/eng/need.gif?r=1600678618"><iaixsl:attribute name="alt">This field is required to place an order</iaixsl:attribute></img>
                                                                <img src="/gfx/eng/correct.png?r=1600678618" class="rma_correct_img" id="rma_add_czek_on" style="display:none;"/>
                                                                <img src="/gfx/eng/incorrect.png?r=1600678618" class="rma_correct_img" id="rma_add_czek_off" style="display:none;"/>
                                                            </iaixsl:if>
                                                        </span>
                    ...
                    <div class="rma_add_form_sectionheader">
                        <iaixsl:choose>
                            <iaixsl:when test="page/rma/@action = 'view' or count(page/rma/stocks/stock) = 1">
                                <span class="rma_add_form_sectionheader">Complaint location</span>
                            </iaixsl:when>
                            <iaixsl:otherwise>
                                <span class="rma_add_form_sectionheader">The address for sending back the faulty product.</span>
                            </iaixsl:otherwise>
                        </iaixsl:choose>
                    </div>
                    <iaixsl:if test="not(page/rma/@action = 'view') and count(/shop/page/rma/stocks/stock) > 1">
                        <div class="rma_add_form_sectiondesc">
                            <span class="rma_add_form_sectiondesc">Select the complaint reception point you would like to send the faulty product to and with which you will communicate for updates.</span>
                        </div>
                    </iaixsl:if>
                        ...
                        <iaixsl:for-each select="page/rma/stocks/stock">
                            <div class="rma_add_form_stock">
                                ...
                                <iaixsl:if test="not(/shop/page/rma/@action = 'view') and count(/shop/page/rma/stocks/stock) > 1">
                                    <iaixsl:attribute name="title">Click here to select this location</iaixsl:attribute>
                                ...
                                <div class="rmaf_sub">
                                    ...
                                    <div class="rma_add_form_stocklink">
                                        <a class="rma_add_form_stocklink" target="_blank">
                                            <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                                            <iaixsl:attribute name="title">View detailed information</iaixsl:attribute>
                                            more information
                                        </a>
                                    </div>
                                </div>
                        ...
                        <a id="rma_add_form_submit" onmouseover="rma_add.checkInps();" class="btn --solid --medium rma_add_form_button_add">
                            ...
                            <iaixsl:choose>
                                <iaixsl:when test="page/rma/@id">
                                    ...
                                    <iaixsl:attribute name="title">Click here to save changes in this complaint</iaixsl:attribute>
                                    Save changes
                                </iaixsl:when>
                                <iaixsl:otherwise>
                                    <iaixsl:attribute name="title">Click here to add a complaint</iaixsl:attribute>
                                    Add a complaint
                                </iaixsl:otherwise>
                            </iaixsl:choose>
