            ...
            <div class="step7">
                        ...
                        <div class="prepaid-buttons">
                            <iaixsl:if test="/shop/page/editlink/@url">
                                <a class="btn-icon prepaid-edit">
                                    <iaixsl:attribute name="title">Clik to modify complaint</iaixsl:attribute>
                                    <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/editlink/@url"/></iaixsl:attribute><small><i class="icon-pencil"></i></small><span>Modify complaint</span></a>
                            </iaixsl:if>
                            <iaixsl:if test="/shop/page/cancellink/@url">
                                <a class="btn-icon prepaid-cancel orderdetails_info_cancel">
                                    <iaixsl:attribute name="onclick">return confirm('Cancellation of the complaint can not be undone. To continue, press "Cancel the complaint."')</iaixsl:attribute>
                                    <iaixsl:attribute name="title">Cancel the complaint</iaixsl:attribute>
                                    <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/cancellink/@url"/></iaixsl:attribute>
                                    <small><i class="icon-remove"></i></small><span>Cancel the complaint</span>
                                </a>
                            </iaixsl:if>
                        </div>
                    </div>
                ...
                <iaixsl:choose>
                    <iaixsl:when test="/shop/page/return_method/@id='2' and $n5_4atxt">
                        <div class="return_image_i">
                            <div class="text-1a">Print a return form and labels</div>
                            <div class="text-2a">Prepare a parcel <small>Attach a return form and a proof of purchase</small></div>
                    ...
                    <iaixsl:otherwise>
                        <div class="return_image_i">
                            <div class="text-1">Print a return form and a label</div>
                            <div class="text-2">Prepare a parcel <small>Attach a return form and a proof of purchase</small></div>
                ...
                <iaixsl:if test="page/returnproducts/products/product">
                    ...
                    <div id="prepaid_order_products">
                        <h2 class="big_label">Products in complaint</h2>
                ...
                <iaixsl:if test="/shop/page/repayment_method or /shop/page/return_method">
                    <div class="returns_details_wrapper">
                        <table class="returns_details_table">
                            <tbody>
                                <tr>
                                    <th class="returns_details_name">Return and refund methods
                                    </th>
...
<iaixsl:when test="/shop/page/return_method/@description">
                                                    <span class="product_name">Return method:
                                                        <iaixsl:value-of select="/shop/page/return_method/@name"/>
                                                    </span>
                                                ...
                                                <iaixsl:when test="/shop/page/return_method/@id = 1">
                                                    ...
                                                    <div class="return_description">
                                                        I commit myself to deliver the parcel personally to a selected return acceptance point.
                                                    </div>
                                                </iaixsl:when>
                                        ...
                                        <td class="returns_details_name float_icon">
                                            ...
                                            <iaixsl:choose>
                                                <iaixsl:when test="/shop/page/repayment_method/@id = 't'">
                                                    <span class="product_name">The refund method: Customer balance</span>

                                                    <div class="return_description">
                                                        I want the refund to be added to my customer balance so I can use it with future orders.
                                                    </div>

                                                </iaixsl:when>
                                                <iaixsl:when test="/shop/page/repayment_method/@id = 'b'">
                                                    <span class="product_name">The refund method: Wire transfer</span>
                                                    <div class="return_description">
                                                ...
                                                <iaixsl:when test="/shop/page/repayment_method/@id = 'tc'">
                                                    <span class="product_name">The refund method: Restore a trade credit</span>
                                                    <div class="return_description">
                                                        The refund will be added to your customer balance in a form of a trade credit.
                                                    </div>
                                                </iaixsl:when>
                                                <iaixsl:otherwise>
                                                    <span class="product_name">
                ...
                <iaixsl:if test="/shop/page/remarks">
                    <div class="returns_details_wrapper">
                        <h2 class="big_label">Comments to the return
                        </h2>
            ...
            <div class="prepaid_summary_buttons">
                ...
                <iaixsl:if test="page/backlink_other/@url">
                    <a class="btn --solid --medium">
                        ...
                        Add another complaint in current order
                    </a>
                </iaixsl:if>
            </div>
        </iaixsl:if>
