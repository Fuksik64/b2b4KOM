            ...
            <div class="client_order">
                <iaixsl:choose>
                    <iaixsl:when test="page/orders/@mode = 'rma'">
                        <div class="progress_bar_wrapper pb_step1 rma_progress_bar">
                            ...
                            <div class="_step _step2">
                                ...
                                <p>
                                    <i/>
                                    <b>Choose products</b> to be returned
                                </p>
                            </div>
                            ...
                            <div class="_step _step5">
                                ...
                                <p>
                                    <i/>
                                    <b>Choose a method</b> of a refund
                                </p>
                            </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
                            <h1 class="big_label">
                                Choose an order in which you want to create a product complaint.
                            </h1>
                        </div>
                    </iaixsl:when>
                    <iaixsl:when test="page/orders/@mode = 'returns'">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
                            <h1 class="big_label">
                                Choose the order from which you want to return products
                            </h1>
                        </div>
                    </iaixsl:when>
                    <iaixsl:when test="page/orders/@mode = 'closed'">
                        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
                            ...
                            <a href="client-orders.php?display=opened" class="btn --solid --medium mt-2">
                                ...
                                List of orders currently in progress
                            </a>
                        </div>
                    </iaixsl:when>
                    <iaixsl:otherwise>
                ...
                <iaixsl:choose>
                                            ...
                                            <td>
                                                <iaixsl:choose>
                                                    ...
                                                    <iaixsl:when test="@paymentstatus = 'g' and (@paid and (number(@cost) > number(@paid)))">
                                                        ...
                                                        pay the remaining amount with  cash on delivery<br/>
                                                                ...
                                                                <iaixsl:when test="@prepaid > 0">
                                                                    ...
                                                                    <iaixsl:choose>
                                                                        ...
                                                                        <iaixsl:when test="@prepaidstatus ='n'">
                                                                            <iaixsl:choose>
                                                                                <iaixsl:when test="@paid and (number(@cost) > number(@paid))">
                                                                                    pay the remaining amout for the order
                                                                                </iaixsl:when>
                                                                                <iaixsl:otherwise>
                                                                                    unpaid
                                                                                </iaixsl:otherwise>
                                                                        ...
                                                                        <iaixsl:when test="@prepaidstatus ='c'">
                                                                            waiting for unblocking the payment
                                                                        </iaixsl:when>
                                                                        ...
                                                                        <iaixsl:when test="@prepaidstatus ='z'">
                                                                            operations with payments have not been conducted
                                                                        </iaixsl:when>
                                                                    </iaixsl:choose>
                                            ...
                                            <div><iaixsl:attribute name="class">btn-icon prepaid-icon status-<iaixsl:value-of select="$status_order"/></iaixsl:attribute>
                                                <iaixsl:choose>
                                                    ...
                                                    <iaixsl:when test="$status_order = 't'">
                                                        <span><i class="icon-ok"></i></span>
                                                        <small><iaixsl:choose><iaixsl:when test="@personal_collection = 'yes'">received</iaixsl:when><iaixsl:otherwise>sent</iaixsl:otherwise></iaixsl:choose></small>
                                                    </iaixsl:when>
                                                    ...
                                                    <iaixsl:when test="$status_order = 'p'">
                                                        <span><i class="icon-ok"></i></span>
                                                        <small>ready to shipment / recieve</small>
                                                    </iaixsl:when>
                                                    ...
                                                    <iaixsl:when test="$status_order = 'w'">
                                                        <iaixsl:choose>
                                                            <iaixsl:when test="number(@paid) = number(@cost)">
                                                                <span><i class="icon-clock"></i></span>
                                                                <small>awaiting further actions</small>
                                                            </iaixsl:when>
                                                            <iaixsl:when test="number(@paid) > 0">
                                                                <span><i class="icon-money"></i></span>
                                                                <small>awaiting further processing</small>
                                                            </iaixsl:when>
                                                            <iaixsl:otherwise>
                                                                <span><i class="icon-pause"></i></span>
                                        ...
                                        <td>
                                            <iaixsl:choose>
                                                <iaixsl:when test="@returns_url">
                                                    <a class="btn --icon-left icon-plus --medium see_button pr-0"><iaixsl:attribute name="href"><iaixsl:value-of select="@returns_url"/></iaixsl:attribute><span><i class='icon-plus'></i></span><small>add a return</small></a>
                                                </iaixsl:when>
                                                <iaixsl:when test="@rma_url">
                                                    <a class="btn --icon-left icon-plus --medium see_button pr-0"><iaixsl:attribute name="href"><iaixsl:value-of select="@rma_url"/></iaixsl:attribute><span><i class='icon-plus'></i></span><small>Choose</small></a>
                                                </iaixsl:when>
                                                <iaixsl:otherwise>
                                                    <a class="btn --icon-left icon-plus --medium see_button pr-0"><iaixsl:attribute name="href"><iaixsl:value-of select="@orderdetails"/></iaixsl:attribute><span><i class='icon-plus'></i></span><small>more...</small></a>
                                                </iaixsl:otherwise>
                                            </iaixsl:choose>
                                        </td>
                                    </tr>
                    ...
                    <iaixsl:otherwise>
                        <div class="client_orders_null">
                            <iaixsl:choose>
                                <iaixsl:when test="page/orders/@mode = 'rma'">
                                    Currently you do not have any orders subject to complaint.
                                </iaixsl:when>
                                <iaixsl:when test="page/orders/@mode = 'returns'">
                                    Currently you do not have any orders which can be returned.
                                </iaixsl:when>
                                <iaixsl:when test="page/orders/@mode = 'closed'">
                                    Currently you do not have any handled orders.
                                </iaixsl:when>
                                <iaixsl:otherwise>
                                    Currently you do not have any orders being processed.
                                </iaixsl:otherwise>
                            </iaixsl:choose>
                        </div>
