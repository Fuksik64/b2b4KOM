                  ...
                  <iaixsl:attribute name="class">basketedit_productslist <iaixsl:if test="not(/shop/page/basket-details/product/size/@type != 'uniw')">nosizesbasket </iaixsl:if><iaixsl:if test="not(/shop/basket/@product_comment_active = 'y')">nocommentbasket</iaixsl:if></iaixsl:attribute>
										...
										<iaixsl:choose>
											...
											<iaixsl:otherwise>
												...
												<h2>
														Available in <strong class="basket__division_weeks"/><i class="icon-clock"/>
												</h2>
											...
											<div class="basket__division_option --not-divide">
												<div class="basket__division_group f-group --radio mb-0">
													...
													<label class="f-label basket__division_label" for="division_no"><strong>I will wait for the order to be completed.</strong><span class="basket__division_option_small d-block mt-1">The store will complete and ship all products from the order at once.</span>
														<div class="basket__division_option_info --not-divide mt-3 pt-2">Products with longer waiting times - ready to ship in <strong class="basket__division_weeks"/></div>
													</label>
												</div>
											</div>
                                            ...
                                            <iaixsl:for-each select="/shop/page/basket-details/summary/payment/instalment">
                                                <a class="instalment_payment_basket__element --link">
                                                    ...
                                                    <div class="instalment_payment_basket__img_container">
                                                        <img src="/gfx/eng/instalment_basket.svg?r=1600678618" class="instalment_payment_basket__img"/>
                                                    </div>
            ...
            <div id="menu_security_policy" class="menu_box">
                <iaixsl:choose>
                    ...
                    <iaixsl:otherwise>
                        ...
                        <div class="menu_sub_box">
                            <img src="/gfx/eng/iai_security.png?r=1600678618" alt="Idosell security badge"/>
