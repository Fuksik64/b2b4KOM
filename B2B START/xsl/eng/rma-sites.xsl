...
<iaixsl:if test="/shop/page/@cache_basket"/>
        ...
        <!--Rma punkty zwrotu CMS (rma_sites_cms, 85243.1)-->
    ...
    <!--Rma punkty zwrotu (rma_sites_form, 107861.1)-->


        <iaixsl:if test="page/@type = 'rma_products' and page/@display = 'stock'">
            <div class="step4a">
                <div class="progress_bar_wrapper pb_step4 rma_progress_bar">
                    ...
                    <div class="_step _step2">
                        ...
                        <p>
                            <i/>
                            <b>Select a product</b> to be returned
                        </p>
                    </div>
                ...
                <iaixsl:choose>
                    <iaixsl:when test="count(page/pickups/pickup) > 1">
                        <h1 class="big_label return_label">Select the return acceptance point address</h1>

                    </iaixsl:when>

                    <iaixsl:otherwise>

                        <h1 class="big_label return_label">Return acceptance point address</h1>
                    ...
                    <iaixsl:choose>
                        <iaixsl:when test="count(page/pickups/pickup) > 1">
                            <iaixsl:for-each select="page/pickups/pickup">
                                ...
                                <div class="pickupl_return">
                                    <iaixsl:if test="@checked = 'true'"><iaixsl:attribute name="class">pickupl_return active</iaixsl:attribute></iaixsl:if>

                                    <iaixsl:attribute name="id">ps_<iaixsl:value-of select="@value"/></iaixsl:attribute>

                                    <input style="display:none;" type="radio" name="stock">
                                    ...
                                    <div class="pickupl_return_sub">
                                        <div class="pickupl_return_header">
                                            <span class="pickupl_return_name"><iaixsl:value-of select="name"/></span>
                                        </div>
                                        <div class="pickupl_return_address">
                                            <span class="pickup_return_address" style="display:none"> <iaixsl:value-of select="address"/></span>
                                            <iaixsl:value-of select="address"/><span class="pickupl_return_city"><iaixsl:value-of select="zipcode"/><iaixsl:text> </iaixsl:text><iaixsl:value-of select="city"/></span>
                                        </div>
                                        <div class="pickupl_return_link">
                                            <a target="_blank">
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="link"/></iaixsl:attribute>
                                                <iaixsl:attribute name="title">more information about the point</iaixsl:attribute>
                                                more information
                                            </a>
                                        </div>
                                        <iaixsl:if test="info">
                                            <div class="pickupl_return_info">
                                ...
                                <div class="pickupl_return_one">
                                    ...
                                    <div class="pickupl_return_one_sub">
                                        ...
                                        <div class="pickupl_return_one_header">
                                            <span class="pickupl_return_one_name"><iaixsl:value-of select="name"/></span>
                                        </div>
                                        <div class="pickupl_return_one_address">

                                            <iaixsl:value-of select="address"/><iaixsl:text> </iaixsl:text>
                                            <span class="pickupl_return_one_city"><iaixsl:value-of select="zipcode"/><iaixsl:text> </iaixsl:text><iaixsl:value-of select="city"/></span>
                                        </div>
