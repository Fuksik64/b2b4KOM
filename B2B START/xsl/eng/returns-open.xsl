...
<iaixsl:if test="/shop/page/@cache_basket"/>
        ...
        <!--Returns Open Form (returns_open_form, 112619.1)-->
			<section class="returns_open mb-4">
				
				<h1 class="returns_open__label headline">
					<span class="returns_open__label_txt headline__name">Select the order from which you want to return products</span>
				</h1>

				
				<div class="returns_open__description menu_messages_message mb-4">
                    <iaixsl:choose>
                        <iaixsl:when test="/shop/page/returns-open/@returns_exist_link and not(/shop/page/returns-open/@returns_exist_link = '')">
                            A return has already been generated for this order. Please check the status of current requests or add another one from the return panel.
                        </iaixsl:when>
                        <iaixsl:when test="/shop/page/returns-open/@client = 'false' or /shop/page/returns-open/@client_orders = 'true'">
                            To return products, enter the order number in which they were sent (you will find it in the e-mail you received after placing the order) and the phone number or e-mail address.
                        </iaixsl:when>
                        <iaixsl:otherwise>
                            No order has been placed on this account. Therefore, you cannot start the complaint generation procedure. If you want to make a complaint about an order processed from another account or without registration, please fill in the form below.
                        </iaixsl:otherwise>
                    </iaixsl:choose>
				</div>
                ...
                <iaixsl:choose>
                    <iaixsl:when test="/shop/page/returns-open/@returns_exist_link and not(/shop/page/returns-open/@returns_exist_link = '')">
                        <div class="returns_open__exists d-flex align-items-center flex-column">
                            <a class="returns_open__exist btn --solid --medium mb-3">
                                <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/returns-open/@returns_exist_link"/></iaixsl:attribute>
                                Go to the return
                            </a>
                            <a class="returns_open__new btn --solid --medium mb-3">
                                <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/returns-open/@returns_new_link"/></iaixsl:attribute>
                                Submit a new return
                            </a>
                        </div>
                    </iaixsl:when>
                    <iaixsl:otherwise>
						<form action="/returns-open.php" method="post" class="returns_open__form row flex-column align-items-center mb-4" novalidate="novalidate">
							<div class="returns_open__inputs col-12 col-sm-7">
								
								<div class="f-group returns_open__number">
									<div class="f-feedback returns_open__feedback --number">
										<input id="returns_open__number_input" type="text" class="f-control --validate" name="id" required="required" minlength="1"/>
										<label for="returns_open__number_input" class="f-label">
											Order ID:
										</label>
								...
								<div class="f-group returns_open__email">
									<div class="f-feedback returns_open__feedback --email">
										<input id="returns_open__email_input" type="text" class="f-control --validate" name="contact_type" required="required" data-validate="phone email"/>
										<label for="returns_open__email_input" class="f-label">
							...
							<iaixsl:variable name="button_legend_returns_open"></iaixsl:variable>
							<div class="returns_open__submit col-12 col-sm-7 d-flex flex-column align-items-center">
								<button class="btn --solid --medium px-5 returns_open__button">
									Find an order
								</button>
								<iaixsl:if test="$button_legend_returns_open">
									<div class="returns_open__button_legend mt-2">
										<iaixsl:value-of select="$button_legend_returns_open"/>
									</div>
								</iaixsl:if>
							</div>
						</form>
						...
						<div class="returns_open__signin d-flex justify-content-center">
							<a class="returns_open__signin_link">
								<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/clientOrders/@url"/></iaixsl:attribute>
								I have a registered account and want to go to the list of my orders
							</a>
						</div>
					</iaixsl:otherwise>
				</iaixsl:choose>
