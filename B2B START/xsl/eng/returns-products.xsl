...
<div class="step2">
        ...
        <h1 class="big_label return_label">Select products for the return</h1>
        ...
        <iaixsl:variable name="required_from_special_offer"><span>This product price had an impact</span> on the price of other products in the basket</iaixsl:variable>
        ...
        <iaixsl:if test="page/products">
            ...
            <iaixsl:variable name="allowReturnInfo">This product cannot be returned.</iaixsl:variable>
            <iaixsl:variable name="allowReturnInfoPoint">Since this product was purchased with points, it cannot be returned. </iaixsl:variable>
            <iaixsl:variable name="allowReturnInfoGratis">Since you received this product for free, it cannot be returned.</iaixsl:variable>
                            ...
                            <tr class="productslist_item">
                                ...
                                <td class="productslist_product_name">
                                    ...
                                    <iaixsl:if test="/shop/page/products/product/@required_from_special_offer = 'true' and $required_from_special_offer != ''">
                                        ...
                                        <div class="productslist_product_info">
                                            <iaixsl:attribute name="class">productslist_product_info visible-phone</iaixsl:attribute>
                                            <span>This product price had an impact</span> on the price of other products in the basket
                                        </div>
                                        </iaixsl:if>
                                    </iaixsl:if>
                                </td>
                            ...
                            <tr class="productslist_tools_bottom">
                                ...
                                <iaixsl:if test="/shop/page/products/product/@required_from_special_offer = 'true' and $required_from_special_offer != ''">
                                    ...
                                    <iaixsl:if test="not($allowReturnInfo) or ($allowReturnInfo and (count(/shop/page/products/product) - count(/shop/page/products/product[@allowReturn='0'])) > 1)">
                                        <a href="#selectall" class="btn --solid --icon-left icon-plus select_all">Select all</a>
                                    </iaixsl:if>
