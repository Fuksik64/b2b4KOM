    ...
    <div class="products_bought row" id="productpb_bought">
        ...
        <div id="pb_list" class="pb_list">
            <div class="pb_list_header row d-none d-md-flex">
                ...
                <div class="pb_header_date col-2"> Date of last purchase</div>
                ...
                <div class="pb_product">
                    ...
                    <div class="col-md-1 col-12 mb-3 mb-md-0">
                        <div class="pb_icon">
                            <a>
                                <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                                <img class="basket_prod rwd-src" alt="Szczegoly" src="/gfx/eng/loader.gif?r=1600678618">
                    ...
                    <div class="col-md-2 col-12 mb-3 mb-md-0">
                        <div class="pb_date">
                            <span class="d-block d-md-none"> Date of last purchase</span>
                            ...
                            <iaixsl:choose>
                                ...
                                <iaixsl:otherwise>
                                    <a class="btn --solid --medium">
                                        ...
                                        <iaixsl:attribute name="title">Add to basket</iaixsl:attribute>
                                        Add to basket
                                    </a>
                                </iaixsl:otherwise>
                            </iaixsl:choose>
