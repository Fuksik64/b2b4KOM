...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 107421.1)-->
        ...
        <!--Newsletter - formularz dodania/usunięcia adresu em (newsletter_form, 107875.1)-->
            <iaixsl:variable name="account_email_info">You are already subscribed to our newsletter. E-mail address assigned to your account is</iaixsl:variable>
            <div id="newsletter_form">
                    ...
                    <div class="newsletter_message_wrapper">
                        <div class="newsletter_message n54531_outline">
                            ...
                            <div class="n54531_outline_sub">
                                <iaixsl:choose>
                                    <iaixsl:when test="/shop/page/communicates_newsletter/message/@type = 'mailing_addsuccess'">Thank you for subscribing to our newsletter. Newsletters will be sent directly to your e-mail address. To make sure you get them all, we suggest adding our e-mail to your address book.</iaixsl:when>

                                    <iaixsl:when test="/shop/page/communicates_newsletter/message/@type = 'mailing_maileregerror'">Provided e-mail is incorrect.</iaixsl:when>

                                    <iaixsl:when test="/shop/page/communicates_newsletter/message/@type = 'mailing_removesuccess'">You have unsubscribed from our newsletter.</iaixsl:when>

                                    <iaixsl:when test="/shop/page/communicates_newsletter/message/@type = 'mailing_nosuchemail'">Provided e-mail has not been found in a newsletter database.</iaixsl:when>

                                    <iaixsl:when test="/shop/page/communicates_newsletter/message/@type = 'mailing_sendingconfirm'">Newsletter subscription confirmation link has been sent to the provided address.</iaixsl:when>

                                    <iaixsl:when test="/shop/page/communicates_newsletter/message/@type = 'mailing_emailexist'">Provided e-mail address is already in our database.</iaixsl:when>

                                    <iaixsl:when test="/shop/page/communicates_newsletter/message/@type = 'mailing_sendingconfirm_remove'">E-mail with the unsubscribe confirmation link has been sent to the provided address.</iaixsl:when>
                                </iaixsl:choose>
                            </div>
                        </div>
                    </div>
                ...
                <iaixsl:choose>
                    <iaixsl:when test="not(/shop/page/communicates_newsletter/message) or (/shop/page/communicates_newsletter/message/@type = 'mailing_maileregerror') or (/shop/page/communicates_newsletter/message/@type = 'mailing_emailexist') or (/shop/page/communicates_newsletter/message/@type = 'mailing_nosuchemail')">
                        <iaixsl:choose>
                                        ...
                                        <form action="/settings.php" method="post" class="newsletter_form row flex-column align-items-center">
                                            ...
                                            <iaixsl:choose>
                                                <iaixsl:when test="$account_email_info">
                                                    <p class="col-md-6 col-12">You are already subscribed to our newsletter. E-mail address assigned to your account is <b><iaixsl:value-of select="/shop/page/client/@email"/></b>.<br />You can unsubscribe at any moment by clicking on the button below.</p>
                                                </iaixsl:when>
                                                <iaixsl:otherwise>
                                                    <p class="col-md-6 col-12">You are already subscribed to our newsletter. You can unsubscribe at any moment by clicking on the button below.</p>
                                                </iaixsl:otherwise>
                                            </iaixsl:choose>
                                            ...
                                            <div class="newsletter_button_wrapper col-md-6 col-12">
                                                <button id="newsletter_button_remove" type="submit" class="btn --solid --secondary">
                                                    <iaixsl:attribute name="value">Unsubscribe</iaixsl:attribute>Unsubscribe
                                                </button>
                                            </div>
                                        </form>
                                    </iaixsl:when>
                                        ...
                                        <iaixsl:choose>
                                            ...
                                            <iaixsl:when test="/shop/page/client/@email != ''">
                                                <form action="/settings.php" method="post" class="newsletter_form row flex-column align-items-center">
                                                    ...
                                                    <p id="newsletter_longdesc" class="col-md-6 col-12">You are not subscribed to our newsletter. If you want to be informed about news and special offers in the shop, click on the button below. Newsletter will be sent to the address <strong><iaixsl:value-of select="page/client/@email"/></strong> which you have entered as your contact e-mail. If you want to change you contact e-mail, go to <a href="/loginedit.php?operation=edit">contact details edition</a></p>
                                                    <input name="mailing_email" type="hidden">
                                                        <iaixsl:attribute name="value"><iaixsl:value-of select="page/client/@email"/></iaixsl:attribute>
                                                    </input>
                                                        ...
                                                        <div class="has-feedback">
                                                            <label class="control-label d-flex align-items-center">
                                                                ...
                                                                <div class="text_to_left">
                                                                    I want to receive an e-mail newsletter. I consent to the processing of my personal data for marketing purposes in accordance with the <a><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/private_policy/@url"/></iaixsl:attribute>privacy policy</a>
                                                                </div>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="newsletter_button_wrapper col-md-6 col-12">
                                                        <button id="newsletter_button_add" type="submit" class="btn --solid">
                                                            <iaixsl:attribute name="value">Subscribe</iaixsl:attribute>Subscribe
                                                        </button>
                                                    </div>
                                                </form>
                                            </iaixsl:when>
                                            ...
                                            <iaixsl:otherwise>
                                                <form action="/settings.php" method="post" class="newsletter_form row flex-column align-items-center">
                                                    <input id="mailing_action_contact" name="mailing_action" value="add" type="hidden"/>
                                                    <p id="newsletter_longdesc" class="col-md-6 col-12">You are not subscribed to our newsletter. If you want to be informed about news and special offers in the shop, enter your e-mail address and click on the button below. The provided e-mail address will be added to the contact details in your profile. You can change it at any time, using <a href="/loginedit.php?operation=edit">contact details edition</a></p>
                            ...
                            <iaixsl:otherwise>
                                <form action="/settings.php" method="post" class="newsletter_form row flex-column align-items-center">
                                    <input id="mailing_action_contact" name="mailing_action" value="add" type="hidden"/>
                                    <p class="col-md-6 col-12">Enter your e-mail address and click on a proper button to subscribe or unsubscribe from our newsletter.</p>
                    ...
                    <iaixsl:otherwise>
                        <iaixsl:variable name="newsletter_mainpage_txt">Home page</iaixsl:variable>
