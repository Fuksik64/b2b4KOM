...
<!--Błędy i informacje w projektorze (menu_messages, 106608.1)-->
        ...
        <iaixsl:variable name="txt_68638_rpoz">If you pay for your order by </iaixsl:variable>
        <iaixsl:variable name="order_edit_button">Change order</iaixsl:variable>
        <iaixsl:variable name="hours_68242"> hours </iaixsl:variable>
        ...
        <iaixsl:variable name="n68313_order2_document_e_invoice">E-invoice</iaixsl:variable>
        ...
        <div class="n57856_order_overtaker">
            <form class="order2_form">
                ...
                <div class="big_label order2_info_label">
                    <span class="n57856_label" id="labels">Details:
                    </span>
                </div>
                        ...
                        <div class="order2_info1" id="order2_box_1">
                            <div class="order2_info1_sub">
                                ...
                                <iaixsl:if test="page/order2/orderclient/@nip">
                                    VAT Number:<iaixsl:value-of select="page/order2/orderclient/@nip"/><br/>
                                </iaixsl:if>
                                <iaixsl:if test="(page/order2/orderclient/@phone1) and not(page/order2/orderclient/@phone1 = '')">
                                    phone no.: <iaixsl:value-of select="page/order2/orderclient/@phone1"/><br/>
                                </iaixsl:if>
                            ...
                            <iaixsl:when test="page/order2/stock">
                                ...
                                <div class="order2_info1" id="order2_box_2b">
                                    <div class="order2_info1_sub"><p>
                                        ...
                                        <iaixsl:value-of select="page/order2/stock/@city"/> (<iaixsl:if test="page/order2/stock/@province"><iaixsl:value-of select="page/order2/stock/@province"/><iaixsl:text>, </iaixsl:text></iaixsl:if><iaixsl:value-of select="page/order2/deliveryaddress/@country_long"/>)<br/></p>
                                    </div>
                                    ...
                                    <iaixsl:if test="/shop/page/order2/stock/@other_stocks='true'">
                                        <a class="order2_button_change_stock d-none d-sm-inline-block btn --solid">
                                            <iaixsl:attribute name="href"><iaixsl:value-of select="page/order2/stock/@change_link"/></iaixsl:attribute>
                                            Change a personal collection point
                                        </a>
                                    </iaixsl:if>
                                </div>
                            </iaixsl:when>
                                ...
                                <div class="order2_info1" id="order2_box_2b">
                                    <div class="order2_info1_sub">
                                        ...
                                        <iaixsl:if test="page/order2/deliveryaddress/@phone and page/order2/deliveryaddress/@phone != ''">
                                            phone no.: <iaixsl:value-of select="page/order2/deliveryaddress/@phone"/><br/>
                                        </iaixsl:if>

                                    </div>
                                    <a class="order2_button_change_address d-none d-sm-inline-block btn --solid">
                                        <iaixsl:attribute name="href"><iaixsl:value-of select="page/order2/deliveryaddress/@changelink"/></iaixsl:attribute>
                                        change a delivery point
                                    </a>
                                </div>
                            </iaixsl:otherwise>
                        </iaixsl:choose>
                            ...
                            <div class="order2_info1_sub">
                                ...
                                <iaixsl:if test="page/order2/orderinvoice/@e_invoice='true' and $n68313_order2_document_e_invoice">
                                    ...
                                    <div id="e-invoice_dialog">
                                        <span class="big_label">Delivery of invoices in electronic form</span>
                                        <div>
                                            <span class="e-invoice_dialog"><font>Be eco-friendly</font> and receive your invoices faster</span>
                        ...
                        <div class="order2_info1_sub">
                                            ...
                                            <iaixsl:if test="/shop/basket/delivery_time/@days > 0">
                                                ...
                                                <iaixsl:choose>
                                                    <iaixsl:when test="/shop/basket/delivery_time/@days ='1'">
                                                        <iaixsl:choose><iaixsl:when test="(/shop/page/order2/orderdetails/@deliveryid = '0-0') or (/shop/page/order2/orderdetails/@deliveryid = '0-1')"></iaixsl:when><iaixsl:otherwise> day </iaixsl:otherwise></iaixsl:choose>
                                                    </iaixsl:when>
                                                    <iaixsl:otherwise>
                                                         days 
                                                    </iaixsl:otherwise>
                            ...
                            <iaixsl:if test="(page/order2/orderdetails/points/@debit) and (page/order2/orderdetails/points/@debit > 0)">
                                <div class="basketedit_summary_debit">
                                    After making a payment, you will gain 
                                    <iaixsl:value-of select="page/order2/orderdetails/points/@debit"/><span> pts </span> in Loyalty Program.
                ...
                <div class="order2_info comment_container clearfix">
                    ...
                    <a href="#toggleComments" id="toggle_comments_button" class="d-sm-none">Comments for the store and the courier</a>

                    <div class="order2_info_sub order_comments">
                        <h3 class="order2_info1">
                            Remarks to a shop staff:
                        </h3>
                                            ...
                                            <tr>
                                                ...
                                                <td class="order2_name">
                                                    ...
                                                    <iaixsl:if test="order_files/file">
                                                        <div class="order2_productlist_files">
                                                            <span class="n53330_projectorlink">Files added by you:</span>
                                                ...
                                                <td class="order2_price" data-mobile-class="hide">
                                                    <iaixsl:if test="@forpoints">
                                                        <iaixsl:value-of select="@points_for_one"/> pts
                                                    </iaixsl:if>
                                                ...
                                                <tr>
                                                    <td colspan="4">
                                                        <div class="order2_comment">
                                                            <span class="comment_label">Your remarks to this product:</span>
                            ...
                            <iaixsl:if test="page/order2/ordersproducts/product[@product_type = 'product_virtual']">
                                <div class="order2_products">
                                    <table class="order2_table">
                                        ...
                                        <tr>
                                            <th class="order2_name">
                                                Ordered <span class="product_virtual">digital files</span>
                                            </th>
                                            <th class="order2_price" data-mobile-class="hide">
                                                Unit price
                                            </th><iaixsl:if test="not(/shop/contact/owner/@vat_registered = 'false')">
                            ...
                            <iaixsl:if test="page/order2/ordersproducts/product[@product_type = 'product_service']">
                                <div class="order2_products">
                                    <table class="order2_table">
                                        ...
                                        <tr>
                                            <th class="order2_name">
                                                Ordered <span class="product_virtual">services</span>
                                            </th>
                                            <th class="order2_price" data-mobile-class="hide">
                                                Unit price
                                            </th><iaixsl:if test="not(/shop/contact/owner/@vat_registered = 'false')">
                                    ...
                                    <table class="order2_table">
                                            ...
                                            <th class="order2_name">
                                                ...
                                                <iaixsl:choose>
                                                    <iaixsl:when test="/shop/page/order2/insurance_product">
                                                        Delivery, payment and insurance
                                                    </iaixsl:when>
                                                    <iaixsl:otherwise>
                                        ...
                                        <tr>
                                            <td class="order2_name">
                                                ...
                                                <span class="order2_name">Delivery method: <iaixsl:value-of select="page/order2/orderdetails/@deliveryname"/>
                                                    <a class="order2_change_delivery_link" href="order1.php">change</a></span>
                                                        ...
                                                        <iaixsl:if test="not(page/order2/shipping/@hide_cost = 'true')">
                                                            ...
                                                            <iaixsl:choose>
                                                                <iaixsl:when test="page/order2/shipping/@cost_type = 'points'">
                                                                    ...
                                                                    <iaixsl:value-of select="page/order2/shipping/@points_cost"/> pts
                                                                </iaixsl:when>
                                                    ...
                                                    <div class="order2_delivery_info">
                                                        <iaixsl:choose>
                                                            ...
                                                            <iaixsl:when test="page/order2/orderdetails/@deliverytype = 'dvp' and page/order2/stock/@stock_id">
                                                                Pay to a shop assistant when collecting your parcel.
                                                            </iaixsl:when>
                                                            <iaixsl:when test="page/order2/orderdetails/@deliverytype = 'dvp'">
                                                                You will pay when the parcel is delivered
                                                            </iaixsl:when>
                                        ...
                                        <iaixsl:if test="/shop/page/order2/balance/@currency_value and /shop/page/order2/balance/@currency_value > 0">
                                            <tr>
                                                <td class="order2_name">
                                                    ...
                                                    <span class="order2_name">Paid from the balance (overpayment on a customer's account)</span>
                                        ...
                                        <iaixsl:if test="/shop/page/order2/insurance_product">
                                            <tr>
                                                <td class="order2_name">
                                                    ...
                                                    <span class="order2_name">Buyer Protection:<iaixsl:value-of select="/shop/page/order2/insurance_product/@service"/></span>
                            ...
                            <div class="order2_terms_wrapper">
                                ...
                                <div class="order2_terms_wrapper_sub">
                                    <label class="order2_terms_conditions">
                                        ...
                                        <i class="css-label"/>
                                        <span><i class="icon-need"></i>  I accept 
                                            <a target="_blank">
                                                <iaixsl:attribute name="title">Terms and Conditions
                                                </iaixsl:attribute>
                                                <iaixsl:attribute name="href">
                                ...
                                <iaixsl:if test="not($returns_agree_control)">
                                    <div class="order2_terms_wrapper_sub">
                                        <label class="order2_cancel">
                                            ...
                                            <i class="css-label"/>
                                            <span><i class="icon-need"></i>  I have acknowledged 
                                                <a target="_blank">
                                                    <iaixsl:attribute name="title">Withdrawal from the agreement
                                                    </iaixsl:attribute>
                                                    <iaixsl:attribute name="href">
                                                        <iaixsl:value-of select="/shop/action/order_cancel/@url"/>
                                                    </iaixsl:attribute>
                                                    my rights to withdraw from the agreement
                                                </a>
                                            </span>
                                        </label>
                                    </div>
                                ...
                                <iaixsl:if test="page/order2/ordersproducts//product[@product_type = 'product_virtual']">
                                    <div class="order2_terms_wrapper_sub virtual">
                                        <label class="order2_virtual">
                                            ...
                                            <i class="css-label"/>
                                            <span><i class="icon-need"></i>  I want immediate access to the digital content and I acknowledge that thereby I lose my right to cancel once the service has begun.</span>
                                        </label>
                                    </div>
                                </iaixsl:if>
                                ...
                                <iaixsl:if test="page/order2/ordersproducts//product[@product_type = 'product_service']">
                                    <div class="order2_terms_wrapper_sub service">
                                        <label class="order2_service">
                                            ...
                                            <i class="css-label"/>
                                            <span><i class="icon-need"></i>  I agree to the starting of the service and I acknowledge that I lose my right to cancel once the service has been fully performed.</span>
                                        </label>
                                    </div>
                                </iaixsl:if>
                            ...
                            <div class="basketedit_summary_buttons table_display">
                                ...
                                <div class="btn_wrapper">
                                    <input class="btn --solid --large order2_button_order terms_required" type="submit">
                                        ...
                                        <iaixsl:attribute name="value">Order with obligation to pay</iaixsl:attribute>
