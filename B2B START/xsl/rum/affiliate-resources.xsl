...
<iaixsl:choose>
    <iaixsl:when test="(0 > page/payments/@total) or (page/payments/@total = '0.00')">
        <span class="affiliate_noresources">There are no funds available on your account currently.</span>
    </iaixsl:when>
    <iaixsl:otherwise>
         <div class="affiliate_resources_wyplata">
            Balance of your affiliate account is
            <ol>
                <li>
                ...
                <li>
                    total amount of reduced commissions due to return of products: 
            ...
            <iaixsl:if test="page/client/@loyalty_points = 'true'">
                 The commission on orders from acquired customers is paid out as points to your <a href="/affiliate-main.php">balance in a loyalty programme</a>
            </iaixsl:if>
                If you wish to change your credit to a voucher, in this field enter a sum which should be no less than:  
                <span class="resources_minpayment">
                    <iaixsl:value-of select="page/shop/@minpayment"/><iaixsl:value-of select="/shop/currency/@name"/>
                </span>
                <span> and not more than the funds available on your account. Next, click on "Request commission payment ".</span>
                <form method="POST">
                    ...
                    <div class="affiliate_resources_payment">
                        <div class="affiliate_resources_payment_sub">
                            <span class="affiliate_resources_kwota_label">Amount to return </span>
                    ...
                    <div class="affiliate_resources_payment_type">
                        <iaixsl:choose>
                            ...
                            <iaixsl:otherwise>
                                This sum will be withdrawn as a voucher.
                            </iaixsl:otherwise>
                        </iaixsl:choose>
                    </div>
                    <input type="submit" class="btn --solid --medium affiliate_resources_submit" id="affiliate_resources_submit">
                                <iaixsl:attribute name="value">Request commission payment </iaixsl:attribute>
                    </input>
                </form>
        </div>
    </iaixsl:otherwise>
                    ...
                    <iaixsl:choose>
                      ...
                      <iaixsl:otherwise>                       
                        <div class="affiliate-icon-status badge-success">
                         ...
                         <span> 
                          Accepted <small>(<iaixsl:value-of select="@status"/>)</small>
                         </span> 
                      </iaixsl:otherwise>
                    </iaixsl:choose>
                  </div>
