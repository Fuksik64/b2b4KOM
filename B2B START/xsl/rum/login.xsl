...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 107421.1)-->
            ...
            <iaixsl:if test="(action/set_render/item/@name = 'popup') or not(action/set_render/item)">
                ...
                <script type="text/javascript" src="/gfx/rum/login.js.gzip?r=1571748615"></script></head>
    ...
    <!--Strona konta (login, 110574.1)-->
            ...
            <iaixsl:if test="(page/@type = 'login') and (page/login/@type='ok') and not(page/login/response)">
                ...
                <div id="login_menu" class="row">
                                    ...
                                    <div class="login_menu_sub col-12">
                                        ...
                                        <div class="balance_section">
                                            ...
                                            <iaixsl:if test="page/login/client/invoice_data/@account_number">
                                                <div class="login_point_count">
                                                <span>Your individual payment account:
                                                    <span class="btn_note"><i class="icon-question"></i></span><div class="tooltipContent"> This is your unique account number into which you can make order payments. This account belongs only to you, so even if you make a mistake and pay too much, the amount will be added to your balance. </div></span>
                    ...
                    <div class="login_menu_wrapper col-12">
                        <iaixsl:if test="(page/login/client_balance/balance/@value > 0) or (page/login/client_balance/limit/@value > 0) or (page/login/client/invoice_data/@account_number)">
                            <iaixsl:attribute name="class">login_menu_wrapper col-md-8 col-12</iaixsl:attribute>
                        </iaixsl:if>
                        ...
                        <iaixsl:if test="/shop/page/actions/products_wishes/@url or /shop/page/actions/products_requests/@url">
                            <div class="login_menu col-md-6 col-12" id="products_login">
                                <div class="login_menu_sub">
                                    <h3>
                                        <iaixsl:choose><iaixsl:when test="$iconsproducts"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsproducts"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="products" src="/gfx/rum/products.png?r=1571748615"/></iaixsl:otherwise></iaixsl:choose>
                                        PRODUCTS
                                    </h3>
                                    <div><span>View and edit your wishlist. You can also edit the list of products that you are looking for and would like to see in our shop.</span></div>
                        ...
                        <iaixsl:if test="/shop/page/actions/orders_opened/@url or /shop/page/actions/orders_closed/@url">
                            <div class="login_menu col-md-6 col-12" id="orders_login">
                                <div class="login_menu_sub">
                                    <h3>
                                        <iaixsl:choose><iaixsl:when test="$iconsorders"><i><iaixsl:attribute name="class"><iaixsl:value-of select="$iconsorders"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="orders" src="/gfx/rum/orders.png?r=1571748615"/></iaixsl:otherwise></iaixsl:choose>
                                        ORDERS
                                    </h3>
                        ...
                        <div class="login_menu col-md-6 col-12" id="client_cards">
                            <div class="login_menu_sub">
                                <h3>
                                    <iaixsl:choose><iaixsl:when test="$iconsprofit"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsprofit"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="profit" src="/gfx/rum/profity.png?r=1571748615"/></iaixsl:otherwise></iaixsl:choose>
                                    BENEFITS FOR BEING OUR LOYAL CUSTOMER 
                                </h3>
                        ...
                        <iaixsl:if test="/shop/page/actions/client_edit/@url">
                            <div class="login_menu col-md-6 col-12" id="dane_login">
                                <div class="login_menu_sub">
                                    <h3>
                                        <iaixsl:choose><iaixsl:when test="$iconseditdata"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconseditdata"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="editdata" src="/gfx/rum/editdata.png?r=1571748615"/></iaixsl:otherwise></iaixsl:choose>
                        ...
                        <div class="login_menu col-md-6 col-12" id="returns_login">
                            <div class="login_menu_sub">
                                <h3>
                                    <iaixsl:choose><iaixsl:when test="$iconsreturns"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsreturns"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="returns" src="/gfx/rum/returns.png?r=1571748615"/></iaixsl:otherwise></iaixsl:choose>
                                    RETURNS
                                </h3>
                        ...
                        <iaixsl:if test="/shop/rma/@active = 'y' and /shop/rma/@link">
                            <div class="login_menu col-md-6 col-12" id="rma_login">
                                <div class="login_menu_sub">
                                    <h3>
                                    <iaixsl:choose><iaixsl:when test="$iconsrma"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsrma"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="rma" src="/gfx/rum/rma.png?r=1571748615"/></iaixsl:otherwise></iaixsl:choose>
                        ...
                        <iaixsl:if test="(/shop/page/actions/client_rebate_points/@url and not(/shop/page/actions/client_rebate_points/@url='')) or /shop/page/actions/products_points/@available='true' or (/shop/page/actions/points_cms/@url and not(/shop/page/actions/points_cms/@url=''))">
                            <div class="login_menu col-md-6 col-12" id="points_login">
                                <div class="login_menu_sub">
                                    <h3>
                                        <iaixsl:choose><iaixsl:when test="$iconspoints"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconspoints"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="points" src="/gfx/rum/points.png?r=1571748615"/></iaixsl:otherwise></iaixsl:choose>
                                        LOYALTY PROGRAM
                                        <iaixsl:if test="/shop/basket/@client_points">
                                            <span>On your account you have <strong><iaixsl:value-of select="/shop/basket/@client_points"/> pts</strong></span>
                                        </iaixsl:if>
                                    </h3>
                        ...
                        <iaixsl:if test="/shop/page/affiliate and /shop/page/affiliate/@link">
                            <div class="login_menu col-md-6 col-12" id="affiliate_login">
                                <div class="login_menu_sub">
                                    <h3>
                                        <iaixsl:choose><iaixsl:when test="$iconsaffiliate"><i><iaixsl:attribute name="class"><iaixsl:value-of disable-output-escaping="yes" select="$iconsaffiliate"/></iaixsl:attribute></i></iaixsl:when><iaixsl:otherwise><img alt="affiliate" src="/gfx/rum/affiliate.png?r=1571748615"/></iaixsl:otherwise></iaixsl:choose>
                                        EARN WITH US
                                    </h3>
