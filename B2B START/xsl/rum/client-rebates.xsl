    ...
    <!--Rabaty klienta - informacje (client_rebates_info, 107782.1)-->
        ...
        <div id="client_rebates_info" class="n58425">
                ...
                <div class="form-code-card">
                    ...
                    <iaixsl:variable name="cardform">
                        <form class="rabat-code form-group" action="settings.php?from=client_rebate" method="post">
                            ...
                            <div class="has-feedback">
                                ...
                                <label class="control-label">Discount card number</label>
                            </div>
                            <button class="btn --large --solid" type="submit" value="">Activate</button>
                        </form>
                    </iaixsl:variable>
                    <iaixsl:variable name="codform">
                        <form class="rabat-card form-group" action="settings.php?from=client_rebate" method="post">
                            ...
                            <div class="has-feedback">
                                ...
                                <label class="control-label">Discount code number</label>
                            </div>
                            <button class="btn --large --solid" type="submit" value="">Activate</button>
                        </form>
                    </iaixsl:variable>
                                ...
                                <div class="col-sm-6 col-12">
                                    ...
                                    <iaixsl:if test="/shop/rebate_card_delete_client_advanced_rebate/@active = 'y' or /shop/rebate_card_delete_rebate_for_profit_points/@active = 'y' ">
                                        <div class="form-code-carsub_info">
                                            <span class="icon-stack"><i class="icon-sign-blank"></i><i class="icon-question icon-light"></i></span> Activating a discount card will cause any discounts already assigned to your account to be ignored for this order. 
                                        </div>
                                    </iaixsl:if>
                                </div>
                            </iaixsl:if>
                            ...
                            <iaixsl:if test="not(page/rebate_code/@type='rebate')">
                                <div class="col-sm-6 col-12">
                                    ...
                                    <iaixsl:if test="/shop/rebate_code_delete_client_advanced_rebate/@active = 'y' or /shop/rebate_code_delete_rebate_for_profit_points/@active = 'y' ">
                                        <div class="form-code-carsub_info">
                                            <span class="icon-stack"><i class="icon-sign-blank"></i><i class="icon-question icon-light"></i></span>  Activating a discount code will cause any discounts already assigned to your account to be ignored for this order. 
                                        </div>
                                    </iaixsl:if>
                                </div>
                            </iaixsl:if>
                    ...
                    <iaixsl:if test="page/rebate_code/@type='rebate'">
                        <div class="active-code-wrapper">
                            <h2 class="big_label">
                                Written discount code for this order
                            </h2>
                            <div class="active-code n67313_out">
                                ...
                                <div class="rabate-button">
                                    <a class="btn --solid" id="n67313_a_change_code" href="#">Change number</a>
                        ...
                        <div class="active-code-wrapper">
                            ...
                            <iaixsl:for-each select="/shop/page/discount_cards/item[@number = /shop/page/rebate_code[@type='card_discount']/@number]">
                                <div class="active-code n67313_out">
                                    ...
                                    <div class="rabate-button">
                                        <a class="btn --solid" id="n67313_a_change_cart" href="#">Change number</a>
                                    </div>
                                </div>
                            </iaixsl:for-each>
                        </div>
                                        ...
                                        <div class="active-code n67313_out">
                                            ...
                                            <div class="code-info">
                                                <ul class="code-details">
                                                    <iaixsl:if test="@number">
                                                        ...
                                                        <li>
                                                            <span>
                                                                Card expiration date<iaixsl:value-of select="@expires"/>
                                                            </span>
                                                        </li>
                                                    </iaixsl:if>
                                                </ul>
                                            ...
                                            <div class="rabate-form">
                                                <form class="rabat-code" action="settings.php?from=client_rebate" method="post">
                                                    ...
                                                    <button class="btn --solid" type="submit" value="">Active</button>
                                                </form>
                                            </div>
                                        </div>
                                    </iaixsl:if>
                                            ...
                                            <iaixsl:choose>
                                                <iaixsl:when test="@active = 'y'">
                                                    <b class="card-status-active">
                                                        <i class="icon-ok-sign"></i> active
                                                    </b>
                                                </iaixsl:when>
                                                <iaixsl:when test="@active = 'n'">
                                                    <b class="card-status-inactive">
                                                        <i class="icon-remove-sign"></i> inactive
                                                    </b>
                                                </iaixsl:when>
                                            </iaixsl:choose>
                                        </div>
            ...
            <iaixsl:if test="page/rebates/range_rebate/range and not(/shop/page/basket_rebate/range)">
                <div class="n67313_out">
                    <div class="n67313_label_b">
                        <span class="n67313_label_l">Threshold discount</span>
                        <div class="n67313_label_r">
                            Calculated from the value of products in a basket. 
                            <iaixsl:choose>
                    ...
                    <div class="n67313_border">
                        <div class="n67313_rebate_l">
                            Value of the order is more than
                            <span class="n67313_label_r">Discount value</span>
                            <iaixsl:if test="page/basket_rebate/range/@points != '0.00'">
                                <span class="n67313_label_r">Point bonus</span>
                            </iaixsl:if>
                        </div>
            ...
            <iaixsl:if test="page/global_rebate">
                <div class="n67313_out">
                    <div class="n67313_label_b">
                        <span class="n67313_label_l">Cumulative discount</span>
                        <div class="n67313_label_r">
                            <iaixsl:choose>
                                <iaixsl:when test="page/global_rebate/@order_days">
                                    Calculated from the value of products purchased in the last<iaixsl:value-of disable-output-escaping="yes" select="page/global_rebate/@order_days"/> days.
                                </iaixsl:when>
                                <iaixsl:otherwise>
                                    Calculated from the value of the earlier-purchased products<br />
                                </iaixsl:otherwise>
                            </iaixsl:choose>
                            <iaixsl:choose>
                    ...
                    <div class="n67313_border">
                        <div class="n67313_rebate_l">
                            Value of the order is more than<span class="n67313_label_r">Discount value</span>
            ...
            <iaixsl:choose>
                <iaixsl:when test="page/rebates/@type = 'r'">
                    ...
                    <iaixsl:if test="not(page/rebates/other/@value = '0.00')">
                        <div class="n67313_out">
                            <div class="n67313_label_b">
                                <span class="n67313_label_l">General discount</span>
                            </div>
                            <div class="n67313_border">
                                <iaixsl:if test="not(page/rebates/other/@value = '0.00')">
                                    <div class="n67313_rebate_l">
                                        On the entire assortment
                                    </div>
                ...
                <iaixsl:when test="(page/rebates/@type = 'z') and ((page/rebates/category) or (page/rebates/producer) or (page/rebates/series))">
                    <div class="n67313_out">
                        <iaixsl:if test="(page/rebates/category) or (page/rebates/producer) or (page/rebates/series)">
                            <div class="n67313_label_b">
                                <span class="n67313_label_l">Group discount</span>
                                <div class="n67313_label_r">
                                    Group discounts do not sum up. Only the one with the highest value is considered.
                                </div>
                            </div>
                        </iaixsl:if>
                        <div class="n67313_border">
                    ...
                    <iaixsl:if test="page/rebates/product">
                        <div class="n67313_out">
                            <div class="n67313_label_b">
                                <span class="n67313_label_l">Specific discount</span>
                                <iaixsl:choose>
                                    <iaixsl:when test="((page/rebates/category) or (page/rebates/producer) or (page/rebates/series)) and ((page/rebates/other) and not(page/rebates/other/@value = '0.00'))">
                                        <div class="n67313_label_r">
                                            Specific discount overrides general and group discounts.
                                        </div>
                                    </iaixsl:when>
                                    <iaixsl:when test="((page/rebates/category) or (page/rebates/producer) or (page/rebates/series)) and not((page/rebates/other) and not(page/rebates/other/@value = '0.00'))">
                                        <div class="n67313_label_r">
                                            Specific discount overrides group discount.
                                        </div>
                                    </iaixsl:when>
                                    <iaixsl:when test="((page/rebates/other) and not(page/rebates/other/@value = '0.00')) and not(page/rebates/category) and not(page/rebates/producer) and not(page/rebates/series)">
                                        <div class="n67313_label_r">
                                            Specific discount overrides general discount.
                                        </div>
                                    </iaixsl:when>
                                </iaixsl:choose>
                            </div>
                ...
                <iaixsl:when test="(page/rebates/@type = 'p' or page/rebates/@type = 'z') and (page/rebates/other/@value = '0.00') and (page/rebates/global/@value = '0.00') and (page/rebates_codes/@active = 'n')">
                    <div class="n67313_norabate">
                        You have no discount currently. Please familiarize yourself with   <a href="/terms.php">
                        terms and conditions, and discount thresholds
                    </a>
                        in our store
                    </div>
                </iaixsl:when>
            ...
            <iaixsl:if test="page/rebate_code/@active = 'y' or page/rebates_for_points/rebate">
                ...
                <div class="n67313_out">
                    ...
                    <iaixsl:if test="page/rebates_for_points/rebate">
                        ...
                        <div class="n67313_rebate_l">Change points to a discount</div>
                                        ...
                                        <div class="for_points_wrapper col-lg-3 col-sm-4 col-12">
                                            <a class="for_points">
                                                ...
                                                <iaixsl:if test="/shop/rebate_for_profit_points_delete_client_advanced_rebate/@active = 'y'">
                                                    <iaixsl:attribute name="title">After points are changed to a discount, a discount assigned to your account will be deleted.</iaixsl:attribute>
                                            ...
                                            <div class="n67313_other_info">
                                                <iaixsl:choose>
                                                    <iaixsl:when test="@calculate_from_price='client_price' and @price_type='net'">
                                                        Discount is calculated from the price
                                                    </iaixsl:when>
                                                    <iaixsl:when test="@calculate_from_price='suggested_retail_price'">
                                                        Discount is calculated from the recommended retail price
                                                    </iaixsl:when>
                                                    <iaixsl:when test="@calculate_from_price='crossed_out_price'">
                                                        Discount is calculated from the crossed-out price
                                                    </iaixsl:when>
                                                </iaixsl:choose>
                                                <iaixsl:choose>
                                ...
                                <div class="n67313_rebate_info">
                                    ...
                                    <iaixsl:choose>
                                        <iaixsl:when test="page/rebate_code/shipping_cost_rebate/@price_type='net'">
                                            <div class="n67313_other_info">
                                                Discount on delivery costs is calculated from the net price
                                            </div>
                                        </iaixsl:when>
                                    </iaixsl:choose>
                                </div>
