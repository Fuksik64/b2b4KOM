...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 107421.1)-->
            ...
            <iaixsl:if test="(action/set_render/item/@name = 'popup') or not(action/set_render/item)">
                ...
                <script type="text/javascript" src="/gfx/rum/search_gallery.js.gzip?r=1571748615"></script></head>
                ...
                <iaixsl:choose>
                    ...
                    <iaixsl:when test="navigation/descendant::item[@ni=/shop/navigation/current/@ni] and not(navigation/descendant::item[@ni=/shop/navigation/current/@ni]/item) and page/@type='search'">
                        <iaixsl:choose>
                            ...
                            <iaixsl:otherwise>
                                <a class="menu_categories_label" href="/categories.php">Categories</a>
                            </iaixsl:otherwise>
                        </iaixsl:choose>   
                        <ul>
                            <iaixsl:for-each select="navigation/descendant::item[@ni=/shop/navigation/current/@ni]/../item">
                    ...
                    <form class="filters__form" method="get">
                                            ...
                                            <div class="filters__content --search">
                                                <div class="f-group mb-0">
                                                    <input type="text" class="f-control --search_by_text __serialize">
                                                        ...
                                                        <iaixsl:attribute name="placeholder">Enter a search phrase</iaixsl:attribute>
                                                    </input>
                                                    ...
                                                    <li class="filters__item mb-2">
                                                        <div class="f-group --small --checkbox mb-0">
                                                            ...
                                                            <label class="f-label">
                                                                ...
                                                                <span class="--name">
                                                                    <iaixsl:choose>
                                                                        <iaixsl:when test="@desc = '1week'">Last week</iaixsl:when>
                                                                        <iaixsl:when test="@desc = '1month'">Last month</iaixsl:when>
                                                                        <iaixsl:when test="@desc = '3months'">Last 3 months</iaixsl:when>
                                                                        <iaixsl:when test="@desc = '6months'">Last 6 months</iaixsl:when>
                                                                        <iaixsl:when test="@desc = '1year'">Last year</iaixsl:when>
                                                                    </iaixsl:choose>
                                                                </span>
                        ...
                        <div class="f-group filters__buttons mt-3">
                            ...
                            <button type="submit" class="btn --large --solid d-block">
                                <iaixsl:attribute name="title">Apply selected filters</iaixsl:attribute>
                            ...
                            <iaixsl:if test="(/shop/page/products/navigation/filtering/filter/item/@selected='selected') or count(/shop/page/products/navigation/filtering/filter/@selected)">
                                <a class="btn d-block" href="/settings.php?filter_remove=all">
                                    ...
                                    <iaixsl:attribute name="title">Remove all filters</iaixsl:attribute>
        ...
        <div class="search_categoriesdescription">
            ...
            <span class="navigation_total">
                ...
                <iaixsl:value-of select="page/products/navigation/@total"/></b> )
            </span>
            </iaixsl:if>
    ...
    <!--Stronicowanie wyników (search_paging, 110683.1)-->
        ...
        <iaixsl:variable name="next_page">Next page</iaixsl:variable>
        ...
        <iaixsl:if test="not(page/products/@hideproducts = 'true') or count(/shop/page/products/display_mode/item) > 1">
            <div id="paging_setting_top" class="s_paging">
                ...
                <iaixsl:if test="count(/shop/page/products/display_mode/item) > 1">
                    <div class="s_paging__item --mode mb-2 mb-sm-3">
                        <iaixsl:for-each select="/shop/page/products/display_mode/item">
                            <iaixsl:if test="@mode = 'list'">
                                <div class="s_paging__display --quick">
                                    <a class="btn --outline --icon-left quick_buy mr-2 mr-sm-3">
                                        <iaixsl:if test="../@active = @mode">
                                            <iaixsl:attribute name="data-active">true</iaixsl:attribute>
                                        </iaixsl:if>

                                        <iaixsl:choose>
                                            <iaixsl:when test="../@active = @mode">
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/products/display_mode/item[@mode = 'normal']/@link"/></iaixsl:attribute>
                                            </iaixsl:when>
                                            <iaixsl:otherwise>
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                                            </iaixsl:otherwise>
                        ...
                        <div class="s_paging__display --view">
                            <span class="s_paging__text">
                                Views
                            </span>
                            <div class="s_paging__link">
                                <iaixsl:for-each select="/shop/page/products/display_mode/item">
                                    <iaixsl:if test="not(@mode = 'list')">
                                        <a class="btn --outline view_link">
                                            <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                                            <iaixsl:attribute name="data-mode"><iaixsl:value-of select="@mode"/></iaixsl:attribute>
                                            <iaixsl:if test="../@active = @mode">
                                                <iaixsl:attribute name="data-active">true</iaixsl:attribute>
                                            </iaixsl:if>

                                            <iaixsl:choose>
                                                <iaixsl:when test="@mode = 'normal'">
                                                    <i class="icon-th-large"></i>
                                                </iaixsl:when>
                                                <iaixsl:when test="@mode = 'gallery'">
                    ...
                    <iaixsl:if test="not(/shop/page/products/navigation/@disable_sort_change = 'y')">
                        <form class="s_paging__item --sort" action="/settings.php">
                            ...
                            <select class="s_paging__select --order --small-md" id="select_top_sort" name="sort_order">
                                <option value="name-a" class="option_name-a"><iaixsl:if test="page/products/navigation/@sort = 'name' and page/products/navigation/@order = 'a'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>Sort by name - ascending</option>
                                <option value="name-d" class="option_name-d"><iaixsl:if test="page/products/navigation/@sort = 'name' and page/products/navigation/@order = 'd'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>Sort by  name - descending</option>
                                <option value="price-a" class="option_price-a"><iaixsl:if test="page/products/navigation/@sort = 'price' and page/products/navigation/@order = 'a'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>Sort by price - ascending</option>
                                <option value="price-d" class="option_price-d"><iaixsl:if test="page/products/navigation/@sort = 'price' and page/products/navigation/@order = 'd'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>Sort by price - descending</option>
                                <option value="date-a" class="option_date-a"><iaixsl:if test="page/products/navigation/@sort = 'date' and page/products/navigation/@order = 'a'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>Sort by date - ascending</option>
                                <option value="date-d" class="option_date-d"><iaixsl:if test="page/products/navigation/@sort = 'date' and page/products/navigation/@order = 'd'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>Sort by date - descending</option>
                            </select>
                        </form>
                    </iaixsl:if>
                        ...
                        <form class="s_paging__item --portions d-none d-md-block" action="/settings.php">
                            ...
                            <select class="s_paging__select --portions --small-md" id="select_top_portions" name="portions">
                                <iaixsl:for-each select="page/products/navigation/portions">
                                    <option><iaixsl:attribute name="value"><iaixsl:value-of select="@counter"/></iaixsl:attribute><iaixsl:if test="@selected = 'true'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>View <iaixsl:value-of select="@counter"/>
                                    </option>
                                </iaixsl:for-each>
                            </select>
                        </form>
    ...
    <!--Lista produktów (search, 110513.1)-->
                    ...
                    <iaixsl:for-each select="/shop/page/products/product">
                        <div class="product_wrapper col-6 col-sm-4">
                            ...
                            <a class="product-icon align_row" data-align="img#css">
                                ...
                                <img class="b-lazy" src="/gfx/rum/loader.gif?r=1571748615">
                            ...
                            <iaixsl:variable name="net_price"></iaixsl:variable>
                            <iaixsl:choose>
                                
                                <iaixsl:when test="$net_price and not($net_price = '')">
                                    <div class="product_prices">
                                        <iaixsl:choose>
                                                ...
                                                <iaixsl:if test="(sizes/prices/@size_min_maxprice_net_formatted != sizes/prices/@size_max_maxprice_net_formatted) or (sizes/prices/@size_min_maxprice_unit_formatted != sizes/prices/@size_max_maxprice_unit_formatted)">
                                                    <del class="max-price">
                                                        <iaixsl:choose>
                                                            ...
                                                            <iaixsl:otherwise>
                                                                <span><iaixsl:value-of select="sizes/prices/@size_min_maxprice_net_formatted"/></span><b> - </b><span><iaixsl:value-of select="sizes/prices/@size_max_maxprice_net_formatted"/></span>
                                                            </iaixsl:otherwise>
                                                        </iaixsl:choose>
                                                    </del>
                                                </iaixsl:if>
                                            </iaixsl:when>
                                            <iaixsl:when test="price/@price_net = 0 and not(/shop/basket/@wholesaler = 'true')">
                                                <a class="show_hurt_price" href="/login.php">
                                                    
                                                </a>
                                            </iaixsl:when>

                                            <iaixsl:when test="(sizes/prices/@minprice_net = 0) and not(price/@points)">
                                                <a class="fon_price" href="/contact.php">
                                            ...
                                            <iaixsl:otherwise>
                                                ...
                                                <iaixsl:if test="price/@points">
                                                    <span class="point-price"><iaixsl:value-of select="price/@points"/><span class="currency"> PTS</span></span>
                                                </iaixsl:if>
                                            </iaixsl:otherwise>
                                        </iaixsl:choose>

                                        <iaixsl:if test="price/@unit_converted_price_formatted"><small class="s_unit_converted_price"><iaixsl:value-of select="price/@unit_converted_price_formatted"/><iaixsl:text> / </iaixsl:text><iaixsl:value-of select="price/@unit_converted_format"/></small>
                                        </iaixsl:if>
                                    </div>
                                </iaixsl:when>
                            ...
                            <div class="search__compare">
                                <iaixsl:if test="/shop/compare/@active = 'y' and $addcompare_txt">
                                    <iaixsl:attribute name="class">search__compare --has-child</iaixsl:attribute>

                                    <iaixsl:choose>
                                        <iaixsl:when test="@id = /shop/compare/product/@id">
                                            <a class="search__compare_item --remove btn" rel="nofollow">
                                                ...
                                                <iaixsl:attribute name="title">Click to remove a product from comparison</iaixsl:attribute>
                                                - Remove from comparison
                                            </a>
                                        </iaixsl:when>
                                        <iaixsl:otherwise>
                                            <a class="search__compare_item --add btn" rel="nofollow">
                                                ...
                                                <iaixsl:attribute name="title">Click to add a product to compare</iaixsl:attribute>
        ...
        <!--Lista produktów jako galeria (search_gallery, 108230.1)-->
            <iaixsl:if test="/shop/page/products/display_mode/@active = 'gallery'">
                ...
                <iaixsl:variable name="count_unit"> pcs.</iaixsl:variable>
                    ...
                    <form action="/basketchange.php?type=multiproduct" method="post">
                                        ...
                                        <div class="info-item-wrapper">
                                            ...
                                            <iaixsl:if test="(firm/@name) and not(firm/@name = '') and (firm/@productslink)">
                                                <div class="info-item">
                                                    ...
                                                    <a class="info-value">
                                                        ...
                                                        <iaixsl:attribute name="title">See a producer's products  <iaixsl:value-of select="firm/@name"/></iaixsl:attribute>
                                            ...
                                            <iaixsl:if test="price/@unit_converted_price_net_formatted">
                                                <div class="info-item">
                                                    ...
                                                    <span class="info-value"><iaixsl:value-of select="price/@unit_converted_price_net_formatted"/>/<iaixsl:value-of select="price/@unit_converted_format"/><small> net</small></span>
                                                </div>
                                            </iaixsl:if>
                                            ...
                                            <iaixsl:if test="(price/@srp_net) and not(price/@srp_net = '')">
                                                <div class="info-item">
                                                    <span class="info-label">Suggested retail price</span>
                                                    <span class="info-value"><iaixsl:value-of select="price/@srp_net_formatted"/><small> net</small></span>
                                                </div>
                                            </iaixsl:if>
                                    ...
                                    <div class="search_list_buttons">
                                        ...
                                        <iaixsl:if test="traits/trait[not(@gfx)] or traits/trait[@gfx2]">
                                            <a href="#show_specification" class="btn_specification btn --outline --icon-right icon-angle-down">
                                                <iaixsl:attribute name="data-toggleTxt">Specification</iaixsl:attribute>
                                                Specification
                                            </a>
                                        </iaixsl:if>
                                    </div>
                                                            ...
                                                            <iaixsl:choose>
                                                                ...
                                                                <iaixsl:when test="(price/@value = 0) and (price/@points)">
                                                                    <div class="price_search_points">
                                                                        <label class="search_forpoints">
                                                                            ...
                                                                            </input><span> buy for <iaixsl:value-of select="price/@points"/> pts.</span>
                                                                        </label>
                                                                    </div>
                                                                </iaixsl:when>
                                                                ...
                                                                <iaixsl:otherwise>
                                                                    ...
                                                                    <iaixsl:if test="price/@price_formatted and /shop/client_data/@uses_vat = 'true'">
                                                                        ...
                                                                        <small> gross </small>)</span>
                                                                    </iaixsl:if>
                                                                    <iaixsl:if test="price/@price_net_formatted">
                                                                        
                                                                        <a class="shipping_info" target="blank" href="#shipping_info">
                                                                            <iaixsl:attribute name="title">Check shipping time and costs</iaixsl:attribute>
                                                                    ...
                                                                    <iaixsl:if test="price/@points">
                                                                        <div class="price_search_points">
                                                                            <span>or</span><label class="search_forpoints">
                                                                            <input type="checkbox" value="1">
                                                                                <iaixsl:attribute name="name">forpoints[<iaixsl:value-of select="$product_position"/><iaixsl:value-of select="position()"/>]</iaixsl:attribute>
                                                                            </input><span> buy for <iaixsl:value-of select="price/@points"/> pts.</span>
                                                                        </label>
                                                                    ...
                                                                    <iaixsl:if test="((@amount_wholesale) and not(@amount = @amount_wholesale))">
                                                                        <iaixsl:choose>
                                                                            <iaixsl:when test="sizes/size/@amount_wholesale = 0">
                                                                                <div class="price_detail_info">(Products available only in retail price)</div>
                                                                            </iaixsl:when>
                                                                            <iaixsl:otherwise>
                                                                                <div class="price_detail_info">
                                                                                    ...
                                                                                    <iaixsl:value-of select="@amount_wholesale"/><iaixsl:text> </iaixsl:text><iaixsl:value-of select="../@unit"/>
                                                                                     retail price 
                                                                                    <img class="search_detail_info_tip" src="/gfx/rum/help_tip.png?r=1571748615"/>)
                                                                                    <div class="tooltipContent">
                                                                                        Over 
                                                                                        <span><iaixsl:value-of select="@amount_wholesale"/><iaixsl:text> </iaixsl:text><iaixsl:value-of select="../@unit"/></span>
                                                                                         net price for each additional purchase <iaixsl:value-of select="../@unit"/>
                                                                                         is 
                                                        ...
                                                        <td class="search_rebate">
                                                            <iaixsl:if test="not((price/@value = 0) and (price/@points))">
                                                                <iaixsl:if test="price/rebateNumber/rebate">
                                                                    <div class="rabat btn --icon-left icon-plus showTip">Discount </div>
                                                                    <div class="tooltipContent">
                                                                ...
                                                                <iaixsl:choose>
                                                                    <iaixsl:when test="not(../../@product_type ='product_bundle')">
                                                                        <button class="search_buy">
                                                                            <iaixsl:attribute name="title">Add this product to basket</iaixsl:attribute>
                                                                        ...
                                                                        <iaixsl:choose>
                                                                            <iaixsl:when test="(../../bundled/product/sizes/size/@type !=  'uniw')">
                                                                                <a class="btn --solid search_see_bundle">
                                                                                    <iaixsl:attribute name="href"><iaixsl:value-of select="../../@link"/></iaixsl:attribute>
                                                                                    <iaixsl:attribute name="title">Go to information about a set</iaixsl:attribute>

                                                                                    Go to information about a set
                                                                                </a>
                                                                            </iaixsl:when>
                                                                            <iaixsl:otherwise>
                                                                                <button class="search_buy">
                                    ...
                                    <iaixsl:if test="count(sizes/size) > $sizes_hide_on">
                                        <iaixsl:if test="not(price/@value = 0 and not(/shop/basket/@wholesaler = 'true'))">
                                            <a href="#show_sizes" class="show_all_sizes btn --icon-right icon-angle-up pl-0">
                                                <iaixsl:attribute name="data-toggleTxt">Show all sizes</iaixsl:attribute>
                                                Hide sizes
                                            </a>
                                        </iaixsl:if>
                                    </iaixsl:if>
                        ...
                        <div id="search-total">
                            <button type="submit" class="btn --solid --large">
                                <iaixsl:attribute name="data-loadtxt">&lt;i class="icon-refresh icon-spin"&gt;&lt;/i&gt; Add selected to basket</iaixsl:attribute>
        ...
        <iaixsl:if test="/shop/page/products/display_mode/@active = 'list'">
            ...
            <form id="quick_buy" action="/basketchange.php?type=multiproduct" method="post">
                    ...
                    <iaixsl:for-each select="/shop/page/products/product">
                        ...
                        <tr>
                            ...
                            <td class="product-name-td">
                                <h3><a class="product-name">
                                    <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                                    <iaixsl:attribute name="title">Click to see the detailed description</iaixsl:attribute>
                                    <span><img><iaixsl:attribute name="alt"><iaixsl:value-of disable-output-escaping="yes" select="name/text()"/></iaixsl:attribute><iaixsl:attribute name="src"><iaixsl:value-of select="icon"/></iaixsl:attribute></img></span>
                                    <iaixsl:value-of disable-output-escaping="yes" select="name"/>
                                </a></h3>
                                <iaixsl:if test="not(sizes/@unit_sellby = '1')">
                                    <div class="info-item">
                                                ...
                                                <div class="col-lg-3 col-sm-4 col-12">
                                                    ...
                                                    <div class="size-price">
                                                        ...
                                                        <div class="price">
                                                            <iaixsl:choose>
                                                                <iaixsl:when test="price/@price_unit_net_formatted">
                                                                    <iaixsl:value-of select="price/@price_unit_net_formatted"/><iaixsl:text> / </iaixsl:text><iaixsl:value-of select="sizes/@unit_sellby"/><iaixsl:text> </iaixsl:text><iaixsl:value-of select="sizes/@unit"/><small> net </small>
                                                                </iaixsl:when>
                                                                <iaixsl:otherwise>
                                                                    <iaixsl:value-of select="price/@price_net_formatted"/><small> net </small>
                                                                </iaixsl:otherwise>
                                                            </iaixsl:choose>
                                                        </div>
                                                    </div>
                ...
                <div id="search-total">
                    <button type="submit" class="btn --solid --large">
                        <iaixsl:attribute name="data-loadtxt"></iaixsl:attribute>
                        Add selected to basket
                    </button>
                </div>
            </form>
        ...
        <iaixsl:variable name="next_page_bottom">Next page</iaixsl:variable>

        <iaixsl:if test="not(page/products/@hideproducts = 'true') or count(/shop/page/products/display_mode/item) > 1">
            <div id="paging_setting_bottom" class="s_paging">
                
                <iaixsl:if test="count(/shop/page/products/display_mode/item) > 1">
                    <div class="s_paging__item --mode mb-2 mb-sm-3 d-none d-md-flex">
                        <iaixsl:for-each select="/shop/page/products/display_mode/item">
                            <iaixsl:if test="@mode = 'list'">
                                <div class="s_paging__display --quick">
                                    <a class="btn --outline --icon-left quick_buy mr-2 mr-sm-3">
                ...
                <iaixsl:if test="not(page/products/@hideproducts = 'true')">
                    <iaixsl:if test="not(/shop/page/products/navigation/@disable_sort_change = 'y')">
                        <form class="s_paging__item --sort d-none d-md-block" action="/settings.php">
        ...
        <iaixsl:if test="page/products/additional/hotspot/products_zone1">
            <div class="main_hotspot container mb-4" id="search_hotspot_zone1">
                <iaixsl:if test="not(page/products/additional/hotspot/products_zone1/product)">
                        ...
                        <iaixsl:choose>
                            <iaixsl:when test="page/products/additional/hotspot/products_zone1/@link">
                                <h2><a class="big_label">
                                    <iaixsl:attribute name="href"><iaixsl:value-of select="page/products/additional/hotspot/products_zone1/@link"/></iaixsl:attribute><iaixsl:attribute name="title">Click to see all products</iaixsl:attribute>
                                    <iaixsl:choose><iaixsl:when test="page/products/additional/hotspot/products_zone1/@name"><iaixsl:value-of select="page/products/additional/hotspot/products_zone1/@name"/></iaixsl:when><iaixsl:otherwise>Special offers</iaixsl:otherwise></iaixsl:choose>
...
<!--Menu powiadomienia (menu_notice, 107640.1)-->
        ...
        <!--Elementy dodawane dynamicznie (menu_dynamically_added_content, 106830.1)-->
            ...
            <script type="text/javascript" src="/gfx/rum/menu_filter.js.gzip?r=1571748615"></script>
            <script type="text/javascript" src="/gfx/rum/search_categoriesdescription.js.gzip?r=1571748615"></script>
            <script>
                app_shop.runApp();
            </script>
