...
<div id="account_icon"><a href="/login.php"><i class="icon-account"></i></a></div>
    ...
    <!--Błędy i informacje w projektorze (menu_messages, 106608.1)-->
        ...
        <iaixsl:if test="page/@type = 'basketedit'">
            <iaixsl:variable name="txt_50001_025a">Przed realizacją zamówienia z płatnością przy odbiorze wymagana jest zaliczka na ten produkt: </iaixsl:variable>
            ...
            <script class="ajaxLoad">
                var only_virtual_literal_1 = 'Pliki do pobrania pojawią się w dziale ';
                var only_virtual_literal_2 = ' w panelu klienta po zrealizowaniu całego zamówienia.';
            </script>
            ...
            <form class="basketedit_productslist" action="/basketchange.php?type=multiproduct" method="post">
                ...
                <div id="basketedit_productslist" class="basketedit_productslist">
                    <h2><iaixsl:attribute name="class">big_label</iaixsl:attribute>Lista produktów w koszyku</h2>
                    <table>
                        ...
                        <iaixsl:for-each select="page/basket-details/product">
                            <tr class="productslist_item">
                                                        ...
                                                        <iaixsl:when test="/shop/page/basket-details/summary/money/@advance_mode = 'default' or /shop/page/basket-details/summary/money/@advance_mode = 'none'">
                                                            <iaixsl:choose>
                                                                <iaixsl:when test="/shop/page/basket-details/summary/money/@cash_on_delivery = 'true' and /shop/page/basket-details/summary/money/@prepaid = 'false'">
                                                                    Przed realizacją zamówienia z płatnością przy odbiorze wymagana jest zaliczka na ten produkt: <iaixsl:value-of select="price/@advanceworth_formatted"/>
                                                                </iaixsl:when>
                                                                <iaixsl:when test="/shop/page/basket-details/summary/money/@cash_on_delivery = 'false' and /shop/page/basket-details/summary/money/@prepaid = 'true'">
                                                                    Przed realizacją zamówienia z płatnością za przedpłatą wymagana jest zaliczka na ten produkt: <iaixsl:value-of select="price/@advanceworth_formatted"/>
                                                                </iaixsl:when>
                                                                <iaixsl:when test="/shop/page/basket-details/summary/money/@cash_on_delivery = 'true' and /shop/page/basket-details/summary/money/@prepaid = 'true'">
                                                                    Przed realizacją zamówienia wymagana jest zaliczka na ten produkt: <iaixsl:value-of select="price/@advanceworth_formatted"/>
                                                                </iaixsl:when>
                                                            </iaixsl:choose>
                                                        </iaixsl:when>
                                ...
                                <iaixsl:if test="/shop/basket/@product_comment_active = 'y' and not(price/@special_offer='true')">
                                    <td class="productslist_product_comment">
                                        <a href="#addComment">
                                            ...
                                            <i class="icon-paper-clip"></i> dodaj opis <br/>lub załącznik
                                        </a>
                                    </td>
                                </iaixsl:if>
                                ...
                                <td class="productslist_product_calculate d-none d-sm-table-cell">
                                    <iaixsl:choose>
                                        <iaixsl:when test="price/@special_offer='true'">
                                            <span class="productslist_specialoffer"><i class="icon-ok-sign"></i>Oferta specjalna</span>
                                        </iaixsl:when>
                                        <iaixsl:otherwise>
                        ...
                        <div class="basketedit_summary_left">
                            ...
                            <iaixsl:if test="$txt_60826_advance_a and (/shop/page/basket-details/summary/money/@advance_mode = 'total' and /shop/page/basket-details/summary/money/@prepaid = 'true' and /shop/page/basket-details/summary/money/@advance > 0)">
                                <div class="summary_left_advance">
                                    ...
                                    Przed realizacją zamówienia z płatnością za przedpłatą wymagane jest wpłacenie zaliczki, na którą składa się część ceny produktów do sprowadzenia na zamówienie, całość ceny produktów dostępnych w naszych magazynach oraz koszt wysyłki wybranej w dalszym etapie procesu składania zamówienia.
                                </div>
                            </iaixsl:if>
            ...
            <div id="menu_security_policy" class="menu_box">
                <iaixsl:choose>
                    ...
                    <iaixsl:otherwise>
                        ...
                        <div class="menu_sub_box">
                            <img src="/gfx/pol/iai_security.png?r=1598273396" alt="Idosell security badge"/>
