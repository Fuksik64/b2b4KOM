...
<div id="account_icon"><a href="/login.php"><i class="icon-account"></i></a></div>
        ...
        <!--Karty stałego klienta - cms (client_cards_cms, 107770.1)-->
            <iaixsl:if test="page/text/body">
                <div class="client-cards_cms">
                    <div class="client-cards_cms_sub">
                        <iaixsl:value-of disable-output-escaping="yes" select="page/text/body"/>
                    </div>
                </div>
            </iaixsl:if>
        <!--Karty stałego klienta - informacje (client_cards_info, 107771.1)-->
			<iaixsl:choose>
				<iaixsl:when test="/shop/page/cards/item">
					<div id="client_cards">
						
						<h2>
							<iaixsl:attribute name="class">big_label</iaixsl:attribute>
							Przyznane karty stałego klienta:
						</h2>
						<table>
							<tr>
							...
							<tr>
								<td class="client_cards_expires">
									<iaixsl:value-of select="@expires"/>
								</td>
								<td class="client_cards_name">
									<iaixsl:value-of select="@name"/>
								</td>
								<td class="client_cards_number">
									<iaixsl:value-of select="@number"/>
								</td>
								<td class="client_cards_active">
									<iaixsl:choose>
						...
						<p>
							Aby sprawdzić jakie poziomy rabatów Ci przyznaliśmy, sprawdź w 
						<a href="client-rebate.php">Twoim panelu klienta stronę Rabat.</a>
						</p>
				...
				<iaixsl:otherwise>
					<div class="menu_messages_message">
                        Nie posiadasz kart stałego klienta
                    </div>
				</iaixsl:otherwise>
			</iaixsl:choose>
