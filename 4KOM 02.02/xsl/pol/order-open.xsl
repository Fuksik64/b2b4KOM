...
<div id="account_icon"><a href="/login.php"><i class="icon-account"></i></a></div>
        ...
        <div class="order_open_form_wrapper">
            ...
            <p>Aby sprawdzić status zamówienia, podaj jego numer (znajdziesz go w wiadomość e-mail, którą otrzymałeś po złożeniu zamówienia) oraz numer telefonu lub adres e-mail.</p>
            ...
            <a href="/login.php">Mam zarejestrowane konto i chcę przejść do listy swoich zamówień.</a>
