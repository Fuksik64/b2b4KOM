...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 107421.1)-->
            ...
            <iaixsl:if test="(action/set_render/item/@name = 'popup') or not(action/set_render/item)">
                ...
                <script src="/gfx/pol/pickup_sites_list.js.gzip?r=1598273396"></script></head>
...
<div id="account_icon"><a href="/login.php"><i class="icon-account"></i></a></div>
    ...
    <!--Błędy i informacje w projektorze (menu_messages, 106608.1)-->
        ...
        <iaixsl:variable name="mapLanguage">pol</iaixsl:variable>
        <iaixsl:variable name="mapCustomMarkers"></iaixsl:variable>
        <iaixsl:variable name="requires_client_number">Nr klienta w systemie kuriera:</iaixsl:variable>
        ...
        <iaixsl:if test="page/pickups">
            ...
            <div id="pickup_site">
                ...
                <img class="markerCluster" style="display:none;" src="/gfx/pol/m1.png?r=1598273396"/>
                <img class="markerCluster" style="display:none;" src="/gfx/pol/m2.png?r=1598273396"/>
                <img class="markerCluster" style="display:none;" src="/gfx/pol/m3.png?r=1598273396"/>
                <img class="markerCluster" style="display:none;" src="/gfx/pol/m4.png?r=1598273396"/>
                <img class="markerCluster" style="display:none;" src="/gfx/pol/m5.png?r=1598273396"/>
                <img class="marker_face" src="/gfx/pol/marker_face.png?r=1598273396"/>
                    ...
                    <iaixsl:choose>
                        <iaixsl:when test="/shop/page/pickups/deliveryaddress and /shop/page/pickups/google_api_key/@value and /shop/page/pickups/google_api_key/@value != ''">
                            <div class="locationField_sub">
                                <p class="pickup_list_desc">Wpisz adres i wyszukaj najbliższe punkty odbioru osobistego. Obok mapy, kliknij na jeden z punktów, aby wybrać odbiór zamówienia w tym miejscu.</p>
                                <div id="locationField">
                                    ...
                                    <a class="btn --solid --medium">
                                        <span class="d-none d-sm-inline">Szukaj punktów</span>
                    ...
                    <form id="pickup_list_form" method="post">
                                    ...
                                    <iaixsl:if test="/shop/page/pickups/deliveryaddress">
                                        <div class="map_button_search">
                                            <a href="#search_here" class="btn --solid --medium pickup_search_here">
                                                <iaixsl:attribute name="title">Kliknij, aby wyszukać punktów na tym obszarze</iaixsl:attribute>
                                    ...
                                    <div class="loadingMap">
                                        <div class="loadingContent">
                                            <div class="loadingBox">
                                                <span class="loadingMap">Ładowanie mapy</span>
                                                <span class="loadingNav">Ładowanie nawigacji</span>
                                                ...
                                                <img class="loadingMapImg" src="/gfx/pol/mapLoader.gif?r=1598273396"/>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div>
                                                ...
                                                <iaixsl:if test="requires_client_number/text() = 'true'">
                                                    <input type="text" name="client_courier_number" disabled="true" required="required">
                                                        <iaixsl:attribute name="placeholder">Nr klienta w systemie kuriera:</iaixsl:attribute>
                                                    </input>
                                                </iaixsl:if>
                                                <iaixsl:if test="info">
                                                            ...
                                                            <iaixsl:choose>
                                                                ...
                                                                <iaixsl:when test="delivery_time">
                                                                    ...
                                                                    <iaixsl:if test="delivery_time/@hour  > 0">
                                                                        <iaixsl:value-of select="delivery_time/@hour"/> godz. 
                                                                    </iaixsl:if>
                                                                ...
                                                                <iaixsl:when test="delivery_time/@days = '0'">
                                                                    <iaixsl:choose>
                                                                        ...
                                                                        <iaixsl:otherwise>
                                                                            Przygotowanie do odbioru osobistego zajmie <iaixsl:value-of select="delivery_time/@hour"/>
                                                                            <iaixsl:choose>
                                                                ...
                                                                <iaixsl:otherwise>
                                                                    Przygotowanie do odbioru osobistego zajmie <iaixsl:value-of select="delivery_time/@days"/>
                                                                    <iaixsl:choose>
                                                                        <iaixsl:when test="delivery_time/@days = '1'">
                                                                             dzień
                                                                        </iaixsl:when>
                        ...
                        <iaixsl:if test="page/order_calendar/@type = 't'">
                            <div class="pickupl_hour_wrapper">
                                <span>Możesz również podać preferowany przedział godzin</span>
                        ...
                        <div class="pickupl_submit">
                            ...
                            <p class="pickupl_back">Jeśli chcesz zmienić formę dostawy, wróć do <a id="pickup_site_back"><iaixsl:attribute name="href"><iaixsl:value-of select="page/pickups/@back"/></iaixsl:attribute><iaixsl:attribute name="title">Kliknij, by wrócić do wyboru dostawy i płatności</iaixsl:attribute>wyboru dostawy i płatności</a>.</p>
                        </div>
                    </form>
                </div>
