                        ...
                        <div class="order2_info1_sub">
                            ...
                            <iaixsl:if test="(page/order2/orderdetails/points/@debit) and (page/order2/orderdetails/points/@debit > 0)">
                                <div class="basketedit_summary_debit">
                                    ...
                                    <iaixsl:value-of select="page/order2/orderdetails/points/@debit"/><span> pkt. </span> w programie lojalnościowym.
                                                ...
                                                <td class="order2_name">
                                                    ...
                                                    <iaixsl:if test="order_files/file">
                                                        <div class="order2_productlist_files">
                                                            <span class="n53330_projectorlink">Dodane przez Ciebie pliki:</span>
                                                ...
                                                <tr>
                                                    <td colspan="4">
                                                        <div class="order2_comment">
                                                            <span class="comment_label">Wpisane przez Ciebie uwagi do tego produktu:</span>
                            ...
                            <iaixsl:if test="page/order2/ordersproducts/product[@product_type = 'product_virtual']">
                                <div class="order2_products">
                                    <table class="order2_table">
                                        ...
                                        <tr>
                                            <th class="order2_name">
                                                Zamowione <span class="product_virtual">produkty wirtualne</span>
                                            </th>
                                            <th class="order2_price" data-mobile-class="hide">
                                                Cena jedn.
                                            </th><iaixsl:if test="not(/shop/contact/owner/@vat_registered = 'false')">
                            ...
                            <iaixsl:if test="page/order2/ordersproducts/product[@product_type = 'product_service']">
                                <div class="order2_products">
                                    <table class="order2_table">
                                        ...
                                        <tr>
                                            <th class="order2_name">
                                                Zamowione <span class="product_virtual">usługi</span>
                                            </th>
                                            <th class="order2_price" data-mobile-class="hide">
                                                Cena jedn.
                                            </th><iaixsl:if test="not(/shop/contact/owner/@vat_registered = 'false')">
                                    ...
                                    <table class="order2_table">
                                        ...
                                        <tr>
                                            <td class="order2_name">
                                                ...
                                                <span class="order2_name">Forma dostawy: <iaixsl:value-of select="page/order2/orderdetails/@deliveryname"/>
                                                    <a class="order2_change_delivery_link" href="order1.php">zmień</a></span>
                                        ...
                                        <iaixsl:if test="not(page/order2/orderdetails/@deliverytype = 'prepaid' and page/order2/orderdetails/@payment_name = '') or (page/order2/orderdetails/@tradeCredit = 'y')">
                                            <tr>
                                                <td class="order2_name">
                                                    ...
                                                    <span class="order2_name"><iaixsl:choose><iaixsl:when test="page/order2/orderdetails/voucher/@value">Forma płatności: <iaixsl:value-of select="page/order2/orderdetails/@payment_name"/></iaixsl:when><iaixsl:when test="(page/order2/orderdetails/@deliverytype = 'prepaid') and (page/order2/orderdetails/@tradeCredit = 'y')">Forma płatności: kredyt kupiecki</iaixsl:when><iaixsl:when test="page/order2/orderdetails/@deliverytype = 'prepaid'">Forma płatności: <iaixsl:value-of select="page/order2/orderdetails/@payment_name"/></iaixsl:when><iaixsl:when test="page/order2/orderdetails/@deliverytype = 'dvp'">Forma płatności: Płatność przy odbiorze</iaixsl:when></iaixsl:choose>
                                                        ...
                                                        <iaixsl:if test="not(page/order2/orderdetails/@tradeCredit = 'y')">
                                                            <a class="order2_change_delivery_link" href="order1.php">zmień</a>
                                                        </iaixsl:if>
                                                    </span>
                                        ...
                                        <iaixsl:if test="/shop/page/order2/balance/@currency_value and /shop/page/order2/balance/@currency_value > 0">
                                            <tr>
                                                <td class="order2_name">
                                                    ...
                                                    <span class="order2_name">Opłacone z salda (nadpłaty na koncie klienta)</span>
                                        ...
                                        <iaixsl:if test="/shop/page/order2/insurance_product">
                                            <tr>
                                                <td class="order2_name">
                                                    ...
                                                    <span class="order2_name">Ochrona Kupującego: <iaixsl:value-of select="/shop/page/order2/insurance_product/@service"/></span>
