                ...
                <div class="main_hotspot mb-4" id="news_cms_associated">
                    <iaixsl:choose>
                        <iaixsl:when test="page/news/cms_products/@link">
                            <a class="big_label">
                                <iaixsl:attribute name="href"><iaixsl:value-of select="page/news/cms_products/@link"/></iaixsl:attribute><iaixsl:attribute name="title">Kliknij aby zobaczyć wszystkie produkty</iaixsl:attribute>
                                <iaixsl:choose><iaixsl:when test="page/news/cms_products/@name"><iaixsl:value-of select="page/news/cms_products/@name"/></iaixsl:when><iaixsl:otherwise>Polecane</iaixsl:otherwise></iaixsl:choose>
