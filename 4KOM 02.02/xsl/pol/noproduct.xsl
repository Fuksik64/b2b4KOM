        ...
        <iaixsl:choose>
                    ...
                    <div class="noproduct_form_sub">
                        <form id="noproduct_form" method="post" novalidate="novalidate">
                            ...
                            <div class="noproduct_form_desc">
                                Możesz skorzystać z poniższego formularza aby przesłać nam opis produktu, którego nie znalazłeś w naszym sklepie. Podaj nazwę produktu i/lub jego krótki opis, a my poinformujemy Cię o pojawieniu się produktu e-mailem.
                            </div>
                            ...
                            <div class="noproduct_form_submit">
                                <a class="btn --solid --large noproduct_form_submit mb-1">
                                    <iaixsl:attribute name="title">Kliknij, aby wysłać obsłudze sklepu informacje o szukanym produkcie</iaixsl:attribute>
                                    Wyślij
                                </a>
                            ...
                            <div class="noproduct_form_desc2">
                                Zanim zgłosisz nam produkt upewnij się, czy nie znajduje się on już na Twojej <a href="products-requests.php" title="Przejdź do listy poszukiwanych produktów">liście poszukiwanych produktów</a>.
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <iaixsl:otherwise>
                <div class="noproduct_form_outline">
                    ...
                    <div class="noproduct_form_sub">
                        <p class="noproduct_form_notlogged">Jeśli nie znalazłeś w naszej ofercie produktu, a chciałbyś kupić go w naszym sklepie, możesz skorzystać ze specjalnego formularza i przesłać nam opis szukanego przedmiotu. Aby móc to zrobić musisz być <a class="loginPopUpShow" href="signin.php">zalogowany</a>.</p>
                    </div>
                </div>
            </iaixsl:otherwise>
        </iaixsl:choose>
                            ...
                            <iaixsl:when test="/shop/page/additional/hotspot/products_zone1/product or /shop/page/additional/hotspot/products_zone1/opinion">
                                <iaixsl:choose>
                                    <iaixsl:when test="/shop/page/additional/hotspot/products_zone1/@link">
                                        <a class="big_label">
                                            <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/additional/hotspot/products_zone1/@link"/></iaixsl:attribute><iaixsl:attribute name="title">Kliknij aby zobaczyć wszystkie produkty</iaixsl:attribute>
                                            <iaixsl:choose><iaixsl:when test="/shop/page/additional/hotspot/products_zone1/@name"><iaixsl:value-of select="/shop/page/additional/hotspot/products_zone1/@name"/></iaixsl:when><iaixsl:otherwise>Promocje</iaixsl:otherwise></iaixsl:choose>
