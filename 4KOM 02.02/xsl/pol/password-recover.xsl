        ...
        <!--Formularz przypomnienia hasła (password-recover, 108083.1)-->
            ...
            <div id="signin_password_recovery">
                ...
                <div class="row flex-column align-items-center ">
                    <p class="reminder_desc col-12 col-sm-6 mb-3">Na Twój adres zostanie wysłany e-mail, który pozwala na automatyczne zalogowanie się. Zmiana hasła będzie możliwa po zalogowaniu na stronie edycji Twoich danych.</p>
                    ...
                    <div class="password_recovery_phone col-12 col-sm-6">
                        Jeżeli nie jesteś w stanie przypomnieć sobie loginu lub nie możesz odebrać z przyczyn niezależnych podanego przy rejestracji e-maila to prosimy o kontakt telefoniczy pod nr telefonu<b><iaixsl:text> </iaixsl:text><iaixsl:value-of select="page/login/response/@tel"/></b><iaixsl:text> </iaixsl:text>lub wysłanie e-maila w tej sprawie na adres <iaixsl:text> </iaixsl:text><a class="mail_54144"><iaixsl:attribute name="href">mailto:<iaixsl:value-of select="page/login/response/@email"/></iaixsl:attribute><iaixsl:value-of select="page/login/response/@email"/></a>.
                    </div>
                </div>
            </div>
