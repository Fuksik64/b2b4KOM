...
<div id="account_icon"><a href="/login.php"><i class="icon-account"></i></a></div>
                                ...
                                <h2>
                                    <iaixsl:choose>
                                        <iaixsl:when test="page/hotspot/products_zone2/@link">
                                            <a class="big_label">
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="page/hotspot/products_zone2/@link"/></iaixsl:attribute><iaixsl:attribute name="title">Kliknij aby zobaczyć wszystkie produkty</iaixsl:attribute>
                                ...
                                <h2>
                                    <iaixsl:choose>
                                        <iaixsl:when test="page/hotspot/products_zone3/@link">
                                            <a class="big_label">
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="page/hotspot/products_zone3/@link"/></iaixsl:attribute><iaixsl:attribute name="title">Kliknij aby zobaczyć wszystkie produkty</iaixsl:attribute>
                                                <iaixsl:choose><iaixsl:when test="page/hotspot/products_zone3/@name"><iaixsl:value-of select="page/hotspot/products_zone3/@name"/></iaixsl:when><iaixsl:otherwise>Bestsellery </iaixsl:otherwise></iaixsl:choose>
                                ...
                                <h2>
                                    <iaixsl:choose>
                                        <iaixsl:when test="page/hotspot/products_zone4/@link">
                                            <a class="big_label">
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="page/hotspot/products_zone4/@link"/></iaixsl:attribute><iaixsl:attribute name="title">Kliknij aby zobaczyć wszystkie produkty</iaixsl:attribute>
                                                <iaixsl:choose><iaixsl:when test="page/hotspot/products_zone4/@name"><iaixsl:value-of select="page/hotspot/products_zone4/@name"/></iaixsl:when><iaixsl:otherwise>Nowości</iaixsl:otherwise></iaixsl:choose>
		...
		<iaixsl:variable name="main_blog_view_all">Zobacz wszystkie</iaixsl:variable>
	...
	<!--CMS na stronie głównej 2 (main_cms2, 106519.1)-->
		...
		<iaixsl:variable name="main_news_view_all">Zobacz wszystkie</iaixsl:variable>
			...
			<section id="main_news" class="article mb-4">
				<h2>
					<a href="/news.php" class="headline">
						...
						<iaixsl:attribute name="title">Kliknij, by zobaczyć wszystkie aktualności</iaixsl:attribute>
