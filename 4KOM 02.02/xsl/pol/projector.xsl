...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 107421.1)-->
            ...
            <iaixsl:if test="(action/set_render/item/@name = 'popup') or not(action/set_render/item)">
                ...
                <script src="/gfx/pol/projector_details.js.gzip?r=1598273396"></script><script src="/gfx/pol/projector_bundle_zone.js.gzip?r=1598273396"></script><script src="/gfx/pol/projector_product_questions.js.gzip?r=1598273396"></script><script src="/gfx/pol/projector_photos.js.gzip?r=1598273396"></script></head>
        ...
        <iaixsl:if test="page/projector/product/traits/trait[@groupid = '1243']">
            ...
            <iaixsl:choose>
                                        ...
                                        <iaixsl:choose>
                                            <iaixsl:when test="(position() = $thumbnailsCount and $imagesSum > $thumbnailsCount)">
                                                ...
                                                <div class="gallery_more">
                                                    ...
                                                    <span class="gallery_text2">zdjęcia</span>
                                                </div>
                                            </iaixsl:when>
                                            <iaixsl:otherwise>
                ...
                <div id="projector_details" class="product_info col-12 col-md-5">
                    ...
                    <iaixsl:variable name="addYourOwn">Dodaj swoją opinię</iaixsl:variable>
						 ...
						 <div class="opinions_wrapper projector_info_opinions_wrapper">
							<div class="note">
								...
								<a href="#opinions_section" class="opinion_link">
									Liczba opinii: <iaixsl:value-of disable-output-escaping="yes" select="page/projector/comments/@all"/>
								</a>
                                <iaixsl:if test="$addYourOwn and not($addYourOwn = '')">
                                    <a href="#opinions_section" id="projector_opinion_add" class="btn">Dodaj swoją opinię</a>
                                </iaixsl:if>
...
<select class="s_versions__select --versions --small-md" name="proj_versions">
                  ...
                  <div class="product_section_sub">
                    <iaixsl:choose>
                      ...
                      <iaixsl:otherwise>
                        <label class="select_button_label">Rozmiar</label>
                        <iaixsl:for-each select="page/projector/product/sizes/size">
                          <iaixsl:choose>
                ...
                <iaixsl:if test="((page/projector/text_sizesgroup) and (page/projector/text_sizesgroup != '')) or /shop/page/projector/product/sizes_chart">
                    <div class="product_section show_size" id="projector_show_size">
                        <div class="product_section_sub">
                            <a href="#show_size_cms" class="show_size_cms"><i class="icon-pencil-and-ruler"></i> Sprawdź jaki rozmiar wybrać.</a>
                        </div>
                    </div>
                </iaixsl:if>
                    ...
                    <div id="projector_buy_section" class="product_section">
                        ...
                        <div class="projector_buttons" id="projector_buttons">
                            ...
                            <a href="#add_favorite" class="projector_buttons_obs btn" id="projector_button_observe">
                                <iaixsl:attribute name="title">Dodaj do listy zakupowej</iaixsl:attribute>
                ...
                <iaixsl:if test="/shop/@trust_level = '1'">
                    <div id="superfairshop_info">
                        <div class="superfairshop_info_wrapper">
                            <div>
                                <img src="/gfx/pol/iai_security_supershop.png?r=1598273396" alt="SuperFair.Shop badge"/>
                                <strong>
                                ...
                                <td class="product_bundle_price_gross">
                                    <iaixsl:choose>
                                        <iaixsl:when test="price/@value > 0">
                                            ...
                                            <small>Oszczędzasz (<iaixsl:value-of select="bundle_price/@percent_diff"/>%)</small>
                                        </iaixsl:when>
                                        <iaixsl:otherwise>
                                            <a href="contact.php">Cena na telefon</a>
                                        </iaixsl:otherwise>
                                    </iaixsl:choose>
                                </td>
								<td class="product_bundle_add_to_cart">
									<form class="buttons_n60137_form" action="basketchange.php" method="post">
									<input type="hidden" name="product">
										<iaixsl:attribute name="value"><iaixsl:value-of select="@id"/></iaixsl:attribute>
									</input>
									<input class="n60137_amount" type="hidden" name="number">
										<iaixsl:attribute name="value">1</iaixsl:attribute>
									</input>
									<iaixsl:choose>
										 <iaixsl:when test="not(sizes/size/@type = 'uniw') or not(sizes/size/@type = 'onesize') and count(sizes/size/@id) > 1">
											<input type="hidden" name="size"><iaixsl:attribute name="value"/></input>
										 </iaixsl:when>
										 <iaixsl:otherwise>
											<input type="hidden" name="size" value="uniw"/>
										</iaixsl:otherwise>
									</iaixsl:choose>
									<button class="btn --solid --medium --secondary n60137_basketadd_search" type="submit" name="mode" value="1">
										<iaixsl:if test="not(sizes/size/@type = 'onesize') and not(sizes/size/@type = 'uniw') and not(/shop/page/products/product/@product_type = 'product_bundle')">
											<iaixsl:attribute name="class">btn --solid --medium --secondary  n60137_basketadd_search pick_size</iaixsl:attribute>
										</iaixsl:if>
										<iaixsl:if test="((sizes/size/@type = 'onesize') or (sizes/size/@type = 'uniw')) and (sizes/size/@amount = '0')">
											 <iaixsl:attribute name="class">btn --solid --medium --secondary  n60137_basketadd_search disabled</iaixsl:attribute>
										</iaixsl:if>
										<iaixsl:if test="sizes/availability/@status = 'disable'">
											<iaixsl:attribute name="disabled">disabled</iaixsl:attribute>
											<iaixsl:attribute name="class">btn --solid --medium --secondary  n60137_basketadd_search disabled</iaixsl:attribute>
										</iaixsl:if>
										<iaixsl:attribute name="title">Dodaj do koszyka</iaixsl:attribute>
										Dodaj do koszyka
									</button>	
									</form>
                                        ...
                                        <iaixsl:for-each select="page/projector/products_associated_zone1/*">
                                            ...
                                            <div class="product_wrapper col-12 col-sm-3">
                                                ...
                                                <a class="product-icon d-flex justify-content-center align-items-center">
                                                    ...
                                                    <img src="/gfx/pol/loader.gif?r=1598273396" class="b-lazy">
                ...
                <div id="n67367" class="clearfix">
                        ...
                        <div id="n67367_returns" class="n67367_returns">
                            ...
                            <iaixsl:choose>
                                <iaixsl:when test="page/projector/returns_config/@returns_shop_shipping_cost = 'shop' or page/projector/returns_config/@returns_shop_shipping_cost = 'shopBalance'">
                                    <h3 data-mobile-class="big_label"><span>Darmowy zwrot</span></h3>
                                </iaixsl:when>
                                <iaixsl:otherwise>
                                    <h3 data-mobile-class="big_label">Łatwy zwrot produktu </h3>
                                </iaixsl:otherwise>
                            </iaixsl:choose>
                            ...
                            <a class="n67367_more btn" href="#see_more">
                                <iaixsl:attribute name="title">Pokaż szczegóły</iaixsl:attribute>
                                <iaixsl:attribute name="data-less">Ukryj szczegóły</iaixsl:attribute>
                                Pokaż szczegóły
                            </a>
                            ...
                            <div class="n67367_returns_moretext">
                                ...
                                <div class="n67367_texts n67367_text1">
                                    <strong><b><iaixsl:value-of select="page/projector/returns_config/@days_to_return"/></b> dni na odstąpienie od umowy</strong>
                                    <div>
                                        Najważniejsza jest Twoja satysfakcja z zakupów. W ciągu
                                        <b><iaixsl:value-of select="page/projector/returns_config/@days_to_return"/></b>
                                         <b> dni możesz odstąpić od umowy bez podania przyczyny.</b>.
                                    </div>
                                </div>
                                ...
                                <div class="n67367_texts n67367_text2">
                                    <iaixsl:choose>
                                        <iaixsl:when test="page/projector/returns_config/@returns_shop_shipping_active = 'y'">
                                            <strong><span>Bez stresu </span>i obaw</strong>
                                            <div>Dbamy o Twoją wygodę, dlatego w naszym sklepie dokonasz zwrotu na korzystnych warunkach.</div>
                                        </iaixsl:when>
                                        <iaixsl:otherwise>
                                            <strong><span>Bez stresu </span>i obaw</strong>
                                            <div>Dbamy o Twoją wygodę. Dlatego oferujemy Ci <b>wygodny system zwrotów</b>.</div>
                                        </iaixsl:otherwise>
                                    </iaixsl:choose>
                                </div>
                                ...
                                <div class="n67367_texts n67367_text3">
                                    ...
                                    <iaixsl:choose>
                                        <iaixsl:when test="page/projector/returns_config/@returns_shop_shipping_cost = 'clientDEFAULT'"> 
                                            ...
                                            <strong><span>Prosty kreator </span>zwrotów</strong>
                                            <div>Wszystkie zwroty w naszym sklepie obsługiwane są przez <b>prosty kreator zwrotów</b>, który daje możliwość odesłania do nas paczki zwrotnej.</div>

                                        </iaixsl:when>
                                        <iaixsl:when test="page/projector/returns_config/@returns_shop_shipping_cost = 'shop'">

                                            <strong><span>Darmowy zwrot</span></strong>
                                            <div>Przy zwrocie produktu, <b>pokryjemy koszt przesyłki zwrotu.</b></div>

                                        </iaixsl:when>
                                        <iaixsl:when test="page/projector/returns_config/@returns_shop_shipping_cost = 'shopBalance'">

                                            <strong><span>Darmowy zwrot</span></strong>
                                            <div>Przy wyborze <b>zwrotu środków na saldo klienta,</b> darmowa przesyłka do sklepu.</div>
                                ...
                                <iaixsl:choose>
                                    <iaixsl:when test="page/projector/returns_config/@returns_shop_shipping_link = 'y'">
                                        <a href="#see_more" class="btn --solid --medium n67367_returns_seemore">
                                            <iaixsl:attribute name="title">Dowiedz się więcej</iaixsl:attribute>
                                            Dowiedz się więcej
                                        </a>
                                    </iaixsl:when>
                                    <iaixsl:otherwise>
                    ...
                    <iaixsl:if test="page/projector/product/sizes_version/@stocks_link or page/projector/product/sizes/@stocks_link and not(/shop/page/projector/product/price/@value = 0)">
                        <div id="n67367_stocks" class="n67367_stocks">
                            <h3 data-mobile-class="big_label">KUP LUB ODBIERZ W NASZYM SKLEPIE</h3>
                            ...
                            <a class="btn">
                                ...
                                <iaixsl:attribute name="title">Sprawdź dostępność</iaixsl:attribute>
                                Sprawdź dostępność
                            </a>
                        </div>
                    </iaixsl:if>
                    ...
                    <iaixsl:if test="page/projector/product/payment/instalment">
                        <div id="n67367_instalment" class="n67367_instalment">
                            <h3 data-mobile-class="big_label">Kup na raty</h3>
                                ...
                                <div class="instalment_value_1">
                                    <iaixsl:choose>
                                        <iaixsl:when test="@value_formatted">
                                            ...
                                            <span class="n67367_section_txt"><iaixsl:value-of select="@name"/> bez wychodzenia z domu. Łatwo i szybko jak zakupy przez internet.</span>

                                            <small class="instalment_value_2">
                                                Dostępne dla zakupów o łącznej wartości od 
                                            ...
                                            <iaixsl:if test="note">
                                                <span class="btn_note">Nota prawna</span>
                                ...
                                <iaixsl:for-each select="page/projector/product/payment/instalment">
                                    <li><iaixsl:attribute name="data-name"><iaixsl:value-of select="@name"/></iaixsl:attribute>
                                        <a class="instalments btn --solid mb-2">
                                            ...
                                            <span>Oblicz ratę <iaixsl:value-of select="@name"/></span>
                                            <img>
                                                <iaixsl:attribute name="src"><iaixsl:value-of select="@gfx"/></iaixsl:attribute>
                                                <iaixsl:attribute name="alt"><iaixsl:value-of select="@name"/></iaixsl:attribute>
                                            </img>
    ...
    <!--Długi opis produktu z HTML (projector_longdescription, 106664.1)-->
                                ...
                                <iaixsl:if test="@type = 'group'">
                                    <iaixsl:text disable-output-escaping="yes">&lt;/ul&gt;</iaixsl:text>
                                        <li class="param_group">
                                            ...
                                            <iaixsl:if test="desc != ''">
                                                <img class="qmark2 showTip" src="/gfx/pol/qmark2.gif?r=1598273396" alt="" title="">
                                ...
                                <iaixsl:if test="@type = 'element'">
                                    <li class="parameter_element">
                                        ...
                                        <strong>
                                            ...
                                            <iaixsl:if test="desc != ''">
                                                <img class="qmark showTip" src="/gfx/pol/qmark2.gif?r=1598273396" alt="" title="">
                                                </img>
                                        ...
                                        <span>
                                            <iaixsl:for-each select="values/value">
                                                ...
                                                <span class="n54117_item_b_sub">
                                                    ...
                                                    <iaixsl:if test="desc != ''">
                                                        <img class="qmark showTip" src="/gfx/pol/qmark.gif?r=1598273396" alt="" title="">
                    ...
                    <iaixsl:if test="(/shop/page/projector/product/enclosures/documents) or (/shop/page/projector/product/enclosures/audio)  or (/shop/page/projector/product/enclosures/other)  or (/shop/page/projector/product/enclosures/images_attachments/item) or (/shop/page/projector/product/enclosures/video/item)">
                        <div class="component_projector_enclosures">
                            ...
                            <div class="n56259_main">
                                ...
                                <iaixsl:variable name="n68814_showlabel">Pliki do pobrania</iaixsl:variable>
        ...
        <div class="product_questions_container" id="product_questions_container">
            ...
            <div class="ask_question_container">
                <div class="ask_question_label">Masz pytania do produktu?</div>
                <div class="ask_question_desc">Jeżeli powyższe informacje są dla Ciebie niewystarczający, prześlij nam swoje pytanie. Postaramy się na nie odpowiedzieć.</div>
                <a id="send_question_button" href="#showQuestionDialog" class="btn --solid --medium mb-4 mt-5 px-5">Zadaj pytanie</a>
            </div>
        </div>
            ...
            <div class="component_projector_askforproduct">
                ...
                <form action="/settings.php" class="projector_askforproduct" method="post" novalidate="novalidate">
                    ...
                    <div class="projector_askforproduct_sub">
                        ...
                        <iaixsl:variable name="form_privacy_info_text1">Dane są przetwarzane zgodnie z </iaixsl:variable>
                        <iaixsl:variable name="form_privacy_info_text2">. Przesyłając je, akceptujesz jej postanowienia. </iaixsl:variable>

                        <iaixsl:if test="$form_privacy_info_text1">
                            <p class="form-privacy-info"><iaixsl:value-of select="$form_privacy_info_text1"/><a><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/private_policy/@url"/></iaixsl:attribute>polityką prywatności</a><iaixsl:value-of select="$form_privacy_info_text2"/></p>
                        </iaixsl:if>
                                ...
                                <div class="align_row main_hotspot_sub">
                                    <div class="products_wrapper row mx-0">
                                        ...
                                        <iaixsl:for-each select="page/projector/products_associated_zone3/*">
                                            ...
                                            <iaixsl:variable name="var_icon_small"><iaixsl:choose><iaixsl:when test="product"><iaixsl:value-of select="product/icon_small"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="icon_small"/></iaixsl:otherwise></iaixsl:choose></iaixsl:variable>
                                            <iaixsl:variable name="var_link"><iaixsl:choose><iaixsl:when test="product"><iaixsl:value-of select="product/@link"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="@link"/></iaixsl:otherwise></iaixsl:choose></iaixsl:variable>
                                            <iaixsl:variable name="var_yousave">Oszczędzasz</iaixsl:variable>
					...
					<iaixsl:for-each select="/shop/page/projector/blog_entries/item">
						<article class="article__item col-12 col-md-6">
							...
							<iaixsl:if test="image/@src and image/@src!=''">
								...
								<img src="/gfx/pol/loader.gif?r=1598273396" class="article__image b-lazy">
	...
	<!--Karta produktu - załączniki (projector_enclosures, 106674.1)-->
        ...
        <!--player video w karcie produktu (projector_video, 110995.1)-->
            ...
            <iaixsl:if test="(/shop/page/projector/product/enclosures/documents) or (/shop/page/projector/product/enclosures/audio)  or (/shop/page/projector/product/enclosures/other)  or (/shop/page/projector/product/enclosures/images_attachments/item) or (/shop/page/projector/product/enclosures/video/item)">
                ...
                <a href="javascript:;" class="projector_video_close"><img src="/gfx/pol/zamknij.gif?r=1598273396" alt="Zamknij" class="projector_photo_close_55916"/></a>
...
<!--Menu powiadomienia (menu_notice, 107640.1)-->
        ...
        <!--Elementy dodawane dynamicznie (menu_dynamically_added_content, 106830.1)-->
            ...
            <script src="/gfx/pol/projector_components_hiding.js.gzip?r=1598273396"></script><script src="/gfx/pol/projector_projector_opinons_form.js.gzip?r=1598273396"></script>
            <script>
                app_shop.runApp();
            </script>
