...
<div id="account_icon"><a href="/login.php"><i class="icon-account"></i></a></div>
        ...
        <!--Menu Blog (menu_blog, 106535.1)-->
            ...
            <div id="menu_blog" >
                ...
                <iaixsl:if test="count(page/navigation/bycategories/item) > 1">
                    <div id="menu_blog_categories" class="menu_blog_box">
                        <ul>
                            <iaixsl:for-each select="page/navigation/bycategories/item">
                                <li>
                                    <iaixsl:if test="@current='active'"><iaixsl:attribute name="class">active</iaixsl:attribute></iaixsl:if>
                                    <a>
                ...
                <iaixsl:if test="page/navigation/bydates/item">
                    <div id="menu_blog_bydates" class="menu_blog_box">
                        <a class="menu_categories_label" href="/blog-list.php">
                            <iaixsl:attribute name="title">Archiwum</iaixsl:attribute>
                            Archiwum
                        </a>
                        <ul>
                            <iaixsl:for-each select="page/navigation/bydates/item">
                                <li>
                                    <iaixsl:if test="@current='active'"><iaixsl:attribute name="class">active</iaixsl:attribute></iaixsl:if>
                                    <a>
                                        <iaixsl:if test="@link"><iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute></iaixsl:if> 
                                        <iaixsl:attribute name="title"><iaixsl:value-of disable-output-escaping="yes" select="@value"/></iaixsl:attribute>
                                        <iaixsl:value-of disable-output-escaping="yes" select="@value"/>
                                    </a>
                                    <iaixsl:if test="item">
                                        <ul>
                                            <iaixsl:for-each select="item">
                                                <li>
                                                    ...
                                                    <a>
                                                        <iaixsl:if test="@link"><iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute></iaixsl:if>
                                                        <iaixsl:choose>
                                                            <iaixsl:when test="@value='01'">
                                                                <iaixsl:attribute name="title">Styczeń&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                Styczeń
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='02'">
                                                                <iaixsl:attribute name="title">Luty&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                Luty
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='03'">
                                                                <iaixsl:attribute name="title">Marzec&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                Marzec
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='04'">
                                                                <iaixsl:attribute name="title">Kwiecień&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                Kwiecień
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='05'">
                                                                <iaixsl:attribute name="title">Maj&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                Maj
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='06'">
                                                                <iaixsl:attribute name="title">Czerwiec&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                Czerwiec
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='07'">
                                                                <iaixsl:attribute name="title">Lipiec&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                Lipiec
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='08'">
                                                                <iaixsl:attribute name="title">Sierpień&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                Sierpień
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='09'">
                                                                <iaixsl:attribute name="title">Wrzesień&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                Wrzesień
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='10'">
                                                                <iaixsl:attribute name="title">Październik&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                Październik
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='11'">
                                                                <iaixsl:attribute name="title">Listopad&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                Listopad
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='12'">
                                                                <iaixsl:attribute name="title">Grudzień&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                Grudzień
                                                            </iaixsl:when>
                                                        </iaixsl:choose>
                                                    </a>
                ...
                <iaixsl:if test="action/blog_rss"> 
                    <div id="menu_blog_rss">
                        <a>
                            <iaixsl:attribute name="href"><iaixsl:value-of select="action/blog_rss/@url"/></iaixsl:attribute>
                            <iaixsl:attribute name="title">Kanał RSS <i class="icon-rss"></i></iaixsl:attribute>
        ...
        <!--Blog - Content (blog_item_content, 107738.1)-->
            <iaixsl:if test="/shop/page/blogitem/long_description">
                ...
                <iaixsl:if test="/shop/page/navigation/bycategories/item/@current='active' or /shop/page/navigation/bydates/item/item/@current='active'">
                    <div class="blog_viewalso">
                        Pokaż więcej wpisów z
                        <iaixsl:choose>
                            
                            <iaixsl:when test="/shop/page/navigation/bycategories/item/@current='active' and not(/shop/page/navigation/bydates//item/@current='active')">
                                kategorii&#160;<a>
                                <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/navigation/bycategories/item[@current='active']/@link"/></iaixsl:attribute>
                                <iaixsl:attribute name="title"><iaixsl:value-of select="/shop/page/navigation/bycategories/item[@current='active']/@value"/></iaixsl:attribute>
                                <iaixsl:value-of select="/shop/page/navigation/bycategories/item[@current='active']/@value"/>
                                </a>
                            </iaixsl:when>

                            
                            <iaixsl:when test="not(/shop/page/navigation/bycategories/item/@current='active') and /shop/page/navigation/bydates/item/item/@current='active'">
                                <iaixsl:for-each select="/shop/page/navigation/bydates/item/item[@current='active'][1]">
                                    <a>
                                        <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                                        <iaixsl:attribute name="title">Inne wpisy z tego miesiąca</iaixsl:attribute>
                                        <iaixsl:choose>
                                                <iaixsl:when test="@value='01'">Styczeń</iaixsl:when>
                                                <iaixsl:when test="@value='02'">Luty</iaixsl:when>
                                                <iaixsl:when test="@value='03'">Marzec</iaixsl:when>
                                                <iaixsl:when test="@value='04'">Kwiecień</iaixsl:when>
                                                <iaixsl:when test="@value='05'">Maj</iaixsl:when>
                                                <iaixsl:when test="@value='06'">Czerwiec</iaixsl:when>
                                                <iaixsl:when test="@value='07'">Lipiec</iaixsl:when>
                                                <iaixsl:when test="@value='08'">Sierpień</iaixsl:when>
                                                <iaixsl:when test="@value='09'">Wrzesień</iaixsl:when>
                                                <iaixsl:when test="@value='10'">Październik</iaixsl:when>
                                                <iaixsl:when test="@value='11'">Listopad</iaixsl:when>
                                                <iaixsl:when test="@value='12'">Grudzień</iaixsl:when>
                                            </iaixsl:choose>&#160;<iaixsl:value-of select="../@value"/>
                                    </a>
                                </iaixsl:for-each>
                            </iaixsl:when>
                            ...
                            <iaixsl:otherwise>
                                kategorii&#160;<a>
                                    ...
                                    <iaixsl:attribute name="title"><iaixsl:value-of select="/shop/page/navigation/bycategories/item[@current='active']/@value"/></iaixsl:attribute>
                                    <iaixsl:value-of select="/shop/page/navigation/bycategories/item[@current='active']/@value"/>
                                </a>&#160;lub&#160;<iaixsl:for-each select="/shop/page/navigation/bydates/item/item[@current='active'][1]">
                                    <a>
                                        <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                                        <iaixsl:attribute name="title">Inne wpisy z tego miesiąca</iaixsl:attribute>
                                        <iaixsl:choose>
        ...
        <!--Blog - Bookmarklets  (blog_item_bookmarklets, 107737.1)-->
            <iaixsl:if test="page/bookmarklets/item">
                <div id="blog_item_bookmarklets">
                    <div class="bookmarklets_section">
                        <ul>
                            <iaixsl:for-each select="page/bookmarklets/item">
                                <li>
                                    <iaixsl:value-of disable-output-escaping="yes" select="text()"/>
                                </li>
                            </iaixsl:for-each>
            ...
            <iaixsl:if test="/shop/page/bookmarklets/item/@icon_small"> </iaixsl:if>
        <!--Blog - Produkty powiązane (blog_item_associated, 107734.1)-->
            <iaixsl:if test="page/cms_products/product or page/cms_products/opinion">
                <iaixsl:variable name="blog_item_associated_blazy_off"></iaixsl:variable>

                <div class="main_hotspot mb-4" id="blog_item_associated">
                    <iaixsl:choose>
                        <iaixsl:when test="page/cms_products/@link">
                            <a class="big_label">
                                <iaixsl:attribute name="href"><iaixsl:value-of select="page/cms_products/@link"/></iaixsl:attribute><iaixsl:attribute name="title">Kliknij aby zobaczyć wszystkie produkty</iaixsl:attribute>
                                <iaixsl:choose><iaixsl:when test="page/cms_products/@name"><iaixsl:value-of select="page/cms_products/@name"/></iaixsl:when><iaixsl:otherwise>Polecane</iaixsl:otherwise></iaixsl:choose>
                                <small><i class="icon-caret-right"></i> Zobacz wszystkie</small>
                            </a>
                        </iaixsl:when>
                        <iaixsl:otherwise>
                            <div class="big_label">
        ...
        <!--Blog - Facebook comments (blog_item_facebook_comments, 107733.1)-->
            <iaixsl:if test="page/facebook_comments">
                <div class="cms_fb_comments">
                    <div class="big_label cms_fb_comments_label">
                    ...
                    <div class="fb-comments">
                        <iaixsl:attribute name="data-href"><iaixsl:value-of select="/shop/page/blogitem/link/@href"/></iaixsl:attribute>
