...
<script src="/gfx/pol/orderdetails_payments.js.gzip?r=1598273396"></script>
                            </iaixsl:when>
                            <iaixsl:otherwise>
...
<iaixsl:if test="page/prepaid/text/body != ''">
    ...
    <!--Informacje o zamówieniu (orderdetails_info, 116656.1)-->
            ...
            <div id="orderdetails_info">
                <h2 class="big_label">
                    ...
                    <span class="order-date">
                        zamówienie z <iaixsl:value-of select="page/prepaid/details/@datetime"/>
                    </span>
                </h2>
                ...
                <div id="orderdetails_info_status">
                    ...
                    <div class="prepaid-status">
                        ...
                        <small>Zamówienie nr:<iaixsl:value-of select="page/prepaid/details/@orderid"/></small>
                        <iaixsl:if test="page/prepaid/details/@msg = 'order' and page/prepaid/details/@prepaidstatus  = 'c'">
                            <div class="prepaid-msg">
                                    <br />Zamówienia nie można jeszcze opłacić. Oczekuj na informację o odblokowaniu płatności i prośbę o wpłatę.
                            </div>
                        </iaixsl:if>
                        <iaixsl:if test="page/prepaid/details/@msg = 'confirm'">
                            <div class="prepaid-msg">
                                Na Twoją skrzynkę wysłaliśmy e-mail z potwierdzeniem zamówienia. Sprawdź swoją pocztę i w e-mailu od nas kliknij na link potwierdzający zamówienie.
                            </div>
                        </iaixsl:if>
                    </div>
                    ...
                    <div class="prepaid-buttons">
                        ...
                        <iaixsl:if test="page/prepaid/editlink/@active = 'y'">
                            ...
                            <iaixsl:attribute name="href"><iaixsl:value-of select="page/prepaid/editlink/@link"/></iaixsl:attribute><small><i class="icon-pencil"></i></small><span>Zmień zamówienie</span></a>
                        </iaixsl:if>
                        ...
                        <iaixsl:if test="/shop/page/prepaid/opinions_forms/trusted_shops/raiting_action">
                            <a class="btn-icon prepaid-opinions" target="_blank">
                                ...
                                <small><i class="icon-star"></i></small><span>Oceń nasz sklep!</span>
                            </a>
                        </iaixsl:if>
                        ...
                        <iaixsl:if test="page/prepaid/confirmlink/@link">
                            <a class="btn-icon prepaid-resend">
                                ...
                                <small><i class="icon-envelope"></i></small><span>Potwierdź ponownie e-mailem</span>
                            </a>
                        </iaixsl:if>
                        ...
                        <iaixsl:if test="(page/prepaid/cancellink/@active='y') and not(page/prepaid/order/@payment_paid)">
                            <a class="btn-icon prepaid-cancel orderdetails_info_cancel">
                                ...
                                <small><i class="icon-remove"></i></small><span>Anuluj zamówienie</span>
                            </a>
                        </iaixsl:if>
                    </div>
                </div>
                ...
                <iaixsl:if test="page/prepaid/prepaid_history/item">
                    <iaixsl:if test="page/prepaid/details/@paymentstatus != 'g' and /shop/page/prepaid_methods/item and (page/prepaid/prepaid_history/item[position() = last()]/@status = 'n' or page/prepaid/prepaid_history/@show_payment_button = 'true')">
                        <div class="show_history_container">
                            <a href="#orderdetails_payments_content">Wyświetl historię wpłat</a>
                        </div>
                    </iaixsl:if>
										...
										<div class="payments_group">
											...
											<label class="payments_group_sub_content">
												...
												<span class="payments_sub_container">
													<iaixsl:if test="@id = 'blik'">
														<span style="display: none;" class="blik_placeholder">Podaj 6-cyfrowy kod BLIK:<input id="blik_placeholder_input" type="text"/></span>
													</iaixsl:if>
						...
						<div class="orderdetails_summary_price">
							...
							<iaixsl:if test="page/prepaid/prepaid_history/@currencysum and page/prepaid/prepaid_history/@currencysum != '0.00' and page/prepaid/prepaid_history/@currencysum != '-0.00'">
								<div class="orderdetails_product_summary left_to_pay">
									<label>Pozostało do zapłacenia:</label>
								...
								<iaixsl:for-each select="page/prepaid/prepaid_history/item[position()=last()]">
									<div class="selected_payment_history">
										...
										<div class="selected_payment_history_description">
											...
											<iaixsl:if test="/shop/page/prepaid_methods/item"></iaixsl:if>
                            ...
                            <div class="row">
                                <div class="credit_card_pci_dss col-12">
                                    ...
                                    <span class="pci_dss_icon_container">
                                        <img src="/gfx/pol/pci_css_logo.png?r=1598273396" alt="PCI DSS Compilant"/>
                                    </span>
                                </div>
                            </div>
                        </form>
            ...
            <table>
                ...
                <tr>
                    <td class="ordered-icon">
                        <img src="/gfx/pol/shipping_icon.png?r=1598273396">
                    ...
                    <iaixsl:when test="/shop/page/prepaid/prepaid_history/item/@status = 'n'">
                        <iaixsl:for-each select="/shop/page/prepaid/prepaid_history/item[@status = 'n']">
                            <tr class="payment_form_item">
                                <td class="ordered-icon">
                                    <img src="/gfx/pol/prepaid_method_icon.png?r=1598273396">
                                        <iaixsl:if test="@icon">
                                            <iaixsl:attribute name="src"><iaixsl:value-of select="@icon"/></iaixsl:attribute>
                                        </iaixsl:if>
                                        <iaixsl:attribute name="alt"><iaixsl:value-of select="@payment_name"/></iaixsl:attribute>
                ...
                <iaixsl:if test="/shop/page/insurance_product">
                    ...
                    <tr>
                        <td class="ordered-icon">
                            <img src="/gfx/pol/insurance_icon.png?r=1598273396" alt="insurance_icon"/>
                        </td>
                        <td class="ordered-name">
                            Ochrona Kupującego: 
    ...
    <!--Szczegóły zamówienia - adres (prepaid_address, 107688.1)-->
        ...
        <!--Dokumenty do zamówienia (prepaid_documents, 116654.1)-->
            <iaixsl:choose>
                <iaixsl:when test="count(page/prepaid/documents/document) > 0">
                    <div id="ordered_documents" class="order2_info comments_container d-block">
                        ...
                        <div class="big_label d-none d-sm-block">Dokumenty do pobrania</div>

                        <div class="order2_info_sub ordered_documents" id="order2_info_sub1">
                            <iaixsl:for-each select="page/prepaid/documents/document[(@type!='invoice_proforma') and (@type!='invoice')]">                          
                                <div class="n57857_item">
                                    <div class="order2_info1">
            ...
            <iaixsl:if test="$prepaidrt_txt and /shop/page/prepaid/actions/return/@url">
                <div class="actions_return col-12 col-sm-6">
                    <div class="actions_return_sub col-12 mb-4">
                        ...
                        <div>
                            <img alt="returns" src="/gfx/pol/returns_action.png?r=1598273396"/><span>Jeżeli chcesz skorzystać z prawa do zwrotu zakupionych produktów bez podania przyczyny - skorzystaj z naszego systemu do zwrotów, który uczyni proces prostym i bezpiecznym.</span></div>
                            <a class="btn --solid">
            ...
            <iaixsl:if test="$prepaidzt_txt and /shop/page/prepaid/actions/rma/@url">
                <div class="actions_rma col-12 col-sm-6">
                    <div class="actions_rma_sub col-12">
                        ...
                        <div>
                            <img alt="rma" src="/gfx/pol/rma_action.png?r=1598273396"/><span>Jeżeli produkt w momencie dostawy był sprawny, ale popsuł się i chcesz zgłosić reklamację z tytułu gwarancji poprzez nasz sklep, skorzystaj z naszego systemu zgłaszania reklamacji, co uczyni proces łatwiejszym i szybszym.</span></div>
                            <a class="btn --solid">
