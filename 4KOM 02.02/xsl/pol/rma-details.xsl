            ...
            <div class="step_confirmation">
                ...
                <iaixsl:if test="/shop/page/documentlink/@url">
                    <div class="orderdetails_documentlink">
                        <h2 class="big_label">
                            <span>Wydruk zgłoszenia reklamacji</span>
                        </h2>
                        <div class="documentlink_image row">
                            <div class="document_img_1 col-12 col-sm-4">
                                <img src="/gfx/pol/documentlink_1.png?r=1598273396" alt=""/>
                                <span>Wydrukuj zgłoszenie reklamacji i etykiety</span>
                            </div>
                            <div class="document_img_2 col-12 col-sm-4">
                                <img src="/gfx/pol/documentlink_2.png?r=1598273396" alt=""/>
                                <span>Przygotuj paczkę. Dołącz formularz reklamacji.</span>
                            </div>
                            <div class="document_img_3 col-12 col-sm-4">
                                <img src="/gfx/pol/documentlink_3.png?r=1598273396" alt=""/>
                                <span>Nadaj paczkę. Za nadanie nic dodatkowo nie płacisz.</span>
                            </div>
                        </div>
                        <iaixsl:if test="/shop/page/documentlink/@url">
