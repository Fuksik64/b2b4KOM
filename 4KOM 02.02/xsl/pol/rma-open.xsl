                ...
                <div class="menu_messages_message mb-4">
                    <iaixsl:choose>
                        <iaixsl:when test="/shop/page/rma-open/@rma_exist_link and not(/shop/page/rma-open/@rma_exist_link = '')">
                            Dla tego zamówienia został już wygenerowana Reklamacja. Prosimy o sprawdzenie statusu obecnych zgłoszeń lub dodanie kolejnego z poziomu panelu Reklamacji.
                        </iaixsl:when>
