                ...
                <iaixsl:choose>
                                        ...
                                        <td>
                                            <iaixsl:choose>
                                                <iaixsl:when test="@returns_url">
                                                    <a class="btn --icon-left icon-plus --medium see_button"><iaixsl:attribute name="href"><iaixsl:value-of select="@returns_url"/></iaixsl:attribute><span><i class='icon-plus'></i></span><small>Wybierz</small></a>
                                                </iaixsl:when>
                                                <iaixsl:when test="@rma_url">
                                                    <a class="btn --icon-left icon-plus --medium see_button"><iaixsl:attribute name="href"><iaixsl:value-of select="@rma_url"/></iaixsl:attribute><span><i class='icon-plus'></i></span><small>Wybierz</small></a>
                                                </iaixsl:when>
                                                <iaixsl:otherwise>
                                                    <a class="btn --icon-left icon-plus --medium see_button"><iaixsl:attribute name="href"><iaixsl:value-of select="@orderdetails"/></iaixsl:attribute><span><i class='icon-plus'></i></span><small>Zobacz</small></a>
                                                </iaixsl:otherwise>
                                            </iaixsl:choose>
                                        </td>
                                    </tr>
                    ...
                    <iaixsl:otherwise>
                        <div class="client_orders_null">
                            <iaixsl:choose>
                                <iaixsl:when test="page/orders/@mode = 'rma'">
                                    Obecnie nie masz zamówień które moga podlegać reklamacji.
                                </iaixsl:when>
                                <iaixsl:when test="page/orders/@mode = 'returns'">
                                    Obecnie nie masz zamówień które moga podlegać zwrotowi.
                                </iaixsl:when>
                                <iaixsl:when test="page/orders/@mode = 'closed'">
