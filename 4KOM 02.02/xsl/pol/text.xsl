            ...
            <iaixsl:if test="page/facebook_comments">
                <div class="cms_fb_comments">
                    <div class="big_label cms_fb_comments_label">
                        <span >Podziel się swoim komentarzem z innymi</span>
                    </div>
                    <div id="fb-root"/>
                    <script>
            ...
            <iaixsl:if test="/shop/page/cms_products/product or /shop/page/cms_products/opinion">
                <div class="main_hotspot mb-4" id="text_cms_associated">
                    <a class="big_label">
                        ...
                        <iaixsl:choose>
                            <iaixsl:when test="/shop/page/cms_products/@name">
                                <iaixsl:value-of select="/shop/page/cms_products/@name"/>
                            </iaixsl:when>
                            <iaixsl:otherwise>
                                    Polecane
                            </iaixsl:otherwise>
                                        ...
                                        <iaixsl:otherwise>
                                            ...
                                            <div class="product_prices">
                                                <iaixsl:choose>
                                                    ...
                                                    <iaixsl:when test="($var_net_value = 0) and $var_points_net = ''">
                                                        <a class="fon_price">
                                                            <iaixsl:attribute name="title">Kliknij, by przejść do formularza kontaktu</iaixsl:attribute>
                                                            <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/contact/link/@url"/></iaixsl:attribute>
                                                            Cena na telefon
