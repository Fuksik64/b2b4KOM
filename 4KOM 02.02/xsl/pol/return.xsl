            ...
            <div class="n54531_outline_sub">
                ...
                <iaixsl:choose>
                    ...
                    <iaixsl:when test="page/return/@type = 'account_nouser'">
                        <h3 class="return_label">Nie ma konta o takim loginie lub z takim adresem e-mail.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'account_disabled'">
                        <h3 class="return_label">Podane konto zostało zablokowane.</h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type = 'payment_success'">
                        <h3 class="return_label">Dyspozycja dokonania płatności internetowej została przyjęta.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type = 'payment_error'">
                        <h3 class="return_label">Wystąpił błąd płatności internetowej.</h3>
                    </iaixsl:when>
