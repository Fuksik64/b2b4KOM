...
<div id="account_icon"><a href="/login.php"><i class="icon-account"></i></a></div>
                                    ...
                                    <li>
                                        <a><iaixsl:choose>
                                            ...
                                            <iaixsl:attribute name="title"><iaixsl:value-of select="text"/></iaixsl:attribute><iaixsl:choose>
                                                <iaixsl:when test="image or image_desktop or image_tablet or image_mobile"><img src="/gfx/eng/loader.gif?r=1598273385">
                                                    <iaixsl:attribute name="alt"><iaixsl:value-of select="text"/></iaixsl:attribute>
                                                    <iaixsl:if test="image_desktop or image_tablet or image_mobile">
                                                        <iaixsl:attribute name="class">rwd-src</iaixsl:attribute>
                                                    </iaixsl:if>
                                ...
                                <h2>
                                    <iaixsl:choose>
                                        <iaixsl:when test="page/hotspot/products_zone3/@link">
                                            <a class="big_label">
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="page/hotspot/products_zone3/@link"/></iaixsl:attribute><iaixsl:attribute name="title">Click here to view all products</iaixsl:attribute>
                                                <iaixsl:choose><iaixsl:when test="page/hotspot/products_zone3/@name"><iaixsl:value-of select="page/hotspot/products_zone3/@name"/></iaixsl:when><iaixsl:otherwise>Bestsellers</iaixsl:otherwise></iaixsl:choose>
                                ...
                                <h2>
                                    <iaixsl:choose>
                                        <iaixsl:when test="page/hotspot/products_zone4/@link">
                                            <a class="big_label">
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="page/hotspot/products_zone4/@link"/></iaixsl:attribute><iaixsl:attribute name="title">Click here to view all products</iaixsl:attribute>
                                                <iaixsl:choose><iaixsl:when test="page/hotspot/products_zone4/@name"><iaixsl:value-of select="page/hotspot/products_zone4/@name"/></iaixsl:when><iaixsl:otherwise>New In</iaixsl:otherwise></iaixsl:choose>
		...
		<iaixsl:variable name="main_blog_view_all">View all</iaixsl:variable>
	...
	<!--CMS na stronie głównej 2 (main_cms2, 106519.1)-->
		...
		<iaixsl:variable name="main_news_view_all">View all</iaixsl:variable>
