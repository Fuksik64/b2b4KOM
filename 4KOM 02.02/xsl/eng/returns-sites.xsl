...
<div id="account_icon"><a href="/login.php"><i class="icon-account"></i></a></div>
    ...
    <!--Zwroty punkty zwrotu (returns_sites_form, 107784.1)-->


<iaixsl:if test="page/@type = 'return_products' and page/@display = 'stock'">
<div class="step4a">
               <div class="progress_bar_wrapper">
            <iaixsl:attribute name="class">progress_bar_wrapper pb_step4</iaixsl:attribute>
