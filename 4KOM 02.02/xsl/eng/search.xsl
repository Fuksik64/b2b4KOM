...
<div id="account_icon"><a href="/login.php"><i class="icon-account"></i></a></div>
        ...
        <!--Filtrowanie wyników wyszukiwania w layout (menu_filter, 97634.1)-->

        <iaixsl:if test="/shop/page/products/navigation/filtering/filter/item/@quantity"> </iaixsl:if>
        <iaixsl:if test="/shop/page/products/navigation/filtering/filter/item/@name"> </iaixsl:if>
        ...
        <iaixsl:if test="/shop/page/products/navigation/filtering/filter/@id='filter_date'"> </iaixsl:if>
        <iaixsl:if test="/shop/page/products/navigation/filtering/filter/@type='text'"> </iaixsl:if>
        <iaixsl:if test="/shop/page/products/navigation/filtering"> </iaixsl:if>
        <iaixsl:if test="/shop/page/products/navigation/search_link/@value"> </iaixsl:if>
        <iaixsl:if test="/shop/page/@cache_filter"> </iaixsl:if>
    ...
    <!--Filtrowanie wyników wyszukiwania (search_filters, 110880.1)-->
          ...
          <iaixsl:if test="count(/shop/page/products/navigation/filtering/filter)">
              <section id="Filters" class="filters mb-4">
                  <form class="filters__form d-md-flex flex-wrap justify-content-start" method="get">
                      ...
                      <iaixsl:for-each select="/shop/page/products/navigation/filtering/filter[(@type = 'list') or (@type = 'text')]">
                          ...
                          <div class="filters__block mr-md-5 my-md-1 mb-2">
                              ...
                              <div class="filters__expand p-md-2">
                                  <iaixsl:attribute name="id"><iaixsl:value-of select="$id"/>_expand</iaixsl:attribute>
                                  <iaixsl:if test="group">
                                      <iaixsl:attribute name="data-group">true</iaixsl:attribute>
                                  </iaixsl:if>
                                          ...
                                          <div class="filters__content --range">
                                              ...
                                              <div class="filters__price">
                                                  ...
                                                  <div class="filters_options">
                                                      <button type="submit" class="btn p-md-0 mt-md-2 d-none d-inline-block">
                                                            ...
                                                            <iaixsl:when test="@id = -1">
                                                              ...
                                                              <iaixsl:otherwise>
                                                                <li class="filters__item mb-1">
                                                                    <a class="filters__toggler">
                                                                        <iaixsl:if test="position() = 1">
                                                                            <iaixsl:attribute name="class">filters__toggler --active</iaixsl:attribute>
                                                                        </iaixsl:if>
                                                                        <div class="btn --icon-right d-block pr-4">
                                                                            <span>
                                                                                <iaixsl:choose>
        ...
        <!--Stronicowanie wyników (search_paging, 110345.1)-->
        ...
        <iaixsl:if test="not(page/products/@hideproducts = 'true')">
            <div id="paging_setting_top" class="s_paging">
                ...
                <iaixsl:if test="count(page/products/navigation/item) > 1">
                    <ul class="s_paging__item pagination d-none mb-2 mb-sm-3">
        ...
        <iaixsl:if test="compare/@count > 0 or /shop/page/@cache_html = 'true'">
            <div id="menu_compare_product" class="compare pt-2 mb-2 pt-sm-3 pb-sm-3 mb-sm-3">
                <iaixsl:if test="/shop/page/@cache_html = 'true'">
            ...
            <iaixsl:if test="/shop/page/products/display_mode/@active = 'normal'">
                <div id="search" class="row">
                    <iaixsl:for-each select="/shop/page/products/product">
                        <div class="product_wrapper col-12 col-sm-4 col-md-3">
                            ...
                            <iaixsl:if test="/shop/compare/@active = 'y' and $addcompare_txt">
                                <a class="btn compare_add" rel="nofollow">
                                    <iaixsl:choose>
                                        <iaixsl:when test="@id = /shop/compare/product/@id">
                                            <iaixsl:attribute name="data-remove">true</iaixsl:attribute>
                                            <iaixsl:if test="/shop/action/settings/@url">
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/settings/@url"/>?comparers=remove&amp;product=<iaixsl:value-of select="@id"/></iaixsl:attribute>
                                            </iaixsl:if>
                                            <iaixsl:attribute name="title"></iaixsl:attribute>
                                        ...
                                        <iaixsl:otherwise>
                                            <iaixsl:if test="/shop/action/settings/@url">
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/settings/@url"/>?comparers=add&amp;product=<iaixsl:value-of select="@id"/></iaixsl:attribute>
                                            </iaixsl:if>
                                            <iaixsl:attribute name="title"></iaixsl:attribute>
                            ...
                            <a class="product-icon align_row" data-align="img#css">
                                ...
                                <img class="b-lazy" src="/gfx/eng/loader.gif?r=1598273385">
                                    ...
                                    <iaixsl:if test="not(sizes/size/@type='uniw')">
                                        <div class="sizes_wrapper">
                                            ...
                                            <iaixsl:for-each select="sizes/size">
                                                <span><iaixsl:value-of select="@description"/></span>
                                            </iaixsl:for-each>
                                        </div>
                                    </iaixsl:if>
...
<!--Menu powiadomienia (menu_notice, 107640.1)-->
        ...
        <!--Elementy dodawane dynamicznie (menu_dynamically_added_content, 106830.1)-->
            ...
            <script src="/gfx/eng/search_filters.js.gzip?r=1598273385"></script>
            <script>
                app_shop.runApp();
            </script>
