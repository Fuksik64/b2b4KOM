...
<div id="account_icon"><a href="/login.php"><i class="icon-account"></i></a></div>
        ...
        <!--Klienci zarejestrowani z PP - Lista (affiliate_clients_list, 59424.1)-->
<iaixsl:if test="not(page/@type='affiliate-not-active')">
    <div class="affiliate_clients_label">
<iaixsl:attribute name="class">big_label affiliate_clients_label</iaixsl:attribute>

        <span class="affiliate_clients_label">
            A list of your customers
        </span>
    </div>
    <iaixsl:choose>
    <iaixsl:when test="count(page/clients_list/login)">
        <div class="affiliate_clients_desc">
            <p class="affiliate_clients_desc">A list of all customers who have created an account thanks to your recommendation can be found below.</p>
        </div>
        <div class="affiliate_clients">
            <div class="affiliate_clients_sub">
                <table class="affiliate_clients">

   <iaixsl:attribute name="class">ui-responsive table-stroke ui-table ui-table-reflow affiliate_clients</iaixsl:attribute>

                    <thead>
                        <tr>
                            <th id="affiliate_clients_th1">customer id</th>
                            <th id="affiliate_clients_th3">the account created on</th>
                        </tr>
                    </thead>
                    <tbody>
                        <iaixsl:for-each select="page/clients_list/login">
                            <tr>
                                <iaixsl:choose>
                                    <iaixsl:when test="position() mod 2">
                                        <iaixsl:attribute name="class">affiliate_clients_row1</iaixsl:attribute>
                                    </iaixsl:when>
                                    <iaixsl:otherwise>
                                        <iaixsl:attribute name="class">affiliate_clients_row2</iaixsl:attribute>
                                    </iaixsl:otherwise>
                                </iaixsl:choose>
                                <td class="affiliate_clients_first">
                                    <span class="affiliate_clients_name"><a><iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute><iaixsl:value-of select="@nr"/></a></span>
                                </td>
                                <td>
    ...
    <iaixsl:otherwise>
        <div class="affiliate_clients_desc_null">
            Currently there are no customers who have created an account thanks to your recommendation.
        </div>
    </iaixsl:otherwise>
    </iaixsl:choose>
</iaixsl:if>
<!--Klienci zarejestrowani z PP - Stronicowanie (affiliate_clients_paging, 110548.1)-->
        <iaixsl:variable name="prev_page"></iaixsl:variable>
        <iaixsl:variable name="next_page">Next page</iaixsl:variable>

        <iaixsl:if test="count(page/clients_list/navigation/item) > 1">
            <ul class="pagination mb-2 mb-sm-3">
                
                <iaixsl:if test="page/clients_list/navigation/prev">
                    <li class="pagination__element --prev">
                        ...
                        <a class="pagination__link">
                            <iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="page/clients_list/navigation/path/@value"/><iaixsl:value-of select="page/clients_list/navigation/prev/@counter"/></iaixsl:attribute>
                        </a>
                        <iaixsl:if test="$prev_page">
                ...
                <iaixsl:if test="not(page/clients_list/navigation/prev)">
                ...
                <iaixsl:for-each select="page/clients_list/navigation/item">
                    <iaixsl:if test="@gap">
                ...
                <iaixsl:if test="page/clients_list/navigation/next">
                    <li class="pagination__element --next">
                        ...
                        <a class="pagination__link">
                            <iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="page/clients_list/navigation/path/@value"/><iaixsl:value-of select="page/clients_list/navigation/next/@counter"/></iaixsl:attribute>
                        </a>
                        <iaixsl:if test="$next_page">
                ...
                <iaixsl:if test="not(page/clients_list/navigation/next)">
