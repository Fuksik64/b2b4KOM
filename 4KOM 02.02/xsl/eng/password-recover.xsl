        ...
        <!--Formularz przypomnienia hasła (password-recover, 108083.1)-->
            ...
            <div id="signin_password_recovery">
                ...
                <div class="row flex-column align-items-center ">
                    <p class="reminder_desc col-12 col-sm-6 mb-3">The e-mail allowing for automatic sign in will be sent to your e-mail address. A password change will be available after signing in to your personal information edition page.</p>
                    ...
                    <div class="password_recovery_phone col-12 col-sm-6">
                        If you don't remember your login or you cannot access the e-mail address provided during the registration, please contact us by phone<b><iaixsl:text> </iaixsl:text><iaixsl:value-of select="page/login/response/@tel"/></b><iaixsl:text> </iaixsl:text>or send an e-mail to <iaixsl:text> </iaixsl:text><a class="mail_54144"><iaixsl:attribute name="href">mailto:<iaixsl:value-of select="page/login/response/@email"/></iaixsl:attribute><iaixsl:value-of select="page/login/response/@email"/></a>.
                    </div>
                </div>
            </div>
