                ...
                <iaixsl:if test="page/navigation/bydates/item">
                    <div id="menu_blog_bydates" class="menu_blog_box">
                        <a class="menu_categories_label" href="/blog-list.php">
                            <iaixsl:attribute name="title">Archives</iaixsl:attribute>
                            Archives
                        </a>
                        <ul>
                                                    ...
                                                    <a>
                                                        ...
                                                        <iaixsl:choose>
                                                            <iaixsl:when test="@value='01'">
                                                                <iaixsl:attribute name="title">January&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                January
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='02'">
                                                                <iaixsl:attribute name="title">February&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                February
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='03'">
                                                                <iaixsl:attribute name="title">March&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                March
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='04'">
                                                                <iaixsl:attribute name="title">April&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                April
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='05'">
                                                                <iaixsl:attribute name="title">May&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                May
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='06'">
                                                                <iaixsl:attribute name="title">June&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                June
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='07'">
                                                                <iaixsl:attribute name="title">July&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                July
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='08'">
                                                                <iaixsl:attribute name="title">August&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                August
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='09'">
                                                                <iaixsl:attribute name="title">September&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                September
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='10'">
                                                                <iaixsl:attribute name="title">October&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                October
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='11'">
                                                                <iaixsl:attribute name="title">November&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                November
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='12'">
                                                                <iaixsl:attribute name="title">December&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                December
                                                            </iaixsl:when>
                                                        </iaixsl:choose>
                                                    </a>
                ...
                <iaixsl:if test="action/blog_rss"> 
                    <div id="menu_blog_rss">
                        <a>
                            ...
                            <iaixsl:attribute name="title">RSS Feed <i class="icon-rss"></i></iaixsl:attribute>
                        ...
                        <iaixsl:choose>
                            ...
                            <iaixsl:when test="not(/shop/page/navigation/bycategories/item/@current='active') and /shop/page/navigation/bydates/item/item/@current='active'">
                                <iaixsl:for-each select="/shop/page/navigation/bydates/item/item[@current='active'][1]">
                                    <a>
                                        <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                                        <iaixsl:attribute name="title">Other entries this month</iaixsl:attribute>
                                        <iaixsl:choose>
                                                <iaixsl:when test="@value='01'">January</iaixsl:when>
                                                <iaixsl:when test="@value='02'">February</iaixsl:when>
                                                <iaixsl:when test="@value='03'">March</iaixsl:when>
                                                <iaixsl:when test="@value='04'">April</iaixsl:when>
                                                <iaixsl:when test="@value='05'">May</iaixsl:when>
                                                <iaixsl:when test="@value='06'">June</iaixsl:when>
                                                <iaixsl:when test="@value='07'">July</iaixsl:when>
                                                <iaixsl:when test="@value='08'">August</iaixsl:when>
                                                <iaixsl:when test="@value='09'">September</iaixsl:when>
                                                <iaixsl:when test="@value='10'">October</iaixsl:when>
                                                <iaixsl:when test="@value='11'">November</iaixsl:when>
                                                <iaixsl:when test="@value='12'">December</iaixsl:when>
                            ...
                            <iaixsl:otherwise>
                                category&#160;<a>
                                    ...
                                    <iaixsl:attribute name="title"><iaixsl:value-of select="/shop/page/navigation/bycategories/item[@current='active']/@value"/></iaixsl:attribute>
                                    <iaixsl:value-of select="/shop/page/navigation/bycategories/item[@current='active']/@value"/>
                                </a>&#160;or&#160;<iaixsl:for-each select="/shop/page/navigation/bydates/item/item[@current='active'][1]">
                                    <a>
                                        <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                                        <iaixsl:attribute name="title">Other entries this month</iaixsl:attribute>
                                        <iaixsl:choose>
                ...
                <div class="main_hotspot mb-4" id="blog_item_associated">
                    <iaixsl:choose>
                        <iaixsl:when test="page/cms_products/@link">
                            <a class="big_label">
                                <iaixsl:attribute name="href"><iaixsl:value-of select="page/cms_products/@link"/></iaixsl:attribute><iaixsl:attribute name="title">Click here to view all products</iaixsl:attribute>
                                <iaixsl:choose><iaixsl:when test="page/cms_products/@name"><iaixsl:value-of select="page/cms_products/@name"/></iaixsl:when><iaixsl:otherwise>Recommended</iaixsl:otherwise></iaixsl:choose>
                                                    ...
                                                    <iaixsl:when test="(($var_value = 0) and $var_points = '') or ($var_value = 0 and $main_hotspot_zone1_b2b_var and not($main_hotspot_zone1_b2b_var = '') and not(/shop/basket/@wholesaler = 'true'))">
                                                        <a class="fon_price">
                                                            <iaixsl:choose>
                                                                ...
                                                                <iaixsl:otherwise>
                                                                    <iaixsl:attribute name="title">Click to go to a contact form</iaixsl:attribute>
