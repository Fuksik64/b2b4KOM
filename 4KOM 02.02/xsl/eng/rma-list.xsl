...
<iaixsl:attribute name="class">rma_list_cms_label  big_label</iaixsl:attribute>
            <span class="rma_list_cms_label">
                    How to add a complaint properly
            </span>
        </div>
    ...
    <!--Informacje o reklamacjach (rma_list_data, 107803.1)-->
        ...
        <iaixsl:variable name="rma_list_paymenthead">Preferred method of a refund:</iaixsl:variable>
        ...
        <iaixsl:choose>
            <iaixsl:when test="/shop/page/rma/item">
                ...
                <div class="client_order">
                    ...
                    <h1 class="big_label">
                        <span>List of your complaints</span>
                    </h1>
                    ...
                    <table class="orders" cellspacing="0" cellpadding="0" >
                        ...
                        <thead>
                            <tr id="orders_header">
                                <td class="ord3" id="orders_head_1">order ID</td>
                                <td class="ord3" id="orders_head_2">date of the complaint</td>
                                

                                <td class="ord3" id="orders_head_5">status</td>
                                <td class="ord3" id="orders_head_6">Action</td>
                            </tr>
                        </thead>
                        <tbody>
                            <iaixsl:for-each select="/shop/page/rma/item">
                                <tr>
                                        ...
                                        <div>
                                            ...
                                            <iaixsl:choose>
                                                ...
                                                <iaixsl:when test="@status=1">
                                                    ...
                                                    <small>Complaint being handled</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=2">
                                                    <span><i class="icon-ok"></i></span>
                                                    <small>Complaint handled positively</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=3">
                                                    <span><i class="icon-remove"></i></span>
                                                    <small>Complaint rejected</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=4">
                                                    <span><i class="icon-clock"></i></span>
                                                    <small>Complaint being handled - Product was sent for testing</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=5">
                                                    <span><i class="icon-clock"></i></span>
                                                    <small>Complaint being handled - Product sent to the producer</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=6">
                                                    <span><i class="icon-clock"></i></span>
                                                    <small>Complaint being handled - Repair in progress</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=7">
                                                    <span><i class="icon-remove"></i></span>
                                                    <small>Complaint rejected - No defect has been found</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=8">
                                                    <span><i class="icon-remove"></i></span>
                                                    <small>Complaint rejected - Defect caused by improper use</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=9">
                                                    <span><i class="icon-remove"></i></span>
                                                    <small>Complaint rejected - the warranty period has been exceeded</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=10">
                                                    <span><i class="icon-ok"></i></span>
                                                    <small>Complaint handled positively - Refund - payment processing</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=11">
                                                    <span><i class="icon-ok"></i></span>
                                                    <small>Complaint handled positively - Refund - Payout</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=12">
                                                    <span><i class="icon-ok"></i></span>
                                                    <small>Complaint handled positively - replacement for a new product</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=13">
                                                    <span><i class="icon-remove"></i></span>
                                                    <small>The return cancelled by a customer</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=14">
                                                    <span><i class="icon-remove"></i></span>
                                                    <small>Complaint has not been delivered</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=15">
                                                    <span><i class="icon-truck"></i> </span>
                                                    <small>Complaint was generated by the customer</small>
                                                </iaixsl:when>
                                                
                                                <iaixsl:when test="@status=16">
                                                    <span><i class="icon-thumbs-down-alt"></i></span>
                                                    <small>Ceasing resending order</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=17">
                                                    <span><i class="icon-box"></i></span>
                                                    <small>Complaint canceled</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=18">
                                                    <span><i class="icon-box"></i></span>
                                                    <small>Complaint canceled by the customer</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=19">
                                                    <span><i class="icon-ok"></i></span>
                                                    <small>Complaint confirmed</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=20">
                                                    <span><i class="icon-clock"></i></span>
                                                    <small>Complaint not handled</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=21">
                                                    <span><i class="icon-remove"></i></span>
                                                    <small>Complaint was rejected</small>
                                                </iaixsl:when>
                                                ...
                                                <iaixsl:when test="@status=25">
                                                    <span><i class="icon-ok"></i></span>
                                                    <small>Complaint handled positively - Return shipment sent to the customer</small>
                                                </iaixsl:when>
                                                ...
                                                <iaixsl:when test="@status=27">
                                                    <span><i class="icon-ok"></i></span>
                                                    <small>Complaint handled positively - Recipient's data change on the sales document</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=28">
                                                    <span><i class="icon-clock"></i></span>
                                                    <small>Complaint being handled - Repair completed</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=29">
                                                    <span><i class="icon-clock"></i></span>
                                                    <small>Complaint being handled - Requires additional information from the customer</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=30">
                                                    <span><i class="icon-remove"></i></span>
                                                    <small>Complaint rejected - Return shipment sent to the customer</small>
                                                </iaixsl:when>
                                                <iaixsl:otherwise>
                                                    <span><i class="icon-ok"></i></span>
                                                    <small>
                                    ...
                                    <td class="ord">
                                        <a class="btn-icon"><iaixsl:attribute name="href"><iaixsl:value-of select="@url"/></iaixsl:attribute><span><i class='icon-plus'></i></span><small>Choose</small></a>
                                    </td>
                                </tr>
                            </iaixsl:for-each>
                        </tbody>
                ...
                <div class="rma_list_data_outline">
                    ...
                    <div class="rma_list_data_addbutton">
                        <a href="rma-add.php" class="btn --solid --medium rma_list_data_addbutton">
                            ...
                            <iaixsl:attribute name="title">Add a complaint</iaixsl:attribute>
                            <span class="img_button_edytujaddbutton"/>
                            <div class="addbutton_maintxt">Add a complaint</div>
                            <div class="addbutton_sidetxt">If you have any objections regarding the quality of a bought product, please add a complaint.</div>
                        </a>
                    </div>
                                ...
                                <div id="rma_panel_close" class="rma_list_data_panel" style="display:none;">
                                    ...
                                    <iaixsl:choose>
                                        <iaixsl:when test="page/list/close/@count = 0">
                                            <span class="rma_list_noitem">No completed complaints.</span>
                                        </iaixsl:when>
                                        <iaixsl:otherwise>
                                            ...
                                            <iaixsl:for-each select="page/list/close/item">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="rma_list_item_operation">
                                                        more information <i class="icon-angle-down"></i>
                                                    </span>
                                                    <span class="rma_list_item_operation ophidden">
                                                        less information <i class="icon-angle-up"></i>
                                                    </span>
                                                </div>
                                                    ...
                                                    <div class="rma_list_item_sub">
                                                        ...
                                                        <div class="rma_list_itmesub1">
                                                            ...
                                                            <div class="rma_list_itemstatus">
                                                                <div class="rma_list_itemhead">
                                                                    <span>Current status of a complaint:</span>
                                                                </div>
                                                        ...
                                                        <div class="rma_list_itmesub2">
                                                            ...
                                                            <div class="rma_list_itemplace">
                                                                <div class="rma_list_itemhead">
                                                                    <span>The complaint being completed by:</span>
                                                                </div>
                                                                        ...
                                                                        <table class="rma_list_itemstock">
                                                                            <tbody>
                                                                                <iaixsl:if test="stock/@phone != ''">
                                                                                    <tr>
                                                                                        <td class="rma_list_itemplace1">phone no.</td>
                                                                                ...
                                                                                <iaixsl:if test="stock/@fax != ''">
                                                                                    <tr>
                                                                                        <td class="rma_list_itemplace1">fax no.</td>
                                                                    ...
                                                                    <iaixsl:if test="stock/@link !=''">
                                                                        <div class="rma_list_itemstock_link">
                                                                            <a class="rma_list_itemstock_link">
                                                                                ...
                                                                                more information <i class="icon-double-angle-right"></i>
                                                                            </a>
                                                                        </div>
                                                                    </iaixsl:if>
                                                                </div>
                                                                                ...
                                                                                <iaixsl:otherwise>
                                                                                    <iaixsl:choose>
                                                                                        ...
                                                                                        <iaixsl:when test="payment/@type = 'c' ">
                                                                                            Details for the cheque:
                                                                                        </iaixsl:when>
                                                                                        <iaixsl:when test="payment/@type = 't' ">
                                                                                            Money to be used for future purchases.
                                                                                        </iaixsl:when>
                                                                                    </iaixsl:choose>
                                                                                </iaixsl:otherwise>
                                                                            </iaixsl:choose>
                                                            ...
                                                            <div class="rma_list_itembuttons">
                                                                <iaixsl:if test="documents/postdocument ">
                                                                    <a class="btn --solid --medium rma_list_button_etykieta" target="_blank">
                                                                        ...
                                                                        <iaixsl:attribute name="title">Click here to print the address label</iaixsl:attribute>
                                                                ...
                                                                <iaixsl:if test="documents/letterofcomplaint">
                                                                    <a class="btn --solid --medium rma_list_button_wydrukuj" target="_blank">
                                                                        ...
                                                                        <iaixsl:attribute name="title">Click here to print the complaint form</iaixsl:attribute>
                                                                ...
                                                                <iaixsl:if test="@edit_link and (@edit_link != '')">
                                                                    <a class="btn --solid --medium rma_list_button_edit">
                                                                        ...
                                                                        <iaixsl:attribute name="title">Click here to edit this complaint</iaixsl:attribute>
                                                                ...
                                                                <iaixsl:if test="@cancel_link and (@cancel_link != '')">
                                                                    <a class="btn --solid --medium rma_list_button_cancel">
                                                                        ...
                                                                        <iaixsl:attribute name="title">Click here to cancel this complaint</iaixsl:attribute>
                                                        ...
                                                        <iaixsl:if test="count(staff_note/note) > 0">
                                                            <div class="rma_list_itmesub3">
                                                                <iaixsl:if test="count(staff_note/note) = 1">
                                                                    <div class="rma_list_noteslabel">Note from the on-line store staff</div>
                                                                </iaixsl:if>
                                                                <iaixsl:if test="count(staff_note/note) > 1">
                                                                    <div class="rma_list_noteslabel">Note from the on-line store staff</div>
                                                                </iaixsl:if>
                                ...
                                <div id="rma_panel_active" class="rma_list_data_panel">
                                    ...
                                    <iaixsl:choose>
                                        <iaixsl:when test="page/list/active/@count = 0">
                                            <span class="rma_list_noitem">No complaints in progress.</span>
                                        </iaixsl:when>
                                        <iaixsl:otherwise>
                    ...
                    <iaixsl:if test="(page/list/active/@count = 0) and (page/list/close/@count = 0)">
                        <span class="rma_list_noitem" id="rma_list_noitem">No complaint has been added yet.</span>
                    </iaixsl:if>
