                    ...
                    <div class="orderdetails_documentlink">
                        ...
                        <div class="documentlink_image row">
                            <div class="document_img_1 col-12 col-sm-4">
                                <img src="/gfx/eng/documentlink_1.png?r=1598273385" alt=""/>
                                <span>Print notification of the return and labels</span>
                            </div>
                            <div class="document_img_2 col-12 col-sm-4">
                                <img src="/gfx/eng/documentlink_2.png?r=1598273385" alt=""/>
                                <span>Prepare the package. Join return form.</span>
                            </div>
                            <div class="document_img_3 col-12 col-sm-4">
                                <img src="/gfx/eng/documentlink_3.png?r=1598273385" alt=""/>
                                <span>Give the package. For giving anything extra you pay.</span>
                            </div>
                        </div>
                        <iaixsl:if test="/shop/page/documentlink/@url">
