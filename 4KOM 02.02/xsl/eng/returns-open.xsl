...
<div id="account_icon"><a href="/login.php"><i class="icon-account"></i></a></div>
        ...
        <!--Returns Open Form (returns_open_form, 108776.1)-->

            <section id="returnsOpen" class="form-open">
                <div class="big_label mb-3">
                    Select the order from which you want to return products
                </div>

                <div class="menu_messages_message mb-4">
                    <iaixsl:choose>
                ...
                <iaixsl:choose>
                    <iaixsl:when test="/shop/page/returns-open/@returns_exist_link and not(/shop/page/returns-open/@returns_exist_link = '')">
                        <div class="d-flex align-items-center flex-column">
                            <a class="btn --solid --medium mx-3 mb-3">
                        ...
                        <form class="row flex-column align-items-center" action="/returns-open.php" method="POST">
                            <div class="form-group col-12 col-sm-6 mb-3">
                                <div class="has-feedback has-required">
                                    ...
                                    <label for="returns_id" class="control-label">
                                        Order number
                                    </label>
                            ...
                            <div class="form-group col-12 col-sm-6 mb-3">
                                <div class="has-feedback has-required">
                                    ...
                                    <label for="returns_contact" class="control-label">
                                        Your phone or email
                                    </label>
                                    <span class="form-control-feedback"/>
                                </div>
                            </div>
                            <div class="form-summary col-12">
                                <div class="form-buttons">
                                    <button class="btn --solid --medium">
                                        Find an order
                                    </button>
                                    <div class="button_legend">
                                        <i class="icon-need"></i> Fields marked with an asterisk are required
                                    </div>
                                </div>
                                <div class="client_account_found">
                                    <a class="client_orders">
