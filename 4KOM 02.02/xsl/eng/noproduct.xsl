...
<div id="account_icon"><a href="/login.php"><i class="icon-account"></i></a></div>
        ...
        <iaixsl:choose>
                    ...
                    <div class="noproduct_form_sub">
                        <form id="noproduct_form" method="post" novalidate="novalidate">
                            ...
                            <div class="noproduct_form_desc">
                                Use the below form to send us a description of a product you have not found. Enter the product name and/or its short description and we will let you know by e-mail when this particual product is available in our on-line shop.
                            </div>
                            ...
                            <div class="noproduct_form_submit">
                                <a class="btn --solid --large noproduct_form_submit mb-1">
                                    <iaixsl:attribute name="title">Click here to send us information about the searched product</iaixsl:attribute>
                                    Send
                                </a>
                            ...
                            <div class="noproduct_form_desc2">
                                Before asking about a new product, make sure that it does not already appear on your <a href="products-requests.php" title="Go to the list of requested products">list of requested products</a>.
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <iaixsl:otherwise>
                <div class="noproduct_form_outline">
                    ...
                    <div class="noproduct_form_sub">
                        <p class="noproduct_form_notlogged">If you have not found a product that you are interested in and you would like to buy it in our on-line store, use a special form and send us the description of this product. To do this, you need to <a class="loginPopUpShow" href="signin.php">sign in</a>.</p>
                    </div>
                </div>
            </iaixsl:otherwise>
        </iaixsl:choose>
                            ...
                            <iaixsl:when test="/shop/page/additional/hotspot/products_zone1/product or /shop/page/additional/hotspot/products_zone1/opinion">
                                <iaixsl:choose>
                                    <iaixsl:when test="/shop/page/additional/hotspot/products_zone1/@link">
                                        <a class="big_label">
                                            <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/additional/hotspot/products_zone1/@link"/></iaixsl:attribute><iaixsl:attribute name="title">Click here to view all products</iaixsl:attribute>
                                            <iaixsl:choose><iaixsl:when test="/shop/page/additional/hotspot/products_zone1/@name"><iaixsl:value-of select="/shop/page/additional/hotspot/products_zone1/@name"/></iaixsl:when><iaixsl:otherwise>Special offers</iaixsl:otherwise></iaixsl:choose>
        ...
        <!--Brak produktów - cms (noproduct_cms, 107918.1)-->
            <iaixsl:if test="page/text/body">
                <div class="big_label">
                    Why is it worth to ask about new products
                </div>
