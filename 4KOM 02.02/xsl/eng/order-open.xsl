...
<div id="account_icon"><a href="/login.php"><i class="icon-account"></i></a></div>
        ...
        <div class="order_open_form_wrapper">
            ...
            <p>To check the order status, enter its number (you can find it in the e-mail which you have received after placing an order) and your phone number or e-mail address.</p>
            ...
            <a href="/login.php">I have an account and I want to go to the list of my orders.</a>
