...
<div id="account_icon"><a href="/login.php"><i class="icon-account"></i></a></div>
        ...
        <!--RMA - open (rma_open_form, 108756.1)-->

            <section id="rmaOpen" class="form-open">
                <div class="big_label mb-4">
                    Choose the order from which you want to make a complaint
                </div>
                ...
                <div class="menu_messages_message mb-4">
                    <iaixsl:choose>
                        <iaixsl:when test="/shop/page/rma-open/@rma_exist_link and not(/shop/page/rma-open/@rma_exist_link = '')">
                            A complaint has already been generated for this order. Please check the status of current applications or add another one from the Complaints panel.
                        </iaixsl:when>
                        <iaixsl:when test="/shop/page/rma-open/@client = 'false' or /shop/page/rma-open/@client_orders = 'true'">
                            To return products, enter the order number in which it was sent (you will find it in the e-mail you received after placing the order) and the phone number or e-mail address.
                        </iaixsl:when>
                        <iaixsl:otherwise>
                            No order has been placed on this account. Therefore, you cannot start the complaint generation procedure. If you want to advertise an order processed from another account or without registration, please fill in the form below.
                        </iaixsl:otherwise>
                    </iaixsl:choose>
                </div>
                ...
                <iaixsl:choose>
                    ...
                    <iaixsl:otherwise>
                        <form class="row flex-column align-items-center" action="/rma-open.php" method="POST">
                            <div class="form-group col-12 col-sm-6 mb-3">
                                <div class="has-feedback has-required">
                                    <input id="rma_id" name="id" class="form-control" type="text" required="required"/>
                                    <label for="rma_id" class="control-label">
                                        Order number
                                    </label>
                            ...
                            <div class="form-group col-12 col-sm-6 mb-3">
                                <div class="has-feedback has-required">
                                    <input id="rma_contact" name="contact_type" class="form-control" type="text" required="required">></input>
                                    <label for="rma_contact" class="control-label">
                                        Your phone or email
                                    </label>
                                    <span class="form-control-feedback"/>
                                </div>
