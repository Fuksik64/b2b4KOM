...
<div id="account_icon"><a href="/login.php"><i class="icon-account"></i></a></div>
    ...
    <!--Błędy i informacje w projektorze (menu_messages, 106608.1)-->
        ...
        <!--Zamówienie niestandardowe - CMS (order_nonstandardized_cms, 108076.1)-->
        ...
        <!--Zamówienie niestandardowe - złożenie zamówienia (order_nonstandardized_form, 108077.1)-->
            <iaixsl:if test="page/action/order/@link">
                <a class="btn --large --solid --icon-right icon-angle-right n59299_link" href="/order2.php?preview=true">
                    Next
                </a>
                <div class="n59299_text">The cost of delivery will be calculated after the order is accepted.</div>
            </iaixsl:if>
