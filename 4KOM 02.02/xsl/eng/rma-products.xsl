                                        ...
                                        <td class="productslist_product_comment">
                                            <iaixsl:if test="not(@allowReturn='0') and not(@allowReturn='2')">
                                                <a href="#addComment">
                                                    ...
                                                    <i class="icon-paper-clip"></i> <span>Descriptopn of<br/> complaint</span>
                                                </a>
                                            </iaixsl:if>
                                        </td>
                                                ...
                                                <div>
                                                    <iaixsl:choose>
                                                        ...
                                                        <iaixsl:otherwise>
                                                            ...
                                                            <a class="choose_prod btn-icon" href="#"><span><i class="icon-plus"></i></span><small>Add a complaint</small></a>
