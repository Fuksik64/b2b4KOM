...
<iaixsl:if test="page/resources">
<div class="affiliate_resources_label">
<iaixsl:attribute name="class">big_label affiliate_resources_label</iaixsl:attribute>
    <span class="affiliate_resources_label">
    Ihre freien Mittel
    </span>
</div>
<input type="hidden" id="payment_min"/>
<iaixsl:choose>
    <iaixsl:when test="(0 > page/payments/@total) or (page/payments/@total = '0.00')">
        <span class="affiliate_noresources">Im Moment haben Sie keine Mittel zur Auszahlung.</span>
    </iaixsl:when>
    <iaixsl:otherwise>
         <div class="affiliate_resources_wyplata">
            Aktueller Stand Ihres Partnerkontos beträgt
            <ol>
                <li>
                    Vollständiger Kontostand: 
                    <strong class="resources_total"><iaixsl:value-of select="page/payments/@total_formatted"/></strong>
                </li>
                <li>
                    Gesamtsumme der reduzierten Provisionen aus Warenrückgaben: 
                    <strong class="resources_returned"><iaixsl:value-of select="page/payments/@returns_formatted"/></strong>
                </li>
            </ol>
            <iaixsl:if test="page/client/@loyalty_points = 'true'">
                 Die Provision für Bestellungen von gewonnenen Kunden wird in Form von Punkten auf Ihr<a href="/affiliate-main.php">Saldo im Loyalitätsprogramm</a> ausgezahlt. 
            </iaixsl:if>
                Wenn Sie die gesammelten Mittel gegen Warengutschein tauschen möchten, geben Sie unten einen Betrag ein, der nicht niedrieger ist als  
                <span class="resources_minpayment">
                    <iaixsl:value-of select="page/shop/@minpayment"/><iaixsl:value-of select="/shop/currency/@name"/>
                </span>
                <span> und nicht höher als die auf Ihrem Konto gesammelten Mittel. Anschließend klicken Sie auf die Schaltfläche "Kommission Zahlungsantrag".</span>
                <form method="POST">
                    <input type="hidden" name="max" id="affiliate_max">
                        <iaixsl:attribute name="value" id="affiliate_max">
                            <iaixsl:value-of select="page/payments/@total"/>
                        </iaixsl:attribute>
                    </input>
                    <input type="hidden" name="min" id="affiliate_min">
                        <iaixsl:attribute name="value" id="affiliate_min">
                            <iaixsl:value-of select="page/shop/@minpayment"/>
                        </iaixsl:attribute>
                    </input>
                    <div class="affiliate_resources_payment">
                        <div class="affiliate_resources_payment_sub">
                            <span class="affiliate_resources_kwota_label">Der Betrag für Rückerstattung beträgt </span>
                            <input class="affiliate_resources_kwota1" type="text" name="amount" maxlength="10" value="0" id="affiliate_resources_kwota1"/>
                            <span class="affiliate_przecinek">,</span>
                            <input class="affiliate_resources_kwota2" type="text" name="cent" value="00" maxlength="2"/>
                            <span class="affiliate_resources_waluta"><iaixsl:value-of select="/shop/currency/@name"/></span>
                            <div id="affiliate_warning1" style="display:none;">
                                <div id="affiliate_warning1_sub">
                                    Der von Ihnen angegebene Betrag ist zu hoch 
                                </div>
                            </div>
                            <div id="affiliate_warning2" style="display:none;">
                                <div id="affiliate_warning2_sub">
                                    Der von Ihnen angegebene Betrag ist zu niedrig 
                                </div>
                            </div>
                            <div class="clear"/>
                        </div>
                    ...
                    <div class="affiliate_resources_payment_type">
                        <iaixsl:choose>
                            <iaixsl:when test="page/client/@paymenttype = 'cash'">
                                <input type="radio" value="voucher" name="method" checked="checked"/>
                                Gutschein 
                                <input type="radio" value="cash" name="method"/>
                                Überweisung
                            </iaixsl:when>
                            <iaixsl:otherwise>
                                Der obige Wert wird in Form eines Gutscheins ausgezahlt.
                            </iaixsl:otherwise>
                        </iaixsl:choose>
                    </div>
                    <input type="submit" class="btn --solid --medium affiliate_resources_submit" id="affiliate_resources_submit">
                                <iaixsl:attribute name="value">Kommission Zahlungsantrag</iaixsl:attribute>
                    </input>
                </form>
        </div>
    </iaixsl:otherwise>
...
<iaixsl:if test="page/resources/resource">
        <table class="affiliate_resources">
          <iaixsl:attribute name="class">ui-responsive table-stroke ui-table ui-table-reflow affiliate_resources</iaixsl:attribute>
            <thead>
                <tr>
                    <th>Auszahlungsdatum</th>
                    <th>Art der Auszahlung</th>
            ...
            <iaixsl:for-each select="page/resources/resource">
                <tr>
                    <td>
                  ...
                  <td>
                    <span><iaixsl:value-of select="@idkey"/></span>
                  </td>
                  <td>
                    <iaixsl:choose>
                      <iaixsl:when test="@expire_date = '0000-00-00'">
                        Unbefristet
                      </iaixsl:when>
                      <iaixsl:when test="@expire_date = ''">
                        -
                      </iaixsl:when>
                      <iaixsl:otherwise>
                        <iaixsl:value-of select="@expire_date"/>
                      </iaixsl:otherwise>
                    </iaixsl:choose>
                  </td>
                  <td>
                    <iaixsl:value-of select="@amount_formatted"/>
                  </td>
                  <td>
                    <iaixsl:value-of select="@used_formatted"/>
                  </td>
                  <td>
                    <div class="affiliate_resources_status">
                    <iaixsl:choose>
                      <iaixsl:when test="@status = 'n'">
                          <div class="affiliate-icon-status badge-important">
                      ...
                      <iaixsl:when test="@status = 'y'">                        
                        <div class="affiliate-icon-status badge-success">
                          <i class="icon-ok"></i>
                        </div>
                          <span>
                          Eingelöst
                      ...
                      <iaixsl:when test="@status = 'b'">                        
                        <div class="affiliate-icon-status badge-warning">
                      ...
                      <iaixsl:when test="@status = '0000-00-00'">
                         <div class="affiliate-icon-status badge-warning">
                      ...
                      <iaixsl:when test="@status = 'Odrzucono'">                        
                        <div class="affiliate-icon-status badge-important">
                          <i class="icon-remove"></i>
                        </div>
                          <span>
                      ...
                      <iaixsl:otherwise>                       
                        <div class="affiliate-icon-status badge-success">
                         ...
                         <span> 
                          Bestätigt <small>(<iaixsl:value-of select="@status"/>)</small>
                         </span> 
                      </iaixsl:otherwise>
                    </iaixsl:choose>
                  </div>
...
<!--Środki do wykorzystania - stronicowanie listy wypł (affiliate_resources_paging, 110553.1)-->
