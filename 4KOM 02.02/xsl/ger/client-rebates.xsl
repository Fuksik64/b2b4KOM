    ...
    <!--Rabaty klienta - informacje (client_rebates_info, 107782.1)-->
        ...
        <div id="client_rebates_info" class="n58425">
                ...
                <div class="form-code-card">
                    ...
                    <iaixsl:variable name="cardform">
                        <form class="rabat-code form-group" action="settings.php?from=client_rebate" method="post">
                            ...
                            <div class="has-feedback">
                                ...
                                <label class="control-label">Rabattkartennummer</label>
                            </div>
                            <button class="btn --large --solid" type="submit" value="">Aktivieren</button>
                        </form>
                    </iaixsl:variable>
                    <iaixsl:variable name="codform">
                        <form class="rabat-card form-group" action="settings.php?from=client_rebate" method="post">
                            ...
                            <div class="has-feedback">
                                ...
                                <label class="control-label">Rabattcodenummer</label>
                            </div>
                            <button class="btn --large --solid" type="submit" value="">Aktivieren</button>
                        </form>
                    </iaixsl:variable>
                                ...
                                <div class="col-sm-6 col-12">
                                    ...
                                    <iaixsl:if test="/shop/rebate_card_delete_client_advanced_rebate/@active = 'y' or /shop/rebate_card_delete_rebate_for_profit_points/@active = 'y' ">
                                        <div class="form-code-carsub_info">
                                            <span class="icon-stack"><i class="icon-sign-blank"></i><i class="icon-question icon-light"></i></span> Nach der Aktivierung der Rabattkarte wird der auf Ihrem Konto verfügbare Rabatt in der Bestellung nicht berücksichtigt.
                                        </div>
                                    </iaixsl:if>
                                </div>
                            </iaixsl:if>
                            ...
                            <iaixsl:if test="not(page/rebate_code/@type='rebate')">
                                <div class="col-sm-6 col-12">
                                    ...
                                    <iaixsl:if test="/shop/rebate_code_delete_client_advanced_rebate/@active = 'y' or /shop/rebate_code_delete_rebate_for_profit_points/@active = 'y' ">
                                        <div class="form-code-carsub_info">
                                            <span class="icon-stack"><i class="icon-sign-blank"></i><i class="icon-question icon-light"></i></span> Nach der Aktivierung des Rabattcodes wird der auf Ihrem Konto verfügbare Rabatt in der Bestellung nicht berücksichtigt.
                                        </div>
                                    </iaixsl:if>
                                </div>
                            </iaixsl:if>
                    ...
                    <iaixsl:if test="page/rebate_code/@type='rebate'">
                        <div class="active-code-wrapper">
                            <h2 class="big_label">
                                 Schriftliche Rabatt-Code für diesen Auftrag
                            </h2>
                            <div class="active-code n67313_out">
                                ...
                                <div class="rabate-button">
                                    <a class="btn --solid" id="n67313_a_change_code" href="#">Ändern Sie die Kartennummer</a>
                        ...
                        <div class="active-code-wrapper">
                            ...
                            <iaixsl:for-each select="/shop/page/discount_cards/item[@number = /shop/page/rebate_code[@type='card_discount']/@number]">
                                <div class="active-code n67313_out">
                                    ...
                                    <div class="rabate-button">
                                        <a class="btn --solid" id="n67313_a_change_cart" href="#">Ändern Sie die Kartennummer</a>
                                    </div>
                                </div>
                            </iaixsl:for-each>
                        </div>
                                        ...
                                        <div class="active-code n67313_out">
                                            ...
                                            <div class="code-info">
                                                <ul class="code-details">
                                                    <iaixsl:if test="@number">
                                                        ...
                                                        <li>
                                                            <span>
                                                                Gültigkeitsdatum der Karte<iaixsl:value-of select="@expires"/>
                                                            </span>
                                                        </li>
                                                    </iaixsl:if>
                                                </ul>
                                            ...
                                            <div class="rabate-form">
                                                <form class="rabat-code" action="settings.php?from=client_rebate" method="post">
                                                    ...
                                                    <button class="btn --solid" type="submit" value="">Aktivieren</button>
                                                </form>
                                            </div>
                                        </div>
                                    </iaixsl:if>
                                            ...
                                            <iaixsl:choose>
                                                <iaixsl:when test="@active = 'y'">
                                                    <b class="card-status-active">
                                                        <i class="icon-ok-sign"></i> aktiv
                                                    </b>
                                                </iaixsl:when>
                                                <iaixsl:when test="@active = 'n'">
                                                    <b class="card-status-inactive">
                                                        <i class="icon-remove-sign"></i> inaktiv
                                                    </b>
                                                </iaixsl:when>
                                            </iaixsl:choose>
                                        </div>
            ...
            <iaixsl:if test="page/rebates/range_rebate/range and not(/shop/page/basket_rebate/range)">
                <div class="n67313_out">
                    <div class="n67313_label_b">
                        <span class="n67313_label_l">Staffelrabatt</span>
                        <div class="n67313_label_r">
                            Wird anhand des Warenkorbwerts berechnet. 
                            <iaixsl:choose>
                    ...
                    <div class="n67313_border">
                        <div class="n67313_rebate_l">
                            Bestellwert über 
                            <span class="n67313_label_r">Rabatthöhe</span>
                            <iaixsl:if test="page/basket_rebate/range/@points != '0.00'">
                                <span class="n67313_label_r">Punktebonus</span>
                            </iaixsl:if>
                        </div>
            ...
            <iaixsl:if test="page/global_rebate">
                <div class="n67313_out">
                    <div class="n67313_label_b">
                        <span class="n67313_label_l">Kumulativer Rabatt</span>
                        <div class="n67313_label_r">
                            <iaixsl:choose>
                                <iaixsl:when test="page/global_rebate/@order_days">
                                    Wird anhand des Gesamtwerts der in den letzten<iaixsl:value-of disable-output-escaping="yes" select="page/global_rebate/@order_days"/> Tagen gekauften Produkte berechnet.
                                </iaixsl:when>
                                <iaixsl:otherwise>
                                    Wird anhand des Gesamtwerts der zuvor gekauften Produkte berechnet<br />
                                </iaixsl:otherwise>
                            </iaixsl:choose>
                            <iaixsl:choose>
                    ...
                    <div class="n67313_border">
                        <div class="n67313_rebate_l">
                            Bestellwert über <span class="n67313_label_r">Rabatthöhe</span>
            ...
            <iaixsl:choose>
                <iaixsl:when test="page/rebates/@type = 'r'">
                    ...
                    <iaixsl:if test="not(page/rebates/other/@value = '0.00')">
                        <div class="n67313_out">
                            <div class="n67313_label_b">
                                <span class="n67313_label_l">Allgemeiner Rabatt</span>
                            </div>
                            <div class="n67313_border">
                                <iaixsl:if test="not(page/rebates/other/@value = '0.00')">
                                    <div class="n67313_rebate_l">
                ...
                <iaixsl:when test="(page/rebates/@type = 'z') and ((page/rebates/category) or (page/rebates/producer) or (page/rebates/series))">
                    <div class="n67313_out">
                        <iaixsl:if test="(page/rebates/category) or (page/rebates/producer) or (page/rebates/series)">
                            <div class="n67313_label_b">
                                <span class="n67313_label_l">Gruppenrabatt</span>
                                <div class="n67313_label_r">
                                    Gruppenrabatte sind nicht kombinierbar. Im Fall der Überlagerung wird der höchste Wert genommen.
                                </div>
                            </div>
                        </iaixsl:if>
                        <div class="n67313_border">
                    ...
                    <iaixsl:if test="page/rebates/product">
                        <div class="n67313_out">
                            <div class="n67313_label_b">
                                <span class="n67313_label_l">Detaillierter Rabatt</span>
                                <iaixsl:choose>
                                    <iaixsl:when test="((page/rebates/category) or (page/rebates/producer) or (page/rebates/series)) and ((page/rebates/other) and not(page/rebates/other/@value = '0.00'))">
                                        <div class="n67313_label_r">
                                            Der detaillierte Rabatt hat Vorrang vor dem allgemeinen Rabatt und dem Gruppenrabatt.
                                        </div>
                                    </iaixsl:when>
                                    <iaixsl:when test="((page/rebates/category) or (page/rebates/producer) or (page/rebates/series)) and not((page/rebates/other) and not(page/rebates/other/@value = '0.00'))">
                                        <div class="n67313_label_r">
                                            Der detaillierte Rabatt hat Vorrang vor dem Gruppenrabatt.
                                        </div>
                                    </iaixsl:when>
                                    <iaixsl:when test="((page/rebates/other) and not(page/rebates/other/@value = '0.00')) and not(page/rebates/category) and not(page/rebates/producer) and not(page/rebates/series)">
                                        <div class="n67313_label_r">
                                            Der detaillierte Rabatt hat Vorrang vor dem allgemeinen Rabatt.
                                        </div>
                                    </iaixsl:when>
                                </iaixsl:choose>
                            </div>
                ...
                <iaixsl:when test="(page/rebates/@type = 'p' or page/rebates/@type = 'z' or page/rebates/@type = 'b') and (page/rebates/other/@value = '0.00') and (page/rebates/global/@value = '0.00') and (page/rebates_codes/@active = 'n')">
                    <div class="menu_messages_message">
                        Im Moment haben Sie keinen Rabatt. Machen Sie sich bitte mit    
                        <a href="/terms.php">
                            den Allgemeinen Geschäftsbedingungen sowie den Rabattschwellen
                        </a>
                        in unserem Shop vertraut.
                    </div>
                </iaixsl:when>
                <iaixsl:otherwise>
                    <iaixsl:if test="not(page/rebates/other/@value = '0.00')">
            ...
            <iaixsl:if test="page/rebate_code/@active = 'y' or page/rebates_for_points/rebate">
                ...
                <div class="n67313_out">
                    ...
                    <iaixsl:if test="page/rebates_for_points/rebate">
                        ...
                        <div class="n67313_rebate_l">Punkte gegen Rabatt tauschen</div>
                                            ...
                                            <div class="n67313_other_info">
                                                <iaixsl:choose>
                                                    <iaixsl:when test="@calculate_from_price='client_price' and @price_type='net'">
                                                        Der Rabatt wird anhand des Preises berechnet
                                                    </iaixsl:when>
                                                    <iaixsl:when test="@calculate_from_price='suggested_retail_price'">
                                                        Der Rabatt wird anhand des empfohlenen Einzelhandelspreises berechnet
                                                    </iaixsl:when>
                                                    <iaixsl:when test="@calculate_from_price='crossed_out_price'">
                                                        Der Rabatt wird anhand des durchgestrichenen Preises berechnet
                                                    </iaixsl:when>
                                                </iaixsl:choose>
                                                <iaixsl:choose>
                                ...
                                <div class="n67313_rebate_info">
                                    ...
                                    <iaixsl:choose>
                                        <iaixsl:when test="page/rebate_code/shipping_cost_rebate/@price_type='net'">
                                            <div class="n67313_other_info">
                                                Der Versandkostenrabatt wird anhand des Nettopreises berechnet
                                            </div>
                                        </iaixsl:when>
                                    </iaixsl:choose>
                                </div>
