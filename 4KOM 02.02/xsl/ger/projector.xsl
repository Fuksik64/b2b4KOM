...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 107421.1)-->
            ...
            <iaixsl:if test="(action/set_render/item/@name = 'popup') or not(action/set_render/item)">
                ...
                <script src="/gfx/ger/projector_details.js.gzip?r=1598273390"></script><script src="/gfx/ger/projector_bundle_zone.js.gzip?r=1598273390"></script><script src="/gfx/ger/projector_product_questions.js.gzip?r=1598273390"></script><script src="/gfx/ger/projector_photos.js.gzip?r=1598273390"></script></head>
...
<div id="account_icon"><a href="/login.php"><i class="icon-account"></i></a></div>
    ...
    <!--Dokładne dane o produkcie (projector_details, 111637.1)-->
            ...
            <iaixsl:variable name="brutto_bundle_txt"> ausgewählte Brutprodukten</iaixsl:variable>
            ...
            <script class="ajaxLoad">
                app_shop.vars.thumbnailsCount = <iaixsl:value-of select="$thumbnailsCount"/>;
                cena_raty = <iaixsl:value-of select="page/projector/product/price/@value"/>;
                <iaixsl:if test="/shop/page/projector/product/traits/trait/@groupid = '1980' ">
                    app_shop.vars.caseBackground = '<iaixsl:value-of select="page/projector/product/traits/trait[@groupid = '1980']/@traitdescription "/>';
                </iaixsl:if>
        ...
        <iaixsl:if test="page/projector/product/traits/trait[@groupid = '1243']">
            <script type="text/javascript">
                app_shop.vars.modelParams = [];
                <iaixsl:for-each select="page/projector/product/traits/trait[@groupid = '1243']">
                    app_shop.vars.modelParams.push('<iaixsl:value-of select="@traitdescription"/>');
                </iaixsl:for-each>
            </script>
        </iaixsl:if>
            ...
            <iaixsl:choose>
                <iaixsl:when test="/shop/page/projector/product/traits/trait[@groupid = 826]/@traitid = 827"> creator</iaixsl:when>
                <iaixsl:when test="/shop/page/projector/product/traits/trait[@groupid = 826]/@traitid = 832"> creator initProduct</iaixsl:when>
            </iaixsl:choose>
                </iaixsl:attribute>
                ...
                <div id="projector_photos" class="photos col-12 col-md-7 pb-4">
                    ...
                    <iaixsl:variable name="bundledCount"><iaixsl:value-of select="count(/shop/page/projector/bundled/product)"/></iaixsl:variable>
                    <iaixsl:variable name="imagesSum"><iaixsl:value-of select="$enclosureCount + $bundledCount"/></iaixsl:variable>
                    <iaixsl:if test="($enclosureCount > 0) or /shop/page/projector/bundled/product">
                        <div id="slider-nav" class="enclosures align_row slider-nav slider d-none d-md-flex" data-align="img#css">
                            ...
                            <iaixsl:if test="($imagesSum > $thumbnailsCount)">
                                <iaixsl:attribute name="data-more-slides"><iaixsl:value-of select="$enclosureCount + $bundledCount - $thumbnailsCount"/></iaixsl:attribute>
                            </iaixsl:if>
                            <iaixsl:for-each select="/shop/page/projector/product/enclosures/images/enclosure">
                                <iaixsl:if test="(not(position() > $thumbnailsCount))">
                                    <a class="thumb_link">
                                        <iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="@url"/></iaixsl:attribute>
                                        <iaixsl:choose>
                                            <iaixsl:when test="(position() = $thumbnailsCount and $imagesSum > $thumbnailsCount)">
                                                <iaixsl:attribute name="data-more"><iaixsl:value-of select="$enclosureCount + $bundledCount - $thumbnailsCount + 1"/></iaixsl:attribute>
                                                <iaixsl:attribute name="class">thumb_link gallery_details</iaixsl:attribute>
                                                <div class="gallery_more">
                                                    <span class="gallery_top">
                                                        <span class="gallery_text">+</span>
                                                        <span class="gallery_items">
                                                            <iaixsl:value-of select="$enclosureCount + $bundledCount - $thumbnailsCount + 1"/>
                                                        </span>
                                                    </span>
                                                    <span class="gallery_text2">Bilder</span>
                                                </div>
                                            </iaixsl:when>
                                            <iaixsl:otherwise>
                            ...
                            <iaixsl:for-each select="/shop/page/projector/bundled/product">
                                ...
                                <iaixsl:if test="(not($positionCount > $thumbnailsCount)) and enclosures/images/enclosure[1]/@icon">
                                    <a class="thumb_link">
                    ...
                    <iaixsl:if test="$enclosureCount > 0">
                ...
                <div id="projector_details" class="product_info col-12 col-md-5">
                    ...
                    <iaixsl:if test="not(page/projector/product/firm/@name = '')">
                        <div class="producer item_info">
                            <a class="brand">
                                ...
                                <iaixsl:choose>
                                    <iaixsl:when test="/shop/page/projector/product/firm/@icon">
                                        <img>
                    ...
                    <iaixsl:variable name="addYourOwn">Fügen Sie Ihre Meinung hinzu</iaixsl:variable>
					 <iaixsl:if test="not(page/projector/comments/notes/complex/item/@avg) and page/projector/comments/@all > 0">
						 <div class="opinions_wrapper projector_info_opinions_wrapper">
							<div class="note">
								...
								<a href="#opinions_section" class="opinion_link">
									Anzahl der Bewertungen: <iaixsl:value-of disable-output-escaping="yes" select="page/projector/comments/@all"/>
								</a>
                                <iaixsl:if test="$addYourOwn and not($addYourOwn = '')">
                                    <a href="#opinions_section" id="projector_opinion_add" class="btn">Fügen Sie Ihre Meinung hinzu</a>
                                </iaixsl:if>
                    ...
                    <iaixsl:if test="(page/projector/product/versions/@count > 0) and (count(page/projector/product/multiversions/multi_version) = 1)">
                        <iaixsl:choose>
                            <iaixsl:when test="page/projector/product/versions/@count > 9">
                            ...
                            <iaixsl:otherwise>
                                <div class="product_section versions versions_buttons">
                                    <label class="select_button_label"><iaixsl:value-of select="page/projector/product/versions/@name"/></label>
<select class="s_versions__select --versions --small-md" name="proj_versions">
                                    <iaixsl:for-each select="page/projector/product/versions/version">
                            <option><iaixsl:if test="@id = /shop/page/projector/product/@id"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if><iaixsl:attribute name="value"><iaixsl:value-of select="@link"/></iaixsl:attribute><iaixsl:value-of select="@name"/></option>
                                    </iaixsl:for-each>
</select>
                  ...
                  <div class="product_section_sub">
                    <iaixsl:choose>
                      <iaixsl:when test="(count(/shop/page/projector/product/sizes/size) > 6) and (not($sizes_projector = '0'))">
                      ...
                      <iaixsl:otherwise>
                        <label class="select_button_label">Größe</label>
                        <iaixsl:for-each select="page/projector/product/sizes/size">
                          <iaixsl:choose>
                ...
                <iaixsl:if test="((page/projector/text_sizesgroup) and (page/projector/text_sizesgroup != '')) or /shop/page/projector/product/sizes_chart">
                    <div class="product_section show_size" id="projector_show_size">
                        <div class="product_section_sub">
                            <a href="#show_size_cms" class="show_size_cms">Größentabelle - überprüfen Sie, welche Größe Sie benötigen.</a>
                        </div>
                    </div>
                </iaixsl:if>
                    ...
                    <div class="projector_product_status_wrapper">
                        ...
                        <iaixsl:if test="not(/shop/page/projector/product/@product_type = 'product_service')">
                            <div id="projector_shipping_info">
                                ...
                                <a class="shipping_info btn" href="#shipping_info">
                    ...
                    <div id="projector_prices_wrapper">
                        ...
                        <div class="product_section" id="projector_price_srp_wrapper">
                            <iaixsl:if test="not(page/projector/product/price/@srp) and not(/shop/page/projector/product/sizes/size[@selected='true']/price/@srp_formatted)">
                                <iaixsl:attribute name="style">display:none;</iaixsl:attribute>
                            </iaixsl:if>
                            ...
                            <div>
                                <span class="projector_price_srp" id="projector_price_srp">
                                    <iaixsl:choose>
                                        <iaixsl:when test="/shop/page/projector/product/sizes/size[@selected='true']/price/@srp_formatted">
                                            <iaixsl:value-of select="/shop/page/projector/product/sizes/size[@selected='true']/price/@srp_formatted"/>
                                        </iaixsl:when>
                                        <iaixsl:otherwise>
                        ...
                        <div class="product_section" id="projector_price_value_wrapper">
                            ...
                            <div class="projector_price_subwrapper">
                                    ...
                                    <div class="rebate_number pt-3" id="projector_rebateNumber">
                                        <iaixsl:for-each select="page/projector/product/sizes/size[1]/price/rebateNumber/rebate">
                                            <div class="rebate_number__item">
                                                ...
                                                <span class="rebate_number__from"><iaixsl:value-of select="format-number(@threshold, '#')"/></span>
                                                ...
                                                <span class="rebate_number__literal --sixth">% - </span>
                                ...
                                <iaixsl:if test="/shop/page/projector/product/firm/@name != 'dreamCase' ">
                        ...
                        <iaixsl:if test="page/projector/product/sizes/@unit_sellby != '1'">
                            <div id="projector_sellbyrecount" class="projector_sellbyrecount product_section">
                                ...
                                <span>
                                    ...
                                    <span id="projector_sellbyprice_wrapper" style="display:none;"><br/>( <span id="projector_sellbyprice"><iaixsl:value-of select="/shop/page/projector/product/price/@price_formatted"/></span> / 1<iaixsl:value-of select="page/projector/product/sizes/@unit"/> )</span>
                                </span>
                            </div>
                        </iaixsl:if>
                        ...
                        <iaixsl:if test="$advanceprice_txt and page/projector/product/price/@advanceprice_formatted">
                            <div id="projector_advanceprice_wrapper">
                                <iaixsl:value-of disable-output-escaping="yes" select="$advanceprice_txt"/><b id="projector_advanceprice"><iaixsl:value-of select="page/projector/product/price/@advanceprice_formatted"/></b> einzuzahlen. Genaue Informationen erhalten Sie in der Zusammenfassung der Bestellung, vor deren Abschicken.
                            </div>
                        </iaixsl:if>
                    </div>
                    ...
                    <div class="product_section tell_availability" id="projector_tell_availability">
                        ...
                        <div class="product_section_sub">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn --solid --large --secondary">
                    ...
                    <div id="projector_buy_section" class="product_section">
                        ...
                        <div class="projector_buttons" id="projector_buttons">
                            ...
                            <button class="btn --solid --large --secondary projector_butttons_buy" id="projector_button_basket" type="submit">
                            ...
                            <a href="#add_favorite" class="projector_buttons_obs btn" id="projector_button_observe">
                                <iaixsl:attribute name="title">Auf die Wunschliste</iaixsl:attribute>
                                Auf die Wunschliste
                            </a>
                            <iaixsl:if test="/shop/compare/@active = 'y'">
                                <a class="projector_prodstock_compare btn">
                ...
                <iaixsl:if test="/shop/@trust_level = '1'">
                    <div id="superfairshop_info">
                        <div class="superfairshop_info_wrapper">
                            <div>
                                <img src="/gfx/ger/iai_security_supershop.png?r=1598273390" alt="SuperFair.Shop badge"/>
                                <strong>
                                ...
                                <td class="product_bundle_price_gross">
                                    <iaixsl:choose>
                                        <iaixsl:when test="price/@value > 0">
                                            ...
                                            <small>Sie sparen (<iaixsl:value-of select="bundle_price/@percent_diff"/>%)</small>
                                        </iaixsl:when>
                                        <iaixsl:otherwise>
                                            <a href="contact.php">Preis auf Anfrage</a>
                                        </iaixsl:otherwise>
                                    </iaixsl:choose>
                                </td>
                            </tr>
        ...
        <!--Karta produktu - bannery (projector_banner, 106656.1)-->
            <iaixsl:if test="page/projector/returns_config/@active='y' or page/projector/product/payment/instalment or page/projector/product/sizes_version/@stocks_link or page/projector/product/sizes/@stocks_link and not(/shop/page/projector/product/price/@value = 0)">
                <div id="n67367" class="clearfix">
                    ...
                    <iaixsl:if test="page/projector/returns_config/@active='y' and not(page/projector/product/@product_type = 'product_virtual' or page/projector/product/@product_type = 'product_service')">
                        <div id="n67367_returns" class="n67367_returns">
                            ...
                            <iaixsl:choose>
                                <iaixsl:when test="page/projector/returns_config/@returns_shop_shipping_cost = 'shop' or page/projector/returns_config/@returns_shop_shipping_cost = 'shopBalance'">
                                    <h3 data-mobile-class="big_label"><span>kostenlose Rückgabe</span>  </h3>
                                </iaixsl:when>
                                <iaixsl:otherwise>
                                    <h3 data-mobile-class="big_label">Einfache Rückgabe der Ware. </h3>
                                </iaixsl:otherwise>
                            </iaixsl:choose>
                            ...
                            <a class="n67367_more btn" href="#see_more">
                                <iaixsl:attribute name="title">Details anzeigen</iaixsl:attribute>
                                <iaixsl:attribute name="data-less">Details verstecken </iaixsl:attribute>
                                Details anzeigen
                            </a>
                            ...
                            <div class="n67367_returns_moretext">
                                ...
                                <div class="n67367_texts n67367_text1">
                                    <strong><b><iaixsl:value-of select="page/projector/returns_config/@days_to_return"/></b> Tage, um vom Vertrag zurückzutreten</strong>
                                    <div>
                                        Ihre Zufriedenheit mit den Einkäufen ist am wichtigsten. Die bei uns bestellten Produkte können Sie innerhalb von
                                        <b><iaixsl:value-of select="page/projector/returns_config/@days_to_return"/></b>
                                        <b>Tagen zurückgeben, ohne den Grund zu nennen</b>
                                    </div>
                                </div>
                                ...
                                <div class="n67367_texts n67367_text2">
                                    <iaixsl:choose>
                                        <iaixsl:when test="page/projector/returns_config/@returns_shop_shipping_active = 'y'">
                                            <strong><span>Stressfrei </span> und ohne Risiko </strong>
                                            <div>Wir sorgen um Ihre Bequemlichkeit, so dass Sie in unserem Geschäft die Rückgabe zu günstigen Konditionen vornehmen können.</div>
                                        </iaixsl:when>
                                        <iaixsl:otherwise>
                                            <strong><span>Stressfrei </span> und ohne Risiko </strong>
                                            <div>Wir sorgen für Ihre Bequemlichkeit. Deswegen bieten wir Ihnen <b>das bequeme Rückgabesystem</b> an.  </div>
                                        </iaixsl:otherwise>
                                    </iaixsl:choose>
                                </div>
                                ...
                                <div class="n67367_texts n67367_text3">
                                    ...
                                    <iaixsl:choose>
                                        <iaixsl:when test="page/projector/returns_config/@returns_shop_shipping_cost = 'clientDEFAULT'"> 
                                            ...
                                            <strong><span>Einfacher Rückgabegenerator</span> </strong>
                                            <div>Alle Rückgaben verlaufen in unserem Geschäft durch den <b>einfachen Rückgabegenerator</b>, wodurch es möglich ist, an uns ein Rückpaket zu schicken.</div>

                                        </iaixsl:when>
                                        <iaixsl:when test="page/projector/returns_config/@returns_shop_shipping_cost = 'shop'">

                                            <strong><span>kostenlose Rückgabe</span>  </strong>
                                            <div>Bei der Rückgabe einer Ware <b>zahlen wir die Versandkosten.</b> </div>

                                        </iaixsl:when>
                                        <iaixsl:when test="page/projector/returns_config/@returns_shop_shipping_cost = 'shopBalance'">

                                            <strong><span>kostenlose Rückgabe</span>  </strong>
                                            <div>Bei der Wahl der <b>Kostenrückerstattung auf das Kundensaldo </b> erfolgt der Versand zum Geschäft kostenlos. </div>
                                ...
                                <iaixsl:choose>
                                    <iaixsl:when test="page/projector/returns_config/@returns_shop_shipping_link = 'y'">
                                        <a href="#see_more" class="btn --solid --medium n67367_returns_seemore">
                                            <iaixsl:attribute name="title">Erfahren Sie mehr</iaixsl:attribute>
                                            Erfahren Sie mehr
                                        </a>
                                    </iaixsl:when>
                                    <iaixsl:otherwise>
                    ...
                    <iaixsl:if test="page/projector/product/sizes_version/@stocks_link or page/projector/product/sizes/@stocks_link and not(/shop/page/projector/product/price/@value = 0)">
                        <div id="n67367_stocks" class="n67367_stocks">
                            <h3 data-mobile-class="big_label">Dieses Produkt ist in unseren Shops erhältlich</h3>
                            ...
                            <a class="btn">
                                ...
                                <iaixsl:attribute name="title">Verfügbarkeit überprüfen</iaixsl:attribute>
                    ...
                    <iaixsl:if test="page/projector/product/payment/instalment">
                        <div id="n67367_instalment" class="n67367_instalment">
                            <h3 data-mobile-class="big_label">Wir bitten ihnen Ratenkauf!</h3>
                                ...
                                <div class="instalment_value_1">
                                    <iaixsl:choose>
                                        <iaixsl:when test="@value_formatted">
                                            ...
                                            <span class="n67367_section_txt"><iaixsl:value-of select="@name"/> ohne das Haus zu verlassen. So einfach und schnell wie ein Online-Shopping.</span>

                                            <small class="instalment_value_2">
                                                Verfügbar für Bestellungen mit dem Gesamtwert von 
                                            ...
                                            <iaixsl:if test="note">
                                                <span class="btn_note">Rechtliche Anmerkung</span>
                                ...
                                <iaixsl:for-each select="page/projector/product/payment/instalment">
                                    <li><iaixsl:attribute name="data-name"><iaixsl:value-of select="@name"/></iaixsl:attribute>
                                        <a class="instalments btn --solid mb-2">
                                            ...
                                            <span>Rate berechnen <iaixsl:value-of select="@name"/></span>
                                            <img>
                                                <iaixsl:attribute name="src"><iaixsl:value-of select="@gfx"/></iaixsl:attribute>
                                                <iaixsl:attribute name="alt"><iaixsl:value-of select="@name"/></iaixsl:attribute>
                                            </img>
    ...
    <!--Długi opis produktu z HTML (projector_longdescription, 106664.1)-->
        ...
        <iaixsl:if test="count(/shop/page/projector/product/dictionary/items) > 0 or (page/projector/product/@code) or (page/projector/product/series) or (page/projector/product/warranty/@name)">
            ...
            <div class="component_projector_dictionary">
                ...
                <div class="n56173_main">
                    <iaixsl:variable name="dictionary_label"></iaixsl:variable>
                    <iaixsl:if test="$dictionary_label != ''">
                       ...
                       <ul class="parameter_list clearfix">
                            ...
                            <iaixsl:if test="page/projector/product/@code">
                                <li class="parameter_element">
                                    ...
                                    <span><iaixsl:value-of select="page/projector/product/@code"/></span>
                                </li>
                            </iaixsl:if>
                            ...
                            <iaixsl:if test="page/projector/product/warranty/@name">
                                <li class="parameter_element">
                                    ...
                                    <a href="#component_projector_warranty_no">
                            ...
                            <iaixsl:for-each select="/shop/page/projector/product/dictionary/items/item">
                                <iaixsl:if test="@type = 'group'">
                                    <iaixsl:text disable-output-escaping="yes">&lt;/ul&gt;</iaixsl:text>
                                        <li class="param_group">
                                            <iaixsl:choose>
                                                <iaixsl:when test="desc != ''">
                                                    <span class="n54117_name_group"><iaixsl:value-of select="@name"/></span>
                                                </iaixsl:when>
                                                <iaixsl:otherwise>
                                                    <span class="n54117_name2_group"><iaixsl:value-of select="@name"/></span>
                                                </iaixsl:otherwise>
                                            </iaixsl:choose>

                                            <iaixsl:if test="desc != ''">
                                                <img class="qmark2 showTip" src="/gfx/ger/qmark2.gif?r=1598273390" alt="" title="">
                                    ...
                                    <iaixsl:text disable-output-escaping="yes">&lt;ul class="parameter_list clearfix"&gt;</iaixsl:text>
                                </iaixsl:if>
                                <iaixsl:if test="@type = 'element'">
                                    <li class="parameter_element">
                                        <iaixsl:if test="following-sibling::item[1]/@type = 'group'">
                                            <iaixsl:attribute name="class">parameter_element group_next</iaixsl:attribute>
                                        </iaixsl:if>
                                        <strong>
                                            <span><iaixsl:value-of select="@name"/></span>
                                            <span class="n67256colon">:</span>
                                            <iaixsl:if test="desc != ''">
                                                <img class="qmark showTip" src="/gfx/ger/qmark2.gif?r=1598273390" alt="" title="">
                                                </img>
                                        ...
                                        <span>
                                            <iaixsl:for-each select="values/value">
                                                ...
                                                <span class="n54117_item_b_sub">
                                                    ...
                                                    <iaixsl:if test="desc != ''">
                                                        <img class="qmark showTip" src="/gfx/ger/qmark.gif?r=1598273390" alt="" title="">
                    ...
                    <iaixsl:if test="(/shop/page/projector/product/enclosures/documents) or (/shop/page/projector/product/enclosures/audio)  or (/shop/page/projector/product/enclosures/other)  or (/shop/page/projector/product/enclosures/images_attachments/item) or (/shop/page/projector/product/enclosures/video/item)">
                        <div class="component_projector_enclosures">
                            ...
                            <div class="n56259_main">
                                ...
                                <iaixsl:variable name="n68814_showlabel">Dateien zum Herunterladen</iaixsl:variable>
        ...
        <div class="product_questions_container" id="product_questions_container">
                    ...
                    <div class="product_questions_list_sub">
                        <iaixsl:for-each select="page/projector/questions/question">
                            <div class="product_question_container">
                                <div class="product_question"><a href="#showDescription"><iaixsl:value-of select="@question"/><span><i class="icon-angle-down"></i></span></a></div>
            ...
            <div class="ask_question_container">
                <div class="ask_question_label">Haben Sie Fragen zum Produkt?</div>
                <div class="ask_question_desc"> Wenn die oben genannten Informationen für Sie nicht ausreichen, senden Sie uns bitte Ihre Frage. Wir werden versuchen, sie zu beantworten.</div>
                <a id="send_question_button" href="#showQuestionDialog" class="btn --solid --medium mb-4 mt-5 px-5">Stellen Sie eine Frage</a>
            </div>
        </div>
            ...
            <div class="component_projector_askforproduct">
                ...
                <form action="/settings.php" class="projector_askforproduct" method="post" novalidate="novalidate">
                    ...
                    <div class="projector_askforproduct_sub">
                        ...
                        <iaixsl:variable name="form_privacy_info_text1">Deine Daten werden gemäß </iaixsl:variable>
                        <iaixsl:variable name="form_privacy_info_text2"> bearbeitet.</iaixsl:variable>

                        <iaixsl:if test="$form_privacy_info_text1">
                            <p class="form-privacy-info"><iaixsl:value-of select="$form_privacy_info_text1"/><a><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/private_policy/@url"/></iaixsl:attribute>der Datenschutzerklärung</a><iaixsl:value-of select="$form_privacy_info_text2"/></p>
                        </iaixsl:if>
        ...
        <!--Produkty powiązane z tym produktem - strefa 1 (projector_associated_zone1, 111701.1)-->
                                ...
                                <h2>
                                    <iaixsl:choose>
                                        <iaixsl:when test="page/projector/products_associated_zone1/@link">
                                            <a class="big_label">
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="page/projector/products_associated_zone1/@link"/></iaixsl:attribute><iaixsl:attribute name="title"></iaixsl:attribute>
                                                <iaixsl:choose><iaixsl:when test="page/projector/products_associated_zone1/@name"><iaixsl:choose><iaixsl:when test="contains(page/projector/products_associated_zone1/@name,'|')"><span><iaixsl:value-of select="substring-before(page/projector/products_associated_zone1/@name,'|')"/></span><small><iaixsl:value-of select="substring-after(page/projector/products_associated_zone1/@name,'|')"/></small></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="page/projector/products_associated_zone1/@name"/></iaixsl:otherwise></iaixsl:choose></iaixsl:when><iaixsl:otherwise>Produkte, die mit diesem Produkt zusammen gekauft wurden</iaixsl:otherwise></iaixsl:choose>
                                            </a>
                                        </iaixsl:when>
                                        <iaixsl:otherwise>
        ...
        <!--Produkty powiązane z tym produktem - strefa 2 (projector_associated_zone2, 111704.1)-->
                                ...
                                <h2>
                                    <span class="big_label">
                                        <iaixsl:choose>
                                            ...
                                            <iaixsl:otherwise>
                                                Produkte, die mit diesem Produkt zusammen gekauft wurden
                                            </iaixsl:otherwise>
                                        </iaixsl:choose>
                                ...
                                <div class="align_row main_hotspot_sub">
                                    <div class="products_wrapper row mx-0">
                                        ...
                                        <iaixsl:for-each select="page/projector/products_associated_zone3/*">
                                            ...
                                            <iaixsl:variable name="var_icon_small"><iaixsl:choose><iaixsl:when test="product"><iaixsl:value-of select="product/icon_small"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="icon_small"/></iaixsl:otherwise></iaixsl:choose></iaixsl:variable>
                                            <iaixsl:variable name="var_link"><iaixsl:choose><iaixsl:when test="product"><iaixsl:value-of select="product/@link"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="@link"/></iaixsl:otherwise></iaixsl:choose></iaixsl:variable>
                                            <iaixsl:variable name="var_yousave">Speichern</iaixsl:variable>
		...
		<iaixsl:if test="count(/shop/page/projector/blog_entries/item) > 0">
			<section id="projector_blog" class="article mb-4">
				<h2>
					...
					<iaixsl:for-each select="/shop/page/projector/blog_entries/item">
						<article class="article__item col-12 col-md-6">
							...
							<iaixsl:if test="image/@src and image/@src!=''">
								...
								<img src="/gfx/ger/loader.gif?r=1598273390" class="article__image b-lazy">
	...
	<!--Karta produktu - załączniki (projector_enclosures, 106674.1)-->
        ...
        <!--player video w karcie produktu (projector_video, 110995.1)-->

            <iaixsl:if test="(/shop/page/projector/product/enclosures/documents) or (/shop/page/projector/product/enclosures/audio)  or (/shop/page/projector/product/enclosures/other)  or (/shop/page/projector/product/enclosures/images_attachments/item) or (/shop/page/projector/product/enclosures/video/item)">
                <div style="display:none;" class="projector_video_cover"/>     
                <div class="projector_video">   
                <a href="javascript:;" class="projector_video_close"><img src="/gfx/ger/zamknij.gif?r=1598273390" alt="Zamknij" class="projector_photo_close_55916"/></a>
                ...
                <div id="menu_preloader_add">
                    <iaixsl:choose>
                        ...
                        <iaixsl:otherwise>
                            ...
                            <div class="big_label">
                                Die Produkte wurden in den Warenkorb gelegt
                            </div>
                        </iaixsl:otherwise>
                    </iaixsl:choose>
                                        ...
                                        <iaixsl:choose>
                                            <iaixsl:when test="/shop/page/projector/products_associated_zone4/@link">
                                                <a class="big_label">
                                                    ...
                                                    <iaixsl:attribute name="title">
                                                        Klicken Sie hier, um alle Produkte anzuzeigen
                                                    </iaixsl:attribute>
                                                    <iaixsl:choose>
                                                                ...
                                                                <div class="product_prices">
                                                                    <iaixsl:choose>
                                                                        <iaixsl:when test="$var_size_min_formatted != $var_size_max_formatted">
                                                                            ...
                                                                            <iaixsl:if test="$var_points != ''">
                                                                                <span class="point-price">
                                                                                    <iaixsl:value-of select="$var_points"/><span class="currency">Point</span>
                                                                                </span>
                                                                            </iaixsl:if>
                                                                        </iaixsl:when>
                                                                        <iaixsl:when test="(($var_value = 0) and $var_points = '') or ($var_value = 0 and $main_hotspot_zone1_b2b_var and not($main_hotspot_zone1_b2b_var = '') and not(/shop/basket/@wholesaler = 'true'))">
                                                                ...
                                                                <div class="product_prices">
                                                                    <iaixsl:choose>
                                                                        <iaixsl:when test="$var_size_min_net_formatted != $var_size_max_net_formatted">
                                                                            ...
                                                                            <iaixsl:if test="$var_points_net != ''">
                                                                                <span class="point-price">
                                                                                    <iaixsl:value-of select="$var_points_net"/><span class="currency">Point</span>
                                                                                </span>
                                                                            </iaixsl:if>
                                                                        </iaixsl:when>
                                                                        <iaixsl:when test="(($var_net_value = 0) and $var_points_net = '') or ($var_net_value = 0 and $main_hotspot_zone1_b2b_var and not($main_hotspot_zone1_b2b_var = '') and not(/shop/basket/@wholesaler = 'true'))">
...
<!--Menu powiadomienia (menu_notice, 107640.1)-->
        ...
        <!--Elementy dodawane dynamicznie (menu_dynamically_added_content, 106830.1)-->
            ...
            <script src="/gfx/ger/projector_components_hiding.js.gzip?r=1598273390"></script><script src="/gfx/ger/projector_projector_opinons_form.js.gzip?r=1598273390"></script>
            <script>
                app_shop.runApp();
            </script>
