...
<div id="account_icon"><a href="/login.php"><i class="icon-account"></i></a></div>
    ...
    <!--Błędy i informacje w projektorze (menu_messages, 106608.1)-->
        ...
        <iaixsl:variable name="order_edit_button">Bestellung ändern</iaixsl:variable>
        <iaixsl:variable name="hours_68242"> Stunden </iaixsl:variable>
        ...
        <iaixsl:variable name="n68313_order2_document_invoice"> Receipt</iaixsl:variable>
        <iaixsl:variable name="n68313_order2_document_e_invoice">E-Rechnung</iaixsl:variable>
        ...
        <div class="n57856_order_overtaker">
            <form class="order2_form">
                ...
                <div class="big_label order2_info_label">
                    <span class="n57856_label" id="labels">Einzelheiten: 
                    </span>
                </div>
                ...
                <div class="order2_info">
                        ...
                        <div class="order2_info1" id="order2_box_1">
                            <div class="order2_info1_sub">
                                ...
                                <iaixsl:if test="page/order2/orderclient/@nip">
                                    USt-IdNr.: <iaixsl:value-of select="page/order2/orderclient/@nip"/><br/>
                                </iaixsl:if>
                                <iaixsl:if test="(page/order2/orderclient/@phone1) and not(page/order2/orderclient/@phone1 = '')">
                                    Telefonnummer:  <iaixsl:value-of select="page/order2/orderclient/@phone1"/><br/>
                                </iaixsl:if>
                            ...
                            <a class="order2_button_change d-none d-sm-inline-block btn --solid">
                                <iaixsl:attribute name="href"><iaixsl:value-of select="page/order2/orderclient/@changelink"/></iaixsl:attribute>
                                ...
                                <div class="order2_info1" id="order2_box_2b">
                                    ...
                                    <iaixsl:if test="not(/shop/page/order2/stock/@link = '')">
                                        <div class="order2_moreinfo">
                                            <a class="order2_stock_moreinfo btn --solid" target="_blank">
                                    ...
                                    <iaixsl:if test="/shop/page/order2/stock/@other_stocks='true'">
                                        <a class="order2_button_change_stock d-none d-sm-inline-block btn --solid">
                                            <iaixsl:attribute name="href"><iaixsl:value-of select="page/order2/stock/@change_link"/></iaixsl:attribute>
                                            Abholort ändern
                                        </a>
                                    </iaixsl:if>
                                ...
                                <div class="order2_info1" id="order2_box_2b">
                                    <div class="order2_info1_sub">
                                        ...
                                        <iaixsl:if test="page/order2/deliveryaddress/@phone and page/order2/deliveryaddress/@phone != ''">
                                            Telefonnummer:  <iaixsl:value-of select="page/order2/deliveryaddress/@phone"/><br/>
                                        </iaixsl:if>

                                    </div>
                                    <a class="order2_button_change_address d-none d-sm-inline-block btn --solid">
                                        <iaixsl:attribute name="href"><iaixsl:value-of select="page/order2/deliveryaddress/@changelink"/></iaixsl:attribute>
                                        Lieferort ändern
                                    </a>
                                </div>
                    ...
                    <div class="order2_info_sub" id="order2_info_sub3">
                        ...
                        <div class="order2_info1" id="order2_box_3">
                            ...
                            <a class="order2_button_change2 d-none d-sm-inline-block btn --solid">
                                <iaixsl:attribute name="href"><iaixsl:value-of select="page/order2/orderclient/@changelink"/></iaixsl:attribute>
                                den Empfänger ändern
                            </a>
                        ...
                        <div class="order2_info1" id="order2_box_4">
                            <div class="order2_info1_sub">
                                ...
                                <label for="order2_document_confirmation">
                                    <input type="radio" class="order2_radio_document" name="invoice" id="order2_document_confirmation" value="0">
                                ...
                                <iaixsl:if test="page/order2/orderinvoice/@e_invoice='true' and $n68313_order2_document_e_invoice">
                                    <label for="order2_document_e_invoice">
                                        <input type="radio" class="order2_radio_document" name="invoice" id="order2_document_e_invoice" value="2">
                                    ...
                                    <div id="e-invoice_dialog">
                                        <span class="big_label">Lieferung von Rechnungen in elektronischer Form</span>
                                        <div>
                                            <span class="e-invoice_dialog"><font>Schützen Sie die Umwelt</font> und beschleunigen den Erhalt der Rechnung</span>
                        ...
                        <div class="order2_info1_sub">
                                ...
                                <iaixsl:if test="/shop/basket/delivery_time/@days and not(basket/@shipping_undefined = 'true')">
                                    ...
                                    <iaixsl:choose>
                                        ...
                                        <iaixsl:when test="$wys_1_68242  and (/shop/basket/delivery_time/@week_amount)  and  (/shop/basket/delivery_time/@week_amount = 0) and (/shop/basket/delivery_time/@hours = 0) and (/shop/basket/delivery_time/@minutes = 0)">
                                            Sie werden die Sendung erhalten haben am 
                                        </iaixsl:when>
                                    ...
                                    <iaixsl:choose>
                                        <iaixsl:when test="/shop/page/order2/orderremarks/@select_date and (/shop/page/order2/orderremarks/@select_date != '')">
                                            <iaixsl:value-of select="/shop/page/order2/orderremarks/@select_date"/><iaixsl:if test="/shop/page/order2/orderremarks/@select_time and (/shop/page/order2/orderremarks/@select_time != '')">,  <iaixsl:value-of select="/shop/page/order2/orderremarks/@select_time"/></iaixsl:if>
                                        </iaixsl:when>
                                            ...
                                            <iaixsl:if test="/shop/basket/delivery_time/@days > 0">
                                                ...
                                                <iaixsl:choose>
                                                    <iaixsl:when test="/shop/basket/delivery_time/@days ='1'">
                                                        <iaixsl:choose><iaixsl:when test="(/shop/page/order2/orderdetails/@deliveryid = '0-0') or (/shop/page/order2/orderdetails/@deliveryid = '0-1')"></iaixsl:when><iaixsl:otherwise> Tag </iaixsl:otherwise></iaixsl:choose>
                                                    </iaixsl:when>
                                                    <iaixsl:otherwise>
                                                         Tagen 
                                                    </iaixsl:otherwise>
                            ...
                            <iaixsl:if test="(page/order2/orderdetails/points/@debit) and (page/order2/orderdetails/points/@debit > 0)">
                                <div class="basketedit_summary_debit">
                                    ...
                                    <iaixsl:value-of select="page/order2/orderdetails/points/@debit"/><span> Pkt. </span> in Rahmen des Treueprogramms.
                ...
                <div class="order2_info comment_container clearfix">
                    ...
                    <a href="#toggleComments" id="toggle_comments_button" class="d-sm-none">Kommentare für das Geschäft und den Zusteller (Kurier)</a>

                    <div class="order2_info_sub order_comments">
                        <h3 class="order2_info1">
                            Bemerkungen an den Bestellungsbearbeiter:
                        </h3>
                    ...
                    <div class="order2_info_sub">
                        <h3 class="order2_info1">
                            Bemerkungen an den Zusteller (Kurier):
                        </h3>
                ...
                <div class="basketedit_summary_container">
                    <div class="basketedit_summary">
                        <div class="basketedit_summary_sub">
                            ...
                            <iaixsl:if test="not(page/order2/ordersproducts/product/@product_type)">
                                    ...
                                    <table class="order2_table">
                                        ...
                                        <tr>
                                            ...
                                            <th class="order2_price" data-mobile-class="hide">
                                                Einheitspreis
                                            </th><iaixsl:if test="not(/shop/contact/owner/@vat_registered = 'false')">
                                            <th class="order2_vat">
                                                MwSt.
                                            </th></iaixsl:if>
                                        ...
                                        <iaixsl:for-each select="page/order2/ordersproducts/product">
                                            <tr>
                                                ...
                                                <td class="order2_name">
                                                    ...
                                                    <iaixsl:if test="version/@name">
                                                        <div class="order2_size_desc">
                                                            <iaixsl:value-of select="version/@name"/>: <iaixsl:value-of select="version/@product_name"/>
                                                        </div>
                                                    </iaixsl:if>
                                                            ...
                                                            <iaixsl:for-each select="bundled/product">
                                                                <span>
                                                                    ...
                                                                    <iaixsl:if test="not(size/@type='uniw') or ((version) and (not(version/@product_name='')))">
                                                                        (<iaixsl:if test="not(size/@type='uniw')">Größe: <iaixsl:value-of select="size/@description"/></iaixsl:if><iaixsl:if test="not(size/@type='uniw') and ((version) and (not(version/@product_name='')))">, </iaixsl:if><iaixsl:if test="(version) and (not(version/@product_name=''))"><iaixsl:value-of select="version/@name"/>: <iaixsl:value-of select="version/@product_name"/></iaixsl:if>)
                                                                    </iaixsl:if>

                                                                    <iaixsl:if test="@product_type = 'product_virtual'">
                                                                        <i class="product_virtual">Digitales Produkt</i>
                                                                    </iaixsl:if>

                                                                    <iaixsl:if test="@product_type = 'product_service'">
                                                                        <i class="product_service">Dienstleistung</i>
                                                                    </iaixsl:if>
                                                                </span>
                                                            </iaixsl:for-each>
                                                        </div>
                                                    ...
                                                    <iaixsl:if test="order_files/file">
                                                        <div class="order2_productlist_files">
                                                            <span class="n53330_projectorlink">Die von Ihnen hinzugefügten Dateien:</span>
                                                ...
                                                <td class="order2_quantity">
                                                    <iaixsl:value-of select="@quantity"/>&#160;<iaixsl:value-of select="@price_unit"/>
                                                </td>
                                                ...
                                                <td class="order2_bruttoworth">
                                                    ...
                                                    <iaixsl:choose>
                                                        ...
                                                        <iaixsl:when test="not(@forpoints)">

                                                            <iaixsl:value-of select="@bruttoworth_formatted"/>

                                                        </iaixsl:when>
                                                        <iaixsl:when test="@forpoints">
                                                            <iaixsl:attribute name="id">points</iaixsl:attribute>
                                                ...
                                                <tr>
                                                    <td colspan="4">
                                                        <div class="order2_comment">
                                                            <span class="comment_label">Die von Ihnen eingegebenen Bemerkungen zu diesem Produkt:</span>
                            ...
                            <iaixsl:if test="page/order2/ordersproducts/product">
                                ...
                                <div class="order2_products">
                                    <table class="order2_table">
                                        ...
                                        <iaixsl:for-each select="page/order2/ordersproducts/product">
                                            <iaixsl:if test="not(@product_type = 'product_virtual' or @product_type = 'product_service')">
                                                <tr>
                            ...
                            <iaixsl:if test="page/order2/ordersproducts/product[@product_type = 'product_virtual']">
                                <div class="order2_products">
                                    <table class="order2_table">
                                        ...
                                        <tr>
                                            <th class="order2_name">
                                                Bestellte <span class="product_virtual">digitale Produkte</span>
                                            </th>
                                            <th class="order2_price" data-mobile-class="hide">
                                                Einheitspreis
                                            </th><iaixsl:if test="not(/shop/contact/owner/@vat_registered = 'false')">
                            ...
                            <iaixsl:if test="page/order2/ordersproducts/product[@product_type = 'product_service']">
                                <div class="order2_products">
                                    <table class="order2_table">
                                        ...
                                        <tr>
                                            <th class="order2_name">
                                                Bestellte <span class="product_virtual">Dienstleistungen</span>
                                            </th>
                                            <th class="order2_price" data-mobile-class="hide">
                                                Einheitspreis
                                            </th><iaixsl:if test="not(/shop/contact/owner/@vat_registered = 'false')">
                                            ...
                                            <iaixsl:if test="@product_type = 'product_service'">
                                                ...
                                                <iaixsl:if test="comment">
                                                    <tr>
                                                        <td colspan="4">
                                                            <iaixsl:if test="not(/shop/contact/owner/@vat_registered = 'false')">
                                                                <iaixsl:attribute name="colspan">3</iaixsl:attribute>
                                                            </iaixsl:if>
                                                            <div class="order2_comment">
                                                                <span class="comment_label">Die von Ihnen eingegebenen Bemerkungen zu diesem Produkt:</span>
                                                                <iaixsl:value-of select="comment"/>
                            ...
                            <iaixsl:if test="page/wrappers/wrapper">
                                <div class="order2_products">

                                    <table class="order2_table">
                                        <tr>
                                            <th class="order2_name">
                                                Augewählte Verpackung:
                                            </th>
                                    ...
                                    <table class="order2_table">
                                            ...
                                            <th class="order2_name">
                                                ...
                                                <iaixsl:choose>
                                                    <iaixsl:when test="/shop/page/order2/insurance_product">
                                                        Lieferung, Zahlung und Versicherung
                                                    </iaixsl:when>
                                                    <iaixsl:otherwise>
                                        ...
                                        <tr>
                                            <td class="order2_name">
                                                ...
                                                <span class="order2_name">Lieferungsart: <iaixsl:value-of select="page/order2/orderdetails/@deliveryname"/>
                                                    <a class="order2_change_delivery_link" href="order1.php">ändern</a></span>

                                                <iaixsl:if test="/shop/page/order2/shipping/comment and /shop/page/order2/shipping/comment != ''">
                                                    <div class="order2_delivery_info"><iaixsl:value-of disable-output-escaping="yes" select="/shop/page/order2/shipping/comment"/></div>
                                                </iaixsl:if>
                                            ...
                                            <td class="order2_bruttoworth">
                                                <div class="worth_box">
                                                    ...
                                                    <iaixsl:if test="(page/order2/shipping/@cost > 0) or (not(page/order2/orderdetails/@deliverytype = 'dvp' and page/order2/stock/@stock_id))">



                                                        <iaixsl:if test="not(page/order2/shipping/@hide_cost = 'true')">
                                        ...
                                        <iaixsl:if test="not(page/order2/orderdetails/@deliverytype = 'prepaid' and page/order2/orderdetails/@payment_name = '') or (page/order2/orderdetails/@tradeCredit = 'y')">
                                            <tr>
                                                <td class="order2_name">
                                                    ...
                                                    <span class="order2_name"><iaixsl:choose><iaixsl:when test="page/order2/orderdetails/voucher/@value">Zahlungsart: <iaixsl:value-of select="page/order2/orderdetails/@payment_name"/></iaixsl:when><iaixsl:when test="(page/order2/orderdetails/@deliverytype = 'prepaid') and (page/order2/orderdetails/@tradeCredit = 'y')">Zahlungsart: Kreditlimit</iaixsl:when><iaixsl:when test="page/order2/orderdetails/@deliverytype = 'prepaid'">Zahlungsart: <iaixsl:value-of select="page/order2/orderdetails/@payment_name"/></iaixsl:when><iaixsl:when test="page/order2/orderdetails/@deliverytype = 'dvp'">Zahlungsart: Zahlung bei Annahme der Sendung</iaixsl:when></iaixsl:choose>
                                                        ...
                                                        <iaixsl:if test="not(page/order2/orderdetails/@tradeCredit = 'y')">
                                                            <a class="order2_change_delivery_link" href="order1.php">ändern</a>
                                                        </iaixsl:if>
                                                    </span>
                                                    ...
                                                    <div class="order2_delivery_info">
                                                        <iaixsl:choose>
                                                            ...
                                                            <iaixsl:when test="(page/order2/orderdetails/@deliverytype = 'prepaid') and not(page/order2/orderdetails/@tradeCredit = 'y')">
                                                                Zahlung vorm Versand der Bestellung
                                                            </iaixsl:when>
                                                            <iaixsl:when test="page/order2/orderdetails/@deliverytype = 'dvp' and page/order2/stock/@stock_id">
                                                                Sie zahlen den Betrag bei Abholung der Sendung im Shop.
                                                            </iaixsl:when>
                                        ...
                                        <iaixsl:if test="/shop/page/order2/balance/@currency_value and /shop/page/order2/balance/@currency_value > 0">
                                            <tr>
                                                <td class="order2_name">
                                                    ...
                                                    <span class="order2_name">Per Saldo bezahlt (Überzahlungen auf dem Kundenkonto)</span>
                                                ...
                                                <td class="order2_bruttoworth">
                                                    <div class="worth_box">
                                                        <iaixsl:attribute name="class">worth_box minus_sign</iaixsl:attribute>
                                                        <iaixsl:if test="$signbeforeprice = 'true'">
                                                            <span class="currency_order2"><iaixsl:value-of select="/shop/currency/@name"/></span>
                                                            <iaixsl:value-of select="$signbetweenpricecurrency"/>
                                                        </iaixsl:if>
                                        ...
                                        <iaixsl:if test="/shop/page/order2/insurance_product">
                                            <tr>
                                                <td class="order2_name">
                                                    ...
                                                    <span class="order2_name">Käuferschutz: <iaixsl:value-of select="/shop/page/order2/insurance_product/@service"/></span>
                            ...
                            <div class="order2_terms_wrapper">
                                ...
                                <div class="order2_terms_wrapper_sub">
                                    <label class="order2_terms_conditions">
                                        ...
                                        <i class="css-label"/>
                                        <span><i class="icon-need"></i>  Ich bin mit den 
                                            <a target="_blank">
                                                <iaixsl:attribute name="title">AGB
                                                </iaixsl:attribute>
                                                <iaixsl:attribute name="href">
                                ...
                                <iaixsl:if test="not($returns_agree_control)">
                                    <div class="order2_terms_wrapper_sub">
                                        <label class="order2_cancel">
                                            ...
                                            <i class="css-label"/>
                                            <span><i class="icon-need"></i>  Ich habe mich mit dem 
                                                <a target="_blank">
                                                    <iaixsl:attribute name="title">Widerruf
                                                    </iaixsl:attribute>
                                                    <iaixsl:attribute name="href">
                                                        <iaixsl:value-of select="/shop/action/order_cancel/@url"/>
                                                    </iaixsl:attribute>
                                                    Widerrufsrecht vertraut gemacht
                                                </a>
                                            </span>
                                        </label>
                                    </div>
                                ...
                                <iaixsl:if test="page/order2/ordersproducts//product[@product_type = 'product_virtual']">
                                    <div class="order2_terms_wrapper_sub virtual">
                                        <label class="order2_virtual">
                                            ...
                                            <i class="css-label"/>
                                            <span><i class="icon-need"></i>  Ja, ich möchte sofort Zugang zu dem digitalen Inhalt und weiß, dass mein Widerrufsrecht mit dem Zugang erlischt.</span>
                                        </label>
                                    </div>
                                </iaixsl:if>
                                ...
                                <iaixsl:if test="page/order2/ordersproducts//product[@product_type = 'product_service']">
                                    <div class="order2_terms_wrapper_sub service">
                                        <label class="order2_service">
                                            ...
                                            <i class="css-label"/>
                                            <span><i class="icon-need"></i>  Ja, bitte beginnen Sie sofort mit der Dienstleistung. Mein Widerrufsrecht erlischt mit vollständiger Ausführung.</span>
                                        </label>
                                    </div>
                                </iaixsl:if>
                            ...
                            <div class="basketedit_summary_buttons table_display">
                                ...
                                <div class="btn_wrapper">
                                    <input class="btn --solid --large order2_button_order terms_required" type="submit">
                                        ...
                                        <iaixsl:attribute name="value">Zahlungspflichtig bestellen</iaixsl:attribute>
