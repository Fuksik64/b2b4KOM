...
<iaixsl:variable name="next_page_bottom">Nächste Seite</iaixsl:variable>
    ...
    <div class="products_bought row" id="productpb_bought">
        <div class="col-12">
        ...
        <form class="pb_search_setting pb_top col-12" action="/settings.php">
            <iaixsl:if test="not(/shop/page/navigation/@disable_sort_change = 'y')">
                <div class="pb_select_sort">
                    ...
                    <select class="pb_paging__select --order --small-md" id="select_top_sort" name="sort_order">
            ...
            <iaixsl:if test="count(page/navigation/portions) > 1">
                <div class="pb_select_portions d-none d-md-inline-block">
                    ...
                    <select class="pb_paging__select --portions --small-md" id="select_top_portions" name="portions">
        ...
        <div id="pb_list" class="pb_list">
            <div class="pb_list_header row d-none d-md-flex">
                ...
                <div class="pb_header_date col-2">Datum des letzten Kaufs</div>
                <div class="pb_header_price col-2"> Preis:</div>
            </div>
            <div class="row productpb_wrapper">
                ...
                <div class="pb_product">
                    ...
                    <div class="col-md-1 col-12 mb-3 mb-md-0">
                        <div class="pb_icon">
                            <a>
                                <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                                <img class="basket_prod rwd-src" alt="Szczegoly" src="/gfx/ger/loader.gif?r=1598273390">
                    ...
                    <div class="col-md-5 col-12 mb-3 mb-md-0">
                        <div class="pb_info">
                            ...
                            <iaixsl:if test="@product_type = 'product_bundle'">
                                <div class="pb_single_info productslist_product_bundle">
                                    Produkt im Set:
                    ...
                    <div class="col-md-2 col-12 mb-3 mb-md-0">
                        <div class="pb_date">
                            <span class="d-block d-md-none">Datum des letzten Kaufs</span>
                            ...
                            <iaixsl:choose>
                                ...
                                <iaixsl:otherwise>
                                    <a class="btn --solid --medium">
                                        ...
                                        <iaixsl:attribute name="title">Zum Warenkorb hinzufügen</iaixsl:attribute>
        ...
        <form class="pb_search_setting pb_down col-12" action="/settings.php">
            <iaixsl:if test="not(/shop/page/navigation/@disable_sort_change = 'y')">
                <div class="pb_select_sort d-none d-md-inline-block">
                    ...
                    <select class="pb_paging__select --order --small-md" id="select_bottom_sort" name="sort_order">
                        <option value="name-a" class="option_name-a"><iaixsl:if test="page/navigation/@sort = 'name' and page/navigation/@order = 'a'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>Sortieren nach Name aufsteigend</option>
                        <option value="name-d" class="option_name-d"><iaixsl:if test="page/navigation/@sort = 'name' and page/navigation/@order = 'd'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>Sortieren nach Name absteigend</option>
                        <option value="price-a" class="option_price-a"><iaixsl:if test="page/navigation/@sort = 'price' and page/navigation/@order = 'a'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>Sortieren nach Preis aufsteigend</option>
                        <option value="price-d" class="option_price-d"><iaixsl:if test="page/navigation/@sort = 'price' and page/navigation/@order = 'd'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>Sortieren nach Preis absteigend</option>
            ...
            <iaixsl:if test="count(page/navigation/portions) > 1">
                <div class="pb_select_portions d-none d-md-inline-block">
                    ...
                    <select class="pb_paging__select --portions --small-md" id="select_bottom_portions" name="portions">
                        <iaixsl:for-each select="page/navigation/portions">
                            <option><iaixsl:attribute name="value"><iaixsl:value-of select="@counter"/></iaixsl:attribute><iaixsl:if test="@selected = 'true'"><iaixsl:attribute name="selected">selected</iaixsl:attribute></iaixsl:if>Anzeigen <iaixsl:value-of select="@counter"/>
                            </option>
                        </iaixsl:for-each>
            ...
            <iaixsl:if test="count(page/navigation/item)">
