...
<div id="account_icon"><a href="/login.php"><i class="icon-account"></i></a></div>
        ...
        <!--Newsletter - formularz dodania/usunięcia adresu em (newsletter_form, 107875.1)-->
            <iaixsl:variable name="account_email_info">Sie haben unseren Newsletter bereits abonniert. Auf Ihr Konto E-Mail-Adresse zugeordnet ist</iaixsl:variable>
            <div id="newsletter_form">
                    ...
                    <div class="newsletter_message_wrapper">
                        <div class="newsletter_message n54531_outline">
                            ...
                            <div class="n54531_outline_sub">
                                <iaixsl:choose>
                                    <iaixsl:when test="/shop/page/communicates_newsletter/message/@type = 'mailing_addsuccess'">Vielen Dank für Ihre Anmeldung zu unserem Newsletter. Ab sofort werden alle Newsletter an die von Ihnen angegebene E-Mail-Adresse geschickt. Um sicherzustellen, dass Sie keinen Newsletter verpassen, schlagen wir Ihnen vor, die E-Mail-Adresse unseres Shops Ihrem Adressbuch hinzuzufügen.</iaixsl:when>

                                    <iaixsl:when test="/shop/page/communicates_newsletter/message/@type = 'mailing_maileregerror'">Die angegebene E-mail-Adresse ist ungültig.</iaixsl:when>

                                    <iaixsl:when test="/shop/page/communicates_newsletter/message/@type = 'mailing_removesuccess'">Ihre E-Mail wurde aus der Newsletterdatenbank ausgetragen.</iaixsl:when>

                                    <iaixsl:when test="/shop/page/communicates_newsletter/message/@type = 'mailing_nosuchemail'">Die angegebene E-Mail-Adresse wurde in der Newsletterdatenbank nicht gefunden.</iaixsl:when>

                                    <iaixsl:when test="/shop/page/communicates_newsletter/message/@type = 'mailing_sendingconfirm'">An die von Ihnen angegebene E-Mail-Adresse wurde eine Bestätigungsnachricht geschickt. Bitte klicken Sie auf den darin enthaltenen Link, um das Newsletter-Abonnement zu aktivieren.</iaixsl:when>

                                    <iaixsl:when test="/shop/page/communicates_newsletter/message/@type = 'mailing_emailexist'">Die angegebene E-Mail-Adresse existiert bereits in unserer Datenbank.</iaixsl:when>

                                    <iaixsl:when test="/shop/page/communicates_newsletter/message/@type = 'mailing_sendingconfirm_remove'">An die von Ihnen angegebene E-Mail-Adresse wurde eine Bestätigungsnachricht geschickt. Bitte klicken Sie auf den darin enthaltenen Link, um das Newsletter-Abonnement zu deaktivieren.</iaixsl:when>
                                </iaixsl:choose>
                            </div>
                        </div>
                    </div>
                ...
                <iaixsl:choose>
                    <iaixsl:when test="not(/shop/page/communicates_newsletter/message) or (/shop/page/communicates_newsletter/message/@type = 'mailing_maileregerror') or (/shop/page/communicates_newsletter/message/@type = 'mailing_emailexist') or (/shop/page/communicates_newsletter/message/@type = 'mailing_nosuchemail')">
                        <iaixsl:choose>
                                        ...
                                        <form action="/settings.php" method="post" class="newsletter_form row flex-column align-items-center">
                                            ...
                                            <iaixsl:choose>
                                                <iaixsl:when test="$account_email_info">
                                                    <p class="col-md-6 col-12">Sie haben unseren Newsletter bereits abonniert. Auf Ihr Konto E-Mail-Adresse zugeordnet ist <b><iaixsl:value-of select="/shop/page/client/@email"/></b>.<br />Sie können den Newsletter-Service jederzeit abbstellen, indem Sie auf die folgende Schaltfläche klicken.</p>
                                                </iaixsl:when>
                                                <iaixsl:otherwise>
                                                    <p class="col-md-6 col-12">Sie haben unseren Newsletter bereits abonniert. Sie können den Newsletter-Service jederzeit abbstellen, indem Sie auf die folgende Schaltfläche klicken.</p>
                                                </iaixsl:otherwise>
                                            </iaixsl:choose>
                                            ...
                                            <div class="newsletter_button_wrapper col-md-6 col-12">
                                                <button id="newsletter_button_remove" type="submit" class="btn --solid --secondary">
                                                    <iaixsl:attribute name="value">Abmelden</iaixsl:attribute>Abmelden
                                                </button>
                                            </div>
                                        </form>
                                    </iaixsl:when>
                                        ...
                                        <iaixsl:choose>
                                            ...
                                            <iaixsl:when test="/shop/page/client/@email != ''">
                                                <form action="/settings.php" method="post" class="newsletter_form row flex-column align-items-center">
                                                    ...
                                                    <p id="newsletter_longdesc" class="col-md-6 col-12">Sie haben unseren Newsletter noch nicht abonniert. Möchten Sie über Produktneuheiten, Sonderangebote und andere Aktionen im Shop benachrichtigt werden, dann klicken Sie auf die folgende Schaltfläche. Der Newsletter wird an die Adresse gesendet <strong><iaixsl:value-of select="page/client/@email"/></strong>, die Sie als Ihre Kontaktadresse angegeben haben. Falls Sie diese E-Mail-Adresse ändern möchten, verwenden Sie bitte <a href="/loginedit.php?operation=edit">das Formular zum Bearbeiten der Kundendaten</a></p>
                                                    <input name="mailing_email" type="hidden">
                                                        <iaixsl:attribute name="value"><iaixsl:value-of select="page/client/@email"/></iaixsl:attribute>
                                                    </input>
                                                        ...
                                                        <div class="has-feedback">
                                                            <label class="control-label d-flex align-items-center">
                                                                ...
                                                                <div class="text_to_left">
                                                                    Ich möchte die Newsletter-E-Mails erhalten. Ich erkläre mich damit einverstanden, dass meine personenbezogenen Daten zu Marketingzwecken gemäß der Datenschutzerklärung bearbeitet werden<a><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/private_policy/@url"/></iaixsl:attribute>der Datenschutzerklärung</a>
                                                                </div>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="newsletter_button_wrapper col-md-6 col-12">
                                                        <button id="newsletter_button_add" type="submit" class="btn --solid">
                                                            <iaixsl:attribute name="value">Anmelden</iaixsl:attribute>Anmelden
                                                        </button>
                                                    </div>
                                                </form>
                                            </iaixsl:when>
                                            ...
                                            <iaixsl:otherwise>
                                                <form action="/settings.php" method="post" class="newsletter_form row flex-column align-items-center">
                                                    <input id="mailing_action_contact" name="mailing_action" value="add" type="hidden"/>
                                                    <p id="newsletter_longdesc" class="col-md-6 col-12">Sie haben unseren Newsletter noch nicht abonniert. Möchten Sie über Produktneuheiten, Sonderangebote und andere Aktionen im Shop benachrichtigt werden, geben Sie bitte die E-Mail-Adresse ein, an die der Newsletter zukünftig gesendet werden soll und anschließend klicken Sie auf die folgende Schaltfläche. Die hier eingegebene Adresse wird zu den Kontaktdaten in Ihrem Profil hinzugefügt und kann jederzeit geändert werden. Hierzu verwenden Sie bitte <a href="/loginedit.php?operation=edit">das Formular zum Bearbeiten der Kontaktdaten</a></p>
                            ...
                            <iaixsl:otherwise>
                                <form action="/settings.php" method="post" class="newsletter_form row flex-column align-items-center">
                                    <input id="mailing_action_contact" name="mailing_action" value="add" type="hidden"/>
                                    <p class="col-md-6 col-12">Geben Sie Ihre E-Mail-Adresse ein und klicken Sie auf die entsprechende Schaltfläche, um unseren Newsletter-Service zu abonnieren oder abzubestellen.</p>
                    ...
                    <iaixsl:otherwise>
                        <iaixsl:variable name="newsletter_mainpage_txt">Startseite</iaixsl:variable>
