                                ...
                                <iaixsl:choose>
                                    ...
                                    <iaixsl:otherwise>
                                        ...
                                        <iaixsl:if test="price/@points">
                                            <span class="point-price"><iaixsl:value-of select="price/@points"/><span class="currency"> PKT.</span></span>
                                        </iaixsl:if>
                                    </iaixsl:otherwise>
                                </iaixsl:choose>
                        ...
                        <iaixsl:choose>
                            <iaixsl:when test="page/products/additional/hotspot/products_zone1/@link">
                                <h2><a class="big_label">
                                    <iaixsl:attribute name="href"><iaixsl:value-of select="page/products/additional/hotspot/products_zone1/@link"/></iaixsl:attribute><iaixsl:attribute name="title">Klicken Sie hier, um alle Produkte anzuzeigen</iaixsl:attribute>
                                    <iaixsl:choose><iaixsl:when test="page/products/additional/hotspot/products_zone1/@name"><iaixsl:value-of select="page/products/additional/hotspot/products_zone1/@name"/></iaixsl:when><iaixsl:otherwise>Sonderangebot</iaixsl:otherwise></iaixsl:choose>
...
<!--Menu powiadomienia (menu_notice, 107640.1)-->
        ...
        <!--Elementy dodawane dynamicznie (menu_dynamically_added_content, 106830.1)-->
            ...
            <script src="/gfx/ger/search_filters.js.gzip?r=1598273390"></script>
            <script>
                app_shop.runApp();
            </script>
