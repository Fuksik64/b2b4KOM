...
<script src="/gfx/ger/orderdetails_payments.js.gzip?r=1598273390"></script>
                            </iaixsl:when>
                            <iaixsl:otherwise>
            ...
            <div id="orderdetails_info">
                <h2 class="big_label">
                    ...
                    <span class="order-date">
                        Bestellung aus <iaixsl:value-of select="page/prepaid/details/@datetime"/>
                    </span>
                </h2>
                ...
                <div id="orderdetails_info_status">
                    ...
                    <div class="prepaid-status">
                        ...
                        <small>Bestellung Nr.:<iaixsl:value-of select="page/prepaid/details/@orderid"/></small>
                        <iaixsl:if test="page/prepaid/details/@msg = 'order' and page/prepaid/details/@prepaidstatus  = 'c'">
                            <div class="prepaid-msg">
                                    <br />Die Bestellung kann noch nicht bezahlt werden. Warten Sie auf eine Mitteilung darüber, dass die Möglichkeit zur Zahlung freigegeben wurde und eine Zahlung aufgefordert wird.
                            </div>
                        </iaixsl:if>
                        <iaixsl:if test="page/prepaid/details/@msg = 'confirm'">
                            <div class="prepaid-msg">
                                An Ihre E-Mail haben wir eine Bestätigung der Bestellung geschickt. Kontrollieren sie Ihre E-Mail und bestätigen sie Ihre Bestellung.
                            </div>
                        </iaixsl:if>
                    </div>
                    ...
                    <div class="prepaid-buttons">
                        ...
                        <iaixsl:if test="page/prepaid/editlink/@active = 'y'">
                            ...
                            <iaixsl:attribute name="href"><iaixsl:value-of select="page/prepaid/editlink/@link"/></iaixsl:attribute><small><i class="icon-pencil"></i></small><span>Bestellung bearbeiten</span></a>
                        </iaixsl:if>
                ...
                <iaixsl:if test="page/prepaid/prepaid_history/item">
                    <iaixsl:if test="page/prepaid/details/@paymentstatus != 'g' and /shop/page/prepaid_methods/item and (page/prepaid/prepaid_history/item[position() = last()]/@status = 'n' or page/prepaid/prepaid_history/@show_payment_button = 'true')">
                        <div class="show_history_container">
                            <a href="#orderdetails_payments_content">Zahlungsverlauf anzeigen</a>
                        </div>
                    </iaixsl:if>
                                                ...
                                                <iaixsl:if test="not(amount/@mark='negativ')">
                                                    <iaixsl:if test="additional_info/data">
                                                        ...
                                                        <table class="orderdetails_transfer">
                                                            <tr>
                                                                <td><span>Name des Empfängers: </span></td>
										...
										<div class="payments_group">
											...
											<label class="payments_group_sub_content">
												...
												<span class="payments_sub_container">
													<iaixsl:if test="@id = 'blik'">
														<span style="display: none;" class="blik_placeholder">Geben Sie den 6-stelligen BLIK-Code ein:<input id="blik_placeholder_input" type="text"/></span>
													</iaixsl:if>
                            ...
                            <div class="row">
                                <div class="credit_card_pci_dss col-12">
                                    ...
                                    <span class="pci_dss_icon_container">
                                        <img src="/gfx/ger/pci_css_logo.png?r=1598273390" alt="PCI DSS Compilant"/>
                                    </span>
                                </div>
                            </div>
                        </form>
            ...
            <table>
                ...
                <tr>
                    <td class="ordered-icon">
                        <img src="/gfx/ger/shipping_icon.png?r=1598273390">
                    ...
                    <iaixsl:when test="/shop/page/prepaid/prepaid_history/item/@status = 'n'">
                        <iaixsl:for-each select="/shop/page/prepaid/prepaid_history/item[@status = 'n']">
                            <tr class="payment_form_item">
                                <td class="ordered-icon">
                                    <img src="/gfx/ger/prepaid_method_icon.png?r=1598273390">
                                        <iaixsl:if test="@icon">
                                            <iaixsl:attribute name="src"><iaixsl:value-of select="@icon"/></iaixsl:attribute>
                                        </iaixsl:if>
                                        <iaixsl:attribute name="alt"><iaixsl:value-of select="@payment_name"/></iaixsl:attribute>
                ...
                <iaixsl:if test="/shop/page/insurance_product">
                    ...
                    <tr>
                        <td class="ordered-icon">
                            <img src="/gfx/ger/insurance_icon.png?r=1598273390" alt="insurance_icon"/>
                        </td>
                        <td class="ordered-name">
                            Käuferschutz: 
            ...
            <iaixsl:if test="$prepaidrt_txt and /shop/page/prepaid/actions/return/@url">
                <div class="actions_return col-12 col-sm-6">
                    <div class="actions_return_sub col-12 mb-4">
                        ...
                        <div>
                            <img alt="returns" src="/gfx/ger/returns_action.png?r=1598273390"/><span>Wenn Sie Ihr Recht auf Rückgabe der gekauften Ware ohne Angabe von Gründen ausüben wollen, nutzen Sie unser Rückgabesystem, das diesen Prozess einfach und sicher macht.</span></div>
                            <a class="btn --solid">
