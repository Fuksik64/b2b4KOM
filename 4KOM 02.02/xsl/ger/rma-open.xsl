        ...
        <!--RMA - open (rma_open_form, 108756.1)-->
            ...
            <section id="rmaOpen" class="form-open">
                <div class="big_label mb-4">
                    Wählen Sie die Bestellung aus, aus der Sie die Ware reklamieren möchten.
                </div>
                ...
                <div class="menu_messages_message mb-4">
                    <iaixsl:choose>
                        <iaixsl:when test="/shop/page/rma-open/@rma_exist_link and not(/shop/page/rma-open/@rma_exist_link = '')">
                            Für diese Bestellung wurde bereits eine Reklamation generiert. Bitte überprüfen Sie den Status Ihrer aktuellen Anmeldungen oder fügen Sie eine weitere Anmeldung über die Registerkarte der Reklamationen hinzu.
                        </iaixsl:when>
