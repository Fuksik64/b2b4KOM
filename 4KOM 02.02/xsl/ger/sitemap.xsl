...
<div id="account_icon"><a href="/login.php"><i class="icon-account"></i></a></div>
        ...
        <!--Mapa strony - drzewo (sitemap_tree, 108106.1)-->


<iaixsl:variable name="login">Ihr Konto</iaixsl:variable>
<iaixsl:variable name="loginedit">Bitte ändern Sie Ihre Daten</iaixsl:variable>
<iaixsl:variable name="address">Lieferadressen</iaixsl:variable>
<iaixsl:variable name="orders_opened">Offene Bestellungen</iaixsl:variable>
<iaixsl:variable name="orders_closed">Abgeschlossene Bestellungen</iaixsl:variable>
<iaixsl:variable name="affiliate">Partnerprogramm</iaixsl:variable>
<iaixsl:variable name="rma">Reklamationen</iaixsl:variable>
...
<div class="sitemap_page_sub">
	...
	<div class="sitemap_mainpage_wrapper">
	    ...
	    <ul>
	        <iaixsl:for-each select="page/sitemap/item[@id='mainpage']/item">
	        <li>
                <a>
                    <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
	...
	<div class="sitemap_searchpage_wrapper">
	    ...
	    <ul>
	        <iaixsl:for-each select="page/sitemap/item[@id='searchpage']/item">
	        <li>
                <a>
                    <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                    <iaixsl:attribute name="title"><iaixsl:value-of select="@name"/></iaixsl:attribute>
	...
	<div class="sitemap_clientpage_wrapper">
	    <label>Kundenkonto</label>	    
        <ul>
            <iaixsl:for-each select="page/sitemap/item[@id='clientpage']/item">
            <li>
                <a>
                    <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                    <iaixsl:choose>
                    	<iaixsl:when test="@id='login'"><iaixsl:attribute name="title"><iaixsl:copy-of select="$login"/></iaixsl:attribute><iaixsl:copy-of select="$login"/></iaixsl:when>
	                    <iaixsl:when test="@id='loginedit'"><iaixsl:attribute name="title"><iaixsl:copy-of select="$loginedit"/></iaixsl:attribute><iaixsl:copy-of select="$loginedit"/></iaixsl:when>
	                    <iaixsl:when test="@id='address'"><iaixsl:attribute name="title"><iaixsl:copy-of select="$address"/></iaixsl:attribute><iaixsl:copy-of select="$address"/></iaixsl:when>
	                    <iaixsl:when test="@id='orders_opened'"><iaixsl:attribute name="title"><iaixsl:copy-of select="$orders_opened"/></iaixsl:attribute><iaixsl:copy-of select="$orders_opened"/></iaixsl:when>
	                    <iaixsl:when test="@id='orders_closed'"><iaixsl:attribute name="title"><iaixsl:copy-of select="$orders_closed"/></iaixsl:attribute><iaixsl:copy-of select="$orders_closed"/></iaixsl:when>
	                    <iaixsl:when test="@id='affiliate'"><iaixsl:attribute name="title"><iaixsl:copy-of select="$affiliate"/></iaixsl:attribute><iaixsl:copy-of select="$affiliate"/></iaixsl:when>
	                    <iaixsl:when test="@id='rma'"><iaixsl:attribute name="title"><iaixsl:copy-of select="$rma"/></iaixsl:attribute><iaixsl:copy-of select="$rma"/></iaixsl:when>
                    </iaixsl:choose> 
                </a>
            </li>
            </iaixsl:for-each>
	...
	<iaixsl:if test="page/sitemap/item/item/@id='categories'">
	  	<div class="sitemap_categories_wrapper">
	        <label><iaixsl:value-of select="page/sitemap/item/item[@id='categories']/@name"/></label>
	        <ul>
		        <iaixsl:for-each select="page/sitemap/item/item[@id='categories']/item">
		        	<li>
	        		<a><iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute><iaixsl:attribute name="title"><iaixsl:value-of select="@name"/></iaixsl:attribute><iaixsl:value-of select="@name"/></a>
	               		<iaixsl:if test="item">
	               			<ul>
	               				<iaixsl:for-each select="item">
	               					<li>
	...
	<iaixsl:if test="page/sitemap/item/item/@id='producers'">
	  	<div class="sitemap_categories_wrapper">
	        <label><iaixsl:value-of select="page/sitemap/item/item[@id='producers']/@name"/></label>
	        <ul>
		        <iaixsl:for-each select="page/sitemap/item/item[@id='producers']/item">
		        	<li>
		        		<a><iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute><iaixsl:attribute name="title"><iaixsl:value-of select="@name"/></iaixsl:attribute><iaixsl:value-of select="@name"/></a>
		        	</li>
		        </iaixsl:for-each>
	...
	<iaixsl:if test="page/sitemap/item/item/@id='traits'">
  		<div class="sitemap_traits_wrapper">
        	<label><iaixsl:value-of select="page/sitemap/item/item[@id='traits']/@name"/></label>
	        <ul>
		        <iaixsl:for-each select="page/sitemap/item/item[@id='traits']/item">
		        	<li>
		        		<a><iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute><iaixsl:attribute name="title"><iaixsl:value-of select="@name"/></iaixsl:attribute><iaixsl:value-of select="@name"/></a>
                            <iaixsl:if test="item">
                            	<ul>
	...
	<iaixsl:if test="page/sitemap/item/item/@id='series'">
	  	<div class="sitemap_series_wrapper">
	        <label><iaixsl:value-of select="page/sitemap/item/item[@id='series']/@name"/></label>
	        <ul>
		        <iaixsl:for-each select="page/sitemap/item/item[@id='series']/item">
		        	<li>
			        	<a><iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute><iaixsl:attribute name="title"><iaixsl:value-of select="@name"/></iaixsl:attribute><iaixsl:value-of select="@name"/></a>
			        </li>
		        </iaixsl:for-each>
	...
	<iaixsl:if test="page/sitemap/item/item/@id='tree1'">
		<div class="sitemap_tree1_wrapper">
	        <label><iaixsl:value-of select="page/sitemap/item/item[@id='tree1']/@name"/></label>
	        <ul>
		        <iaixsl:for-each select="page/sitemap/item/item[@id='tree1']/item">
		        	<li>
	        		<a><iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute><iaixsl:attribute name="title"><iaixsl:value-of select="@name"/></iaixsl:attribute><iaixsl:value-of select="@name"/></a>
	               		<iaixsl:if test="item">
	               			<ul>
	...
	<iaixsl:if test="page/sitemap/item/item/@id='tree2'">
		<div class="sitemap_tree1_wrapper">
	        <label><iaixsl:value-of select="page/sitemap/item/item[@id='tree2']/@name"/></label>
	        <ul>
		        <iaixsl:for-each select="page/sitemap/item/item[@id='tree2']/item">
		        	<li>
	        		<a><iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute><iaixsl:attribute name="title"><iaixsl:value-of select="@name"/></iaixsl:attribute><iaixsl:value-of select="@name"/></a>
	               		<iaixsl:if test="item">
	               			<ul>
