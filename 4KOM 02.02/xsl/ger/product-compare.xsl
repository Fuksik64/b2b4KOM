...
<h1 class="big_label product_compare_label">Produktvergleich</h1>
    <iaixsl:if test="page/projector/text/body">
            <div id="component_projector_cms" class="cm">
                <iaixsl:value-of disable-output-escaping="yes" select="page/projector/text/body"/>
            </div>
    </iaixsl:if>


<iaixsl:if test="/shop/compare/@active"> </iaixsl:if>
    <!--Porównywarka produktów - lista w ramce (product_compare_list, 108094.1)-->


        <div id="product_compare_list_wrapper" class="hidePrev">

            <div id="product_compare_list" class="compare_page">

                <iaixsl:attribute name="data-compare_item"><iaixsl:value-of select="count(page/products/product)"/></iaixsl:attribute>
                ...
                <table>
                    ...
                    <tbody>
                        <tr class="cmp_product">
                            ...
                            <th class="cmp_product configure"><div class="item_width">
                                <iaixsl:if test="lastsearch">
                                    <a class="btn --solid --secondary --medium d-block mb-2">

                                        <iaixsl:attribute name="href"><iaixsl:value-of select="lastsearch"/></iaixsl:attribute>

                                        Zurück zur Liste der Waren
                                    </a>
                                </iaixsl:if>
                                <a class="btn --solid --medium d-block mb-2">
                                    <iaixsl:attribute name="href">#differences</iaixsl:attribute>
                                    <iaixsl:attribute name="data-toggleTxt">Unterschiede ausblenden</iaixsl:attribute>
                                    Nur Unterschiede anzeigen

                                </a>
                            </div></th>
                            <iaixsl:for-each select="page/products/product">
                                <td class="cmp_product">

                                    <div class="configure_item item_width">
                                        <a >
                                            <iaixsl:attribute name="href">#hiddeProduct=<iaixsl:value-of select="@id"/></iaixsl:attribute>
                                            <iaixsl:attribute name="data-position"><iaixsl:value-of select="position()"/></iaixsl:attribute>
                                            <iaixsl:attribute name="data-toggleTxt">&lt;i class="icon-plus"&gt;&lt;/i&gt; zeig an</iaixsl:attribute>
                                            <i class="icon-minus"></i> verbirg
                                        </a>
                                        <a class="hideCol">
                                            <iaixsl:attribute name="data-del_position"><iaixsl:value-of select="position()"/></iaixsl:attribute>
                                            <iaixsl:attribute name="href">settings.php?comparers=remove&amp;product=<iaixsl:value-of select="@id"/></iaixsl:attribute>
                                            <i class="icon-remove"></i> lösch
                                        </a>
                                    </div>
                                    <div class="product_wrapper item_width">
                                        <a class="product-icon align_row" data-align="img#css">
                                            <iaixsl:attribute name="href"><iaixsl:value-of select="link"/></iaixsl:attribute>
                                            <img class="b-lazy" src="/gfx/ger/loader.gif?r=1598273390">
                                            ...
                                            <strong class="label_icons hideCol">
                                                ...
                                                <iaixsl:if test="(additional/promotion)">
                                                    <span class="label promo">
                                                        Im Sonderangebot
                                                    </span>
                                                </iaixsl:if>
                                                <iaixsl:if test="(additional/new)">
                                                    <span class="label newproducts">
                                                        Neu
                                                    </span>
                                                </iaixsl:if>
                                                <iaixsl:choose>
                                                    <iaixsl:when test="(additional/promotion) and (additional/new)">
                                                    </iaixsl:when>
                                                    <iaixsl:when test="(additional/promotion) or (additional/new)">
                                                        <iaixsl:choose>
                                                            <iaixsl:when test="(additional/bestseller)">
                                                                <span class="label bestseller">
                                                                    Unser Bestseller
                                                                </span>
                                                            </iaixsl:when>
                                                            <iaixsl:when test="(additional/discount)">
                                                                <span class="label discount">
                                                                    Preisreduzierung
                                                                </span>
                                                            </iaixsl:when>
                                                            <iaixsl:when test="(additional/distinguished)">
                                                    ...
                                                    <iaixsl:otherwise>
                                                        <iaixsl:if test="(additional/bestseller)">
                                                            <span class="label bestseller">
                                                                Unser Bestseller
                                                            </span>
                                                        </iaixsl:if>
                                                        <iaixsl:if test="(additional/discount)">
                                                            <span class="label discount">
                                                                Preisreduzierung
                                                            </span>
                                                        </iaixsl:if>
                                                        <iaixsl:if test="(additional/distinguished) and not((additional/bestseller) and (additional/discount))">
                                                            <span class="label distinguished">
                                                                Empfohlen
                                                            </span>
                                                        </iaixsl:if>
                                        ...
                                        <iaixsl:variable name="var_size_min_formatted"><iaixsl:value-of select="price/price/@size_min_formatted"/></iaixsl:variable>
                                        <iaixsl:variable name="var_size_max_formatted"><iaixsl:value-of select="price/price/@size_max_formatted"/></iaixsl:variable>
                                        <iaixsl:variable name="var_points"><iaixsl:value-of select="price/price/@points"/></iaixsl:variable>
                                        <iaixsl:variable name="var_value"><iaixsl:value-of select="price/price/@value"/></iaixsl:variable>
                                        <iaixsl:variable name="var_price_formatted"><iaixsl:value-of select="price/price/@price_formatted"/></iaixsl:variable>
                                        <iaixsl:variable name="var_maxprice_formatted"><iaixsl:value-of select="price/price/@maxprice_formatted"/></iaixsl:variable>
                                        ...
                                        <div class="product_prices hideCol">
                                            <iaixsl:choose>
                                                ...
                                                <iaixsl:when test="$var_size_min_formatted != $var_size_max_formatted">
                                                    <span class="price">
                                                        <iaixsl:value-of select="$var_size_min_formatted"/>
                                                        <iaixsl:text> - </iaixsl:text>
                                                        <iaixsl:value-of select="$var_size_max_formatted"/>
                                                    </span>
                                                ...
                                                <iaixsl:when test="($var_value = 0) and $var_points = ''">
                                                    <a class="fon_price">
                                            ...
                                            <iaixsl:if test="price/price/@unit_converted_price_formatted"><small class="unit_price"><iaixsl:value-of select="price/price/@unit_converted_price_formatted"/><iaixsl:text> / </iaixsl:text><iaixsl:value-of select="price/price/@unit_converted_format"/></small>
                                            </iaixsl:if>
                                        </div>

                                        <iaixsl:if test="producer != '' or barcode != '' or @note">
                                            <div class="list_traits hideCol">
                                                <ul>
                                                    <iaixsl:if test="producer != ''">
                                                        <li class="producer">
                                                            <span>Hersteller</span>
                                                            <div>
                                                                <iaixsl:value-of disable-output-escaping="yes" select="producer"/>
                                                            </div>
                                                        </li>
                                                    </iaixsl:if>
                                                    <iaixsl:if test="barcode != ''">
                                                        <li class="barcode">
                                                            <span>Produktcode</span>
                                                            <div>
                                                                <iaixsl:value-of disable-output-escaping="yes" select="barcode"/>
                                                            </div>
                                                        </li>
                                                    </iaixsl:if>
                                                    <iaixsl:if test="@note">
                        ...
                        <iaixsl:if test="page/products/product/size">
                            <iaixsl:if test="not(page/products/product/size/size/@name = 'uniw')">
                                <tr>
                                    <th><div class="item_width"> Größe</div></th>
                                    <iaixsl:for-each select="page/products/product">
                                        <td>
                                            <div class="hideCol item_width">
                                                <iaixsl:for-each select="size/size">
                                                    <iaixsl:if test="not(@name = 'uniw')">
                                                        <iaixsl:value-of select="text()"/><iaixsl:if test="not(count(../size) = position())">, </iaixsl:if>
                                                    </iaixsl:if>
                                                </iaixsl:for-each>
                                            </div>
                                        </td>
                        ...
                        <iaixsl:if test="page/products/versions">
                            <iaixsl:for-each select="page/products/versions/version">
                                <tr>
                                    <th><div class="item_width">Versionen für  <iaixsl:value-of select="@name"/></div></th>
                                    <iaixsl:for-each select="product">
                                        <td>
                                            <div class="hideCol item_width">
                                                <iaixsl:for-each select="version">
                                                    <iaixsl:choose>
                                                        <iaixsl:when test="not(@icon)">
                                                            <img><iaixsl:attribute name="src"><iaixsl:value-of select="@icon"/></iaixsl:attribute></img>
                                                        </iaixsl:when>
                                                        <iaixsl:otherwise>
                                                            <iaixsl:value-of select="@name"/><iaixsl:if test="not(count(../version) = position())">, </iaixsl:if>
                                                        </iaixsl:otherwise>
                                                    </iaixsl:choose>
                        ...
                        <iaixsl:if test="page/products/product/description">
                            <tr>
                                <th><div class="item_width"> Beschreibung</div></th>
                                <iaixsl:for-each select="page/products/product">
                                    <td>
                                        <div class="hideCol item_width">
                                            <iaixsl:value-of disable-output-escaping="yes" select="description"/>
                        ...
                        <iaixsl:if test="page/products/traits">
                            <iaixsl:for-each select="page/products/traits/traits_group">
                                <tr>
                                    <th><div class="item_width">
                                        <iaixsl:value-of disable-output-escaping="yes" select="@name"/>
                                    </div></th>
                                    <iaixsl:for-each select="product">
                                        <td>
                                            <div class="hideCol item_width">
                                                <iaixsl:for-each select="trait">
                                                    <iaixsl:value-of disable-output-escaping="yes" select="text()"/><iaixsl:if test="not(count(../trait) = position())">, </iaixsl:if>
                                                </iaixsl:for-each>
                                            </div>
                                        </td>
                                    </iaixsl:for-each>
                        ...
                        <iaixsl:for-each select="/shop/page/products/dictionary/element_group">
                            <tr>
                                <th><div class="item_width"> <iaixsl:value-of disable-output-escaping="yes" select="@name"/></div></th>
                                <iaixsl:for-each select="product">
                                    <td><div class="hideCol item_width">
                                        <iaixsl:for-each select="item"><iaixsl:if test="position()!=1">, </iaixsl:if>
                                            <iaixsl:value-of disable-output-escaping="yes" select="text()"/>
                                        </iaixsl:for-each>
                                    </div></td>
                                </iaixsl:for-each>
            ...
            <div class="navigation">
                <a class="prev" href="#prev"><i class="icon-chevron-left"></i></a>
                <a class="next" href="#next"><i class="icon-chevron-right"></i></a>
            </div>
