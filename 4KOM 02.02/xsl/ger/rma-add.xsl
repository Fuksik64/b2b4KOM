...
<div id="account_icon"><a href="/login.php"><i class="icon-account"></i></a></div>
    ...
    <iaixsl:if test="page/text/body">
        <div class="rma_add_cms_label">
<iaixsl:attribute name="class">rma_add_cms_label  big_label</iaixsl:attribute>
            <span class="rma_add_cms_label">
                    Zusätzliche Informationen
            </span>
        </div>
        <div class="rma_add_cms">
            <div class="rma_add_cms_sub">
                <iaixsl:attribute name="class">rma_add_cms_sub cm</iaixsl:attribute>
    ...
    <!--Dodawanie reklamacji - Formularz (rma_add_form, 107791.1)-->
        ...
        <iaixsl:variable name="tel_link">tel: </iaixsl:variable>
        ...
        <div class="rma_add_form_outline">
            <form id="rma_add_form" method="post" action="/rma-add.php">
                <iaixsl:if test="page/rma/@action = 'add'">
                    <input name="add" type="hidden" value="1"/>
                </iaixsl:if>
                <iaixsl:if test="page/rma/@action = 'edit'">
                    <input name="edit" type="hidden">
                        <iaixsl:attribute name="value"><iaixsl:value-of select="page/rma/@id"/></iaixsl:attribute>
                    </input>
                </iaixsl:if>
                <iaixsl:if test="not(page/rma/@action = 'view')">
                    <iaixsl:if test="page/rma/inputs/@serial_number_active">
                        <input name="serial_number_active" id="serial_number_active" type="hidden">
                            <iaixsl:attribute name="value"><iaixsl:value-of select="page/rma/inputs/@serial_number_active"/></iaixsl:attribute>
                        </input>
                    </iaixsl:if>
                    <iaixsl:if test="page/rma/payments/@active">
                        <input name="payments_active" id="payments_active" type="hidden">
                            <iaixsl:attribute name="value"><iaixsl:value-of select="page/rma/payments/@active"/></iaixsl:attribute>
                        </input>
                    </iaixsl:if>
                    <input type="hidden" name="rma_stock" id="rma_stock">
                        <iaixsl:attribute name="value"><iaixsl:value-of select="page/rma/stocks/stock[@selected = 'selected']/@id"/></iaixsl:attribute>
                    </input>
                </iaixsl:if>

                <div class="rma_add_form_label">
                    <span class="rma_add_form_label">
                        Reklamationsabteilung(RMA)
                    </span>
                </div>
                <div class="rma_add_form_addbutton">
                    <a href="rma-list.php" class="btn --solid --medium --icon-left icon-file-alt rma_add_form_listbutton">
                        <iaixsl:attribute name="title">Klicken Sie hier, um zur Liste der Reklamationen zu gelangen</iaixsl:attribute>
                        <span class="img_rma_add"/>
                        Ihre Reklamationen
                    </a>
                </div>
                ...
                <div class="rma_add_form_label" id="label2_rma">
                    <span class="rma_add_form_label">
                        <iaixsl:choose>
                            <iaixsl:when test="page/rma/@action = 'view'">
                                Vorschau der Reklamation Nr.<iaixsl:value-of select="page/rma/@id"/>
                            </iaixsl:when>
                            <iaixsl:when test="page/rma/@action = 'edit'">
                                Bearbeitung der Reklamation Nr.<iaixsl:value-of select="page/rma/@id"/>
                            </iaixsl:when>
                            <iaixsl:when test="page/rma/@action = 'add'">
                                Meldung einer neuen Reklamation
                            </iaixsl:when>
                        </iaixsl:choose>
                    </span>
                </div>
                ...
                <div class="rma_add_form_section" id="rma_add_form_section1">
                    <div class="rma_add_form_sectionheader">
                        <span class="rma_add_form_sectionheader">Ihre Daten</span>
                    </div>
                    <iaixsl:if test="not(page/rma/@action = 'view')">
                        <div class="rma_add_form_sectiondesc">
                            <span class="rma_add_form_sectiondesc">Unten befinden sich die Daten, die Sie bei der Registrierung eingegeben haben. Bitte überprüfen Sie, ob alle Angaben korrekt sind.</span>
                            <a class="rma_add_form_clientedit">
                                <iaixsl:attribute name="href"><iaixsl:value-of select="page/rma/client/@edit_link"/></iaixsl:attribute>
                                <iaixsl:attribute name="title">Gehen Sie zur Datenbearbeitung</iaixsl:attribute>
                    ...
                    <div class="rma_add_form_sectionsub row" id="rma_add_form_subsection1">
                        ...
                        <div class="rma_add_form_box" id="rma_add_form_box1">
                            <span class="rma_add_form_adr1">Rechnungsdaten:</span>
                            <div class="rma_add_form_boxsub3">
                                <iaixsl:choose>
                                    <iaixsl:when test="page/rma/client/@company_name">
                                        <span class="rma_add_form_infovalue3"><iaixsl:value-of select="page/rma/client/@company_name"/></span>
                                    </iaixsl:when>
                                    <iaixsl:otherwise>
                                        <span class="rma_add_form_infovalue3"><iaixsl:value-of select="page/rma/client/@name"/><iaixsl:text> </iaixsl:text><iaixsl:value-of select="page/rma/client/@lastname"/></span>
                                    </iaixsl:otherwise>
                                </iaixsl:choose>
                            </div>
                            <iaixsl:if test="page/rma/client/@address and not(page/rma/client/@address = '')">
                                <div class="rma_add_form_boxsub3">
                                    <span class="rma_add_form_infovalue3"><iaixsl:value-of select="page/rma/client/@address"/></span>
                                </div>
                            </iaixsl:if>
                            <iaixsl:if test="page/rma/client/@zip and not(page/rma/client/@zip = '')">
                                <div class="rma_add_form_boxsub3">
                                    <span class="rma_add_form_infovalue3"><iaixsl:value-of select="page/rma/client/@zip"/><iaixsl:text> </iaixsl:text><iaixsl:value-of select="page/rma/client/@city"/><span class="rma_add_form_infocountry"><iaixsl:text> (</iaixsl:text><iaixsl:if test="page/rma/client/@province"><iaixsl:value-of select="page/rma/client/@province"/><iaixsl:text>, </iaixsl:text></iaixsl:if><iaixsl:value-of select="page/rma/client/@country"/><iaixsl:text>)</iaixsl:text></span></span>
                                </div>
                            </iaixsl:if>
                            <iaixsl:if test="page/rma/client/@nip and not(page/rma/client/@nip = '')">
                                <div class="rma_add_form_boxsub3">
                                    <span class="rma_add_form_infovalue3"><iaixsl:value-of select="page/rma/client/@nip"/></span>
                                </div>
                            </iaixsl:if>
                        ...
                        <div class="rma_add_form_box" id="rma_add_form_box2">
                            <span class="rma_add_form_adr2">Lieferadresse:</span>
                            <div class="rma_add_form_boxsub3">
                                <iaixsl:choose>
                                    <iaixsl:when test="page/rma/delivery_adress/@company_name">
                                        <span class="rma_add_form_infovalue3"><iaixsl:value-of select="page/rma/delivery_adress/@company_name"/></span>
                                    </iaixsl:when>
                                    <iaixsl:otherwise>
                                        <span class="rma_add_form_infovalue3"><iaixsl:value-of select="page/rma/delivery_adress/@firstname"/><iaixsl:text> </iaixsl:text><iaixsl:value-of select="page/rma/delivery_adress/@lastname"/></span>
                                    </iaixsl:otherwise>
                                </iaixsl:choose>
                            </div>
                            <iaixsl:if test="page/rma/delivery_adress/@street and not(page/rma/delivery_adress/@street = '')">
                                <div class="rma_add_form_boxsub3">
                                    <span class="rma_add_form_infovalue3"><iaixsl:value-of select="page/rma/delivery_adress/@street"/></span>
                                </div>
                            </iaixsl:if>
                            <iaixsl:if test="page/rma/delivery_adress/@zipcode and not(page/rma/delivery_adress/@zipcode = '')">
                                <div class="rma_add_form_boxsub3">
                                    <span class="rma_add_form_infovalue3"><iaixsl:value-of select="page/rma/delivery_adress/@zipcode"/><iaixsl:text> </iaixsl:text><iaixsl:value-of select="page/rma/delivery_adress/@city"/><span class="rma_add_form_infocountry"><iaixsl:text> (</iaixsl:text><iaixsl:if test="page/rma/delivery_adress/@province"><iaixsl:value-of select="page/rma/delivery_adress/@province"/><iaixsl:text>, </iaixsl:text></iaixsl:if><iaixsl:value-of select="page/rma/delivery_adress/@country"/><iaixsl:text>)</iaixsl:text></span></span>
                                </div>
                            </iaixsl:if>
                        </div>
                        </div>
                        ...
                        <div class="rma_add_form_box" id="rma_add_form_box2b">
                            <span class="rma_add_form_adr1">Kontaktdaten:</span>

                            <iaixsl:if test="page/rma/client/@phone and not(page/rma/client/@phone = '')">
                                <div class="rma_add_form_boxsub3">
                                    <span class="rma_add_form_infovalue3"><iaixsl:value-of select="page/rma/client/@phone"/></span>
                                </div>
                            </iaixsl:if>
                            <iaixsl:if test="page/rma/client/@phone2 and not(page/rma/client/@phone2 = '')">
                                <div class="rma_add_form_boxsub3">
                                    <span class="rma_add_form_infovalue3"><iaixsl:value-of select="page/rma/client/@phone2"/></span>
                                </div>
                            </iaixsl:if>
                            <iaixsl:if test="page/rma/client/@email and not(page/rma/client/@email = '')">
                                <div class="rma_add_form_boxsub3">
                                    <span class="rma_add_form_infovalue3"><iaixsl:value-of select="page/rma/client/@email"/></span>
                                </div>
                            </iaixsl:if>
                        </div>
                        </div>
                ...
                <div class="rma_add_form_section" id="rma_add_form_section2">
                    <div class="rma_add_form_sectionheader">
                        <span class="rma_add_form_sectionheader">Informationen zum reklamierten Produkt</span>
                    </div>
                    <iaixsl:if test="not(page/rma/@action = 'view')">
                        <div class="rma_add_form_sectiondesc">
                            <span class="rma_add_form_sectiondesc">Die folgende Informationen sind notwendig, um die Reklamation zu prüfen. Bitte geben Sie den Produktnamen mit der Größe ein.</span>
                        </div>
                    </iaixsl:if>
                    <div class="rma_add_form_sectionsub row" id="rma_add_form_subsection2">
                        ...
                        <div class="rma_add_form_box" id="rma_add_form_box3">
                            <div class="rma_add_form_boxsub">
                                ...
                                <iaixsl:choose>
                                    <iaixsl:when test="page/rma/@action = 'view'">
                                        <span class="rma_add_form_infotitle">
                                            Produktname:
                                        </span>
                                        <span id="rma_add_form_product" class="rma_add_form_infovalue"><iaixsl:value-of disable-output-escaping="no" select="page/rma/inputs/@product"/></span>
                                    </iaixsl:when>
                                    <iaixsl:otherwise>
                                        <div class="form-group clearfix">
                                            <div class=" ">
                                                <label for="rma_add_form_product" class="control-label">
                                                    Produktname:
                                                </label>
                                            </div>
                                            <div class="has-feedback has-required ">
                                                <input id="rma_add_form_product" name="product" type="text" class="form-control validate rma_add_form_input" minlength="3">
                                                    <iaixsl:if test="/shop/page/rma/@action = 'edit'">
                                                        <iaixsl:attribute name="value"><iaixsl:value-of disable-output-escaping="no" select="page/rma/inputs/@product"/></iaixsl:attribute>
                                                    </iaixsl:if>
                                                </input>
                                ...
                                <iaixsl:if test="not(page/rma/@action = 'view')"><div class="rma_add_help" id="rma_add_product_help"><div class="rma_add_help2"/></div></iaixsl:if>
                            </div>
                            <iaixsl:if test="not(page/rma/inputs/@serial_number_active = '0')">
                                <div class="rma_add_form_boxsub">
                                    ...
                                    <iaixsl:choose>
                                        <iaixsl:when test="page/rma/@action = 'view'">
                                            ...
                                            <span id="rma_add_form_serial_number" class="rma_add_form_infovalue"><iaixsl:value-of disable-output-escaping="no" select="page/rma/inputs/@serial_number"/></span>
                                        </iaixsl:when>
                                        <iaixsl:otherwise>
                                        <div class="form-group clearfix">
                                            <div class=" ">
                                                <label for="rma_add_form_begin_ymd" class="control-label">
                                                    Seriennummer des Produkts:
                                                </label>
                                            </div>
                                            <div class=" ">
                                                <input id="rma_add_form_serial_number" type="text" name="serial_number" class="form-control rma_add_form_input">
                                                    <iaixsl:if test="/shop/page/rma/@id">
                                                        <iaixsl:attribute name="value"><iaixsl:value-of select="page/rma/inputs/@serial_number"/></iaixsl:attribute>
                                                    </iaixsl:if>
                                                </input>
                                            </div>
                                        </div>
                                    ...
                                    <iaixsl:if test="not(page/rma/@action = 'view')"><div class="rma_add_help" id="rma_add_serial_number_help"><div class="rma_add_help2"/></div></iaixsl:if>
                                </div>
                            </iaixsl:if>
                            <div class="rma_add_form_boxsub">
                                ...
                                <iaixsl:choose>
                                    <iaixsl:when test="page/rma/@action = 'view'">
                                        ...
                                        <span id="rma_add_form_begin_ymd" class="rma_add_form_infovalue"><iaixsl:value-of disable-output-escaping="no" select="page/rma/inputs/@data"/></span>
                                    </iaixsl:when>
                                    <iaixsl:otherwise>
                                    ...
                                    <div class="form-group clearfix">
                                            ...
                                            <div class="has-feedback has-required ">
                                                <input id="rma_add_form_begin_ymd" type="text" name="begin_ymd" class="form-control validate rma_add_form_input" onkeyup="rma_add.checkInps('begin_ymd');" minlength="10">
                                                    <iaixsl:attribute name="value"><iaixsl:value-of select="page/rma/inputs/@data"/></iaixsl:attribute>
                                                </input>
                                                <span class="form-control-feedback"/>
                                            </div>
                                        </div>

                                        <input id="rma_add_form_beginy" name="beginy" type="hidden">
                                            <iaixsl:attribute name="value"><iaixsl:value-of select="page/rma/inputs/@calY"/></iaixsl:attribute>
                                        </input>
                                        <input id="rma_add_form_beginm" name="beginm" type="hidden">
                                            <iaixsl:attribute name="value"><iaixsl:value-of select="page/rma/inputs/@calm"/></iaixsl:attribute>
                                        </input>
                                        <input id="rma_add_form_begind" name="begind" type="hidden">
                                            <iaixsl:attribute name="value"><iaixsl:value-of select="page/rma/inputs/@cald"/></iaixsl:attribute>
                                        </input>
                                        <div class="rma_add_help" id="rma_add_ymd_help"><div class="rma_add_help2"/></div>
                                    </iaixsl:otherwise>
                                </iaixsl:choose>
                            </div>
                            <div class="rma_add_form_boxsub">
                                <span class="rma_add_form_infotitle">Kaufort:</span>
                                <span class="rma_add_form_infovalue">
                                    <iaixsl:choose>
                                        <iaixsl:when test="page/rma/@action = 'view'">
                                            <iaixsl:if test="page/rma/buy_place/place[@checked = 'true']/@name = 'shop'">Online-Shop </iaixsl:if>
                                            <iaixsl:if test="page/rma/buy_place/place[@checked = 'true']/@name = 'auction'">Internet-Auktion<iaixsl:value-of select="page/rma/auctions/auction[@checked = 'true']/@name"/></iaixsl:if>
                                            <iaixsl:if test="page/rma/buy_place/place[@checked = 'true']/@name = 'other'"><iaixsl:value-of disable-output-escaping="no" select="page/rma/buy_place/place[@name = 'other']/@desc"/></iaixsl:if>
                                        </iaixsl:when>
                                        <iaixsl:otherwise>
                                            <iaixsl:for-each select="page/rma/buy_place/place">
                                                <span class="rma_add_form_buyplace">
                                                    <input type="radio" name="buy_place">
                                                        <iaixsl:attribute name="value"><iaixsl:value-of select="@value"/></iaixsl:attribute>
                                                        <iaixsl:attribute name="onclick">rma_add.setPlace('rma_add_form_buyplace_<iaixsl:value-of select="@name"/>');</iaixsl:attribute>
                                                        <iaixsl:if test="@checked = 'true'">
                                                            <iaixsl:attribute name="checked">checked</iaixsl:attribute>
                                                        </iaixsl:if>
                                                    </input>
                                                    <iaixsl:choose>
                                                        <iaixsl:when test="@name = 'shop'">
                                                            Online-Shop 
                                                        </iaixsl:when>
                                                        <iaixsl:when test="@name = 'auction'">
                                                            Internet-Auktion
                                                            <span class="rma_add_form_boxsub_hidden">
                                                                <iaixsl:attribute name="id">rma_add_form_buyplace_auction</iaixsl:attribute>
                                                                <iaixsl:choose>
                                                                ...
                                                                <select id="buy_place_action" name="buy_place_action">
                                                                    <iaixsl:for-each select="/shop/page/rma/auctions/auction">
                                                                        <option>
                                                                            <iaixsl:attribute name="value"><iaixsl:value-of select="@value"/></iaixsl:attribute>
                                                                            <iaixsl:if test="@checked = 'true'">
                                                                                <iaixsl:attribute name="selected">selected</iaixsl:attribute>
                            ...
                            <iaixsl:if test="not(page/rma/@action = 'view')">
                                <iaixsl:for-each select="page/rma/buy_place/place">
                                    <div class="rma_add_form_boxsub_hidden">
                                        <iaixsl:choose>
                                            <iaixsl:when test="@checked = 'true'">
                                                <iaixsl:attribute name="style">display:block;</iaixsl:attribute>
                                            </iaixsl:when>
                                        ...
                                        <iaixsl:choose>
                                            <iaixsl:when test="@name = 'shop'">
                                                <iaixsl:attribute name="id">rma_add_form_buyplace_shop</iaixsl:attribute>
                                            </iaixsl:when>
                                            <iaixsl:when test="@name = 'other'">
                                                <iaixsl:attribute name="id">rma_add_form_buyplace_other</iaixsl:attribute>
                                                
                                                <div class="form-group clearfix">
                                                    <div class=" ">
                                                        <label for="buy_place_desc" class="control-label">
                                                            Kurze Beschreibung des Kauforts:
                                                        </label>
                                                    </div>
                                                    <div class="has-feedback has-required ">
                                                        <input id="buy_place_desc" class="rma_add_form_input form-control validate" name="buy_place_desc" type="text" onkeyup="rma_add.checkInps('buy_place_desc');">
                                                            <iaixsl:attribute name="value"><iaixsl:value-of select="@desc"/></iaixsl:attribute>
                                                        </input>
                                                        <span class="form-control-feedback"/>
                                                    </div>
                                                </div>
                                                <div class="rma_add_help" id="buy_place_desc_help"><div class="rma_add_help2"/></div>
                                            </iaixsl:when>
                                        </iaixsl:choose>
                                    </div>
                                </iaixsl:for-each>
                        ...
                        <div class="rma_add_form_box" id="rma_add_form_box4">
                            ...
                            <div class="rma_add_form_descval">
                                <iaixsl:choose>
                                    <iaixsl:when test="page/rma/@action = 'view'">
                                        <span class="rma_add_form_desc">Mängelbeschreibung:</span>
                                        <iaixsl:value-of disable-output-escaping="no" select="page/rma/failure"/>

                                    </iaixsl:when>
                                    <iaixsl:otherwise>
                                        <div class="form-group clearfix">
                                            <div class=" ">
                                                <label for="rma_add_form_desc" class="control-label">
                                                    Mängelbeschreibung:
                                                </label>
                                            </div>
                                            <div class="has-feedback has-required ">
                                                <textarea id="rma_add_form_desc" name="usterka" class="form-control validate rma_add_form_desc" minlength="3">
                                                    <iaixsl:if test="page/rma/@action = 'edit'">
                                                        <iaixsl:value-of select="page/rma/failure"/>
                                                    </iaixsl:if>
                                                </textarea>
                                                <span class="form-control-feedback"/>
                                            </div>
                                        </div>
                                        <div class="rma_add_help" id="rma_add_desc_help"><div class="rma_add_help2"/></div>
                                    </iaixsl:otherwise>
                                </iaixsl:choose>
                            </div>
                        </div>
                ...
                <iaixsl:if test="not(page/rma/payments/@active = '0')">
                    <div class="rma_add_form_section" id="rma_add_form_section3">
                        <div class="rma_add_form_sectionheader">
                            <span class="rma_add_form_sectionheader">Rückerstattung</span>
                        </div>
                        <iaixsl:if test="not(page/rma/@action = 'view')">
                            <div class="rma_add_form_sectiondesc">
                                <span class="rma_add_form_sectiondesc">Zur Beschleunigung der Rückerstattung, wenn die Beschwerde positiv behandelt werden, geben Sie unten, welcher Rückerstattung Sie erwarten. Die Angabe dieser Informationen bedeutet nicht, dass Sie das Geld zurück bekommen.</span>
                            </div>
                        </iaixsl:if>
                        ...
                        <div class="col-12 col-sm-4">
                            <div class="rma_add_form_box" id="rma_add_form_box5">
                                <div class="rma_add_form_boxsub2">
                                    <span class="rma_add_form_infotitle2">Form der Rückerstattung:</span>
                                    <span class="rma_add_form_infovalue2">
                                        <iaixsl:choose>
                                            <iaixsl:when test="page/rma/@action = 'view'">
                                                <iaixsl:choose>
                                                    <iaixsl:when test="page/rma/payments/payment[@checked = 'true']/@type = 'b'">Bankkonto</iaixsl:when>
                                                    <iaixsl:when test="page/rma/payments/payment[@checked = 'true']/@type = 'p'">Geldanweisung an die Adresse</iaixsl:when>
                                                    <iaixsl:when test="page/rma/payments/payment[@checked = 'true']/@type = 'c'">Scheck</iaixsl:when>
                                                    <iaixsl:when test="page/rma/payments/payment[@checked = 'true']/@type = 't'">freie Mittel für zukünftige Einkäufe</iaixsl:when>
                                                </iaixsl:choose>
                                            </iaixsl:when>
                                            <iaixsl:otherwise>
                                                <iaixsl:for-each select="page/rma/payments/payment">
                                                    <span>
                                                        <input type="radio" name="payment_source">
                                                            <iaixsl:attribute name="value"><iaixsl:value-of select="@type"/></iaixsl:attribute>
                                                            <iaixsl:attribute name="onclick">rma_add.setPayment('rma_add_form_pay<iaixsl:value-of select="@type"/>');</iaixsl:attribute>
                                                            <iaixsl:if test="@checked = 'true'">
                                                                <iaixsl:attribute name="checked">checked</iaixsl:attribute>
                                                            </iaixsl:if>
                                                        </input>
                                                        <iaixsl:choose>
                                                            <iaixsl:when test="@type = 'b'">
                                                                Bankkonto
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@type = 'p'">
                                                                Geldanweisung an die Adresse
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@type = 'c'">
                                                                Scheck
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@type = 't'">
                                                                freie Mittel für zukünftige Einkäufe
                                                            </iaixsl:when>
                                                        </iaixsl:choose>
                                                    </span>
                                                </iaixsl:for-each>
                                ...
                                <iaixsl:choose>
                                    <iaixsl:when test="page/rma/@action = 'view'">
                                        <iaixsl:choose>
                                            <iaixsl:when test="page/rma/payments/payment[@checked = 'true']/@type = 'b'">
                                                <div class="rma_add_form_boxsub2_hidden" style="display:block;">
                                                    <span class="rma_add_form_infotitle2">Bankkonto</span>
                                                    <span class="rma_add_form_infovalue2"><iaixsl:value-of disable-output-escaping="no" select="page/rma/payments_text"/></span>
                                                </div>
                                            </iaixsl:when>
                                            <iaixsl:when test="page/rma/payments/payment[@checked = 'true']/@type = 'p'">
                                                <div class="rma_add_form_boxsub2_hidden" style="display:block;">
                                                    <span class="rma_add_form_infotitle2">Geldanweisung an die Adresse</span>
                                                    <span class="rma_add_form_infovalue2"><iaixsl:value-of disable-output-escaping="no" select="page/rma/payments_text"/></span>
                                                </div>
                                            </iaixsl:when>
                                            <iaixsl:when test="page/rma/payments/payment[@checked = 'true']/@type = 'c'">
                                                <div class="rma_add_form_boxsub2_hidden" style="display:block;">
                                                    <span class="rma_add_form_infotitle2">Scheck</span>
                                                    <span class="rma_add_form_infovalue2"><iaixsl:value-of disable-output-escaping="no" select="page/rma/payments_text"/></span>
                                                </div>
                                            </iaixsl:when>
                                        </iaixsl:choose>
                                    ...
                                    <iaixsl:otherwise>
                                        <iaixsl:for-each select="page/rma/payments/payment">
                                            <div class="rma_add_form_boxsub2_hidden">
                                                <iaixsl:attribute name="id">rma_add_form_pay<iaixsl:value-of select="@type"/></iaixsl:attribute>
                                                <iaixsl:choose>
                                                    <iaixsl:when test="@checked = 'true'">
                                                        <iaixsl:attribute name="style">display:block;</iaixsl:attribute>
                                                    </iaixsl:when>
                                                ...
                                                <iaixsl:choose>
                                                    <iaixsl:when test="@type = 'p'">
                                                        ...
                                                        <span class="rma_add_form_infotitle2">
                                                            Adresse:
                                                            <iaixsl:if test="/shop/page/rma/payments/@active = '1'">
                                                                <img class="rma_need" src="/gfx/ger/need.gif?r=1598273390"><iaixsl:attribute name="alt">Dieses Feld muss ausgefüllt werden, um die Bestellung aufzugeben</iaixsl:attribute></img>
                                                                <img src="/gfx/ger/correct.png?r=1598273390" class="rma_correct_img" id="rma_add_przekaz_on" style="display:none;"/>
                                                                <img src="/gfx/ger/incorrect.png?r=1598273390" class="rma_correct_img" id="rma_add_przekaz_off" style="display:none;"/>
                                                            </iaixsl:if>
                                                        </span>
                                                        <textarea id="rma_add_form_przekaz" class="rma_add_form_input" name="payment_addres2" onkeyup="rma_add.checkInps('payment_addres2');">
                                                            <iaixsl:if test="(@checked = 'true') and (/shop/page/rma/payments_text)"><iaixsl:value-of disable-output-escaping="no" select="/shop/page/rma/payments_text"/></iaixsl:if>
                                                        </textarea>
                                                        <div class="rma_add_help" id="rma_add_przekaz_help"><div class="rma_add_help2"/></div>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="@type = 'b'">
                                                        <iaixsl:if test="@checked = 'true'">
                                                        ...
                                                        <span class="rma_add_form_infotitle2">
                                                            ...
                                                            <iaixsl:if test="/shop/page/rma/payments/@active = '1'">
                                                                <img class="rma_need" src="/gfx/ger/need.gif?r=1598273390"><iaixsl:attribute name="alt">Dieses Feld muss ausgefüllt werden, um die Bestellung aufzugeben</iaixsl:attribute></img>
                                                                <img src="/gfx/ger/correct.png?r=1598273390" class="rma_correct_img" id="rma_add_bankaccount_on" style="display:none;"/>
                                                                <img src="/gfx/ger/incorrect.png?r=1598273390" class="rma_correct_img" id="rma_add_bankaccount_off" style="display:none;"/>
                                                            </iaixsl:if>
                                                        </span>
                                                        <input id="rma_add_form_bankaccount" class="rma_add_form_input" type="text" name="payment_addres1" onkeyup="rma_add.checkInps('payment_addres1');">
                                                            <iaixsl:if test="(@checked = 'true') and (/shop/page/rma/payments_text)">
                                                                <iaixsl:attribute name="value"><iaixsl:value-of disable-output-escaping="no" select="/shop/page/rma/payments_text"/></iaixsl:attribute>
                                                            </iaixsl:if>
                                                        </input>
                                                        <div class="rma_add_help" id="rma_add_bankaccount_help"><div class="rma_add_help2"/></div>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="@type = 'c'">
                                                        <iaixsl:if test="@checked = 'true'">
                                                        ...
                                                        <span class="rma_add_form_infotitle2">
                                                            ...
                                                            <iaixsl:if test="/shop/page/rma/payments/@active = '1'">
                                                                <img class="rma_need" src="/gfx/ger/need.gif?r=1598273390"><iaixsl:attribute name="alt">Dieses Feld muss ausgefüllt werden, um die Bestellung aufzugeben</iaixsl:attribute></img>
                                                                <img src="/gfx/ger/correct.png?r=1598273390" class="rma_correct_img" id="rma_add_czek_on" style="display:none;"/>
                                                                <img src="/gfx/ger/incorrect.png?r=1598273390" class="rma_correct_img" id="rma_add_czek_off" style="display:none;"/>
                                                            </iaixsl:if>
                                                        </span>
                                                        <textarea id="rma_add_form_czek" class="rma_add_form_input" name="payment_addres3" onkeyup="rma_add.checkInps('payment_addres3');">
                                                            <iaixsl:if test="(@checked = 'true') and (/shop/page/rma/payments_text)"><iaixsl:value-of disable-output-escaping="no" select="/shop/page/rma/payments_text"/></iaixsl:if>
                                                        </textarea>
                                                        <div class="rma_add_help" id="rma_add_czek_help"><div class="rma_add_help2"/></div>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="@type = 't'">
                                                        <iaixsl:if test="@checked = 'true'">
                ...
                <div class="rma_add_form_section" id="rma_add_form_section4">
                    <div class="rma_add_form_sectionheader">
                        <iaixsl:choose>
                            <iaixsl:when test="page/rma/@action = 'view' or count(page/rma/stocks/stock) = 1">
                                <span class="rma_add_form_sectionheader">Ort der Realisierung der Reklamation</span>
                            </iaixsl:when>
                            <iaixsl:otherwise>
                                <span class="rma_add_form_sectionheader">Wohin möchten Sie die Reklamation senden?</span>
                            </iaixsl:otherwise>
                        </iaixsl:choose>
                    </div>
                    <iaixsl:if test="not(page/rma/@action = 'view') and count(/shop/page/rma/stocks/stock) > 1">
                        <div class="rma_add_form_sectiondesc">
                            <span class="rma_add_form_sectiondesc">Wählen Sie einen Punkt der Einnahme einer Reklamation an die Sie sie senden und mit wem werden Sie in ihrem Fall sich kontaktieren werden</span>
                        </div>
                    </iaixsl:if>
                    <div class="rma_add_form_sectionsub" id="rma_add_form_subsection4">
                        <iaixsl:for-each select="page/rma/stocks/stock">
                            <div class="rma_add_form_stock">
                                <iaixsl:if test="@selected = 'selected' and count(/shop/page/rma/stocks/stock) > 1">
                                    <iaixsl:attribute name="class">rma_add_form_stock rmaf_selected</iaixsl:attribute>
                                </iaixsl:if>
                                <iaixsl:attribute name="style">cursor: default;</iaixsl:attribute>
                                <iaixsl:attribute name="id">rmaf_<iaixsl:value-of select="@id"/></iaixsl:attribute>
                                <iaixsl:if test="not(/shop/page/rma/@action = 'view') and count(/shop/page/rma/stocks/stock) > 1">
                                    <iaixsl:attribute name="title">Klicken Sie hier, um die Reklamation in diesem Standort auszuwählen</iaixsl:attribute>
                                    <iaixsl:attribute name="onclick">rma_add.chooseSite($(this).attr('id'));</iaixsl:attribute>
                                    <iaixsl:attribute name="style"></iaixsl:attribute>
                                </iaixsl:if>
                                <iaixsl:if test="count(/shop/page/rma/stocks/stock) = 1">
                                    <iaixsl:attribute name="style">cursor: default;</iaixsl:attribute>
                                </iaixsl:if>
                                <div class="rmaf_sub">
                                    <div class="rma_add_form_stockheader">
                                        <span class="rma_add_form_stockname"><iaixsl:value-of select="@name"/></span>
                                    </div>
                                    <div class="rma_add_form_stockaddress">
                                        <iaixsl:if test="@street != ''">
                                            <iaixsl:value-of select="@street"/><br/>
                                        </iaixsl:if>
                                        <iaixsl:if test="@zipcode != ''">
                                            <iaixsl:value-of select="@zipcode"/><iaixsl:text> </iaixsl:text>
                                        </iaixsl:if>
                                        <iaixsl:value-of select="@city"/><span class="rma_add_form_infocountry"><iaixsl:text> (</iaixsl:text><iaixsl:if test="@province"><iaixsl:value-of select="@province"/><iaixsl:text>, </iaixsl:text></iaixsl:if><iaixsl:value-of select="@country"/><iaixsl:text>)</iaixsl:text></span>
                                    </div>

                                    <iaixsl:if test="$tel_link">
                                        <iaixsl:if test="@phone != ''">
                                            <span class="rma_add_form_phone">
                                                <iaixsl:value-of select="$tel_link"/>
                                                <iaixsl:choose>
                                                    <iaixsl:when test="@phone_link != ''">
                                                        <a>
                                                            <iaixsl:attribute name="href"><iaixsl:value-of select="@phone_link"/></iaixsl:attribute>
                                                            <iaixsl:attribute name="title"><iaixsl:value-of select="@phone"/></iaixsl:attribute>
                                                            <iaixsl:value-of select="@phone"/>
                                                        </a>
                                                    </iaixsl:when>
                                                    <iaixsl:otherwise>
                                                        <iaixsl:value-of select="@phone"/>
                                        ...
                                        <iaixsl:if test="@mail != ''">
                                            <a class="rma_add_form_mail">
                                                <iaixsl:attribute name="title"><iaixsl:value-of select="@mail"/></iaixsl:attribute>
                                                <iaixsl:choose>
                                                    <iaixsl:when test="@mail_link != ''">
                                                        <iaixsl:attribute name="href"><iaixsl:value-of select="@mail_link"/></iaixsl:attribute>
                                                    </iaixsl:when>
                                                    <iaixsl:otherwise>
                                                        <iaixsl:attribute name="href">mailto:<iaixsl:value-of select="@mail"/></iaixsl:attribute>
                                                    </iaixsl:otherwise>
                                                </iaixsl:choose>
                                                <iaixsl:value-of select="@mail"/>
                                            </a>
                                        </iaixsl:if>
                                    </iaixsl:if>

                                    <div class="rma_add_form_stocklink">
                                        <a class="rma_add_form_stocklink" target="_blank">
                                            <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                                            <iaixsl:attribute name="title">Details anzeigen</iaixsl:attribute>
                                            mehr Informationen
                                        </a>
                                    </div>
                                </div>
                ...
                <iaixsl:if test="not(page/rma/@action = 'view')">
                    <div class="rma_add_form_submit">
                        <a id="rma_add_form_submit" onmouseover="rma_add.checkInps();" class="btn --solid --medium rma_add_form_button_add">


                            <iaixsl:choose>
                                <iaixsl:when test="page/rma/@id">
                                    <iaixsl:attribute name="data-button_edit">true</iaixsl:attribute>
                                    <iaixsl:attribute name="title">Klicken Sie hier, um die Änderungen in der Reklamation zu speichern</iaixsl:attribute>
                                    Änderungen speichern
                                </iaixsl:when>
                                <iaixsl:otherwise>
                                    <iaixsl:attribute name="title">Klicken Sie hier, um die Reklamation zu melden</iaixsl:attribute>
                                    Reklamation melden
                                </iaixsl:otherwise>
                            </iaixsl:choose>
                        ...
                        <div class="button_legend">
                            ...
                            <i class="icon-need"></i> Felder mit einem Stern gekennzeichneten Felder sind Pflicht.
                        </div>
