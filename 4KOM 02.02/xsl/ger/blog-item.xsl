                ...
                <iaixsl:if test="page/navigation/bydates/item">
                    <div id="menu_blog_bydates" class="menu_blog_box">
                        <a class="menu_categories_label" href="/blog-list.php">
                            <iaixsl:attribute name="title">Archiv</iaixsl:attribute>
                            Archiv
                        </a>
                        <ul>
                                                    ...
                                                    <a>
                                                        ...
                                                        <iaixsl:choose>
                                                            <iaixsl:when test="@value='01'">
                                                                <iaixsl:attribute name="title">Januar&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                Januar
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='02'">
                                                                <iaixsl:attribute name="title">Februar&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                Februar
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='03'">
                                                                <iaixsl:attribute name="title">März&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                März
                                                            </iaixsl:when>
                                                            ...
                                                            <iaixsl:when test="@value='05'">
                                                                <iaixsl:attribute name="title">Mai&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                Mai
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='06'">
                                                                <iaixsl:attribute name="title">Juni&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                Juni
                                                            </iaixsl:when>
                                                            <iaixsl:when test="@value='07'">
                                                                <iaixsl:attribute name="title">Juli&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                Juli
                                                            </iaixsl:when>
                                                            ...
                                                            <iaixsl:when test="@value='10'">
                                                                <iaixsl:attribute name="title">Oktober&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                Oktober
                                                            </iaixsl:when>
                                                            ...
                                                            <iaixsl:when test="@value='12'">
                                                                <iaixsl:attribute name="title">Dezember&#160;<iaixsl:value-of select="../@value"/></iaixsl:attribute>
                                                                Dezember
                                                            </iaixsl:when>
                                                        </iaixsl:choose>
                                                    </a>
                        ...
                        <iaixsl:choose>
                            ...
                            <iaixsl:when test="not(/shop/page/navigation/bycategories/item/@current='active') and /shop/page/navigation/bydates/item/item/@current='active'">
                                <iaixsl:for-each select="/shop/page/navigation/bydates/item/item[@current='active'][1]">
                                    <a>
                                        <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                                        <iaixsl:attribute name="title">Weitere Einträge in diesem Monat</iaixsl:attribute>
                                        <iaixsl:choose>
                                                <iaixsl:when test="@value='01'">Januar</iaixsl:when>
                                                <iaixsl:when test="@value='02'">Februar</iaixsl:when>
                                                <iaixsl:when test="@value='03'">März</iaixsl:when>
                                                <iaixsl:when test="@value='04'">April</iaixsl:when>
                                                <iaixsl:when test="@value='05'">Mai</iaixsl:when>
                                                <iaixsl:when test="@value='06'">Juni</iaixsl:when>
                                                <iaixsl:when test="@value='07'">Juli</iaixsl:when>
                                                <iaixsl:when test="@value='08'">August</iaixsl:when>
                                                <iaixsl:when test="@value='09'">September</iaixsl:when>
                                                <iaixsl:when test="@value='10'">Oktober</iaixsl:when>
                                                <iaixsl:when test="@value='11'">November</iaixsl:when>
                                                <iaixsl:when test="@value='12'">Dezember</iaixsl:when>
                            ...
                            <iaixsl:otherwise>
                                den Kategorie&#160;<a>
                                    ...
                                    <iaixsl:attribute name="title"><iaixsl:value-of select="/shop/page/navigation/bycategories/item[@current='active']/@value"/></iaixsl:attribute>
                                    <iaixsl:value-of select="/shop/page/navigation/bycategories/item[@current='active']/@value"/>
                                </a>&#160;oder&#160;<iaixsl:for-each select="/shop/page/navigation/bydates/item/item[@current='active'][1]">
                                    <a>
                                        <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                                        <iaixsl:attribute name="title">Weitere Einträge in diesem Monat</iaixsl:attribute>
                                        <iaixsl:choose>
                ...
                <div class="main_hotspot mb-4" id="blog_item_associated">
                    <iaixsl:choose>
                        <iaixsl:when test="page/cms_products/@link">
                            <a class="big_label">
                                <iaixsl:attribute name="href"><iaixsl:value-of select="page/cms_products/@link"/></iaixsl:attribute><iaixsl:attribute name="title">Klicken Sie hier, um alle Produkte anzuzeigen</iaixsl:attribute>
                                <iaixsl:choose><iaixsl:when test="page/cms_products/@name"><iaixsl:value-of select="page/cms_products/@name"/></iaixsl:when><iaixsl:otherwise>Empfohlen</iaixsl:otherwise></iaixsl:choose>
                                <small><i class="icon-caret-right"></i> Alles anzeigen</small>
                            </a>
                        </iaixsl:when>
                        <iaixsl:otherwise>
                            <div class="big_label">
