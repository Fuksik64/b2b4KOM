...
<div id="account_icon"><a href="/login.php"><i class="icon-account"></i></a></div>
        ...
        <!--Otwórz zamówienie (order_open_form, 107887.1)-->

        <iaixsl:variable name="required_68516"></iaixsl:variable>

        <div class="order_open_form_wrapper">
            <h1>
                <iaixsl:attribute name="class">big_label</iaixsl:attribute>
                Bestellstatus überprüfen
            </h1>
            <p>Um den Bestellstatus überprüfen zu können, geben Sie bitte die Bestellnummer (Sie finden diese Nummer in der E-Mail, die Sie nach Aufgabe der Bestellung erhalten haben) sowie Ihre Telefonnummer bzw. E-Mail-Adresse ein.</p>

            <form action="/order-open.php" method="post" class="order_open_form row flex-column align-items-center">
                <input type="hidden" name="operation" value="order_open"/>

                

                <div class="order_open_form form-group col-md-6 col-12">
                    <div class="has-feedback has-required">
                        <input id="order_id" class="form-control validate" name="order_id" minlength="1">
                        </input>
                ...
                <div class="order_open_form form-group col-md-6 col-12">
                    <div class="has-feedback has-required">
                        <input id="order_open_email" type="text" class="form-control validate" name="email" data-validate="phone email">
                        </input>
                        <label for="order_open_email" class="control-label">
                ...
                <button type="submit" class="btn --solid --medium mb-3">
                    Bestellung prüfen
                </button>
            ...
            <a href="/login.php">Ich habe bereits ein Konto und möchte zur Liste meiner Bestellungen übergehen.</a>
