                                        ...
                                        <td>
                                            <iaixsl:choose>
                                                <iaixsl:when test="@returns_url">
                                                    <a class="btn --icon-left icon-plus --medium see_button"><iaixsl:attribute name="href"><iaixsl:value-of select="@returns_url"/></iaixsl:attribute><span><i class='icon-plus'></i></span><small>Retoure hinzufügen</small></a>
                                                </iaixsl:when>
                                                <iaixsl:when test="@rma_url">
                                                    <a class="btn --icon-left icon-plus --medium see_button"><iaixsl:attribute name="href"><iaixsl:value-of select="@rma_url"/></iaixsl:attribute><span><i class='icon-plus'></i></span><small>Wählen</small></a>
                                                </iaixsl:when>
                                                <iaixsl:otherwise>
                                                    <a class="btn --icon-left icon-plus --medium see_button"><iaixsl:attribute name="href"><iaixsl:value-of select="@orderdetails"/></iaixsl:attribute><span><i class='icon-plus'></i></span><small>mehr...</small></a>
                                                </iaixsl:otherwise>
                                            </iaixsl:choose>
                                        </td>
                                    </tr>
