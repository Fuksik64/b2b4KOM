...
<div id="account_icon"><a href="/login.php"><i class="icon-account"></i></a></div>
        ...
        <!--Banery na stronie głównej (main_banner1, 106482.1)-->
            <iaixsl:if test="count(commercial_banner/link) > 0">
                ...
                <div id="main_banner1" class="mb-4">
                    <iaixsl:variable name="banner_class"></iaixsl:variable>
                    <iaixsl:if test="commercial_banner/link[1]/image or commercial_banner/link[1]/image_desktop or commercial_banner/link[1]/image_tablet or commercial_banner/link[1]/image_mobile">
                        <iaixsl:attribute name="class">
                            <iaixsl:choose>
                                <iaixsl:when test="$banner_class and not($banner_class = '')">
                                    <iaixsl:value-of select="$banner_class"/>
                                </iaixsl:when>
                                <iaixsl:otherwise>
                                    skeleton mb-4
                                </iaixsl:otherwise>
                    ...
                    <iaixsl:if test="$txt_69867_01">
                        <h2><iaixsl:value-of select="$txt_69867_01"/></h2>
                    </iaixsl:if>
                                    ...
                                    <li>
                                        <a><iaixsl:choose>
                                            ...
                                            <iaixsl:attribute name="title"><iaixsl:value-of select="text"/></iaixsl:attribute><iaixsl:choose>
                                                <iaixsl:when test="image or image_desktop or image_tablet or image_mobile"><img src="/gfx/ger/loader.gif?r=1598273390">
                                                    <iaixsl:attribute name="alt"><iaixsl:value-of select="text"/></iaixsl:attribute>
                                                    <iaixsl:if test="image_desktop or image_tablet or image_mobile">
                                                        <iaixsl:attribute name="class">rwd-src</iaixsl:attribute>
                                                    </iaixsl:if>
        ...
        <!--Buttony strefa 2 na stronie głównej (main_buttons2, 106484.1)-->
            <iaixsl:if test="count(commercial_button2/link)"> 
                <div id="menu_buttons2" class="row mb-4 clearfix">
        ...
        <!--CMS na stronie głównej (main_cms, 106501.1)-->
            <iaixsl:if test="page/text[@id='13']">
                <iaixsl:for-each select="page/text[@id='13']">
                    <div class="cm mb-5" id="main_cms">
                        <iaixsl:value-of disable-output-escaping="yes" select="body"/>
                    </div>
                </iaixsl:for-each>
            </iaixsl:if>
        <!--Hotspot na stronie głównej - strefa 1 (main_hotspot_zone1, 111610.1)-->
                                    ...
                                    <iaixsl:choose>
                                        <iaixsl:when test="page/hotspot/products_zone1/@link">
                                            <a class="big_label">
                                                ...
                                                <iaixsl:choose><iaixsl:when test="page/hotspot/products_zone1/@name"><iaixsl:choose><iaixsl:when test="contains(page/hotspot/products_zone1/@name,'|')"><span><iaixsl:value-of select="substring-before(page/hotspot/products_zone1/@name,'|')"/></span><small><iaixsl:value-of select="substring-after(page/hotspot/products_zone1/@name,'|')"/></small></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="page/hotspot/products_zone1/@name"/></iaixsl:otherwise></iaixsl:choose></iaixsl:when><iaixsl:otherwise>Neuheiten</iaixsl:otherwise></iaixsl:choose>
                                            </a>
                                        </iaixsl:when>
                                        <iaixsl:otherwise>
        ...
        <!--Hotspot na stronie głównej - strefa 2 (main_hotspot_zone2, 111618.1)-->
            
                <iaixsl:if test="page/hotspot/products_zone2">
                    <div id="main_hotspot_zone2" class="main_hotspot mb-4">
                        <iaixsl:if test="not(page/hotspot/products_zone2/product)">
                            <iaixsl:attribute name="data-ajaxLoad">true</iaixsl:attribute>
                            <iaixsl:attribute name="data-pageType">main</iaixsl:attribute>
                        </iaixsl:if>
                        <iaixsl:choose>
                                ...
                                <h2>
                                    <iaixsl:choose>
                                        <iaixsl:when test="page/hotspot/products_zone2/@link">
                                            <a class="big_label">
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="page/hotspot/products_zone2/@link"/></iaixsl:attribute><iaixsl:attribute name="title">Klicken Sie hier, um alle Produkte anzuzeigen</iaixsl:attribute>
                                                <iaixsl:choose><iaixsl:when test="page/hotspot/products_zone2/@name"><iaixsl:choose><iaixsl:when test="contains(page/hotspot/products_zone2/@name,'|')"><span><iaixsl:value-of select="substring-before(page/hotspot/products_zone2/@name,'|')"/></span><small><iaixsl:value-of select="substring-after(page/hotspot/products_zone2/@name,'|')"/></small></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="page/hotspot/products_zone2/@name"/></iaixsl:otherwise></iaixsl:choose></iaixsl:when><iaixsl:otherwise>Sonderangebote</iaixsl:otherwise></iaixsl:choose>
                                            </a>
                                        </iaixsl:when>
                                        <iaixsl:otherwise>
                                            <span class="big_label">
                ...
                <iaixsl:if test="page/hotspot/products_zone2/opinion"> </iaixsl:if>
        ...
        <!--Hotspot na stronie głównej - strefa 3 (main_hotspot_zone3, 106488.1)-->
                ...
                <iaixsl:if test="page/hotspot/products_zone3">
                    <div id="main_hotspot_zone3" class="main_hotspot mb-4">
                        <iaixsl:if test="not(page/hotspot/products_zone3/product)">
                            <iaixsl:attribute name="data-ajaxLoad">true</iaixsl:attribute>
                            <iaixsl:attribute name="data-pageType">main</iaixsl:attribute>
                        </iaixsl:if>
                        <iaixsl:choose>
                                ...
                                <h2>
                                    <iaixsl:choose>
                                        <iaixsl:when test="page/hotspot/products_zone3/@link">
                                            <a class="big_label">
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="page/hotspot/products_zone3/@link"/></iaixsl:attribute><iaixsl:attribute name="title">Klicken Sie hier, um alle Produkte anzuzeigen</iaixsl:attribute>
                                                <iaixsl:choose><iaixsl:when test="page/hotspot/products_zone3/@name"><iaixsl:value-of select="page/hotspot/products_zone3/@name"/></iaixsl:when><iaixsl:otherwise>Bestseller </iaixsl:otherwise></iaixsl:choose>
                ...
                <iaixsl:if test="page/hotspot/products_zone3/opinion"> </iaixsl:if>
        ...
        <!--Hotspot na stronie głównej - strefa 4 (main_hotspot_zone4, 106513.1)-->
                ...
                <iaixsl:if test="page/hotspot/products_zone4">
                    <div id="main_hotspot_zone4" class="main_hotspot mb-4">
                        <iaixsl:if test="not(page/hotspot/products_zone4/product)">
                            <iaixsl:attribute name="data-ajaxLoad">true</iaixsl:attribute>
                            <iaixsl:attribute name="data-pageType">main</iaixsl:attribute>
                        </iaixsl:if>
                        <iaixsl:choose>
                                ...
                                <h2>
                                    <iaixsl:choose>
                                        <iaixsl:when test="page/hotspot/products_zone4/@link">
                                            <a class="big_label">
                                                <iaixsl:attribute name="href"><iaixsl:value-of select="page/hotspot/products_zone4/@link"/></iaixsl:attribute><iaixsl:attribute name="title">Klicken Sie hier, um alle Produkte anzuzeigen</iaixsl:attribute>
                                                <iaixsl:choose><iaixsl:when test="page/hotspot/products_zone4/@name"><iaixsl:value-of select="page/hotspot/products_zone4/@name"/></iaixsl:when><iaixsl:otherwise>Neuheiten</iaixsl:otherwise></iaixsl:choose>
                ...
                <iaixsl:if test="page/hotspot/products_zone4/opinion"> </iaixsl:if>
        ...
        <!--Newsy na stronie głównej (strefa 2) (main_news2, 111145.1)-->
		<iaixsl:variable name="main_blog_date"></iaixsl:variable>
		<iaixsl:variable name="main_blog_after_label"></iaixsl:variable>
		<iaixsl:variable name="main_blog_see_more">Weiterlesen</iaixsl:variable>
		<iaixsl:variable name="main_blog_view_all">Alles anzeigen</iaixsl:variable>
	...
	<!--CMS na stronie głównej 2 (main_cms2, 106519.1)-->
        ...
        <iaixsl:variable name="main_news_date"></iaixsl:variable>
		<iaixsl:variable name="main_news_after_label"></iaixsl:variable>
		<iaixsl:variable name="main_news_see_more">Weiterlesen</iaixsl:variable>
		<iaixsl:variable name="main_news_view_all">Alles anzeigen</iaixsl:variable>

		<iaixsl:if test="count(page/mainpage1/item) > 0">
			<section id="main_news" class="article mb-4">
				<h2>
					<a href="/news.php" class="headline">
						...
						<iaixsl:attribute name="title">Klicken Sie hier, um alle Nachrichten zu sehen</iaixsl:attribute>
						<span class="headline__name">Aktuell</span>
