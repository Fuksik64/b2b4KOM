...
<div id="account_icon"><a href="/login.php"><i class="icon-account"></i></a></div>
        ...
        <iaixsl:choose>
            <iaixsl:when test="/shop/basket/@login">
                <div class="noproduct_form_outline">
                    <div class="noproduct_form_label">
                        <iaixsl:attribute name="class">noproduct_form_label big_label</iaixsl:attribute>
                    ...
                    <div class="noproduct_form_sub">
                        <form id="noproduct_form" method="post" novalidate="novalidate">
                            <iaixsl:attribute name="action"><iaixsl:value-of select="page/action/form/@url"/></iaixsl:attribute>
                            <input type="hidden" name="add_request_product" value="1"/>
                            <div class="noproduct_form_desc">
                                Mit Hilfe dieses Formulars können Sie uns eine Beschreibung des Produkts schicken, das Sie in unserem Sortiment nicht gefunden haben. Bitte geben Sie den Produktnamen und/oder eine kurze Beschreibung ein. Wir werden uns bei Ihnen melden, sobald das Produkt bei uns erhältlich ist.
                            </div>
                            <div class="noproduct_form_section row flex-column align-items-center">
                                <div class="form-group  col-md-6 col-12">
                                    <div class="has-feedback has-required">
                                        <input type="text" id="noproduct_name" name="name" class="form-control validate" minlength="3">
                                        </input>
                                        <label for="noproduct_name" class="control-label">
                                            Produktname:
                                        </label>
                            ...
                            <div class="noproduct_form_section row flex-column align-items-center">
                                <div class="form-group  col-md-6 col-12">
                                    <div class="has-feedback has-required ">
                                        <textarea name="desc" id="noproduct_desc" class="form-control validate" minlength="3">
                                        </textarea>
                                        <label for="noproduct_desc" class="control-label">
                                            Beschreibung:
                                        </label>
                                        <span class="form-control-feedback"/>
                                    </div>
                            ...
                            <div class="noproduct_form_submit">
                                <a class="btn --solid --large noproduct_form_submit mb-1">
                                    <iaixsl:attribute name="title">Klicken Sie hier, um dem Kundenservice Informationen zum gesuchten Produkt zu senden</iaixsl:attribute>
                                    Senden
                                </a>
                            ...
                            <div class="noproduct_form_desc2">
                                Bevor Sie Ihren Produktvorschlag abschicken, überprüfen Sie bitte, ob das Produkt in der <a href="products-requests.php" title="Przejdź do listy poszukiwanych produktów">Liste der gesuchten Produkte</a> bereits vorhanden ist.
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <iaixsl:otherwise>
                <div class="noproduct_form_outline">
                    ...
                    <div class="noproduct_form_sub">
                        <p class="noproduct_form_notlogged">Falls Sie in unserem Angebot das gesuchte Produkt nicht gefunden haben, es aber bei uns gerne kaufen möchten, können Sie uns mit Hilfe eines speziell dafür vorgesehenen Formulars die Beschreibung des gesuchten Produkts senden. Hierfür müssen Sie <a class="loginPopUpShow" href="signin.php"> eingeloggt </a> sein.</p>
                    </div>
                </div>
            </iaixsl:otherwise>
        </iaixsl:choose>
        <!--Hotspot w noproduct strefa 1 (noproduct_hotspot_zone1, 107919.1)-->
                ...
                <iaixsl:if test="/shop/page/additional/hotspot/products_zone1">
                    <div class="main_hotspot mb4" id="noproduct_hotspot_zone1">
                        <iaixsl:if test="not(/shop/page/additional/hotspot/products_zone1/product)">
                            ...
                            <iaixsl:when test="/shop/page/additional/hotspot/products_zone1/product or /shop/page/additional/hotspot/products_zone1/opinion">
                                <iaixsl:choose>
                                    <iaixsl:when test="/shop/page/additional/hotspot/products_zone1/@link">
                                        <a class="big_label">
                                            <iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/additional/hotspot/products_zone1/@link"/></iaixsl:attribute><iaixsl:attribute name="title">Klicken Sie hier, um alle Produkte anzuzeigen</iaixsl:attribute>
                                            <iaixsl:choose><iaixsl:when test="/shop/page/additional/hotspot/products_zone1/@name"><iaixsl:value-of select="/shop/page/additional/hotspot/products_zone1/@name"/></iaixsl:when><iaixsl:otherwise>Sonderangebote</iaixsl:otherwise></iaixsl:choose>
        ...
        <!--Brak produktów - cms (noproduct_cms, 107918.1)-->
            <iaixsl:if test="page/text/body">
                <div class="big_label">
                    Warum lohnt es sich, uns die gesuchten Produkten zu melden?
                </div>
                <div class="noproduct_cms">
                    <div class="noproduct_cms_sub">
