...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!--Typ strony (envelope, 107421.1)-->
            ...
            <iaixsl:if test="(action/set_render/item/@name = 'popup') or not(action/set_render/item)">
                ...
                <script src="/gfx/ger/pickup_sites_list.js.gzip?r=1598273390"></script></head>
...
<div id="account_icon"><a href="/login.php"><i class="icon-account"></i></a></div>
    ...
    <!--Błędy i informacje w projektorze (menu_messages, 106608.1)-->
        ...
        <iaixsl:variable name="scControl"></iaixsl:variable>
        ...
        <iaixsl:variable name="mapLanguage">PL</iaixsl:variable>
        <iaixsl:variable name="mapCustomMarkers"></iaixsl:variable>
        <iaixsl:variable name="requires_client_number">Postnummer:</iaixsl:variable>
        <iaixsl:variable name="info_selected_pickup"><iaixsl:value-of select="normalize-space(page/pickups/selected/pickup/info)"/></iaixsl:variable>
        
        <script class="ajaxLoad">
            var mapTypePickups = "<iaixsl:value-of select="$mapType"/>";
            var navControlPickups = "<iaixsl:value-of select="$navControl"/>";
            var mapTypeControlPickups = "<iaixsl:value-of select="$mapTypeControl"/>";
            var scControlPickups = "<iaixsl:value-of select="$scControl"/>";
            var controlTypePickups = "<iaixsl:value-of select="$controlType"/>";
            var mapTypeControlStylePickups = "<iaixsl:value-of select="$mapTypeControlStyle"/>";
            var markersAnimationPickups = "<iaixsl:value-of select="$markersAnimation"/>";
            var bCordPickups = "<iaixsl:value-of select="$bCord"/>";
            var lCordPickups = "<iaixsl:value-of select="$lCord"/>";
            var pickupsLanguage   = "<iaixsl:value-of select="$mapLanguage"/>";
            var pickupsZoom     = parseInt("<iaixsl:value-of select="$mapZoom"/>");
            var markerPickupsCustomIcon      = "<iaixsl:value-of select="$mapCustomMarkers"/>";
            var Holidays = {}; var Holidays_stocks = [];
                var selected_pickup_point = {
                <iaixsl:for-each select="page/pickups/selected/pickup">
                    "id": <iaixsl:call-template name="escape-quote-string"><iaixsl:with-param name="str" select="@value"/></iaixsl:call-template>,
                    "name": <iaixsl:call-template name="escape-quote-string"><iaixsl:with-param name="str" select="name"/></iaixsl:call-template>,
                    "location": <iaixsl:call-template name="escape-quote-string"><iaixsl:with-param name="str" select="$info_selected_pickup"/></iaixsl:call-template>,
                    "address": {
                        "country": "Polska",
                        "postcode": <iaixsl:call-template name="escape-quote-string"><iaixsl:with-param name="str" select="zipcode"/></iaixsl:call-template>,
                        "city": <iaixsl:call-template name="escape-quote-string"><iaixsl:with-param name="str" select="city"/></iaixsl:call-template>,
                        "street": <iaixsl:call-template name="escape-quote-string"><iaixsl:with-param name="str" select="address"/></iaixsl:call-template>,
                        "buildingAndHouseNumber": ""
                    },
                    "coordinates": {
                        "latitude": <iaixsl:call-template name="escape-quote-string"><iaixsl:with-param name="str" select="location/@latitude"/></iaixsl:call-template>,
                        "longitude": <iaixsl:call-template name="escape-quote-string"><iaixsl:with-param name="str" select="location/@longitude"/></iaixsl:call-template>
                    },
                    "link": <iaixsl:call-template name="escape-quote-string"><iaixsl:with-param name="str" select="link"/></iaixsl:call-template>,
                    "requiresClientNumber": <iaixsl:value-of select="requires_client_number"/>
                </iaixsl:for-each>
            };
        </script>

        <iaixsl:if test="page/pickups">
            <script class="ajaxLoad">
                var mapSiteType = 'pickup_site';
                var google_api_key = '<iaixsl:value-of select="/shop/page/pickups/google_api_key/@value"/>';

            </script>
            <div id="pickup_site">
                <iaixsl:if test="not(/shop/page/pickups/google_api_key/@value) or /shop/page/pickups/google_api_key/@value = ''">
                    <iaixsl:attribute name="class">no_google_api_key</iaixsl:attribute>
                </iaixsl:if>
                <h1 class="big_label">
                    Auswählen <iaixsl:value-of select="page/pickups/@validName"/>
                </h1>

                <img class="markerCluster" style="display:none;" src="/gfx/ger/m1.png?r=1598273390"/>
                <img class="markerCluster" style="display:none;" src="/gfx/ger/m2.png?r=1598273390"/>
                <img class="markerCluster" style="display:none;" src="/gfx/ger/m3.png?r=1598273390"/>
                <img class="markerCluster" style="display:none;" src="/gfx/ger/m4.png?r=1598273390"/>
                <img class="markerCluster" style="display:none;" src="/gfx/ger/m5.png?r=1598273390"/>
                <img class="marker_face" src="/gfx/ger/marker_face.png?r=1598273390"/>

                <div class="pickup_site_sub">
                    <iaixsl:choose>
                        <iaixsl:when test="/shop/page/pickups/deliveryaddress and /shop/page/pickups/google_api_key/@value and /shop/page/pickups/google_api_key/@value != ''">
                            <div class="locationField_sub">
                                <p class="pickup_list_desc">Geben Sie die Adresse ein und suchen Sie nach den nächstgelegenen Sammelstellen. Klicken Sie neben der Karte auf einen der Punkte, um die Bestellung hier abzuholen.</p>
                                <div id="locationField">
                                    <input id="autocomplete_location" onFocus="geolocate()" type="text">
                                        <iaixsl:attribute name="value">
                                            
                                            <iaixsl:value-of select="/shop/page/pickups/deliveryaddress/@street"/>, <iaixsl:value-of select="/shop/page/pickups/deliveryaddress/@city"/>, <iaixsl:value-of select="/shop/page/pickups/deliveryaddress/@country_long"/>
                                        </iaixsl:attribute>
                                    </input>
                                    <a class="btn --solid --medium">
                                        <span class="d-none d-sm-inline">Suche nach Punkten</span>
                                        <span class="d-sm-none"><i class="icon-search"></i></span>
                                    </a>
                                </div>
                            </div>
                        </iaixsl:when>
                        <iaixsl:when test="/shop/page/pickups/deliveryaddress and not(/shop/page/pickups/google_api_key/@value)">
                            <div class="locationField_sub">
                                <p class="pickup_list_desc"></p>
                                <div id="locationField">
                                    <input id="autocomplete_location" class="autocomplete_nomap" type="text">
                                        <iaixsl:choose>
                                            <iaixsl:when test="/shop/page/pickups/selected/pickup">
                                                <iaixsl:attribute name="value"><iaixsl:value-of select="/shop/page/pickups/selected/pickup/city"/>, <iaixsl:value-of select="/shop/page/pickups/selected/pickup/address"/></iaixsl:attribute>
                                            </iaixsl:when>
                                            <iaixsl:otherwise>
                                                <iaixsl:attribute name="value"><iaixsl:value-of select="/shop/page/pickups/deliveryaddress/@city"/></iaixsl:attribute>
                                            </iaixsl:otherwise>
                                        </iaixsl:choose>
                                    </input>
                                </div>
                    ...
                    <form id="pickup_list_form" method="post">
                        <iaixsl:attribute name="action"><iaixsl:value-of select="page/pickups/@action"/></iaixsl:attribute>

                        <div class="pickup_map_sidebar">
                            <iaixsl:if test="/shop/page/pickups/google_api_key/@value and /shop/page/pickups/google_api_key/@value != ''">
                                <div class="mapContainer_pickup">
                                    <iaixsl:if test="/shop/page/pickups/deliveryaddress">
                                        <div class="map_button_search">
                                            <a href="#search_here" class="btn --solid --medium pickup_search_here">
                                                <iaixsl:attribute name="title">Klicken Sie hier, um nach Punkten in diesem Bereich zu suchen</iaixsl:attribute>
                                                Hier suchen
                                            </a>
                                        </div>
                                    </iaixsl:if>
                                    ...
                                    <div class="loadingMap">
                                        <div class="loadingContent">
                                            <div class="loadingBox">
                                                <span class="loadingMap">Karte wird geladen</span>
                                                <span class="loadingNav">Navigation wird geladen</span>
                                                <span class="loadingMarkers">
                                                    Informationen zu den möglichen Abholorten werden geladen 
                                                    <span class="loadingMarkersComplete"/>
                                                    aus
                                                    <span class="loadingMarkersCount"/>
                                                </span>
                                                <img class="loadingMapImg" src="/gfx/ger/mapLoader.gif?r=1598273390"/>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="asideContainer_pickup">
                                <iaixsl:if test="not(/shop/page/pickups/google_api_key/@value)">
                                    <iaixsl:attribute name="style">display: none;</iaixsl:attribute>
                                </iaixsl:if>
                                <iaixsl:for-each select="page/pickups/*/pickup">
                                    <input type="radio" required="required">
                                        
                                        <iaixsl:attribute name="name"><iaixsl:value-of select="/shop/page/pickups/@name"/></iaixsl:attribute>
                                        <iaixsl:attribute name="value"><iaixsl:value-of select="@value"/></iaixsl:attribute>
                                        <iaixsl:attribute name="id">pickup_point_<iaixsl:value-of select="@value"/></iaixsl:attribute>
                                    </input>
                                    <label class="pickup_point">
                                        <iaixsl:attribute name="for">pickup_point_<iaixsl:value-of select="@value"/></iaixsl:attribute>
                                        <iaixsl:if test="location/@latitude"><iaixsl:attribute name="data-latitude"><iaixsl:value-of select="location/@latitude"/></iaixsl:attribute></iaixsl:if>
                                        <iaixsl:if test="location/@longitude"><iaixsl:attribute name="data-longitude"><iaixsl:value-of select="location/@longitude"/></iaixsl:attribute></iaixsl:if>
                                        <iaixsl:attribute name="data-requires_client_number"><iaixsl:value-of select="requires_client_number/text()"/></iaixsl:attribute>
                                        <iaixsl:attribute name="data-id"><iaixsl:value-of select="@value"/></iaixsl:attribute>
                                        <div class="pickup_point_sub">
                                            ...
                                            <b class="headerText"><iaixsl:value-of select="name"/></b>
                                            <div>
                                                <span class="streetText"><iaixsl:value-of select="address"/></span>
                                                <span class="zipcodePickup"><iaixsl:value-of select="zipcode"/><iaixsl:text> </iaixsl:text><span class="cityText"><iaixsl:value-of select="city"/></span></span>
                                                <iaixsl:if test="requires_client_number/text() = 'true'">
                                                    <input type="text" name="client_courier_number" disabled="true" required="required">
                                                        <iaixsl:attribute name="placeholder">Postnummer:</iaixsl:attribute>
                                                    </input>
                                                </iaixsl:if>
                                                <iaixsl:if test="info">
                                            ...
                                            <iaixsl:if test="info">
                                                <div class="pickup_point_info">
                                                    <div class="moreText">
                                                        <iaixsl:value-of select="info"/>
                                                    </div>
                                                    <iaixsl:if test="time">
                                                        <div class="timeText">
                                                            <iaixsl:choose>
                                                                <iaixsl:when test="time/@undefinded_time = 'true'">
                                                                    Unbekannte Realisierungszeit der Bestellung
                                                                </iaixsl:when>

                                                                <iaixsl:when test="(delivery_time/@days = 0) and (delivery_time/@hours = 0) and (delivery_time/@minutes = 0)">
                                                                    Abholung innerhalb von 24 Stunden.
                                                                </iaixsl:when>

                                                                <iaixsl:when test="delivery_time">
                                                                    Abholung möglich in 
                                                                    <iaixsl:if test="delivery_time/@days  > 0">

                                                                        <iaixsl:value-of select="delivery_time/@days"/>
                                                                        <iaixsl:choose>
                                                                            <iaixsl:when test="delivery_time/@days = '1'">
                                                                                 Tag
                                                                            </iaixsl:when>
                                                                            <iaixsl:otherwise>
                                                                                 Tagen
                                                                    ...
                                                                    <iaixsl:if test="delivery_time/@hour  > 0">
                                                                        <iaixsl:value-of select="delivery_time/@hour"/> Stunde
                                                                    </iaixsl:if>

                                                                    <iaixsl:if test="delivery_time/@minutes  > 0">
                                                                        <iaixsl:value-of select="delivery_time/@minutes"/> min 
                                                                    </iaixsl:if>
                                                                </iaixsl:when>
                                                                <iaixsl:when test="delivery_time/@days = '0'">
                                                                    <iaixsl:choose>
                                                                        <iaixsl:when test="delivery_time/@hour = '0'">
                                                                            Abholung innerhalb von 24 Stunden.
                                                                        </iaixsl:when>
                                                                        <iaixsl:otherwise>
                                                                            Abholung möglich in <iaixsl:value-of select="delivery_time/@hour"/>
                                                                            <iaixsl:choose>
                                                                                <iaixsl:when test="delivery_time/@hour = '1'">
                                                                                     Stunde
                                                                                </iaixsl:when>
                                                                                <iaixsl:when test="(delivery_time/@hour = '2') or (delivery_time/@hour = '3') or (delivery_time/@hour = '4') or (delivery_time/@hour = '22') or (delivery_time/@hour = '23') or (delivery_time/@hour = '24')">
                                                                                      Std. 
                                                                                </iaixsl:when>
                                                                                <iaixsl:otherwise>
                                                                                     Stunden
                                                                ...
                                                                <iaixsl:otherwise>
                                                                    Abholung möglich in <iaixsl:value-of select="delivery_time/@days"/>
                                                                    <iaixsl:choose>
                                                                        <iaixsl:when test="delivery_time/@days = '1'">
                                                                             Tag
                                                                        </iaixsl:when>
                                                    ...
                                                    <a class="moreLink" target="_blank">
                                                        <iaixsl:attribute name="href"><iaixsl:value-of select="link"/></iaixsl:attribute>
                                        ...
                                        <a class="btn --solid --icon-left icon-globe map_dir" target="_blank">
                                            <iaixsl:attribute name="href">

                                                <iaixsl:choose>
                                                    <iaixsl:when test="location/@longitude and location/@longitude != '' ">
                                                        https://www.google.com/maps/dir/?api=1&amp;destination=<iaixsl:value-of select="location/@latitude"/>,<iaixsl:value-of select="location/@longitude"/>
                                                    </iaixsl:when>
                                                    <iaixsl:otherwise>
                                                        https://maps.google.com?saddr=Current+Location&amp;daddr=<iaixsl:value-of select="address"/>+<iaixsl:value-of select="zipcode"/>+<iaixsl:value-of select="city"/>
                                                    </iaixsl:otherwise>
                                                </iaixsl:choose>
                        ...
                        <iaixsl:if test="(page/order_calendar/@type = 'y') or (page/order_calendar/@type = 't')">
                        ...
                        <iaixsl:if test="page/order_calendar/@type = 't'">
                            <div class="pickupl_hour_wrapper">
                                <span>Sie können auch Ihre bevorzugte Stundenzahl eingeben (z. B. 13.00 - 16.00)</span>
                        ...
                        <div class="pickupl_submit">
                            <button class="btn --solid --large --icon-right icon-angle-right" type="submit">
                                <iaixsl:if test="not(page/pickups/proposed/pickup[@default = 'true']) and not(page/pickups/selected/pickup[@default = 'true']) ">
                                    <iaixsl:attribute name="data-pickupl_idle">true</iaixsl:attribute>
                                </iaixsl:if>
                                Weiter
                            </button>
                            <p class="pickupl_back">Wenn Sie die ausgewählte Lieferungsart ändern möchten, kehren Sie zur <a id="pickup_site_back"><iaixsl:attribute name="href"><iaixsl:value-of select="page/pickups/@back"/></iaixsl:attribute><iaixsl:attribute name="title">Klicken Sie hier, um zur Übersicht der Lieferungs- und Zahlungsarten zurückzukehren.</iaixsl:attribute> Übersicht der Lieferungs- und Zahlungsarten zurück</a>.</p>
                        </div>
                    </form>
                </div>
            ...
            <script class="ajaxLoad">
                app_shop.vars.apiKey = '<iaixsl:value-of select="/shop/page/pickups/google_api_key/@value"/>';
                <iaixsl:if test="/shop/page/pickups/deliveryaddress/@country_code">
                    app_shop.vars.country_code = '<iaixsl:value-of select="/shop/page/pickups/deliveryaddress/@country_code"/>';
                </iaixsl:if>
                    app_shop.vars.language = '<iaixsl:value-of select="/shop/language/@id"/>';
                <iaixsl:if test="/shop/page/pickups/courier/@isCod">
                    app_shop.vars.isCod = <iaixsl:value-of select="/shop/page/pickups/courier/@isCod"/>;
                </iaixsl:if>
                <iaixsl:if test="/shop/page/pickups/courier/@id">
                    app_shop.vars.courierId = '<iaixsl:value-of select="/shop/page/pickups/courier/@id"/>';
                </iaixsl:if>
            </script>
        </iaixsl:if>

        <iaixsl:if test="/shop/page/pickups/country/region/city/pickup"> </iaixsl:if>
        <iaixsl:if test="/shop/page/pickups/country/region/city/pickup/delivery_time"> </iaixsl:if>
        <iaixsl:if test="/shop/page/pickups/country/region/city/pickup/name"> </iaixsl:if>
        <iaixsl:if test="/shop/page/pickups/country/region/city/pickup/address"> </iaixsl:if>
        <iaixsl:if test="/shop/page/pickups/country/region/city/pickup/link"> </iaixsl:if>
        <iaixsl:if test="/shop/page/pickups/country/region/city/pickup/requires_client_number"> </iaixsl:if>
        <iaixsl:if test="/shop/page/pickups/country/region/city/pickup/info"> </iaixsl:if>
