...
<iaixsl:attribute name="class">big_label affiliate_clients_label</iaixsl:attribute>
    ...
    <iaixsl:when test="count(page/clients_list/login)">
        <div class="affiliate_clients_desc">
            <p class="affiliate_clients_desc">Unten befindet sich die Liste aller Kunden, die aufgrund Ihrer Empfehlung ein Konto erstellt haben.</p>
        </div>
   ...
   <iaixsl:attribute name="class">ui-responsive table-stroke ui-table ui-table-reflow affiliate_clients</iaixsl:attribute>
                    ...
                    <thead>
                        <tr>
                            <th id="affiliate_clients_th1">Kunden-ID</th>
                            <th id="affiliate_clients_th3">Datum der Kontoerstellung</th>
                        </tr>
                    </thead>
                    <tbody>
    ...
    <iaixsl:otherwise>
        <div class="affiliate_clients_desc_null">
            Im Moment gibt es keine Kunden, die aufgrund Ihrer Empfehlung ein Konto erstellt haben.
        </div>
    </iaixsl:otherwise>
    </iaixsl:choose>
</iaixsl:if>
