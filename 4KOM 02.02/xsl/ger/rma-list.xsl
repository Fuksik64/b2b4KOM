...
<iaixsl:attribute name="class">rma_list_cms_label  big_label</iaixsl:attribute>
    ...
    <!--Informacje o reklamacjach (rma_list_data, 107803.1)-->
        ...
        <iaixsl:variable name="rma_list_paymenthead">Bevorzugte Form der Gelderstattung:</iaixsl:variable>
        ...
        <iaixsl:choose>
            <iaixsl:when test="/shop/page/rma/item">
                ...
                <div class="client_order">
                    ...
                    <h1 class="big_label">
                        <span>Abgeschlossene und stornierte Bestellungen</span>
                    </h1>
                    ...
                    <table class="orders" cellspacing="0" cellpadding="0" >
                        ...
                        <thead>
                            <tr id="orders_header">
                                <td class="ord3" id="orders_head_1">Bestellungs-ID</td>
                                <td class="ord3" id="orders_head_2">Bestelldatum</td>
                                

                                <td class="ord3" id="orders_head_5">Status</td>
                                <td class="ord3" id="orders_head_6">Handeln</td>
                            </tr>
                        </thead>
                        <tbody>
                            <iaixsl:for-each select="/shop/page/rma/item">
                                <tr>
                                        ...
                                        <div>
                                            ...
                                            <iaixsl:choose>
                                                ...
                                                <iaixsl:when test="@status=1">
                                                    ...
                                                    <small>Beanstandung wird geprüft</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=2">
                                                    <span><i class="icon-ok"></i></span>
                                                    <small>Beanstandung angenommen</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=3">
                                                    <span><i class="icon-remove"></i></span>
                                                    <small>Beanstandung abgelehnt</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=4">
                                                    <span><i class="icon-clock"></i></span>
                                                    <small>Beanstandung wird geprüft – zu den Tests weitergeleitet</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=5">
                                                    <span><i class="icon-clock"></i></span>
                                                    <small>Beanstandung wird geprüft – das Produkt wurde an den Hersteller geschickt</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=6">
                                                    <span><i class="icon-clock"></i></span>
                                                    <small>Beanstandung wird geprüft – Reparatur dauert an</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=7">
                                                    <span><i class="icon-remove"></i></span>
                                                    <small>Beanstandung abgelehnt – kein Mangel festgestellt</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=8">
                                                    <span><i class="icon-remove"></i></span>
                                                    <small>Beanstandung abgelehnt – Fehler durch falsche Nutzung</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=9">
                                                    <span><i class="icon-remove"></i></span>
                                                    <small>Beanstandung abgelehnt – Garantiefrist überschritten</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=10">
                                                    <span><i class="icon-ok"></i></span>
                                                    <small>Beanstandung angenommen – Geldrückgabe – zur Zahlung weitergeleitet</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=11">
                                                    <span><i class="icon-ok"></i></span>
                                                    <small>Beanstandung angenommen – Geldrückgabe – Auszahlung</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=12">
                                                    <span><i class="icon-ok"></i></span>
                                                    <small>Beanstandung angenommen – Umtausch gegen ein neues Produkt</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=13">
                                                    <span><i class="icon-remove"></i></span>
                                                    <small>Durch den Kunden stornierte Retoure</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=14">
                                                    <span><i class="icon-remove"></i></span>
                                                    <small>Beanstandung nicht erhalten</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=15">
                                                    <span><i class="icon-truck"></i> </span>
                                                    <small>Kunde hat die Beanstandung generiert</small>
                                                </iaixsl:when>
                                                
                                                <iaixsl:when test="@status=16">
                                                    <span><i class="icon-thumbs-down-alt"></i></span>
                                                    <small>Erneuter Versand der Bestellung unterlassen </small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=17">
                                                    <span><i class="icon-box"></i></span>
                                                    <small>Beanstandung storniert</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=18">
                                                    <span><i class="icon-box"></i></span>
                                                    <small>Beanstandung vom Kunden storniert</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=19">
                                                    <span><i class="icon-ok"></i></span>
                                                    <small>Beschwerde bestätigt</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=20">
                                                    <span><i class="icon-clock"></i></span>
                                                    <small>Beanstandung nicht bearbeitet</small>
                                                </iaixsl:when>
                                                ...
                                                <iaixsl:when test="@status=24">
                                                    <span><i class="icon-remove"></i></span>
                                                    <small>Die durch schlechte Bedienung verursacht Defekt</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=25">
                                                    <span><i class="icon-ok"></i></span>
                                                    <small>Beanstandung angenommen – Rücksendung wurde an den Kurierdienst geschickt</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=26">
                                                    <span><i class="icon-ok"></i></span>
                                                    <small>Beanstandung angenommen – neue Ware wurde gesendet, ohne auf die ursprüngliche Ware zu warten</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=27">
                                                    <span><i class="icon-ok"></i></span>
                                                    <small>Beanstandung angenommen – Änderung der Empfängerangaben auf dem Verkaufsdokument</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=28">
                                                    <span><i class="icon-clock"></i></span>
                                                    <small>Beanstandung wird bearbeitet – Reparatur abgeschlossen</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=29">
                                                    <span><i class="icon-clock"></i></span>
                                                    <small>Beanstandung wird bearbeitet – zusätzliche Kundeninformationen erforderlich</small>
                                                </iaixsl:when>
                                                <iaixsl:when test="@status=30">
                                                    <span><i class="icon-remove"></i></span>
                                                    <small>Beanstandung abgelehnt – Rücksendung an den Kunden geschickt</small>
                                                </iaixsl:when>
                                                <iaixsl:otherwise>
                                                    <span><i class="icon-ok"></i></span>
                                                    <small>
                                    ...
                                    <td class="ord">
                                        <a class="btn-icon"><iaixsl:attribute name="href"><iaixsl:value-of select="@url"/></iaixsl:attribute><span><i class='icon-plus'></i></span><small>Wählen</small></a>
                                    </td>
                                </tr>
                            </iaixsl:for-each>
                        </tbody>
            ...
            <iaixsl:otherwise>
                ...
                <div class="rma_list_data_outline">
                    <div class="rma_list_data_label">
                        <span class="rma_list_data_label">
                    ...
                    <div class="rma_list_data_addbutton">
                        <a href="rma-add.php" class="btn --solid --medium rma_list_data_addbutton">
                            ...
                            <iaixsl:attribute name="title"><i class="icon-pencil"></i> Reklamation hinzuzufügen</iaixsl:attribute>
                            <span class="img_button_edytujaddbutton"/>
                            <div class="addbutton_maintxt"><i class="icon-pencil"></i> Reklamation hinzuzufügen</div>
                            <div class="addbutton_sidetxt">Stimmt etwas mit Ihre Bestellung nicht? Bitte eine Reklamation melden.</div>
                        </a>
                    </div>
                        ...
                        <div class="rma_list_data_sub">
                            ...
                            <div class="rma_list_data_toggler">
                                <div id="rma_tab_close" class="rma_list_tab" onclick="rma_list.choosePanel('rma_tab_close','rma_panel_close');">
                                    ...
                                    <span>Abgeschlossene Reklamationen</span>
                                </div>
                                <div id="rma_tab_active" class="rma_list_tab rma_on" onclick="rma_list.choosePanel('rma_tab_active','rma_panel_active');">
                                    ...
                                    <span>Reklamationen in Bearbeitung</span>
                                </div>
                            </div>
                                ...
                                <div id="rma_panel_close" class="rma_list_data_panel" style="display:none;">
                                    ...
                                    <iaixsl:choose>
                                        <iaixsl:when test="page/list/close/@count = 0">
                                            <span class="rma_list_noitem">Keine abgeschlossenen Reklamationen</span>
                                        </iaixsl:when>
                                        <iaixsl:otherwise>
                                            
                                            <div class="rma_list_data_labels">
                                                <span class="rma_list_label_nmbr">
                                                    Reklamationsnummer
                                                </span>
                                                <span class="rma_list_label_product">
                                                    Produkt

                                                </span>
                                                <span class="rma_list_label_status">
                                                    Aktueller Status
                                                </span>
                                                <span class="rma_list_label_operation">
                                                    Operationen
                                                </span>
                                            </div>
                                            ...
                                            <iaixsl:for-each select="page/list/close/item">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="rma_list_item_operation">
                                                        mehr Informationen <i class="icon-angle-down"></i>
                                                    </span>
                                                    <span class="rma_list_item_operation ophidden">
                                                        weniger Informationen <i class="icon-angle-up"></i>
                                                    </span>
                                                </div>
                                                    ...
                                                    <div class="rma_list_item_sub">
                                                        ...
                                                        <div class="rma_list_itmesub1">
                                                            <div class="rma_list_itemdata">
                                                                ...
                                                                <div class="rma_list_itemhead">
                                                                    <span>Genaue Daten:</span>
                                                                </div>
                                                                <table class="rma_list_itemdata">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td class="rma_list_itemdata1">
                                                                                Seriennummer:
                                                                            </td>
                                                            ...
                                                            <div class="rma_list_itemstatus">
                                                                <div class="rma_list_itemhead">
                                                                    <span>Aktueller Bearbeitungsstatus der Reklamationsmeldung:</span>
                                                                </div>
                                                        ...
                                                        <div class="rma_list_itmesub2">
                                                            ...
                                                            <div class="rma_list_itemplace">
                                                                <div class="rma_list_itemhead">
                                                                    <span>Reklamation wird bearbeitet in:</span>
                                                                </div>
                                                                        ...
                                                                        <table class="rma_list_itemstock">
                                                                            <tbody>
                                                                                <iaixsl:if test="stock/@phone != ''">
                                                                                    <tr>
                                                                                        <td class="rma_list_itemplace1">Tel.</td>
                                                                    ...
                                                                    <iaixsl:if test="stock/@link !=''">
                                                                        <div class="rma_list_itemstock_link">
                                                                            <a class="rma_list_itemstock_link">
                                                                                <iaixsl:attribute name="href"><iaixsl:value-of select="stock/@link"/></iaixsl:attribute>
                                                                                mehr Informationen <i class="icon-double-angle-right"></i>
                                                                            </a>
                                                                        </div>
                                                                    </iaixsl:if>
                                                                </div>
                                                                                ...
                                                                                <iaixsl:otherwise>
                                                                                    <iaixsl:choose>
                                                                                        ...
                                                                                        <iaixsl:when test="payment/@type = 'c' ">
                                                                                            Daten, auf die der Scheck ausgestellt werden soll:
                                                                                        </iaixsl:when>
                                                                                        <iaixsl:when test="payment/@type = 't' ">
                                                                                            Geld, das Sie bei künftigen Einkäufen verwenden können.
                                                                                        </iaixsl:when>
                                                                                    </iaixsl:choose>
                                                                                </iaixsl:otherwise>
                                                                            </iaixsl:choose>
                                                            ...
                                                            <div class="rma_list_itembuttons">
                                                                <iaixsl:if test="documents/postdocument ">
                                                                    <a class="btn --solid --medium rma_list_button_etykieta" target="_blank">
                                                                        ...
                                                                        <iaixsl:attribute name="title">Klicken Sie hier, um das Adressetikett zu drucken</iaixsl:attribute>
                                                                        <span class="img_button_etykieta"/>
                                                                        <i class="icon-print"></i> Adressenetikett ausdrucken
                                                                    </a>
                                                                </iaixsl:if>
                                                                <iaixsl:if test="documents/letterofcomplaint">
                                                                    <a class="btn --solid --medium rma_list_button_wydrukuj" target="_blank">
                                                                        ...
                                                                        <iaixsl:attribute name="title">Klicken Sie hier, um die Reklamationsmeldung zu drucken</iaixsl:attribute>
                                                                        <span class="img_button_zgloszenie"/>
                                                                        <i class="icon-print"></i> Reklamationsmeldung ausdrucken
                                                                    </a>
                                                                </iaixsl:if>
                                                                <iaixsl:if test="@edit_link and (@edit_link != '')">
                                                                    <a class="btn --solid --medium rma_list_button_edit">
                                                                        ...
                                                                        <iaixsl:attribute name="title">Klicken Sie hier, um die Reklamation zu bearbeiten</iaixsl:attribute>
                                                                        <span class="img_button_edytuj"/>
                                                                        <i class="icon-pencil"></i>  Reklamation bearbeiten
                                                                    </a>
                                                                </iaixsl:if>
                                                                ...
                                                                <iaixsl:if test="@cancel_link and (@cancel_link != '')">
                                                                    <a class="btn --solid --medium rma_list_button_cancel">
                                                                        ...
                                                                        <iaixsl:attribute name="title">Klicken Sie hier, um die Reklamation zu stornieren</iaixsl:attribute>
                                                                        <span class="img_button_anuluj"/>
                                                                        <i class="icon-remove"></i>  Reklamation stornieren
                                                                    </a>
                                                                </iaixsl:if>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <iaixsl:if test="count(staff_note/note) > 0">
                                                            <div class="rma_list_itmesub3">
                                                                <iaixsl:if test="count(staff_note/note) = 1">
                                                                    <div class="rma_list_noteslabel">Notiz des Kundenservices</div>
                                                                </iaixsl:if>
                                                                <iaixsl:if test="count(staff_note/note) > 1">
                                                                    <div class="rma_list_noteslabel">Notiz des Kundenservices</div>
                                                                </iaixsl:if>
                                ...
                                <div id="rma_panel_active" class="rma_list_data_panel">
                                    ...
                                    <iaixsl:choose>
                                        <iaixsl:when test="page/list/active/@count = 0">
                                            <span class="rma_list_noitem">Keine Reklamationen in Bearbeitung.</span>
                                        </iaixsl:when>
                                        <iaixsl:otherwise>
                    ...
                    <iaixsl:if test="(page/list/active/@count = 0) and (page/list/close/@count = 0)">
                        <span class="rma_list_noitem" id="rma_list_noitem">Es wurde noch keine Reklamation hinzugefügt.</span>
                    </iaixsl:if>
