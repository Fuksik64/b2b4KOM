        ...
        <!--Returns Open Form (returns_open_form, 108776.1)-->
            ...
            <section id="returnsOpen" class="form-open">
                <div class="big_label mb-3">
                    Wählen Sie die Bestellung aus, aus der Sie die Ware zurücksenden möchten.
                </div>
                            ...
                            <div class="form-summary col-12">
                                <div class="form-buttons">
                                    ...
                                    <div class="button_legend">
                                        <i class="icon-need"></i> Felder, die mit einem Sternchen (*) versehen sind, müssen ausgefüllt werden
                                    </div>
                                </div>
