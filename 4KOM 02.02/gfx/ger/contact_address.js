...
var contact_txt1="Besuchen Sie unseren Laden";var contact_txt2="Besuchen Sie eines unserer Geschäfte";var contact_txt3="mehr Informationen";var contact_txt4="mon";var contact_txt5="die";var contact_txt6="mit";var contact_txt7="don";var contact_txt8="fre";var contact_txt9="sam";var contact_txt10="son";var contact_txt13="mon - fre";var contact_txt11="Öffnungszeiten";var contact_txt12="Geschlossen";var contact_txt14="Telefon";var s_count=0;function build_stock(name,street,city,postcode,link,open,tel){var label_text=contact_txt1;if(s_count>1)label_text=contact_txt2;var stock_wrapper='<div class="stocks_list_wrapper table_cell"><p class="stocks_list_stock">';stock_wrapper+='<span class="stocks_list_name"><a class="stocks_list_name" href="'+link+'" style="height: 32px;">'+name+'</a></span>';stock_wrapper+='<span class="stocks_list_adress"><span class="stocs_list_street">'+street+'</span><br><span class="stocs_list_city">'+postcode+' '+city+'</span></span>';stock_wrapper+='<a class="stocks_list_more" href="'+link+'">'+contact_txt3+'</a>';var daysNames=[contact_txt4,contact_txt5,contact_txt6,contact_txt7,contact_txt8,contact_txt9,contact_txt10];if(open){stock_wrapper+='<span class="stocks_list_label"><span>'+contact_txt11+'</span></span>';if(open[1]==open[2]&&open[2]==open[3]&&open[3]==open[4]&&open[4]==open[5]){if(open[1]=='nD')
...
{contact_map.language=contactLanguage;google.load('maps','3',{callback:callback,other_params:'sensor=false&language='+contact_map.language+'&key='+google_api_key});});else if((parent.location.protocol+'//')=='http://')
$.getScript("http://www.google.com/jsapi",function()
{contact_map.language=contactLanguage;google.load('maps','3',{callback:callback,other_params:'sensor=false&language='+contact_map.language+'&key='+google_api_key});});},mapInit:function(){contact_map.zoom=contactZoom;contact_map.geokoder=new google.maps.Geocoder();var wspolrzedne=new google.maps.LatLng(parseInt(bCordContact),parseInt(lCordContact));if(markersAnimationContact!='')
